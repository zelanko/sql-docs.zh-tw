---
title: "SharePoint 模式 (SSRS) 在報表伺服器上已發行報表項目的 URL 範例 | Microsoft Docs"
ms.custom: ""
ms.date: "03/14/2017"
...
|在 [!INCLUDE[winSPServ](../../includes/winspserv-md.md)] 或 [!INCLUDE[SPF2010](../../includes/spf2010-md.md)] 部署上，**Shared Documents** 中的 Company Sales 範例報表。|http://TestServer/TestSite/Shared%20Documents/Company%20Sales.rdl|  
|在 [!INCLUDE[offSPServ](../../includes/offspserv-md.md)] 或 [!INCLUDE[SPS2010](../../includes/sps2010-md.md)] 執行個體上，**Documents/Doc** 資料夾中的 Company Sales 範例報表。|http://TestServer/TestSite/Documents/Doc/Company%20Sales.rdl|  
