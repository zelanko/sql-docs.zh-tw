---
title: "rsconfig 公用程式 (SSRS) |Microsoft 文件"
ms.custom: 
ms.date: 03/20/2017
...
## <a name="see-also"></a>請參閱＜  
 ...
 [設定自動的執行帳戶 &#40;SSRS 組態管理員 &#41;](../../reporting-services/install-windows/configure-the-unattended-execution-account-ssrs-configuration-manager.md)   
