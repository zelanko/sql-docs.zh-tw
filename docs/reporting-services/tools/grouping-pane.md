...
![ssrs_fyi_note](../../analysis-services/instances/install-windows/media/ssrs-fyi-note.png)切換**進階的模式**，向下箭號，旁邊的 [資料行群組] 窗格中，以滑鼠右鍵按一下，然後按一下**進階模式**。  
