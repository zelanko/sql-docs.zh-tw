...
-   [How to Administer SSRS using PowerShell](http://curah.microsoft.com/13107/how-to-administer-ssrs-using-powershell)(如何使用 PowerShell 管理 SSRS)。  
