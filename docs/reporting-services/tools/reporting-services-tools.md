...
helpviewer_keywords: 
  ...
  - "元件 [Reporting Services], 關於元件"
  - "Reporting Services, 元件"
  - "SSRS, 元件"
  - "報表 [Reporting Services], 工具"
  - "SQL Server Reporting Services, 元件"
  - "SQL Server Reporting Services, 工具"
  - "架構 [Reporting Services]"
