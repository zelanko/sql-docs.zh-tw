...
10. 在 [TargetServerURL] 文字方塊中，鍵入目標報表伺服器的 URL。 在發行報表之前，您必須設定此屬性為有效的報表伺服器 URL。 當您發行至以原生模式執行的報表伺服器時，請使用報表伺服器之虛擬目錄的 URL (例如 http:*//server/reportserver* 或 https:*//server/reportserver*)。 這是報表伺服器的虛擬目錄，而非報表管理員。  
     ...
     發行至以 SharePoint 整合模式執行的報表伺服器時，請使用 SharePoint 頂層網站或子網站的 URL。 如果您未指定網站，則會使用預設頂層網站 (例如 https://伺服器名稱、 https://伺服器名稱/網站或 https://伺服器名稱/網站/子網站)。  
...
## <a name="see-also"></a>另請參閱  
 [發佈資料來源與報表](../../reporting-services/reports/publishing-data-sources-and-reports.md)[預覽報表](../../reporting-services/reports/previewing-reports.md)[報表設計工具 F1 說明](../../reporting-services/tools/report-designer-f1-help.md) [報表伺服器 SharePoint 模式下已發佈之報表項目的 URL 範例 &#40;SSRS&#41; ](../../reporting-services/tools/url-examples-for-items-on-a-report-server-sharepoint-mode.md) [專案屬性頁對話方塊](../../reporting-services/tools/project-property-pages-dialog-box.md)[將報表發佈到報表伺服器](../../reporting-services/reports/publishing-reports-to-a-report-server.md)
