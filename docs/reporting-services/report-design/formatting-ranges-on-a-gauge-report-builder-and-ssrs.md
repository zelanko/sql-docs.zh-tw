...
# 設定量測計上範圍的格式 (報表產生器及 SSRS)
 ...
 您可以使用在標尺上放置指標的相同方式來放置範圍。 **[位置]** 和 **[距標尺距離]** 屬性會決定範圍的位置。 如需詳細資訊，請參閱[量測計 &#40;報表產生器及SSRS&#41;](../../reporting-services/report-design/gauges-report-builder-and-ssrs.md)。  
