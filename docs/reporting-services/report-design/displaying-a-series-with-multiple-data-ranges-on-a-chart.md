---
title: "包含多個資料範圍的數列顯示在圖表上 |Microsoft 文件"
ms.custom: 
ms.date: 03/07/2017
...
# <a name="displaying-a-series-with-multiple-data-ranges-on-a-chart"></a>將包含多個資料範圍的數列顯示在圖表上
 ...
 ![包含多個資料範圍圖表](../../reporting-services/report-design/media/rs-multipledatarangeschart.gif "與多個資料範圍的圖表")  
...
[在圖表上的多個數列](../../reporting-services/report-design/multiple-series-on-a-chart-report-builder-and-ssrs.md)   
[格式化圖表](../../reporting-services/report-design/formatting-a-chart-report-builder-and-ssrs.md)   
[3D、 浮凸和其他圖表中的效果](../../reporting-services/report-design/chart-effects-3d-bevel-and-other-report-builder.md)   
...
[收集圓形圖小配量](../../reporting-services/report-design/collect-small-slices-on-a-pie-chart-report-builder-and-ssrs.md)  
