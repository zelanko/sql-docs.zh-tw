...
8.  以滑鼠右鍵按一下量測計，按一下 [加入指標]，然後按一下 [子系]。 [選取指標樣式] 對話方塊隨即開啟。  
...
8.  以滑鼠右鍵按一下量測計，按一下 [加入指標]，然後按一下 [相鄰]。 [選取指標樣式] 對話方塊隨即開啟。  
...
14. 以滑鼠右鍵按一下量測計面板，然後按一下 [加入標籤]。 標籤就會加入至量測計面板。 再重複一次。  
  
     量測計面板有兩個標籤。  
  
15. 將每個標籤拖曳到量測計或指標附近的位置。  
  
16. 以滑鼠右鍵按一下量測計附近的標籤，按一下 [標籤屬性]，然後在 [文字] 方塊中輸入您想要的文字。  
  
17. 以滑鼠右鍵按一下指標附近的標籤，按一下 [標籤屬性]，然後在 [文字] 方塊中輸入您想要的文字。  
