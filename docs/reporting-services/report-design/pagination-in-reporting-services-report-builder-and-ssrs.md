...
-   ResetPageNumber 會指出分頁時，是否應該將頁碼重設為 1。 如果這個屬性評估為 True，則會重設頁碼。  
 ...
 在您的報表中，您可以使用 **Globals** 集合，撰寫參考目前頁面名稱或頁碼的運算式。 如需詳細資訊，請參閱[內建的全域和使用者參考 &#40;報表產生器及 SSRS&#41;](../../reporting-services/report-design/built-in-globals-and-users-references-report-builder-and-ssrs.md)。  
