---
title: Var 函式 (報表產生器) | Microsoft Docs
description: 在報表產生器中，使用 Var 函式來傳回運算式所指定所有非 Null 數值的變異數。
ms.date: 03/07/2017
 ...
 *範圍 (scope)*  
 (**字串**) 選擇性。 包含要套用彙總函式之報表項目的資料集、群組或資料區域名稱的常數。 如果未指定 *scope* ，則使用目前的範圍。  
