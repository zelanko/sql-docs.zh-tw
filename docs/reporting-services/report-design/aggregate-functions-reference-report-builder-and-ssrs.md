...
|**函數**|**說明**|  
|------------------|---------------------|  
|[Avg](../../reporting-services/report-design/avg-function-report-builder-and-ssrs.md)|傳回運算式指定的所有非 Null 數值的平均值 (在給定範圍中評估)。|  
|[計數](../../reporting-services/report-design/count-function-report-builder-and-ssrs.md)|傳回運算式指定的非 Null 值的計數 (在給定範圍的內容中評估)。|  
|[CountDistinct](../../reporting-services/report-design/countdistinct-function-report-builder-and-ssrs.md)|傳回運算式指定的所有非 Null 相異值的計數 (在給定範圍的內容中評估)。|  
|[Max](../../reporting-services/report-design/max-function-report-builder-and-ssrs.md)|傳回運算式指定的所有非 Null 數值的最大值 (在給定範圍的內容中)。 這個函數可用來指定圖表軸的最大值以控制刻度。|  
|[Min](../../reporting-services/report-design/min-function-report-builder-and-ssrs.md)|傳回運算式指定的所有非 Null 數值的最小值 (在給定範圍的內容中)。 這個函數可用來指定圖表軸的最小值以控制刻度。|  
|[StDev](../../reporting-services/report-design/stdev-function-report-builder-and-ssrs.md)|傳回運算式指定的所有非 Null 數值的標準差 (在給定範圍中評估)。|  
|[StDevP](../../reporting-services/report-design/stdevp-function-report-builder-and-ssrs.md)|傳回運算式指定的所有非 Null 數值的母體標準差 (在給定範圍的內容中評估)。|  
|[Sum](../../reporting-services/report-design/sum-function-report-builder-and-ssrs.md)|傳回運算式指定之所有非 Null 數值的總和 (在給定範圍中評估)。|  
|[Union](../../reporting-services/report-design/union-function-report-builder-and-ssrs.md)|傳回運算式所指定之 **SqlGeometry** 或 **SqlGeography** 類型的所有非 Null 空間資料值聯集 (在給定的範圍中評估)。|  
|[Var](../../reporting-services/report-design/var-function-report-builder-and-ssrs.md)|傳回運算式指定的所有非 Null 數值的變異數 (在給定範圍中評估)。|  
|[VarP](../../reporting-services/report-design/varp-function-report-builder-and-ssrs.md)|傳回運算式指定的所有非 Null 數值的母體擴展變異數 (在給定範圍的內容中評估)。|  
  
 ![搭配回到頁首連結使用的箭頭圖示](../../analysis-services/instances/media/uparrow16x16.png "搭配回到頁首連結使用的箭頭圖示")回到頁首  
...
|**函數**|**說明**|  
|------------------|---------------------|  
|[RowNumber](../../reporting-services/report-design/rownumber-function-report-builder-and-ssrs.md)|傳回指定範圍中資料列數的執行計數。 **RowNumber** 函數從 1 開始重新計數，而不是 0。|  
|[RunningValue](../../reporting-services/report-design/runningvalue-function-report-builder-and-ssrs.md)|傳回運算式指定的所有非 Null 數值的執行彙總 (在給定範圍中評估)。|  
...
|**函數**|**說明**|  
|------------------|---------------------|  
|[CountRows](../../reporting-services/report-design/countrows-function-report-builder-and-ssrs.md)|傳回指定之範圍中的資料列數目，包括具有 Null 值的資料列。|  
...
|**函數**|**說明**|  
|------------------|---------------------|  
|[Lookup 函數](../../reporting-services/report-design/lookup-function-report-builder-and-ssrs.md)|從指定之運算式的資料集傳回值。|  
|[LookupSet 函數](../../reporting-services/report-design/lookupset-function-report-builder-and-ssrs.md)|從指定之運算式的資料集傳回一組值。|  
|[Multilookup 函數](../../reporting-services/report-design/multilookup-function-report-builder-and-ssrs.md)|從包含名稱/值組的資料集傳回第一組符合某一組名稱的值。|  
...
|**函數**|**說明**|  
|------------------|---------------------|  
|[第一個](../../reporting-services/report-design/first-function-report-builder-and-ssrs.md)|傳回所指定運算式給定範圍中的第一個值。|  
|[最後一個](../../reporting-services/report-design/last-function-report-builder-and-ssrs.md)|傳回所指定運算式給定範圍中的最後一個值。|  
|[Previous](../../reporting-services/report-design/previous-function-report-builder-and-ssrs.md)|傳回某個項目在指定之範圍內上一個執行個體的值或指定的彙總值。|  
...
|**函數**|**說明**|  
|------------------|---------------------|  
|[Aggregate](../../reporting-services/report-design/aggregate-function-report-builder-and-ssrs.md)|傳回指定之運算式的自訂彙總，由資料提供者定義。|  
...
|函數|說明|  
|--------------|-----------------|  
|[InScope](../../reporting-services/report-design/inscope-function-report-builder-and-ssrs.md)|指出目前項目的執行個體是否在指定的範圍內。|  
...
|函數|說明|  
|--------------|-----------------|  
|[Level](../../reporting-services/report-design/level-function-report-builder-and-ssrs.md)|傳回遞迴階層中之目前所在的層級。|  
