---
title: "將邊框加入至圖表 （報表產生器及 SSRS） |Microsoft 文件"
ms.custom: 
ms.date: 03/03/2017
...
## <a name="see-also"></a>請參閱＜  
 ...
 [將斜面、 浮凸與紋理樣式圖表 &#40;報表產生器及 SSRS &#41;](../../reporting-services/report-design/chart-effects-add-bevel-emboss-or-texture-report-builder.md)  
