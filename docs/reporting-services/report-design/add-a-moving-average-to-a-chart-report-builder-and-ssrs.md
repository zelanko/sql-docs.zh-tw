---
title: "將移動平均加入至圖表 （報表產生器及 SSRS） |Microsoft 文件"
ms.custom: 
ms.date: 03/03/2017
...
![report-builder-column-chart-tutorial](../../reporting-services/media/report-builder-column-chart-tutorial.png)
 ...
 [教學課程： 將直條圖加入至報表 （報表產生器）](Tutorial:%20Add%20a%20Column%20Chart%20to%20Your%20Report%20\(Report%20Builder\).md)會引導您完成將移動平均加入至圖表中，如果您想要再試一次，其中範例資料。
