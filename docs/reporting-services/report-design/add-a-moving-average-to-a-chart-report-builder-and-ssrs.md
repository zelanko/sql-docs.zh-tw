...
![report-builder-column-chart-tutorial](../../reporting-services/media/report-builder-column-chart-tutorial.png)
 ...
 如果您想用範例資料來進行嘗試，[教學課程：將直條圖新增至報表 (報表產生器)](Tutorial:%20Add%20a%20Column%20Chart%20to%20Your%20Report%20\(Report%20Builder\).md) 會引導您將移動平均新增至圖表中。
