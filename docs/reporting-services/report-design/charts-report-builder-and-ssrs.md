---
title: 圖表 (報表產生器) | Microsoft Docs
description: 在報表產生器中使用圖表資料區域，可協助編頁報表讀者一眼便了解大量的彙總資料。
ms.date: 03/07/2017
...
##  <a name="how-a-chart-is-like-a-matrix"></a><a name="SimilarMatrix"></a>圖表與矩陣的相似處  
