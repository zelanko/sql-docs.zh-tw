...
## 使用來自 ESRI 形狀檔中空間資料的我的圖層永遠有內嵌的資料。  
...
## 我將資料來源或資料集重新命名為易記名稱，因此現在我的地圖中沒有出現任何資料。  
...
## 我在報表中設定地圖置中與檢視。 當我重新開啟報表時，為什麼地圖檢視不一樣了？  
...
## 當我將標籤或工具提示設定為運算式時，出現有關資料集範圍的運算式錯誤。  
...
## 請參閱＜  
 ...
 [疑難排解報表產生器](http://msdn.microsoft.com/zh-tw/3806fc48-56f8-44d1-a3c1-df8c33cce0a3)  
