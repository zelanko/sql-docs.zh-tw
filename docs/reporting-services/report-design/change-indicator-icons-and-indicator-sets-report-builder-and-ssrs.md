---
title: 變更指標圖示和指標集合 (報表產生器) | Microsoft Docs
description: 了解如何變更指標圖示和集合以包含不同、更多或更少的指標圖示，讓您在報表產生器中更清楚地描述資料。
ms.date: 03/01/2017
...
3.  在您要變更的圖示旁邊按一下 [色彩]**** 資料行中的向下箭號，然後按一下要使用的色彩：[無色彩]**** 或 [更多色彩]****。  
     ...
     如果您按一下 [更多色彩]，[選取色彩] 對話方塊隨即開啟，讓您從中選擇色彩。 如需其選項的詳細資訊，請參閱[選取色彩對話方塊 &#40;報表產生器及 SSRS&#41;](./formatting-lines-colors-and-images-report-builder-and-ssrs.md)。 按一下 [確定] 關閉 [選取色彩] 對話方塊。  
