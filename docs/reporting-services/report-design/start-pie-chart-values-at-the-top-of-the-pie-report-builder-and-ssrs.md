...
![資料集從 90 度開始的報表產生器圓形圖螢幕擷取畫面。](../../reporting-services/media/report-builder-pie-chart-start-at-90.png)

*圖表值從 90 度開始。*

你可能希望第一個值能從正上方開始。 

![資料集從頂端開始的報表產生器圓形圖螢幕擷取畫面。](../../reporting-services/media/report-builder-pie-chart-start-at-top.png)
