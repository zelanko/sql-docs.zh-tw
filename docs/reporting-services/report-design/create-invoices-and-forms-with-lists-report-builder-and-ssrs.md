---
title: 建立發票和表單的清單 (報表產生器) | Microsoft Docs
description: 了解如何定義並使用清單以建立自由格式的報表或表單，以及如何在報表產生器中使用清單搭配其他資料區域。
ms.date: 03/07/2017
...
##  <a name="adding-a-list-to-your-report"></a><a name="AddingList"></a> 將清單加入報表  
