---
title: "Last 函數 (報表產生器及 SSRS) | Microsoft Docs"
ms.custom: ""
ms.date: "12/09/2016"
...
-   *Expression* 不得包含指定 *recursive*的巢狀彙總。  
 ...
 如需詳細資訊，請參閱[彙總函式參考 &#40;報表產生器及 SSRS&#41;](../../reporting-services/report-design/aggregate-functions-reference-report-builder-and-ssrs.md) 和 [Expression Scope for Totals, Aggregates, and Built-in Collections &#40;Report Builder and SSRS&#41;](../../reporting-services/report-design/expression scope for totals, aggregates, and built-in collections.md) (總計、彙總與內建集合的運算式範圍 (報表產生器及 SSRS))。  
  
 如需遞迴彙總的詳細資訊，請參閱 [Creating Recursive Hierarchy Groups &#40;Report Builder and SSRS&#41;](../../reporting-services/report-design/creating-recursive-hierarchy-groups-report-builder-and-ssrs.md) (建立遞迴階層群組 (報表產生器及 SSRS))。  
