...
### <a name="b-use-join-to-create-a-result-list"></a>B. 使用 Join 建立結果清單 
...
### <a name="c-add-code-to-generate-html"></a>C. 新增程式碼以產生 HTML
...
### <a name="d-call-the-function"></a>D. 呼叫函式
