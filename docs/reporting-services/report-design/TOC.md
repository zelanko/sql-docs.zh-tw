...
## [資料區及地圖](data-regions-and-maps-report-builder-and-ssrs.md)  
...
### [圖表圖例 - 格式設定](chart-legend-formatting-report-builder.md)  
### [圖表圖例 - 隱藏項目](chart-legend-hide-items-report-builder.md)  
...
### [圖表效果 - 3D、斜面和其他](chart-effects-3d-bevel-and-other-report-builder.md)  
### [圖表效果 - 加入 3D 效果](chart-effects-add-3d-effects-report-builder.md)  
### [圖表效果 - 加入斜面、浮凸或紋理](chart-effects-add-bevel-emboss-or-texture-report-builder.md)  
...
### [將空白點加入至圖表 (報表產生器及 SSRS)](add-empty-points-to-a-chart-report-builder-and-ssrs.md)  
...
## [自訂報表中的參數窗格](customize-the-parameters-pane-in-a-report-report-builder.md)  
...
### [報表產生器函式 - 彙總函式參考](report-builder-functions-aggregate-functions-reference.md)  
#### [報表產生器函式 - 彙總函式](report-builder-functions-aggregate-function.md)  
...
#### [報表產生器函式 - First 函數](report-builder-functions-first-function.md)  
#### [報表產生器函式 - InScope 函數](report-builder-functions-inscope-function.md)  
#### [報表產生器函式 - Last 函數](report-builder-functions-last-function.md)  
#### [報表產生器函式 - Level 函數](report-builder-functions-level-function.md)  
#### [報表產生器函式 - Lookup 函數](report-builder-functions-lookup-function.md)  
#### [報表產生器函式 - LookupSet 函數](report-builder-functions-lookupset-function.md)  
#### [報表產生器函式 - Max 函數](report-builder-functions-max-function.md)  
#### [報表產生器函式 - Min 函數](report-builder-functions-min-function.md)  
...
#### [報表產生器函式 - RowNumber 函數](report-builder-functions-rownumber-function.md)  
#### [報表產生器函式 - RunningValue 函數](report-builder-functions-runningvalue-function.md)  
#### [報表產生器函式 - StDev 函數](report-builder-functions-stdev-function.md)  
#### [報表產生器函式 - StDevP 函數](report-builder-functions-stdevp-function.md)  
#### [報表產生器函式 - Sum 函數](report-builder-functions-sum-function.md)  
#### [報表產生器函式 - Union 函數](report-builder-functions-union-function.md)  
...
#### [內建集合 - 全域和使用者參考](built-in-collections-built-in-globals-and-users-references-report-builder.md)  
#### [內建集合 - 參數集合參考](built-in-collections-parameters-collection-references-report-builder.md)  
#### [內建集合 - 資料集欄位集合參考](built-in-collections-dataset-fields-collection-references-report-builder.md)  
#### [內建集合 - DataSources 和 DataSets 參考](built-in-collections-datasources-and-datasets-references-report-builder.md)  
#### [內建集合 - 報表和群組變數參考](built-in-collections-report-and-group-variables-references-report-builder.md)  
