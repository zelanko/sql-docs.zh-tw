---
title: 設定圖表上資料點的格式 (報表產生器) | Microsoft Docs
description: 了解如何使用對話方塊或使用 [屬性] 窗格來分類和顯示報表產生器中的關聯性，以格式化圖表上的軸標籤。
ms.date: 03/03/2017
...
-   在 [軸屬性] 對話方塊中，選取 [純量軸] 選項。 這樣會在軸上沒有資料群組值存在的位置加入數值或日期/時間值。 如需詳細資訊，請參閱[軸屬性對話方塊、軸選項 &#40;報表產生器及 SSRS&#41;](/previous-versions/sql/)。  
