...
description: 了解如何在編頁報表中新增或刪除指標，以在報表產生器中傳達單一資料的狀態。
ms.date: 03/01/2017
...
ms.locfileid: "84881250"
---
# <a name="add-or-delete-an-indicator-report-builder-and-ssrs"></a>加入或刪除指標 (報表產生器及 SSRS)
  在 [!INCLUDE[ssRSnoversion_md](../../includes/ssrsnoversion-md.md)] 編頁報表中，指標是最小的量測單位，僅一眼就可傳達單一資料值的狀態。 如需指標的詳細資訊，請參閱 [指標 &#40;報表產生器及 SSRS&#41;](../../reporting-services/report-design/indicators-report-builder-and-ssrs.md)。  
