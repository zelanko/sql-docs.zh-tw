---
title: 報表和群組變數集合參考 (報表產生器) | Microsoft Docs
description: 當具有在報表中使用多次的複雜計算時，請建立擁有唯一名稱的變數。
ms.date: 03/01/2017
...
-   **讀寫使用** ：設定一次某個值，然後在報表工作階段中序列化該值。 變數的讀寫選項會比在報表定義的程式碼區塊中使用靜態變數提供更好的替代方案。  
 ...
 如需有關工作階段的詳細資訊，請參閱＜ [Previewing Reports in Report Builder](../../reporting-services/report-builder/previewing-reports-in-report-builder.md)＞。  
