...
###  <a name="what-is-a-sql-server-spatial-query"></a><a name="SqlServerSpatial"></a> 何謂 SQL Server 空間查詢？  
...
> [!NOTE]  
>  當您在精靈中定義資料來源時，您會在 [設計查詢] 頁面看到不同的查詢設計工具，端視您所連接的資料來源類型而定。 如需詳細資訊，請參閱[查詢設計工具 &#40;SSRS&#41;](../report-data/query-design-tools-ssrs.md)。  
...
##  <a name="choose-spatial-data-and-map-view-options"></a><a name="MapView"></a> 選擇空間資料及地圖檢視選項  
 在此頁面上，您可以設定下列選項：  
...
###  <a name="what-is-map-resolution-and-optimization"></a><a name="Resolution"></a> 何謂地圖解析度和最佳化？  
...
###  <a name="what-does-embedding-spatial-data-do"></a><a name="Embed"></a> 內嵌的空間資料用途為何？  
...
###  <a name="what-is-a-bing-map-tile-background"></a><a name="Tiles"></a> 何謂 Bing 地圖底圖背景？  
...
###  <a name="what-is-the-difference-among-a-basic-map-a-bubble-map-and-an-analytical-map"></a><a name="MapType"></a> 基本地圖、泡泡地圖與分析地圖之間的差異為何？  
...
###  <a name="what-is-the-difference-between-spatial-data-and-analytical-data"></a><a name="Diff"></a> 空間資料和分析資料之間的差異為何？  
