---
title: 鑽研報表 (報表產生器) | Microsoft Docs
description: 探索鑽研報表，這是在選取報表中的連結，以取得報表產生器中原始摘要報表項目的詳細資料時，所開啟的報表。
ms.date: 03/07/2017
