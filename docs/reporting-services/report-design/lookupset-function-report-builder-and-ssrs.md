---
title: "LookupSet 函數 (報表產生器及 SSRS) | Microsoft Docs"
ms.custom: ""
ms.date: "12/09/2016"
...
-   傳回結果運算式值的集合。  
 ...
 若要從具有一對一關聯性之名稱/值組的資料集中，擷取指定名稱的單一值，請使用 [Lookup 函數 &#40;報表產生器及 SSRS&#41;](../../reporting-services/report-design/lookup-function-report-builder-and-ssrs.md)。 若要針對一組值呼叫 **Lookup**，請使用 [Multilookup 函數 &#40;報表產生器及 SSRS &#41;](../../reporting-services/report-design/multilookup-function-report-builder-and-ssrs.md)。  
