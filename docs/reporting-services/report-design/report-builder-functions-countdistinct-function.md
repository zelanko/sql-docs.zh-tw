---
title: CountDistinct 函式 (報表產生器) | Microsoft Docs
description: 在指定範圍內容中，取得由運算式指定所有相異非 Null 值的計數。
ms.date: 03/07/2017
...
ms.locfileid: "83689752"
---
# <a name="report-builder-functions---countdistinct-function"></a>報表產生器函式 - CountDistinct 函式
