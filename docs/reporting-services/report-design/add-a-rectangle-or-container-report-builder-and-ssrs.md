---
title: "加入矩形或容器 (報表產生器及 SSRS) | Microsoft Docs"
ms.custom: ""
ms.date: "03/01/2017"
...
2.  按一下 [框線] 按鈕旁的箭號，以便決定要變更矩形的哪一面。    
    ...
    > [!NOTE]    
    >  如果將線條樣式設定為 [雙線] 而線條的寬度為 1 1/2 pt 或更窄，當您在報表產生器、報表設計師或 [!INCLUDE[ssRSnoversion_md](../../includes/ssrsnoversion-md.md)] Web 入口網站中執行報表時，線條可能不會出現雙線。 當您將報表匯出為其他格式 (例如 Microsoft Word 和 Acrobat PDF) 時，會出現雙線。    
