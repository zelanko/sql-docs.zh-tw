---
title: Avg 函式 (報表產生器) | Microsoft Docs
description: 了解編頁報表中的 Avg 函數，其可傳回報表產生器中運算式所指定之所有非 Null 數值的平均值。
ms.date: 03/07/2017
...
## <a name="example"></a>範例  
 下列兩個程式碼範例提供名為 `Cost` 的資料集所包含的 `Inventory`欄位中所有值的平均值。  
