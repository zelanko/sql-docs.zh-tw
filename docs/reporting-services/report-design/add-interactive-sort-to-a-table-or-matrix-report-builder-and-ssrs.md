---
title: 將互動式排序新增至資料表或矩陣 (報表產生器) | Microsoft Docs
description: 讓使用者使用報表產生器中互動式排序按鈕來變更資料表與矩陣中資料列與資料行的排序次序。
ms.date: 03/01/2017
...
7.  針對您要加入互動式排序按鈕的每個資料行重複步驟 1-6。  
 ...
 ![搭配 [回到頁首] 連結使用的箭頭圖示](/analysis-services/analysis-services/instances/media/uparrow16x16.gif "與 [回到頁首] 連結搭配使用的箭頭圖示") [[回到頁首]](#BackToTop)  
