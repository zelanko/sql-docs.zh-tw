...
description: 系統屬性是報表伺服器資料庫的全域屬性。 您可以使用 Web 服務方法，來讀取或是修改大部分屬性。
ms.date: 03/06/2017
...
|EnableRemoteErrors|包含外部錯誤資訊 (例如，有關報表資料來源的錯誤資訊) 以及針對從遠端電腦要求報表之使用者傳回的錯誤訊息。 有效值為 **true** 和 **false**。 預設值為 **false**。 如需詳細資訊，請參閱[啟用遠端錯誤 &#40;Reporting Services&#41;](../../../reporting-services/report-server/enable-remote-errors-reporting-services.md)。|  
