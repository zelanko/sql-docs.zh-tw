---
title: SQL Server 2016 中 SQL Server Reporting Services 已被取代的功能 | Microsoft Docs
ms.custom: ''
ms.date: 07/02/2017
...
下一版的 SQL Server 將不支援下列 SQL Server Reporting Services 功能。 請勿在新的開發工作中使用這些功能，並且儘速修改使用這些功能的應用程式。
