---
title: SQL Server 2016 Reporting Services 中已淘汰的功能 | Microsoft Docs
ms.date: 07/02/2017
...
本文描述已淘汰的 SQL Server 2016 Reporting Services 功能。 在此版本中仍然提供已被取代的功能，不過，這些功能排程在 [!INCLUDE[ssNoVersion](../includes/ssnoversion-md.md)]之後版本中移除。 請勿在新的應用程式中使用已被取代的功能。
...
SQL Server 2014 Reporting Services 已被取代的功能
