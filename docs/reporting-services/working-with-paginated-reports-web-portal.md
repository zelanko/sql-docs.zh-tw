...
2.  選取 [編頁報表]。  
    ...
    ![顯示 [新增] 下拉式清單的螢幕擷取畫面，其中已標註 [編頁報表] 選項。](../reporting-services/media/ssrswebportal-new-report.png)  
...
1.  針對您要管理的資料庫選取 **省略符號 (...)** 。  
    ...
    ![顯示使用者選取資料集省略符號選項的螢幕擷取畫面。](../reporting-services/media/ssrswebportal-manage-report1.png)  
  
2.  選取 [管理] 會開啟編輯畫面。  
    
    ![顯示已選取省略符號選項並標註 [管理] 選項的螢幕擷取畫面。](../reporting-services/media/ssrswebportal-manage-report2.png)  
  
## <a name="properties"></a>屬性  
  
在 [屬性] 畫面上，您可以變更分頁報表的 [名稱] 和 [描述]。 您也可以 [刪除]、[移動]、[建立連結報表]、[在報表產生器中編輯]、[下載] 或 [取代]。  
    
![顯示 [Edit Company Sales] \(編輯公司銷售\) 對話方塊中 [屬性] 畫面的螢幕擷取畫面。](../reporting-services/media/ssrswebportal-report-properties.png)  
   
## <a name="parameters"></a>參數  
  
您可以修改分頁報表的現有參數。 若要加入新的參數，您必須在報表產生器或 SQL Server Data Tools 中編輯報表。  
  
![顯示 [Edit Company Sales] \(編輯公司銷售\) 對話方塊中 [參數] 畫面的螢幕擷取畫面。](../reporting-services/media/ssrswebportal-report-parameters.png)  
   
## <a name="data-source"></a>資料來源  
您可以指向共用資料來源，或輸入自訂資料來源的連接資訊。  
  
![顯示 [Edit Company Sales] \(編輯公司銷售\) 對話方塊中 [資料來源] 畫面的螢幕擷取畫面。](../reporting-services/media/ssrswebportal-report-datasource.png)  
...
![顯示 [Edit Company Sales] \(編輯公司銷售\) 對話方塊中 [訂用帳戶] 畫面的螢幕擷取畫面。](../reporting-services/media/ssrswebportal-report-subscription1.png)
...
![顯示 [Edit Company Sales] \(編輯公司銷售\) 對話方塊中 [快取] 畫面的螢幕擷取畫面，其中已選取 [永遠以最新的資料執行此報表] 選項。](../reporting-services/media/ssrswebportal-report-caching1.png)  
   
選取 [快取此報表的複本並在可用時加以使用] 會顯示更多選項。  
  
![顯示 [Edit Company Sales] \(編輯公司銷售\) 對話方塊中 [快取] 畫面的螢幕擷取畫面，其中已選取 [快取此報表的複本並在可用時加以使用] 選項。](../reporting-services/media/ssrswebportal-report-caching2.png)  
...
![[Edit Company Sales] \(編輯公司銷售\) 對話方塊的螢幕擷取畫面，其中顯示 [建立快取重新整理計劃] 選項。](../reporting-services/media/ssrswebportal-report-caching3.png)  
