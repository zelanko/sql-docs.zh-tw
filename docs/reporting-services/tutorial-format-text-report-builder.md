...
description: 了解如何在 Reporting Services 分頁報表中以各種方式格式化文字。 例如，您可實驗不同的格式。
ms.date: 05/30/2017
...
[設定報表項目格式](../reporting-services/report-design/formatting-report-items-report-builder-and-ssrs.md)  
