# [概觀](create-deploy-and-manage-mobile-and-paginated-reports.md)
## [新功能 Reporting Services](what-s-new-in-sql-server-reporting-services-ssrs.md) 
...
### [SQL Server Reporting Services SQL Server 2016 中已停止的功能](discontinued-functionality-to-sql-server-reporting-services-in-sql-server.md)  
### [SQL Server Reporting Services SQL Server 2016 中的重大變更](breaking-changes-in-sql-server-reporting-services-in-sql-server-2016.md)  
### [SQL Server Reporting Services SQL Server 2016 中的行為變更](behavior-changes-to-sql-server-reporting-services-in-sql-server-2016.md)  

# 規劃
## [選擇供分析及報告的 Microsoft 商業智慧 (BI) 工具](choosing-microsoft-business-intelligence-bi-tools-for-analysis-and-reporting.md)  
...
## [Reporting Services 的 SQL Server 2016 版本支援的功能](reporting-services-features-supported-by-the-editions-of-sql-server-2016.md)  

# [安裝](../reporting-services/install-windows/install-reporting-services.md)
  
# [Web 入口網站](web-portal-ssrs-native-mode.md)  
## [商標 web 入口網站](branding-the-web-portal.md)  
...
## [使用訂閱 （入口網站）](working-with-subscriptions-web-portal.md)  
## [使用 Reporting Services 中的 KPI](working-with-kpis-in-reporting-services.md)  
## [我的設定 Power BI 整合 （入口網站）](my-settings-for-power-bi-integration-web-portal.md)
...
## [資料警示管理員讓 SharePoint 使用者](data-alert-manager-for-sharepoint-users.md)  
...
## [編輯資料警示設計工具中警示](edit-a-data-alert-in-alert-designer.md)  
## [管理資料警示管理員 中的 SharePoint 網站上的所有資料警示](manage-all-data-alerts-on-a-sharepoint-site-in-data-alert-manager.md)  
## [管理我的資料警示管理員 中的資料警示](manage-my-data-alerts-in-data-alert-manager.md)  
## [授與權限給使用者和警示系統管理員](grant-permissions-to-users-and-alerting-administrators.md)

# [擴充功能](extensions-ssrs.md)  
...
## [存取報表伺服器項目使用 URL 存取](access-report-server-items-using-url-access.md)  
## [將報表參數，在 URL 內傳遞](pass-a-report-parameter-within-a-url.md)  
## [URL 存取參數參考](url-access-parameter-reference.md)  
## [在 URL 中的報表參數設定的語言](set-the-language-for-report-parameters-in-a-url.md)  
## [在 URL 中指定裝置資訊設定](specify-device-information-settings-in-a-url.md)  
## [匯出的報表是使用 URL 存取](export-a-report-using-url-access.md)  
## [使用 URL 存取報表中搜尋](search-a-report-using-url-access.md)  
## [轉譯報表記錄快照集使用 URL 存取](render-a-report-history-snapshot-using-url-access.md)  
...
## [報表伺服器 web 服務](../reporting-services/report-server-web-service/accessing-the-soap-api.md)
## [擴充功能](../reporting-services/extensions/reporting-services-extension-library.md)
...
## [建立使用 ReportViewer （SSRS 教學課程） 參數的鑽研 (RDLC) 報表](create-drillthrough-rdlc-report-with-parameters-reportviewer.md)  
...
### [第 3 課： 設計父報表使用報表精靈](lesson-3-design-the-parent-report-using-the-report-wizard.md)  
### [第 4 課： 定義子報表的資料連接和資料表](lesson-4-define-a-data-connection-and-data-table-for-child-report.md)  
### [第 5 課： 設計子報表使用報表精靈](lesson-5-design-the-child-report-using-the-report-wizard.md)  
### [第 6 課： 將 ReportViewer 控制項加入至應用程式](lesson-6-add-a-reportviewer-control-to-the-application.md)  
...
### [替代方法來取得資料連接 （報表產生器）](alternative-ways-to-get-a-data-connection-report-builder.md)  
