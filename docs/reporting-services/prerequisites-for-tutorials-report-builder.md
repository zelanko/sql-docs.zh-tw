...
-   針對[教學課程：地圖報表 (報表產生器)](tutorial-map-report-report-builder.md)，報表伺服器必須設定支援以 Bing 地圖服務作為背景。 如需詳細資訊，請參閱 [對應報表支援規劃](./report-design/plan-a-map-report-report-builder-and-ssrs.md)。   
