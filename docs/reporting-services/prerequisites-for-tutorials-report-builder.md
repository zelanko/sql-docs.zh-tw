...
-   針對[教學課程：地圖報表 (報表產生器)](tutorial-map-report-report-builder.md)，報表伺服器必須設定支援以 Bing 地圖服務作為背景。 如需詳細資訊，請參閱 [對應報表支援規劃](https://msdn.microsoft.com/5ddc97a7-7ee5-475d-bc49-3b814dce7e19)。   
