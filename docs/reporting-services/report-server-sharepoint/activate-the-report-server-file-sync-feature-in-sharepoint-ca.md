---
title: "啟動報表伺服器檔案同步處理功能，在 SharePoint 中的 |Microsoft 文件"
ms.custom: 
ms.date: 09/25/2017
...
---
# <a name="activate-the-report-server-file-sync-feature-in-sharepoint"></a>啟用 SharePoint 中的報表伺服器檔案同步處理功能
...
### <a name="to-activate-or-deactivate-the-reporting-services-file-sync-feature-on-a-site"></a>啟用或停用站台的 Reporting Services 檔案同步處理功能
...
## <a name="see-also"></a>另請參閱
 ...
 [疑難排解報表組件 （報表產生器及 SSRS）](http://msdn.microsoft.com/d9fe1932-46e7-421b-a8a9-4c54d9576e94)   
