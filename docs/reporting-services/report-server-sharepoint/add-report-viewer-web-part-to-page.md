---
title: "將報表檢視器 web 組件加入至 SharePoint 頁面 |Microsoft 文件"
...
# <a name="add-report-viewer-web-part-to-a-sharepoint-page"></a>將報表檢視器 web 組件加入至 SharePoint 網頁
...
1. 編輯 SharePoint 網頁時，選取右上角的 web 組件中的向下箭號，然後選取**編輯 Web 組件**。
...
* 在 web 組件最上方的連結會產生錯誤並不會不瀏覽您任何位置。
