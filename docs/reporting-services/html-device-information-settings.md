---
title: "HTML 裝置資訊設定 |Microsoft 文件"
ms.date: 03/16/2017
...
|**StreamRoot (\*)**|這個路徑會加在報表伺服器傳回的 HTML 報表中的 IMG 元素之 **src** 屬性值前面。 依預設，報表伺服器會提供路徑。 您可以使用此設定，根路徑指定影像在報表中 (例如， **http://\<伺服器名稱 >/資源/companyimages**)。|  
