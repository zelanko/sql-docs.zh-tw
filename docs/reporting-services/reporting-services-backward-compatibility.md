...
|[SQL Server 2016 中 SQL Server Reporting Services 的重大變更](http://msdn.microsoft.com/en-us/39c7aafd-dcb9-4317-b8f7-d15828eb4f9a)|描述當升級 [!INCLUDE[ssRSnoversion](../includes/ssrsnoversion-md.md)]時可能會遇到的問題。|  
|[SQL Server 2016 中 SQL Server Reporting Services 的行為變更](http://msdn.microsoft.com/en-us/2a767f0f-84f2-4099-8784-1e37790f858e)|描述 [!INCLUDE[ssRSnoversion](../includes/ssrsnoversion-md.md)]中已變更的功能。|  
