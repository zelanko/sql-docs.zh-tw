...
---
# rsInternalError - Reporting Services 錯誤
...
## 使用者動作  
 若要判斷這個訊息的明確原因，請檢閱位於 located at \Microsoft SQL Server\MSRS12.\<執行個體名稱>\Reporting Services\LogFiles 的報表伺服器記錄檔。 如需詳細資訊，請參閱 [Reporting Services 記錄檔和來源](../../reporting-services/report-server/reporting-services-log-files-and-sources.md)。  
