---
title: "為 Reporting Services 訂閱與傳遞疑難排解 | Microsoft Docs"
ms.custom: ""
ms.date: "05/31/2016"
...
---
# 為 Reporting Services 訂閱與傳遞疑難排解
...
其中 \<錯誤訊息> 會以協同作業資料物件 (CDO) 傳回的其他錯誤訊息資訊取代。  
  
### 若要解決這個問題：  
* 將 **Rsreportserver.config** 檔案中的 `SendUsing` 元素的值設為 1。  
