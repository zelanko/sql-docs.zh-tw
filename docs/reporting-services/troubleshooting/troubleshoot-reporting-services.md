...
---
# 針對 Reporting Services 進行疑難排解
  檢閱本節中的主題，以便識別及疑難排解 [!INCLUDE[ssRSnoversion](../../includes/ssrsnoversion-md.md)] 的問題。  
  
 ![![小型檔案資料夾圖示](../../analysis-services/media/filefolder-small.png "小型檔案資料夾圖示")](/Image/filefolder_small.png)   **疑難排解 Reporting Services 的問題**  
...
+  [疑難排解 Reporting Services 的報表設計問題](../../reporting-services/troubleshooting/troubleshoot-report-design-issues-with-reporting-services.md)  
...
+  [Reporting Services 報表轉譯問題疑難排解](../../reporting-services/troubleshooting/troubleshoot-reporting-services-report-rendering-issues.md)  
...
![![小型檔案資料夾圖示](../../analysis-services/media/filefolder-small.png "小型檔案資料夾圖示")](/Image/filefolder_small.png)   **錯誤和事件參考**  
