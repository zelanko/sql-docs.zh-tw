---
title: "疑難排解 Reporting Services 的報表設計問題 | Microsoft Docs"
ms.custom: ""
ms.date: "02/27/2016"
...
## 如何設計兩個資料表，或是一個圖表和一個資料表，讓它們並排顯示？  
...
### 轉譯規則會使用頁面大小、容器、對等物件、相對位置和空白來決定配置  
