---
title: "將參數加入行動報表中 | Reporting Services | Microsoft Docs"
ms.custom: ""
ms.date: "11/01/2016"
...
將參數加入行動報表之後，您可以建立 URL 以[使用查詢字串參數開啟報表](../../reporting-services/mobile-reports/open-a-mobile-report-with-specific-query-string-parameters.md)。
...
### 另請參閱  
-  [使用特定查詢字串參數開啟行動報表](../../reporting-services/mobile-reports/open-a-mobile-report-with-specific-query-string-parameters.md)
