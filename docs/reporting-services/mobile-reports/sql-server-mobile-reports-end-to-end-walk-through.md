...
2. 若要新增您自己的資料，按一下右上角的 [新增資料]，然後瀏覽至您的資料。    
...
3. 回到 [資料] 索引標籤上，在 [資料屬性]窗格中，變更 [數值表示方式]、[色彩表示方式]，以及您資料中欄位的其他屬性。 
...
3. 點選左上角的選項圖示 ![PBI_iPad_OptionsIcon](../../reporting-services/mobile-reports/media/pbi-ipad-optionsicon.png)，然後點選 [連線到伺服器]。  
