...
---
# 準備 Reporting Services 行動報表的 Excel 資料
...
>**注意**：[!INCLUDE[PRODUCT_NAME](../../includes/ss-mobilereptpub-short.md)] 不會自動重新整理 Excel 資料。 您可以透過 [!INCLUDE[PRODUCT_NAME](../../includes/ss-mobilereptpub-short.md)] 的 **refresh** 命令重新整理資料 (僅在檔案未經移動時)。  
