...
---
# 為手機或平板電腦配置 Reporting Services 行動報表
...
1. 在 [!INCLUDE[SS_MobileReptPub_Short](../../includes/ss-mobilereptpub-short.md)] 的右上角，選取配置圖示 > [手機] 或 [平板電腦]。  
  
   ![SSMRP_LayoutMenu](../../reporting-services/mobile-reports/media/ssmrp-layoutmenu.png)  
     
   手機配置方格隨即開啟。 所有視覺效果都在 [配置] 索引標籤上。  
