---
title: "在行動報表中加入量測計 | Reporting Services | Microsoft Docs"
ms.custom: ""
ms.date: "03/30/2017"
...
---
# 在行動報表中加入量測計 | Reporting Services
...
在 [!INCLUDE[PRODUCT_NAME](../../includes/product-name.md)] 中，所有量測計至少都有一個共通屬性︰主要值，在行動報表其中一份資料表中設為數值的欄位。  
