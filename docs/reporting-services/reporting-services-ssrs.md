...
helpviewer_keywords: 
  - "報表 [Reporting Services]"
  - "SSRS"
  - "報表 [Reporting Services], 關於報表"
  - "Reporting Services"
...
# Reporting Services (SSRS)
  在內部部署建立、部署和管理行動和分頁報表等工作，都可使用 SQL Server Reporting Services (SSRS) 提供齊全的現成工具與服務來完成。 
...
* 您可以在任何新式瀏覽器中檢視的**新式入口網站**。 在新的入口網站中，您可以組織和顯示行動和分頁報表，以及新的 KPI。 您也可以在入口網站上儲存 Excel 活頁簿和 Power BI Desktop 報表。 
...
* [Reporting Services 的新功能](../reporting-services/sql-server-reporting-services-ssrs-中的新功能.md)
...
原生模式 Reporting Services 使用者的首頁，就是您可以在任何新式瀏覽器中檢視的新式入口網站。 您可以在新的入口網站中存取所有行動和分頁報表，以及新的 KPI。 您可以標記 [我的最愛]，而且如果您具有相關角色，也可以管理內容。 
...
此入口網站仍提供傳統資料夾階層，因此您可以組織內容。 您可以依行動報表、KPI、分頁報表，加上 Power BI Desktop 報表、Excel 活頁簿、共用資料集和共用資料來源等類型來組織內容，以作為報表的建置組塊。 您可以用安全的方式進行儲存和管理。

您仍然可以在新的入口網站中，為報表處理進行排程、視需要存取報表，以及訂閱已發行的報表。

深入了解 [Reporting Services 入口網站](../reporting-services/web-portal-ssrs-native-mode.md)。
...
## <a name="includessrsnoversiontokenssrsnoversionmdmd-programming-features"></a>[!INCLUDE[ssRSnoversion](../includes/ssrsnoversion-md.md)] 程式設計功能  
...
## <a name="browse-content-by-area"></a>依區域瀏覽內容  
* [回溯相容性](../reporting-services/回溯相容性-reporting-services.md) 
...
* [SQL Server 行動報表發行工具](../reporting-services/mobile-reports/create-mobile-reports-with-sql-server-mobile-report-publisher.md)  
* [Reporting Services 中的 KPI](../reporting-services/working-with-kpis-in-reporting-services.md)
