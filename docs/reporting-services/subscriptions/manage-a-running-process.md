...
ms.topic: "article"
helpviewer_keywords: 
  - "報表處理 [Reporting Services], 狀態資訊"
  - "作業 [Reporting Services]"
  - "檢視作業"
  - "取消作業"
  - "使用者作業 [Reporting Services]"
  - "系統作業 [Reporting Services]"
  - "報表處理 [Reporting Services], 管理執行中的處理序"
  - "處理序 [Reporting Services]"
  - "掃描處理序 [Reporting Services]"
  - "狀態資訊 [Reporting Services]"
  - "報表處理 [Reporting Services]"
  - "取消訂閱"
  - "報表伺服器 [Reporting Services], 作業"
  - "資料驅動訂閱"
  - "顯示作業"
  - "訂閱 [Reporting Services], 執行中的處理序"
