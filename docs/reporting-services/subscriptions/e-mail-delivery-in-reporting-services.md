...
ms.topic: "article"
helpviewer_keywords: 
  - "訂閱 [Reporting Services], 電子郵件"
  - "電子郵件 [Reporting Services]"
  - "郵件 [Reporting Services]"
...
## 電子郵件伺服器組態  
 ...
 如需如何設定原生模式報表伺服器的資訊，請參閱[電子郵件設定 - Reporting Services 原生模式 (組態管理員)](https://msdn.microsoft.com/library/ms189342.aspx)
