...
ms.topic: "article"
helpviewer_keywords: 
  - "安全性 [Reporting Services], 報表"
  - "安全性 [Reporting Services], 資源"
  - "報表 [Reporting Services], 安全性"
  - "機密報表 [Reporting Services]"
  - "資源 [Reporting Services], 安全性"
...
3.  攻擊者會建立與網頁或報表伺服器的連結，指定「javascript:\<這裡的惡意指令碼>」形式的參數值，並傳送該連結給引誘攻擊的某個人。  
  
## 減少已發行之報表或文件中的超連結內指令碼資料隱碼攻擊  
