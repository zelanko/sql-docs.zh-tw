...
ms.topic: "article"
helpviewer_keywords: 
  - "使用者 [Reporting Services]"
  - "角色 [Reporting Services]"
  - "以角色為基礎的安全性 [Reporting Services], 角色指派"
  - "群組 [Reporting Services]"
...
## 預先定義的角色指派  
 ...
 如需提供預設安全性之預先定義角色指派的詳細資訊，請參閱[預先定義的角色](../../reporting-services/security/predefined-roles.md)。  
