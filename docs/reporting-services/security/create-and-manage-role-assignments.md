---
title: "建立和管理角色指派 | Microsoft Docs"
ms.custom: ""
ms.date: "03/01/2017"
...
## 建立系統層級角色指派  
 ...
 如需詳細資訊，請參閱[將報表伺服器的存取權授與使用者 &#40;報表管理員&#41;](../../reporting-services/security/grant-user-access-to-a-report-server-report-manager.md) 和[預先定義的角色](../../reporting-services/security/predefined-roles.md)。  
