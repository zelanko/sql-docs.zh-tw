---
title: "使用 URL 存取整合 Reporting Services |Microsoft 文件"
ms.custom: 
ms.date: 03/14/2017
...
## <a name="in-this-section"></a>本節內容  
 [Web 應用程式中使用 URL 存取](../../reporting-services/application-integration/integrating-reporting-services-using-url-access-web-application.md)  
