---
title: 使用報表檢視器控制項整合 Reporting Services | Microsoft Docs
ms.date: 09/18/2018
...
ms.locfileid: "62741871"
---
# <a name="integrating-reporting-services-using-report-viewer-controls"></a>使用報表檢視器控制項整合 Reporting Services
