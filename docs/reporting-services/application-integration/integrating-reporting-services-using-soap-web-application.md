---
title: 在 Web 應用程式-Reporting Services 中使用 SOAP API |Microsoft Docs
ms.date: 06/26/2019
...
::: moniker range=">=sql-server-2017||=sqlallproducts-allversions"
 ...
 您也可以使用 Web 應用程式來管理報表伺服器及其內容。 Web 入口網站中，隨附於[!INCLUDE[ssRSnoversion](../../includes/ssrsnoversion-md.md)]，是管理大部分的工作，您通常會執行使用 Reporting Services 的 Web 應用程式的範例。 您可以將入口網站的報表管理功能新增到自訂 Web 應用程式。 例如，您可能會想要傳回報表伺服器資料庫中可用報表的清單，並將它們顯示在 [!INCLUDE[vstecasp](../../includes/vstecasp-md.md)] **Listbox** 控制項中，以供您的使用者選擇。 下列程式碼會連接報表伺服器資料庫，並在報表伺服器資料庫中傳回項目的清單。 接著會將可用的報表加入 Listbox 控制項，如此會顯示每個報表的路徑。  
