...
description: 了解在您為子報表建立資料連線與資料表之後，如何使用報表設計師中的報表精靈設計子報表。
ms.date: 05/18/2016
...
您已使用 [報表精靈] 成功設計子報表。 接下來您要將 ReportViewer 控制項加入至網站應用程式。 請參閱[第 6 課：將 ReportViewer 控制項新增至應用程式](../reporting-services/lesson-6-add-a-reportviewer-control-to-the-application.md)。  
