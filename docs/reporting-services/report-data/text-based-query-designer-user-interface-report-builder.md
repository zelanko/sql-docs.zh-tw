---
title: "以文字為基礎的查詢設計工具使用者介面 (報表產生器) | Microsoft Docs"
ms.custom: ""
ms.date: "03/14/2017"
...
|![執行查詢](../../reporting-services/report-data/media/rsqdicon-run.png "執行查詢")|執行查詢，並將結果集顯示在 [結果] 窗格中。|  
...
### StoredProcedure 命令類型  
 ...
 ![以文字為基礎的查詢設計工具中的預存程序](../../reporting-services/report-data/media/rs-relational-text-sp.gif "以文字為基礎的查詢設計工具中的預存程序")  
