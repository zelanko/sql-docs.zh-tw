---
title: "在 Analysis Services 的 MDX 查詢設計工具中定義參數 (報表產生器及 SSRS) | Microsoft Docs"
ms.custom: ""
ms.date: "03/14/2017"
...
ms.topic: "article"
helpviewer_keywords: 
  - "參數 [Reporting Services], MDX"
  - "多維度運算式 [Reporting Services]"
  - "資料採礦預測 [Reporting Services]"
  - "MDX [Reporting Services], 定義參數"
...
8.  [!INCLUDE[clickOK](../../includes/clickok-md.md)]  
     ...
     若要檢視可為報表參數提供可用值的資料集，請以滑鼠右鍵按一下 [報表資料] 窗格中的空白區域，然後按一下 [顯示隱藏的資料集]。 [報表資料] 窗格會顯示報表中的所有資料集。  
...
3.  在 MDX 查詢設計工具工具列上，按一下 [查詢參數] \(![[查詢參數] 對話方塊圖示](../../reporting-services/report-data/media/iconqueryparameter.png "[查詢參數] 對話方塊圖示"))。 [查詢參數] 對話方塊隨即開啟。  
  
4.  在 [參數] 資料行中，按一下 [\<輸入參數>]，然後輸入參數名稱。  
