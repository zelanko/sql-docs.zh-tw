---
title: "Power Pivot 連接類型 (SSRS) |Microsoft 文件"
ms.custom: 
ms.date: 03/01/2017
...
## <a name="connection-string"></a>連接字串  
 連接字串是 URL[!INCLUDE[ssGemini](../../includes/ssgemini-md.md)]活頁簿發行至 SharePoint 中[!INCLUDE[ssGemini](../../includes/ssgemini-md.md)]圖庫或其他程式庫，例如`http://contoso-srv/subsite/PowerPivotLibrary/ContosoSales.xlsx`。  
