...
## <a name="queries"></a>查詢  
 ...
 查詢設計工具會分析該查詢來決定資料集的欄位。 您可以手動編輯資料集欄位集合**報表資料**窗格。 如需詳細資訊，請參閱[加入、編輯、重新整理報表資料窗格中的欄位 &#40;報表產生器及 SSRS&#41;](../../reporting-services/report-data/add-edit-refresh-fields-in-the-report-data-pane-report-builder-and-ssrs.md)。  
  
## <a name="filters"></a>篩選  
 在 [篩選] 窗格中，請指定要從查詢結果中篩選出或包含在查詢結果中的維度和成員。  
  
## <a name="parameters"></a>參數  
 在 [篩選] 窗格中，選取**參數**篩選器，以自動建立報表參數對應至篩選選取範圍的可用值的選項。  
