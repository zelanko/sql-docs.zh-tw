---
title: "搭配報表使用 Office 資料連線 (.odc) (SharePoint 整合模式的 Reporting Services) | Microsoft Docs"
ms.custom: ""
ms.date: "03/14/2017"
...
helpviewer_keywords: 
  - "Office 資料連線 (.odc) 檔"
  - "SharePoint 整合 [Reporting Services], 共用資料來源"
  - ".odc 檔"
...
manager: "erikre"
---
# 搭配報表使用 Office 資料連線 (.odc) (SharePoint 整合模式的 Reporting Services)
...
-   您必須在 [!INCLUDE[msCoName](../../includes/msconame-md.md)] Office 2007 (舊版 .odc 與報表定義檔不相容) 中建立此 .odc 檔案。  
 ...
 現有的 .odc 檔案必須與報表與查詢完全相容，您才能使用該檔案。 如果發生需要大幅修改報表或 .odc 檔案的錯誤，則應為報表建立新的 .rsds 檔案。 如需如何建立使用 .rsds 檔案之共用資料來源的詳細資訊，請參閱[建立和管理共用資料來源 &#40;SharePoint 整合模式的 Reporting Services&#41;](../Topic/Create%20and%20Manage%20Shared%20Data%20Sources%20\(Reporting%20Services%20in%20SharePoint%20Integrated%20Mode\).md)。  
