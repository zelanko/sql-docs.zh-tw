...
description: 了解圖形化查詢設計工具使用者介面，以供在報表設計師中，從關聯式資料庫中擷取報表資料集的資料。
ms.date: 03/14/2017
