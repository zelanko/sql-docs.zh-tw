...
1.  在原生模式報表管理員中，瀏覽至包含報表的資料夾。 按一下項目操作功能表 ![報表管理員中適用於 SSRS 項目的操作功能表](../../reporting-services/report-data/media/ssrs-report-manager-item-context-menu.png "報表管理員中適用於 SSRS 項目的操作功能表")。  
...
2.  按一下操作功能表 ![報表管理員中適用於 SSRS 項目的操作功能表](../../reporting-services/report-data/media/ssrs-report-manager-item-context-menu.png "報表管理員中適用於 SSRS 項目的操作功能表")，然後按一下 [管理]。  
