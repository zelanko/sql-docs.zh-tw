...
# [在 Analysis Services 的 MDX 查詢設計工具中定義參數](define parameters in the mdx query designer for analysis services.md)
...
# [為自訂資料處理延伸模組指定連接](specify-connections-for-custom-data-processing-extensions.md)
