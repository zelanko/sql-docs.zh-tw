...
|**Value**|元素的值。 **Value** 只能用於元素路徑中的最後一個 **ElementNode** 上。 例如，因為 \<Return> 是一個分葉節點，如果將它加入元素路徑的結尾，**Return {@}** 的值會是 **Chair**。|  
|**元素**|具名子元素的值。 例如，Customers {}/Customer {}/LastName 只會擷取 LastName 元素的值。|  
