...
## 下者中的資料： [!INCLUDE[ssRBnoversion](../../includes/ssrbnoversion-md.md)]  
...
|本機伺服器上的 SQL Server 資料庫|`data source="(local)";initial catalog=AdventureWorks`|將資料來源類型設為 **Microsoft SQL Server**。|  
...
|[!INCLUDE[ssSDS](../../includes/sssds-md.md)] 位於雲端中|`Data Source=<host>;Initial Catalog=AdventureWorks; Encrypt=True`|將資料來源類型設為 **Windows Azure SQL Database**。 如需詳細資訊，請參閱 [SQL Azure 連接類型 &#40;SSRS&#41;](../../reporting-services/report-data/sql-azure-connection-type-ssrs.md)。|  
