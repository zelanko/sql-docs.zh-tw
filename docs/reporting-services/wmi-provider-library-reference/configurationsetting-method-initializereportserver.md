---
title: "InitializeReportServer 方法 (WMI MSReportServer_ConfigurationSetting) |Microsoft 文件"
ms.custom: 
ms.date: 03/01/2017
...
---
# <a name="configurationsetting-method---initializereportserver"></a>InitializeReportServer ConfigurationSetting 方法
  初始化指定的報表服務執行個體。  
