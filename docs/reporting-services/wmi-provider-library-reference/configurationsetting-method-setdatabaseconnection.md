---
title: "SetDatabaseConnection 方法 (WMI MSReportServer_ConfigurationSetting) |Microsoft 文件"
ms.custom: 
ms.date: 03/14/2017
...
---
# <a name="configurationsetting-method---setdatabaseconnection"></a>SetDatabaseConnection ConfigurationSetting 方法
