...
## 備註  
 *UrlString* 不包含虛擬目錄名稱。 [SetVirtualDirectory](../../reporting-services/wmi-provider-library-reference/setvirtualdirectory-method-wmi-msreportserver-configurationsetting.md) 方法是針對該目的提供的。  
