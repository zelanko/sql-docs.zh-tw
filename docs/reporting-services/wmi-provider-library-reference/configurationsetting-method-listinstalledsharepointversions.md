---
title: "ListInstalledSharePointVersions 方法 (WMI) |Microsoft 文件"
ms.custom: 
ms.date: 03/01/2017
...
---
# <a name="configurationsetting-method---listinstalledsharepointversions"></a>ListInstalledSharePointVersions ConfigurationSetting 方法
