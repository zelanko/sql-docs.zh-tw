---
title: "SetEmailConfiguration 方法 (WMI MSReportServer_ConfigurationSetting) |Microsoft 文件"
ms.custom: 
ms.date: 03/01/2017
...
---
# <a name="configurationsetting-method---setemailconfiguration"></a>SetEmailConfiguration ConfigurationSetting 方法
