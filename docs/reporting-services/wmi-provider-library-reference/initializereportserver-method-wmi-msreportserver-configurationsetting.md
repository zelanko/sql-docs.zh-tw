...
## 備註  
 ...
 如果呼叫 InitializeReportServer 方法時，報表伺服器的 [IsInitialized](../../reporting-services/wmi-provider-library-reference/isinitialized-property-wmi-msreportserver-configurationsetting.md) 屬性設定為 **true**，此方法就會傳回成功但不會嘗試加密加密金鑰。  
