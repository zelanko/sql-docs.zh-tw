---
title: "InstanceName 屬性 (WMI MSReportServer_Instance) |Microsoft 文件"
ms.custom: 
ms.date: 03/01/2017
...
---
# <a name="msreportserverinstance-properties---instancename"></a>MSReportServer_Instance 屬性-執行個體名稱
