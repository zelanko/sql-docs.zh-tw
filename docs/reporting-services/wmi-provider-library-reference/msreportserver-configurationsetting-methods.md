---
title: "MSReportServer_ConfigurationSetting 方法 |Microsoft 文件"
ms.custom: 
ms.date: 03/20/2017
...
|[SetDatabaseQueryTimeout](../../reporting-services/wmi-provider-library-reference/configurationsetting-method-setdatabasequerytimeout.md)|指定報表伺服器資料庫查詢的預設逾時值。|  
...
|[SetServiceState](../../reporting-services/wmi-provider-library-reference/configurationsetting-method-setservicestate.md)|開啟和關閉報表伺服器服務。|  
