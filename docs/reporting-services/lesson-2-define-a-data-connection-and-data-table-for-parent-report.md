...
description: 了解如何在使用 Visual C# 的 ASP.NET 網站範本建立新的網站專案後，為父報表建立資料連線以及資料表。
ms.date: 05/18/2016
...
您已成功建立父報表的資料連接和資料表。 接下來您將使用 [報表精靈] 設計父報表。 請參閱[第 3 課：使用 [報表精靈] 來設計父報表](../reporting-services/lesson-3-design-the-parent-report-using-the-report-wizard.md)。  
