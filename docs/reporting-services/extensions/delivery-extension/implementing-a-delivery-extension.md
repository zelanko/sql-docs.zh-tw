---
title: "Implementing a Delivery Extension |Microsoft 文件"
ms.custom: 
ms.date: 03/16/2017
...
# <a name="implementing-a-delivery-extension"></a>實作傳遞延伸模組
 ...
 傳遞延伸模組的範例實作，請參閱[SQL Server Reporting Services 產品範例](http://go.microsoft.com/fwlink/?LinkId=177889)。  
...
## <a name="in-this-section"></a>本節內容  
 ...
 [通知類別使用傳遞延伸模組](../../../reporting-services/extensions/delivery-extension/using-a-notification-class-for-a-delivery-extension.md)  
 描述的屬性**通知**類別，以及如何在您的傳遞延伸模組實作中使用它。  
  
 [使用傳遞延伸模組的設定類別](../../../reporting-services/extensions/delivery-extension/using-the-setting-class-for-a-delivery-extension.md)  
 描述的屬性**設定**類別，以及如何在您的傳遞延伸模組實作中使用它。  
 ...
 描述的屬性**RenderedOutputFile**類別，以及如何在您的傳遞延伸模組實作中使用它。  
 ...
 [偵錯傳遞延伸模組程式碼](../../../reporting-services/extensions/delivery-extension/debugging-delivery-extension-code.md)  
 描述如何偵錯您的傳遞延伸模組中的程式碼。  
