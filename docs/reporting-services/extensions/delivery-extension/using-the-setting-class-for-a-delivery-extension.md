---
title: "使用傳遞延伸模組的設定類別 |Microsoft 文件"
ms.custom: 
ms.date: 03/06/2017
...
# <a name="using-the-setting-class-for-a-delivery-extension"></a>使用傳遞延伸模組的設定類別
 ...
 如需如何使用的範例<xref:Microsoft.ReportingServices.Interfaces.Setting>類別，請參閱[SQL Server Reporting Services 產品範例](http://go.microsoft.com/fwlink/?LinkId=177889)。  
