...
![顯示使用者將報表項目釘選到儀表板會發生什麼情況的圖表。](../../reporting-services/install-windows/media/ssrs-pin-to-powerbi-flow.png)
...
![顯示訂用帳戶引發重新整理儀表板磚時會發生什麼狀況的圖表。](../../reporting-services/install-windows/media/ssrs-subscription-to-powerbi-flow.png)
