---
title: 適用於 SharePoint 的 SSRS 增益集所在位置 | Microsoft Docs
description: 適用於 SharePoint 產品和技術的 SQL Server Reporting Services 增益集 (rssharepoint.msi) 是能夠整合報表伺服器與 SharePoint 部署的 Web 下載功能。
ms.date: 12/04/2019
...
適用於 SharePoint 產品和技術的 [!INCLUDE[msCoName](../../includes/msconame-md.md)] [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] [!INCLUDE[ssRSnoversion](../../includes/ssrsnoversion-md.md)] (SSRS) 增益集 (rssharepoint.msi) 是能夠整合報表伺服器與 SharePoint 部署的 Web 下載功能。  
