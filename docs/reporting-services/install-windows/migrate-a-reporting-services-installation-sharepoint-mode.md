---
description: 移轉 Reporting Services 安裝 (SharePoint 模式)
...
##  <a name="migrate-from-a-sql-server-2012-or-sql-server-2014-deployment"></a><a name="bkmk_migrate_from_ctp"></a> 從 SQL Server 2012 或 SQL Server 2014 部署移轉  
