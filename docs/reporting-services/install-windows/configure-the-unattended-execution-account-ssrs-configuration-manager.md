---
title: "設定自動執行帳戶 (SSRS 組態管理員) | Microsoft Docs"
ms.custom: ""
ms.date: "05/31/2016"
...
helpviewer_keywords: 
  ...
  - "安全性 [Reporting Services], 自動報表處理"
  - "自動報表處理 [Reporting Services]"
  - "認證 [Reporting Services]"
  - "外部資料來源 [Reporting Services]"
  - "帳戶 [Reporting Services]"
  - "報表 [Reporting Services], 處理"
...
## 另請參閱  
 [Reporting Services 組態管理員 (SSRS 原生模式)](http://msdn.microsoft.com/zh-tw/379eab68-7f13-4997-8d64-38810240756e)  
