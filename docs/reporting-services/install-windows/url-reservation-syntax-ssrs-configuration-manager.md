---
description: URL 保留項目語法 (報表伺服器組態管理員)
...
ms.locfileid: "91934135"
---
# <a name="url-reservation-syntax--report-server-configuration-manager"></a>URL 保留項目語法 (報表伺服器組態管理員)
