---
title: "加入其他 Reporting Services Web 前端伺服器陣列 |Microsoft 文件"
ms.custom: 
ms.date: 05/30/2017
...
-   (4) 代表軟體或硬體網路負載平衡解決方案 (NLB)。  
 ...
 ![將 SSRS 加入至新的 SharePoint WFE](../../reporting-services/install-windows/media/rs-sharepointscale-wfe.gif "將 SSRS 加入至新的 SharePoint WFE")  
