...
description: 在報表產生器中，您可將報表發佈至報表伺服器。 其他人則可以進行檢視。 每當執行已發佈的報表時，就會看到最新的資料。
ms.date: 03/01/2017
...
1.  在報表產生器的按鈕中，按一下 **[儲存]** 。 [另存新檔] _\<Report Item>_ 對話方塊隨即開啟。  
...
1.  在 [報表產生器] 按鈕中，按一下 **[另存新檔]** 。 [另存新檔] _\<Report Item>_ 對話方塊隨即開啟。  
...
## <a name="see-also"></a>另請參閱  
 ...
 [將報表匯出為其他檔案類型 &#40;報表產生器及 SSRS &#41;](/previous-versions/sql/)  
