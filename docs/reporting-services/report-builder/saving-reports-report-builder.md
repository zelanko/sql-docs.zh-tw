...
description: 在報表產生器中，您可儲存報表的定義，其中包括版面配置，但不包含資料。 每次執行報表時，都會重新整理資料。
ms.date: 03/01/2017
...
##  <a name="saving-reports-to-a-report-server"></a><a name="SavingReportDefinitions"></a> 將報表儲存到報表伺服器  
