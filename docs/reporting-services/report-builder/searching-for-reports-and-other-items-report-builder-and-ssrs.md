...
-   若要在報表管理員中搜尋項目，請在頁首的 [搜尋] 文字方塊中輸入搜尋字串。 搜尋會由資料夾階層的最上層節點開始，然後沿著每一個分支繼續搜尋。 如果您沒有存取特定分支的權限，則會略過該分支。 這適用於其他使用者專屬的 [我的報表] 資料夾，以及通常無法使用的其他資料夾。 只有您有權檢視的報表和項目，才會包含在搜尋結果中。  
...
## <a name="see-also"></a>請參閱＜  
 [尋找及檢視報表在報表管理員 &#40;報表產生器及 SSRS &#41;](https://msdn.microsoft.com/library/dd255286.aspx)   
