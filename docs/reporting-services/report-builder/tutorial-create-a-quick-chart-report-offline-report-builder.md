...
##  <a name="WhatsNext"></a> 下一步  
 ...
 開始之前，閱讀一些概念和詞彙的相關資訊可能會有所協助。 請參閱 [Reporting Services 概念 (SSRS)](../reporting-services-concepts-ssrs.md)。 此外，在您建立第一份報表之前，請花點時間規劃一下。 這是值得花費的時間。 請參閱[規劃報表 &#40;報表產生器&#41;](../../reporting-services/report-design/planning-a-report-report-builder.md)。  
