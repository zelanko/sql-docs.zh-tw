---
title: 隱藏項目 (報表產生器) | Microsoft Docs
description: 在報表產生器中，您可設定報表項目的可見度。 您可指定報表參數或其他運算式來有條件地隱藏項目。
ms.date: 03/01/2017
...
3.  在 **[一開始執行報表時]** 中，指定當您一開始檢視報表時，是否要隱藏此項目：  
    ...
    -   若要指定在執行階段評估的運算式，請按一下 [依據運算式顯示或隱藏]  。 鍵入運算式或按一下運算式 (**fx**) 按鈕，在 [運算式]  對話方塊中建立運算式。  
        ...
        > ![Properties_Visibility 對話方塊與隱藏的屬性](../../reporting-services/report-builder/media/hiddenproperty-propertiesvisibility.png "Properties_Visibility 對話方塊與隱藏的屬性")  
