---
title: "設定 URL 中報表參數的語言 | Microsoft Docs"
ms.custom: ""
ms.date: "03/01/2017"
...
helpviewer_keywords: 
  - "覆寫報表語言設定"
  - "報表伺服器 [Reporting Services], 語言設定"
  - "語言 [Reporting Services]"
  - "URL 存取 [Reporting Services], 語言覆寫"
  - "國際化考量 [Reporting Services]"
  - "全球化考量 [Reporting Services]"
