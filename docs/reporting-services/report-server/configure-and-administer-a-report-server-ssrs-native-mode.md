...
ms.topic: "article"
helpviewer_keywords: 
  - "Reporting Services, 元件"
  - "部署 [Reporting Services], 元件選項"
  - "報表伺服器 [Reporting Services], 元件選項"
  - "組態選項 [Reporting Services]"
  - "administering Reporting Services"
  - "元件 [Reporting Services], 設定"
...
-   使用 [!INCLUDE[ssManStudio](../../includes/ssmanstudio-md.md)] 來自訂伺服器屬性、啟用 [我的報表]、啟用追蹤記錄及設定網站範圍的預設值。 如需網站設定的詳細資訊，請參閱 Management Studio 的 [Reporting Services Report Server &#40;Native Mode&#41;](../../reporting-services/report-server/reporting-services-report-server-native-mode.md)。 請注意，您可以建立並執行以程式設計方式設定伺服器屬性的指令碼。 如需詳細資訊，請參閱[編寫部署和管理工作的指令碼](../../reporting-services/tools/script-deployment-and-administrative-tasks.md)和[報表伺服器系統屬性](../Topic/Report%20Server%20System%20Properties.md)。  
