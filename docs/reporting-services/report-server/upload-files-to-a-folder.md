...
description: 了解當從檔案系統上傳不同的檔案類型，並將其當成受控項目儲存在 Reporting Services 報表伺服器資料庫時，會發生什麼事。
ms.date: 06/17/2019
...
## <a name="see-also"></a>另請參閱  
 ...
 [在報表伺服器中上傳檔案或報表](../../reporting-services/reports/upload-a-file-or-report-report-manager.md)   
