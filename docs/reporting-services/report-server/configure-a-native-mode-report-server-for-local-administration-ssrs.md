...
##  <a name="bkmk_configure_ssdt"></a> 若要設定 SQL Server Data Tools (SSDT) 來發行至本機報表伺服器  
...
1.  在 [開始] 畫面中，輸入 **sql server**，然後以滑鼠右鍵按一下 [SQL Server Data Tools]。 按一下 **[以系統管理員身分執行]**。  
