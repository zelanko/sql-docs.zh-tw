...
##  <a name="bkmk_configure_local_server"></a> 設定本機報表伺服器和入口網站的管理  
...
###  <a name="bkmk_configure_folder_settings"></a> 入口網站資料夾設定  
...
###  <a name="bkmk_configure_site_settings"></a> 入口網站網站設定  
...
##  <a name="bkmk_configure_ssms"></a> 設定 SQL Server Management Studio (SSMS) 來進行本機報表伺服器管理  
...
##  <a name="bkmk_configure_ssdt"></a> 設定 SQL Server Data Tools (SSDT) 來發行至本機報表伺服器  
