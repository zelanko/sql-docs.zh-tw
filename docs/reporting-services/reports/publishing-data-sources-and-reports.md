...
## <a name="in-this-section"></a>本節內容  
 ...
 [在 SharePoint 模式 &#40; 在報表伺服器上的已發行的報表項目的 URL 範例SSRS &#41;](../../reporting-services/tools/url-examples-for-items-on-a-report-server-sharepoint-mode.md)  
