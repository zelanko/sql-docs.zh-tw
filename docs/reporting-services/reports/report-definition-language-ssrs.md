...
helpviewer_keywords: 
  ...
  - "RDL [Reporting Services], 關於報表定義語言"
  - "SSRS"
  - "報表定義語言, 關於報表定義語言"
  - "報表定義語言"
  - "RDL [Reporting Services]"
  - "報表 [Reporting Services], 定義"
...
##  <a name="bkmk_RDL_XML_Schema_Definition"></a> RDL XML 結構描述定義  
 ...
 RDL XSD 是在 ReportDefinition.xsd 檔案中提供的，這個檔案位於產品 CD-ROM 的 Extras 資料夾中， 同時可透過下列 URL 在報表伺服器上取用：http://servername/reportserver/reportdefinition.xsd。  
...
|**布林**|具有 **true** 或 **false** 物件值的屬性。 除非另有指定，否則省略的選擇性布林物件值為 **False**。|  
