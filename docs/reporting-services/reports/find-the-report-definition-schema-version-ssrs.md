...
ms.topic: "article"
helpviewer_keywords: 
  - "XML 結構描述 [Reporting Services]"
  - "報表定義語言, XML 結構描述"
  - "結構描述 [Reporting Services]"
...
1.  開啟新的專案。 您所選擇的專案版本會決定 RDL 結構描述的版本。 [!INCLUDE[ssCurrent](../../includes/sscurrent-md.md)] 中支援多個結構描述版本。 如需詳細資訊，請參閱 [SQL Server Data Tools 中的部署和版本支援 &#40;SSRS&#41;](../../reporting-services/tools/deployment-and-version-support-in-sql-server-data-tools-ssrs.md)。  
