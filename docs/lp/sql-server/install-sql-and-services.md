                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>安裝 SQL Server</h3>
                                                    <p>提供可以用於安裝 SQL Server 之不同安裝選項的概觀。</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>安裝 SQL Server Analysis Services (SSAS)</h3>
                                                    <p>可針對商務報表和用戶端應用程式 (例如 Power BI、Excel、Reporting Services 與其他資料視覺效果報表) 提供企業級語意資料模型的分析資料引擎。 </p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>安裝 SQL Server Integration Services (SSIS)</h3>
                                                    <p> 使用 Integration Services 透過下列方式來解決複雜的商務問題：複製或下載檔案、載入資料倉儲、清理和採礦資料，以及管理 SQL Server 物件與資料。 </p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>安裝 SQL Server Reporting Services (SSRS)</h3>
                                                    <p>用來建立、發行和管理報表，然後以不同的方式將報表提供給正確使用者的解決方案，而不論使用者是在其行動裝置上的網頁瀏覽器中檢視報表，還是將報表當做 [收件匣] 中的電子郵件進行檢視。 </p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>升級 SQL Server Analysis Services (SSAS)</h3>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>升級 SQL Server Integration Services (SSIS)</h3>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>升級 SQL Server Reporting Services (SSRS)</h3>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
