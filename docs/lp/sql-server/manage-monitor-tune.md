                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>資料庫生命週期管理</h3>
                                                    <p>一套針對資料庫應用程式管理資料庫結構描述、資料與中繼資料的全面方法</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>資料壓縮</h3>
                                                    <p>可協助您壓縮資料以節省磁碟空間的 SQL Server 功能。 </p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Database Mail</h3>
                                                    <p>從 SQL Server 資料庫引擎寄送電子郵件訊息的企業解決方案。 </p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    ...
                                                    <p>可執行已排程之管理工作的 SQL Server 功能。 </p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>SQLDiag</h3>
                                                    <p>收集來自 SQL Server 之記錄與資料的一般用途公用程式。 </p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>SQL Profiler</h3>
                                                    <p>建立、管理、分析並取代 SQL Server 活動所留下的追蹤。 </p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>自動調整</h3>
                                                    <p>SQL 2017 的新功能，可自動偵測潛在的效能問題。 </p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>計畫指南</h3>
                                                    <p>SQL Server 的功能，允許手動輸入執行計畫以進行特定查詢。</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>資源管理員</h3>
                                                    <p>指定應用程式要求可以使用的 CPU、IO 與記憶體數量限制。 </p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
