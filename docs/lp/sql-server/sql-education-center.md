                            ...
                            <div class="cardSize">
                                <div class="cardPadding">
                                    <div class="card">
                                        ...
                                        <div class="cardText">
                                            <p>搭配使用 Microsoft Azure Blob 儲存體服務和 SQL Server 2016 資料庫</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="cardSize">
                                <div class="cardPadding">
                                    <div class="card">
                                        ...
                                        <div class="cardText">
                                            <h3>準刪除記錄清除程序</h3>
                                            <p>提供背景程序的概觀，此程序會將已標示為要刪除的記錄從頁面刪除。</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="cardSize">
                                <div class="cardPadding">
                                    <div class="card">
                                        ...
                                        <div class="cardText">
                                            <h3>索引架構和設計</h3>
                                            <p>包含索引架構的資訊與最佳做法，可協助您設計有效的索引。</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="cardSize">
                                <div class="cardPadding">
                                    <div class="card">
                                        ...
                                        <div class="cardText">
                                            <h3>記憶體管理架構</h3>
                                            <p>說明 SQL Server 如何管理記憶體，以及讀取和寫入分頁時的記憶體使用量。</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="cardSize">
                                <div class="cardPadding">
                                    <div class="card">
                                        ...
                                        <div class="cardText">
                                            <h3>分頁與範圍架構</h3>
                                            <p>說明所有 SQL Server 版本中用於管理分頁與範圍的資料結構。</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="cardSize">
                                <div class="cardPadding">
                                    <div class="card">
                                        ...
                                        <div class="cardText">
                                            <h3>查詢處理架構</h3>
                                            <p>涵蓋 SQL Server 如何處理查詢，以及透過執行計畫快取來將查詢重複使用最佳化。</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="cardSize">
                                <div class="cardPadding">
                                    <div class="card">
                                        ...
                                        <div class="cardText">
                                            <h3>執行緒和工作架構</h3>
                                            <p>說明 SQL 如何操縱執行緒與工作，這有助於要求應用程式邏輯與執行路徑。 </p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="cardSize">
                                <div class="cardPadding">
                                    <div class="card">
                                        ...
                                        <div class="cardText">
                                            <h3>交易鎖定與資料列版本設定</h3>
                                            <p>描述 SQL Server 資料庫引擎用以確保每個交易實體完整性的鎖定與資料列版本設定機制。</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
...
<div class="container centered pageFooter">
        ...
        <ul class="links">
           <li>
                <a href="https://aka.ms/editsqldocs" data-linktype="external">參與編輯 SQL 文件</a>
            </li>
           <li>
                <a href="https://aka.ms/sqldocsurvey" data-linktype="external">SQL 文件意見反應</a>
            </li>
           <li>
