                                        ...
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    ...
                                                    <p>此教學課程將為您介紹用來管理 SQL Server 基礎結構的整合式環境。 SQL Server Management Studio 提供設定、監視及管理 SQL Server 執行個體的圖形介面。 </p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>撰寫 Transact-SQL</h3>
                                                    <p> 此教學課程將供撰寫 Transact-SQL 陳述式以建立及管理 SQL Server 資料庫中各種物件的基本技巧。</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>使用憑證簽署預存程序</h3>
                                                    <p>此教學課程說明如何使用由 SQL Server 產生的憑證來簽署預存程序。</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>擁有權鏈結與環境切換</h3>
                                                    <p>此教學課程利用案例來說明涉及擁有權鏈結與使用者環境切換的 SQL Server 安全性概念。</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>準刪除記錄清除程序</h3>
                                                    <p> 此指南提供準刪除清除程序的概觀，它是背景程序，會將已標示為要刪除的記錄從頁面刪除。 </p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>索引架構和設計</h3>
                                                    <p>此指南包含索引架構的資訊與最佳做法，可協助您設計符合應用程式需求的有效索引。 </p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>記憶體管理架構</h3>
                                                    <p> 此指南說明 SQL Server 如何管理記憶體，以及讀取和寫入頁面時的記憶體使用量。 </p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>移轉後驗證和最佳化</h3>
                                                    <p>在移轉至 SQL Server 後常發生的一些效能案例與解決方法概觀。 </p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>查詢處理架構</h3>
                                                    <p>SQL Server 資料庫引擎會處理各種資料儲存架構上的查詢，例如本機資料表、資料分割資料表，以及分散到多部伺服器的資料表。 此指南涵蓋 SQL Server 如何處理查詢，以及透過執行計畫快取來將查詢重複使用最佳化。 </p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>執行緒和工作架構</h3>
                                                    <p>執行緒是一種作業系統功能，可讓應用程式邏輯分成數個並行的執行路徑。 此指南說明 SQL 如何操作執行緒和工作。 </p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>交易鎖定與資料列版本設定</h3>
                                                    <p> 此指南描述 SQL Server 資料庫引擎用以確保每筆交易實體完整性的鎖定及資料列版本設定機制，並提供有關應用程式如何能夠有效控制交易的資訊。 </p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
