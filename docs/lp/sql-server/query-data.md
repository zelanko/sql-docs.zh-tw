                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>全文檢索搜尋</h3>
                                                    <p>全文檢索索引包括資料表中一或多個以字元為基礎的資料行，而全文檢索搜尋可讓您查詢它們。</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>聯結</h3>
                                                    <p>探索使用聯結時，SQL Server 所執行的不同排序、交集和聯集作業。 </p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>指令碼</h3>
                                                    <p>探索 SQL Server 支援的各種指令碼語言，例如 Powershell 與 xQuery。 </p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>子查詢</h3>
                                                    <p> 子查詢是指在 SELECT、INSERT、UPDATE 或 DELETE 陳述式中，或在另一個子查詢之中為巢狀的。 </p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>同義字</h3>
                                                    <p>提供抽象層的資料庫物件可保護用戶端應用程式，避免變更基底物件的名稱或位置。 </p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>使用者定義的函式</h3> 
                                                    <p>接收參數、執行動作，然後將該動作的結果以值傳回的常式。 </p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
