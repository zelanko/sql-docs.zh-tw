...
---
# <a name="sql-server-vnext-release-notes"></a>SQL Server vNext 版本資訊
...
- [SQL Server Reporting Services 版本資訊](../reporting-services/reporting-services-release-notes.md) 發佈於 Reporting Services 小節。
...
### <a name="supported-installation-scenarios-ctp-14"></a>支援的安裝案例 (CTP 1.4)
...
具體而言，雖然下列案例可能適合您，但它們未經完整測試，且  不 [!INCLUDE[ssSQLv14_md](../includes/sssqlv14-md.md)]支援：
- 解除安裝 CTP 1.1。
...
**問題和對客戶的影響︰** 使用 [!INCLUDE[ssIS_md](../includes/ssis-md.md)] 或 catalog.stop_operation 預存程序停止 [!INCLUDE[ssManStudio_md](../includes/ssmanstudio-md.md)] 中的作業，可能會因下列錯誤而失敗：「執行使用者自訂常式或彙總 'stop_operation_internal' 時，發生 .NET Framework 錯誤。」
...
**問題和對客戶的影響︰** 將 [!INCLUDE[ssIS_md](../includes/ssis-md.md)] 相應放大功能安裝在電腦上，刪除 **SSISDB** 目錄可能會因下列錯誤而失敗： 」。 
