...
我們規劃在未來提供更多的教學課程。 同時，您可以繼續學習針對舊版發行的教學課程。 在某些情況下，您可能會發現 [!INCLUDE[ssCurrent](../includes/sscurrent-md.md)] 與舊版的使用者介面稍有差異，或教學課程必要條件有些微的不同。 如果教學課程使用其中一個 [!INCLUDE[ssSampleDBCoShort](../includes/sssampledbcoshort-md.md)] 資料庫，那麼您應該下載和使用 [!INCLUDE[ssCurrent](../includes/sscurrent-md.md)] 版本。  
  
如果您使用的是 [!INCLUDE[ssCurrent](../includes/sscurrent-md.md)] 伺服器，表示已安裝 [!INCLUDE[ssCurrent](../includes/sscurrent-md.md)] 資料提供者。 為了讓教學課程正常運作，您將需要搭配這些提供者使用的 [!INCLUDE[ssCurrent](../includes/sscurrent-md.md)] 範例資料庫，或是搭配舊版範例資料庫使用的資料提供者。  
