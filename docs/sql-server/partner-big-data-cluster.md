---
title: SQL Server 巨量資料叢集合作夥伴
description: 執行 SQL Server 巨量資料叢集的第三方合作夥伴清單。
ms.topic: conceptual
...
ms.locfileid: "82169612"
---
# <a name="sql-server-big-data-clusters-partners"></a>SQL Server 巨量資料叢集合作夥伴
[!INCLUDE[appliesto-ss-xxxx-xxxx-xxx-md](../includes/appliesto-ss-xxxx-xxxx-xxx-md.md)]
如需在使用 SQL Server 巨量資料叢集來執行解決方案方面的支援，您可以與這些合作夥伴合作。 本文列出了部分使用巨量資料叢集解決方案的 Microsoft 合作夥伴。

## <a name="our-partners"></a>我們的合作夥伴
...
|![PureStorage][5] |Pure Storage 提供操作簡單的 Evergreen™ 平台，讓組織能夠將資料轉變為情報與優勢，將資料化為創新的助力，藉此打造更美好的世界。  Pure Storage 支援巨量資料叢集 (BDC)，具有高度調整空間的存放網狀架構，適用於所有與 Kubernetes 相容的容器協調流程平台。 Pure 的 FlashBlade 是一種易於管理的高效能存放平台，其可供 SQL Server 2019 巨量資料叢集 HDFS 進行階層處理，能夠將可用的存放空間擴展至數 PB，以及將 IO 頻寬擴展至數十 GB。 FlashArray 與 FlashBlade 是成功實現巨量資料叢集的重要因素。 |[網站][purestorage_website]<br>[資料工作表][purestorage_datasheet]<br>[Twitter][purestorage_twitter]<br>[文件][purestorage_docs]|
...
|![azuredatalake][6] |Azure Data Lake Analytics<br><br>支援智慧行動的隨選分析作業服務<br><br>透過數以 PB 的資料，輕鬆地在 U-SQL、R、Python，以及 .NET 中開發及執行大規模的平行資料轉換及處理程式。 您不需要管理基礎結構，就可以視需要處理資料、立即調整規模，且只按作業計費。|[網站][azuredatalake_website]<br>[資料工作表](/azure/data-lake-analytics/data-lake-analytics-overview/)<br>[Twitter][azuredatalake_twitter]<br>[部落格][azuredatalake_blog]|
