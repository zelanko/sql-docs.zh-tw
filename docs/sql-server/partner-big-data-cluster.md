...
|![azuredatalake][5] |Azure Data Lake Analytics<br><br>支援智慧行動的隨選分析作業服務<br><br>透過數以 PB 的資料，輕鬆地在 U-SQL、R、Python，以及 .NET 中開發及執行大規模的平行資料轉換及處理程式。 您不需要管理基礎結構，就可以視需要處理資料、立即調整規模，且只按作業計費。|[網站][azuredatalake_website]<br>[資料工作表](/azure/data-lake-analytics/data-lake-analytics-overview/)<br>[Twitter][azuredatalake_twitter]<br>[部落格][azuredatalake_blog]|
