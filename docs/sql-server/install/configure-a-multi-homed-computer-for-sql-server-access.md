...
ms.topic: "article"
helpviewer_keywords: 
  - "通訊埠 [SQL Server], 多重主目錄電腦"
  - "多重主目錄電腦 [SQL Server] 設定通訊埠"
  - "防火牆系統 [Database Engine], 多重主目錄電腦"
...
#### 判斷使用的 IP 位址和連接埠 [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)]  
