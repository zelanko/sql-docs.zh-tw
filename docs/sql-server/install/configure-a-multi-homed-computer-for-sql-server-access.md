...
description: 了解如何設定 SQL Server 及 Windows 防火牆，以在多重主目錄環境中提供給 SQL Server 執行個體的網路連結。
...
2.  在 [[!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] 組態管理員] 的主控台窗格中，依序展開 [[!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] 網路組態] 和 [\<instance name> 的通訊協定]，然後按兩下 [TCP/IP]。  
