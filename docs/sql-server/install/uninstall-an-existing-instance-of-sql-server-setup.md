...
helpviewer_keywords: 
  - "移除 SQL Server 的執行個體"
  - "解除安裝 SQL Server 的執行個體"
  - "移除 SQL Server"
  - "SQL Server 執行個體, 解除安裝"
  - "解除安裝 SQL Server"
...
### 若要解除安裝 [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)]  
  
1.  若要開始解除安裝程序，請移至 **[控制台]** ，然後移至 **[程式和功能]**。  
  
2.  在 **[!INCLUDE[msCoName](../../includes/msconame-md.md)][!INCLUDE[ssSQL14](../../includes/sssql14-md.md)]** 上按一下滑鼠右鍵，然後選取 [解除安裝]。 然後按一下 **[移除]**。 這樣就會啟動 [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] 安裝精靈。  
