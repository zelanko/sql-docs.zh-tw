...
description: 本文摘要說明 SQL Server 安裝程序的一些變更，包括 SysPrep 支援和從 SQL Server 2005 升級。
ms.custom: ''
ms.date: 08/23/2017
ms.prod: sql
ms.reviewer: ''
...
[!INCLUDE [SQL Server Windows Only - ASDBMI ](../../includes/applies-to-version/sql-windows-only-asdbmi.md)]
 ...
 支援從 [!INCLUDE[ssVersion2005](../../includes/ssversion2005-md.md)] 升級，但不支援並存。 如需 [!INCLUDE[ssVersion2005](../../includes/ssversion2005-md.md)][!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)]支援的詳細資訊，請參閱 [支援的版本與版本升級](../../database-engine/install-windows/supported-version-and-edition-upgrades.md)。  
 
  
## <a name="see-also"></a>另請參閱  
[SQL Server 的新功能](../../sql-server/what-s-new-in-sql-server-2017.md)
