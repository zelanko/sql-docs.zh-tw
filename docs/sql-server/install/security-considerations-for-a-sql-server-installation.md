...
## 安裝之前 [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)]  
 設定伺服器環境時，請遵循這些最佳做法：  
...
###  <a name="physical_security"></a> 加強實體安全性  
...
###  <a name="isolated_services"></a> 隔離服務  
...
###  <a name="sa_with_least_privileges"></a> 設定安全檔案系統  
...
###  <a name="disabled_protocols"></a> 停用 NetBIOS 和伺服器訊息區塊  
...
## 安裝時或安裝後 [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)]  
