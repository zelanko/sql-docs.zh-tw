---
title: "為資料表啟用 Stretch Database | Microsoft Docs"
ms.custom: 
  - "SQL2016_New_Updated"
ms.date: "08/05/2016"
...
ms.topic: "article"
helpviewer_keywords: 
  - "Stretch Database, 啟用資料表"
  - "啟用 Stretch Database 資料表"
 ...
 **選取資料庫資料表**  
 ...
 您可以移轉整個資料表，也可以在精靈中指定簡單的篩選函數。 如果您想要使用不同類型的篩選函數來選取要遷移的資料列，請執行下列其中一項操作。  
...
```  
 ...
 如需詳細資訊，請參閱 [ALTER TABLE &#40;Transact-SQL&#41;](../../t-sql/statements/create-table-transact-sql.md)。  
