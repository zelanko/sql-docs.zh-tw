...
description: 本文探討 SQL Server 2019 的計算容量限制，以及其在具有超執行緒處理器的實體和虛擬化環境中有何差異。
ms.custom: ''
ms.date: 11/07/2017
ms.prod: sql
ms.reviewer: ''
...
## <a name="see-also"></a>另請參閱  
 ...
 [SQL Server 2016 的安裝快速入門](../database-engine/install-windows/install-sql-server.md)  
