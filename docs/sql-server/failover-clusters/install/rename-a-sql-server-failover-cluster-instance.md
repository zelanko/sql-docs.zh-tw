...
helpviewer_keywords: 
  - "叢集 [SQL Server], 虛擬伺服器"
  - "重新命名虛擬伺服器"
  - "虛擬伺服器 [SQL Server], 容錯移轉叢集"
  - "容錯移轉叢集 [SQL Server], 虛擬伺服器"
 ...
 **[!INCLUDE[ssASnoversion](../../../includes/ssasnoversion-md.md)]：** 在您使用 Windows 叢集系統管理員工具來變更 [!INCLUDE[ssASCurrent](../../../includes/ssascurrent-md.md)] 容錯移轉叢集執行個體的網路名稱之後，未來的升級或解除安裝作業可能會失敗。 若要解決這個問題，請遵循[此文](http://go.microsoft.com/fwlink/?LinkId=244002) (http://go.microsoft.com/fwlink/?LinkId=244002) 之＜解決方案＞一節中的指示來更新 **ClusterName** 登錄項目。  
