---
title: "高可用性解決方案 (SQL Server) | Microsoft Docs"
ms.custom: ""
ms.date: "05/19/2016"
...
ms.topic: "article"
helpviewer_keywords: 
  - "高可用性 [SQL Server]，解決方案"
  - "Database Engine [SQL Server]，可用性"
  - "資料庫可用性 [SQL Server]"
  - "可用性 [SQL Server]"
  - "伺服器可用性 [SQL Server]"
...
>  **注意！** 想要知道哪些 [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] 版本支援指定的高可用性方案嗎？ 請參閱 [SQL Server 2016 版本支援的功能](../Topic/Features%20Supported%20by%20the%20Editions%20of%20SQL%20Server%202016.md)的＜高可用性 (AlwaysOn)＞一節。    
...
-   對於透過 [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] 的資料保護，我們建議您使用 [!INCLUDE[ssHADR](../../includes/sshadr-md.md)]。    
       ...
       >  如果您執行不支援 [!INCLUDE[ssHADR](../../includes/sshadr-md.md)] 的 [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] 版本，建議使用記錄傳送。 如需支援 [!INCLUDE[ssHADR](../../includes/sshadr-md.md)] 之 [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] 版本的相關資訊，請參閱 [SQL Server 2016 版本支援的功能](../Topic/Features%20Supported%20by%20the%20Editions%20of%20SQL%20Server%202016.md)的＜高可用性 (AlwaysOn)＞一節。    
