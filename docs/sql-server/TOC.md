...
## [版本及支援的 SQL Server 2016 功能](editions-and-components-of-sql-server-2016.md)
## [版本及支援的 SQL Server 2017 功能](editions-and-components-of-sql-server-2017.md)
...
## [設定 SQL Server 將意見反應傳送給 Microsft](sql-server-customer-feedback.md)
## 合作夥伴
### [監視](partner-monitor-sql-server.md)
### [高可用性及災害復原](partner-hadr-sql-server.md)
### [管理](partner-management-sql-server.md)
### [開發](partner-dev-sql-server.md)

# [新文章及更新的文章](new-updated-sql-server.md)
...
# [安裝 (Windows)](../sql-server/install/planning-a-sql-server-installation.md)
# [安裝 (Linux)](../linux/sql-server-linux-setup.md)
...
### [SQL 在 Channel 9](https://channel9.msdn.com/Search?term=sql#ch9Search&lang-en=en&pubDate=year)

## 意見反應及說明
### [參與編輯 SQL 文件](sql-server-docs-contribute.md)
### [UserVoice - 建議 SQL Server 改進項目](https://feedback.azure.com/forums/908035-sql-server)
