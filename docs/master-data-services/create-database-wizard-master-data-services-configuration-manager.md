---
description: 建立資料庫精靈 (Master Data Services 組態管理員)
title: 建立資料庫精靈
ms.custom: ''
ms.date: 03/20/2017
ms.prod: sql
