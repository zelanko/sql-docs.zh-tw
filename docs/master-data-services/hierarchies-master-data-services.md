---
title: "階層 (Master Data Services) |Microsoft 文件"
ms.custom: 
ms.date: 04/01/2016
...
## <a name="hierarchy-example"></a>階層範例  
 ...
 ![依子類別範例的階層分組](../master-data-services/media/mds-conc-hierarchy.gif "階層依子類別目錄的範例")  
...
|建立衍生階層。|[建立衍生的階層 &#40;Master Data services&#41;](../master-data-services/create-a-derived-hierarchy-master-data-services.md)|  
