...
ms.topic: "article"
helpviewer_keywords: 
  - "安全性 [Master Data Services], 資料庫角色"
  - "資料庫 [Master Data Services], 使用者"
  - "安全性 [Master Data Services], 資料庫使用者"
  - "資料庫 [Master Data Services], 角色"
  - "資料庫 [Master Data Services], 登入"
  - "安全性 [Master Data Services], 資料庫登入"
...
---
# 資料庫登入、使用者和角色 (Master Data Services)
  [!INCLUDE[ssMDSshort](../includes/ssmdsshort-md.md)] 包含的登入、使用者和角色會自動安裝在主控 [!INCLUDE[ssMDSshort](../includes/ssmdsshort-md.md)] 資料庫的 [!INCLUDE[ssDEnoversion](../includes/ssdenoversion-md.md)] 執行個體上。 不應對這些登入、使用者和角色進行修改。  
