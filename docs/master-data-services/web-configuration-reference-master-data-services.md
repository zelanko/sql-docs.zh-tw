...
|**codedom**|.NET Framework 元素。 如需詳細資訊， [ \<](https://go.microsoft.com/fwlink/?LinkId=178351)請參閱 MSDN library 中的 system.object> 元素。|  
...
|**系統診斷**|.NET Framework 元素。 如需詳細資訊，請參閱[ \<MSDN library 中的 system. diagnostics> 元素](https://go.microsoft.com/fwlink/?LinkId=178355)。|  
