...
---
# 概觀：從 Excel 匯入資料 (適用於 Excel 的 MDS 增益集)
...
|執行合併衝突，如此您就可以發佈您的變更。|[合併衝突 &#40;適用於 Excel 的 MDS 增益集&#41;](../../master-data-services/microsoft-excel-add-in/merge-conflicts-mds-add-in-for-excel.md)|  
