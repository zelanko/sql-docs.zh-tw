---
title: 連接到 MDS 保存庫
description: 在適用於 Excel 的 Master Data Services 增益集中，您必須先連接到 Master Data Services 存放庫，才能載入或發佈資料。
...
-   [將資料從 Master Data Services 匯出至 Excel](../../master-data-services/microsoft-excel-add-in/export-data-to-excel-from-master-data-services.md)  
