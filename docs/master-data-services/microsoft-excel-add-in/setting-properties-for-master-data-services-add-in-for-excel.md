...
|設定：Version|版本選取項目|選取將載入 Excel 增益集中之主要資料的版本。 可為以下項目：<br /><br /> [無]  表示具有未預設為任何版本的版本<br /><br /> [最舊]  表示預設為最舊的版本；[最新]  表示預設為最新的版本。|  
...
|資料：儲存格格式|顯示格式|選取顯示網域屬性值的慣用格式。 選項為 [代碼 {Name}]、[代碼] 和 [名稱 {Code}]。|  
