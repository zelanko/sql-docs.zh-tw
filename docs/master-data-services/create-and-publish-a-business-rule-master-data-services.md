---
title: 建立及發行商務規則
description: 瞭解如何在 Master Data Services 中建立商務規則，以確保主要資料的正確性。 建立規則之後，請將它發佈以套用規則。
ms.custom: ''
ms.date: 03/01/2017
ms.prod: sql
ms.prod_service: mds
...
20. 按一下 [檔案] 。 新的資料列就會加入 [Then] (則) **** 方格中。  
...
21. 或者，若要新增 **Else** 動作，請完成下列步驟。  
    ...
    5.  按一下 [檔案] 。 新的資料列就會新增至 [Else]**** 方格中。  
  
22. 按一下 [檔案] 。 新的資料列就會加入商務規則方格中。  
  
23. 按一下 [全部發行] ****。  
  
24. 在確認對話方塊中按一下 **[確定]**。 [Business Rule State] (商務規則狀態) **** 資料行中的值是 [使用中] ****。  
