---
description: 取代的 Master Data Services 功能
title: 取代的 Master Data Services 功能
ms.custom: ''
ms.date: 03/14/2017
ms.prod: sql
ms.prod_service: mds
...
## <a name="external-resources"></a>外部資源  
 msdn.com 上的部落格文章 [Deprecated: Explicit Hierarchies and Collections](https://techcommunity.microsoft.com/t5/sql-server-integration-services/deprecated-explicit-hierarchies-and-collections/ba-p/388221)(已取代︰明確階層和集合)。  
