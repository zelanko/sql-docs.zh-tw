...
|資料行名稱|說明|  
|-----------------|-----------------|  
|狀態|索引狀態。<br /><br /> 當您按一下 [**儲存**] 時，會顯示 [![正在更新狀態](../master-data-services/media/mds-statusicon-updating.png "I正在更新狀態的 con」)影像] 圖示，指出索引正在更新。<br /><br /> 如果建立或編輯索引時發生錯誤，則會顯示 [![錯誤狀態](../master-data-services/media/mds-statusicon-error.png "I錯誤狀態的 con」)影像] 圖示。<br /><br /> 否則，狀態會是 [確定]，而 [![確定狀態影像] 圖示](../master-data-services/media/mds-statusicon-ok.png "I「確定」狀態的 con)會顯示。|  
|名稱|索引名稱。|  
|是唯一的|指定索引是否是唯一的。|  
|依據屬性|顯示定義索引的屬性顯示名稱。|  
