---
title: "部署模型 (Master Data Services) |Microsoft 文件"
ms.custom:
- SQL2016_New_Updated
ms.date: 03/01/2017
...
> [!IMPORTANT]  
>  [!INCLUDE[ssCurrent](../includes/sscurrent-md.md)]**MDSModelDeploy 工具**回溯相容於中建立的封裝[!INCLUDE[ssSQL11](../includes/sssql11-md.md)]或更高版本。  
