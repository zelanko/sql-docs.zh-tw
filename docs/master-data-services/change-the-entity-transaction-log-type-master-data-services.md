---
description: 變更實體交易記錄類型 (Master Data Services)
title: 變更實體交易記錄類型
ms.custom: ''
ms.date: 03/14/2017
ms.prod: sql
...
|交易記錄類型|描述|  
|--------------------------|-----------------|  
|屬性|實體變更記錄儲存在屬性等級。<br /><br /> 交易記錄檔的儲存方式與相同 [!INCLUDE[ssSQL14](../includes/sssql14-md.md)] [!INCLUDE[ssMDSshort](../includes/ssmdsshort-md.md)] 。|  
