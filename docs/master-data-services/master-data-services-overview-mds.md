...
# Master Data Services 概觀 (MDS)
 ...
 例如產品實體在費用與權數上可能會有沒有特定格式的屬性。 而且會有色彩 ![Number 1](../master-data-services/media/mds-number1.png "Number 1") 的網域屬性，其中包含由色彩實體成員所植入的值。 此主要色彩清單用作為「產品」實體的屬性值 ![Number 2](../master-data-services/media/mds-number2.png "Number 2")。  
 ...
 衍生的階層由模型中實體之間的關聯性而來。 這些是網域屬性關聯性。 例如，在產品模型中可能會有色彩衍生階層 ![Number 1](../master-data-services/media/mds-number1.png "Number 1")，其來自色彩 ![Number 2](../master-data-services/media/mds-number2.png "Number 2") 與產品 ![Number 3](../master-data-services/media/mds-number3.png "Number 3") 實體之間的關聯性。  
...
|建立使用者定義的中繼資料|若要描述模型物件，請將使用者定義的中繼資料加入至模型。 中繼資料可能包含物件擁有者或資料來源。|[中繼資料 &#40;Master Data Services&#41;](../Topic/Metadata%20\(Master%20Data%20Services\).md)|  
