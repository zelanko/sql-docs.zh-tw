...
本主題說明 [!INCLUDE[ssMDSshort](../includes/ssmdsshort-md.md)]的索引鍵資料組織和管理功能。 
 ...
 例如產品實體在費用與權數上可能會有沒有特定格式的屬性。 而且，色彩![編號 1](../master-data-services/media/mds-number1.png "數字 1")有一個網域屬性，其中包含由色彩實體成員填入的值。 此主要色彩清單會當做產品實體![編號 2](../master-data-services/media/mds-number2.png "數字 2")的屬性值使用。  
  
 ![色彩的網域屬性](../master-data-services/media/mds-productentity-color-domainattribute.png "色彩的網域屬性")  
  
 衍生的階層由模型中實體之間的關聯性而來。 這些是網域屬性關聯性。 例如，在產品型號中，您可以有色彩衍生階層![編號 1](../master-data-services/media/mds-number1.png "數字 1") ，來自第![二](../master-data-services/media/mds-number2.png "數字 2")色和第![3](../master-data-services/media/mds-number3.png "數字 3")號實體之間的關聯性。  
 ...
 下表摘要列出 [!INCLUDE[ssMDSshort](../includes/ssmdsshort-md.md)] 的主要工作。 除非另有指示，否則您必須是模型系統管理員，才能完成下列所有程序。 如需詳細資訊，請參閱系統[管理員 &#40;Master Data Services&#41;](../master-data-services/administrators-master-data-services.md)。  
