...
ms.topic: "article"
helpviewer_keywords: 
  - "屬性群組 [Master Data Services]"
  - "屬性群組 [Master Data Services], 關於屬性群組"
...
## 顯示或隱藏屬性群組  
 ...
 如果您想要隱藏群組中的特定屬性，您可以將**拒絕**權限指派給此屬性。 如需詳細資訊，請參閱[分葉權限 &#40;Master Data Services&#41;](../master-data-services/leaf-permissions-master-data-services.md) 或[合併的權限 &#40;Master Data Services&#41;](../Topic/Consolidated%20Permissions%20\(Master%20Data%20Services\).md)。  
