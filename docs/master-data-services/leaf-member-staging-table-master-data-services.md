---
title: "分葉成員暫存資料表 (Master Data Services) |Microsoft 文件"
ms.custom: 
ms.date: 04/01/2016
...
# <a name="leaf-member-staging-table-master-data-services"></a>分葉成員暫存資料表 (Master Data Services)
  使用分葉成員暫存資料表 (stg.name_Leaf) 中[!INCLUDE[ssMDSshort](../includes/ssmdsshort-md.md)]資料庫建立、 更新、 停用，以及刪除分葉成員。 您也可以用它來更新分葉成員的屬性值。  
