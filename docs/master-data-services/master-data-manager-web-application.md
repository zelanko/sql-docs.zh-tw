...
description: 瞭解如何使用主資料管理員 web 應用程式來執行 Master Data Services 的系統管理工作。
ms.custom: ''
ms.date: 12/20/2016
ms.prod: sql
ms.prod_service: mds
...
> [無法透過 SQL Server 2016 中的低權限帳戶建立 MDS 網站](https://aka.ms/mdssupport) 
 ...
 [總管功能區域 &#40;主資料管理員&#41;](../master-data-services/explorer-functional-area-master-data-manager.md)  
 ...
 [系統管理功能區域 &#40;主資料管理員&#41;](../master-data-services/system-administration-functional-area-master-data-manager.md)  
