...
3.  針對每個參數標記，呼叫 [SQLBindParameter](../../../relational-databases/native-client-odbc-api/sqlbindparameter.md) 將參數的資料值和資料長度指標指向在步驟1所配置之結構陣列第一個元素中的變數。 如果參數是資料執行中參數，請設定此參數。  
