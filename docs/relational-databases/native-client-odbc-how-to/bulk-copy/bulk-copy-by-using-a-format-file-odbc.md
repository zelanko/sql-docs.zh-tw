...
5.  呼叫 [bcp_readfmt](../../../relational-databases/native-client-odbc-extensions-bulk-copy-functions/bcp-readfmt.md) 讀取格式檔案，此檔案描述大量複製作業所使用的資料檔案。  
...
## <a name="example"></a>範例  
 ...
 執行第五個 ( [!INCLUDE[tsql](../../../includes/tsql-md.md)]) 程式代碼清單，以刪除範例所使用的資料表。  
