---
title: 使用格式檔案 (ODBC) 大量複製 |Microsoft 文件
ms.custom: ''
ms.date: 03/14/2017
ms.prod: sql
...
5.  呼叫[bcp_readfmt](../../../relational-databases/native-client-odbc-extensions-bulk-copy-functions/bcp-readfmt.md)讀取描述大量複製作業所使用之資料檔案的格式檔案。  
