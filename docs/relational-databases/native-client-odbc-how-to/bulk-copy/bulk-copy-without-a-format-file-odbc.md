...
4.  呼叫[bcp_init](../../../relational-databases/native-client-odbc-extensions-bulk-copy-functions/bcp-init.md)設定下列資訊：  
    ...
    -   複製的方向：DB_IN 從檔案來檢視或資料表或從資料表或檢視表檔案 DB_OUT。  
  
5.  呼叫[bcp_exec](../../../relational-databases/native-client-odbc-extensions-bulk-copy-functions/bcp-exec.md)以便執行大量複製作業。  
