...
3.  使用 SQL_HANDLE_ENV 的**HandleType**呼叫[SQLAllocHandle](https://go.microsoft.com/fwlink/?LinkId=58396) ，以初始化 ODBC 並配置環境控制碼。  
...
5.  （選擇性）呼叫 [SQLSetEnvAttr](../../relational-databases/native-client-odbc-api/sqlsetenvattr.md) 來設定其他環境選項，或呼叫 [SQLGetEnvAttr](https://go.microsoft.com/fwlink/?LinkId=58403) 來取得環境選項。  
