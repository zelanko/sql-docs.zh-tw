...
2.  使用 SQL_COPT_SS_PERF_QUERY_INTERVAL 來呼叫 [SQLSetConnectAttr](../../relational-databases/native-client-odbc-api/sqlsetconnectattr.md) ，並將設定為以毫秒為單位的逾時間隔。  
  
3.  使用 SQL_COPT_SS_PERF_QUERY 和 SQL_PERF_START 來呼叫 [SQLSetConnectAttr](../../relational-databases/native-client-odbc-api/sqlsetconnectattr.md) ，以開始記錄長時間執行的查詢。  
  
4.  使用 SQL_COPT_SS_PERF_QUERY 和 SQL_PERF_STOP 來呼叫 [SQLSetConnectAttr](../../relational-databases/native-client-odbc-api/sqlsetconnectattr.md) ，以停止記錄長時間執行的查詢。  
