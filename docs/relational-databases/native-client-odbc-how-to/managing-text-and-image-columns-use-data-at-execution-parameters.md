...
## <a name="example"></a>範例  
 ...
 執行第一個[!INCLUDE[tsql](../../includes/tsql-md.md)]( ) 程式碼清單以建立範例使用的表。  
...
## <a name="see-also"></a>另請參閱  
 [管理文字和影像列「如何」主題&#40;ODBC&#41;](https://msdn.microsoft.com/library/f97333ad-e2ab-4d26-9395-741ba25f2c28)  
