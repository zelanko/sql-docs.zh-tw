...
|*pOtherOptions*[in]|如果不是 Null，[!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] Native Client OLE DB 提供者會向介面要求 options 物件。 如果 options 物件的*ulTimeout*成員不是零，[!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] Native Client OLE DB 提供者會傳回 XACT_E_NOTIMEOUT。 [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] Native Client OLE DB 提供者會忽略*szDescription*成員的值。|  
...
|*fAsync*[in]|[!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] Native Client OLE DB 提供者不支援非同步中止。 如果值不是 FALSE，[!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] Native Client OLE DB 提供者會傳回 XACT_E_NOTSUPPORTED。|  
...
|*grfRM*[in]|必須是 0。|  
 ...
 會話上的 [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] Native Client OLE DB 提供者資料列集會根據資料列集屬性 DBPROP_ABORTPRESERVE 和 DBPROP_COMMITPRESERVE 的值，保留在本機認可或中止作業上。 根據預設，這些屬性都是 VARIANT_FALSE，而且會話上的所有 [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] Native Client OLE DB 提供者資料列集都會在中止或認可作業之後遺失。  
