---
title: 隔離等級（Native Client OLE DB 提供者） |Microsoft Docs
ms.custom: ''
ms.date: 03/14/2017
ms.prod: sql
...
ms.locfileid: "87240050"
---
# <a name="isolation-levels-native-client-ole-db-provider"></a>隔離等級（Native Client OLE DB 提供者）
