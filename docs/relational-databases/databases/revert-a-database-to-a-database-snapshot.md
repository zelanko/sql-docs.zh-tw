---
title: "將資料庫還原成資料庫快照集 | Microsoft Docs"
ms.custom: ""
ms.date: "03/09/2017"
...
1.  識別您要將資料庫還原成哪一個資料庫快照集。 您可以檢視 [!INCLUDE[ssManStudioFull](../../includes/ssmanstudiofull-md.md)] 中之資料庫的快照集 (請參閱[檢視資料庫快照集 &#40;SQL Server&#41;](../../relational-databases/databases/view-a-database-snapshot-sql-server.md))。 此外，您可以從 [sys.databases &#40;Transact-SQL&#41;](../../relational-databases/system-catalog-views/sys-databases-transact-sql.md) 目錄檢視的 **source_database_id** 資料行中，識別某個檢視的來源資料庫。  
...
3.  執行還原作業。  
     ...
     如需詳細資訊，請參閱 [RESTORE &#40;Transact-SQL&#41;](../Topic/RESTORE%20\(Transact-SQL\).md)。  
...
-   對於 **sales_snapshot1200** 快照集，請參閱[建立資料庫快照集 &#40;Transact-SQL&#41;](../../relational-databases/databases/create-a-database-snapshot-transact-sql.md) 中的＜在 Sales 資料庫上建立快照集＞。  
