...
[!INCLUDE[appliesto-ss-xxxx-xxxx-xxx-md](../../includes/appliesto-ss-xxxx-xxxx-xxx-md.md)] 使用此頁面即可設定和修改資料庫記錄傳送的屬性。  
...
## <a name="see-also"></a>另請參閱  
 [記錄傳送預存程序 &#40;Transact-SQL&#41;](../../relational-databases/system-stored-procedures/log-shipping-stored-procedures-transact-sql.md)   
