...
-   資料庫有資料庫快照集存在。  
     ...
     在卸離資料庫之前，您必須先卸除它的所有快照集。 如需詳細資訊，請參閱[卸除資料庫快照集 &#40;Transact-SQL&#41;](../../relational-databases/databases/drop-a-database-snapshot-transact-sql.md)。  
...
-   [附加資料庫時的中繼資料變更](#Metadata)  
  
-   [備份和還原與附加](#BnR)  
  
-   [將資料庫附加至另一個伺服器執行個體](#OtherServerInstance)  
