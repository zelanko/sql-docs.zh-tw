...
###  <a name="Restrictions"></a> 限制事項  
 如需限制事項的清單，請參閱[資料庫卸離與附加 &#40;SQL Server&#41;](../../relational-databases/databases/database-detach-and-attach-sql-server.md)。  
...
3.  以滑鼠右鍵按一下資料庫名稱，並指向**工作**，然後按一下 [卸離]。 **[卸離資料庫]** 對話方塊隨即出現。  
     ...
     **保留全文檢索目錄**  
     依預設，卸離作業會保留與該資料庫關聯的所有全文檢索目錄。 請清除 [保留全文檢索目錄] 核取方塊，以移除這些全文檢索目錄。 只有當您從 [!INCLUDE[ssVersion2005](../../includes/ssversion2005-md.md)] 升級資料庫時，才會出現這個選項。  
    ...
    -   當資料庫有一個或多個使用中的連接時，[狀態]為 [未就緒]且 [訊息] 資料行顯示 *<number_of_active_connections>*** 個使用中的連接** — 例如：**1 個使用中的連接**。 您必須選取 **[卸除連接]**中斷任何使用中的連接之後，才能卸離資料庫。  
