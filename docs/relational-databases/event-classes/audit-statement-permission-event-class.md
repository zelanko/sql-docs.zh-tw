...
ms.topic: "article"
helpviewer_keywords: 
  - "Audit Statement Permission 事件類別"
...
# Audit Statement Permission 事件類別
 ...
 未來的 [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] 版本可能會移除 **Audit Statement Permission** 事件類別。 建議您改用 **Audit Schema Object Management** 事件類別。  
  
## Audit Statement Permission 事件類別資料行  
...
|**Permissions**|**bigint**|代表被檢查之權限類型的整數值。<br /><br /> 1=CREATE DATABASE (僅適用於 master 資料庫)<br /><br /> 2=CREATE TABLE<br /><br /> 4=CREATE PROCEDURE<br /><br /> 8=CREATE VIEW<br /><br /> 16=CREATE RULE<br /><br /> 32=CREATE DEFAULT<br /><br /> 64=BACKUP DATABASE<br /><br /> 128=BACKUP LOG<br /><br /> 256=BACKUP TABLE<br /><br /> 512=CREATE FUNCTION|19|是|  
...
## 另請參閱  
 ...
 [Audit Schema Object Management 事件類別](../../relational-databases/event-classes/audit-schema-object-management-event-class.md)  
