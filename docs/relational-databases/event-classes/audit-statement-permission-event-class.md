---
description: Audit Statement Permission 事件類別
...
|**權限**|**bigint**|代表被檢查之權限類型的整數值。<br /><br /> 1=CREATE DATABASE (僅適用於 master 資料庫)<br /><br /> 2=CREATE TABLE<br /><br /> 4=CREATE PROCEDURE<br /><br /> 8=CREATE VIEW<br /><br /> 16=CREATE RULE<br /><br /> 32=CREATE DEFAULT<br /><br /> 64=BACKUP DATABASE<br /><br /> 128=BACKUP LOG<br /><br /> 256=BACKUP TABLE<br /><br /> 512=CREATE FUNCTION|19|是|  
