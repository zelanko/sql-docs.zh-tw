...
ms.tgt_pltfrm: 
ms.topic: article
helpviewer_keywords: SP:CacheHit event class
...
ms.openlocfilehash: 030d3b119bb61232863cbcf765807a2cc4e7175b
...
[!INCLUDE[appliesto-ss-asdb-xxxx-xxx-md](../../includes/appliesto-ss-asdb-xxxx-xxx-md.md)] SP:CacheHit 事件類別指出預存程序在計畫快取中。  
