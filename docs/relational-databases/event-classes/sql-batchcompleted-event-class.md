...
---
# SQL:BatchCompleted 事件類別
  SQL:BatchCompleted 事件類別代表已完成 [!INCLUDE[tsql](../../includes/tsql-md.md)] 批次。  
  
## SQL:BatchCompleted 事件類別資料行  
...
|錯誤|**int**|事件的錯誤號碼。<br /><br /> 0=確定<br /><br /> 1=錯誤<br /><br /> 2=中止|31|是|  
|EventClass|**int**|事件類型 = 12。|27|否|  
