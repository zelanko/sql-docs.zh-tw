---
title: "遺失聯結述詞事件類別 | Microsoft Docs"
ms.custom: ""
ms.date: "03/14/2017"
...
---
# 遺失聯結述詞事件類別
  「遺失聯結述詞」事件類別指示要執行的查詢沒有聯結述詞。 這可能造成長時間執行的查詢。 如需聯結述詞的詳細資訊，請參閱[述詞 &#40;Transact-SQL&#41;](../Topic/Predicates%20\(Transact-SQL\).md)。  
