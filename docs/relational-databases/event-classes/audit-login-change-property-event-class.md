---
description: Audit Login Change Property 事件類別
...
ms.openlocfilehash: 2a183f8f9c2080eda14391c465c809c9116beba3
ms.sourcegitcommit: 1a544cf4dd2720b124c3697d1e62ae7741db757c
ms.translationtype: HT
ms.contentlocale: zh-TW
ms.lasthandoff: 12/14/2020
ms.locfileid: "97476359"
---
...
|**EventClass**|**int**|事件類別 = 106。|27|否|  
|**EventSequence**|**int**|要求中的給定事件順序。|51|否|  
|**EventSubClass**|**int**|事件子類別的類型。<br /><br /> 1=預設資料庫已變更<br /><br /> 2=預設語言已變更<br /><br /> 3=名稱已變更<br /><br /> 4=憑證已變更<br /><br /> 5=政策已變更<br /><br /> 6=到期日已變更|21|是|  
