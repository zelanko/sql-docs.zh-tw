...
ms.topic: "article"
helpviewer_keywords: 
  - "Audit Login Change Password 事件類別"
...
---
# Audit Login Change Password 事件類別
  每次使用者變更其 [!INCLUDE[msCoName](../../includes/msconame-md.md)][!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] 登入密碼時，就會發生 **Audit Login Change Password** 事件類別。  
  
## Audit Login Change Password 事件類別資料行  
...
|**EventClass**|**int**|事件類型 = 107。|27|否|  
|**EventSequence**|**int**|要求中的給定事件順序。|51|否|  
|**EventSubClass**|**int**|事件子類別的類型。<br /><br /> 1=密碼自行變更<br /><br /> 2=密碼已變更<br /><br /> 3=密碼自行重設<br /><br /> 4=密碼已重設<br /><br /> 5=密碼已解除鎖定<br /><br /> 6=密碼必須變更|21|是|  
...
|**ObjectType**|**int**|代表參與事件之物件類型的值。 這個值會對應到 **sys.objects** 目錄檢視中的類型資料行。 如需各值，請參閱 [ObjectType 追蹤事件資料行](../../relational-databases/event-classes/objecttype-trace-event-column.md)。|28|是|  
