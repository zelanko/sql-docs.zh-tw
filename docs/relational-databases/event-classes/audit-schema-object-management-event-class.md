...
ms.topic: "article"
helpviewer_keywords: 
  - "Audit Schema Object Management 事件類別"
...
## Audit Schema Object Management 事件類別資料行  
...
|**LoginSid**|**image**|已登入之使用者的安全性識別碼 (SID)。 您可以在 **sys.server_principals** 目錄檢視中找到此這項資訊。 伺服器上的每一個登入之 SID 是唯一的。|41|是|  
