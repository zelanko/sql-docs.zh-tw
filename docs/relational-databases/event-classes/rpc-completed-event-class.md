---
title: "RPC:Completed 事件類別 | Microsoft Docs"
ms.custom: ""
ms.date: "12/04/2015"
...
|有效期間|**bigint**|事件花費的時間量。 自 [!INCLUDE[ssKilimanjaro](../../includes/sskilimanjaro-md.md)]開始以毫秒為單位。 舊版中的單位是毫秒。|13|是|  
...
|Reads|**bigint**|遠端程序呼叫所發出的分頁讀取數。|16|是|  
