---
description: Audit Add Role 事件類別
...
ms.openlocfilehash: fdad83f36cdba9a79f48ea94a4bcd6c97ab1f4c3
ms.sourcegitcommit: 1a544cf4dd2720b124c3697d1e62ae7741db757c
ms.translationtype: HT
ms.contentlocale: zh-TW
ms.lasthandoff: 12/14/2020
ms.locfileid: "97440159"
---
...
## <a name="audit-add-role-event-class-data-columns"></a>Audit Add Role 事件類別資料行  
...
|**RoleName**|**nvarchar**|要加入或移除的資料庫角色名稱。|38|是|  
...
## <a name="see-also"></a>另請參閱  
 ...
 [Audit Database Principal Management 事件類別](../../relational-databases/event-classes/audit-database-principal-management-event-class.md)  
