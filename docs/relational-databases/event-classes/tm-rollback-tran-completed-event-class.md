...
ms.tgt_pltfrm: 
ms.topic: article
helpviewer_keywords: 'TM: Rollback Tran Completed event class'
...
ms.openlocfilehash: 0b71e871f7209b402399ac186b89e35ea82459ba
...
[!INCLUDE[appliesto-ss-asdb-xxxx-xxx-md](../../includes/appliesto-ss-asdb-xxxx-xxx-md.md)] TM: Rollback Tran Completed 事件類別指出 ROLLBACK TRANSACTION 要求已完成。 要求是從用戶端透過交易管理介面傳送。 EventSubClass 資料行指出新交易是否會在目前交易回復之後啟動。  
