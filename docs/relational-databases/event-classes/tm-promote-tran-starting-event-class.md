...
[!INCLUDE[appliesto-ss-asdb-xxxx-xxx-md](../../includes/appliesto-ss-asdb-xxxx-xxx-md.md)] TM: Promote Tran Starting 事件類別指出正在啟動 PROMOTE TRANSACTION 要求。 要求是從用戶端透過交易管理介面傳送。  
