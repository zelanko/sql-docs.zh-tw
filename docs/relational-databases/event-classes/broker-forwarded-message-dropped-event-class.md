---
description: Broker:Forwarded Message Dropped 事件類別
...
|DBUserName|**nvarchar**|此訊息的來源 Broker 執行個體識別碼。|40|No|  
|錯誤|**int**|sys.messages 中的訊息識別碼，代表事件內的文字。|31|No|  
...
|TargetLoginName|**nvarchar**|將轉寄訊息的目的網路位址。|42|No|  
