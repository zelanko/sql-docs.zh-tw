...
# [Broker:Message Drop 事件類別](broker-message-drop-event-class.md)
...
# [Security Audit 事件類別目錄 (SQL Server Profiler)](security-audit-event-category-sql-server-profiler.md)
...
# [資料庫鏡像連接事件類別](database-mirroring-connection-event-class.md)
...
# [點陣圖警告事件類別](bitmap-warning-event-class.md)
...
# [Errors and Warnings 事件類別目錄 (Database Engine)](errors-and-warnings-event-category-database-engine.md)
...
# [Progress Report 事件類別目錄](progress-report-event-category.md)
...
# [SQL Server 事件類別參考](sql-server-event-class-reference.md)
