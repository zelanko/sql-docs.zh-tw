...
[!INCLUDE[appliesto-ss-asdb-xxxx-xxx-md](../../includes/appliesto-ss-asdb-xxxx-xxx-md.md)] Exec Prepared SQL 事件類別代表 SqlClient、ODBC、OLE DB 或 DB-Library 已經執行一或多個備妥的 [!INCLUDE[tsql](../../includes/tsql-md.md)] 陳述式。  
