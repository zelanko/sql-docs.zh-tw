...
[!INCLUDE[appliesto-ss-asdb-xxxx-xxx-md](../../includes/appliesto-ss-asdb-xxxx-xxx-md.md)] **Audit Database Principal Impersonation** 事件類別會在資料庫範圍內出現模擬時發生，例如 EXECUTE AS \<*user*> 或 SETUSER。  
