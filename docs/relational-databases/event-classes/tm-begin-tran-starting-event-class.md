...
ms.tgt_pltfrm: 
ms.topic: article
helpviewer_keywords: 'TM: Begin Tran Starting event class'
...
[!INCLUDE[appliesto-ss-asdb-xxxx-xxx-md](../../includes/appliesto-ss-asdb-xxxx-xxx-md.md)] TM: Begin Tran Starting 事件類別指出正在啟動 BEGIN TRANSACTION 要求。 要求是從用戶端透過交易管理介面傳送。  
