---
description: Audit Database Scope GDR 事件類別
...
ms.locfileid: "96126821"
---
# <a name="audit-database-scope-gdr-event-class"></a>Audit Database Scope GDR 事件類別
[!INCLUDE [SQL Server - ASDB](../../includes/applies-to-version/sql-asdb.md)]
  每當 [!INCLUDE[msCoName](../../includes/msconame-md.md)] [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] 任何使用者針對授與資料庫權限的資料庫專有動作對陳述式權限發出 GRANT、REVOKE 或 DENY 時，就會發生 **Audit Database Scope GDR** 事件類別。  
...
|**權限**|**bigint**|代表被檢查之權限類型的整數值。<br /><br /> 1=CREATE DATABASE<br /><br /> 2=CREATE TABLE<br /><br /> 4=CREATE PROCEDURE<br /><br /> 8=CREATE VIEW<br /><br /> 16=CREATE RULE<br /><br /> 32=CREATE DEFAULT<br /><br /> 64=BACKUP DATABASE<br /><br /> 128=BACKUP LOG<br /><br /> 256=BACKUP TABLE<br /><br /> 512=CREATE FUNCTION|19|是|  
