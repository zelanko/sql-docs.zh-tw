...
[!INCLUDE[appliesto-ss-asdb-xxxx-xxx-md](../../includes/appliesto-ss-asdb-xxxx-xxx-md.md)] EventLog 事件類別指出已將事件記錄在 [!INCLUDE[msCoName](../../includes/msconame-md.md)] Windows 事件記錄檔中。  
  
## <a name="eventlog-event-class-data-columns"></a>EventLog 事件類別資料行  
...
|錯誤|**int**|給定事件的錯誤號碼 (如果有的話)。|31|是|  
|EventClass|**int**|事件類型 = 21。|27|否|  
