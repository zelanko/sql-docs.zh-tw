...
[!INCLUDE[appliesto-ss-asdb-xxxx-xxx-md](../../includes/appliesto-ss-asdb-xxxx-xxx-md.md)] ErrorLog 事件類別指出已將訊息記錄在 [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] 錯誤記錄檔中。  
  
## <a name="errorlog-event-class-data-columns"></a>ErrorLog 事件類別資料行  
