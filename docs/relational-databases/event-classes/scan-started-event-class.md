...
ms.tgt_pltfrm: 
ms.topic: article
helpviewer_keywords: Scan:Started event class
...
[!INCLUDE[appliesto-ss-asdb-xxxx-xxx-md](../../includes/appliesto-ss-asdb-xxxx-xxx-md.md)] 啟動資料表或索引掃描時，會發生 Scan:Started 事件類別。  
