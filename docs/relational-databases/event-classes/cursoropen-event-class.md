...
|**EventClass**|**int**|記錄的事件類型 = 53。|27|否|  
|**EventSequence**|**int**|**CursorOpen** 事件類別在批次中的順序。|51|否|  
|**GroupID**|**int**|SQL 追蹤事件引發所在之工作負載群組的識別碼。|66|是|  
|**Handle**|**int**|ODBC、OLE DB 或 DB-Library 用來和伺服器協調執行的整數。|33|是|  
