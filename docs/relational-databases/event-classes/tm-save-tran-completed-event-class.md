...
ms.tgt_pltfrm: 
ms.topic: article
helpviewer_keywords: 'TM: Save Tran Completed event class'
...
[!INCLUDE[appliesto-ss-asdb-xxxx-xxx-md](../../includes/appliesto-ss-asdb-xxxx-xxx-md.md)] TM: Save Tran Completed 事件類別指出已完成 SAVE TRANSACTION 要求。 要求是從用戶端透過交易管理介面傳送。  
