---
title: "Database Suspect Data Page 事件類別 | Microsoft Docs"
ms.custom: ""
ms.date: "03/15/2017"
...
---
# Database Suspect Data Page 事件類別
  **Database Suspect Data Page** 事件類別指出何時要將頁面加入 [msdb](../../relational-databases/databases/msdb-database.md) 中的 [suspect_pages](../../relational-databases/system-tables/suspect-pages-transact-sql.md) 資料表。 請在監視可疑頁面出現的追蹤中包含此事件類別。  
...
## Database Suspect Data Page 事件類別資料行  
