...
ms.locfileid: "85719927"
---
# <a name="nullability-and-three-value-logic-comparisons"></a>Null 屬性和三值邏輯比較
 [!INCLUDE [SQL Server](../../includes/applies-to-version/sqlserver.md)]
  如果您熟悉 [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] 資料類型，則會在的**SqlTypes**命名空間中找到類似的語義和有效位數 [!INCLUDE[dnprdnshort](../../includes/dnprdnshort-md.md)] 。 不過，其中仍有一些差異，而且本主題將涵蓋最重要的差異。  
...
## <a name="operations-functions-and-null-values"></a>作業、函數和 NULL 值  
 如果 SqlTypes 的任何運算元或引數為 Null，則所有算術運算子（+、-、 \* 、/、%）、位運算子（~、& 和 |）和大部分**SqlTypes**函數都會傳回 null。 **IsNull**屬性一律會傳回 true 或 false 值。  
  
## <a name="precision"></a>準確率  
 [!INCLUDE[dnprdnshort](../../includes/dnprdnshort-md.md)] CLR 中的十進位資料類型與 [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] 中的數值和十進位資料類型具有不同的最大值。 此外，[!INCLUDE[dnprdnshort](../../includes/dnprdnshort-md.md)] CLR 十進位資料類型會採用最大有效位數。 不過，在的 CLR 中 [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] ， **SqlDecimal**會提供相同的最大有效位數和小數位數，以及與中的 decimal 資料類型相同的語義 [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] 。  
