---
title: WMI 提供者組態管理概念 |Microsoft Docs
ms.custom: ''
ms.date: 03/14/2017
ms.prod: sql
...
## <a name="see-also"></a>另請參閱  
 [了解組態管理的 WMI 提供者](../../relational-databases/wmi-provider-configuration/understanding-the-wmi-provider-for-configuration-management.md)   
