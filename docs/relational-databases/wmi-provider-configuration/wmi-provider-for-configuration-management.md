...
description: 深入瞭解在 Microsoft Management Console 中與 SQL Server 組態管理員搭配使用的 WMI 提供者，以及 Microsoft SQL Server Configuration Manager。
ms.custom: ''
ms.date: 03/14/2017
ms.prod: sql
...
## <a name="see-also"></a>另請參閱  
 [瞭解設定管理的 WMI 提供者](../../relational-databases/wmi-provider-configuration/understanding-the-wmi-provider-for-configuration-management.md)   
