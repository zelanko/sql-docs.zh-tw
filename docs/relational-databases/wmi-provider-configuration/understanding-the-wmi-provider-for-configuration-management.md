---
title: 組態管理的 WMI 提供者
description: 瞭解 Configuration Management 的 WMI 提供者如何使用 WMI 來管理 SQL Server 中的服務、伺服器別名和用戶端/伺服器網路設定。
...
[!INCLUDE [SQL Server](../../includes/applies-to-version/sqlserver.md)]
 ...
 如需使用 WMI 提供者進行設定管理的管理應用程式範例，請參閱搭配 [使用 WQL 和指令碼語言與 Wmi 提供者進行設定管理](../../relational-databases/wmi-provider-configuration/using-wql-and-scripting-languages-with-the-wmi-provider.md)。  
  
 如需使用 WMI 提供者進行程式設計管理應用程式的詳細資訊，請參閱 .NET Framework SDK 中的 WMI 檔集 [!INCLUDE[msCoName](../../includes/msconame-md.md)] 。  
