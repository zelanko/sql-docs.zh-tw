...
ms.locfileid: "73779266"
---
# <a name="data-type-usage"></a>資料類型使用方式
[!INCLUDE[appliesto-ss-asdb-asdw-pdw-md](../../includes/appliesto-ss-asdb-asdw-pdw-md.md)]

  [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] Native Client ODBC 驅動程式和 [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] 會強加下列資料類型的使用。  
  
|資料類型|限制|  
|---------------|----------------|  
|日期常值|日期常值，儲存在 SQL_TYPE_TIMESTAMP 資料行中（[!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)]**日期時間**或**Smalldatetime**的資料類型）時，其時間值為12：00： 00.000 A.M。|  
...
|SQL_LONGVARBINARY、SQL_LONGVARCHAR、SQL_WLONGVARCHAR|當連接到 [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] 6 的實例時，會完全支援 SQL_LONGVARBINARY、SQL_LONGVARCHAR 或 SQL_WLONGVARCHAR 資料類型（使用 WHERE 子句）的資料行更新。*x*和更新版本。 當連接到 [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] 4.2*x*的實例時，會發生 S1000 錯誤「部分插入/更新」。 文字或影像資料行的插入/更新未成功」。<br /><br /> 注意： [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] Native Client ODBC 驅動程式支援連接至 [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] 6.5 和更早版本。|  
