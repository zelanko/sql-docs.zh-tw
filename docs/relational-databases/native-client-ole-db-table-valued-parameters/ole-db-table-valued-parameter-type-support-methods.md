...
|Isscommandwithparameters::|會設定資料表值參數所特有的屬性，例如結構描述名稱、類型名稱、資料行順序和預設資料行。<br /><br /> 取用者指定的參數序數*iOrdinal* SSPARAMPROPS 結構。 所要求的屬性集為 DBPROPSET_SQLSERVERPARAMETER。|  
