...
## <a name="see-also"></a>另請參閱  
 ...
 [表值參數列集建立](../../relational-databases/native-client-ole-db-table-valued-parameters/table-valued-parameter-rowset-creation.md)   
