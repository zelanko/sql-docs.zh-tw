---
description: 'Table-Valued SQL Server Native Client (OLE DB 中的參數) '
...
ms.locfileid: "97476009"
---
# <a name="table-valued-parameters--in-sql-server-native-client-ole-db"></a>Table-Valued SQL Server Native Client (OLE DB 中的參數) 
