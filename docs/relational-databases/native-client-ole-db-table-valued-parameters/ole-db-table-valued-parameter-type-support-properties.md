...
ms.locfileid: "87246730"
---
# <a name="ole-db-table-valued-parameter-type-support-in-sql-server-native-client-properties"></a>OLE DB SQL Server Native Client 中的資料表值參數類型支援（屬性）
