 ...
 **運算式產生器**  
 如果在 [尋找選項] 中選取 [使用] 核取方塊，[尋找目標] 方塊旁的三角形按鈕就會變成可用的。 按一下此按鈕，即可顯示萬用字元或規則運算式的清單，視選取的 **[使用]** 選項而定。 在此清單中選擇任何項目，會加入 **[尋找目標]** 方塊中所指定的字串。  
 ...
 **運算式產生器**  
 如果在 [尋找選項] 中選取 [使用] 核取方塊，[取代成] 方塊旁的三角形按鈕就會變成可用的。 按一下此按鈕，即可顯示萬用字元或規則運算式的清單，視選取的 **[使用]** 選項而定。 按一下此清單中的任何項目，將其加入 **[取代成]** 方塊中所指定的字串。  
