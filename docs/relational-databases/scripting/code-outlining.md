...
ms.topic: "article"
helpviewer_keywords: 
  - "查詢編輯器 [SQL Server Management Studio], 程式碼大綱"
  - "查詢編輯器 [SQL Server Management Studio], 隱藏程式碼"
...
### Analysis Services XMLA 查詢編輯器區域  
 ...
 ![具有內部隱藏節點的 XML 程式嗎](../../relational-databases/scripting/media/editoutlinexmlinnercol.png "具有內部隱藏節點的 XML 程式嗎")  
  
 當您將指標移至具有三個句號 (...) 的方塊上方時，已摺疊區域中的程式碼就會顯示在工具提示中，如下圖所示。  
  
 ![顯示隱藏程式碼的 XML 程式碼工具提示](../../relational-databases/scripting/media/editoutlinexmlmouse.gif "顯示隱藏程式碼的 XML 程式碼工具提示")  
  
 當您按一下 \<MiddleTag> 行的減號時，就會同時摺疊 MiddleTag 和 InnerTag，如下圖所示。  
  
 ![具有內部及中間隱藏標記的 XML 程式碼](../../relational-databases/scripting/media/editoutlinexmlmiddlecol.png "具有內部及中間隱藏標記的 XML 程式碼")  
  
 當您按一下 \<OuterTag> 行的減號時，就會摺疊這三行，如下圖所示。  
  
 ![顯示所以三個隱藏標記的 XML 程式碼](../../relational-databases/scripting/media/editoutlinexmloutercol.png "顯示所以三個隱藏標記的 XML 程式碼")  
