---
title: "疑難排解 IntelliSense (SQL Server Management Studio) | Microsoft Docs"
ms.custom: ""
ms.date: "03/14/2017"
...
ms.topic: "article"
helpviewer_keywords: 
  - "無法使用的選項 [IntelliSense]"
  - "IntelliSense [SQL Server], 疑難排解"
  - "IntelliSense [SQL Server], 無法使用的選項"
  - "疑難排解 [IntelliSense]"
...
manager: "jhubbard"
---
# 疑難排解 IntelliSense (SQL Server Management Studio)
