...
helpviewer_keywords: 
  - "大小寫須相符 [SQL Server]"
  - "恢復作業"
  - "搜尋 [SQL Server Management Studio]"
  - "取代文字"
  - "快速搜尋和取代 [SQL Server Management Studio]"
  - "查詢編輯器 [SQL Server Management Studio], 復原"
  - "查詢編輯器 [SQL Server Management Studio], 搜尋"
  - "規則運算式 [SQL Server Management Studio]"
  - "尋找文字 [SQL Server Management Studio]"
  - "文字 [SQL Server], 搜尋和取代作業"
  - "尋找 [SQL Server Management Studio]"
  - "尋找文字"
  - "查詢編輯器 [SQL Server Management Studio], 取代文字"
  - "尋找和取代對話方塊"
  - "萬用字元選項 [SQL Server Management Studio]"
  - "全字拼寫須相符 [SQL Server]"
  - "搜尋 [SQL Server Management Studio], 取代"
