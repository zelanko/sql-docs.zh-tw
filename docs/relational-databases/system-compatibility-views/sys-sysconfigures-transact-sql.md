...
|**狀態**|**smallint**|指示選項狀態的點陣圖。 可能的值如下：<br /><br /> 0 = 靜態。 設定在伺服器重新啟動時生效。<br /><br /> 1 = 動態。 變數在執行 RECONFIGURE 陳述式時生效。<br /><br /> 2 = 進階。 只有在已設定**show advanced 選項**時，才會顯示變數。 設定在伺服器重新啟動時生效。<br /><br /> 3 = 動態和進階。|  
