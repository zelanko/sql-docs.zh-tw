---
title: sys.sys進程（Transact-sql） |Microsoft Docs
ms.custom: ''
ms.date: 03/15/2017
ms.prod: sql
...
|page_resource |**binary （8）** |**適用於**：[!INCLUDE[sql-server-2019](../../includes/sssqlv15-md.md)] <br /><br /> 如果資料行包含頁面，則為頁面資源的8位元組十六進位標記法 `waitresource` 。 |  
