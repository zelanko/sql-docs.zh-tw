...
[!INCLUDE[tsql-appliesto-ss2008-xxxx-xxxx-xxx-md](../../../includes/tsql-appliesto-ss2008-xxxx-xxxx-xxx-md.md)]取得布林屬性，指定是否啟用伺服器網路通訊協定。  
...
## <a name="property-valuereturn-value"></a>屬性值/傳回值  
 布林值，指定是否啟用伺服器網路通訊協定： **true**如果已啟用伺服器網路通訊協定，或**false**如果已停用伺服器網路通訊協定。  
