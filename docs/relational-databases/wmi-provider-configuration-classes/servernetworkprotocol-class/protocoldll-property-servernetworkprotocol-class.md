---
title: "ProtocolDLL 屬性 （ServerNetworkProtocol 類別） |Microsoft 文件"
ms.custom: 
ms.date: 03/14/2017
...
[!INCLUDE[tsql-appliesto-ss2008-xxxx-xxxx-xxx-md](../../../includes/tsql-appliesto-ss2008-xxxx-xxxx-xxx-md.md)]取得伺服器網路通訊協定所需的.dll 檔案的名稱。  
