---
title: "PropertyType 屬性 （ServerNetworkProtocolProperty 類別） |Microsoft 文件"
ms.custom: 
ms.date: 03/14/2017
...
[!INCLUDE[tsql-appliesto-ss2008-xxxx-xxxx-xxx-md](../../../includes/tsql-appliesto-ss2008-xxxx-xxxx-xxx-md.md)]取得屬性的型別。  
