...
ms.locfileid: "47705713"
---
# <a name="clientsettings-class"></a>ClientSettings 類別
[!INCLUDE[tsql-appliesto-ss2008-xxxx-xxxx-xxx-md](../../includes/tsql-appliesto-ss2008-xxxx-xxxx-xxx-md.md)]
  [ClientSettings 類別](../../relational-databases/wmi-provider-configuration-classes/clientsettings-class.md)代表[!INCLUDE[msCoName](../../includes/msconame-md.md)][!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)]用戶端上的設定。  
