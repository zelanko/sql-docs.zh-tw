...
[!INCLUDE[tsql-appliesto-ss2008-xxxx-xxxx-xxx-md](../../../includes/tsql-appliesto-ss2008-xxxx-xxxx-xxx-md.md)]可讓用戶端網路通訊協定所指定[Configure Client Protocols](http://technet.microsoft.com/library/ms181035.aspx)。  
