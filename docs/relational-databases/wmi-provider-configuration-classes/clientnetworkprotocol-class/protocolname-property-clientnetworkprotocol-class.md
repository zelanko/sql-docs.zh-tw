...
[!INCLUDE[tsql-appliesto-ss2008-xxxx-xxxx-xxx-md](../../../includes/tsql-appliesto-ss2008-xxxx-xxxx-xxx-md.md)]取得所指定之目前網路通訊協定名稱[Configure Client Protocols](http://technet.microsoft.com/library/ms181035.aspx)。  
