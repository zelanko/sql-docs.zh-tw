---
description: ProtocolDisplayName 屬性 (ClientNetworkProtocol 類別)
title: 'ProtocolDisplayName 屬性 (ClientNetworkProtocol) '
...
[!INCLUDE [SQL Server](../../../includes/applies-to-version/sqlserver.md)]
  取得 [設定用戶端通訊](https://technet.microsoft.com/library/ms181035.aspx)協定所指定之用戶端網路通訊協定的顯示名稱。  
