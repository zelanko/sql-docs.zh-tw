---
title: "GeneralFlags 屬性 （ServerSettings 類別） |Microsoft 文件"
ms.custom: 
ms.date: 03/14/2017
...
[!INCLUDE[tsql-appliesto-ss2008-xxxx-xxxx-xxx-md](../../../includes/tsql-appliesto-ss2008-xxxx-xxxx-xxx-md.md)]取得執行個體相關聯之一般旗標[!INCLUDE[msCoName](../../../includes/msconame-md.md)] [!INCLUDE[ssNoVersion](../../../includes/ssnoversion-md.md)]。  
...
## <a name="property-valuereturn-value"></a>屬性值/傳回值  
 指定與 [執行個體相關之一般旗標的](../../../relational-databases/wmi-provider-configuration-classes/serversettingsgeneralflag-class/serversettingsgeneralflag-class.md) ServerSettingsGeneralFlag 類別 [!INCLUDE[ssNoVersion](../../../includes/ssnoversion-md.md)]物件陣列。  
