---
description: InstanceName 屬性 (ServerSettings 類別)
title: 'InstanceName 屬性 (ServerSettings) '
...
ms.locfileid: "88485116"
---
# <a name="instancename-property-serversettings-class"></a>InstanceName 屬性 (ServerSettings 類別)
[!INCLUDE [SQL Server](../../../includes/applies-to-version/sqlserver.md)]
  取得套用 [!INCLUDE[msCoName](../../../includes/msconame-md.md)] [!INCLUDE[ssNoVersion](../../../includes/ssnoversion-md.md)] 伺服器設定之的實例名稱。  
