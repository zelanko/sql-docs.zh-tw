---
title: ClientSettingsGeneralFlag 類別
ms.custom: ''
ms.date: 03/14/2017
ms.prod: sql
...
ms.locfileid: "73660671"
---
# <a name="clientsettingsgeneralflag-class"></a>ClientSettingsGeneralFlag 類別
[!INCLUDE[tsql-appliesto-ss2008-xxxx-xxxx-xxx-md](../../../includes/tsql-appliesto-ss2008-xxxx-xxxx-xxx-md.md)]
  [ClientSettingsGeneralFlag 類別](../../../relational-databases/wmi-provider-configuration-classes/clientsettingsgeneralflag-class/clientsettingsgeneralflag-class.md)代表 [!INCLUDE[msCoName](../../../includes/msconame-md.md)] [!INCLUDE[ssNoVersion](../../../includes/ssnoversion-md.md)] 用戶端實例上的一般旗標設定。  
