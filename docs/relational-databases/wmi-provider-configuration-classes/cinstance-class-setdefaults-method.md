---
description: CInstance 類別 - SetDefaults 方法
...
|參數|描述|  
|---------------|-----------------|  
|*OverwriteAll*|指定是否要覆寫用戶端實例上之現有值的布林值 [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] ： **true** 表示覆寫現有的資料，如果不覆寫現有的資料，則為 **false** 。|  
