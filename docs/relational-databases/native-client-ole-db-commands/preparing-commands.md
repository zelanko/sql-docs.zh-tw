---
description: 在 SQL Server Native Client 中準備命令
title: '準備命令 (Native Client OLE DB 提供者) '
ms.custom: ''
ms.date: 03/14/2017
ms.prod: sql
...
ms.locfileid: "97439879"
---
# <a name="preparing-commands-in-sql-server-native-client"></a>在 SQL Server Native Client 中準備命令
