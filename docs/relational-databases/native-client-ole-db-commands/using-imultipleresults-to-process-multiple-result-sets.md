...
ms.locfileid: "87242266"
---
# <a name="using-imultipleresults-to-process-multiple-result-sets-in-sql-server-native-client"></a>在 SQL Server Native Client 中使用 IMultipleResults 處理多個結果集
