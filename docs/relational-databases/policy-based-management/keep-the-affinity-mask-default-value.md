...
[!INCLUDE[appliesto-ss-xxxx-xxxx-xxx-md](../../includes/appliesto-ss-xxxx-xxxx-xxx-md.md)] 此規則會檢查親和性遮罩的 [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] 設定是否設定為預設值 0。 affinity mask 選項會動態控制 CPU 相似性。  
