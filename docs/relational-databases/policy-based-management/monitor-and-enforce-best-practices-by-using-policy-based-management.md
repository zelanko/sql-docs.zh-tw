...
|備份和資料檔位置|[備份檔案必須位在與資料庫檔案不同的裝置上](../Topic/Backup%20Files%20Must%20Be%20on%20Separate%20Devices%20from%20the%20Database%20Files.md)|  
...
|資料庫定序|[將使用者定義資料庫的定序設定為 master 和 model 資料庫的定序](../Topic/Set%20the%20Collation%20of%20User-defined%20Databases%20to%20Match%20Those%20of%20the%20master%20and%20model%20Databases.md)|  
