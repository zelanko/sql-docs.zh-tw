...
|備份和資料檔位置|[備份檔案必須位在與資料庫檔案不同的裝置上](../backup-restore/backup-devices-sql-server.md)|  
...
|資料庫定序|[將使用者定義資料庫的定序設定為 master 和 model 資料庫的定序](/previous-versions/sql/sql-server-2016/bb402915(v=sql.130))|  
