...
## <a name="for-more-information"></a>取得詳細資訊  
 [SQL Server 中平行處理原則最大程度組態選項的建議和指導方針](../../database-engine/configure-windows/configure-the-max-degree-of-parallelism-server-configuration-option.md)    
