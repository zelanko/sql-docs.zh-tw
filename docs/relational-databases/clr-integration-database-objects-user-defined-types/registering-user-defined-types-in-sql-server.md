...
### <a name="example"></a>範例  
 下列 [!INCLUDE[tsql](../../includes/tsql-md.md)] 必須以下列順序執行。 第一個資料表會參考**點**UDT 必須先卸除，然後類型，和最後的組件。  
