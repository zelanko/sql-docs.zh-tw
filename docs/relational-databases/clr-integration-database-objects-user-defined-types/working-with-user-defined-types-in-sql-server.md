...
ms.locfileid: "85727760"
---
# <a name="working-with-user-defined-types-in-sql-server"></a>使用 SQL Server 中的使用者定義型別
 [!INCLUDE [SQL Server](../../includes/applies-to-version/sqlserver.md)]
  您可以 [!INCLUDE[msCoName](../../includes/msconame-md.md)] [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] [!INCLUDE[tsql](../../includes/tsql-md.md)] 使用一般查詢語法，從語言存取中的使用者定義型別（UDT）功能。 在資料庫物件定義中，UDT 可當做 [!INCLUDE[tsql](../../includes/tsql-md.md)] 批次、函數及預存程序中的變數，以及函數及預存程序中的引數使用。  
