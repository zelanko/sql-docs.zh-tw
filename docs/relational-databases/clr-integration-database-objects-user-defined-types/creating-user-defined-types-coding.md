 ...
 **Microsoft.SqlServer.Server.SqlUserDefinedTypeAttribute**需要。 **Serializable**屬性是選擇性的。 您也可以指定**Microsoft.SqlServer.Server.SqlFacetAttribute**提供有關 UDT 的傳回型別資訊。 如需詳細資訊，請參閱[對 CLR 常式的自訂屬性](../../relational-databases/clr-integration/database-objects/clr-integration-custom-attributes-for-clr-routines.md)。  
