...
## 選項  
 **加入**  
 按一下以選取一種 「 發行者 」，若要加入，這樣會啟動 **連接到伺服器** 對話方塊。 選項包括：  
...
-   **加入 Oracle 發行者...**  
     ...
     使用 [!INCLUDE[msCoName](../../includes/msconame-md.md)] [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] 對話方塊，連接到與 Oracle 發行者相關聯的 **[連接到伺服器]** 對話方塊。  
 ...
 **移除**  
 在對話方塊中，頂端方格中選取發行者，然後按一下 **移除** 要加入的發行者清單中移除 「 發行者 」。  
  
> [!NOTE]  
>  此按鈕無法用來移除已顯示在複寫監視器中的發行者。 若要移除已顯示 「 發行者 」 以滑鼠右鍵按一下複寫監視器，然後按一下左窗格中的 「 發行者 」 **移除**。  
