...
description: 了解如何使用 SQL Server Management Studio、Transact-SQL 或 Replication Management Objects，在 SQL Server 中檢視及修改複寫安全性設定。
ms.custom: ''
ms.date: 03/16/2017
ms.prod: sql
...
2.  [發行集屬性 - \<Publication>] 對話方塊的 [代理程式安全性] 頁面。 如需有關存取這個對話方塊的詳細資訊，請參閱＜ [View and Modify Publication Properties](../../../relational-databases/replication/publish/view-and-modify-publication-properties.md)＞。  
  
3.  [訂閱屬性 - \<Subscription>] 對話方塊。 如需有關存取這個對話方塊的詳細資訊，請參閱＜ [View and Modify Push Subscription Properties](../../../relational-databases/replication/view-and-modify-push-subscription-properties.md) ＞與＜ [View and Modify Pull Subscription Properties](../../../relational-databases/replication/view-and-modify-pull-subscription-properties.md)＞。  
  
4.  [散發者屬性 - \<Distributor>] 和 [散發資料庫屬性 - \<Database>] 對話方塊。 如需存取這些對話方塊的詳細資訊，請參閱＜ [View and Modify Distributor and Publisher Properties](../../../relational-databases/replication/view-and-modify-distributor-and-publisher-properties.md)＞。  
  
5.  [發行者屬性 - \<Publisher>] 對話方塊。 如需存取此對話方塊的詳細資訊，請參閱＜ [View and Modify Distributor and Publisher Properties](../../../relational-databases/replication/view-and-modify-distributor-and-publisher-properties.md)＞。  
...
1.  在訂閱者端的 [訂閱屬性 - \<Subscription>] 對話方塊中，按一下 [發行者連線] 資料列，然後按一下資料列中的屬性 ( **&#x2026;** ) 按鈕。  
