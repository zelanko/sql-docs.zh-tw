...
# <a name="security-and-protection-replication"></a>安全性與保護 (複寫)
  協助保護在 [!INCLUDE[msCoName](../../../includes/msconame-md.md)] [!INCLUDE[ssNoVersion](../../../includes/ssnoversion-md.md)] 中所部署的複寫案例不受到惡意的攻擊，並提升資料的安全性。  
  
 ![小型檔案資料夾圖示](../../../analysis-services/media/filefolder-small.png "Small File Folder Icon") **安全性概觀**  
 ...
 ![小型檔案資料夾圖示](../../../analysis-services/media/filefolder-small.png "Small File Folder Icon") **安全程式開發**  
 ...
 ![小型檔案資料夾圖示](../../../analysis-services/media/filefolder-small.png "Small File Folder Icon") **安全的部署**  
 ...
 ![小型檔案資料夾圖示](../../../analysis-services/media/filefolder-small.png "Small File Folder Icon") **安全作業**  
