...
[!INCLUDE[appliesto-ss-xxxx-xxxx-xxx-md](../../includes/appliesto-ss-xxxx-xxxx-xxx-md.md)] 本節提供有關 [新增發行集精靈] 之下列頁面的資訊：  
  
-   [Oracle 發行者](../../relational-databases/replication/oracle-publisher.md)  
  
-   [管理密碼](../../relational-databases/replication/administrative-password.md)  
  
-   [發行集資料庫](../../relational-databases/replication/publication-database.md)  
  
-   [發行集類型](../../relational-databases/replication/publication-type.md)  
  
-   [訂閱者類型](../../relational-databases/replication/subscriber-types.md)  
...
-   [快照集代理程式 &#40;新增發行集精靈&#41;](../../relational-databases/replication/snapshot-agent-new-publication-wizard.md)  
