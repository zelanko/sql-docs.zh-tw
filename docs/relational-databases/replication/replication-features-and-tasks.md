...
[!INCLUDE[appliesto-ss-xxxx-xxxx-xxx-md](../../includes/appliesto-ss-xxxx-xxxx-xxx-md.md)] 尋找任何人 (設計師、開發人員、分析師或系統管理員) 設計及實作複寫解決方案所需的資訊。  
...
-   [複寫至 SQL 資料庫](../../relational-databases/replication/replication-to-sql-database.md)  
  
-   [複寫代理程式](../../relational-databases/replication/agents/replication-agents.md)  
...
##  <a name="Interoperability"></a> 複寫和高可用性功能的互通性  
