...
---
# 在 Oracle 發行者端建立的物件
  [!INCLUDE[msCoName](../../../includes/msconame-md.md)] [!INCLUDE[ssNoVersion](../../../includes/ssnoversion-md.md)] 複寫會以啟用變更追蹤和轉送 「 Oracle 發行者 」 上安裝資料庫物件 ([!INCLUDE[ssNoVersion](../../../includes/ssnoversion-md.md)] 不會安裝在 「 Oracle 發行者 」 上的任何二進位檔案)。 下表列出當「Oracle 發行者」在「[!INCLUDE[ssNoVersion](../../../includes/ssnoversion-md.md)] 散發者」端上識別為「發行者」時，在該「Oracle 發行者」端上建立的物件。 提供的物件描述僅供參考之用。 不應對這些物件進行修改。  
  
|Object Name|物件類型|描述|  
|-----------------|-----------------|-----------------|  
|HREPL_ArticleNlog_V|Table|用於儲存已發行資料表進行變更時的資訊之變更追蹤資料表。 每個已發行資料表都會建立變更追蹤資料表。|  
|HREPL_Changes|Table|Xactset 作業內部用於決定等待被指派至交易集之變更數量的資料表。 如需這項作業的詳細資訊，請參閱 [效能微調 Oracle 發行者](../../../relational-databases/replication/non-sql/performance-tuning-for-oracle-publishers.md)。|  
