...
## <a name="user-action"></a>使用者動作  
 ...
 使用 [sp_help_jobstep](../../relational-databases/system-stored-procedures/sp-help-jobstep-transact-sql.md) ，檢視要為指定複寫代理程式重試 **Run agent** 步驟的目前最大次數設定。 您可以使用 `@retry_attempts`sp_update_jobstep[ 預存程序的 ](../../relational-databases/system-stored-procedures/sp-update-jobstep-transact-sql.md) 參數來調整作業步驟重試次數。  
