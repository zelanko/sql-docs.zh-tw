...
> [!NOTE]  
>  未指定替代位置 (使用 **發行集屬性** 對話方塊或 [sp_changepublication & #40。Transact-SQL & #41;](../../relational-databases/system-stored-procedures/sp-changepublication-transact-sql.md))這是預設快照集資料夾位置相同。  
...
-   [!包含 [ssManStudioFull] (.../ Token/ssManStudioFull_md.md)]: [Specify an Alternate Snapshot Folder Location &#40;SQL Server Management Studio&#41;](../../relational-databases/replication/publish/specify-an-alternate-snapshot-folder-location-sql-server-management-studio.md)  
