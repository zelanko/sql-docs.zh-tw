---
title: 設定預先定義的複寫警示 (SSMS)
description: 了解如何使用 SQL Server Management Studio (SSMS) 設定預先定義的複寫警示
