 ...
 **加入 Oracle 發行者**  
 按一下即可啟動 **散發者屬性** 對話方塊。 在此對話方塊中，按一下 **[加入]**，然後按一下 **[加入 Oracle 發行者]**。 在 **[連接到伺服器]** 對話方塊中，指定 Oracle 伺服器名稱，以及複寫管理的使用者結構描述之登入和密碼。 如需詳細資訊，請參閱 [連接到伺服器 #40; Oracle & #41;、 登入](../../relational-databases/replication/connect-to-server-oracle-login.md)。  
