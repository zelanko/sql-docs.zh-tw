...
[!INCLUDE[appliesto-ss-asdbmi-xxxx-xxx-md](../../../includes/appliesto-ss-asdbmi-xxxx-xxx-md.md)]
  雙向異動複寫是一種特殊的異動複寫拓撲，它可讓兩台伺服器彼此之間交換變更：每台伺服器都會發行資料，然後向發行集訂閱另一台伺服器上相同的資料。 `@loopback_detection`sp_addsubscription &#40;Transact-SQL&#41;[ 的](../../../relational-databases/system-stored-procedures/sp-addsubscription-transact-sql.md) 參數已設定為 TRUE，以確定變更僅傳送到訂閱者而不會將變更傳回給發行者。  
