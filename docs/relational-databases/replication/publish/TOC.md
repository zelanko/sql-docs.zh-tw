...
# [設定佇列更新衝突解決選項 (SQL Server Management Studio)](set-queued-updating-conflict-resolution-options-sql-server-management-studio.md)
...
# [設定訂閱的逾期期限](set-the-expiration-period-for-subscriptions.md)
# [啟用交易式發行集的可更新訂閱](enable-updating-subscriptions-for-transactional-publications.md)
