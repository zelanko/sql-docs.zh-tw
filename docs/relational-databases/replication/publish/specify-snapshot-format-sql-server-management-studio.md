...
---
# 指定快照集格式 (SQL Server Management Studio)
  指定快照集格式上 **快照** 頁面 **發行集屬性-\< 發行集>** 對話方塊。 如需有關存取這個對話方塊的詳細資訊，請參閱＜ [View and Modify Publication Properties](../../../relational-databases/replication/publish/view-and-modify-publication-properties.md)＞。  
  
### 若要指定快照集格式  
  
1.  在 **快照** 頁面 **發行集屬性-\< 發行集>** 對話方塊中，選取 **原生 SQL Server-所有訂閱者必須是執行 SQL Server 伺服器** 或 **字元-如果發行者或訂閱者沒有執行 SQL Server 則需要**。  
