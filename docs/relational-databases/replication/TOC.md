...
# [新增功能 (複寫)](what-s-new-replication.md)  
# [複寫回溯相容性](replication-backward-compatibility.md)  
## [SQL Server 複寫中已過時的功能](deprecated-features-in-sql-server-replication.md)  
...
##### [透過 FTP 傳輸快照集](transfer-snapshots-through-ftp.md)  
...
#### [針對商務邏輯處理常式進行 偵錯 (複寫程式設計)](debug-a-business-logic-handler-replication-programming.md)  
...
#### [系統管理密碼](administrative-password.md)  
...
#### [連線到伺服器 (Oracle)，登入](connect-to-server-oracle-login.md)  
#### [連線到伺服器 (Oracle)，連線屬性](connect-to-server-oracle-connection-properties.md)  
...
# 疑難排解程式
## [尋找具有異動複寫的錯誤](troubleshoot-tran-repl-errors.md)
