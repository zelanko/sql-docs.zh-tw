...
ms.locfileid: "88455506"
---
# <a name="smo-programming-languages"></a>SMO 程式語言
[!INCLUDE [SQL Server ASDB, ASDBMI, ASDW ](../../includes/applies-to-version/sql-asdb-asdbmi-asa.md)]

  本節描述如何 [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] 在 [!INCLUDE[msCoName](../../includes/msconame-md.md)] Visual c # .net 中設計 (SMO) 的管理物件程式設計。
...
|[Visual C&#35; .NET 中的消費者入門](../../relational-databases/server-management-objects-smo/smo-programming-getting-started-in-visual-csharp-net.md)|提供有關如何使用 Visual C# .NET 開始編寫 SMO 程式的資訊。|  
 ...
 SMO 是一種 .NET 組件。 若要使用 [!INCLUDE[msCoName](../../includes/msconame-md.md)] .NET Framework 編寫程式，您必須選擇 Common Language Runtime 所支援的語言。 在 SMO 參考中，有 managed 語言（例如 Visual c # .NET）的語法。  
