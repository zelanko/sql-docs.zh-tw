...
[!INCLUDE[appliesto-ss-xxxx-xxxx-xxx-md](../../includes/appliesto-ss-xxxx-xxxx-xxx-md.md)]所有必要的 SQL Server 管理物件 (SMO) 元件內含在 Microsoft.SqlServer.SqlManagementObjects NuGet 封裝。 SMO 是實作於數個 Managed 組件中。 您可以在用戶端或伺服器上開發 SMO 應用程式。  
