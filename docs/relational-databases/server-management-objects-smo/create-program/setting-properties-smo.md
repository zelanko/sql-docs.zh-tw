...
## <a name="iterating-through-all-properties-of-an-object-in-visual-basic"></a>在 Visual Basic 中反覆運算物件的所有屬性  
 這個程式碼範例會逐一**屬性**集合<xref:Microsoft.SqlServer.Management.Smo.StoredProcedure>物件，並上顯示[!INCLUDE[vsprvs](../../../includes/vsprvs-md.md)]輸出畫面。  
