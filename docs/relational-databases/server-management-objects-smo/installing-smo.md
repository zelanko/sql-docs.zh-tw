...
## <a name="system-requirements"></a>系統需求
 ...
 SMO 需要 [!INCLUDE[dnprdnshort](../../includes/dnprdnshort-md.md)] 4.0 或 .NET Core 2.0 才能執行，因此使用它的任何應用程式都必須確定用戶端電腦已安裝該版本或更高版本。 使用 NetFx SMO 程式庫安裝的某些原生二進位檔也需要安裝 VC 2013 執行時間;該執行時間不會包含在封裝中。 您可以從 https://www.microsoft.com/download/details.aspx?id=40784 下載適用于您的目標架構的可轉散發套件
