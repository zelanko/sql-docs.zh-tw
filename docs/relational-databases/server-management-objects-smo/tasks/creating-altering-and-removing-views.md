...
[!INCLUDE[appliesto-ss-xxxx-xxxx-xxx-md](../../../includes/appliesto-ss-xxxx-xxxx-xxx-md.md)]在[!INCLUDE[ssNoVersion](../../../includes/ssnoversion-md.md)]管理物件 (SMO)[!INCLUDE[ssNoVersion](../../../includes/ssnoversion-md.md)]檢視都由<xref:Microsoft.SqlServer.Management.Smo.View>物件。  
