...
|CreateSPs|示範如何建立**選取**儲存選取的資料庫中的每個資料表的程序。|  
...
|SQLServerList|列舉可用的執行個體的清單[!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)]。|  
...
|觸發程序|顯示資料庫觸發程序。|  
|UtilityConversion|搭配**LoadRegAssembly**。 包含與 [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] 搭配使用的 Common Language Runtime (CLR) 示範函數。|  
