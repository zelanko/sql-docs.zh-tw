---
title: Blob 和 OLE 物件（Native Client OLE DB 提供者） |Microsoft Docs
ms.custom: ''
ms.date: 03/16/2017
ms.prod: sql
...
ms.locfileid: "87242298"
---
# <a name="blobs-and-ole-objects-in-sql-server-native-client"></a>SQL Server Native Client 中的 Blob 和 OLE 物件
