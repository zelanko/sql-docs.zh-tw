...
description: 瞭解 ODBC 呼叫 escape 序列，這是執行預存程式的慣用方法。 Native Client ODBC 驅動程式也支援交易 SQLEXECUTE。
ms.custom: ''
ms.date: 03/16/2017
ms.prod: sql
