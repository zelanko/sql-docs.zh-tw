...
|Datetime2|SQL_TYPE_TIMESTAMP<br /><br /> SQL_TIMESTAMP|'yyyy-mm-dd hh:mm:ss_.999999]<br /><br /> 您最多可以使用七位數選擇性地指定小數秒。|  
...
```  
 ...
 如果**timezone_hour**為負數,**則timezone_minute**必須為負數或零。 如果**timezone_hour**為正,**則timezone_minute**必須為正或為零。 如果**timezone_hour**為零,**則timezone_minute**的範圍 -59 到 +59 中可能具有任何值。  
