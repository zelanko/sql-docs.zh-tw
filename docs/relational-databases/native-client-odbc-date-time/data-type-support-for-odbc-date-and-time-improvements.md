...
```  
 ...
 如果**timezone_hour**是負數**timezone_minute**必須為負數或零。 如果**timezone_hour**是正數， **timezone_minute**必須是正數或零。 如果**timezone_hour**為零， **timezone_minute**可能-59 到 + 59 範圍內會有任何值。  
