...
## <a name="in-this-section"></a>本節內容  
 ...
 [增強型的日期和時間類型行為與前一個 SQL Server 版本 &#40; ODBC &#41;](../../relational-databases/native-client-odbc-date-time/enhanced-date-and-time-type-behavior-with-previous-sql-server-versions-odbc.md)  
