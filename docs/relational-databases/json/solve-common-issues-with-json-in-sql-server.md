...
### <a name="use-openjson-instead-of-jsonvalue-to-return-long-text-values"></a>請使用 OPENJSON 傳回長文字值，不要用 JSON_VALUE。  
...
### <a name="use-openjson-instead-of-jsonvalue-to-handle-duplicate-keys"></a>請使用 OPENJSON 處理重複的索引鍵，不要用 JSON_VALUE。  
