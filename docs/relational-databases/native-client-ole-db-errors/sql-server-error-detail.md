---
description: SQL Server Native Client 錯誤詳細資料
title: 'SQL Server (Native Client OLE DB 提供者的錯誤詳細資料) '
ms.custom: ''
ms.date: 03/16/2017
ms.prod: sql
