...
請考慮將資料庫變更為使用 PAGE_VERIFY CHECKSUM 選項。 如需 PAGE_VERIFY 的資訊，請參閱 [ALTER DATABASE &#40;Transact-SQL&#41;](~/t-sql/statements/alter-database-transact-sql-set-options.md)。  
