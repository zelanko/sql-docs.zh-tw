...
ms.author: mathoma
manager: craigg
ms.openlocfilehash: cb3d636ed72fa09858776950f8747e61b1b86a99
ms.sourcegitcommit: 61381ef939415fe019285def9450d7583df1fed0
ms.translationtype: HT
ms.contentlocale: zh-TW
ms.lasthandoff: 10/01/2018
ms.locfileid: "47659416"
---
...
|事件來源|MSSQLSERVER|  
|元件|SQLEngine|  
|符號名稱|DBCC3_IAM_PAGE_RANGE_IN_WRONG_FILEGROUP|  
|訊息文字|物件識別碼 O_ID，索引識別碼 I_ID，分割區識別碼 PN_ID，配置單位識別碼 A_ID (類型 TYPE) 的 IAM 頁面 P_ID 控制應該是位於檔案群組 FG_ID2，卻位於檔案群組 FG_ID1 的頁面。|  
  
## <a name="explanation"></a>說明  
檔案群組 *FG_ID1* 中的索引配置對應 (IAM) 頁面 *P_ID* 錯誤地將檔案群組 *FG_ID2* 的範圍包含在內。 IAM 頁面的所有範圍都應該和 IAM 頁面本身位於同一個檔案群組。  
