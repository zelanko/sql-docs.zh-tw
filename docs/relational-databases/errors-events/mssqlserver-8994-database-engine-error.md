...
ms.author: mathoma
manager: craigg
ms.openlocfilehash: e121fb31eb3c9de8865e6c3fd2beb4f3a98a0e18
ms.sourcegitcommit: ee661730fb695774b9c483c3dd0a6c314e17ddf8
ms.translationtype: HT
ms.contentlocale: zh-TW
ms.lasthandoff: 05/19/2018
ms.locfileid: "34326119"
---
...
|事件來源|MSSQLSERVER|  
|元件|SQLEngine|  
|符號名稱|DBCC3_MISSING_FORWARDING_ROW|  
|訊息文字|物件識別碼 O_ID，轉送資料列頁面 P_ID1，位置 S_ID1 應該由轉送資料列頁面 P_ID2，位置 S_ID2 所指向。 沒有遇到轉送資料列。 可能是配置錯誤。|  
  
## <a name="explanation"></a>說明  
堆積中的轉送資料列遺漏了應該指向它的轉送資料列。  
