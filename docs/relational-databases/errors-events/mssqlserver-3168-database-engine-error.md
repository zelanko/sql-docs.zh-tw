...
[還原系統資料庫 &#40;SQL Server&#41; 的限制](~/relational-databases/backup-restore/back-up-and-restore-of-system-databases-sql-server.md#limitations-on-restoring-system-databases)  
