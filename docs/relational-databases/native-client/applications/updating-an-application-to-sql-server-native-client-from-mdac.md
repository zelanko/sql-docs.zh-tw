---
title: 從 MDAC 更新
description: 從 Windows 資料存取元件升級至 SQL Server Native Client，這會以回溯相容性來公開 SQL Server 2005 的新功能。
ms.custom: ''
ms.date: 03/14/2017
ms.prod: sql
ms.reviewer: ''
...
-   [!INCLUDE[ssNoVersion](../../../includes/ssnoversion-md.md)] Native Client 不包含 XML 整合。 [!INCLUDE[ssNoVersion](../../../includes/ssnoversion-md.md)]Native Client 支援 SELECT .。。FOR XML 查詢，但不支援任何其他 XML 功能。 不過， [!INCLUDE[ssNoVersion](../../../includes/ssnoversion-md.md)] Native Client 支援中引進的**xml**資料類型 [!INCLUDE[ssVersion2005](../../../includes/ssversion2005-md.md)] 。  
...
-   MDAC 連接字串允許針對 **Trusted_Connection** 關鍵字使用布林值 (**true**)。 [!INCLUDE[ssNoVersion](../../../includes/ssnoversion-md.md)]Native Client 連接字串必須使用 **[是] 或 [** **否**]。  
