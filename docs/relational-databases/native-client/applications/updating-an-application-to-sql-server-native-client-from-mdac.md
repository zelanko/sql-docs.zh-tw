---
title: Native Client，從 MDAC 更新應用程式 SQL
ms.custom: ''
ms.date: 03/14/2017
ms.prod: sql
ms.reviewer: ''
...
[!INCLUDE[appliesto-ss-asdb-asdw-pdw-md](../../../includes/appliesto-ss-asdb-asdw-pdw-md.md)]
 ...
 本主題的資訊可幫助您更新 MDAC (或 Windows DAC) 應用程式，使其保持為 [!INCLUDE[ssNoVersion](../../../includes/ssnoversion-md.md)] 中隨附的最新 [!INCLUDE[ssVersion2005](../../../includes/ssversion2005-md.md)] Native Client 版本。 若要協助您將此應用程式與隨附的[!INCLUDE[ssNoVersion](../../../includes/ssnoversion-md.md)] Native client 版本做為最[!INCLUDE[ssCurrent](../../../includes/sscurrent-md.md)]新，請參閱[從 SQL Server 2005 native client 更新應用程式](../../../relational-databases/native-client/applications/updating-an-application-from-sql-server-2005-native-client.md)。  
...
-   MDAC 連接字串允許**Trusted_Connection**關鍵字的布林值（**true**）。 Native Client 連接字串必須使用 **[是] 或 [否]** 。 **** [!INCLUDE[ssNoVersion](../../../includes/ssnoversion-md.md)]  
...
-   資料類型**Varchar （max）**、 **Nvarchar （max）**、 **Varbinary （max）**、 **xml**、 **udt**或其他大型物件類型的傳回值，不能傳回到早于[!INCLUDE[ssVersion2005](../../../includes/ssversion2005-md.md)]的用戶端版本。 如果您想要使用這些類型當做傳回值，則必須使用 [!INCLUDE[ssNoVersion](../../../includes/ssnoversion-md.md)] Native Client。  
...
-   如果您使用 ODBC 或 OLE DB 呼叫來開始交易，[!INCLUDE[ssNoVersion](../../../includes/ssnoversion-md.md)] Native Client 與 MDAC 之間會有行為上的差異；使用 [!INCLUDE[ssNoVersion](../../../includes/ssnoversion-md.md)] Native Client 時會立即開始交易，但是使用 MDAC 時會在初次存取資料庫之後開始交易。 這可能會影響預存程式和批次的[!INCLUDE[ssNoVersion](../../../includes/ssnoversion-md.md)]行為\@ \@，因為在批次或預存程式完成執行之後，需要 TRANCOUNT 是相同的，就像批次或預存程式啟動時一樣。  
...
-   當您使用[!INCLUDE[ssNoVersion](../../../includes/ssnoversion-md.md)] Native Client 驅動程式搭配 system.string 來存取公開新[!INCLUDE[ssNoVersion](../../../includes/ssnoversion-md.md)] [!INCLUDE[ssNoVersion](../../../includes/ssnoversion-md.md)]的特定資料類型或功能的伺服器電腦時，可能會遇到錯誤。 System.string 提供一般的 ODBC 執行，並隨後不會公開廠商特有的功能或延伸模組。 （ [!INCLUDE[ssNoVersion](../../../includes/ssnoversion-md.md)] Native Client 驅動程式已更新為原本就支援最[!INCLUDE[ssNoVersion](../../../includes/ssnoversion-md.md)]新功能）。若要解決這個問題，您可以還原為 MDAC，或遷移至 SqlClient。  
