...
|**sp_columns** 預存程序現在會針對 IS_NULLABLE 資料行傳回 **"NO"**，而非 **"NO "**。|[!INCLUDE[ssNoVersion](../../../includes/ssnoversion-md.md)]從 Native Client[!INCLUDE[ssKatmai](../../../includes/sskatmai-md.md)]10.0 （）開始， **sp_columns**預存程式現在會針對 IS_NullABLE 資料行傳回 **"no"** ，而不是 **"no"** 。|  
