...
[!INCLUDE[appliesto-ss-asdb-asdw-pdw-md](../../../includes/appliesto-ss-asdb-asdw-pdw-md.md)]
  ...
  [!INCLUDE[ssNoVersion](../../../includes/ssnoversion-md.md)] Native Client 標頭檔與程式庫檔案會與 [!INCLUDE[ssNoVersion](../../../includes/ssnoversion-md.md)] 一起安裝。 開發應用程式時，將開發所需的所有檔案複製並安裝到您的開發環境相當重要。 如需有關安裝和轉散發 [!INCLUDE[ssNoVersion](../../../includes/ssnoversion-md.md)] Native Client 的詳細資訊，請參閱[安裝 SQL Server Native Client](../../../relational-databases/native-client/applications/installing-sql-server-native-client.md)。  
...
## <a name="using-the-sql-server-native-client-header-file"></a>使用 SQL Server Native Client 標頭檔  
 若要使用 [!INCLUDE[ssNoVersion](../../../includes/ssnoversion-md.md)] Native Client 標頭檔，您必須在 C /C++程式設計程式碼中使用 include 語句。 下列章節描述如何同時針對 OLE DB 和 ODBC 應用程式執行此動作。  
...
> [!NOTE]  
>  如果應用程式同時使用 OLE DB 和 ODBC API，以上顯示的第一行程式碼應該省略。 此外，如果應用程式具有 sqloledb 的**include**語句，sqlncli 的**include**語句就必須在它之後。  
...
## <a name="static-linking-and-bcp-functions"></a>靜態連結與 BCP 函數  
 ...
 如需詳細資訊，請參閱執行[大量複製作業](../../../relational-databases/native-client/features/performing-bulk-copy-operations.md)。  
