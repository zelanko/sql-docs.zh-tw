...
[!INCLUDE [SQL Server](../../../includes/applies-to-version/sql-asdb-asdbmi-asa-pdw.md)]
  ...
  如需示範如何使用 Native Client 連接到的 [!INCLUDE[ssSDSfull](../../../includes/sssdsfull-md.md)] 範例 [!INCLUDE[ssNoVersion](../../../includes/ssnoversion-md.md)] ，請參閱 [開發：使用說明主題 (Azure SQL Database) ](https://msdn.microsoft.com/library/ee621787.aspx)。  
