...
|sqlncli11.lib|直接呼叫屬於[!INCLUDE[ssNoVersion](../../../includes/ssnoversion-md.md)] NATIVE Client ODBC 驅動程式一部分之**bcp**公用程式函式所需的程式庫檔案。<br /><br /> 注意：如果您在程式碼中參考 sqlncli11 檔案，則必須確定 sqlncli11 檔案位於您的系統路徑中，以及使用您的應用程式之使用者的系統路徑中。|  
