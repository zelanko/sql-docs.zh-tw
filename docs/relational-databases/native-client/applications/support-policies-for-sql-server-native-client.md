...
## <a name="ado-support-policies"></a>ADO 支援原則  
 ...
 ADO 應用程式可以使用 [!INCLUDE[ssVersion2005](../../../includes/ssversion2005-md.md)]中包含的 [!INCLUDE[ssNoVersion](../../../includes/ssnoversion-md.md)] Native Client 版本。 ADO 應用程式也可以使用 [!INCLUDE[ssNoVersion](../../../includes/ssnoversion-md.md)] Native Client 11.0 (隨附於 [!INCLUDE[ssSQL14](../../../includes/sssql14-md.md)])，但是如果它們這樣做，就必須在連接字串中指定 `DataTypeCompatibility=80`。 當連接字串中存在 [!INCLUDE[ssVersion2005](../../../includes/ssversion2005-md.md)] 時，只能使用 `DataTypeCompatibility=80` 的功能。  
...
## <a name="ole-db-support-policies"></a>OLE DB 支援原則  
 ...
 如果未經認證可搭配 [!INCLUDE[ssNoVersion](../../../includes/ssnoversion-md.md)] Native Client 使用的 OLE DB 應用程式在其連接字串中指定了 [!INCLUDE[ssNoVersion](../../../includes/ssnoversion-md.md)]，它們就可以使用 `DataTypeCompatibility=80` Native Client。  
  
 如果使用 OLE DB 服務元件的 OLE DB 應用程式在其連接字串中指定了 [!INCLUDE[ssNoVersion](../../../includes/ssnoversion-md.md)]，它們就只能使用 `DataTypeCompatibility=80` Native Client。 不過，在此情況下，不會提供 [!INCLUDE[ssVersion2005](../../../includes/ssversion2005-md.md)] 之後新增的功能。  
