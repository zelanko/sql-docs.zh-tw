---
title: OLE DB
description: SQL Server Native Client OLE DB 提供者是用來存取資料的 COM API，用於工具、公用程式或需要高效能的低層級元件。
ms.custom: ''
ms.date: 03/17/2017
ms.prod: sql
