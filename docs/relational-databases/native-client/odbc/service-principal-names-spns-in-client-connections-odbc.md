---
title: 用戶端連接中的服務主體名稱（Spn）（ODBC） |Microsoft Docs
ms.custom: ''
ms.date: 03/14/2017
ms.prod: sql
...
ms.locfileid: "73787961"
---
# <a name="service-principal-names-spns-in-client-connections-odbc"></a>用戶端連接 (ODBC) 中的服務主要名稱 (SPN)
[!INCLUDE[appliesto-ss-asdb-asdw-pdw-md](../../../includes/appliesto-ss-asdb-asdw-pdw-md.md)]

  本主題描述可在用戶端應用程式內支援服務主要名稱 (SPN) 的 ODBC 屬性和函數。 如需有關用戶端應用程式中 Spn 的詳細資訊，請參閱[用戶端連接中的服務主體名稱&#40;SPN&#41;支援](../../../relational-databases/native-client/features/service-principal-name-spn-support-in-client-connections.md)和[取得相互 Kerberos 驗證](../../../relational-databases/native-client-odbc-how-to/get-mutual-kerberos-authentication.md)。  
