...
[!INCLUDE[appliesto-ss-asdb-asdw-pdw-md](../../../includes/appliesto-ss-asdb-asdw-pdw-md.md)]
 ...
 如需有關資料表值參數和 ODBC 的詳細資訊，請參閱[資料表&#40;值&#41;參數 odbc](../../../relational-databases/native-client-odbc-table-valued-parameters/table-valued-parameters-odbc.md)。  
  
 如需有關資料表值參數和 OLE DB 的詳細資訊，請參閱[資料表&#40;值&#41;參數 OLE DB](../../../relational-databases/native-client-ole-db-table-valued-parameters/table-valued-parameters-ole-db.md)。  
