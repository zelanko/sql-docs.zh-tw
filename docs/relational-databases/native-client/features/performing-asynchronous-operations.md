...
>   
>  此外，遠端 proxy/stub dll （在 MDAC 2.8 中）無法在 [!INCLUDE[ssNoVersion](../../../includes/ssnoversion-md.md)] Native Client 中呼叫**ISSAsynchStatus**介面。 **ISSAsynchStatus** 介面不會透過遠端公開。  
>   
