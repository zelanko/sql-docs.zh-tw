...
### <a name="sqlgettypeinfo"></a>SQLGetTypeInfo  
 Native Client ODBC 驅動程式會將 SQL_SS_LENGTH_UNLIMITED 報告為 SQLGetTypeInfo 函數中**xml**資料類型的最大 COLUMN_SIZE。 [](../../../relational-databases/native-client-odbc-api/sqlgettypeinfo.md) [!INCLUDE[ssNoVersion](../../../includes/ssnoversion-md.md)]  
