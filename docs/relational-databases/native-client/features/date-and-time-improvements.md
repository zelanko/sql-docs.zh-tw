---
description: SQL Server Native Client 的日期和時間改進
...
ms.locfileid: "88498988"
---
# <a name="sql-server-native-client-date-and-time-improvements"></a>SQL Server Native Client 的日期和時間改進
[!INCLUDE [SQL Server](../../../includes/applies-to-version/sql-asdb-asdbmi-asa-pdw.md)]
 ...
 如需日期/時間改善的詳細資訊，請參閱 [日期和時間改善 &#40;OLE DB&#41;](../../../relational-databases/native-client-ole-db-date-time/date-and-time-improvements-ole-db.md) 和 [&#40;ODBC&#41;的日期和時間改進 ](../../../relational-databases/native-client-odbc-date-time/date-and-time-improvements-odbc.md)。  
