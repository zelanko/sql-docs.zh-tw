# [概觀](system-functions-for-transact-sql.md)  
# [AlwaysOn 可用性群組](always-on-availability-groups-functions-transact-sql.md)  
...
# [異動資料擷取](change-data-capture-functions-transact-sql.md)  
## [cdc.fn_cdc_get_all_changes_ < 執行個體 >](cdc-fn-cdc-get-all-changes-capture-instance-transact-sql.md)  
## [cdc.fn_cdc_get_net_changes_ < 執行個體 >](cdc-fn-cdc-get-net-changes-capture-instance-transact-sql.md)  
...
## [sys.fn_all_changes_ < 執行個體 >](sys-fn-all-changes-capture-instance-transact-sql.md)  
## [sys.fn_net_changes_ < 執行個體 >](sys-fn-net-changes-capture-instance-transact-sql.md)  
# [變更追蹤](change-tracking-functions-transact-sql.md)  
...
## [CHANGE_TRACKING_CONTEXT WITH 與](with-change-tracking-context-transact-sql.md)  
# [資料收集器](data-collector-functions-transact-sql.md)  
## [f](fn-syscollector-get-execution-details-transact-sql.md)  
...
# [Filestream 和 FileTable](filestream-and-filetable-functions-transact-sql.md)  
...
## [路徑名稱](pathname-transact-sql.md)  
# [受管理備份](managed-backup-functions-transact-sql.md)  
...
# [全文檢索搜尋和語意搜尋](full-text-search-and-semantic-search-functions-transact-sql.md)  
...
# [系統中繼資料](system-metadata-functions.md)  
...
# [系統安全性](system-security-functions.md)  
...
# [系統追蹤](system-trace-functions.md)  
...
## [sys.fn_trace_geteventinfo](sys-fn-trace-getinfo-transact-sql.md)  
