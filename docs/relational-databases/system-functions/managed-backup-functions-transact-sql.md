---
title: Managed Backup 函數（Transact-sql） |Microsoft Docs
ms.custom: ''
ms.date: 03/14/2017
ms.prod: sql
...
ms.locfileid: "68140616"
---
# <a name="managed-backup-functions-transact-sql"></a>Managed Backup 函數（Transact-sql）
[!INCLUDE[tsql-appliesto-ss2016-xxxx-xxxx-xxx-md](../../includes/tsql-appliesto-ss2016-xxxx-xxxx-xxx-md.md)]

  [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)]提供的下列函式[!INCLUDE[ss_smartbackup](../../includes/ss-smartbackup-md.md)]。  
