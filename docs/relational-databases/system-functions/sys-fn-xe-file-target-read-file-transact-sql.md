...
## <a name="remarks"></a>備註  
 藉由在中[!INCLUDE[ssManStudio](../../includes/ssmanstudio-md.md)]執行**fn_xe_file_target_read_file**來讀取大型結果集，可能會導致錯誤。 使用 [**結果至**檔案模式] （**Ctrl + Shift + F**）將大型結果集匯出至檔案，並改為使用其他工具來讀取檔案。  
