...
> [!Note]
> 針對 fn_helpcollations ( # A1 的 Azure SQL 資料倉儲查詢必須在 master 資料庫中執行。  
...
[適用于 Azure SQL 資料倉儲的資料庫定序支援](https://azure.microsoft.com/blog/database-collation-support-for-azure-sql-data-warehouse-2)  
