---
title: "Database Mail 組態物件 | Microsoft Docs"
ms.custom: ""
ms.date: "03/14/2017"
...
helpviewer_keywords: 
  - "Database Mail [SQL Server], 組態物件"
  - "Database Mail [SQL Server], 帳戶"
  - "組態物件 [Database Mail]"
  - "Database Mail [SQL Server], 設定檔"
...
-   [Database Mail 組態物件關聯性](#VisualElement)  
  
-   [Database Mail 帳戶](#DBAccount)  
  
-   [Database Mail 設定檔](#DBProfile)  
  
-   [Database Mail 組態工作](#RelatedTasks)  
  
-   [其他 Database Mail 組態工作 (系統預存程序)](#Add_Tasks)  
