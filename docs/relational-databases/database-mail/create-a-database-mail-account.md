...
[!INCLUDE[appliesto-ss-xxxx-xxxx-xxx-md](../../includes/appliesto-ss-xxxx-xxxx-xxx-md.md)] 您可以使用 [Database Mail 設定精靈] 或 [!INCLUDE[tsql](../../includes/tsql-md.md)] 來建立 Database Mail 帳戶。  
