...
ms.openlocfilehash: 62868167a20bb8619f62bf6a009708a6248523a4
...
[!INCLUDE[SNAC_Deprecated](../../includes/snac-deprecated.md)]
  ...
  當擷取和更新資料透過[!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)]資料指標， [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] Native Client OLE DB 提供者取用者應用程式受限於相同考量和條件約束套用至任何其他用戶端應用程式。  
