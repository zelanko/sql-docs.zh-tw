---
title: 監視及疑難排解受管理的資料庫物件
description: 可以用來監視和疑難排解 managed 資料庫物件和元件 (CLR) 的工具相關資訊。
...
|Event - 事件|描述|  
|-----------|-----------------|  
|[Assembly Load 事件類別](../event-classes/sql-server-event-class-reference.md)|用於監視組件載入要求 (成功或失敗)。|  
...
|目錄檢視|描述|  
|------------------|-----------------|  
|[sys. 元件 &#40;Transact-sql&#41;](../../relational-databases/system-catalog-views/sys-assemblies-transact-sql.md)|傳回資料庫中註冊之組件的相關資訊。|  
...
## <a name="dynamic-management-views"></a>動態管理檢視  
 動態管理檢視和函數傳回伺服器狀態資訊，這項資訊可用來監視伺服器執行個體的健全狀況、診斷問題和調整效能。 如需詳細資訊，請參閱 [&#40;transact-sql&#41;的動態管理檢視和函數 ](~/relational-databases/system-dynamic-management-views/system-dynamic-management-views.md)。  
