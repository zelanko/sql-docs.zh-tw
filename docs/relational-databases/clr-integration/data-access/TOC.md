# [從 CLR 資料庫物件進行資料存取](data-access-from-clr-database-objects.md)

# [同處理序 ADO.NET +](../../../relational-databases/clr-integration-data-access-in-process-ado-net/sql-server-in-process-specific-extensions-to-ado-net.md)
