...
description: 本文說明使用與 .NET Framework CLR 的 Microsoft SQL Server 整合來編譯資料庫物件所需的命名空間和程式庫。
ms.custom: ''
ms.date: 08/02/2016
ms.prod: sql
ms.reviewer: ''
...
將此程式編譯為程式庫，並將其載入 [!INCLUDE[ssNoVersion](../../../includes/ssnoversion-md.md)] ，並以預存程式的形式執行。  
