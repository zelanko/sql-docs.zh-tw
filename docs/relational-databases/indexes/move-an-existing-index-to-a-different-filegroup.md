...
7.  選取要移動索引的檔案群組。  
     ...
     如果資料表或索引已分割，請選取移動索引所使用的分割區配置。 如需有關分割區索引的詳細資訊，請參閱＜ [Partitioned Tables and Indexes](../../relational-databases/partitions/partitioned-tables-and-indexes.md)＞。  
