...
> [!IMPORTANT]  
>  如果運算式一定會針對指定的輸入集傳回相同的結果，這些運算式就具有決定性。 [COLUMNPROPERTY](../../t-sql/functions/columnproperty-transact-sql.md) 函數的 **IsDeterministic** 屬性會報告 *computed_column_expression* 是否具決定性。  
