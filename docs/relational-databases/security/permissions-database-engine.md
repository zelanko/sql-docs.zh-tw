...
|DATABASE|ALTER ANY SENSITIVITY CLASSIFICATION|ALSP<br />適用於 [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] (SQL Server 2019 (15.x) 到最新版本)，SQL Database。|DATABASE|CONTROL SERVER|
