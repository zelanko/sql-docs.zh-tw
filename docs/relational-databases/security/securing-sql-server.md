...
# 保護 SQL Server 的安全
 ...
 您可以在 [SQL Server](http://go.microsoft.com/fwlink/?LinkID=31629) 網站上找到有關 [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] 安全性的詳細資訊。 這包括最佳作法指南和安全性檢查清單。 該網站也提供了最新的 Service Pack 資訊和下載檔。  
...
|設定要搭配使用的防火牆 [!INCLUDE[ssISnoversion](../../includes/ssisnoversion-md.md)]|[針對 SSIS 服務的存取設定 Windows 防火牆](../../integration-services/service/configure-a-windows-firewall-for-access-to-the-ssis-service.md)|  
...
|如需詳細資訊|請參閱|  
|---------------------------|---------|  
|連接、設定與控制 [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)]|[使用 SQL Server Management Studio](../../ssms/use-sql-server-management-studio.md)|  
