...
[!INCLUDE[appliesto-ss-xxxx-xxxx-xxx-md](../../../includes/appliesto-ss-xxxx-xxxx-xxx-md.md)] 本主題描述如何使用 [!INCLUDE[ssManStudioFull](../../../includes/ssmanstudiofull-md.md)] 登入 [!INCLUDE[ssCurrent](../../../includes/sscurrent-md.md)]，以檢視 SQL Server 稽核記錄。  
