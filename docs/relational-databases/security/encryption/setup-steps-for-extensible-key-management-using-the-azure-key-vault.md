...
-   安裝最新 [Azure PowerShell](https://azure.microsoft.com/documentation/articles/powershell-install-configure/) (5.2.0 或更新版本)。  
...
3.  **使用下列項目來註冊 (建立) [!INCLUDE[ssNoVersion](../../../includes/ssnoversion-md.md)] 連接器作為 EKM 提供者： [!INCLUDE[ssNoVersion](../../../includes/ssnoversion-md.md)]**  
     ...
     -- 使用本身為 Azure Key Vault 之 EKM 提供者的 [!INCLUDE[ssNoVersion](../../../includes/ssnoversion-md.md)] 連接器，建立密碼編譯提供者。    
...
5.  **開啟 Azure 金鑰保存庫金鑰於 [!INCLUDE[ssNoVersion](../../../includes/ssnoversion-md.md)]**  
     ...
     無論您建立了新的金鑰，或匯入了如第 II 部分所述的非對稱金鑰，您都需要開啟金鑰。 請在下列 [!INCLUDE[tsql](../../../includes/tsql-md.md)] 指令碼中提供您的金鑰名稱來開啟金鑰。  
