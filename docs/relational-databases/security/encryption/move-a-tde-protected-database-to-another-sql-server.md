...
3.  在物件總管中，以滑鼠右鍵按一下 [資料庫] 資料夾，然後選取 [新增資料庫]。  
...
1.  在物件總管中，以滑鼠右鍵按一下上方加密的資料庫，指向 [工作]，然後選取 [卸離…]。  
...
7.  在 [!INCLUDE[ssManStudioFull](../../../includes/ssmanstudiofull-md.md)] 的物件總管中，以滑鼠右鍵按一下 [資料庫] 資料夾，然後選取 [附加…]。  
