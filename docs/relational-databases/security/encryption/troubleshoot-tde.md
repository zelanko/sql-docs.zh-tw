...
ms.locfileid: "66718092"
---
# <a name="common-errors-and-resolutions-with-transparent-data-encryption-tde-with-customer-managed-keys-in-azure-key-vault-akv"></a>使用 Azure Key Vault (AKV) 客戶受控金鑰進行透明資料加密 (TDE) 的常見錯誤和解決方案
