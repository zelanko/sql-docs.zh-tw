...
ms.topic: "article"
helpviewer_keywords: 
  - "應用程式角色 [SQL Server], 關於應用程式角色"
  - "主體 [SQL Server], 應用程式角色"
  - "認證 [SQL Server], 角色"
  - "應用程式角色 [SQL Server]"
  - "角色 [SQL Server], 應用程式"
  - "權限 [SQL Server], 角色"
  - "使用者 [SQL Server], 應用程式角色"
  - "驗證 [SQL Server], 角色"
  - "群組 [SQL Server], 角色"
...
# 應用程式角色
 ...
 在 [!INCLUDE[ssNoVersion](../../../includes/ssnoversion-md.md)] 中，因為應用程式角色未與伺服器層級主體產生關聯，所以應用程式角色無法存取伺服器層級中繼資料。 若要停用這項限制，並藉此允許應用程式角色存取伺服器層級中繼資料，請設定全域旗標 4616。 如需詳細資訊，請參閱[追蹤旗標 &#40;Transact-SQL&#41;](../Topic/Trace%20Flags%20\(Transact-SQL\).md) 和 [DBCC TRACEON &#40;Transact-SQL&#41;](../../../t-sql/database-console-commands/dbcc-traceon-transact-sql.md)。  
