...
靜態資料遮罩推出為 [SQL Server Management Studio](../../ssms/sql-server-management-studio-ssms.md) 18.0 Preview 5 和更新版本的元件。 
> [!IMPORTANT]
> 我們已決定我們目前的原型不符合我們客戶的期望。 因此我們將來不再提供此功能。 如果有替代候選項目，我們將會通知您我們的計劃。
>
