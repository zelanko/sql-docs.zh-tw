...
>  空間索引的空間分解與應用程式資料使用的度量單位無關。  
 ...
 ![將多邊形和線條放到 4x4 層級 1 方格內](../../relational-databases/spatial/media/spndx-level-1-objects.png "將多邊形和線條放到 4x4 層級 1 方格內")  
...
3.  聯結扁平化的金字塔，以形成非 Euclidean 平面。  
 ...
 ![將橢圓體投射到平面上](../../relational-databases/spatial/media/spndx-geodetic-projection.png "將橢圓體投射到平面上")  
