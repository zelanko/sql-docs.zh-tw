...
8.  在 [從 \<table name> 選取資料行] 對話方塊中，選取相對應核取方塊來選取 **geometry** 或 **geography** 類型的資料行。 任何其他的空間資料行就會變成無法編輯。 如果您想要選取不同的空間資料行，就必須先清除目前選取的資料行。 完成後，請按一下 **[確定]** 。  
