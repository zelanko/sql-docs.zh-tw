...
ms.topic: "article"
helpviewer_keywords: 
  - "geometry 資料類型 [SQL Server], 了解"
  - "geography 資料類型 [SQL Server], 空間資料"
  - "平面空間資料 [SQL Server], geometry 資料類型"
  - "空間資料類型 [SQL Server]"
...
### LineString 和 CircularString 的比較  
...
### LineString 和 CompoundCurve 的比較  
...
### CircularString 和 CompoundCurve 的比較  
