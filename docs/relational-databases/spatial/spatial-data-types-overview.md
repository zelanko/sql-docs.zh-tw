...
[!INCLUDE[appliesto-ss-asdb-xxxx-xxx-md](../../includes/appliesto-ss-asdb-xxxx-xxx-md.md)]
 ...
 -  
 -> [!IMPORTANT]  
 ->  如需 [!INCLUDE[ssSQL11](../../includes/sssql11-md.md)] 中空間功能 (包括空間資料類型的增強功能) 的詳細描述及範例，請下載技術白皮書：[New Spatial Features in SQL Server Code-Named "Denali"](http://go.microsoft.com/fwlink/?LinkId=226407) (SQL Server 代號 "Denali" 中的新空間功能)。  
 -  
 ...
 -  
 -  
 -##  <a name="differences"></a> 幾何與地理資料類型之間的差異  
 ...
 -  
 --   每一個**地理**執行個體都必須符合單一半球的大小。 大於半球的空間物件將無法儲存。  
 -  
 --   當來自開放地理空間協會 (OGC) Well-Known Tex (WKT) 或 Well-Known Binary (WKB) 表示法的任何**地理**執行個體產生大於半球的物件時，會擲回 **ArgumentException**。  
 -  
 --   需要兩個**地理**執行個體輸入的**地理**資料類型方法 (例如 STIntersection()、STUnion()、STDifference() 及 STSymDifference())，會在這些方法的結果不符合單一半球大小時，傳回 null。 如果輸出超過單一半球，STBuffer() 也會傳回 null。  
 -  
 ...
 -  
 --   [OGC 規格，簡單功能存取第 1 部份 - 常見架構](http://go.microsoft.com/fwlink/?LinkId=93627)  
 -  
 --   [OGC 規格，簡單功能存取第 2 部份 - SQL 選項](http://go.microsoft.com/fwlink/?LinkId=93628)  
 -  
 -  
 ...
 -  
 -> [!NOTE]  
 ->  如果為圓弧線段提供了 Z 值，則圓弧線段中所有點的這些值都必須相同，系統才會接受輸入。 例如：系統可接受 `CIRCULARSTRING(0 0 1, 2 2 1, 4 0 1)` ，但無法接受 `CIRCULARSTRING(0 0 1, 2 2 2, 4 0 1)` 。  
 -  
 -### LineString 與 CircularString 的比較  
 ...
 -  
 -### LineString 與 CompoundCurve 的比較  
 ...
 -  
 -### CircularString 與 CompoundCurve 的比較  
 ...
 -- [幾何資料類型方法參考](https://msdn.microsoft.com/library/bb933973.aspx) 
 -- [地理資料類型方法參考](http://msdn.microsoft.com/library/028e6137-7128-4c74-90a7-f7bdd2d79f5e)   
 -- [STNumCurves &#40;幾何資料類型&#41;](../../t-sql/spatial-geometry/stnumcurves-geometry-data-type.md)   
 -- [STNumCurves &#40;地理資料類型&#41;](../../t-sql/spatial-geography/stnumcurves-geography-data-type.md)   
 -- [STGeomFromText &#40;幾何資料類型&#41;](../../t-sql/spatial-geometry/stgeomfromtext-geometry-data-type.md)   
 -- [STGeomFromText &#40;地理資料類型&#41;](../../t-sql/spatial-geography/stgeomfromtext-geography-data-type.md)  
