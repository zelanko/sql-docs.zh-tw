---
title: "使用 SQL Server Profiler 建立及測試計畫指南 | Microsoft Docs"
ms.custom: ""
ms.date: "03/14/2017"
...
helpviewer_keywords: 
  - "檢查計畫指南"
  - "計畫指南 [SQL Server], 測試"
  - "計畫指南 [SQL Server]，SQL Server Profiler"
  - "比對查詢與計畫指南 [SQL Server]"
  - "測試計畫指南"
  - "SQL Server Profiler, 計畫指南"
  - "計畫指南 [SQL Server], 建立"
  - "擷取查詢文字 [SQL Server]"
  - "驗證計畫指南"
  - "Profiler [SQL Server Profiler], 計畫指南"
  - "比對查詢與計畫指南 [SQL Server]"
