...
ms.topic: "article"
helpviewer_keywords: 
  - "查詢統計資料 [SQL Server] 即時查詢統計資料"
  - "即時查詢統計資料"
  - "偵錯 [SQL Server], 即時查詢統計資料"
  - "統計資料 [SQL Server], 即時查詢統計資料"
...
## <a name="remarks"></a>備註  
 必須先啟用統計資料設定檔基礎結構，即時查詢統計資料才可以擷取查詢進度資訊。 指定 [!INCLUDE[ssManStudio](../../includes/ssmanstudio-md.md)] 中的 [Include Live Query Statistics (包括即時查詢統計資料)]，可啟用目前查詢工作階段的統計資料基礎結構。 
...
## <a name="see-also"></a>另請參閱  
 ...
 [追蹤旗標](Trace%20Flags%20\(Transact-SQL\).md)