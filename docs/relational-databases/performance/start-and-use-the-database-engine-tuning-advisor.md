...
#### 若要從 SQL Server Management Studio 查詢編輯器中啟動 Database Engine Tuning Advisor  
...
7.  按一下 **[開始分析]**。  
    ...
    -   [停止分析 (附帶建議)] 會停止微調工作階段並提示您確定是否要 Database Engine Tuning Advisor 根據目前為止所作的分析來產生建議。  
...
##  <a name="XMLInput"></a> 建立 XML 輸入檔  
 ...
 您的 [!INCLUDE[msCoName](../../includes/msconame-md.md)] [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)]安裝中有 [!INCLUDE[ssDE](../../includes/ssde-md.md)] Tuning Advisor XML 結構描述，其位置如下：  
