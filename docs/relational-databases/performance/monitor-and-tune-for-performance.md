...
ms.topic: "article"
helpviewer_keywords: 
  - "SQL Server 執行個體, 監視效能"
  - "監視伺服器效能 [SQL Server]"
  - "Database Engine [SQL Server], 效能"
  - "監視效能 [SQL Server], 關於效能"
  - "伺服器效能 [SQL Server]"
  - "監視效能 [SQL Server]"
  - "資料庫效能 [SQL Server], 關於效能"
  - "微調資料庫 [SQL Server], 關於效能"
  - "狀態資訊 [SQL Server], 效能監視"
  - "資料庫監視 [SQL Server], 關於效能"
  - "監視 [SQL Server], 查詢效能"
  - "伺服器效能 [SQL Server], 關於效能"
  - "微調資料庫 [SQL Server]"
  - "資料庫效能 [SQL Server]"
  - "監視 [SQL Server], 伺服器效能"
  - "監視資料庫 [SQL Server]"
  - "監視伺服器效能 [SQL Server], 關於監視伺服器效能"
