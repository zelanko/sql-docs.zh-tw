...
[!INCLUDE[ssManStudioFull](../../includes/ssmanstudiofull-md.md)] 17.2 版和更新版本包含 [效能儀表板]。 此儀表板的設計目的是要透過視覺方式提供 [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] (從 [!INCLUDE[ssKatmai](../../includes/ssKatmai-md.md)] 與 [!INCLUDE[ssazure_md](../../includes/ssazure_md.md)] 開始) 效能狀態的快速見解。 
