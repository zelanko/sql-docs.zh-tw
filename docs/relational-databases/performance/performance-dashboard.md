...
ms.locfileid: "54242395"
---
# <a name="performance-dashboard"></a>效能儀表板
[!INCLUDE[appliesto-ss-xxxx-xxxx-xxx-md](../../includes/appliesto-ss-xxxx-xxxx-xxx-md.md)]

[!INCLUDE[ssManStudioFull](../../includes/ssmanstudiofull-md.md)] 17.2 版和更新版本包含 [效能儀表板]。 此儀表板的設計目的是要透過視覺方式提供 [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] (從 [!INCLUDE[ssKatmai](../../includes/ssKatmai-md.md)] 開始) 效能狀態的快速深入解析。 

[效能儀表板] 可協助您快速識別出 [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] 是否正發生效能瓶頸。 如果發現瓶頸，將可輕鬆擷取對解決問題而言，可能必要的額外診斷資料。 [效能儀表板] 可協助識別的一些常見效能問題包括：
-  CPU 瓶頸 (以及哪些查詢耗用最多 CPU)
-  IO 瓶頸 (以及哪些查詢執行最多 IO)
...
![功能表中的 [效能儀表板]](../../relational-databases/performance/media/perf_dashboard_ssms.png "功能表中的 [效能儀表板]")  
...
需要 `VIEW SERVER STATE` 和 `ALTER TRACE` 權限。 
