...
|*D*|IPD 中的 SQL_DESC_PRECISION 或 SQL_DESC_SCALE。|未使用的。 這必須是 0。<br /><br /> 如果這個參數是不 0、 SQLBindParameter 會傳回 SQL_ERROR，並將診斷記錄會產生含有 SQLSTATE = HY104 和訊息 「 無效的有效位數或小數位數 」。|  
