---
description: 影響資料表值參數的陳述式屬性
title: 影響 Table-Valued 參數的屬性
ms.custom: ''
ms.date: 03/06/2017
ms.prod: sql
...
|屬性名稱|類型|描述|  
|--------------------|----------|-----------------|  
|SQL_SOPT_SS_PARAM_FOCUS|SQLUINTEGER|如需 SQL_SS_PARAM_FOCUS 的詳細資訊，請參閱 [SQLSetStmtAttr](../../relational-databases/native-client-odbc-api/sqlsetstmtattr.md)。|  
|SQL_SOPT_SS_NAME_SCOPE|SQLUINTEGER|如需 SQL_SS_NAME_SCOPE 的詳細資訊，請參閱 [SQLSetStmtAttr](../../relational-databases/native-client-odbc-api/sqlsetstmtattr.md)。|  
||||
