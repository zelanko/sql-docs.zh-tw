...
-   **Ntext**資料中的特殊字元可能會因為 BLOB 類型的比較限制而造成 SQLXML 4.0 的問題。 例如，使用 **\<diffgr:before>** 在 DiffGram 的資料行的並行檢查中時，在 DiffGram 的區塊中使用 "[Serializable]" 將**ntext**會失敗，並出現下列 SQLOLEDB 錯誤描述：  
