...
ms.openlocfilehash: 0a7fefc897d782e9ebaedabed628807688740dad
...
## <a name="in-this-section"></a>本節內容  
 ...
 [使用 ADO & #40; 執行 DiffGramSQLXML 4.0 & #41;](../../../relational-databases/sqlxml-annotated-xsd-schemas-xpath-queries/diffgram/executing-a-diffgram-by-using-ado-sqlxml-4-0.md)  
 提供使用 ActiveX Data Objects (ADO) 執行 Diffgram 的範例。  
  
 [執行 DiffGram 使用 SQLXML Managed 類別](../../../relational-databases/sqlxml-annotated-xsd-schemas-xpath-queries/diffgram/executing-a-diffgram-by-using-sqlxml-managed-classes.md)  
