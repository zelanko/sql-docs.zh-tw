...
|命令<br /><br /> 屬性|預設值<br /><br /> (如果有的話)|Description|  
|--------------------------|----------------------------|-----------------|  
...
|命名空間||這個屬性會讓使用命名空間的 XPath 查詢得以執行。 如需這個屬性使用的範例，請參閱[執行含有命名空間的 XPath 查詢&#40;SQLXMLOLEDB 提供者&#41;](../../../relational-databases/sqlxml-annotated-xsd-schemas-xpath-queries/data-access-components-provider/executing-xpath-queries-with-namespaces-sqlxmloledb-provider.md)。|  
