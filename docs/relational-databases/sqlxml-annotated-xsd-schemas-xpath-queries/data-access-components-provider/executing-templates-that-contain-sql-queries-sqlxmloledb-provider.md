...
description: 使用 SQLXMLOLEDB 提供者來查看用戶端 ADO 應用程式的範例，以執行包含 SQL 查詢的伺服器端 XML 範本。
ms.date: 03/14/2017
ms.prod: sql
