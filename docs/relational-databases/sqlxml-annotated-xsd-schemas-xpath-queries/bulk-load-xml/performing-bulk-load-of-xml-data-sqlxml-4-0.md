...
description: 瞭解如何在 SQLXML 4.0 中使用 XML 大量載入，將半結構化 XML 資料載入 Microsoft SQL Server 資料表中。
ms.date: 03/17/2017
ms.prod: sql
...
## <a name="in-this-section"></a>本節內容  
 [XML 大量載入的簡介 &#40;SQLXML 4.0&#41;](../../../relational-databases/sqlxml-annotated-xsd-schemas-xpath-queries/bulk-load-xml/introduction-to-xml-bulk-load-sqlxml-4-0.md)  
