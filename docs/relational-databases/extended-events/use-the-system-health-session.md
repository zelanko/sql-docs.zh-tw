---
title: "使用 system_health 工作階段 | Microsoft Docs"
ms.custom: ""
ms.date: "06/25/2016"
...
ms.topic: "article"
helpviewer_keywords: 
  - "擴充事件 [SQL Server], 系統健康工作階段"
  - "擴充事件 [SQL Server], system_health 工作階段"
  - "system_health 工作階段 [SQL Server 擴充的事件]"
  - "系統健康工作階段 [SQL Server 擴充的事件]"
