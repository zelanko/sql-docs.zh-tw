...
只有 SQL Server Management Studio (SSMS) v17.3 或更新版本才提供此功能。 請確認目前使用的是最新版本。 您可以於[此處](../../ssms/download-sql-server-management-studio-ssms.md)找到最新版本。
