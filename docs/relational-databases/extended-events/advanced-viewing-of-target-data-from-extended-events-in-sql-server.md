...
- [Azure SQL Database 中的擴充事件](http://azure.microsoft.com/documentation/articles/sql-database-xevent-db-diff-from-svr/)
...
> [AZURE.NOTE] [檢視目標資料] 顯示指定事件工作階段的「多個 .XEL 檔案的累積資料」。 每個「啟動-停止」循環會建立名稱中內嵌稍後時間衍生整數的檔案，但每個檔案都共用相同的根名稱。
...
### B.4 使用 sys.fn_xe_file_target_read_file 函數檢視 .XEL
...
![[選擇資料行] 對話方塊，也提供 [合併資料行] 選項](/Image/SQL%20Server/xevents-ssms-ui35-choosecolumns.png)
...
![[篩選] 對話方塊上的時間範圍和資料行篩選](/Image/SQL%20Server/xevents-ssms-ui45-filters.png)
...
![[工具列] > [群組] 按鈕，然後是 [群組] 對話方塊](/Image/SQL%20Server/xevents-ssms-ui53-grouping.png)
...
![[工具列] > [彙總] 按鈕，然後是 [彙總] 對話方塊](/Image/SQL%20Server/xevents-ssms-ui51-aggregdialogcount.png)

彙總達成之後，顯示會有新的外觀，如下所示。

![[工具列] > [彙總] 按鈕，然後是 [彙總] 對話方塊](/Image/SQL%20Server/xevents-ssms-ui52-aggregnewdisplay.png)
