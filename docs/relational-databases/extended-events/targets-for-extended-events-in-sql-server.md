...
在 Transact-SQL 中，[CREATE EVENT SESSION](CREATE EVENT SESSION %28Transact-SQL%29.md) 陳述式是擴充事件的重要部分。 若要撰寫陳述式，您通常需要下列項目的清單和說明︰
...
#### 含 ring_buffer 的 CREATE EVENT SESSION
...
### ring_buffer 針對 lock_acquired 所接收到的 XML 輸出
