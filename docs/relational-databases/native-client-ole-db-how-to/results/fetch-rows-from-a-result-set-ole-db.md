---
title: 從結果集提取資料列（Native Client OLE DB 提供者） |Microsoft Docs
ms.custom: ''
ms.date: 03/14/2017
ms.prod: sql
...
ms.locfileid: "87246997"
---
# <a name="fetch-rows-from-a-result-set-native-client-ole-db-provider"></a>從結果集提取資料列（Native Client OLE DB 提供者）
