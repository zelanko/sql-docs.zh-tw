...
ms.openlocfilehash: a0e359e9218fab6fc65094a5ed20df1507f8cca5
...
2.  將 SQLOLEDB 提供者特有的資料來源屬性 SSPROP_ENABLEFASTLOAD 設定為 VARIANT_TRUE。 此屬性設定為 VARIANT_TRUE，新建立的工作階段可讓取用者存取**IRowsetFastLoad**。  
