---
description: '使用書簽 (Native Client OLE DB 提供者來取出資料列) '
title: '使用書簽 (Native Client OLE DB 提供者來取出資料列) '
ms.custom: ''
ms.date: 03/14/2017
ms.prod: sql
...
ms.locfileid: "91867634"
---
# <a name="retrieve-rows-using-bookmarks-native-client-ole-db-provider"></a>使用書簽 (Native Client OLE DB 提供者來取出資料列) 
