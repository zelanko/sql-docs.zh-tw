---
title: 使用書簽來取出資料列（Native Client OLE DB 提供者）
ms.custom: ''
ms.date: 03/14/2017
ms.prod: sql
...
ms.locfileid: "87247007"
---
# <a name="retrieve-rows-using-bookmarks-native-client-ole-db-provider"></a>使用書簽來取出資料列（Native Client OLE DB 提供者）
