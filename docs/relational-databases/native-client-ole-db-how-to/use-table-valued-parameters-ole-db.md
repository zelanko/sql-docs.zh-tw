---
description: '在 SQL Server Native Client (OLE DB 中使用 Table-Valued 參數) '
...
ms.locfileid: "97419588"
---
# <a name="use-table-valued-parameters-in-sql-server-native-client-ole-db"></a>在 SQL Server Native Client (OLE DB 中使用 Table-Valued 參數) 
...
-   顯示 SQLNCLI11 錯誤的錯誤處理。  
 ...
 如需資料表值參數的詳細資訊，請參閱 [&#40;SQL Server Native Client&#41;的資料表值參數 ](../../relational-databases/native-client/features/table-valued-parameters-sql-server-native-client.md)。  
