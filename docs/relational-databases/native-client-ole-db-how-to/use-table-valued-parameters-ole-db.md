...
-   顯示 SQLNCLI11 錯誤的錯誤處理。  
 ...
 有關表值參數的詳細資訊,請參閱[&#40;SQL Server 本機用戶端&#41;的表值參數](../../relational-databases/native-client/features/table-valued-parameters-sql-server-native-client.md)。  
