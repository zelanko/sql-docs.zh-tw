---
description: '使用 SQL Server Native Client (OLE DB 中的資料表值參數) '
...
ms.locfileid: "88448430"
---
# <a name="use-table-valued-parameters-in-sql-server-native-client-ole-db"></a>使用 SQL Server Native Client (OLE DB 中的資料表值參數) 
