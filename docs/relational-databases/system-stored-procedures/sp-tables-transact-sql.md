...
> [!NOTE]  
>  若要判斷同義字基底物件的名稱，請查詢 [sys. 同義字](../../relational-databases/system-catalog-views/sys-synonyms-transact-sql.md) 目錄檢視。  
...
`[ @fUsePattern = ] 'fUsePattern'` 決定是否將底線 ( _ ) 、percent (% ) 和方括弧 ( [或] ) 字元視為萬用字元。 有效值是 0 (關閉模式比對) 和 1 (開啟模式比對)。 *fUsePattern* 是 **bit**，預設值是1。  
...
## <a name="see-also"></a>另請參閱  
 [sys. 同義字 &#40;Transact-sql&#41;](../../relational-databases/system-catalog-views/sys-synonyms-transact-sql.md)   
