...
|**security_mode**|**1**|當連接到發行者時，使用 Windows 驗證。 *這無法針對非*[!INCLUDE[msCoName](../../includes/msconame-md.md)] [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)]發行者進行變更 *。*|  
||**0**|當連接到發行者時，使用 [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] 驗證。 *這無法針對非*[!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)]發行者進行變更 *。*|  
