...
-   **sp_rda_deauthorize_db**  
    ...
    -   執行[sys.databases &#40; &#41; ](../../relational-databases/system-stored-procedures/sys-sp-rda-reauthorize-db-transact-sql.md)以重新連接到遠端 Azure 資料庫，sp_rda_reauthorize_db 的 transact-sql。 此操作會自動將查詢模式重設為 LOCAL_AND_REMOTE，這是 Stretch Database 的預設行為。 也就是說，查詢會傳回本機和遠端資料的結果。  
...
-   **sp_rda_reauthorize_db**  
     ...
     當您執行[sp_rda_reauthorize_db &#40; &#41; sys.databases](../../relational-databases/system-stored-procedures/sys-sp-rda-reauthorize-db-transact-sql.md)來重新連接到遠端 Azure 資料庫時，此作業會自動將查詢模式重設為 LOCAL_AND_REMOTE，這是 Stretch Database 的預設行為。 也就是說，查詢會傳回本機和遠端資料的結果。  
