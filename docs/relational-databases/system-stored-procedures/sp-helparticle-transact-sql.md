...
|**schema_option**|**binary （8）**|給定發行項的結構描述產生選項點陣圖。 如需**schema_option**值的完整清單，請參閱[sp_addarticle &#40;transact-sql&#41;](../../relational-databases/system-stored-procedures/sp-addarticle-transact-sql.md)。|  
