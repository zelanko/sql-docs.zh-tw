...
|**嚴重性**|**int**|嚴重性層級 (從**9**透過**25**， **110**， **120**， **130**，或**140**)定義警示。|  
|**已啟用**|**tinyint**|目前是否已啟用警示的狀態 (**1**) 與否 (**0**)。 不會傳送未啟用的警示。|  
...
|**旗標**|**int**|[!INCLUDE[ssInternalOnly](../../includes/ssinternalonly-md.md)]|  
...
|**型別**|**int**|事件類型：<br /><br /> **1**  =  [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)]事件警示<br /><br /> **2**  =  [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)]效能警示<br /><br /> **3** = WMI 事件警示|  
...
|**event_id**|**int**|[!INCLUDE[ssInternalOnly](../../includes/ssinternalonly-md.md)]|  
|**message_id**|**int**|定義警示的訊息錯誤號碼。 (通常對應於中的錯誤代碼**sysmessages**資料表)。 如果利用嚴重性來定義警示， **message_id**是**0**或 NULL。|  
|**嚴重性**|**int**|嚴重性層級 (從**9**透過**25**， **110**， **120**， **130**，或 1**40**)定義警示。|  
|**已啟用**|**tinyint**|目前是否已啟用警示的狀態 (**1**) 與否 (**0**)。 不會傳送未啟用的警示。|  
|**delay_between_responses**|**int**|這個警示各次回應之間的等待期間 (以秒為單位)。|  
|**last_occurrence_date**|**int**|警示上次發生的日期。|  
|**last_occurrence_time**|**int**|警示上次發生的時間。|  
...
|**型別**|**int**|警示類型：<br /><br /> **1**  =  [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)]事件警示<br /><br /> **2**  =  [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)]效能警示<br /><br /> **3** = WMI 事件警示|  
