---
title: sys.databases sp_cdc_stop_job （Transact-sql） |Microsoft Docs
ms.custom: ''
ms.date: 03/14/2017
ms.prod: sql
...
`[ [ @job_type = ] 'job_type_' ]`要加入的作業類型。 *job_type*是**Nvarchar （20）** ，預設值為**capture**。 有效的輸入為**capture**和**清除**。  
