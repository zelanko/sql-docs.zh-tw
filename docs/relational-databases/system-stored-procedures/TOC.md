...
# 檔案資料流與 FileTable
## [檔案資料流與 FileTable - sp_filestream_force_garbage_collection](filestream-and-filetable-sp-filestream-force-garbage-collection.md)  
## [檔案資料流與 FileTable - sp_kill_filestream_non_transacted_handles](filestream-and-filetable-sp-kill-filestream-non-transacted-handles.md)  
# 使用中的地理複寫
...
# [分散式查詢](distributed-queries-stored-procedures-transact-sql.md)  
...
# [全文檢索搜尋及語意搜尋](full-text-search-and-semantic-search-stored-procedures-transact-sql.md)  
...
# [OLE 自動化](ole-automation-stored-procedures-transact-sql.md)  
