# [概觀](system-stored-procedures-transact-sql.md)  
# [空間索引](spatial-index-stored-procedures-arguments-and-properties.md)  
...
# 時態表
## [時態表-sys.sp_cleanup_temporal_history](temporal-table-sys-sp-cleanup-temporal-history.md)  
## [時態表-sp_xtp_flush_temporal_history](temporal-table-sp-xtp-flush-temporal-history.md)  
# 快照集備份
## [快照集備份-sp_delete_backup_file_snapshot](snapshot-backup-sp-delete-backup-file-snapshot.md)  
## [快照集備份-sp_delete_backup](snapshot-backup-sp-delete-backup.md)  
# PolyBase
## [PolyBase 預存程序-sp_polybase_join_group](polybase-stored-procedures-sp-polybase-join-group.md)  
## [PolyBase 預存程序-sp_polybase_leave_group](polybase-stored-procedures-sp-polybase-leave-group.md)  
# Filestream 和 Filetable
## [Filestream 和 FileTable-s](filestream-and-filetable-sp-filestream-force-garbage-collection.md)  
## [Filestream 和 FileTable-sp_kill_filestream_non_transacted_handles](filestream-and-filetable-sp-kill-filestream-non-transacted-handles.md)  
# 使用中的地理複寫
## [sp_wait_for_database_copy_sync](active-geo-replication-sp-wait-for-database-copy-sync.md)  
# [目錄](catalog-stored-procedures-transact-sql.md)  
...
# [異動資料擷取](change-data-capture-stored-procedures-transact-sql.md)  
...
# [資料指標](cursor-stored-procedures-transact-sql.md)  
...
# [資料收集器](data-collector-stored-procedures-transact-sql.md)  
...
## [sys.sp_xtp_bind_db_resource_pool](sys-sp-xtp-unbind-db-resource-pool-transact-sql.md)  
...
# [資料庫維護計畫](database-maintenance-plan-stored-procedures-transact-sql.md)  
...
# [分散式的查詢](distributed-queries-stored-procedures-transact-sql.md)  
...
# [防火牆規則 (Azure SQL Database)](firewall-rules-stored-procedures-azure-sql-database.md)  
...
# [全文檢索搜尋和語意搜尋](full-text-search-and-semantic-search-stored-procedures-transact-sql.md)  
...
# [一般擴充](general-extended-stored-procedures-transact-sql.md)  
...
# [記錄傳送](log-shipping-stored-procedures-transact-sql.md)  
...
# [受管理備份](managed-backup-stored-procedures-transact-sql.md)  
...
# [管理資料倉儲](management-data-warehouse-stored-procedures-transact-sql.md)  
...
## [物件階層語法](object-hierarchy-syntax-transact-sql.md)  
...
# [原則式管理](policy-based-management-stored-procedures-transact-sql.md)  
...
# [查詢存放區](query-store-stored-procedures-transact-sql.md)  
...
## [sp_query_store_remove_plan (Transct-sql& SQL)](sp-query-store-remove-plan-transct-sql.md)  
...
# [安全性](security-stored-procedures-transact-sql.md)  
...
# [SQL 資料倉儲](sql-data-warehouse-stored-procedures.md)  
...
## [j](sp-update-jobschedule-transact-sql.md)  
...
# [Stretch Database 擴充](stretch-database-extended-stored-procedures-transact-sql.md)  
...
# [複寫](replication-stored-procedures-transact-sql.md)  
