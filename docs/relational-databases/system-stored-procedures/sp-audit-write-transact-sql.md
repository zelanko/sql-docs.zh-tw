...
## <a name="arguments"></a>引數  
 ...
 由使用者定義的參數，並記錄在 audit 記錄檔的 **user_defined_event_id** 資料行中。 * \@ user_defined_event_id*是類型**Smallint**。  
...
## <a name="remarks"></a>備註  
 當 **USER_DEFINED_AUDIT_GROUP** 新增至伺服器審核規格或資料庫審核規格時， **sp_audit_write** 觸發的事件就會包含在 AUDIT 記錄檔中。  
