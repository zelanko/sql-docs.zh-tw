...
> [!IMPORTANT]  
> [!INCLUDE[ssNoteDepFutureAvoid](../../includes/ssnotedepfutureavoid-md.md)]若要取得中鎖定的相關資訊 [!INCLUDE[ssDEnoversion](../../includes/ssdenoversion-md.md)] ，請使用[sys.databases dm_tran_locks](../../relational-databases/system-dynamic-management-views/sys-dm-tran-locks-transact-sql.md)動態管理檢視。  
