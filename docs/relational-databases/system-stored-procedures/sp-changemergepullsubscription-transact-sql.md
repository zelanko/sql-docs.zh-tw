...
|**優先順序**||適用於回溯相容性。執行[sp_changemergesubscription](../../relational-databases/system-stored-procedures/sp-changemergesubscription-transact-sql.md)在發行者端而是要修改的訂用帳戶的優先權。|  
