...
## <a name="arguments"></a>引數  
 ...
 [ **@agent_type =** ] '*agent_type*'  
 記錄傳送作業的類型。 0 = 備份、1 = 複製、2 = 還原。 *agent_type*是**tinyint**不能是 NULL。  
...
## <a name="remarks"></a>備註  
 **sp_cleanup_log_shipping_history**必須從執行**主要**任何記錄傳送伺服器上的資料庫。 這個預存程序清除本機和遠端副本**log_shipping_monitor_history_detail**和**log_shipping_monitor_error_detail**根據歷程記錄保留期限。  
