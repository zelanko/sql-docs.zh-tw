---
title: sp_drop_agent_profile (TRANSACT-SQL) |Microsoft 文件
ms.custom: ''
ms.date: 03/06/2017
ms.prod: sql
...
## <a name="remarks"></a>備註  
 **sp_drop_agent_profile**用於所有複寫類型。  
  
 給定的設定檔的參數也會卸除從**MSagent_parameters**資料表。  
