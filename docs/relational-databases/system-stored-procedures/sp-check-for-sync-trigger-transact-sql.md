...
### <a name="a-add-code-to-a-trigger-on-a-subscriber-table"></a>A. 將程式碼新增至訂閱者資料表上的觸發程式
...
### <a name="b-add-code-to-a-trigger-on-a-publisher-table"></a>B. 將程式碼加入至發行者資料表上的觸發程式
