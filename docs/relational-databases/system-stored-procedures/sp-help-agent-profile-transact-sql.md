...
`[ @agent_type = ] agent_type` 這是代理程式的類型。 *agent_type* 是 **int**，預設值是 **0**，而且可以是下列值之一。  
...
## <a name="permissions"></a>權限  
 只有 **系統管理員（sysadmin** ）固定伺服器角色或 **replmonitor** 固定資料庫角色的成員，才可以執行 **sp_help_agent_profile**。  
