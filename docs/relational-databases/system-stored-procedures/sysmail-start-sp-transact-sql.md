...
## <a name="remarks"></a>備註  
 ...
 這個預存程式在 **msdb** 資料庫中。 這個預存程序會啟動存放外送訊息要求的 Database Mail 佇列，而且會啟用外部程式的 [!INCLUDE[ssSB](../../includes/sssb-md.md)] 啟動作業。  
...
## <a name="examples"></a>範例  
 下列範例顯示在 **msdb** 資料庫中啟動 Database Mail。 這個範例假設您已啟用 Database Mail。  
