...
`[ @subscriber = ] 'subscriber'`這是訂閱者的名稱。 *訂閱者*是**sysname**, 預設值 **%** 是, 它會傳回所有資訊。  
...
|**發行者**|**sysname**|發行者的名稱。|  
|**訂閱者**|**sysname**|訂閱者的名稱。|  
|**type**|**tinyint**|訂閱者的類型：<br /><br /> **0**  = 資料庫1 = ODBC 資料源[!INCLUDE[msCoName](../../includes/msconame-md.md)] [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)]|  
...
|**frequency_relative_interval**|**int**|當*frequency_type*設定為**32** (每月相對) 時, 所使用的散發代理程式日期:<br /><br /> **1** = 第一個<br /><br /> **2** = 秒<br /><br /> **4** = 第三個<br /><br /> **8** = 第四個<br /><br /> **16** = 最後|  
...
|**security_mode**|**int**|實作的安全性模式：<br /><br /> **0**  = 驗證[!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)]<br /><br /> 1 =  Windows[!INCLUDE[msCoName](../../includes/msconame-md.md)]驗證|  
...
|**frequency_relative_interval2**|**int**|當*frequency_type*設定為 32 (每月相對) 時, 所使用的合併代理程式日期:<br /><br /> **1** = 第一個<br /><br /> **2** = 秒<br /><br /> **4** = 第三個<br /><br /> **8** = 第四個<br /><br /> **16** = 最後|  
...
## <a name="permissions"></a>Permissions  
 只有**系統管理員 (sysadmin** ) 固定伺服器角色、 **db_owner**固定資料庫角色或發行集之發行集存取清單的成員, 才能夠執行**sp_helpsubscriberinfo**。  
