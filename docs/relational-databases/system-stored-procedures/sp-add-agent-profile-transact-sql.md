 ...
 **sp_add_agent_profile**用於快照式複寫、 異動複寫和合併式複寫。  
 ...
 當**sp_add_agent_profile**會執行，資料列會加入新的自訂設定檔中[MSagent_profiles &#40;TRANSACT-SQL&#41; ](../../relational-databases/system-tables/msagent-profiles-transact-sql.md)資料表和相關聯的預設參數，這個設定檔會加入至[MSagent_parameters &#40;TRANSACT-SQL&#41; ](../../relational-databases/system-tables/msagent-parameters-transact-sql.md)資料表。  
