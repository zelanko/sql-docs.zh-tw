...
`[ @name = ] 'name'` 要刪除的操作員名稱。 *名稱*已**sysname**，沒有預設值。  
  
`[ @reassign_to_operator = ] 'reassign_operator'` 指定的操作員的警示可以重新指派操作員的名稱。 *reassign_operator*已**sysname**，預設值是 NULL。  
