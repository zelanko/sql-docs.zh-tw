...
> [!IMPORTANT]  
>  [!INCLUDE[ssNoteDepFutureAvoid](../../includes/ssnotedepfutureavoid-md.md)] 使用[ALTER DATABASE](../../t-sql/statements/alter-database-transact-sql.md)改。  
...
## <a name="arguments"></a>引數  
 [ @dbname=] '*資料庫*'  
 這是要重設的資料庫名稱。 *資料庫*已**sysname**，沒有預設值。  
