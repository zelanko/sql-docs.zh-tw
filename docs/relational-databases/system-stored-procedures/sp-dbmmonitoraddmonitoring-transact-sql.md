...
## <a name="remarks"></a>備註  
 ...
 如果從啟動資料庫鏡像 [!INCLUDE[ssManStudioFull](../../includes/ssmanstudiofull-md.md)] ，則會自動執行 **sp_dbmmonitoraddmonitoring** 程式。 如果您使用 ALTER DATABASE 語句來手動啟動鏡像，若要監視伺服器實例上的鏡像資料庫，您必須手動執行 **sp_dbmmonitoraddmonitoring** 。  
