...
> [!IMPORTANT]
>  這個預存程序已被取代，支援它的目的是為了回溯相容性。 它應該只用于 [!INCLUDE[msCoName](../../includes/msconame-md.md)] [!INCLUDE[ssVersion2000](../../includes/ssversion2000-md.md)] 發行者和重新發行 [!INCLUDE[ssVersion2000](../../includes/ssversion2000-md.md)] 訂閱者。 這個程序不應該用於含有 [!INCLUDE[ssVersion2005](../../includes/ssversion2005-md.md)] 或更高版本中導入之資料類型的資料行。  
