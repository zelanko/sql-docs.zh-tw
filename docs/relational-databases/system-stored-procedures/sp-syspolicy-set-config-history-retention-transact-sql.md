---
title: sp_syspolicy_set_config_history_retention (TRANSACT-SQL) |Microsoft 文件
ms.custom: ''
ms.date: 08/09/2016
ms.prod: sql
...
## <a name="arguments"></a>引數  
 [  **@value=** ]*值*  
 這是保留原則式管理記錄的天數。 *值*是**sqlvariant**。  
  
## <a name="return-code-values"></a>傳回碼值  
 **0** （成功） 或**1** （失敗）  
  
## <a name="remarks"></a>備註  
 您必須在 msdb 系統資料庫的內容中執行 sp_syspolicy_set_config_history_retention。  
  
 如果*值*設為 0，將不會自動移除記錄。  
  
 若要檢視記錄保留的目前值，請執行下列查詢：  
