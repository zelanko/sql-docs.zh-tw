---
title: "SQL Server Agent 預存程序 (TRANSACT-SQL) |Microsoft 文件"
ms.custom: 
ms.date: 03/14/2017
...
[!INCLUDE[tsql-appliesto-ss2012-xxxx-xxxx-xxx-md](../../includes/tsql-appliesto-ss2012-xxxx-xxxx-xxx-md.md)]
  ...
  [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] 支援下列系統預存程序所使用的[!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)]代理程式來管理已排程和事件驅動活動。  
