---
title: 原則式管理預存程序 (TRANSACT-SQL) |Microsoft 文件
ms.custom: ''
ms.date: 03/14/2017
ms.prod: sql
...
ms.author: sstein
manager: craigg
ms.openlocfilehash: 40f02fdceb72ec75be5e48e752323c8f4bda2ed6
...
[!INCLUDE[tsql-appliesto-ss2012-xxxx-xxxx-xxx-md](../../includes/tsql-appliesto-ss2012-xxxx-xxxx-xxx-md.md)]
  ...
  [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] 支援下列系統預存程序，用於以原則為基礎的管理。  
