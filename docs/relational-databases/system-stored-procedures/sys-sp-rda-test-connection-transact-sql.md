...
-   如果您提供 **\@database_name**的值，但指定的資料庫未啟用 Stretch，則您必須提供 **@no__t 3server_address**的值。  
  
-   如果您提供 **\@database_name**的值，而且指定的資料庫已啟用 Stretch，則您不需要提供 **@no__t 3server_address**的值。 如果您提供 **@no__t 1server_address**的值，則預存程式會忽略它，並使用已與已啟用延展功能的資料庫相關聯的現有 Azure 伺服器。  
...
## <a name="return-code-values"></a>傳回碼值  
 如果**成功**，sp_rda_test_connection 會傳回錯誤14855（STRETCH_MAJOR，STRETCH_CONNECTION_TEST_PROC_SUCCEEDED）並加上嚴重性 EX_INFO 和成功的傳回碼。  
  
 萬一**發生失敗**，sp_rda_test_connection 會傳回錯誤14856（STRETCH_MAJOR，STRETCH_CONNECTION_TEST_PROC_FAILED），並傳回嚴重性 EX_USER 和錯誤傳回碼。  
...
|-----------------|-----------------------|-------------------|--------------------|  
|2|ERROR_NO_CONNECTION|*@no__t 1connection 相關的錯誤號碼 >*|*@no__t 1connection 相關的錯誤訊息 >*|  
...
|link_state|link_state_desc|error_number|error_message|  
|-----------------|-----------------------|-------------------|--------------------|  
|1|ERROR_AZURE_FIREWALL|*@no__t 1firewall 相關的錯誤號碼 >*|*@no__t 1firewall 相關的錯誤訊息 >*|  
...
|link_state|link_state_desc|error_number|error_message|  
|-----------------|-----------------------|-------------------|--------------------|  
|3|ERROR_AUTH_FAILURE|*@no__t 1authentication 相關的錯誤號碼 >*|*@no__t 1authentication 相關的錯誤訊息 >*|  
