---
title: sp_syspolicy_rename_policy (TRANSACT-SQL) |Microsoft 文件
ms.custom: ''
ms.date: 08/09/2016
ms.prod: sql
...
ms.author: sstein
manager: craigg
ms.openlocfilehash: 5d5bb24cc7c1ae81b644ec78ea9dba21a201819e
...
## <a name="remarks"></a>備註  
 ...
 您必須指定值，其中一個*名稱*或*policy_id*。 兩者不得同時為 NULL。 若要取得這些值，請查詢 msdb.dbo.syspolicy_policies 系統檢視表。  
