...
|GRANTEE|**sysname**|列出的 GRANTOR 已授與這份 TABLE_NAME 的權限之資料庫使用者名稱。 在[!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)]中，這個資料行一律包含來自 database_principalssystem 視圖的資料庫使用者。 這個欄位一律會傳回值。|  
