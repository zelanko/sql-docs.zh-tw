...
`[ @dbname = ] 'dbname'` 是要設定複寫資料庫選項的資料庫。 *db_name*是**sysname**，沒有預設值。  
  
`[ @optname = ] 'optname'` 是要啟用或停用的複寫資料庫選項。 *optname*是**sysname**，它可以是下列其中一個值。  
...
## <a name="see-also"></a>另請參閱  
 ...
 [刪除發行](../../relational-databases/replication/publish/delete-a-publication.md)集   
