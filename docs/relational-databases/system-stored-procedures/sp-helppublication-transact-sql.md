...
|replicate_partition_switch|**int**|指定是否要更改資料表 ...針對已發行的資料庫執行的 SWITCH 語句應該複寫到訂閱者。 只有當*allow_partition_switch*設為**1**時，這個選項才有效。|  
...
## <a name="permissions"></a>Permissions  
 ...
 若為非 [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] 的發行者，只有在散發者端的系統管理員（sysadmin）固定伺服器角色成員，或是散發資料庫上 db_owner 固定資料庫角色的成員，或 PAL 中的使用者，才能夠執行 sp_helppublication。  
