...
## <a name="arguments"></a>引數  
 ...
 [  **@table_name =** ] **'***table_name***'**  
 這是包含指定之資料行的資料表名稱。 *table_name*已**sysname**，預設值是 NULL。  
 ...
 [  **@column_name =** ] **'***column_name***'**  
 這是提供的權限資訊所屬的資料行名稱。 *column_name*已**sysname**，預設值是 NULL （所有資料行）。  
...
## <a name="see-also"></a>另請參閱  
 [sp_table_privileges_ex &#40;-SQL&AMP;#41;&#41;](../../relational-databases/system-stored-procedures/sp-table-privileges-ex-transact-sql.md)   
