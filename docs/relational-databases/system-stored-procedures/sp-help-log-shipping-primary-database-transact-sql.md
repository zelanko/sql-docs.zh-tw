...
## <a name="examples"></a>範例  
 此範例說明如何使用 **sp_help_log_shipping_primary_database** 來取出資料庫的主資料庫設定 [!INCLUDE[ssSampleDBobject](../../includes/sssampledbobject-md.md)] 。  
