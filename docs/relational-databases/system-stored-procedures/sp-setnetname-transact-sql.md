...
ms.locfileid: "88485652"
---
# <a name="sp_setnetname-transact-sql"></a>sp_setnetname (Transact-SQL)
[!INCLUDE [SQL Server](../../includes/applies-to-version/sqlserver.md)]

  將 **sys. 伺服器** 中的網路名稱設定為遠端實例的實際網路電腦名稱稱 [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] 。 這個程序可用來啟用對於網路名稱含有無效 [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] 識別碼之電腦的遠端預存程序呼叫。  
 ...
 ** @server = '** *伺服器* **'**  
 這是使用者編寫的遠端預存程序呼叫語法所參考的遠端伺服器名稱。 **Sys. 伺服器**中只有一個資料列必須已經存在，才能使用此*伺服器*。 *server* 是 **sysname**，沒有預設值。  
...
## <a name="remarks"></a>備註  
 ...
 由於連結伺服器和遠端伺服器在相同命名空間中，因此，它們的名稱不能相同。 不過，您可以指定不同的名稱，並使用 **sp_setnetname** 將其中一個連結伺服器和遠端伺服器的網路名稱設定為基礎伺服器的網路名稱，藉此為指定的伺服器定義連結伺服器和遠端伺服器。  
...
## <a name="permissions"></a>權限  
 需要 **系統管理員（sysadmin** ）和 **setupadmin** 固定伺服器角色中的成員資格。  
