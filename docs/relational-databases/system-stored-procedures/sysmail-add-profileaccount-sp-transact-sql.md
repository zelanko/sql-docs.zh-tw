...
ms.locfileid: "89538522"
---
# <a name="sysmail_add_profileaccount_sp-transact-sql"></a>sysmail_add_profileaccount_sp (Transact-SQL)
[!INCLUDE [SQL Server](../../includes/applies-to-version/sqlserver.md)]

  將 Database Mail 帳戶加入 Database Mail 設定檔中。 使用[sysmail_add_account_sp &#40;transact-sql&#41;](../../relational-databases/system-stored-procedures/sysmail-add-account-sp-transact-sql.md)建立資料庫帳戶之後執行**sysmail_add_profileaccount_sp** ，並使用[Sysmail_add_profile_sp &#40;Transact-sql&#41;](../../relational-databases/system-stored-procedures/sysmail-add-profile-sp-transact-sql.md)建立資料庫設定檔。  
...
## <a name="remarks"></a>備註  
 ...
 請注意，這個預存程序並不會變更已關聯於指定設定檔的帳戶序號。 如需更新帳戶序號的詳細資訊，請參閱 [sysmail_update_profileaccount_sp &#40;transact-sql&#41;](../../relational-databases/system-stored-procedures/sysmail-update-profileaccount-sp-transact-sql.md)。  
 ...
 預存程式 **sysmail_add_profileaccount_sp** 位於 **msdb** 資料庫中，而且是由 **dbo** 架構所擁有。 如果目前的資料庫不是 **msdb**，就必須以三部分名稱執行程式。  
