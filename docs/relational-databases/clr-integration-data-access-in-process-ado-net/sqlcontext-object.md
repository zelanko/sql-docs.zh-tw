...
[!INCLUDE[appliesto-ss-xxxx-xxxx-xxx-md](../../includes/appliesto-ss-xxxx-xxxx-xxx-md.md)]
 ...
 呼叫端的內容會在**SqlCoNtext**物件中抽象化。 如需有關**SqlTriggerCoNtext**方法和屬性的詳細資訊，請**** 參閱[!INCLUDE[dnprdnshort](../../includes/dnprdnshort-md.md)] SDK 中的 SqlTriggerCoNtext 類別參考檔。  
