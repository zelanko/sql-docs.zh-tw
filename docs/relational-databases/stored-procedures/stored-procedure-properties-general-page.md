...
[!INCLUDE[appliesto-ss-asdb-asdw-pdw-md](../../includes/appliesto-ss-asdb-asdw-pdw-md.md)] 顯示預存程序的相關資訊。 所有資訊為唯讀。  
 ...
 **系統物件**  
 指出預存程序是否為系統物件。 值為 True 與 False。  
  
 **ANSI NULLS**  
 指出物件是否使用 ANSI NULLS 選項建立。  
  
 **已加密**  
 指出預存程序是否加密。 值為 True 與 False。  
  
 **供複寫**  
 指出物件是否使用 FOR REPLICATION 選項建立。  
