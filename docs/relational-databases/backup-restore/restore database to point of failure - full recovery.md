---
title: "在完整復原模式下將資料庫還原至失敗點 (Transact-SQL) | Microsoft Docs"
ms.custom: ""
ms.date: "03/14/2017"
...
helpviewer_keywords: 
  - "失敗點 [SQL Server]"
  - "還原資料庫 [SQL Server]，失敗點"
  - "資料庫還原 [SQL Server]，失敗點"
...
2.  執行下列基本的 [RESTORE DATABASE](../Topic/RESTORE%20\(Transact-SQL\).md) 陳述式，還原完整的資料庫備份：  
