...
### <a name="optimizing-restores"></a>最佳化還原  
 ...
 當您執行還原時，也可以開啟追蹤旗標 3051，以產生詳細的記錄檔。 此記錄檔位於記錄目錄中，且使用下列格式命名：BackupToUrl-\<執行個體名稱>-\<資料庫名稱>-action-\<PID>.log。 此記錄檔包含每次往返 Windows Azure 儲存體的相關資訊 (包括時間點)，有助於診斷問題。  
