...
ms.author: mikeray
manager: craigg
ms.openlocfilehash: bd2542886647b7c30eb02a0c79b8b21e62b47998
ms.sourcegitcommit: 61381ef939415fe019285def9450d7583df1fed0
ms.translationtype: HT
ms.contentlocale: zh-TW
ms.lasthandoff: 10/01/2018
ms.locfileid: "47647136"
---
...
-   因為 SQL Server 必須連接至外部來源以擷取備份檔案，所以會使用 SQL 認證來驗證儲存體帳戶。 因此，RESTORE 陳述式需要 WITH CREDENTIAL 選項。 如需詳細資訊，請參閱 [使用 Microsoft Azure Blob 儲存體服務進行 SQL Server 備份及還原](../../relational-databases/backup-restore/sql-server-backup-and-restore-with-microsoft-azure-blob-storage-service.md)。  
...
### <a name="optimizing-restores"></a>最佳化還原  
 ...
 當您執行還原時，也可以開啟追蹤旗標 3051，以產生詳細的記錄檔。 此記錄檔會置於記錄檔目錄中，並使用下列格式命名：BackupToUrl-\<執行個體>-\<資料庫名稱>-action-\<PID>.log。 此記錄檔包含每次往返 Windows Azure 儲存體的相關資訊 (包括時間點)，有助於診斷問題。  
