---
title: "檢視備份磁帶或檔案的內容 (SQL Server) | Microsoft Docs"
ms.custom: ""
ms.date: "03/17/2017"
...
###  <a name="Security"></a> 安全性  
 如需安全性的相關資訊，請參閱 [RESTORE HEADERONLY &#40;Transact-SQL&#41;](../Topic/RESTORE%20HEADERONLY%20\(Transact-SQL\).md)。  
...
3.  使用 [RESTORE HEADERONLY](../Topic/RESTORE%20HEADERONLY%20\(Transact-SQL\).md) 陳述式。 此範例會傳回 `AdventureWorks2012-FullBackup.bak` 檔案的相關資訊。  
