...
## <a name="back-up-files-and-filegroups-using-ssms"></a>使用 SSMS 備份檔案與檔案群組   
...
## <a name="back-up-files-and-filegroups-using-t-sql"></a>使用 T-SQL 備份檔案與檔案群組
