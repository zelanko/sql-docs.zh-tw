...
ms.topic: "article"
helpviewer_keywords: 
  - "災害復原 [SQL Server], 請參閱還原 [SQL Server]"
  - "備份 [SQL Server]"
  - "還原資料庫 [SQL Server]"
  - "備份 [SQL Server], 請參閱備份 [SQL Server]"
  - "資料庫 [SQL Server], 還原"
  - "備份資料庫 [SQL Server]"
  - "還原 [SQL Server], 請參閱還原 [SQL Server]"
  - "災害復原 [SQL Server], 請參閱備份 [SQL Server]"
  - "備份 [SQL Server]"
  - "Database Engine [SQL Server], 備份"
  - "資料庫 [SQL Server], 備份"
