...
- 如果您的伺服器透過 Proxy 伺服器存取 Azure，您必須使用追蹤旗標 1819，然後透過下列其中一個方法來設定 WinHTTP Proxy 設定：
   ...
   - Windows Vista 與 Windows Server 2008 或更新版本上的 [netsh.exe](/previous-versions/windows/it-pro/windows-server-2008-R2-and-2008/cc731131) 公用程式。 
...
##  <a name="back-up-up-with-ssms"></a><a name="BackupTaskSSMS"></a> 使用 SSMS 備份  
