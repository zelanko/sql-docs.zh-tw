---
title: "使用標示的異動以一致的方式復原相關資料庫 (完整復原模式) | Microsoft Docs"
ms.custom: ""
ms.date: "03/14/2017"
...
helpviewer_keywords: 
  - "異動標記 [SQL Server]"
  - "標示的交易 [SQL Server]"
  - "資料庫還原 [SQL Server], 插入異動標記"
  - "復原 [SQL Server], 相關資料庫"
  - "還原資料庫 [SQL Server], 相關資料庫復原"
  - "復原還原 [SQL Server], 相關資料庫"
  - "標示的交易 [SQL Server], 建立"
  - "BEGIN TRAN...WITH MARK 陳述式"
  - "兩階段認可"
...
-   標示的交易認可之後，會在 **msdb** 的 [logmarkhistory](../../relational-databases/system-tables/logmarkhistory-transact-sql.md) 資料表中插入一個資料列。  
