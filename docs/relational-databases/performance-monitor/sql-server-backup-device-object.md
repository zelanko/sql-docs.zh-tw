...
description: 了解 Backup Device 物件，其所提供計數器可監視備份與還原作業所使用的 Microsoft SQL Server 備份裝置。
ms.custom: ''
ms.date: 03/14/2017
ms.prod: sql
