...
|----------------------------------------------|-----------------|  
|**Avg. Length of Batched Writes**|儲存於批次中的傳輸物件平均數目。|  
|**Avg. Time To Write Batch (ms)**|儲存傳輸物件批次所需的平均毫秒數。|  
|**Avg. Time to Write Batch Base**|僅供內部使用。|
|**Avg. Time Between Batches (ms)**|傳輸物件批次寫入之間的平均毫秒數。|  
|**Avg. Time Between Batches Base**|僅供內部使用。| 
