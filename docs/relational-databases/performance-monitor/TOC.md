...
# [SQL Server Agent、Statistics 物件](sql-server-agent-statistics-object.md)
# [SQL Server 的 Broker Statistics 物件](sql-server-broker-statistics-object.md)
# [SQL Server、Deprecated Features 物件](sql-server-deprecated-features-object.md)
# [SQL Server Agent、Alerts 物件](sql-server-agent-alerts-object.md)
...
# [SQL Server, 查詢存放區物件](sql-server-query-store-object.md)
# [SQL Server：HTTP_STORAGE_OBJECT](sql-server-http-storage-object.md)
# [SQL Server, Columnstore 物件](sql-server-columnstore-object.md)
...
# [SQL Server, LogPool FreePool 物件](sql-server-logpool-freepool-object.md)
# [SQL Server, 外部指令碼物件](sql-server-external-scripts-object.md)
...
# [SQL Server, Memory Broker Clerks 物件](sql-server-memory-broker-clerks-object.md)
# [SQL Server Agent、JobSteps 物件](sql-server-agent-jobsteps-object.md)
...
# [SQL Server 代理程式、作業物件](sql-server-agent-jobs-object.md)
