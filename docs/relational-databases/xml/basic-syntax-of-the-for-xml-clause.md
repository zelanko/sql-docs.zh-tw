...
> [!IMPORTANT]  
> FOR XML 選項的 **XMLDATA** 指示詞**已淘汰**。 在 RAW 和 AUTO 模式的情況下，請使用 XSD 產生。 EXPLICT 模式中沒有 XMLDATA 指示詞的替代項目。 [!INCLUDE[ssNoteDepFutureAvoid](../../includes/ssnotedepfutureavoid-md.md)]

## <a name="syntax"></a>語法

下列是 [FOR 子句 (Transact-SQL)](../../t-sql/queries/select-for-clause-transact-sql.md) 中描述的基本語法。
...
如需同樣適用於 Azure SQL Database SELECT...**FOR XML** 子句的文件，請參閱 [FOR XML (SQL Server)](../../relational-databases/xml/for-xml-sql-server.md)。
