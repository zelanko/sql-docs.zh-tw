...
# [範例：重新命名 <資料列> 元素](example-renaming-the-row-element.md)
# [搭配 FOR XML 使用 PATH 模式](use-path-mode-with-for-xml.md)
# [在 FOR XML 查詢中的 TYPE 指示詞](type-directive-in-for-xml-queries.md)
...
# [撤銷 XML 結構描述集合上的權限](revoke-permissions-on-an-xml-schema-collection.md)
...
# [使用者自訂資料類型 (UDT) 的 FOR XML 支援](for-xml-support-for-the-user-defined-data-types-udt.md)
