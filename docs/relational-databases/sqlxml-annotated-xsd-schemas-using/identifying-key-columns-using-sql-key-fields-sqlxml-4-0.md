...
[!INCLUDE[appliesto-ss-asdb-xxxx-xxx-md](../../includes/appliesto-ss-asdb-xxxx-xxx-md.md)]針對 XSD 結構描述指定 XPath 查詢時，索引鍵資訊才能在大部分情況下取得適當的巢狀結果。 指定**sql: key-fields-欄位**註解是確保會產生適當階層的方式。  
