...
---
# 最佳化 NewOrg 資料表
您在[使用現有的階層式資料填入資料表](../../relational-databases/tables/populating-a-table-with-existing-hierarchical-data.md)工作中建立的 **NewOrd** 資料表包含所有員工資訊，並使用 **hierarchyid** 資料類型代表階層式結構。 此工作會新增索引以支援在 **hierarchyid** 資料行上進行搜尋。  
