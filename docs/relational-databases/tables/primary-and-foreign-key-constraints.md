...
ms.openlocfilehash: 5c2fa1b1b89d617917ee7be8120521cf79167cde
...
|描述如何停用複寫的外部索引鍵條件約束。|[停用複寫的外部索引鍵條件約束](../../relational-databases/tables/disable-foreign-key-constraints-for-replication.md)|  
