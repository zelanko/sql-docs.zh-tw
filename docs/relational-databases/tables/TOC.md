...
### [修改系統設定版本時態表中的資料](modifying-data-in-a-system-versioned-temporal-table.md)  
### [查詢系統設定版本時態表中的資料](querying-data-in-a-system-versioned-temporal-table.md)  
### [變更系統設定版本時態表的結構描述](changing-the-schema-of-a-system-versioned-temporal-table.md)  
