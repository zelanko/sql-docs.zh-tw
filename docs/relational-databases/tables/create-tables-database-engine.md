---
description: 建立資料表 (Database Engine)
...
4.  鍵入資料行名稱，選擇資料類型，然後選擇是否允許讓每個資料行都是 null，如下圖所示：  
     ...
     ![顯示已選取 ModifiedDate 資料行的 [允許 Null] 選項的螢幕擷取畫面。](../../relational-databases/tables/media/addcolumnsintabledesigner.gif "AddColumnsinTableDesigner")  
...
7.  若要建立外部索引鍵關聯性、檢查條件約束或索引，請在 [資料表設計工具] 窗格中按一下滑鼠右鍵並選取清單中的物件，如下圖所示：  
     ...
     ![顯示 [關聯性] 選項的螢幕擷取畫面。](../../relational-databases/tables/media/addtableobjects.gif "AddTableObjects")  
...
8.  依預設，此資料表包含在 **dbo** 結構描述中。 若要為資料表指定不同的結構描述，請在 [資料表設計工具] 窗格中按一下滑鼠右鍵並選取 [屬性]，如下圖所示。 從 [結構描述] 下拉式清單中選取適當的結構描述。  
     ...
     ![顯示 [結構描述] 選項的 [屬性] 窗格螢幕擷取畫面。](../../relational-databases/tables/media/specifyatableschema.gif "Specifyatableschema")  
