# [概觀](system-dynamic-management-views.md)  

# [AlwaysOn 可用性群組](always-on-availability-groups-dynamic-management-views-functions.md)  
...
# [執行](execution-related-dynamic-management-views-and-functions-transact-sql.md)  
...
# [記憶體最佳化資料表](memory-optimized-table-dynamic-management-views-transact-sql.md)  
...
# [物件](object-related-dynamic-management-views-and-functions-transact-sql.md)  
...
# [複寫](replication-related-dynamic-management-views-transact-sql.md)  
...
# [資源管理員](resource-governor-related-dynamic-management-views-transact-sql.md)  
...
# [與伺服器相關](server-related-dynamic-management-views-and-functions-transact-sql.md)  
...
# [SQL Server 作業系統](sql-server-operating-system-related-dynamic-management-views-transact-sql.md)  
