...
|distribution_type|**nvarchar(32)**|將會進行此步驟的散發類型。|'AllNodes', 'AllDistributions', 'AllComputeNodes', 'ComputeNode', 'Distribution', 'SubsetNodes', 'SubsetDistributions', 'Unspecified'|  
|location_type|**nvarchar(32)**|其中正在執行的步驟。|' Compute'、 '控制項'，'DMS'|  
