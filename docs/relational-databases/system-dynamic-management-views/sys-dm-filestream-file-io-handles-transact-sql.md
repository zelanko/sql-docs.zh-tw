...
|**filestream_transaction_id**|**varbinary(128)**|顯示與給定控制代碼相關聯之交易的識別碼。 這是 **get_filestream_transaction_coNtext** 函數所傳回的值。 您可以使用此欄位來聯結 **sys. dm_filestream_file_io_requests** 視圖。 可為 Null。|  
