...
|distribution_id|**Int**|如果有任何背景工作執行所在的發佈。|請參閱在 distribution_id [sys.pdw_distributions &#40;TRANSACT-SQL &#41;](../../relational-databases/system-catalog-views/sys-pdw-distributions-transact-sql.md).|  
