...
> **注意：** 若要從或呼叫這個 [!INCLUDE[ssSDWfull](../../includes/sssdwfull-md.md)] [!INCLUDE[ssPDW](../../includes/sspdw-md.md)] ，請使用名稱 **sys. dm_pdw_nodes_os_sys_info**。  
...
|**sqlserver_start_time_ms_ticks**|**bigint**|代表**ms_tick** [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] 上一次啟動時的 ms_tick 號碼。 與目前的 ms_ticks 資料行比較。 不可為 Null。|  
