...
|**visible_target_kb**|**int**|**適用於**：[!INCLUDE[ssSQL11](../../includes/sssql11-md.md)] 及更新版本。<br /><br /> 與**committed_target_kb**相同。 不可為 Null。|  
...
|**virtual_machine_type_desc**|**nvarchar(60)**|**適用於**：[!INCLUDE[ssKilimanjaro](../../includes/sskilimanjaro-md.md)] 及更新版本。<br /><br /> 描述**virtual_machine_type**資料行。 不可為 Null。<br /><br /> NONE = [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] 不是在虛擬機器內執行。<br /><br /> 在執行虛擬機器的 OS （採用硬體輔助虛擬化的主機 OS）內部，執行程式管理平臺（virtual machine）中的 [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)]。<br /><br /> OTHER = [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] 是在不採用硬體助理（例如 Microsoft Virtual PC）的 OS 所裝載的虛擬機器內執行。|  
|**softnuma_configuration**|**int**|**適用於**：[!INCLUDE[ssSQL15](../../includes/sssql15-md.md)] 及更新版本。<br /><br /> 指定 NUMA 節點的設定方式。 不可為 Null。<br /><br /> 0 = 關閉表示硬體預設值<br /><br /> 1 = 自動軟體 NUMA<br /><br /> 2 = 透過登錄手動軟體 NUMA|  
|**softnuma_configuration_desc**|**nvarchar(60)**|**適用於**：[!INCLUDE[ssSQL15](../../includes/sssql15-md.md)] 及更新版本。<br /><br /> OFF = 軟 NUMA 功能已關閉<br /><br /> ON = [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] 會自動決定軟體 NUMA 的 NUMA 節點大小<br /><br /> MANUAL = 手動設定的軟體 NUMA|
