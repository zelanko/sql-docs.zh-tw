...
> **注意：** 呼叫這個屬性從[!INCLUDE[ssSDWfull](../../includes/sssdwfull-md.md)]或是[!INCLUDE[ssPDW](../../includes/sspdw-md.md)]，使用名稱**sys.dm_pdw_nodes_os_sys_info**。  
...
|**process_physical_affinity**|**nvarchar(3072)** |**適用於：** 開頭[!INCLUDE[ssSQL17](../../includes/sssql17-md.md)]。<br /><br />尚未要取得的資訊。 |
...
|**cores_per_socket** |**int** | **適用於**：[!INCLUDE[ssSQL15](../../includes/sssql15-md.md)] SP2 到 [!INCLUDE[ssCurrent](../../includes/sscurrent-md.md)]。<br /><br />在系統上指定每個通訊端可用的處理器的數目。 |  
|**numa_node_count** |**int** | **適用於**：[!INCLUDE[ssSQL15](../../includes/sssql15-md.md)] SP2 到 [!INCLUDE[ssCurrent](../../includes/sscurrent-md.md)]。<br /><br />指定系統上的可用的 numa 節點數目。 此資料行包含實體 numa 節點，以及軟體式 numa 節點。 |  
