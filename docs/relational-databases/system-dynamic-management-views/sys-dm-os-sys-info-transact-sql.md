...
|**bpool_committed**|**int**|**適用物件：** [!INCLUDE[ssKatmai](../../includes/sskatmai-md.md)]至 [!INCLUDE[ssKilimanjaro](../../includes/sskilimanjaro-md.md)] 。<br /><br /> 代表記憶體管理員中已認可的記憶體 (KB)。 不包含記憶體管理員中的保留記憶體。 不可為 Null。|  
...
|**sqlserver_start_time**|**datetime**|指定本機系統日期和 [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] 上次啟動的時間。 不可為 Null。|  
...
|**softnuma_configuration_desc**|**nvarchar(60)**|**適用於：** [!INCLUDE[ssSQL15](../../includes/sssql15-md.md)] 及更新版本。<br /><br /> OFF = 軟 NUMA 功能已關閉<br /><br /> ON = [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] 自動決定軟體 numa 的 numa 節點大小<br /><br /> MANUAL = 手動設定的軟體 NUMA|
...
|**cores_per_socket** |**int** | **適用範圍：** [!INCLUDE[ssSQL15](../../includes/sssql15-md.md)] SP2 及更新版本。<br /><br />指定系統上每個通訊端可用的處理器數目。 |  
|**numa_node_count** |**int** | **適用範圍：** [!INCLUDE[ssSQL15](../../includes/sssql15-md.md)] SP2 及更新版本。<br /><br />指定系統上可用的 numa 節點數目。 此資料行包含實體 numa 節點和軟性 numa 節點。 |  
