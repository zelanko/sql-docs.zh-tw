...
|**operational_state**|**tinyint**|目前的複本，其中一個操作狀態：<br /><br /> 0 = 暫止容錯移轉<br /><br /> 1 = 暫止<br /><br /> 2 = Online<br /><br /> 3 = 離線<br /><br /> 4 = 失敗<br /><br /> 5 = 失敗，無仲裁<br /><br /> NULL = 複本不是本機。<br /><br /> 如需詳細資訊，請參閱[角色和操作狀態](#RolesAndOperationalStates)稍後在本主題中。|  
