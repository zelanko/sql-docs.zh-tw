---
title: sys.databases dm_exec_xml_handles （Transact-sql） |Microsoft Docs
ms.custom: ''
ms.date: 03/15/2017
ms.prod: sql
...
[!INCLUDE[tsql-appliesto-ss2008-xxxx-asdw-xxx-md](../../includes/tsql-appliesto-ss2008-xxxx-asdw-xxx-md.md)]
  ...
  傳回**sp_xml_preparedocument**已開啟的使用中控制碼的相關資訊。  
 ...
 *session_id* |0  
 工作階段的識別碼。 如果指定*session_id* ，此函數會傳回指定會話中 XML 控制碼的相關資訊。  
