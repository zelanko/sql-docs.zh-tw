---
title: sys.databases dm_xtp_gc_queue_stats （Transact-sql） |Microsoft Docs
ms.custom: ''
ms.date: 08/02/2016
ms.prod: sql
ms.reviewer: ''
...
[!INCLUDE [SQL Server Azure SQL Database](../../includes/applies-to-version/sql-asdb.md)]
 ...
 您可以藉由執行 sys.dm_xtp_gc_queue_stats 來了解已加入佇列的工作是否已經在處理，藉以判斷記憶體回收是否釋出已刪除之資料列的記憶體。 如果未處理 current_queue_depth 中的專案，或如果沒有任何新的工作專案加入 current_queue_depth，這就表示垃圾收集並未釋放記憶體。 例如，如果有長時間執行的交易，則無法進行垃圾收集。  
