---
title: sys.databases dm_pdw_lock_waits （Transact-sql） |Microsoft Docs
ms.custom: ''
ms.date: 03/07/2017
ms.prod: sql
...
ms.locfileid: "67899381"
---
# <a name="sysdm_pdw_lock_waits-transact-sql"></a>sys.databases dm_pdw_lock_waits （Transact-sql）
...
|型別|**nvarchar(255)**|此專案所代表的等候類型。|可能的值：<br /><br /> Shared<br /><br /> SharedUpdate<br /><br /> ExclusiveUpdate<br /><br /> 獨佔|  
