...
在[!INCLUDE[ssSDS_md](../../includes/sssds-md.md)]高階層級上， `VIEW DATABASE STATE`需要資料庫的許可權。 在[!INCLUDE[ssSDS_md](../../includes/sssds-md.md)] [ `Server Admin`標準] 和 [基本] 層上，需要角色`Azure Active Directory admin`成員資格或帳戶。   
