...
> [!NOTE]  
>  若要從或呼叫這個 [!INCLUDE[ssSDWfull](../../includes/sssdwfull-md.md)] [!INCLUDE[ssPDW](../../includes/sspdw-md.md)] ，請使用 **sys.dm_pdw_nodes_tran_top_version_generators** 名稱。  
...
## <a name="remarks"></a>備註  
 因為 **sys.dm_tran_top_version_generators** 可能必須在掃描整個版本存放區時讀取許多頁面，所以執行 **sys.dm_tran_top_version_generators** 可能會干擾系統效能。  
