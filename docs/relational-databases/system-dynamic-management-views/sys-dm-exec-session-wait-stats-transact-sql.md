...
## <a name="remarks"></a>Remarks  
 ...
 如需等候類型的詳細資訊，請參閱[sys.databases &#40;。 dm_os_wait_stats transact-sql&#41;](../../relational-databases/system-dynamic-management-views/sys-dm-os-wait-stats-transact-sql.md)。  
  
## <a name="permissions"></a>Permissions  
 如果使用者具有伺服器的**VIEW SERVER STATE**許可權，則使用者會在 [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)]的實例上看到所有執行中的會話;否則，使用者只會看到目前的會話。  
