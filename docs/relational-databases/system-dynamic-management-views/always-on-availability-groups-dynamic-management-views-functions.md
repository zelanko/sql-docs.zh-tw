---
description: Always On 可用性群組動態管理檢視-函數
title: Always On 可用性群組動態管理 Views-函數 |Microsoft Docs
ms.custom: ''
ms.date: 03/16/2017
ms.prod: sql
ms.reviewer: ''
...
ms.locfileid: "89551334"
---
# <a name="always-on-availability-groups-dynamic-management-views---functions"></a>Always On 可用性群組動態管理檢視-函數
