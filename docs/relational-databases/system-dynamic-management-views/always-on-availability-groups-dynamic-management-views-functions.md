---
title: Alwayson 可用性群組動態管理檢視-函式 |Microsoft Docs
ms.custom: ''
ms.date: 03/16/2017
ms.prod: sql
ms.reviewer: ''
...
ms.locfileid: "47646946"
---
# <a name="always-on-availability-groups-dynamic-management-views---functions"></a>Alwayson 可用性群組動態管理檢視-函式
