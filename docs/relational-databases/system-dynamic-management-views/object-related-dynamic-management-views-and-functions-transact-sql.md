---
description: 物件相關的動態管理檢視和函數 (Transact-SQL)
title: 物件相關的動態管理檢視和函數 (Transact-sql) |Microsoft Docs
ms.custom: ''
ms.date: 02/10/2017
ms.prod: sql
ms.reviewer: ''
