...
|**user_objects_deferred_dealloc_page_count**|**bigint**|已標示為延後的取消配置的頁面數目。<br /><br /> **注意：** 在 service pack 中引進[!INCLUDE[ssSQL11](../../includes/sssql11-md.md)]和[!INCLUDE[ssSQL14](../../includes/sssql14-md.md)]。|  
