...
|**is_primary_replica**|**bit**|如果複本是主要的，則傳回 1; 如果是資料庫所屬可用性群組中的次要複本，則傳回0。 這不是指分散式可用性群組或作用中異地複寫關聯中的主要或次要資料庫。<br /><br />**適用物件：** [!INCLUDE[ssSQL14](../../includes/sssql14-md.md)]和更新版本。|  
