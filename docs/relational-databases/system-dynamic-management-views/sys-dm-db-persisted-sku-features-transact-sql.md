...
-   **MultipleFSContainers**： 表示資料庫使用多個 FILESTREAM 容器。 此資料庫有多個容器 （檔案） 的 FILESTREAM 檔案群組。 如需詳細資訊，請參閱 [FILESTREAM &#40;SQL Server&#41;](../../relational-databases/blob/filestream-sql-server.md)。  
