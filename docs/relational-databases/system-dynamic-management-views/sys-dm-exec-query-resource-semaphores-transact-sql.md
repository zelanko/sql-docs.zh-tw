...
> [!NOTE]  
>  若要從或呼叫這個 [!INCLUDE[ssSDWfull](../../includes/sssdwfull-md.md)] [!INCLUDE[ssPDW](../../includes/sspdw-md.md)] ，請使用名稱 **sys. dm_pdw_nodes_exec_query_resource_semaphores**。  
...
## <a name="remarks"></a>備註  
 ...
 使用 **sys. dm_exec_query_resource_semaphores** 進行疑難排解，但不將它包含在將使用未來版本的應用程式中 [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] 。  
