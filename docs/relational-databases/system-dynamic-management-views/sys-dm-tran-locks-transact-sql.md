...
|資料行名稱|資料類型|描述|  
|-----------------|---------------|-----------------|  
|**resource_type**|**nvarchar(60)**|代表資源類型。 這個值可以是下列值之一：資料庫、 檔案、 物件、 頁面、 索引鍵、 範圍、 RID、 應用程式、 中繼資料、 HOBT 或 ALLOCATION_UNIT。|  
