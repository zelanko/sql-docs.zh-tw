...
|**is_primary_replica**|**bit**|如果複本是主要，則會傳回 1，或者如果它是次要複本，則會傳回 0。<br /><br />**適用物件：** [!INCLUDE[ssSQL14](../../includes/sssql14-md.md)]和更新版本。|  
...
|**secondary_lag_seconds**|**bigint**|在同步處理期間，次要複本在主要複本後方的秒數。<br /><br />**適用物件：** [!INCLUDE[ssSQL15](../../includes/sssql15-md.md)]和更新版本。|  
