...
|encryption_scan_state_desc|**nvarchar(32)**|**適用對象**：[!INCLUDE[sql-server-2019](../../includes/sssqlv15-md.md)] 及更新版本。<br><br>表示加密掃描目前狀態的字串。<br><br> 無<br><br>RUNNING<br><br>SUSPENDED<br><br>ABORTED<br><br>套|
