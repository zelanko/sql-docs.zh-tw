...
## <a name="remarks"></a>備註  
 若要使用此視圖，您必須連接到**master**資料庫。 [!INCLUDE[ssSDS](../../includes/sssds-md.md)]使用伺服器`sys.dm_operation_status`的 master 資料庫中的 view 來追蹤在上執行之下列作業的狀態： **** [!INCLUDE[ssSDS](../../includes/sssds-md.md)]  
