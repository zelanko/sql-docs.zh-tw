...
[!INCLUDE[tsql-appliesto-ss2008-all-md](../../includes/tsql-appliesto-ss2008-all-md.md)]
  ...
  傳回 [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)]目前配置的記憶體物件。 您可以使用**dm_os_memory_objects sys.databases**來分析記憶體使用量，並找出可能的記憶體流失。  
...
|**page_allocator_address**|**Varbinary （8）**|頁面配置器的記憶體位址。 不可為 Null。 如需詳細資訊，請參閱[sys.databases &#40;。 dm_os_memory_clerks transact-sql&#41;](../../relational-databases/system-dynamic-management-views/sys-dm-os-memory-clerks-transact-sql.md)。|  
 ...
 **partition_type**、 **contention_factor**、 **waiting_tasks_count**和**exclusive_access_count**尚未在 [!INCLUDE[sqldbesa](../../includes/sqldbesa-md.md)]中執行。  
