...
> **注意：** 若要從或呼叫這個 [!INCLUDE[ssSDWfull](../../includes/sssdwfull-md.md)] [!INCLUDE[ssPDW](../../includes/sspdw-md.md)] ，請使用名稱 **sys. dm_pdw_nodes_os_buffer_descriptors**。  
...
## <a name="remarks"></a>備註  
 sys. dm_os_buffer_descriptors 會傳回資源資料庫正在使用的頁面。 sys. dm_os_buffer_descriptors 不會傳回可用或遭竊頁面的相關資訊，或讀取時有錯誤的頁面相關資訊。  
