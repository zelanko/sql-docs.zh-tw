...
|modified_extent_page_count|**Bigint**|**適用於**：[!INCLUDE[ssSQL15](../../includes/sssql15-md.md)] SP2 及更新版本。<br /><br />自上一次完整資料庫備份以來，檔案已配置的範圍中修改的總頁數。 修改過的頁面計數可用來追蹤自從上次完整備份之後，資料庫中的差異變更量，以決定是否需要差異備份。|
