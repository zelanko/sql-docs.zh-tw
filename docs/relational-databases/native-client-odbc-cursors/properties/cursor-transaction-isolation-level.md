...
-   快照集 (SQL_TXN_SS_SNAPSHOT)  
 ...
 請注意，ODBC API 會指定其他交易隔離等級，但是 [!INCLUDE[ssNoVersion](../../../includes/ssnoversion-md.md)] 或 [!INCLUDE[ssNoVersion](../../../includes/ssnoversion-md.md)] Native Client ODBC 驅動程式並不支援。  
