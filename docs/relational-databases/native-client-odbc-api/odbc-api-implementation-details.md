---
description: ODBC API 實作詳細資料
title: ODBC API 的執行詳細資料 |Microsoft Docs
ms.custom: ''
ms.date: 03/16/2017
ms.prod: sql
...
## <a name="see-also"></a>另請參閱  
 [SQL Server Native Client &#40;ODBC&#41; 參考](../native-client/odbc/sql-server-native-client-odbc.md)   
