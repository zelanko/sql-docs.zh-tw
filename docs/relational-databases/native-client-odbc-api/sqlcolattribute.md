...
ms.locfileid: "35696789"
---
# <a name="sqlcolattribute"></a>SQLColAttribute
[!INCLUDE[appliesto-ss-asdb-asdw-pdw-md](../../includes/appliesto-ss-asdb-asdw-pdw-md.md)]
[!INCLUDE[SNAC_Deprecated](../../includes/snac-deprecated.md)]

  您可以使用**SQLColAttribute**來擷取已備妥或已執行的 ODBC 陳述式的結果集資料行的屬性。 呼叫**SQLColAttribute**上備妥的陳述式原因往返[!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)]。 [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] Native Client ODBC 驅動程式接收結果集資料行資料做為陳述式執行，因此呼叫的一部分**SQLColAttribute**完成後**SQLExecute**或**SQLExecDirect**不造成伺服器往返。  
