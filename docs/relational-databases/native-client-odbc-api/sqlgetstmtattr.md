...
## <a name="sql_sopt_ss_nocount_status"></a>SQL_SOPT_SS_NOCOUNT_STATUS  
 SQL_SOPT_SS_NOCOUNT_STATUS 屬性工作表示 NOCOUNT 選項的目前設定，其控制是否在 [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] 呼叫[SQLRowCount](../../relational-databases/native-client-odbc-api/sqlrowcount.md)時，報告語句所影響的資料列數目。 *Valueptr 是*值的類型是 SQLLEN。  
