...
1. 建立測試物件。  在 [!INCLUDE[ssManStudioFull](../../includes/ssmanstudiofull-md.md)] 中執行下列 [!INCLUDE[tsql](../../includes/tsql-md.md)]。  
...
2.  嘗試跨資料庫查詢。 在 [!INCLUDE[ssManStudioFull](../../includes/ssmanstudiofull-md.md)] 中執行下列 [!INCLUDE[tsql](../../includes/tsql-md.md)]。
...
3.  建立記憶體最佳化資料表類型。  在 [!INCLUDE[ssManStudioFull](../../includes/ssmanstudiofull-md.md)] 中執行下列 [!INCLUDE[tsql](../../includes/tsql-md.md)]。
