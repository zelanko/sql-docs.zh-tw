...
|運算|DROP INDEX|不支援卸除記憶體最佳化資料表上的索引。 您可以使用 ALTER TABLE 刪除索引。<br /><br /> 如需詳細資訊，請參閱 [改變記憶體最佳化資料表](../../relational-databases/in-memory-oltp/altering-memory-optimized-tables.md)。|  
