...
## [記憶體最佳化資料表的檢查點作業](checkpoint-operation-for-memory-optimized-tables.md)  
## [為記憶體最佳化物件定義持久性](defining-durability-for-memory-optimized-objects.md)  
...
## [記憶體內部 OLTP 的 SQL Server 管理物件支援](sql-server-management-objects-support-for-in-memory-oltp.md)  
## [記憶體內部 OLTP 的 SQL Server Integration Services 支援](sql-server-integration-services-support-for-in-memory-oltp.md)  
## [記憶體內部 OLTP 的 SQL Server Management Studio 支援](sql-server-management-studio-support-for-in-memory-oltp.md)  
...
## [記憶體最佳化建議程式](memory-optimization-advisor.md)  
