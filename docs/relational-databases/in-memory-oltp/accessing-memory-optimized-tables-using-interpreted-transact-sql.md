---
title: "使用解譯的 Transact-SQL 存取記憶體最佳化的資料表 | Microsoft Docs"
ms.custom: ""
ms.date: "05/31/2016"
...
---
# 使用解譯的 Transact-SQL 存取記憶體最佳化的資料表
...
- 報告查詢，通常會使用原生編譯的預存程序中未提供的建構 (例如「視窗」函數 (有時稱為 [OVER](../Topic/OVER%20Clause%20\(Transact-SQL\).md) 函數))。  
...
如需有關資料表提示的詳細資訊，請參閱。 [資料表提示 &#40;Transact-SQL&#41;](../Topic/Table%20Hints%20\(Transact-SQL\).md)。 已加入 SNAPSHOT 來支援 [!INCLUDE[hek_2](../../includes/hek-2-md.md)]。  
...
- 將 [MEMORY_OPTIMIZED_ELEVATE_TO_SNAPSHOT][](../Topic/ALTER%20DATABASE%20SET%20Options%20\(Transact-SQL\).md) 資料庫選項設定為 [ON]。  
  
在[自動認可模式](http://msdn.microsoft.com/zh-tw/c8de5b60-d147-492d-b601-2eeae8511d00)下執行之查詢所存取的記憶體最佳化資料表不需要隔離等級資料表提示。  
