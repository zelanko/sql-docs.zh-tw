---
title: "使用記憶體最佳化資料表的需求 | Microsoft Docs"
ms.custom: 
  - "SQL2016_New_Updated"
ms.date: "11/16/2016"
...
[!INCLUDE[tsql-appliesto-ss2014-xxxx-xxxx-xxx_md](../../includes/tsql-appliesto-ss2014-xxxx-xxxx-xxx-md.md)]
 ...
 除了 [安裝 SQL Server 2016 的硬體與軟體需求](../../sql-server/install/hardware-and-software-requirements-for-installing-sql-server-2016.md)以外，以下還有使用記憶體內部 OLTP 的需求：  
...
## <a name="important-notes-on-using-includehek2tokenhek2mdmd"></a>使用 [!INCLUDE[hek_2](../../includes/hek-2-md.md)] 的重要注意事項  
