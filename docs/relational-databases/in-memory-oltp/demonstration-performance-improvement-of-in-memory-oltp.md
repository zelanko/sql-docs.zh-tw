...
description: 這個程式碼範例會使用已解譯的 Transact-SQL 和原生編譯的預存程序來示範記憶體最佳化資料表的快速效能。
...
### <a name="step-1a-prerequisite-if-using-ssnoversion"></a>步驟 1a：使用 [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] 時的必要條件  
...
### <a name="step-1b-prerequisite-if-using-sssdsfull"></a>步驟 1b：使用 [!INCLUDE[ssSDSFull](../../includes/sssdsfull-md.md)] 時的必要條件  
