...
ms.locfileid: "33181244"
---
# <a name="sysdatabaseautomatictuningoptions-transact-sql"></a>log_reuse_wait_desc\_自動\_tuning_options (TRANSACT-SQL)
...
|-----------------|---------------|-----------------|  
|**name**|**nvarchar(128)**|自動微調選項的名稱。 請參閱[ALTER DATABASE 設定 AUTOMATIC_TUNING &#40;TRANSACT-SQL&#41; ](../../t-sql/statements/alter-database-transact-sql-set-options.md)可用選項。|  
