...
|**於 actual_state**|**smallint**|表示自動微調選項的作業模式。<br />0 = OFF<br />1 = ON |  
|**actual_state_desc**|**nvarchar （60)**|自動微調選項的實際作業模式的文字描述。<br />OFF<br />ON|  
|**原因**|**smallint**|表示實際和所需的狀態為何不同。<br />2 = 已停用<br />11 = QUERY_STORE_OFF<br />12 = QUERY_STORE_READ_ONLY<br />13 = NOT_SUPPORTED|   
