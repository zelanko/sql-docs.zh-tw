---
title: sys.fulltext_indexes (TRANSACT-SQL) |Microsoft 文件
ms.custom: ''
ms.date: 06/10/2016
ms.prod: sql
...
> [!NOTE]  
>  建立此全文檢索索引的程式碼範例，請參閱 「 範例 」 一節[CREATE FULLTEXT INDEX &#40;TRANSACT-SQL&#41;](../../t-sql/statements/create-fulltext-index-transact-sql.md)。  
