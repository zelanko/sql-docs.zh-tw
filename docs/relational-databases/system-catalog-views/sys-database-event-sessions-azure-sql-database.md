---
title: sys.database_event_sessions (Azure SQL Database) |Microsoft 文件
ms.custom: ''
ms.date: 03/14/2017
ms.prod: ''
...
ms.locfileid: "33180744"
---
# <a name="sysdatabaseeventsessions-azure-sql-database"></a>sys.database_event_sessions (Azure SQL Database)
[!INCLUDE[tsql-appliesto-xxxxxx-asdb-xxxx-xxx-md](../../includes/tsql-appliesto-xxxxxx-asdb-xxxx-xxx-md.md)]

  列出在目前資料庫中存在的所有事件工作階段定義[!INCLUDE[ssSDSfull](../../includes/sssdsfull-md.md)]。  
  
> [!NOTE]  
>  名為類似的目錄檢視`sys.server_event_sessions`僅適用於[!INCLUDE[msCoName](../../includes/msconame-md.md)] [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)]。  
  
||  
|-|  
|**適用於**: [!INCLUDE[sqldbesa](../../includes/sqldbesa-md.md)]，以及任何更新的版本。|  
...
|memory_partition_mode|**nchar(1)**|在記憶體中建立事件緩衝區的位置。 預設的分割模式為 G。不可設為 Null。 memory_partition_mode 是下列之一：<br /><br /> G - NONE<br /><br /> C - PER_CPU<br /><br /> N - PER_NODE|  
