...
|資料行名稱|資料類型|描述|  
|-----------------|---------------|-----------------|  
|*\<inherited columns>*||如需此視圖所繼承之資料行的清單，請參閱[&#40;transact-sql&#41;的 sys.databases 類型](../../relational-databases/system-catalog-views/sys-types-transact-sql.md)。|  
