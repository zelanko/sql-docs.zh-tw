...
|**minimum_value**|**sql_variant NULL**|可由順序物件產生的最小值。 達到此值之後，順序物件在嘗試產生更多的值時會傳回錯誤，如果已指定 CYCLE 選項則會重新啟動。 如果尚未指定任何 MINVALUE，這個資料行會傳回順序產生器的資料類型所支援的最小值。|  
...
|**last_used_value**|**sql_variant NULL**|傳回所產生的最後一個值[Next Value For](../../t-sql/functions/next-value-for-transact-sql.md)函式。 適用於 SQL Server 2017 和更新版本。|  
