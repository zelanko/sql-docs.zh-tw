...
|類型|**tinyint**|配置單位的類型：<br /><br /> 0 = 已卸除<br /><br /> 1 = 同資料列資料 (除 LOB 資料類型之外的所有資料類型)<br /><br /> 2 = 大型物件（LOB）資料（**text**、 **Ntext**、 **image**、 **xml**、大數數值型別和 CLR 使用者定義類型）<br /><br /> 3 = 資料列溢位資料|  
