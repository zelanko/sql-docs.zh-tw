...
ms.openlocfilehash: 96f0d1bf6d6210c41ec3b6ea228ef53b3c9c82a9
...
|**sys.views**|**bit**|1 = 檢視是由系統自動建立，以儲存 datetime 資料行之間的相互關聯資訊。 若要建立這份檢視，請將 DATE_CORRELATION_OPTIMIZATION 設為 ON。|  
