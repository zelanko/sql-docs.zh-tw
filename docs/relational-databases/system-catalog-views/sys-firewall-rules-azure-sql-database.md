...
## <a name="remarks"></a>備註
 ...
 若要傳回與您的 Microsoft Azure SQL Database 相關聯之資料庫層級防火牆設定的資訊, 請使用[database_firewall_rules &#40;Azure SQL Database&#41;](../../relational-databases/system-catalog-views/sys-database-firewall-rules-azure-sql-database.md)。  
