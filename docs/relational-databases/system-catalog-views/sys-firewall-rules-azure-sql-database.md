...
|NAME|**& LT;LANGUAGEKEYWORD&GT;NVARCHAR(128)&LT;/LANGUAGEKEYWORD&GT**|您選擇用來描述和區分伺服器層級防火牆設定的名稱。|  
...
|end_ip_address|**VARCHAR(50**|伺服器層級防火牆設定範圍中最高的 IP 位址。 等於或小於這個位址的 IP 位址可以嘗試連接至 [!INCLUDE[ssSDS](../../includes/sssds-md.md)] 伺服器。 可能的最高 IP 位址為 `255.255.255.255`。<br /><br /> 注意： Windows Azure 的連線嘗試時，便允許這個欄位並**start_ip_address**欄位等於`0.0.0.0`。|  
