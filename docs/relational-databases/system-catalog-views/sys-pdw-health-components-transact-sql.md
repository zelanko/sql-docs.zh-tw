...
|group_id|**Int**|此元件所屬的邏輯元件群組。 請參閱[sys.pdw_health_components (Parallel Data Warehouse)](../../relational-databases/system-catalog-views/sys-pdw-health-components-transact-sql.md)。|NOT NULL|  
