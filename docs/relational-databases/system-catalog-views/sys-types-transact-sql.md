...
|**rule_object_id**|**int**|使用[sp_bindrule](../../relational-databases/system-stored-procedures/sp-bindrule-transact-sql.md)系結至類型的獨立規則識別碼。<br /><br /> 0 = 沒有規則。|  
