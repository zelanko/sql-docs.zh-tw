...
|**version**|**int**|字典格式的版本。|  
|**型別**|**int**|字典類型：<br /><br /> 1 – 雜湊字典包含**int**值<br /><br /> 2 – 未使用<br /><br /> 3 – 包含字串值的雜湊字典<br /><br /> 4 – 雜湊字典包含**float**值<br /><br /> 如需字典的詳細資訊，請參閱[資料行存放區索引指南](~/relational-databases/indexes/columnstore-indexes-overview.md)。|  
