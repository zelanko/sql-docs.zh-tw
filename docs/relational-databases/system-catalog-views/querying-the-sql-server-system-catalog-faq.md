...
###  <a name="_FAQ1"></a>如何? 在指定的資料庫中找不到叢集索引的所有資料表嗎？  
...
###  <a name="_FAQ2"></a>如何? 尋找指定的架構中包含的所有實體擁有者嗎？  
...
###  <a name="_FAQ3"></a>如何? 尋找沒有主鍵的所有資料表嗎？  
 在您執行下列查詢之前，請使用有效的資料庫名稱取代 `<database_name>`。  
...
###  <a name="_FAQ4"></a>如何? 尋找沒有索引的所有資料表嗎？  
 在您執行下列查詢之前，請使用有效的資料庫名稱取代 `<database_name>`。  
...
###  <a name="_FAQ5"></a>如何? 尋找具有識別欄位的所有資料表嗎？  
 在您執行下列查詢之前，請使用有效的資料庫名稱取代 `<database_name>`。  
...
###  <a name="_FAQ7"></a>如何? 找出指定之資料表的資料行類型嗎？  
...
###  <a name="_FAQ8"></a>如何? 在指定的函式上尋找相依性嗎？  
...
###  <a name="_FAQ9"></a>如何? 尋找資料庫中的所有預存程式？  
...
###  <a name="_FAQ10"></a>如何? 找出指定的預存程式或函數的參數嗎？  
...
###  <a name="_FAQ12"></a>如何? 在資料庫中尋找所有使用者定義函數嗎？  
 在您執行下列查詢之前，請使用有效的資料庫名稱取代 `<database_name>`。  
...
###  <a name="_FAQ13"></a>如何? 在資料庫中尋找所有視圖嗎？  
 在您執行下列查詢之前，請使用有效的資料庫名稱取代 `<database_name>`。  
...
###  <a name="_FAQ6"></a>如何? 尋找過去 N 天內修改過的所有實體嗎？  
...
###  <a name="_FAQ14"></a>如何? 找出指定資料表的 LOB 資料類型嗎？  
 在您執行下列查詢之前，請使用有效的名稱取代 `<database_name>` 及 `<schema_name.table_name>`。  
...
###  <a name="_FAQ19"></a>如何? 查看伺服器層級觸發程式的定義嗎？  
...
###  <a name="_FAQ16"></a>如何? 尋找指定資料表的主鍵資料行嗎？  
 在您執行下列查詢之前，請使用有效的名稱取代 `<database_name>` 及 `<schema_name.table_name>`。  
...
###  <a name="_FAQ17"></a>如何? 找出指定資料表的外鍵資料行嗎？  
 在您執行下列查詢之前，請使用有效的名稱取代 `<database_name>` 及 `<schema_name.table_name>`。  
...
###  <a name="_FAQ18"></a>如何? 尋找對指定的主體授與或拒絕的許可權嗎？  
...
###  <a name="_FAQ20"></a>如何? 判斷是否在計算資料行運算式中使用資料行？  
...
###  <a name="_FAQ21"></a>如何? 尋找計算資料行運算式中使用的所有資料行？  
 在您執行下列查詢之前，請使用有效的名稱取代 `<database_name>`。  
...
###  <a name="_FAQ22"></a>如何? 尋找相依于指定 CLR 使用者定義型別或別名型別的資料行？  
...
###  <a name="_FAQ23"></a>如何? 尋找相依于指定 CLR 使用者定義型別或別名型別的計算資料行？  
...
###  <a name="_FAQ24"></a>如何? 尋找相依于指定 CLR 使用者定義型別或別名型別的參數嗎？  
...
###  <a name="_FAQ25"></a>如何? 尋找相依于指定 CLR 使用者定義型別的檢查條件約束？  
...
###  <a name="_FAQ26"></a>如何? 找出相依于指定 CLR 使用者定義型別或別名型別的 views、Transact-sql 函數和 Transact-sql 預存程式嗎？  
 在您執行下列查詢之前，請使用有效的名稱取代 `<database_name>`，並使用符合結構描述的有效 CLR 使用者定義型別、別名類型名稱來取代 `<schema_name.data_type_name>`。  
...
###  <a name="_FAQ27"></a>如何? 尋找指定資料表的所有條件約束嗎？  
 在您執行下列查詢之前，請使用有效的名稱取代 `<database_name>` 及 `<schema_name.table_name>`。  
...
###  <a name="_FAQ28"></a>如何? 尋找指定資料表的所有索引嗎？  
 在您執行下列查詢之前，請使用有效的名稱取代 `<database_name>` 及 `<schema_name.table_name>`。  
...
###  <a name="_FAQ30"></a>如何? 尋找所有具有指定之資料行名稱的物件嗎？  
...
###  <a name="_FAQ31"></a>如何? 在指定的資料庫中尋找所有使用者定義資料表嗎？  
 在您執行下列查詢之前，請使用有效的名稱取代 `<database_name>`。  
...
###  <a name="_FAQ32"></a>如何? 尋找已分割的所有資料表和索引嗎？  
 在您執行下列查詢之前，請使用有效的名稱取代 `<database_name>`。  
...
###  <a name="_FAQ33"></a>如何? 在指定的物件上尋找所有統計資料嗎？  
...
###  <a name="_FAQ34"></a>如何? 在指定的物件上尋找所有統計資料和統計資料行嗎？  
 在您執行以下查詢之前，請使用有效的名稱取代 `<database_name>`，並使用有效的資料表、索引檢視或資料表值函數名稱來取代 `<schema_name.object_name>`。  
