---
title: sys.databases column_master_keys （Transact-sql） |Microsoft Docs
ms.custom: ''
ms.date: 10/15/2019
ms.prod: sql
...
|**key_store_provider_name**|**sysname**|包含 CMK 之資料行主要金鑰存放區的提供者名稱。 允許的值包括：<br /><br /> MSSQL_CERTIFICATE_STORE-如果資料行主要金鑰存放區是憑證存放區。<br /><br /> 如果資料行主要金鑰存放區是自訂類型，則為使用者定義的值。|  
