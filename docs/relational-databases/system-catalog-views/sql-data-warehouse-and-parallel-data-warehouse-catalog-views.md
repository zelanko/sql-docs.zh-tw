---
title: "SQL 資料倉儲和平行處理資料倉儲目錄檢視 |Microsoft 文件"
ms.custom: 
ms.date: 03/15/2017
ms.prod: 
...
ms.openlocfilehash: ba6641724b8fabdfd482492aa2a9744b8de8b18a
...
[!INCLUDE[tsql-appliesto-xxxxxx-xxxx-asdw-pdw-md](../../includes/tsql-appliesto-xxxxxx-xxxx-asdw-pdw-md.md)]
 ...
 所有[!INCLUDE[ssSDW](../../includes/sssdw-md.md)]和[!INCLUDE[ssPDW](../../includes/sspdw-md.md)]目錄檢視開頭**sys.pdw**。  
...
## <a name="includesssdwincludessssdw-mdmd-and-includesspdwincludessspdw-mdmd-catalog-views"></a>[!INCLUDE[ssSDW](../../includes/sssdw-md.md)]和[!INCLUDE[ssPDW](../../includes/sspdw-md.md)]目錄檢視  
 下列目錄檢視適用於兩者[!INCLUDE[ssSDW](../../includes/sssdw-md.md)]和[!INCLUDE[ssPDW](../../includes/sspdw-md.md)]:  
