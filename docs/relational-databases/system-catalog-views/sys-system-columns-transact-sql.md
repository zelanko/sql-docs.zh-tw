...
|**rule_object_id**|**int**|使用 sys.databases 系結至資料行之獨立規則的識別碼**sp_bindrule**。<br /><br /> 0 = 沒有獨立規則。<br /><br /> 如需資料行層級的檢查條件約束，請參閱[ &#40;sys.databases&#41;check_constraints](../../relational-databases/system-catalog-views/sys-check-constraints-transact-sql.md)。|  
