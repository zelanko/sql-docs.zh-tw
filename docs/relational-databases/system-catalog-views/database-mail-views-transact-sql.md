---
title: "Database Mail 檢視 (TRANSACT-SQL) |Microsoft 文件"
ms.custom: 
ms.date: 03/06/2017
...
ms.openlocfilehash: e1fd6273028d54b3aa441f84e2cf13dd73abbdae
...
[!INCLUDE[appliesto-ss-xxxx-xxxx-xxx-md](../../includes/appliesto-ss-xxxx-xxxx-xxx-md.md)]
  ...
  Database Mail 具有下列檢視，可顯示 Database Mail 電子郵件內容、電子郵件狀態和任何收到的訊息，如 Database Mail 記錄的錯誤。 這些檢視表位於**msdb**資料庫。  
