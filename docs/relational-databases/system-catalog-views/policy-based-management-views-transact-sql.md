...
dev_langs: TSQL
helpviewer_keywords: Policy-Based Management, system views
...
ms.openlocfilehash: bbdb7dff92ad9e31dac828d88f67ca6605aa9e51
...
[!INCLUDE[tsql-appliesto-ss2012-xxxx-xxxx-xxx-md](../../includes/tsql-appliesto-ss2012-xxxx-xxxx-xxx-md.md)]
  ...
  以原則為基礎的管理具有以下檢視，可顯示有關以原則為基礎的管理原則、條件、運算式、群組和篩選的資訊。 這些檢視表位於 msdb 資料庫中，而且擁有者是 dbo 結構描述。  
