...
|**mirroring_safety_level_desc**|**tinyint**|鏡像資料庫的更新安全設定：<br /><br /> 0 = 未知狀態<br /><br /> 1 = 關閉 [非同步]<br /><br /> 2 = 完整 [同步]<br /><br /> NULL= 資料庫無法存取或未鏡像。|  
...
|**sys.database_mirroring**|**int**|鏡像連接逾時 (以秒為單位)。 這是等待夥伴或見證回應的秒數，過了這段時間，便將它們視為無法使用。 預設的逾時值是 10 秒。<br /><br /> NULL= 資料庫無法存取或未鏡像。|  
