...
|**sent_status**|**Varchar (8) **|郵件的狀態。 一律 **傳送** 此視圖的。|  
...
## <a name="permissions"></a>權限  
 授與 **系統管理員（sysadmin** ）固定伺服器角色和 **databasemailuserrole** 資料庫角色。 由 **系統管理員（sysadmin** ）固定伺服器角色的成員執行時，此視圖會顯示所有已傳送的訊息。 所有其他使用者只看得到他們所傳送的訊息。  
