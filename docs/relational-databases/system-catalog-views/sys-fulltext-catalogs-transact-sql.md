...
> [!NOTE]  
>  未來的版本將移除下列資料行 [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] ： **data_space_id**、 **file_id**和 **path**。 請勿在新的開發工作中使用這些資料行，並且儘速修改目前使用任何一個資料行的應用程式。  
