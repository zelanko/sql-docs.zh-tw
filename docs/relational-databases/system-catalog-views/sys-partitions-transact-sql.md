...
|data_compression|**tinyint**|表示每個資料分割的壓縮狀態：<br /><br /> 0 = NONE <br />1 = ROW <br />2 = PAGE <br />3 = 資料行存放區：**適用于**： [!INCLUDE[ssSQL11](../../includes/sssql11-md.md)] 和更新版本<br />4 = COLUMNSTORE_ARCHIVE：**適用于**： [!INCLUDE[ssSQL14](../../includes/sssql14-md.md)] 和更新版本<br /><br /> **注意：** 全文檢索索引將會在任何版本的 [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)]中壓縮。|  
