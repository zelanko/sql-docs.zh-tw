...
|**容量**|**int**|目前的檔案大小 (以 8 KB 頁數為單位)。<br /><br /> 0 = 不適用<br /><br /> 如果是資料庫快照集，size 會反映快照集可以使用的最大檔案空間。<br /><br /> 針對 FILESTREAM 檔案群組容器，大小會反映容器目前使用的大小。|  
...
|**drop_lsn**|**數值（25，0）**|卸除檔案的 LSN。<br /><br /> 0 = 無法重複使用的檔案名稱。|  
