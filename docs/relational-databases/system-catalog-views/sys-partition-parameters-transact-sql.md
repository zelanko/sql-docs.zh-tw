---
title: sys.databases partition_parameters （Transact-sql） |Microsoft Docs
ms.custom: ''
ms.date: 03/15/2017
ms.prod: sql
...
|**system_type_id**|**tinyint**|參數系統類型的識別碼。 對應至**sys.databases**目錄檢視的**system_type_id**資料行。|  
