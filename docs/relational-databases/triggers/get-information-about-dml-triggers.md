---
description: 取得關於 DML 觸發程序的詳細資訊
...
4.  在 [物件相依性] 視窗中，若要檢視相依於 DML 觸發程序的物件，請選取 [相依於 \<DML trigger name> 的物件]。 物件會出現在 **[相依性]** 區域中。  
  
     若要檢視 DML 所相依的物件，請選取 [\<DML trigger name> 所相依的物件]。 物件會出現在 **[相依性]** 區域中。 展開每個節點，查看所有物件。  
