...
helpviewer_keywords: 
  - "OLE DB, 連結的伺服器"
  - "OLE DB 提供者, 連結的伺服器"
  - "伺服器管理 [SQL Server], 連結的伺服器"
  - "連結的伺服器 [SQL Server]"
  - "分散式查詢 [SQL Server], 連結的伺服器"
  - "伺服器 [SQL Server], 連結的"
  - "遠端伺服器 [SQL Server], 連結的伺服器"
  - "連結的伺服器 [SQL Server], 關於連結的伺服器"
...
-   針對 **sys.servers** 系統目錄檢視來執行查詢，以檢視在特定 [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] 執行個體中定義的連結伺服器相關資訊。  
