...
helpviewer_keywords: 
  - "停用字詞表 [全文檢索搜尋]"
  - "全文檢索搜尋 [SQL Server], 停用字詞表"
  - "全文檢索搜尋 [SQL Server], 非搜尋字"
  - "非搜尋字 [全文檢索搜尋]"
...
##  <a name="understand"></a> 了解停用字詞及停用字詞表  
...
#### 在 Management Studio 中建立全文檢索停用字詞表  
...
7.  選取下列建立停用字詞表選項的其中一個：  
    ...
    -   **從現有全文檢索停用字詞表建立**  
     ...
     如需詳細資訊，請參閱[新增全文檢索停用字詞表 &#40;一般頁面&#41;](../Topic/New%20Full-Text%20Stoplist%20\(General%20Page\).md)。  
...
#### 在 Management Studio 中變更停用字詞表中的停用字詞  
...
5.  在 [[全文檢索停用字詞表屬性]](../Topic/Full-Text%20Stoplist%20Properties.md) 對話方塊中：  
