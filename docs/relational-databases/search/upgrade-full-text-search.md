...
ms.topic: "article"
helpviewer_keywords: 
  - "全文檢索搜尋 [SQL Server], 安裝"
  - "移轉全文檢索索引 [SQL Server]"
  - "升級全文檢索搜尋"
  - "安裝全文檢索搜尋"
  - "全文檢索搜尋 [SQL Server], 升級"
...
-   如果全文檢索目錄處於離線狀態，備份將會失敗。  
 ...
 如需備份和還原 [!INCLUDE[ssVersion2005](../../includes/ssversion2005-md.md)] 全文檢索目錄的詳細資訊，請參閱《[!INCLUDE[ssVersion2005](../../includes/ssversion2005-md.md)] 線上叢書》中的[備份與還原全文檢索目錄](http://go.microsoft.com/fwlink/?LinkId=121052)和[檔案備份、還原及全文檢索目錄](http://go.microsoft.com/fwlink/?LinkId=121053)。  
...
### 範例  
 下列範例會在 [RESTORE](../Topic/RESTORE%20\(Transact-SQL\).md) 陳述式中使用 MOVE 子句來還原名為 `ftdb1` 的 [!INCLUDE[ssVersion2005](../../includes/ssversion2005-md.md)] 資料庫。 [!INCLUDE[ssVersion2005](../../includes/ssversion2005-md.md)] 資料庫、記錄和目錄檔案都會移至 [!INCLUDE[ssCurrent](../../includes/sscurrent-md.md)] 伺服器執行個體上的新位置，如下所示：  
