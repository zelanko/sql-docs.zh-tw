...
7.  選取下列其中一個選項：  
    ...
    -   **從現有搜尋屬性清單建立**  
     ...
     如需詳細資訊，請參閱 [新增搜尋屬性清單](../../t-sql/statements/create-search-property-list-transact-sql.md)。  
...
###  <a name="viewing-and-changing-a-search-property-list"></a><a name="viewing"></a> 檢視和變更搜尋屬性清單  
