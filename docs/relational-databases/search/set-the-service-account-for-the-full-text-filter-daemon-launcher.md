---
title: "設定全文檢索篩選背景程式啟動器的服務帳戶 | Microsoft Docs"
ms.custom: ""
ms.date: "03/14/2017"
...
ms.topic: "article"
helpviewer_keywords: 
  - "全文檢索搜尋 [SQL Server], FDHOST 啟動器 (MSSQLFDLauncher) 服務帳戶"
  - "FDHOST 啟動器 (MSSQLFDLauncher) [SQL Server]"
...
-   [若未啟動 SQL 全文檢索篩選背景程式啟動器服務](#error)  
  
##  <a name="setting"></a> 設定服務帳戶  
  
#### 設定全文檢索搜尋的 SQL 全文檢索篩選背景程式啟動器服務帳戶  
...
##  <a name="error"></a> 若未啟動 SQL 全文檢索篩選背景程式啟動器服務  
