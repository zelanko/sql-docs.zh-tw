...
###  <a name="HowToEnableCreate"></a> 如何：在沒有全文檢索索引時建立語意索引  
...
###  <a name="HowToEnableAlter"></a> 如何：在具有現有全文檢索索引時建立語意索引  
 ...
 **使用 SQL Server Management Studio 加入語意索引**  
 您可以在 [全文檢索索引屬性] 對話方塊的 [全文檢索索引資料行] 頁面上變更已啟用語意和全文檢索索引的資料行。 如需詳細資訊，請參閱[管理全文檢索索引](../Topic/Manage%20Full-Text%20Indexes.md)。  
