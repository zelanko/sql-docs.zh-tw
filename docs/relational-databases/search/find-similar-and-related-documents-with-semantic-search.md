...
##  <a name="BasicsQuerySimilar"></a> 尋找相似或相關的文件  
  
###  <a name="HowToQuerySimilar"></a> 如何：使用 SEMANTICSIMILARITYTABLE 尋找相似或相關的文件  
...
##  <a name="BasicsQuerySimilarity"></a> 尋找文件相似或相關程度的詳細資訊  
  
###  <a name="HowToQuerySimilarity"></a> 如何：使用 SEMANTICSIMILARITYDETAILSTABLE 尋找文件相似或相關程度的詳細資訊  
