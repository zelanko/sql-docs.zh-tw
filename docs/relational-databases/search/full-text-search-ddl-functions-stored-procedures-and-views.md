...
[!INCLUDE [SQL Server Azure SQL Database](../../includes/applies-to-version/sql-asdb.md)]
 ...
 如需支援語意搜尋之資料庫物件的清單，請參閱＜ [語意搜尋 DDL、函數、預存程序及檢視](../../relational-databases/search/semantic-search-ddl-functions-stored-procedures-and-views.md)＞。  
