---
title: "使用語意搜尋找到文件中的主要片語 | Microsoft Docs"
ms.custom: ""
ms.date: "03/04/2017"
...
##  <a name="BasicsQueryKey"></a> 在文件中尋找主要片語  
  
###  <a name="howtofind"></a> 如何：使用 SEMANTICKEYPHRASETABLE 在文件中尋找主要片語  
