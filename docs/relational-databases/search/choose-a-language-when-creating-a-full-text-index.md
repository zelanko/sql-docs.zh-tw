...
helpviewer_keywords: 
  - "語言 [全文檢索搜尋]"
  - "全文檢索索引 [SQL Server], 語言"
  - "國際化考量 [全文檢索搜尋]"
  - "字幹分析器 [全文檢索搜尋]"
  - "全球化考量 [全文檢索搜尋]"
  - "全文檢索搜尋 [SQL Server], 國際化考量"
  - "語言 [SQL Server], 全文檢索索引"
  - "斷詞工具 [全文檢索搜尋]"
...
##  <a name="nondef"></a> 在全文檢索查詢中指定非預設資料行層級語言  
 依預設，在 [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] 中，全文檢索搜尋會使用指定給包含在全文檢索子句中之每個資料行的語言來剖析查詢字詞。 若要覆寫此行為，請在查詢時指定非預設語言。 若為已安裝資源的支援語言，您就可以使用 [CONTAINS](../../t-sql/queries/contains-transact-sql.md)、[CONTAINSTABLE](../../relational-databases/system-functions/containstable-transact-sql.md)、[FREETEXT](../../t-sql/queries/freetext-transact-sql.md) 或 [FREETEXTTABLE](../../relational-databases/system-functions/freetexttable-transact-sql.md) 查詢的 LANGUAGE *language_term* 子句來指定用於查詢字詞之斷詞、詞幹分析、同義字和停用字詞處理的語言。  
