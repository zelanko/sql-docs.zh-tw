...
> **注意** 全文檢索搜尋是 [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] Database Engine 的選擇性元件。 如需詳細資訊，請參閱[安裝 SQL Server 2016](../../database-engine/install-windows/install-sql-server-2016.md)。  
  
##  <a name="queries"></a> 全文檢索搜尋 - 查詢  
...
-   篩選背景程式主機處理序 (fdhost.exe)。  
 ...
 ![全文檢索搜尋結構](../../relational-databases/search/media/ifts-arch.gif "全文檢索搜尋結構")  
...
-   **撰寫全文檢索查詢**  
    ...
    -   [使用 NEAR 搜尋靠近另一個單字的字詞](../../relational-databases/search/search-for-words-close-to-another-word-with-near.md)  
...
-   **管理語言元件**  
    ...
    -   [使用自訂字典自訂斷詞工具行為](../../relational-databases/search/customize-the-behavior-of-word-breakers-with-a-custom-dictionary.md)  
...
-   [升級全文檢索搜尋](../../relational-databases/search/upgrade-full-text-search.md)升級全文檢索搜尋  
  
##  <a name="relcontent"></a> 相關內容  
  
-   [全文檢索搜尋 DDL、函數、預存程序與檢視](../../relational-databases/search/full-text-search-ddl-functions-stored-procedures-and-views.md)  
