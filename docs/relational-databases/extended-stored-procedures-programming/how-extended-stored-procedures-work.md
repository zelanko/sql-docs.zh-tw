...
1.  當用戶端執行擴充預存程式時，要求會從用戶端應用程式以表格式資料流程（TDS）或簡單物件存取通訊協定（SOAP）格式傳送至 [!INCLUDE[msCoName](../../includes/msconame-md.md)] [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)]。  
