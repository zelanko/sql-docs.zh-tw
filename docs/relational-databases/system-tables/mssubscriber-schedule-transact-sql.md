...
|**frequency_type**|**int**|排程散發代理程式所採用的頻率：<br /><br /> **1** = 一次。<br /><br /> **2** = on demand。<br /><br /> **4** = 每天。<br /><br /> **8** = 每週。<br /><br /> **16** = 每月。<br /><br /> **32** = 每月相對。<br /><br /> **64** = 自動啟動。<br /><br /> **128** = 重複執行。|  
