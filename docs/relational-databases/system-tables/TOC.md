...
# [擴充事件資料表 - trace_xe_action_map](extended-events-tables-trace-xe-action-map.md)  
# [擴充事件資料表 - trace_xe_event_map](extended-events-tables-trace-xe-event-map.md)  
...
# [將系統資料表對應至系統檢視](mapping-system-tables-to-system-views-transact-sql.md)  
