# [概觀](system-tables-transact-sql.md)  
# [擴充事件目錄資料表-trace_xe_action_map](extended-events-tables-trace-xe-action-map.md)  
# [擴充事件目錄資料表-trace_xe_event_map](extended-events-tables-trace-xe-event-map.md)  
# [資料層應用程式資料表 sysdac_history_internal](data-tier-application-tables-sysdac-history-internal.md)  
# [資料層應用程式資料表 sysdac_instances_internal](data-tier-application-tables-sysdac-instances-internal.md)  
# [將系統資料表對應至系統檢視表](mapping-system-tables-to-system-views-transact-sql.md)  
# [系統基底資料表](system-base-tables.md)  
# [備份與還原資料表](backup-and-restore-tables-transact-sql.md)  
...
# [異動資料擷取資料表](change-data-capture-tables-transact-sql.md)  
...
# [資料庫維護計畫資料表](database-maintenance-plan-tables-transact-sql.md)  
...
# [Integration Services 資料表](integration-services-tables-transact-sql.md)  
...
# [記錄傳送資料表](log-shipping-tables-transact-sql.md)  
...
# [SQL Server Agent 資料表](sql-server-agent-tables-transact-sql.md)  
...
## [dbo.sysschedules](dbo-sysjobschedules-transact-sql.md)  
...
## [dbo.sysjobschedules](dbo-sysschedules-transact-sql.md)  
...
# [複寫資料表](replication-tables-transact-sql.md)  
...
## [M](mspeer-conflictdetectionconfigrequest-transact-sql.md)  
...
## [sysarticleupdates 中](sysarticleupdates-transact-sql.md)  
