...
|**logical_record_level_conflict_resolution**|**bit**|指出應該在邏輯記錄層級或資料列或資料行層級解決衝突。<br /><br /> **0** = 使用資料列或資料行層級的解析。<br /><br /> **1** = 當發生衝突時，來自優勝者的整個邏輯記錄會覆寫遺失端的整個邏輯記錄。<br /><br /> **1**值可搭配邏輯記錄層級偵測和資料列或資料行層級偵測使用。|  
