...
1.  呼叫[bcp_init](../../relational-databases/native-client-odbc-extensions-bulk-copy-functions/bcp-init.md)來指定從資料表或視圖大量複製（設定 BCP_OUT）到資料檔案。  
...
2.  呼叫[bcp_control](../../relational-databases/native-client-odbc-extensions-bulk-copy-functions/bcp-control.md) ，並將*EOPTION*設為 BCPHINTS，並將*iValue*設定為包含 transact-sql 語句之 SQLTCHAR 字串的指標。  
...
3.  呼叫**bcp_exec**來執行大量複製作業。  
 ...
 大量複製並使用**bcp_colfmt**時，您可以輕鬆地建立格式檔案，以描述您在最後一次呼叫 bcp_colfmt[之後所](../../relational-databases/native-client-odbc-extensions-bulk-copy-functions/bcp-writefmt.md)建立的資料檔案。  
