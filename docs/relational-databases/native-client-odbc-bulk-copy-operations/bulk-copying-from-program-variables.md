---
description: 從程式變數中大量複製
title: 從程式變數進行大量複製 |Microsoft Docs
ms.custom: ''
ms.date: 03/14/2017
ms.prod: sql
...
|SQL_DECIMAL|SQL_C_CHAR|SQLCHARACTER|**decimal**<br /><br /> **12 月**<br /><br /> **money**<br /><br /> **smallmoney**|  
...
|SQL_INTEGER (不帶正負號)|SQL_C_CHAR|SQLCHARACTER|**decimal**<br /><br /> **12 月**|  
