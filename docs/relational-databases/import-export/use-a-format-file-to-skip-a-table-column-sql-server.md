---
title: "使用格式檔案以略過資料表資料行 (SQL Server) | Microsoft Docs"
ms.custom: ""
ms.date: "08/05/2016"
...
## 範例資料表與資料檔  
 下列範例會要求在 **dbo** 結構描述下之 [!INCLUDE[ssSampleDBnormal](../../includes/sssampledbnormal-md.md)] 範例資料庫中有一個名為 `myTestSkipCol` 的資料表。 使用如下陳述式建立此資料表：  
...
>  您可能需要指定您要連接的伺服器執行個體的名稱。 此外，也可能需要指定使用者名稱和密碼。 如需相關資訊，請參閱 [bcp Utility](../../tools/bcp-utility.md)。  
 ...
 ![myTestSkipCol ���預設非 XML 格式檔案](../../relational-databases/import-export/media/mytestskipcol-f-c-default-fmt.gif "myTestSkipCol ���預設非 XML 格式檔案")  
