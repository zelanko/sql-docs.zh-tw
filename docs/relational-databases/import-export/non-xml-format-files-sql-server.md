...
description: SQL Server 2019 支援非 XML 格式檔案和 XML 格式檔案，以進行大量匯出和匯入。 了解非 XML 格式檔案及其優點。
ms.custom: ''
ms.date: 03/14/2017
ms.prod: sql
