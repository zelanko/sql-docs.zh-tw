...
> [!IMPORTANT]
> 您無法使用 BCP 將資料從 Azure Blob 儲存體匯入至 Azure SQL Database。 使用 [BULK INSERT](../../t-sql/statements/bulk-insert-transact-sql.md) 或是 [OPENROWSET](../../t-sql/functions/openrowset-transact-sql.md) 匯入至 Azure Blob 儲存體或從 Azure Blob 儲存體匯出。
