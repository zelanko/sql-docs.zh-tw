...
ms.topic: "article"
helpviewer_keywords: 
  - "大量匯入 [SQL Server], null 值"
  - "大量匯入 [SQL Server], 預設值"
  - "資料格式 [SQL Server], null 值"
  - "大量資料列集提供者 [SQL Server]"
  - "bcp 公用程式 [SQL Server], null 值"
  - "BULK INSERT 陳述式"
  - "預設值"
  - "OPENROWSET 函數, 大量匯入"
  - "資料格式 [SQL Server], 預設值"
...
您可以指定在資料檔的空白欄位中，對應的資料表資料行會使用其預設值 (若有的話)。  若要使用預設值，請使用資料表提示 [KEEPDEFAULTS](Table%20Hints%20\(Transact-SQL\).md)。
 
> [!NOTE]
>  如需詳細資訊，請參閱 [INSERT &#40;Transact-SQL&#41;](../../t-sql/statements/insert-transact-sql.md)、[SELECT &#40;Transact-SQL&#41;](../../t-sql/queries/select-transact-sql.md)、[OPENROWSET &#40;Transact-SQL&#41;](../../t-sql/functions/openrowset-transact-sql.md) 及 [ &#40;Transact-SQL&#41;](../Topic/Table%20Hints%20\(Transact-SQL\).md)
...
### **範例資料檔**<a name="sample_data_file"></a>
...
### **透過[非 XML 格式檔案](../../relational-databases/import-export/non-xml-format-files-sql-server.md)使用 [bcp](../../tools/bcp-utility.md) 並保留 Null 值**<a name="bcp_null_fmt"></a>
...
### **透過[非 XML 格式檔案](../../relational-databases/import-export/non-xml-format-files-sql-server.md)使用 [bcp](../../tools/bcp-utility.md) 並使用預設值**<a name="bcp_default_fmt"></a>
...
### **透過[非 XML 格式檔案](../../relational-databases/import-export/non-xml-format-files-sql-server.md)使用 [BULK INSERT](../../t-sql/statements/bulk-insert-transact-sql.md) 並保留 Null 值**<a name="bulk_null_fmt"></a>
...
### **透過[非 XML 格式檔案](../../relational-databases/import-export/non-xml-format-files-sql-server.md)使用 [BULK INSERT](../../t-sql/statements/bulk-insert-transact-sql.md) 並使用預設值**<a name="bulk_default_fmt"></a>
...
### **透過[非 XML 格式檔案](../../relational-databases/import-export/non-xml-format-files-sql-server.md)使用 [OPENROWSET(BULK...)](../../t-sql/functions/openrowset-transact-sql.md) 並保留 Null 值**<a name="openrowset__null_fmt"></a>
**FORMATFILE** 引數。  請在 Microsoft [!INCLUDE[ssManStudioFull](../../includes/ssmanstudiofull-md.md)] (SSMS) 中執行下列 Transact-SQL：
...
### **&#9679;透過[非 XML 格式檔案](../../relational-databases/import-export/non-xml-format-files-sql-server.md)使用 [OPENROWSET(BULK...)](../../t-sql/functions/openrowset-transact-sql.md) 並使用預設值**<a name="openrowset__default_fmt"></a>
...
## 另請參閱  
 ...
 [資料表提示 &#40;Transact-SQL&#41;](../Topic/Table%20Hints%20\(Transact-SQL\).md)  
