...
# [使用 bcp 時指定相容性的資料格式](specify-data-formats-for-compatibility-when-using-bcp-sql-server.md)
...
# [使用格式檔案以略過資料表資料行](use-a-format-file-to-skip-a-table-column-sql-server.md)
...
# [資料的大量匯入及匯出](bulk-import-and-export-of-data-sql-server.md)
