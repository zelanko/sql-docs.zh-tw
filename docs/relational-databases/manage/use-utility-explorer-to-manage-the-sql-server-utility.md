---
title: "使用公用程式總管來管理 SQL Server 公用程式 | Microsoft Docs"
ms.custom: ""
ms.date: "03/14/2017"
...
## 從公用程式總管註冊 SQL Server 執行個體或資料層應用程式  
