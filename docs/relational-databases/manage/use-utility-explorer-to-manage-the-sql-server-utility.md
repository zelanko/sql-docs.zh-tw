...
PowerShell 沒有 F1 說明，但其包含 **Get-Help** Cmdlet，此 Cmdlet 提供 PowerShell 的使用資訊。 如需使用 Get-Help 的詳細資訊，請參閱 [Get Help SQL Server PowerShell](../../relational-databases/scripting/get-help-sql-server-powershell.md)。  
