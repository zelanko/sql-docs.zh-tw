...
-   您必須從 UCP 中移除所有 SQL Server 受管理的執行個體。 請注意，UCP 就是 SQL Server 受管理的執行個體。 如需詳細資訊，請參閱[如何：從 SQL Server 公用程式移除 SQL Server 執行個體](https://go.microsoft.com/fwlink/?LinkId=169392)。  
