...
description: 更加了解 SQL Server 公用程式。 了解其功能，以及了解可如何使用此功能來監視 SQL Server 環境。
ms.custom: ''
ms.date: 03/14/2017
ms.prod: sql
...
|描述如何疑難排解 SQL Server 公用程式。|[疑難排解 SQL Server 公用程式](/previous-versions/sql/sql-server-2016/ee210592(v=sql.130))|  
