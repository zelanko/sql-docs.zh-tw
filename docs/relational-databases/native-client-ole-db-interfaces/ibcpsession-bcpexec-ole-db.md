...
## <a name="remarks"></a>備註  
 **BCPExec**方法會將資料從使用者檔案至資料庫資料表，反之亦然，複製的值而定*eDirection*參數搭配[ibcpsession:: Bcpinit](../../relational-databases/native-client-ole-db-interfaces/ibcpsession-bcpinit-ole-db.md)方法。  
