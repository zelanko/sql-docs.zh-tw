...
## <a name="remarks"></a>Remarks  
 根據與 **IBCPSession::BCPInit** 方法搭配使用之 *eDirection* 參數的值，[BCPExec](../../relational-databases/native-client-ole-db-interfaces/ibcpsession-bcpinit-ole-db.md) 方法會將資料從使用者檔案複製到資料庫資料表，反之亦然。  
