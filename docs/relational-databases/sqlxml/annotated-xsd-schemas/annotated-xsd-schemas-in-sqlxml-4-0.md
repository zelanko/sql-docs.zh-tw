---
title: SQLXML 4.0 中的註解式 XSD 結構描述
description: 如需在 SQLXML 4.0 中使用批註式 XSD 架構的相關資訊，請參閱。
ms.custom: ''
ms.date: 01/11/2019
ms.prod: sql
...
## <a name="in-this-section"></a>本節內容  
 ...
 [在 XSD 架構中使用批註 &#40;SQLXML 4.0&#41;](../../../relational-databases/sqlxml-annotated-xsd-schemas-using/using-annotations-in-xsd-schemas-sqlxml-4-0.md)  
 ...
 [將批註式 XDR 架構轉換為對等的 XSD 架構 &#40;SQLXML 4.0&#41;](../../../relational-databases/sqlxml/annotated-xsd-schemas/converting-annotated-xdr-schemas-to-equivalent-xsd-schemas-sqlxml-4-0.md)  
