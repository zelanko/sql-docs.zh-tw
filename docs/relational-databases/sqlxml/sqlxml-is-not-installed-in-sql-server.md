...
[!INCLUDE[appliesto-ss-asdb-xxxx-xxx-md](../../includes/appliesto-ss-asdb-xxxx-xxx-md.md)]
 ...
 如果應用程式在上[!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)]執行，而且需要 sqlxml 4.0，您就必須下載並安裝 SQLXML 4.0 SP1。  
