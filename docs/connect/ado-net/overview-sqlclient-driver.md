...
|[尋找其他 SqlClient 驅動程式資訊](find-additional-sqlclient-driver-information.md)|包含有關驅動程式之實用資訊的頁面。|  

## <a name="next-steps"></a>後續步驟
 [SqlClient 驅動程式 GitHub 存放庫](https://github.com/dotnet/SqlClient) \(英文\)  
