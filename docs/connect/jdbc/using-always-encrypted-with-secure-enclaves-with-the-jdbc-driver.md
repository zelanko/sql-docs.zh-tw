...
- 驗證環境相依性 (例如 DLL、KeyStore 等) 都位於正確的路徑。 具有安全記憶體保護區的 Always Encrypted 是現有 [Always Encrypted](../../connect/jdbc/using-always-encrypted-with-the-jdbc-driver.md) 功能的附加元件，且共用相似的先決條件。
