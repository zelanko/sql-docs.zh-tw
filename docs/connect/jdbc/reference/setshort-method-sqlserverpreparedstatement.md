---
title: setShort 方法 (SQLServerPreparedStatement) |Microsoft 文件
ms.custom: ''
ms.date: 01/19/2017
ms.prod: sql
...
ms.openlocfilehash: 1f84f8118b0bd85250fa8d7bc97e7f0e09d76f96
...
## <a name="remarks"></a>備註  
 SetShort 方法 java.sql.PreparedStatement 介面中所指定此 setShort 方法。  
