---
description: supportsSubqueriesInExists 方法 (SQLServerDatabaseMetaData)
...
## <a name="remarks"></a>備註  
 這個 supportsSubqueriesInExists 方法是由 java.sql.DatabaseMetaData 介面中的 supportsSubqueriesInExists 方法所指定。  
