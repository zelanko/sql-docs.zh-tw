---
title: removeConnectionEventListener 方法 (SQLServerPooledConnection) |Microsoft 文件
ms.custom: ''
ms.date: 01/19/2017
ms.prod: sql
...
## <a name="remarks"></a>備註  
 這個 removeConnectionEventListener 方法是由 javax.sql.PooledConnection 介面中 removeConnectionEventListener 方法指定。  
