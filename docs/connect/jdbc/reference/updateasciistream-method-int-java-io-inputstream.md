...
## <a name="remarks"></a>備註  
 此 updateAsciiStream 方法是由 java.sql.ResultSet 介面中的 updateAsciiStream 方法所指定。  
 ...
 使用這個方法來處理 **image**、**text** 和 **ntext**[!INCLUDE[ssNoVersion](../../../includes/ssnoversion-md.md)] 等資料類型，可能會影響到效能。  
