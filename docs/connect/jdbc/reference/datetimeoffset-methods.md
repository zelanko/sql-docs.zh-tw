---
title: DateTimeOffset 方法 |Microsoft 文件
ms.custom: ''
ms.date: 01/19/2017
ms.prod: sql
...
ms.locfileid: "32826703"
---
# <a name="datetimeoffset-methods"></a>DateTimeOffset 方法
[!INCLUDE[Driver_JDBC_Download](../../../includes/driver_jdbc_download.md)]

  如需 DateTimeOffset 成員的資訊，請參閱[DateTimeOffset 成員](../../../connect/jdbc/reference/datetimeoffset-members.md)。  
