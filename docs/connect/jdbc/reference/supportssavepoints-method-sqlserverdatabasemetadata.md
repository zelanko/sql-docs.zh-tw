---
title: supportsSavepoints 方法 (SQLServerDatabaseMetaData) |Microsoft 文件
ms.custom: ''
ms.date: 01/19/2017
ms.prod: sql
...
ms.author: genemi
manager: craigg
ms.openlocfilehash: 097eb89233ea8dbda232cd572342ef9f8545f666
...
## <a name="remarks"></a>備註  
 這個 supportsSavepoints 方法是由 java.sql.DatabaseMetaData 介面中 supportsSavepoints 方法指定。  
