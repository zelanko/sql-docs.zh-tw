---
title: "updateShort 方法 (int，short) |Microsoft 文件"
ms.custom: 
ms.date: 01/19/2017
...
ms.openlocfilehash: 6a2c892a8ba73664d2daa73560f0930757e8f8c1
...
## <a name="remarks"></a>備註  
 UpdateShort 方法 java.sql.ResultSet 介面中所指定此 updateShort 方法。  
