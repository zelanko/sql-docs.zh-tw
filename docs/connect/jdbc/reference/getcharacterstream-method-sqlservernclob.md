...
[!INCLUDE[Driver_JDBC_Download](../../../includes/driver_jdbc_download.md)]
  ...
  將 **java.sql.NClob** 物件所指定的 **NCLOB** 值擷取為 **java.io.Reader** 物件。  
  
## <a name="overload-list"></a>多載清單  
  
|名稱|描述|  
|----------|-----------------|  
|[getCharacterStream 方法 &#40;&#41; &#40;SQLServerNClob&#41;](../../../connect/jdbc/reference/getcharacterstream-method-braces-sqlservernclob.md)|取出 **NCLOB** 資料作為 **Reader** 物件或字元資料流。|  
