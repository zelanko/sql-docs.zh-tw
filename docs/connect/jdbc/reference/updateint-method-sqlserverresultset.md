...
|名稱|描述|  
|----------|-----------------|  
|[updateInt (int, int)](../../../connect/jdbc/reference/updateint-method-int-int.md)|透過指定的資料行索引，使用 **int** 值來更新指定的資料行。|  
|[updateInt (java.lang.String, int)](../../../connect/jdbc/reference/updateint-method-java-lang-string-int.md)|透過指定的資料行名稱，使用 **int** 值來更新指定的資料行。|  
