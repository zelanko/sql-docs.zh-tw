---
description: getAsciiStream 方法 (SQLServerResultSet)
...
ms.locfileid: "88437370"
---
# <a name="getasciistream-method-sqlserverresultset"></a>getAsciiStream 方法 (SQLServerResultSet)
[!INCLUDE[Driver_JDBC_Download](../../../includes/driver_jdbc_download.md)]

  擷取這個 [SQLServerResultSet](../../../connect/jdbc/reference/sqlserverresultset-class.md) 物件中目前資料列中所指定資料行的值來當作 ASCII 字元資料流。  
