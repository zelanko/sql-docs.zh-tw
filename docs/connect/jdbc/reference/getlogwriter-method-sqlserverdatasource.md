---
title: getLogWriter 方法 (SQLServerDataSource) |Microsoft 文件
ms.custom: ''
ms.date: 01/19/2017
ms.prod: sql
...
## <a name="remarks"></a>備註  
 這個 getLogWriter 方法是由 javax.sql.DataSource 介面中 getLogWriter 方法所指定的。  
