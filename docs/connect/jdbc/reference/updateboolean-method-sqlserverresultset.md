...
|[屬性]|Description|  
|----------|-----------------|  
|[updateBoolean (int, boolean)](../../../connect/jdbc/reference/updateboolean-method-int-boolean.md)|透過指定的資料行索引，使用 **boolean** 值來更新指定的資料行。|  
|[updateBoolean (java.lang.String, boolean)](../../../connect/jdbc/reference/updateboolean-method-java-lang-string-boolean.md)|透過指定的資料行名稱，使用 **boolean** 值來更新指定的資料行。|  
