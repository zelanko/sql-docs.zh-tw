---
title: setLong 方法 (SQLServerCallableStatement) |Microsoft 文件
ms.custom: ''
ms.date: 01/19/2017
ms.prod: sql
...
ms.author: genemi
manager: craigg
ms.openlocfilehash: 9539da05e55056aaa10d9fd6378977336d7d79c6
...
## <a name="remarks"></a>備註  
 SetLong 方法 java.sql.CallableStatement 介面中所指定此 setLong 方法。  
