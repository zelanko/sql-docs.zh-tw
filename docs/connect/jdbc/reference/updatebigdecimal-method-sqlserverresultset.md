...
|名稱|描述|  
|----------|-----------------|  
|[updateBigDecimal (int, java.math.BigDecimal)](../../../connect/jdbc/reference/updatebigdecimal-method-int-java-math-bigdecimal.md)|透過指定的資料行索引，使用 BigDecimal 物件來更新指定的資料行。|  
|[updateBigDecimal (java.lang.String, java.math.BigDecimal)](../../../connect/jdbc/reference/updatebigdecimal-method-java-lang-string-java-math-bigdecimal.md)|透過指定的資料行名稱，使用 BigDecimal 物件來更新指定的資料行。|  
