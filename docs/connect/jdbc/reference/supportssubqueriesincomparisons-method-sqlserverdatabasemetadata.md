---
description: supportsSubqueriesInComparisons 方法 (SQLServerDatabaseMetaData)
title: supportsSubqueriesInComparisons 方法 (SQLServerDatabaseMetaData) | Microsoft Docs
ms.custom: ''
ms.date: 01/19/2017
ms.prod: sql
...
## <a name="remarks"></a>備註  
 這個 supportsSubqueriesInComparisons 方法是由 java.sql.DatabaseMetaData 介面中的 supportsSubqueriesInComparisons 方法所指定。  
