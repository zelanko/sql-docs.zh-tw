---
title: SQLServerConnectionPoolDataSource 建構函式 （) |Microsoft 文件
ms.custom: ''
ms.date: 01/19/2017
ms.prod: sql
...
ms.author: genemi
manager: craigg
ms.openlocfilehash: b6fa3778cc84edb86edc278644f84ac4a564943e
...
[!INCLUDE[Driver_JDBC_Download](../../../includes/driver_jdbc_download.md)]
  ...
  初始化的新執行個體[SQLServerConnectionPoolDataSource](../../../connect/jdbc/reference/sqlserverconnectionpooldatasource-class.md)類別。  
...
## <a name="see-also"></a>另請參閱  
 [SQLServerConnectionPoolDataSource 建構函式](../../../connect/jdbc/reference/sqlserverconnectionpooldatasource-constructors.md)   
