---
description: getDate 方法 (SQLServerResultSet)
...
ms.locfileid: "88436270"
---
# <a name="getdate-method-sqlserverresultset"></a>getDate 方法 (SQLServerResultSet)
[!INCLUDE[Driver_JDBC_Download](../../../includes/driver_jdbc_download.md)]

  使用 Java 程式語言，擷取這個 [SQLServerResultSet](../../../connect/jdbc/reference/sqlserverresultset-class.md) 物件中目前資料列中所指定資料行的值來當作 java.sql.Date 物件。  
