---
description: SQLServerResultSet 類別
...
## <a name="remarks"></a>備註  
 ...
 這個類別支援解除包裝為 SQLServerResultSet 類別、ISQLServerResultSet 介面和 java.sql.ResultSet 介面。 如需詳細資訊，請參閱[包裝函式與介面](../../../connect/jdbc/wrappers-and-interfaces.md)。  
