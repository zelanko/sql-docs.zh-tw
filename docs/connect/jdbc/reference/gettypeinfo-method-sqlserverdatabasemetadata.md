...
|NULLABLE|**短**|指出資料行是否能包含 null 值。 它可能是下列其中一個值：<br /><br /> typeNoNulls (0)<br /><br /> typeNullable (1)<br /><br /> typeNullableUnknown (2)|  
|CASE_SENSITIVE|**boolean**|指出資料類型是否區分大小寫。 「**true**"如果類型是區分大小寫，否則 「**false**"。|  
|SEARCHABLE|**短**|指出資料行是否能用於 SQL WHERE 子句。 它可能是下列其中一個值：<br /><br /> typePredNone (0)<br /><br /> typePredChar (1)<br /><br /> typePredBasic (2)<br /><br /> typeSeachable (3)|  
...
|MINIMUM_SCALE|**短**|小數點右邊的最大位數。|  
|MAXIMUM_SCALE|**短**|小數點右邊的最小位數。|  
