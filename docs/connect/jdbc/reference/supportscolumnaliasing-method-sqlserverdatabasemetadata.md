---
description: supportsColumnAliasing 方法 (SQLServerDatabaseMetaData)
...
## <a name="remarks"></a>備註  
 這個 supportsColumnAliasing 方法是由 java.sql.DatabaseMetaData 介面中的 supportsColumnAliasing 方法指定。  
