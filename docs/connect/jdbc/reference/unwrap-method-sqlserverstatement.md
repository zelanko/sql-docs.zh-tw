---
title: 解除包裝方法 (SQLServerStatement) |Microsoft Docs
ms.custom: ''
ms.date: 01/19/2017
ms.prod: sql
...
## <a name="remarks"></a>Remarks  
 ...
 如需範例程式碼, 請參閱[更新大型資料範例](../../../connect/jdbc/updating-large-data-sample.md)或解除包裝[ &#40; &#41;方法 SQLServerCallableStatement](../../../connect/jdbc/reference/unwrap-method-sqlservercallablestatement.md)。  
