---
title: position 方法 (SQLServerBlob) | Microsoft Docs
ms.custom: ''
ms.date: 01/19/2017
ms.prod: sql
...
|名稱|描述|  
|----------|-----------------|  
|[position (java.sql.Blob, long)](../../../connect/jdbc/reference/position-method-java-sql-blob-long.md)|依據給定模式和開始索引，傳回指定之模式在 BLOB 中的位置。|  
|[position (byte&#91;&#93;, long)](../../../connect/jdbc/reference/position-method-byte-long.md)|依據指定 **byte** 陣列模式和起始索引，傳回指定模式在 BLOB 中的位置。|  
