---
title: updateBoolean 方法 (java.lang.String，boolean) |Microsoft 文件
ms.custom: ''
ms.date: 01/19/2017
ms.prod: sql
...
## <a name="remarks"></a>備註  
 UpdateBoolean 方法 java.sql.ResultSet 介面中所指定此 updateBoolean 方法。  
