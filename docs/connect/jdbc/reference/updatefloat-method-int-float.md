---
title: "updateFloat 方法 （int，float） |Microsoft 文件"
ms.custom: 
ms.date: 01/19/2017
...
ms.openlocfilehash: 33ec697feff5fbaed21b5939ed0021321de576a4
...
## <a name="remarks"></a>備註  
 UpdateFloat 方法 java.sql.ResultSet 介面中所指定此 updateFloat 方法。  
