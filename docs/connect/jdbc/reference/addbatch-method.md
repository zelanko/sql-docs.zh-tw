...
ms.locfileid: "67955992"
---
# <a name="addbatch-method-"></a>addBatch 方法 ()
[!INCLUDE[Driver_JDBC_Download](../../../includes/driver_jdbc_download.md)]

  將一組參數新增至這個 [SQLServerPreparedStatement](../../../connect/jdbc/reference/sqlserverpreparedstatement-class.md) 物件的命令批次中。  
...
## <a name="remarks"></a>備註  
 這個 addBatch 方法是由 java.sql.PreparedStatement 介面中的 addBatch 方法所指定。  
