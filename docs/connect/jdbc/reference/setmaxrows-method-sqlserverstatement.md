...
## <a name="remarks"></a>備註  
 ...
 如需 SET ROWCOUNT SQL 陳述式的詳細資訊，請參閱《[!INCLUDE[ssNoVersion](../../../includes/ssnoversion-md.md)] 線上叢書》中的 [＜SET ROWCOUNT (Transact-SQL)＞](../../../t-sql/statements/set-rowcount-transact-sql.md)主題。  
