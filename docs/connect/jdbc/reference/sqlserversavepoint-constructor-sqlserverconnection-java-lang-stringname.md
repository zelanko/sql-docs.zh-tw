---
title: SQLServerSavepoint 建構函式的儲存點 |Microsoft 文件
ms.custom: ''
ms.date: 01/19/2017
ms.prod: sql
...
[!INCLUDE[Driver_JDBC_Download](../../../includes/driver_jdbc_download.md)]
  ...
  初始化的新執行個體[SQLServerException](../../../connect/jdbc/reference/sqlserverexception-class.md)類別，根據給定的連接和名稱。  
...
## <a name="see-also"></a>另請參閱  
 [SQLServerSavepoint 建構函式](../../../connect/jdbc/reference/sqlserversavepoint-constructors.md)   
