---
title: getMaxTablesInSelect 方法 (SQLServerDatabaseMetaData) |Microsoft 文件
ms.custom: ''
ms.date: 01/19/2017
ms.prod: sql
...
## <a name="remarks"></a>備註  
 這個 getMaxTablesInSelect 方法是由 java.sql.DatabaseMetaData 介面中 getMaxTablesInSelect 方法指定。  
