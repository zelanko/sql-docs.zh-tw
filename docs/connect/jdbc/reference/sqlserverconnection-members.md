...
|[closeUnreferencedPreparedStatementHandles](../../../connect/jdbc/reference/closeunreferencedpreparedstatementhandles-method-sqlserverconnection.md)|強制取消-準備的任何未處理捨棄已備妥之陳述式執行的要求。| 
...
|[createBlob](../../../connect/jdbc/reference/createblob-method-sqlserverconnection.md)|會建立**java.sql.Blob**物件沒有任何資料。|  
|[createClob](../../../connect/jdbc/reference/createclob-method-sqlserverconnection.md)|會建立**java.sql.Clob**物件沒有任何資料。|  
|[createNClob](../../../connect/jdbc/reference/createnclob-method-sqlserverconnection.md)|會建立**java.sql.NClob**物件沒有任何資料。|  
...
|[createSQLXML](../../../connect/jdbc/reference/createsqlxml-method-sqlserverconnection.md)|會建立**java.sql.SQLXML**物件沒有任何資料。|  
...
|[getDisableStatementPooling](../../../connect/jdbc/reference/getdisablestatementpooling-method-sqlserverconnection.md)|傳回的值**disableStatementPooling**連接屬性。 此設定會控制是否啟用陳述式共用或不適用於此連線。|
...
|[isStatementPoolingEnabled](../../../connect/jdbc/reference/isstatementpoolingenabled-method-sqlserverconnection.md)|傳回是否啟用陳述式共用或不適用於此連線。|  
...
|[setDisableStatementPooling](../../../connect/jdbc/reference/setdisablestatementpooling-method-sqlserverconnection.md)|設定為 true 或 false 的陳述式共用。|  
...
|[setServerPreparedStatementDiscardThreshold](../../../connect/jdbc/reference/setserverpreparedstatementdiscardthreshold-method-sqlserverconnection.md)|設定新的值**serverPreparedStatementDiscardThreshold**連接屬性。|  
