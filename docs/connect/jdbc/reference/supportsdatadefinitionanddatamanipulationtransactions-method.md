...
## <a name="remarks"></a>備註  
 這個 suportsDataDefinitionAndDataManipulationTransactions 方法是由 javax.sql.DatabaseMetaData 介面中的 suportsDataDefinitionAndDataManipulationTransactions 方法指定。  
