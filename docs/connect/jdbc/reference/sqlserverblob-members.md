---
title: "SQLServerBlob 成員 |Microsoft 文件"
ms.custom: 
ms.date: 01/19/2017
...
[!INCLUDE[Driver_JDBC_Download](../../../includes/driver_jdbc_download.md)]
  ...
  下表列出所公開的成員[SQLServerBlob](../../../connect/jdbc/reference/sqlserverblob-class.md)類別。  
...
|名稱|Description|  
|----------|-----------------|  
|[釋放](../../../connect/jdbc/reference/free-method-sqlserverblob.md)|這個方法會釋放 BLOB 物件並且釋出它所保留的資源。|  
...
|[長度](../../../connect/jdbc/reference/length-method-sqlserverblob.md)|傳回 BLOB 物件中的位元組數目。|  
|[位置](../../../connect/jdbc/reference/position-method-sqlserverblob.md)|依據給定模式和開始索引，傳回指定之模式在 BLOB 中的位置。|  
...
|[截斷](../../../connect/jdbc/reference/truncate-method-sqlserverblob.md)|依給定長度截斷 BLOB。|  
