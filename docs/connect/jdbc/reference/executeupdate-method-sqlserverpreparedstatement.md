---
title: "executeUpdate 方法 (SQLServerPreparedStatement) |Microsoft 文件"
ms.custom: 
ms.date: 01/19/2017
...
ms.openlocfilehash: d7528cff3a03ade1daeba4592bea809f2488c874
...
|名稱|Description|  
|----------|-----------------|  
|[executeUpdate （)](../../../connect/jdbc/reference/executeupdate-method.md)|執行 SQL 陳述式中這[SQLServerPreparedStatement](../../../connect/jdbc/reference/sqlserverpreparedstatement-class.md)物件，它必須是 SQL INSERT、 UPDATE、 MERGE 或 DELETE 陳述式或傳回任何內容，例如 DDL 陳述式的 SQL 陳述式。|  
