---
title: "getBoolean 方法 (int) |Microsoft 文件"
ms.custom: 
ms.date: 01/19/2017
...
ms.openlocfilehash: 87b80cfff1ebecbb98dfbd5e37e4394cd331e53c
...
## <a name="remarks"></a>備註  
 GetBoolean 方法 java.sql.CallableStatement 介面中所指定此 getBoolean 方法。  
