...
|[空間資料類型範例](../../connect/jdbc/spatial-data-types-sample.md)|描述如何儲存和擷取資料與空間資料型別 '幾何' 和 'Geography' 的[!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)]與資料庫**幾何**並**Geography**定義的 Microsoft JDBC Driver 的 Java 型別。|
