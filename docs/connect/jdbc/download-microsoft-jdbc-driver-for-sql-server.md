...
JDBC 驅動程式可以藉由新增為下列程式碼 POM.xml 檔案中的相依性加入至 Maven 專案：
...
## <a name="download-previous-versions-of-jdbc-drivers-for-sql-server"></a>下載舊版 JDBC Driver for SQL Server  
...
無法使用這裡下載不支援的驅動程式版本。 因為我們會持續改進 Java 連接性支援， 因此我們強烈建議您使用 JDBC 驅動程式的最新版本。  
