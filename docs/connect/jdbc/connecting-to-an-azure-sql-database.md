...
-   [如何：使用 JDBC 連線到 SQL Azure](http://msdn.microsoft.com/library/gg715284.aspx)  
  
-   [在 Java 中使用 SQL Azure](http://msdn.microsoft.com/library/windowsazure/hh749029(VS.103).aspx)
