...
| [使用結果集](working-with-result-sets.md)                          | 這些範例應用程式示範如何使用結果集，來處理 [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] 資料庫中包含的資料。                                                                                                         |
| [使用大型資料](working-with-large-data.md)                            | 這些範例應用程式會示範如何使用自適性緩衝來擷取 [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] 資料庫中的大數值資料，而沒有伺服器資料指標的負擔。                                                      |
| [SQL 資料探索與分類](data-discovery-classification-sample.md) | 這個範例應用程式示範如何使用 JDBC Driver，從 ResultSet 物件擷取 [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] 資料庫中所含的資料探索與分類資訊。                                         |
