...
| 公用 SQLServerMetaData (SQLServerMetaData sqlServerMetaData)                                                                                                                    | 初始化的新執行個體 SQLServerMetaData 從另一個 SQLServerMetaData 物件。                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                      |
| 公用字串 getColumName()                                                                                                                                                     | 擷取的資料行名稱。                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                  |
| 公用 int getSqlType()                                                                                                                                                          | 擷取 java sql 型別。                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                |
| 公用 int getPrecision()                                                                                                                                                        | 擷取傳遞給資料行類型的有效位數。                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                   |
| 公用 int getScale()                                                                                                                                                            | 擷取的小數位數傳遞至資料行的類型。                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                       |
| 公用 SQLServerSortOrder getSortOrder()                                                                                                                                         | 擷取的排序次序。                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                   |
| 公用 int getSortOrdinal()                                                                                                                                                      | 擷取的排序序數。                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                 |
| 公用的則為 true isUniqueKey()                                                                                                                                                     | 傳回資料行是否為唯一。                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                       |
| 公用的則為 true useServerDefault()                                                                                                                                                | 傳回 wheher 資料行中，會使用預設的伺服器值。                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                    |
...
| 公用的迭代器 < 項目\<整數，Object [] >> getIterator()      | 擷取資料表的資料列的迭代器。 |
| public void addColumnMetadata （columnName 字串、 int sqlType） | 將指定的資料行的中繼資料。              |
| public void addColumnMetadata （SQLServerDataColumn 資料行）     | 將指定的資料行的中繼資料。              |
| public void addRow （物件...的值）                          | 將一個資料列加入至資料表中。              |
| 公用對應\<Integer，SQLServerDataColumn > getColumnMetadata() | 擷取此資料表的資料行中繼資料。       |
...
| [屬性]                                                    | Description                                                                                             |
| ------------------------------------------------------- | ------------------------------------------------------------------------------------------------------- |
| 公用 SQLServerMetaData getColumnMetaData （int 資料行）; | 擷取指定資料行索引的資料行中繼資料。                                               |
| 公用 int getColumnCount();                            | 擷取資料行的總數。                                                                  |
| 公開的物件 [] getRowData();                           | 取得目前資料列的資料當作物件的陣列。                                          |
| 公用的則為 true next （);                                  | 移至下一個資料列。 如果移動成功，而且沒有下一個資料列，則為 false 的否則，傳回 True。 |
...
| [屬性]                                                                                                        | Description                                                                                                                                                                                                                                                                                                                      |
| ----------------------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| 公用最終的 void setStructured （字串 paratemeterName，字串 tvpName，SQLServerDataTable tvpDataTable）    | 會填入資料表值參數傳遞至具有資料表的預存程序。 paratemeterName 是參數的名稱，tvpName 是 TVP，型別的名稱，tvpDataTable 是資料的資料表物件。                                                                                                                 |
| 公用最終的 void setStructured （字串 paratemeterName，字串 tvpName，結果集 tvpResultSet）             | 會填入資料表值參數傳遞至預存程序中，使用另一個資料表中擷取一個結果集。 paratemeterName 是參數的名稱，tvpName 是 TVP，型別的名稱，tvpResultSet 是來源的結果集物件。                                                                              |
| 公用最終的 void setStructured （字串 paratemeterName，字串 tvpName，ISQLServerDataRecord tvpDataRecord） | 會填入資料表值參數傳遞至預存程序與 ISQLServerDataRecord 物件。 ISQLServerDataRecord 用於串流資料，而且使用者會決定如何使用它。 paratemeterName 是參數的名稱，tvpName 是 TVP，型別的名稱，tvpDataRecord 是 ISQLServerDataRecord 物件。 |
