...
|[使用 JDBC Driver](../../connect/jdbc/using-the-jdbc-driver.md)|描述如何設定您的環境，以使用 Microsoft JDBC Driver，以及如何建立對 [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] 資料庫的簡單連接。|  
