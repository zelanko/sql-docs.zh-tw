...
[!INCLUDE[Driver_JDBC_Download](../../includes/driver_jdbc_download.md)]
  ...
  Microsoft JDBC Driver for SQL Server 是類型 4 Java 資料庫連線 (JDBC) 4.2 相容驅動程式可提供對 SQL Server 2017、 SQL Server 2016、 SQL Server 2014、 SQL Server 2012、 SQL Server 2008 R2、 SQL Server 2008 和 Azure SQL Database 穩固的資料存取.  
...
|[JDBC Driver 的系統需求](../../connect/jdbc/system-requirements-for-the-jdbc-driver.md)|說明使用 Microsoft JDBC Driver 所須符合的系統需求。|  
|[使用 JDBC Driver](../../connect/jdbc/using-the-jdbc-driver.md)|描述如何設定環境以使用 Microsoft JDBC 驅動程式，以及如何進行的簡單連接[!INCLUDE[ssNoVersion](../../includes/ssnoversion_md.md)]資料庫。|  
...
|[部署 JDBC Driver](../../connect/jdbc/deploying-the-jdbc-driver.md)|說明如何在 Windows 及 Unix 作業系統上部署 Microsoft JDBC Driver。|  
