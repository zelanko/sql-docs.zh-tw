...
ms.locfileid: "42785597"
---
# <a name="overview-of-the-jdbc-driver"></a>JDBC Driver 概觀
[!INCLUDE[Driver_JDBC_Download](../../includes/driver_jdbc_download.md)]

  Microsoft JDBC Driver 6.0 (預覽版) for SQL Server 是類型 4 Java 資料庫連線 (JDBC) 4.2 相容驅動程式，其提供對於 SQL Server 2016 (預覽版)、SQL Server 2014、SQL Server 2012、SQL Server 2008 R2、SQL Server 2008 及 Azure SQL Database 穩固的資料存取。  
...
|[使用 JDBC Driver](../../connect/jdbc/using-the-jdbc-driver.md)|說明如何設定您的環境，以使用 Microsoft JDBC Driver，以及如何建立對 [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] 資料庫的簡單連接。|  
