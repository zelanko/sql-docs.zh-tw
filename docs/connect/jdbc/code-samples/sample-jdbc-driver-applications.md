...
| [SQL 資料探索與分類](../../jdbc/code-samples/data-discovery-and-classification-sample.md) | 這個範例應用程式示範如何使用 JDBC Driver，從 ResultSet 物件擷取 [!INCLUDE[ssNoVersion](../../../includes/ssnoversion-md.md)] 資料庫中所含的資料探索與分類資訊。                                            |
