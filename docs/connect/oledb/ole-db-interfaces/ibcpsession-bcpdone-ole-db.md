---
title: IBCPSession::BCPDone (OLE DB 驅動程式) | Microsoft Docs
description: 了解 IBCPSession::BCPDone 方法如何在 OLE DB Driver for SQL Server 中認可要傳送至 SQL Server 的其餘資料列。
ms.custom: ''
ms.date: 06/14/2018
ms.prod: sql
