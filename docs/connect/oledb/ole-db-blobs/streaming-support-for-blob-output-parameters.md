---
title: BLOB 輸出參數的串流支援 (OLE DB 驅動程式)
description: 了解 OLE DB Driver for SQL Server 中適用於 BLOB 輸出參數的串流支援。 此範例會將 BLOB 參數繫結為 ISequentialStreams。
ms.custom: ''
ms.date: 06/14/2018
ms.prod: sql
