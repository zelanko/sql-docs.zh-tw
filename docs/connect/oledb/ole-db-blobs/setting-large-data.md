...
description: 了解如何使用 OLE DB Driver for SQL Server 透過傳遞取用者儲存物件的指標來設定 BLOB 資料。
ms.custom: ''
ms.date: 06/14/2018
ms.prod: sql
...
[!INCLUDE[Driver_OLEDB_Download](../../../includes/driver_oledb_download.md)]
  ...
  您可以利用 OLE DB Driver for SQL Server，藉由傳遞取用者儲存物件的指標來設定 BLOB 資料。  
