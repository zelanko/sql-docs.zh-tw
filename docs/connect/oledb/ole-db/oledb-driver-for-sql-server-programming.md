...
[!INCLUDE[Driver_OLEDB_Download](../../../includes/driver_oledb_download.md)]
  ...
  OLE DB Driver for SQL Server 是用來存取資料的低階 COM API。 建議將 OLE DB Driver for SQL Server　用於開發工具、公用程式或需要高效能的低階元件。 OLE DB Driver for SQL Server　是原生、高效能的提供者，會直接存取 [!INCLUDE[ssNoVersion](../../../includes/ssnoversion-md.md)] 表格式資料流 (TDS) 通訊協定。  
