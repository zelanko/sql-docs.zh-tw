...
description: 了解 OLE DB Driver for SQL Server 中 OLE DB 的變更，以支援大型 Common Language Runtime 使用者定義型別。
ms.custom: ''
ms.date: 06/12/2018
ms.prod: sql
...
[!INCLUDE[Driver_OLEDB_Download](../../../includes/driver_oledb_download.md)]
 ...
 如需在 OLE DB Driver for SQL Server 中支援大型 CLR UDT 的詳細資訊，請參閱[大型 CLR 使用者定義型別](../../oledb/features/large-clr-user-defined-types.md)。 如需範例，請參閱[使用大型 CLR UDT &#40;OLE DB&#41;](../../oledb/ole-db-how-to/use-large-clr-udts-ole-db.md)。  
