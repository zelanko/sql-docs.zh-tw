---
title: 資料表值參數 (OLE DB Driver for SQL Server) | Microsoft Docs
description: OLE DB Driver for SQL Server 支援資料表值參數，其能提供有效的方式將資料的多個資料列傳遞至伺服器。
ms.custom: ''
ms.date: 06/12/2018
ms.prod: sql
...
[!INCLUDE[Driver_OLEDB_Download](../../../includes/driver_oledb_download.md)]
 ...
 如需有關資料表值參數和 OLE DB 的詳細資訊，請參閱[資料表值參數 &#40;OLE DB&#41;](../../oledb/ole-db-table-valued-parameters/table-valued-parameters-ole-db.md)。  
