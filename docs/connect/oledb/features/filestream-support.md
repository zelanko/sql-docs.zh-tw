...
description: SQL Server 支援增強的 FILESTREAM 功能，其能讓您透過 SQL Server 或檔案系統來儲存及存取大型二進位值。
ms.custom: ''
ms.date: 09/13/2019
ms.prod: sql
...
ms.locfileid: "88861479"
---
# <a name="filestream-support-in-ole-db-driver-for-sql-server"></a>OLE DB Driver for SQL Server 中的 FILESTREAM 支援
