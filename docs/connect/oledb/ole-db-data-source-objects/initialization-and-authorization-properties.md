...
|DBPROP_AUTH_ENCRYPT_PASSWORD|SQL Server 的 OLE DB 驅動程式會使用[!INCLUDE[msCoName](../../../includes/msconame-md.md)]標準[!INCLUDE[ssNoVersion](../../../includes/ssnoversion-md.md)]的安全性機制來隱藏密碼。<br /><br /> SQL Server 的 OLE DB 驅動程式會在嘗試設定屬性值時傳回 DB_S_ERRORSOCCURRED。 DBPROP 結構的 *dwStatus* 成員表示 DBPROPSTATUS_NOTSUPPORTED。|  
...
|DBPROP_AUTH_MASK_PASSWORD|SQL Server 的 OLE DB 驅動程式會使用[!INCLUDE[ssNoVersion](../../../includes/ssnoversion-md.md)]標準的安全性機制來隱藏密碼。<br /><br /> SQL Server 的 OLE DB 驅動程式會在嘗試設定屬性值時傳回 DB_S_ERRORSOCCURRED。 DBPROP 結構的 *dwStatus* 成員表示 DBPROPSTATUS_NOTSUPPORTED。|  
...
|DBPROP_INIT_PROTECTION_LEVEL|SQL Server 的 OLE DB 驅動程式不支援實例連接的[!INCLUDE[ssNoVersion](../../../includes/ssnoversion-md.md)]保護層級。<br /><br /> SQL Server 的 OLE DB 驅動程式會在嘗試設定屬性值時傳回 DB_S_ERRORSOCCURRED。 DBPROP 結構的 *dwStatus* 成員表示 DBPROPSTATUS_NOTSUPPORTED。|  
