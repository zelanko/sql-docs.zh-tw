---
title: 將資料行新增到 SQL Server 資料表 (OLE DB 驅動程式) | Microsoft Docs
description: 了解 ITableDefinition::AddColumn 方法如何讓取用者將資料行新增至 OLE DB Driver for SQL Server 中的 SQL Server 資料表。
ms.custom: ''
ms.date: 06/14/2018
ms.prod: sql
