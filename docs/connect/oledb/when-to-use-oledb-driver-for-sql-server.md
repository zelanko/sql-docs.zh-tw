...
[!INCLUDE[Driver_OLEDB_Download](../../includes/driver_oledb_download.md)]
  ...
  OLE DB Driver for SQL Server 是可用來存取 [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] 資料庫中資料的其中一種技術。  如需不同資料存取技術的討論內容，請參閱 [Data Access Technologies Road Map](https://go.microsoft.com/fwlink/?LinkID=179186) (資料存取技術藍圖)  
