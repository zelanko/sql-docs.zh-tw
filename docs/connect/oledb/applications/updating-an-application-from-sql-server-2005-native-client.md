...
description: 了解從 SQL Server 2005 (9.x) 中的 SQL Server Native Client 起，OLE DB Driver for SQL Server 中的重大變更。
ms.custom: ''
ms.date: 06/12/2018
ms.prod: sql
...
ms.locfileid: "88860043"
---
# <a name="updating-applications-from-sql-server-2005-native-client"></a>從 SQL Server 2005 Native Client 更新應用程式
