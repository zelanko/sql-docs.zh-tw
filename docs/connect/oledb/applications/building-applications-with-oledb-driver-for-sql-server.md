...
## <a name="in-this-section"></a>本節內容  
 ...
 討論如何安裝 OLE DB 驅動程式的 SQL Server 中的位置各種元件的安裝，以及如何解除安裝適用於 SQL Server 的 OLE DB 驅動程式。  

 [適用於 SQL Server 的 OLE DB 驅動程式的元件](../../oledb/applications/components-of-oledb-driver-for-sql-server.md)  
 討論組成包括程式庫、 資源、 說明和標頭檔的 SQL Server 的 OLE DB 驅動程式的元件。  
 ...
 討論各種類型的 for SQL Server 連接到 OLE DB 驅動程式透過資料庫時可用的連接字串。  

 [使用 OLE DB 驅動程式的 SQL Server 標頭和程式庫檔案](../../oledb/applications/using-the-oledb-driver-for-sql-server-header-and-library-files.md)  
 討論如何使用 SQL Server 標頭和應用程式中的程式庫檔案的 OLE DB 驅動程式。  

 [更新 MDAC 從 SQL Server 的 OLE DB 驅動程式的應用程式](../../oledb/applications/updating-an-application-to-oledb-driver-for-sql-server-from-mdac.md)  
 ...
 [使用 ADO 與 OLE DB 驅動程式，適用於 SQL Server](../../oledb/applications/using-ado-with-oledb-driver-for-sql-server.md)  
 討論 ADO 要如何使用 OLE DB 驅動程式的 SQL Server 存取和使用[!INCLUDE[ssNoVersion](../../../includes/ssnoversion-md.md)]功能。  

 [SQL Server 的 OLE DB 驅動程式的支援原則](../../oledb/applications/support-policies-for-oledb-driver-for-sql-server.md)  
