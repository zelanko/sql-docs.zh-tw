---
title: 設定大型資料 (OLE DB 驅動程式)
description: 了解如何在 OLE DB Driver for SQL Server 中設定 BLOB 資料、建立資料表、新增記錄、在資料列集中擷取該記錄，以及設定 BLOB 欄位的值。
ms.custom: ''
ms.date: 06/14/2018
ms.prod: sql
...
author: David-Engel
ms.author: v-daenge
ms.openlocfilehash: e37968327c3a41a6473545bb4ccfa817a87f855f
ms.sourcegitcommit: c7f40918dc3ecdb0ed2ef5c237a3996cb4cd268d
ms.translationtype: HT
ms.contentlocale: zh-TW
ms.lasthandoff: 10/05/2020
ms.locfileid: "91727030"
---
