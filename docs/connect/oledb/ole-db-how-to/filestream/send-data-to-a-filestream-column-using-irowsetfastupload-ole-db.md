...
description: 透過此範例，了解如何使用 IRowsetFastUpload 介面，將 4MB 到 4GB 的資料傳送至 OLE DB Driver for SQL Server 中的 FILESTREAM 資料行。
ms.custom: ''
ms.date: 06/14/2018
ms.prod: sql
...
## <a name="example"></a>範例  
 ...
 複製第三個程式碼清單並將它貼入名為 IRowsetFastLoadUpload.cpp 的檔案中。  
  
 編譯 IRowsetFastLoadUpload.cpp、ISSHelper.cpp、ole32.lib 和 oleaut32.lib。  
