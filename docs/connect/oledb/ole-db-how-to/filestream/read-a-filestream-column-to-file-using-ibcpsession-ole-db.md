---
title: FILESTREAM 資料行讀到檔案使用 IBCPSession (OLE DB) |Microsoft 文件
description: FILESTREAM 資料行讀到檔案使用 IBCPSession (OLE DB)
ms.custom: ''
ms.date: 03/26/2018
ms.prod: sql
...
manager: craigg
ms.openlocfilehash: e80426cbd61a84a82863f6d42b350549c62f0f37
