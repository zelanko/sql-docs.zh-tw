...
| Java     | [JDBC](http://go.microsoft.com/fwlink/?LinkId=245496)<br />[下載 6.2](http://www.microsoft.com/download/details.aspx?id=55539) |
...
| PHP      | *作業系統：*<br /><br />[Windows 的 PHP 驅動程式](http://www.microsoft.com/download/details.aspx?id=20098)<br />[Ubuntu 或 MacOS PHP 驅動程式，從 Github](http://github.com/Microsoft/msphpsql/tree/dev#install-unix) |
