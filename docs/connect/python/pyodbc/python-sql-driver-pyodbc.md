---
title: Python SQL 驅動程式 - pyodbc | Microsoft Docs
ms.custom: ''
ms.date: 08/09/2017
ms.prod: sql
...
* [步驟 3︰使用 pyodbc 連接到 SQL 的概念證明](step-3-proof-of-concept-connecting-to-sql-using-pyodbc.md)  

## <a name="documentation"></a>文件

* [pyodbc 文件](https://mkleehammer.github.io/pyodbc/) \(英文\)  
