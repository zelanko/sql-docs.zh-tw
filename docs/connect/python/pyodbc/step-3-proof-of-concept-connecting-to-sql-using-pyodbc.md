...
在此範例中，您將了解如何安全地執行 [INSERT](../../../t-sql/statements/insert-transact-sql.md) 陳述式，並傳遞可協助您應用程式防禦 [SQL 插入](../../../relational-databases/tables/primary-and-foreign-key-constraints.md)的參數。    
