---
description: 使用資料分類搭配 Microsoft ODBC Driver for SQL Server
...
如需如何將分類指派給資料行的詳細資訊，請參閱 [SQL 資料探索與分類](../../relational-databases/security/sql-data-discovery-and-classification.md)。
