...
description: 這個 C++ 範例應用程式會示範如何使用 ODBC API 來連線及存取 SQL 資料庫。
ms.custom: ''
ms.date: 07/08/2019
ms.prod: sql
...
在 2013 年 10 月和 2019 年 7 月之間，此範例 C++ ODBC 應用程式下載次數高達 47,300 次。 在 2019 年 7 月，此應用程式來源已從 Microsoft 的程式碼庫移至此網頁。
...
## <a name="b-odbcsqlcpp-code"></a>B. odbcsql.cpp 程式碼
...
## <a name="c-odbcsqlsln-code"></a>C. odbcsql.sln 程式碼
...
## <a name="d-odbcsqlvcxproj-code"></a>D. odbcsql.vcxproj 程式碼
