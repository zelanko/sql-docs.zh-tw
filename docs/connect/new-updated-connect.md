...
1. [用戶端程式設計與 Microsoft SQL Server 首頁](homepage-sql-connection-programming.md)
2. [使用 Azure Active Directory 驗證進行連接](php/azure-active-directory.md)
3. [閒置連接恢復功能](php/connection-resiliency.md)
4. [PHP Linux 和 Mac 的驅動程式安裝教學課程](php/installation-tutorial-linux-mac.md)
5. [Microsoft SQL 資料庫的連接模組](sql-connection-libraries.md)
