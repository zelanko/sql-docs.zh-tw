...
ms.author: genemi
manager: craigg
ms.openlocfilehash: 94635ec5e90ad004efe2c2df693f794e536c3d6b
...
PDO 類別包含可讓您的 PHP 應用程式連接到 [!INCLUDE[ssNoVersion](../../includes/ssnoversion_md.md)] 執行個體的方法。  
