---
title: "Microsoft PHP Driver for SQL Server |Microsoft 文件"
ms.custom: 
ms.date: 01/19/2017
...
SQL Server Driver for PHP 可讓 SQL server 的 PHP 應用程式整合。 驅動程式是 PHP 延伸模組，可讓讀取和寫入 SQL Server 資料從 PHP 指令碼中。 驅動程式提供介面用於存取 Azure SQL Database，資料中的 SQL Server 2005 所有版本和更新版本 （包括 Express Edition)。 驅動程式會使用 PHP 功能，包括 PHP 資料流讀取及寫入大型物件。  
...
* [PHP SQL 驅動程式支援資源](support-resources-for-the-php-sql-driver.md)
  
## <a name="download"></a>下載  
* ![下載 DownArrow Circled](../../ssdt/media/download.png)[來下載 PHP driver for SQL](../sql-connection-libraries.md#anchor-20-drivers-relational-access)
  
## <a name="samples"></a>範例  
* [PHP SQL 驅動程式的程式碼範例](code-samples-for-php-sql-driver.md)
