---
title: 如何：執行交易
description: 本主題說明並示範在使用 Microsoft Drivers for PHP for SQL Server 時如何執行交易
ms.custom: ''
ms.date: 08/10/2020
ms.prod: sql
...
[交易 (資料庫引擎)](/previous-versions/sql/sql-server-2008-r2/ms190612(v=sql.105))
