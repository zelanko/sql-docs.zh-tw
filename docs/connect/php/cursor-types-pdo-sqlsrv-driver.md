---
title: 資料指標類型 (PDO_SQLSRV 驅動程式)
description: 了解各種伺服器端和用戶端游標，以及使用者在使用 Microsoft PDO_SQLSRV Driver for PHP for SQL Server 時如何指定游標類型。
ms.custom: ''
ms.date: 08/10/2020
ms.prod: sql
...
## <a name="pdo_sqlsrv-and-server-side-cursors"></a>PDO_SQLSRV 和伺服器端資料指標
...
## <a name="pdo_sqlsrv-and-client-side-cursors"></a>PDO_SQLSRV 和用戶端資料指標
