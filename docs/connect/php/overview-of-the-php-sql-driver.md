...
|主題|描述|  
|---------|---------------|  
| ![Download-DownArrow-Circled](../../ssdt/media/download.png)[下載 Drivers for PHP for SQL Server](download-drivers-php-sql-server.md) | 下載 Microsoft Drivers for PHP for SQL Server 的連結。 |
