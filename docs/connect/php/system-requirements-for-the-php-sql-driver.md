...
如需如何下載及安裝最新的穩定 PHP 二進位檔的資訊，請參閱 [PHP 網站](http://php.net)。  Microsoft Drivers for PHP for SQL Server 需要下列的 PHP 版本：

|PHP for SQL Server 驅動程式版本&#8594;<br />&#8595; PHP 版本|5.3 和 5.2<br />&nbsp;|4.3<br />&nbsp;|4.0<br />&nbsp;|3.2<br />&nbsp;|3.1<br />&nbsp;|
|---|---|---|---|---|---|
...
-   您的 PHP 延伸目錄中必須要有某個版本的驅動程式檔案。 請參閱[驅動程式版本](#driver-versions)針對不同的驅動程式檔案的相關資訊。  若要載入驅動程式，請參閱[下載 Microsoft Drivers for PHP for SQL Server](download-drivers-php-sql-server.md)。 如需為 PHP 設定驅動程式的資訊，請參閱[載入 Microsoft Drivers for PHP for SQL Server](../../connect/php/loading-the-php-sql-driver.md)。

-   需要 Web 伺服器。 您的 Web 伺服器必須設定為執行 PHP。 如需裝載 IIS 與 PHP 應用程式的資訊，請參閱[PHP 的網站上的教學課程](http://php.net/manual/fa/install.windows.iis.php)。  
...
-   Microsoft Drivers for PHP for SQL Server 5.3 版會最後才支援 PHP 7.0。
...
|PHP for SQL Server 驅動程式版本&#8594;<br />&#8595;ODBC 驅動程式版本|5.3<br />&nbsp;|5.2<br />&nbsp;|4.3<br />&nbsp;|4.0<br />&nbsp;|3.2<br />&nbsp;|3.1<br />&nbsp;|
|---|---|---|---|---|---|---|
|ODBC 驅動程式 17+ |Y|Y| | | | |
...
|PHP for SQL Server 驅動程式版本&#8594;<br />&#8595; SQL Server 版本|5.3<br />&nbsp;|5.2<br />&nbsp;|4.3<br />&nbsp;|4.0<br />&nbsp;|3.2<br />&nbsp;|3.1<br />&nbsp;|
|---|---|---|---|---|---|---|
|Azure SQL Database        |Y|Y|Y| | | |
|Azure SQL 受控執行個體|Y|Y|Y| | | |
|Azure SQL 資料倉儲  |Y|Y|Y| | | |
...
|PHP for SQL Server 驅動程式版本&#8594;<br />&#8595; 作業系統|5.3<br />&nbsp;|5.2<br />&nbsp;|4.3<br />&nbsp;|4.0<br />&nbsp;|3.2<br />&nbsp;|3.1<br />&nbsp;|
|---|---|---|---|---|---|---|
...
|---------------|---------------|----------------|---------------------|  
|32 位元 php_sqlsrv_7_nts.dll <br />32 位元 php_pdo_sqlsrv_7_nts.dll |7.0|否 |32 位元 php7.dll|
|32 位元 php_sqlsrv_7_ts.dll  <br />32 位元 php_pdo_sqlsrv_7_ts.dll  |7.0|是|32 位元 php7ts.dll|
|64 位元 php_sqlsrv_7_nts.dll <br />64 位元 php_pdo_sqlsrv_7_nts.dll |7.0|否 |64 位元 php7.dll|  
|64 位元 php_sqlsrv_7_ts.dll  <br />64 位元 php_pdo_sqlsrv_7_ts.dll  |7.0|是|64 位元 php7ts.dll|
|32 位元 php_sqlsrv_71_nts.dll<br />32 位元 php_pdo_sqlsrv_71_nts.dll|7.1|否 |32 位元 php7.dll|  
|32 位元 php_sqlsrv_71_ts.dll <br />32 位元 php_pdo_sqlsrv_71_ts.dll |7.1|是|32 位元 php7ts.dll|  
|64 位元 php_sqlsrv_71_nts.dll<br />64 位元 php_pdo_sqlsrv_71_nts.dll|7.1|否 |64 位元 php7.dll|  
|64 位元 php_sqlsrv_71_ts.dll <br />64 位元 php_pdo_sqlsrv_71_ts.dll |7.1|是|64 位元 php7ts.dll|   
|32 位元 php_sqlsrv_72_nts.dll<br />32 位元 php_pdo_sqlsrv_72_nts.dll|7.2|否 |32 位元 php7.dll|  
|32 位元 php_sqlsrv_72_ts.dll <br />32 位元 php_pdo_sqlsrv_72_ts.dll |7.2|是|32 位元 php7ts.dll|  
|64 位元 php_sqlsrv_72_nts.dll<br />64 位元 php_pdo_sqlsrv_72_nts.dll|7.2|否 |64 位元 php7.dll|  
|64 位元 php_sqlsrv_72_ts.dll <br />64 位元 php_pdo_sqlsrv_72_ts.dll |7.2|是|64 位元 php7ts.dll|  
