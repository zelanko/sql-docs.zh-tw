...
|[搭配使用 Microsoft Drivers for PHP for SQL Server 和 Always Encrypted](../../connect/php/using-always-encrypted-php-drivers.md)|提供搭配 PHP 驅動程式使用 Always Encrypted 功能的資訊。|  
|[Microsoft Drivers for PHP for SQL Server 的安全性考量](../../connect/php/security-considerations-for-php-sql-driver.md)|說明開發、部署和執行應用程式的安全性考量。|  
