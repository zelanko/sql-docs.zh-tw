...
|[搭配使用 Microsoft Drivers for PHP for SQL Server 和 Always Encrypted](../../connect/php/using-always-encrypted-php-drivers.md)|提供有關在 PHP 驅動程式中使用 Always Encrypted 功能的資訊。|  
|[適用于 PHP for SQL Server 的 Microsoft 驅動程式安全性考慮](../../connect/php/security-considerations-for-php-sql-driver.md)|說明開發、部署和執行應用程式的安全性考量。|  
