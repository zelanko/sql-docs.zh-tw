---
title: 連接到伺服器
description: 了解使用 Microsoft Drivers for PHP for SQL Server 連線至資料庫的不同方法。
ms.custom: ''
ms.date: 03/26/2018
ms.prod: sql
...
|[如何：在指定的通訊埠上連接](../../connect/php/how-to-connect-on-a-specified-port.md)|描述如何連接到特定連接埠上的伺服器。|  
|[連接共用](../../connect/php/connection-pooling-microsoft-drivers-for-php-for-sql-server.md)|提供有關驅動程式中連接共用的資訊。|  
|[如何：停用 Multiple Active Resultsets (MARS)。](../../connect/php/how-to-disable-multiple-active-resultsets-mars.md)|描述如何在進行連接時停用 MARS 功能。|  
