...
|主題|描述|  
|---------|---------------|  
|[操作說明：使用 Windows 驗證進行連線](../../connect/php/how-to-connect-using-windows-authentication.md)|描述如何使用 Windows 驗證建立連接。|  
|[操作說明：使用 SQL Server 驗證進行連線](../../connect/php/how-to-connect-using-sql-server-authentication.md)|描述如何使用 SQL Server 驗證建立連接。|  
|[操作說明：使用 Azure Active Directory 驗證進行連線](../../connect/php/azure-active-directory.md)|描述如何設定驗證模式，並使用 Azure Active Directory 身分識別進行連線。|  
|[操作說明：在指定的連接埠上連線](../../connect/php/how-to-connect-on-a-specified-port.md)|描述如何連接到特定連接埠上的伺服器。|  
|[連接共用](../../connect/php/connection-pooling-microsoft-drivers-for-php-for-sql-server.md)|提供有關驅動程式中連接共用的資訊。|  
|[操作說明：停用 Multiple Active Resultsets (MARS)](../../connect/php/how-to-disable-multiple-active-resultsets-mars.md)|描述如何在進行連接時停用 MARS 功能。|  
