---
title: 如何：停用 Multiple Active Result Set (MARS)
description: 了解在使用 Microsoft Driver for PHP for SQL Server 時如何停用 Multiple Active Resultset 支援
ms.custom: ''
ms.date: 08/10/2020
ms.prod: sql
