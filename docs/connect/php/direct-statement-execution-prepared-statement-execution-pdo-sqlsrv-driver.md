---
title: 直接陳述式 - 已備妥的陳述式執行 PDO_SQLSRV 驅動程式
description: 了解在使用 Microsoft PDO_SQLSRV Driver for PHP for SQL Server 時，如何使用 PDO::SQLSRV_ATTR_DIRECT_QUERY 屬性直接執行陳述式
ms.custom: ''
ms.date: 08/10/2020
ms.prod: sql
