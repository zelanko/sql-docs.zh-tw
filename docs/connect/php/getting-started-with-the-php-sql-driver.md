---
title: "PHP SQL 驅動程式使用者入門 |Microsoft 文件"
ms.custom: 
ms.date: 01/19/2017
...
---
# <a name="getting-started-with-the-php-sql-driver"></a>PHP SQL 驅動程式快速入門
...
* [步驟 4︰使用 PHP 彈性地連接到 SQL](../../connect/php/step-4-connect-resiliently-to-sql-with-php.md)  
