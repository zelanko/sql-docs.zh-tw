...
在 Windows 上搭配 PHP Drivers for SQL Server 使用 Azure AD 時，系統可能會要求您安裝 [Microsoft Online Services 登入小幫手](https://www.microsoft.com/download/details.aspx?id=41950) (ODBC 17+ 不需要)。
