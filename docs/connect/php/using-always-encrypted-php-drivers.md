---
title: 搭配 PHP Drivers for SQL Server 使用 Always Encrypted
description: 了解如何使用 Always Encrypted 搭配 PHP Drivers for SQL Server，以保護應用程式中的敏感性資料。
ms.date: 12/12/2019
ms.prod: sql
