...
ms.topic: "article"
helpviewer_keywords: 
  - "SQL Server 組態管理員, 啟動及停止服務"
  - "停止 SQL Server Agent"
  - "參數 [SQL Server], 啟動選項"
  - "SQL Server, 啟動選項"
  - "Database Engine [SQL Server], 啟動及停止服務"
  - "暫停 SQL Server"
  - "PowerShell [SQL Server], 啟動及停止服務"
  - "單一使用者模式 [SQL Server], 啟動於"
  - "SQL Server Management Studio [SQL Server], 啟動或停止服務"
  - "停止 SQL Server Browser 服務"
  - "啟動 SQL Server Agent"
  - "預設執行個體 [SQL Server], 啟動和停止"
  - "SQL Server Agent, 啟動和停止"
  - "命令提示字元 [SQL Server], 啟動及停止 SQL Server 服務"
  - "繼續 SQL Server"
  - "啟動 SQL Server Database Engine"
  - "net stop 命令 [SQL Server]"
  - "命令提示字元 [SQL Server], SQL Browser 服務"
  - "組態管理員, 啟動及停止服務"
  - "繼續 SQL Server"
  - "啟動選項 [SQL Server]"
  - "具名執行個體 [SQL Server], 啟動和停止"
  - "net start 命令 [SQL Server]"
  - "SQL Server, 啟動和停止"
  - "停止 SQL Server"
  - "啟動 SQL Server Browser 服務"
  - "SQL Server Database Engine 設定啟動選項"
  - "管理 SQL Server, 啟動及停止服務"
  - "Management Studio [SQL Server], 啟動或停止服務"
...
#### 啟動 [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] 組態管理員  
...
#### 若要啟動、停止、暫停、繼續或重新啟動 [!INCLUDE[ssDEnoversion](../../includes/ssdenoversion-md.md)]  
...
> [!NOTE]  
>  若要使用啟動選項啟動 [!INCLUDE[ssDEnoversion](../../includes/ssdenoversion-md.md)] 的執行個體，請參閱[設定伺服器啟動選項 &#40;SQL Server 組態管理員&#41;](../../database-engine/configure-windows/configure-server-startup-options-sql-server-configuration-manager.md)。  
  
#### 若要啟動、停止、暫停、繼續或重新啟動 [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] Browser 或是 [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] Agent 的執行個體  
...
#### 若要啟動、停止或重新啟動 [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] Agent 的執行個體  
...
#### 若要使用 [!INCLUDE[ssDE](../../includes/ssde-md.md)] 停止 [!INCLUDE[tsql](../../includes/tsql-md.md)]  
...
#### 若要啟動及停止 [!INCLUDE[ssDE](../../includes/ssde-md.md)] 服務  
...
## 另請參閱  
 [SQL Server 安裝程式文件集的概觀](../Topic/Overview%20of%20SQL%20Server%20Setup%20Documentation.md)   
