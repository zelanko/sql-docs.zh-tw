...
-   當執行個體的 [自主資料庫驗證] 關閉 (0) 時，便無法建立自主資料庫，或附加到 [!INCLUDE[ssDE](../../includes/ssde-md.md)]。  
  
-   當執行個體的 [自主資料庫驗證] 開啟 (1) 時，就可以建立自主資料庫，或附加到 [!INCLUDE[ssDE](../../includes/ssde-md.md)]。  
...
> [!NOTE] [!INCLUDE[ssSDS_md](../../includes/sssds-md.md)] 和 [!INCLUDE[ssSDW_md](../../includes/sssdw-md.md)] 一律會啟用自主資料庫且無法停用。
