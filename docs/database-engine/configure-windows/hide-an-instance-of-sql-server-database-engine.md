---
title: "隱藏 SQL Server Database Engine 的執行個體 | Microsoft Docs"
ms.custom: ""
ms.date: "08/19/2015"
...
ms.topic: "article"
helpviewer_keywords: 
  - "Database Engine [SQL Server], 隱藏執行個體"
  - "隱藏 Database Engine 的執行個體"
...
## 另請參閱  
 ...
 [如何將靜態連接埠指派給 SQL Server 具名執行個體，並避免常見陷阱](http://blogs.msdn.com/b/arvindsh/archive/2012/09/08/how-to-assign-a-static-port-to-a-sql-server-named-instance-and-avoid-a-common-pitfall.aspx)  
