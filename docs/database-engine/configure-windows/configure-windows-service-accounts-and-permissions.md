...
helpviewer_keywords: 
  - "啟動服務狀態 [SQL Server]"
  - "安裝程式 [SQL Server], 使用者帳戶"
  - "Windows 權限 [SQL Server]"
  - "修改使用者帳戶"
  - "預設帳戶"
  - "網域 [SQL Server], 使用者帳戶"
  - "啟動帳戶 [SQL Server]"
  ...
  - "執行個體感知服務 [SQL Server]"
  - "權限 [SQL Server], 服務"
  - "SQL Server Agent 服務, 使用者帳戶"
  - "Windows NT 權限 [SQL Server]"
  - "使用者帳戶 [SQL Server]"
  - "識別執行個體非感知服務 [SQL Server]"
  - "安裝 SQL Server, 使用者帳戶"
  - "停用啟動狀態 [SQL Server]"
  - "使用者帳戶 [SQL Server]，使用者"
  - "本機服務帳戶 [SQL Server]"
  - "SQL Server 安裝精靈"
  - "執行個體非感知服務 [SQL Server]"
  - "服務 [SQL Server], 安裝時設定"
  - "Windows 帳戶 [SQL Server]"
  - "SQL Server 服務, 使用者帳戶"
  - "使用者帳戶 [SQL Server], 服務"
  - "MSSQLServer"
  - "識別執行個體感知服務 [SQL Server]"
  - "服務 [SQL Server], 帳戶"
  - "存取控制清單"
  - "選擇性帳戶 [SQL Server]"
  - "服務帳戶 [SQL Server]"
...
##  <a name="a-nameservicedetailsa-services-installed-by-includessnoversiontokenssnoversionmdmd"></a><a name="Service_Details"></a> [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] 安裝的服務  
...
-   **[!INCLUDE[ssISnoversion](../../includes/ssisnoversion-md.md)]** - 提供 [!INCLUDE[ssISnoversion](../../includes/ssisnoversion-md.md)] 封裝儲存體和執行的管理支援。 可執行檔路徑為 \<MSSQLPATH>\130\DTS\Binn\MsDtsSrvr.exe  
...
##  <a name="a-nameservpropa-service-properties-and-configuration"></a><a name="Serv_Prop"></a> 服務屬性和組態  
...
###  <a name="a-namedefaultacctsa-default-service-accounts"></a><a name="Default_Accts"></a> 預設服務帳戶  
...
####  <a name="a-namechangingaccountsa-changing-account-properties"></a><a name="Changing_Accounts"></a> 變更帳戶內容  
...
###  <a name="a-namenewaccountsa-managed-service-accounts-group-managed-service-accounts-and-virtual-accounts"></a><a name="New_Accounts"></a> 受管理的服務帳戶、群組受管理的服務帳戶和虛擬帳戶  
...
-   <a name="VA_Desc"></a>**虛擬帳戶**  
    ...
    |[!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] 預設執行個體上的 [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] Agent 服務|**NT SERVICE\SQLSERVERAGENT**|  
    |名為 **PAYROLL** 之 [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] 執行個體上的 [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] Agent 服務|**NT SERVICE\SQLAGENT$PAYROLL**|  
...
###  <a name="a-nameautostarta-automatic-startup"></a><a name="Auto_Start"></a> 自動啟動  
...
###  <a name="a-nameconfigureservicesa-configuring-services-during-unattended-installation"></a><a name="Configure_services"></a> 在自動安裝期間設定服務  
 ...
 *如需自動安裝的詳細資訊和範例語法，請參閱 [從命令提示字元安裝 SQL Server 2016](../../database-engine/install-windows/install-sql-server-2016-from-the-command-prompt.md)。  
  
 ** [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] 和 [!INCLUDE[ssExpress](../../includes/ssexpress-md.md)] with Advanced Services 的執行個體會停用 [!INCLUDE[ssExpress](../../includes/ssexpress-md.md)] Agent 服務。  
  
###  <a name="a-namefirewalla-firewall-port"></a><a name="Firewall"></a> 防火牆通訊埠  
...
##  <a name="a-nameservperma-service-permissions"></a><a name="Serv_Perm"></a> 服務權限  
...
###  <a name="a-nameservsida-service-configuration-and-access-control"></a><a name="Serv_SID"></a> 服務組態和存取控制  
...
###  <a name="a-namewindowsa-windows-privileges-and-rights"></a><a name="Windows"></a> Windows 權限和權利  
 ...
 * [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] 的執行個體會停用 [!INCLUDE[ssExpress](../../includes/ssexpress-md.md)]Agent 服務。  
  
###  <a name="a-namereviewingaclsa-file-system-permissions-granted-to-sql-server-per-service-sids-or-local-windows-groups"></a><a name="Reviewing_ACLs"></a> 授與 SQL Server 個別服務 SID 或本機 Windows 群組的檔案系統權限  
...
||\<ToolsDir>\DReplayController\\{所有 DLL}|讀取、執行、列出資料夾內容|  
 ...
 * [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] 和 [!INCLUDE[ssExpress](../../includes/ssexpress-md.md)] with Advanced Services 的執行個體會停用 [!INCLUDE[ssExpress](../../includes/ssexpress-md.md)] Agent 服務。  
 ...
 當資料庫檔案儲存於使用者定義的位置時，您必須授與個別服務 SID 對該位置的存取權。 如需將檔案系統權限授與個別服務 SID 的詳細資訊，請參閱 [設定 Database Engine 對檔案系統的存取權限](../../database-engine/configure-windows/configure-file-system-permissions-for-database-engine-access.md)。  
  
###  <a name="a-namefilesystemothera-file-system-permissions-granted-to-other-windows-user-accounts-or-groups"></a><a name="File_System_Other"></a> 授與其他 Windows 使用者帳戶或群組的檔案系統權限  
...
||僅限管理員|\\\\.\root\Microsoft\SqlServer\ServerEvents\\<sql_instance_name>*|完整控制|  
||管理員，系統|\tools\binn\schemas\sqlserver\2004\07\showplan|完整控制|  
||使用者|\tools\binn\schemas\sqlserver\2004\07\showplan|讀取、執行|  
|[!INCLUDE[ssRSnoversion](../../includes/ssrsnoversion-md.md)]|\<報表伺服器 Web 服務帳戶>|*\<install>*\Reporting Services\LogFiles|DELETE<br /><br /> READ_CONTROL<br /><br /> SYNCHRONIZE<br /><br /> FILE_GENERIC_READ<br /><br /> FILE_GENERIC_WRITE<br /><br /> FILE_READ_DATA<br /><br /> FILE_WRITE_DATA<br /><br /> FILE_APPEND_DATA<br /><br /> FILE_READ_EA<br /><br /> FILE_WRITE_EA<br /><br /> FILE_READ_ATTRIBUTES<br /><br /> FILE_WRITE_ATTRIBUTES|  
||報表管理員應用程式集區識別 [!INCLUDE[vstecasp](../../includes/vstecasp-md.md)] 帳戶，Everyone|*\<install>*\Reporting Services\ReportManager、*\<install>*\Reporting Services\ReportManager\Pages\\\*.\*、*\<install>*\Reporting Services\ReportManager\Styles\\\*.\*、*\<install>*\Reporting Services\ReportManager\webctrl_client\1_0\\*.\*|讀取|  
||報表管理員應用程式集區識別|*\<install>*\Reporting Services\ReportManager\Pages\\*.\*|讀取|  
||\<報表伺服器 Web 服務帳戶>|*\<install>*\Reporting Services\ReportServer|讀取|  
||\<報表伺服器 Web 服務帳戶>|*\<install>*\Reporting Services\ReportServer\global.asax|Full|  
...
||網路服務|*\<install>*\Reporting Services\ReportServer\ReportService.asmx|Full|  
...
###  <a name="a-nameunusuallocationsa-file-system-permissions-related-to-unusual-disk-locations"></a><a name="Unusual_Locations"></a> 與不常見磁碟位置相關的檔案系統權限  
...
###  <a name="a-namereviewadditionalconsiderationsa-reviewing-additional-considerations"></a><a name="Review_additional_considerations"></a> 檢閱其他考量  
...
###  <a name="a-nameregistrya-registry-permissions"></a><a name="Registry"></a> 登錄權限  
...
###  <a name="a-namepipesa-named-pipes"></a><a name="Pipes"></a> 具名管道  
...
##  <a name="a-nameprovisioninga-provisioning"></a><a name="Provisioning"></a> 提供  
...
###  <a name="a-namedeprova-database-engine-provisioning"></a><a name="DE_Prov"></a> 資料庫引擎提供  
 下列帳戶會在 [!INCLUDE[ssDEnoversion](../../includes/ssdenoversion-md.md)]中加入為登入。  
  
####  <a name="a-namewinprincipalsa-windows-principals"></a><a name="Win_Principals"></a> Windows 主體  
 在安裝期間， [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] 安裝程式至少需要將一個使用者帳戶命名為 **系統管理員 (sysadmin)** 固定伺服器角色的成員。  
  
####  <a name="a-namesaa-sa-account"></a><a name="sa"></a> sa 帳戶  
...
####  <a name="a-nameloginsa-sql-server-per-service-sid-login-and-privileges"></a><a name="Logins"></a> SQL Server 個別服務 SID 登入和權限  
...
####  <a name="a-nameagenta-sql-server-agent-login-and-privileges"></a><a name="Agent"></a> SQL Server Agent 登入和權限  
...
####  <a name="a-namehadrona-includesshadrctokensshadrcmdmd-and-sql-failover-cluster-instance-and-privileges"></a><a name="Hadron"></a> [!INCLUDE[ssHADRc](../../includes/sshadrc-md.md)] 和 SQL 容錯移轉叢集執行個體和權限  
...
####  <a name="a-namewritera-sql-writer-and-privileges"></a><a name="Writer"></a> SQL 寫入器和權限  
...
####  <a name="a-namesqlwmia-sql-wmi-and-privileges"></a><a name="SQLWMI"></a> SQL WMI 和權限  
...
###  <a name="a-namessasa-ssas-provisioning"></a><a name="SSAS"></a> SSAS 提供  
...
###  <a name="a-namessrsa-ssrs-provisioning"></a><a name="SSRS"></a> SSRS 提供  
...
##  <a name="a-nameupgradea-upgrading-from-previous-versions"></a><a name="Upgrade"></a> 從舊版升級  
...
##  <a name="a-nameappendixa-appendix"></a><a name="Appendix"></a> 附錄  
...
###  <a name="a-nameservacctsa-description-of-service-accounts"></a><a name="Serv_Accts"></a> 服務帳戶的描述  
 服務帳戶是用來啟動 Windows 服務 (例如 [!INCLUDE[ssDEnoversion](../../includes/ssdenoversion-md.md)]) 的帳戶。  
  
####  <a name="a-nameanyosa-accounts-available-with-any-operating-system"></a><a name="Any_OS"></a> 可搭配任何作業系統使用的帳戶  
...
###  <a name="a-nameidentifyinstanceawareandunawarea-identifying-instance-aware-and-instance-unaware-services"></a><a name="Identify_instance_aware_and_unaware"></a> 識別執行個體感知和執行個體非感知服務  
...
###  <a name="a-namelocalizedservicenamesa-localized-service-names"></a><a name="Localized_service_names"></a> 當地語系化服務名稱  
