...
- **[!INCLUDE[ssISnoversion](../../includes/ssisnoversion-md.md)]** - 提供 [!INCLUDE[ssISnoversion](../../includes/ssisnoversion-md.md)] 套件儲存體和執行的管理支援。 可執行檔路徑為 \<MS SQL 路徑>\130\DTS\Binn\MsDtsSrvr.exe
