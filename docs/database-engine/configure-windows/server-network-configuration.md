...
description: 熟悉 SQL Server 網路設定工作。 檢視啟用通訊協定、設定加密、註冊 SPN 和其他動作的資訊。
ms.custom: ''
ms.date: 07/27/2016
ms.prod: sql
