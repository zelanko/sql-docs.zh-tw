...
description: 熟悉 SQL Server 中的連線設定。 了解可判斷延遲的限制式檢查、NULL 處理及其他行為的選項。
ms.custom: ''
ms.date: 03/14/2017
ms.prod: sql
...
## <a name="see-also"></a>另請參閱  
 [選項 &#40;查詢執行：SQL Server:進階頁面&#41;](../../ssms/f1-help/database-engine-query-editor-sql-server-management-studio.md)   
