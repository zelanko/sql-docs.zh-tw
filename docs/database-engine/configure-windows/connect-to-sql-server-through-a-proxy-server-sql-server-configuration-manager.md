---
title: "經由 Proxy 伺服器連接至 SQL Server (SQL Server 組態管理員) | Microsoft Docs"
ms.custom: ""
ms.date: "12/15/2016"
...
helpviewer_keywords: 
  ...
  - "RWS"
  - "LATs"
  - "Proxy 伺服器 [SQL Server]"
  - "連接 [SQL Server], Proxy 伺服器"
...
---
# 經由 Proxy 伺服器連接至 SQL Server (SQL Server 組態管理員)
...
##  <a name="a-namessmsprocedurea-using-sql-server-configuration-manager"></a><a name="SSMSProcedure"></a> 使用 SQL Server 組態管理員  
