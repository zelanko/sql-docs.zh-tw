---
title: "C2 稽核模式伺服器組態選項 | Microsoft Docs"
ms.custom: ""
ms.date: "03/02/2017"
...
> [!NOTE]  
>  [!INCLUDE[ssNoteDepFutureAvoid](../../includes/ssnotedepfutureavoid-md.md)] 「通用條件憑證」(Common Criteria Certification) 已取代 C2 安全性標準。 請參閱[通用條件符合已啟用伺服器組態選項](../../database-engine/configure-windows/common-criteria-compliance-enabled-server-configuration-option.md)。  
