---
title: "設定用於 Database Engine 存取的 Windows 防火牆 | Microsoft Docs"
ms.custom: ""
ms.date: "03/14/2017"
...
4.  在 **[通訊協定及連接埠]** 對話方塊中，選取 **[TCP]**。 選取 [特定本機連接埠]，然後輸入 [!INCLUDE[ssDE](../../includes/ssde-md.md)] 執行個體的通訊埠編號，例如 **1433** 表示預設執行個體。 按一下 **[下一步]**。  
