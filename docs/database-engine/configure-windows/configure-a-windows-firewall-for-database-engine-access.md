...
description: 了解如何設定 Windows 防火牆，讓用戶端電腦可以透過防火牆存取 SQL Server 資料庫引擎的執行個體。
ms.custom: ''
ms.date: 03/14/2017
ms.prod: sql
...
## <a name="see-also"></a>另請參閱  
 [操作說明：設定防火牆設定 (Azure SQL Database)](/azure/azure-sql/database/firewall-configure)  
