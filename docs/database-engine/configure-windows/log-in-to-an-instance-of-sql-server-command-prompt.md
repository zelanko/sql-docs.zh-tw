...
[!INCLUDE[appliesto-ss-xxxx-xxxx-xxx-md](../../includes/appliesto-ss-xxxx-xxxx-xxx-md.md)] 本主題描述如何使用 **sqlcmd** 公用程式測試 [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] 執行個體的連線。  
