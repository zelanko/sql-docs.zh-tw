---
title: "Database Engine 執行個體 (SQL Server) | Microsoft Docs"
ms.custom: ""
ms.date: "03/14/2017"
...
---
# Database Engine 執行個體 (SQL Server)
...
## 另請參閱  
 ...
 [Database Engine 跨執行個體功能](../../relational-databases/database-engine-cross-instance-features.md)  
