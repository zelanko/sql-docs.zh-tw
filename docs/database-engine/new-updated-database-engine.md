...
1. [自動植入次要複本](availability-groups/windows/automatic-seeding-secondary-replicas.md)
2. [設定分散式交易的可用性群組](availability-groups/windows/configure-availability-group-for-distributed-transactions.md)
3. [設定分散式可用性群組](availability-groups/windows/configure-distributed-availability-groups.md)
4. [分散式可用性群組](availability-groups/windows/distributed-availability-groups.md)
5. [網域獨立的可用性群組](availability-groups/windows/domain-independent-availability-groups.md)
6. [SQL Server 2017 中已取代的資料庫引擎功能](deprecated-database-engine-features-in-sql-server-2017.md)
