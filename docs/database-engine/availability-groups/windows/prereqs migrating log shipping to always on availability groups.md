---
title: "從記錄傳送移轉至 AlwaysOn 可用性群組的必要條件 (SQL Server) | Microsoft Docs"
ms.custom: ""
ms.date: "03/14/2017"
...
ms.topic: "article"
helpviewer_keywords: 
  - "記錄傳送 [SQL Server], AlwaysOn 可用性群組"
...
manager: "jhubbard"
---
# 從記錄傳送移轉至 AlwaysOn 可用性群組的必要條件 (SQL Server)
 ...
 **如需詳細資訊：＜＞**  
 ...
 [Converting a logshipping configuration to Availability Group](http://blogs.msdn.com/b/sqlAlways%20On/archive/2012/01/09/converting-a-logshipping-configuration-to-availability-group.aspx) (將記錄傳送組態轉換成可用性群組) (SQL Server 部落格)  
...
-   **部落格：**  
     ...
     [將記錄傳送組態轉換成可用性群組](http://blogs.msdn.com/b/sqlAlways%20On/archive/2012/01/09/converting-a-logshipping-configuration-to-availability-group.aspx)  
  
     [將記錄傳送主要資料庫和次要資料庫加入至現有的可用性群組](http://blogs.msdn.com/b/sqlAlways%20On/archive/2012/02/01/use-log-shipping-to-prepare-secondary-databases-for-an-existing-availability-group.aspx)  
