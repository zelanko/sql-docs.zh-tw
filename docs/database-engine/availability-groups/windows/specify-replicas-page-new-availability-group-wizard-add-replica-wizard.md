---
title: 可用性群組精靈：[指定複本] 頁面
description: 描述 SQL Server Management Studio (SSMS) 中 [新增可用性群組精靈] 的 [指定複本] 頁面選項。
 ...
 **靜態 IP**  
 ...
 如果將 [靜態 IP] 選取為網路模式 (這是預設選項)，方格會顯示 [子網路] 和 [IP 位址] 資料行，並顯示相關聯的 [新增] 和 [移除] 按鈕。 在您加入第一個子網路之前，此方格是空的。  
