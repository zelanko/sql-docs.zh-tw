...
## [必要條件、限制及建議](prereqs-restrictions-recommendations-always-on-availability.md)  
...
## [用戶端連線性](always-on-client-connectivity-sql-server.md)  
...
## [容錯移轉叢集和可用性群組](failover-clustering-and-always-on-availability-groups-sql-server.md)  
...
## 與其他功能的互通性
### [變更追蹤和資料擷取](replicate-track-change-data-capture-always-on-availability.md)  
...
## [接聽程式、 用戶端及容錯移轉](listeners-client-connectivity-application-failover.md)  
## [登入與作業](logins-and-jobs-for-availability-group-databases.md)  
## [工作階段期間可用性複本之間可能發生的失敗](possible-failures-during-sessions-between-availability-replicas-sql-server.md)  
...
### [啟用彈性容錯移轉原則](configure-flexible-automatic-failover-policy.md)  
### [設定複本的備份](configure-backup-on-availability-replicas-sql-server.md)  
...
### [以原則檢視健全狀況](use-always-on-policies-to-view-the-health-of-an-availability-group-sql-server.md)  
...
### [選取初始資料同步頁面 (AlwaysOn 可用性群組精靈)](select-initial-data-synchronization-page-always-on-availability-group-wizards.md)  
...
### [可用性複本沒有健全狀況良好的角色](availability-replica-does-not-have-a-healthy-role.md)  
### [可用性複本已中斷連接](availability-replica-is-disconnected.md)  
### [可用性複本未聯結](availability-replica-is-not-joined.md)  
### [可用性資料庫的資料同步狀態健全狀況不佳](data-synchronization-state-of-availability-database-is-not-healthy.md)  
### [某些可用性資料庫的資料同步狀態健全狀況不佳](data-synchronization-state-of-some-availability-database-is-not-healthy.md)  
...
### [某些可用性複本沒有健全狀況良好的角色](some-availability-replicas-do-not-have-a-healthy-role.md)  
