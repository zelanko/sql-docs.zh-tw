...
ms.topic: "article"
helpviewer_keywords: 
  - "FileTable [SQL Server], 可用性群組"
  - "FILESTREAM [SQL Server], 可用性群組"
...
-   FILESTREAM 和 FileTable 函數會接受或傳回虛擬網路名稱 (VNN) 而非電腦名稱。 如需有關這些函數的詳細資訊，請參閱 [Filestream 和 FileTable 函數 &#40;Transact-SQL&#41;](../../../relational-databases/system-functions/filestream-and-filetable-functions-transact-sql.md)。  
