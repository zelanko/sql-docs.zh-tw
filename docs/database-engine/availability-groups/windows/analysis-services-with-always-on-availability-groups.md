...
---
# Analysis Services 與 AlwaysOn 可用性群組
[!INCLUDE[tsql-appliesto-ss2016-xxxx-xxxx-xxx_md](../../../includes/tsql-appliesto-ss2016-xxxx-xxxx-xxx-md.md)]
 ...
 [檢查清單：僅針對唯讀作業使用次要複本](#bkmk_UseSecondary)  
  
 [建立使用 AlwaysOn 可用性資料庫的 Analysis Services 資料來源](#bkmk_ssasAODB)  
  
 [測試組態](#bkmk_test)  
  
 [容錯移轉之後會發生什麼情況](#bkmk_whathappens)  
  
 [使用 AlwaysOn 可用性資料庫時回寫](#bkmk_writeback)  
...
## 另請參閱  
 ...
 [啟用維度回寫](../../../analysis-services/multidimensional-models/enable-dimension-writeback.md)  
