...
3.  在 [SQL Server 組態管理員] 中，按一下 [SQL Server 服務]，以滑鼠右鍵按一下 [SQL Server (\<_instance name_>)]，其中 **\<**_instance name_**>** 是要停用 AlwaysOn 可用性群組的本機伺服器執行個體名稱，然後按一下 [屬性]。  
...
###  <a name="FollowUp"></a> 後續操作：停用 Always On 之後  
