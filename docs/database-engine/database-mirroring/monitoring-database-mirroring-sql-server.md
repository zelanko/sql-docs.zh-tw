...
-   **sys.database_mirroring_witnesses**  
     ...
     這個目錄檢視會針對伺服器執行個體是見證的每一個工作階段，顯示其資料庫鏡像中繼資料。 如需詳細資訊，請參閱 [sys.database_mirroring_witnesses &#40;Transact-SQL&#41;](../Topic/sys.database_mirroring_witnesses%20\(Transact-SQL\).md)。  
  
-   **sys.dm_db_mirroring_connections**  
  
     此動態管理檢視會針對每一個資料庫鏡像網路連接，傳回一個資料列。  
  
     如需詳細資訊，請參閱 [sys.dm_db_mirroring_connections &#40;Transact-SQL&#41;](../Topic/sys.dm_db_mirroring_connections%20\(Transact-SQL\).md)。  
