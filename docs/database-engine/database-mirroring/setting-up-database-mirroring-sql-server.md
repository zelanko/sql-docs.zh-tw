...
-   [準備伺服器執行個體以參與資料庫鏡像](#PrepareInstances)  
  
-   [概觀：建立資料庫鏡像](#EstablishUsingWinAuthentication)  
...
>   
>  如需使用認證基礎的安全性來透過 [!INCLUDE[tsql](../../includes/tsql-md.md)] 設定資料庫鏡像的範例，請參閱[範例：使用憑證設定資料庫鏡像 &#40;Transact-SQL&#41;](../../database-engine/database-mirroring/example-setting-up-database-mirroring-using-certificates-transact-sql.md)。  
