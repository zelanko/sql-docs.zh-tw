...
description: 了解如何使用 [設定警告臨界值] 對話方塊，在 SQL Server 中啟用及設定所選鏡像資料庫的警告臨界值。
ms.custom: ''
ms.date: 03/07/2017
ms.prod: sql
...
-   **未連線到** *server_instance_name*  
  
-   **正在嘗試連線到** *server_instance_name*  
