---
title: "使用 Windows 驗證允許資料庫鏡像的網路存取 (SQL Server) | Microsoft Docs"
ms.custom: ""
ms.date: "03/14/2017"
...
## 範例  
 下列 [!INCLUDE[tsql](../../includes/tsql-md.md)] 範例會為屬於 `Otheruser` 網域的 `Adomain` 使用者帳戶建立 [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] 登入。 接著，此範例會將預先存在的鏡像資料庫端點 `Mirroring_Endpoint` 的連接權限授與此使用者。  
