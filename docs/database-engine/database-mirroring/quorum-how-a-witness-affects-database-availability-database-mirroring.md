...
helpviewer_keywords: 
  - "仲裁 [SQL Server], 資料庫鏡像"
  - "在資料鏡像中公開執行 [SQL Server]"
  - "見證對夥伴仲裁 [SQL Server]"
  - "夥伴 [SQL Server], 夥伴對夥伴仲裁"
  - "見證 [SQL Server], 仲裁"
  - "有仲裁 [SQL Server]"
  - "仲裁 [SQL Server]"
  - "鏡像資料庫 [SQL Server]"
...
-   「夥伴對夥伴仲裁」，由兩個夥伴所組成。  
 ...
 ![仲裁：完整；旁觀與夥伴；兩個夥伴](../../database-engine/database-mirroring/media/dbm-failovautoquorum.gif "仲裁：完整；旁觀與夥伴；兩個夥伴")  
...
### 仲裁如何影響資料庫可用性  
 ...
 ![旁觀與夥伴如何合作](../../database-engine/database-mirroring/media/dbm-quorum-scenarios.gif "旁觀與夥伴如何合作")  
