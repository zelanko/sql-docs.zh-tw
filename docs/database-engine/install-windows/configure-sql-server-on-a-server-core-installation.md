...
---
# 在 Server Core 安裝上設定 SQL Server
...
-   [在 Windows Server 上設定及管理 Server Core](../../database-engine/install-windows/configure-sql-server-on-a-server-core-installation.md#BKMK_ConfigureWindows)  
  
-   [安裝 SQL Server 更新](../../database-engine/install-windows/configure-sql-server-on-a-server-core-installation.md#BKMK_InstallSQLUpdates)  
  
-   [啟動/停止 SQL Server 服務](../../database-engine/install-windows/configure-sql-server-on-a-server-core-installation.md#BKMK_StartStopServices)  
  
-   [啟用 AlwaysOn 可用性群組](../../database-engine/install-windows/configure-sql-server-on-a-server-core-installation.md#BKMK_EnableAlwaysON)  
  
-   [設定在 Server Core 上執行之 SQL Server 的遠端存取](../../database-engine/install-windows/configure-sql-server-on-a-server-core-installation.md#BKMK_ConfigureRemoteAccess)  
  
-   [SQL Server Profiler](../../database-engine/install-windows/configure-sql-server-on-a-server-core-installation.md#BKMK_Profiler)  
  
-   [SQL Server 稽核](../../database-engine/install-windows/configure-sql-server-on-a-server-core-installation.md#BKMK_Auditing)  
  
-   [命令提示字元公用程式](../../database-engine/install-windows/configure-sql-server-on-a-server-core-installation.md#BKMK_CMD)  
  
-   [使用疑難排解工具](../../database-engine/install-windows/configure-sql-server-on-a-server-core-installation.md#BKMK_troubleshoot)  
  
##  <a name="BKMK_ConfigureWindows"></a> 在 Windows Server 上設定及管理 Server Core  
...
-   [Configuring a Server Core installation: Overview](http://go.microsoft.com/fwlink/?LinkId=245958) (設定伺服器核心安裝：概觀) (http://go.microsoft.com/fwlink/?LinkId=245958)  
  
-   [Configuring a Server Core installation of Windows Server 2008 R2 with Sconfig.cmd](http://go.microsoft.com/fwlink/?LinkId=245959) (使用 Sconfig.cmd 設定 Windonws Server 2008 R2 伺服器核心安裝) (http://go.microsoft.com/fwlink/?LinkId=245959)  
  
-   [Installing a server role on a server running a Server Core installation of Windows Server 2008 R2: Overview](http://go.microsoft.com/fwlink/?LinkId=245960) (於執行 Windows Server 2008 R2 伺服器核心安裝的伺服器上安裝伺服器角色：概觀) (http://go.microsoft.com/fwlink/?LinkId=245960)  
  
-   [Installing Windows Features on a server running a Server Core installation of Windows Server 2008 R2: Overview](http://go.microsoft.com/fwlink/?LinkId=245961) (於執行 Windows Server 2008 R2 伺服器核心安裝的伺服器上安裝 Windows 功能：概觀) (http://go.microsoft.com/fwlink/?LinkId=245961)  
  
-   [Managing a Server Core installation: Overview](http://go.microsoft.com/fwlink/?LinkId=245962) (管理伺服器核心安裝：概觀) (http://go.microsoft.com/fwlink/?LinkId=245962)  
  
-   [Administering a Server Core installation](http://go.microsoft.com/fwlink/?LinkId=245963) (管理伺服器核心安裝) (http://go.microsoft.com/fwlink/?LinkId=245963)  
  
##  <a name="BKMK_InstallSQLUpdates"></a> 安裝 [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] 更新  
 本節提供有關在 Windows Server Core 機器上安裝 [!INCLUDE[ssCurrent](../../includes/sscurrent-md.md)] 更新的資訊。 我們建議客戶及時評估並安裝最新的 [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] 更新，以便確保系統保持在最新狀態而且具有最新的安全性更新。 如需有關在 Windows Server Core 機器上安裝[!INCLUDE[ssCurrent](../../includes/sscurrent-md.md)]之資訊，請參閱[在 Server Core 上安裝 SQL Server 2016](../../database-engine/install-windows/install-sql-server-2016-on-server-core.md)。  
  
 以下是安裝產品更新的兩種狀況：  
  
-   [在進行新安裝期間安裝 SQL Server 2016 的更新](../../database-engine/install-windows/configure-sql-server-on-a-server-core-installation.md#bkmk_NewInstall)  
  
-   [在 SQL Server 2016 安裝完成之後安裝更新](../../database-engine/install-windows/configure-sql-server-on-a-server-core-installation.md#bkmk_alreadyInstall)  
  
###  <a name="bkmk_NewInstall"></a> 在進行新安裝期間安裝 [!INCLUDE[ssCurrent](../../includes/sscurrent-md.md)] 的更新。  
 [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] 安裝程式只支援 Server Core 作業系統上的命令提示字元安裝。 如需詳細資訊，請參閱[從命令提示字元安裝 SQL Server 2016](../../database-engine/install-windows/install-sql-server-2016-from-the-command-prompt.md)。  
...
##  <a name="BKMK_StartStopServices"></a> 啟動/停止 [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] 服務  
...
##  <a name="BKMK_EnableAlwaysON"></a> 啟用 AlwaysOn 可用性群組  
...
### 在遠端使用 [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] 組態管理員  
 這些步驟是為了在執行用戶端版的 [!INCLUDE[win7](../../includes/win7-md.md)] 或更新版本的電腦上，或已安裝伺服器圖形化介面的另一部伺服器上執行 (也就是 [!INCLUDE[winserver2008r2](../../includes/winserver2008r2-md.md)] 的完整安裝，或是已啟用伺服器圖形化介面功能的 [!INCLUDE[win8srv](../../includes/win8srv-md.md)] 安裝)。  
...
1.  開啟 [電腦管理]。 若要開啟 [電腦管理]，請執行下列其中一項作業：  
    ...
    2.  在啟用伺服器圖形化介面的 [!INCLUDE[win8srv](../../includes/win8srv-md.md)] 上：  
...
6.  在 [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] 組態管理員中，按一下 [[!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] 服務]，以滑鼠右鍵按一下 [[!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] (\<執行個體名稱>)]，其中 \<執行個體名稱> 是您想要啟用 AlwaysOn 可用性群組的本機伺服器執行個體名稱，然後按一下屬性。  
...
### 使用 PowerShell 指令程式來啟用 AlwaysOn 可用性群組  
...
##  <a name="BKMK_ConfigureRemoteAccess"></a> 設定在 Server Core 上執行之 [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] 的遠端存取  
...
### 在執行個體上啟用遠端連線 [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)]  
...
### 啟用及啟動 [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] Browser 服務  
...
### 在 Windows 防火牆中建立例外狀況  
 在 Windows 防火牆中建立 [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] 存取的例外狀況時，請遵循[設定 Windows 防火牆以允許 SQL Server 存取](../../sql-server/install/configure-the-windows-firewall-to-allow-sql-server-access.md)中指定的步驟。  
  
### 在執行個體上啟用 TCP/IP [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)]  
...
##  <a name="BKMK_Auditing"></a> [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] 稽核  
...
|[sqlagent90 應用程式](../../tools/sqlagent90-application.md)|用來從命令提示字元啟動 [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] Agent。|\<磁碟機>:\Program Files\\[!INCLUDE[msCoName](../../includes/msconame-md.md)][!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)]\\<*instance_name*>\MSSQL\Binn|  
...
|[sqlmaint 公用程式](../../tools/sqlmaint-utility.md)|用來執行舊版 [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] 所建立的資料庫維護計畫。|\<磁碟機>:\Program Files\\[!INCLUDE[msCoName](../../includes/msconame-md.md)][!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)]\MSSQL13.MSSQLSERVER\MSSQL\Binn|  
...
|[sqlservr 應用程式](../../tools/sqlservr-application.md)|用來從命令提示字元啟動和停止 [!INCLUDE[ssDE](../../includes/ssde-md.md)] 執行個體，以進行疑難排解。|\<磁碟機>:\Program Files\\[!INCLUDE[msCoName](../../includes/msconame-md.md)][!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)]\MSSQL13.MSSQLSERVER\MSSQL\Binn|  
...
## 另請參閱  
 [在 Server Core 上安裝 SQL Server 2016](../../database-engine/install-windows/install-sql-server-2016-on-server-core.md)   
 [安裝的使用說明主題](../Topic/Installation%20How-to%20Topics.md)  
