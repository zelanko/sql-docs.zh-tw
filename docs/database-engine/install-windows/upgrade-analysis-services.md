...
helpviewer_keywords: 
  - "升級資料庫"
  - "資料庫 [Analysis Services], 升級"
  - "安裝 Analysis Services, 並存安裝 installations"
  - "Analysis Services 升級"
  - "Analysis Services升級, 關於 Analysis Services 升級"
  - "SSAS, 資料庫移轉"
  - "升級 Analysis Services"
  - "安裝 Analysis Services, 升級"
  - "SSAS, 升級"
...
---
# 升級 Analysis Services
  Analysis Services 執行個體可以升級至相同伺服器模式的 SQL Server 2016 版本，以利用目前版本中所採用的功能，如 [What's New in Analysis Services](../../analysis-services/what-s-new-in-analysis-services.md)中所述。  
...
-   [SQL Server 2016 版本資訊](http://go.microsoft.com/fwlink/?LinkID=398124) 說明已知問題及因應措施。  
...
4.  重新開啟 **DirectQuery** 。 請參閱 [DirectQuery for Tabular 1200 models](../Topic/DirectQuery%20for%20Tabular%201200%20models.md) 取得詳細指引。  
...
## 另請參閱  
 ...
 [以多維度及資料採礦模式安裝 Analysis Services](../Topic/Install%20Analysis%20Services%20in%20Multidimensional%20and%20Data%20Mining%20Mode.md)   
