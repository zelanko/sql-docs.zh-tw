...
ms.topic: "article"
helpviewer_keywords: 
  - "合併式複寫資料庫升級 [SQL Server 複寫]"
  - "複寫 [SQL Server], 升級"
  - "交易式複寫, 升級資料庫"
  - "快照式複寫 [SQL Server], 升級資料庫"
  - "升級複寫的資料庫"
...
## 升級至 Standard、Workgroup 或 Express Edition  
 從 [!INCLUDE[ssCurrent](../../includes/sscurrent-md.md)] 的一個版本升級到另一個版本之前，請確認您目前使用的功能在您想要升級後的版本中受到支援。 如需詳細資訊，請參閱 [SQL Server 2016 版本支援的功能](../Topic/Features%20Supported%20by%20the%20Editions%20of%20SQL%20Server%202016.md)中的＜複寫＞一節。  
