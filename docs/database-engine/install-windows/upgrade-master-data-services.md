...
description: 探索升級 Microsoft SQL Server Master Data Services 的四個案例。 了解檔案位置與升級疑難排解。
ms.custom: ''
ms.date: 07/21/2017
ms.prod: sql
ms.reviewer: ''
...
##  <a name="upgrade-without-database-engine-upgrade"></a><a name="noengine"></a> 升級但不包含 Database Engine 升級  
