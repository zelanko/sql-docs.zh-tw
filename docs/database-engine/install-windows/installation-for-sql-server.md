...
- [[!INCLUDE[ss2014](../../includes/sssql14-md.md)] 的版本和支援的功能](https://technet.microsoft.com/library/cc645993(v=sql.120).aspx)
...
[SQL Server 安裝程式使用者介面參考](https://msdn.microsoft.com/library/183b5cdd-962e-41ca-8064-ea44f622c77d)  
...
[安裝具有 SharePoint 的 SQL Server BI 功能 &#40;PowerPivot 和 Reporting Services&#41;](https://msdn.microsoft.com/library/3166107c-30c2-468e-bb1b-bb42b79b37c3)  
...
![ssrs_fyi_note](https://docs.microsoft.com/analysis-services/analysis-services/instances/install-windows/media/ssrs-fyi-note.png) 安裝新的範例資料庫， [Wide World Importers](../../sample/world-wide-importers/wide-world-importers-documentation.md)。 
  
[其他 SQL Server 範例和範例資料庫](https://sqlserversamples.codeplex.com/)  
