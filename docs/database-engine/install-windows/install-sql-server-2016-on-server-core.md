...
manager: "jhubbard"
---
# 在 Server Core 上安裝 SQL Server 2016
 ...
 [!INCLUDE[winserver2008r2](../../includes/winserver2008r2-md.md)] 或 [!INCLUDE[win8srv](../../includes/win8srv-md.md)] 作業系統的 Server Core 安裝選項提供執行特定伺服器角色的基本環境， 可協助降低這些伺服器角色的維護和管理需求，以及減少其攻擊面。 如需在 [!INCLUDE[winserver2008r2](../../includes/winserver2008r2-md.md)] 上實作之 Server Core 的詳細資訊，請參閱 [Windows Server 2008 R2 的 Server Core](http://go.microsoft.com/fwlink/?LinkId=202439) (http://go.microsoft.com/fwlink/?LinkId=202439)。 如需在 [!INCLUDE[win8srv](../../includes/win8srv-md.md)] 上實作之 Server Core 的詳細資訊，請參閱 [Windows Server 2012 的 Server Core](http://msdn.microsoft.com/library/hh846323\(VS.85\).aspx) (http://msdn.microsoft.com/library/hh846323(VS.85).aspx)。  
...
|[!INCLUDE[dnprdnshort](../../includes/dnprdnshort-md.md)] 3.5 SP1 Full Profile|包含在 [!INCLUDE[winserver2008r2](../../includes/winserver2008r2-md.md)] SP1 的 Server Core 安裝中。 如果未啟用，安裝程式預設會予以啟用。<br /><br /> 在 Windows 伺服器作業系統的電腦上，您必須先下載及安裝 .NET Framework 3.5 SP1，才能執行安裝程式以安裝相依於 .NET 3.5 SP1 的元件。<br /><br /> 如需如何在 [!INCLUDE[win8srv](../../includes/win8srv-md.md)] 中取得和啟用 .NET Framework 3.5 之建議和指導的詳細資訊，請參閱 [Microsoft .NET Framework 3.5 部署考量](http://msdn.microsoft.com/library/windows/hardware/hh975396) (http://msdn.microsoft.com/library/windows/hardware/hh975396)。|  
|[!INCLUDE[dnprdnshort](../../includes/dnprdnshort-md.md)] 4 Server Core Profile|若是 [!INCLUDE[ssCurrent](../../includes/sscurrent-md.md)] 以外的所有 [!INCLUDE[ssExpress](../../includes/ssexpress-md.md)] 版本，安裝程式會將 [!INCLUDE[dnprdnshort](../../includes/dnprdnshort-md.md)] 4 Server Core Profile 安裝為必要元件。|  
...
|Windows PowerShell|隨附於 [!INCLUDE[winserver2008r2](../../includes/winserver2008r2-md.md)] SP1 和 [!INCLUDE[win8srv](../../includes/win8srv-md.md)] 的 Server Core 安裝。|  
  
##  <a name="a-namebksupportedfeaturesa-supported-features"></a><a name="BK_SupportedFeatures"></a> 支援的功能  
...
|管理工具 - 基本|僅限遠端|不支援在 Server Core 上安裝這些功能。 這些元件可以安裝在與 [!INCLUDE[winserver2008r2](../../includes/winserver2008r2-md.md)] Server Core SP1 或 [!INCLUDE[win8srv](../../includes/win8srv-md.md)] Server Core 不同的伺服器上，並連接至安裝在 Server Core 上的 [!INCLUDE[ssDE](../../includes/ssde-md.md)] Services。|  
|管理工具 - 完整|僅限遠端|不支援在 Server Core 上安裝這些功能。 這些元件可以安裝在與 [!INCLUDE[winserver2008r2](../../includes/winserver2008r2-md.md)] Server Core SP1 或 [!INCLUDE[win8srv](../../includes/win8srv-md.md)] Server Core 不同的伺服器上，並連接至安裝在 Server Core 上的 [!INCLUDE[ssDE](../../includes/ssde-md.md)] Services。|  
|Distributed Replay Controller|否||  
|Distributed Replay Client|僅限遠端|不支援在 Server Core 上安裝這些功能。 這些元件可以安裝在與 [!INCLUDE[winserver2008r2](../../includes/winserver2008r2-md.md)] Server Core SP1 或 [!INCLUDE[win8srv](../../includes/win8srv-md.md)] Server Core 不同的伺服器上，並連接至安裝在 Server Core 上的 [!INCLUDE[ssDE](../../includes/ssde-md.md)] Services。|  
|SQL 用戶端連接性 SDK|是||  
|Microsoft Sync Framework|是|Microsoft Sync Framework 未包含在 [!INCLUDE[ssCurrent](../../includes/sscurrent-md.md)] 安裝套件中。 您可以從這個 [Microsoft 下載中心](http://go.microsoft.com/fwlink/?LinkId=221788) (http://go.microsoft.com/fwlink/?LinkId=221788) 頁面下載適當的 Sync Framework 版本，並將它安裝在執行 [!INCLUDE[winserver2008r2](../../includes/winserver2008r2-md.md)] SP1 或 [!INCLUDE[win8srv](../../includes/win8srv-md.md)] Server Core 安裝的電腦上。|  
 ...
 *不支援在 Server Core 上安裝 32 位元版本的 [!INCLUDE[ssCurrent](../../includes/sscurrent-md.md)]。  
...
2.  **使用組態檔安裝**  
    ...
    -   安裝 [!INCLUDE[ssDE](../../includes/ssde-md.md)]。 下列範例示範如何安裝包含 [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)][!INCLUDE[ssDE](../../includes/ssde-md.md)] 的新獨立執行個體：  
...
## <a name="configuring-remote-access-of-includessnoversiontokenssnoversionmdmd-running-on-server-core"></a>設定在 Server Core 上執行之 [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] 的遠端存取  
...
### <a name="enable-remote-connections-on-the-instance-of-includessnoversiontokenssnoversionmdmd"></a>在 [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] 的執行個體上啟用遠端連接  
...
### <a name="enable-and-start-the-includessnoversiontokenssnoversionmdmd-browser-service"></a>啟用及啟動 [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] Browser 服務  
...
### <a name="enable-tcpip-on-the-instance-of-includessnoversiontokenssnoversionmdmd"></a>在 [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] 的執行個體上啟用 TCP/IP  
...
## <a name="see-also"></a>另請參閱  
 ...
 [Server Core 安裝選項快速入門指南](http://go.microsoft.com/fwlink/?LinkId=221422)   
 [設定 Server Core 安裝︰概觀](http://go.microsoft.com/fwlink/?LinkId=221423)   
 [Windows PowerShell 中由工作焦點列出的容錯移轉叢集 Cmdlet](http://go.microsoft.com/fwlink/?LinkId=221419)   
 [針對容錯移轉叢集將 Cluster.exe 命令對應到 Windows PowerShell Cmdlet](http://go.microsoft.com/fwlink/?LinkId=221421)  
