---
title: 執行 SQL Server 遷移評估 (Data Migration Assistant) |Microsoft Docs
...
如果您想要進一步將這些評量延伸到整個資料資產, 並找出 SQL Server 實例和資料庫的相對就緒, 以便遷移至 Azure SQL Database, 請選取 [**上傳至**], 將結果上傳至 Azure 遷移中樞 Azure Migrate.
