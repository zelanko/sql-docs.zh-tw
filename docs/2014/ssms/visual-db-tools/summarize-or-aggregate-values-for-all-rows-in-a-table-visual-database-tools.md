---
title: 摘要或彙總值的所有資料列的資料表 (Visual Database Tools) |Microsoft Docs
ms.custom: ''
ms.date: 06/13/2017
...
2.  在 [圖表] 窗格的背景上按一下滑鼠右鍵，然後從快速鍵功能表中選擇 [群組依據]。 [查詢和檢視表設計工具](query-and-view-designer-tools-visual-database-tools.md)會將 [群組依據] 資料行新增至 [準則] 窗格的方格中。  
