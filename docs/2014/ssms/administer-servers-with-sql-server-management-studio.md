...
## <a name="see-also"></a>另請參閱  
 ...
 [查看或變更伺服器屬性 &#40;SQL Server&#41;](../database-engine/configure-windows/view-or-change-server-properties-sql-server.md)  
