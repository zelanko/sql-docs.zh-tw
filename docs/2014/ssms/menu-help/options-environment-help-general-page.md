...
# <a name="options-environment-help-general-page"></a>選項（環境-說明-一般頁面）
  使用 [**選項**] 對話方塊來選擇檔集，並決定是否要在不同的[!INCLUDE[msCoName](../../includes/msconame-md.md)] [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] [!INCLUDE[ssManStudio](../../includes/ssmanstudio-md.md)]視窗中，于內部或外部顯示主題。 若要存取此對話方塊，請按一下 [工具]**** 功能表上的 [選項]****，展開 [環境]**** 節點中的 [說明]****，然後按一下 [一般]****。  
