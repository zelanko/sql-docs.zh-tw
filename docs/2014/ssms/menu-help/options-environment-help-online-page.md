...
# <a name="options-environment-help-online-page"></a>選項（環境-說明-線上頁面）
  [**選項**] 對話方塊可讓您指定用於[!INCLUDE[msCoName](../../includes/msconame-md.md)] [!INCLUDE[ssManStudioFull](../../includes/ssmanstudiofull-md.md)]搜尋的說明來源，包括 F1 說明。 在 [工具]**** 功能表上，按一下 [選項]****、展開 [環境]**** 資料夾、選取 [說明]****，然後按一下 [線上]****。 如果 [線上]**** 頁面未出現在清單中，請在 [選項]**** 對話方塊中選取 [顯示所有設定]**** 核取方塊。  
