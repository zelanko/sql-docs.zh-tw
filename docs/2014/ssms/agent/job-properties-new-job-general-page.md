---
title: 作業屬性和新增作業 （一般頁面） |Microsoft Docs
ms.custom: ''
ms.date: 03/06/2017
...
ms.locfileid: "37284544"
---
# <a name="job-properties-and-new-job-general-page"></a>作業屬性和新增作業 （一般頁面）
  使用此頁面來檢視和修改 [!INCLUDE[msCoName](../../includes/msconame-md.md)] [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] Agent 作業的一般屬性。  
