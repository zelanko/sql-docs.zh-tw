...
# <a name="f1-help-for-server-connections-sql-server-management-studio"></a>伺服器連接的 F1 說明 (SQL Server Management Studio)
 ...
 [連接到伺服器 &#40;登入頁面&#41; Reporting Services](../../database-engine/connect-to-server-login-page-reporting-services.md)  
  
 [連接到伺服器 &#40;Reporting Services&#41;](../../database-engine/connect-to-server-reporting-services.md)  
