...
-   利用指令碼儲存連接資訊。  
 ...
 [方案總管] 為開發人員所適用的工具，他們會建立及重複使用與同一專案相關的指令碼。 如果稍後需要類似工作，您可以使用已儲存在專案中的指令碼群組。 如果曾經使用 [!INCLUDE[msCoName](../includes/msconame-md.md)] [!INCLUDE[vsprvs](../includes/vsprvs-md.md)] 來建立應用程式，則您應該對 [方案總管] 非常熟悉。  
