---
title: 消費者入門（SQL Server 2014） |Microsoft Docs
ms.custom: ''
ms.date: 11/25/2019
...
ms.locfileid: "84926799"
---
# <a name="getting-started-sql-server-2014"></a>使用者入門 (SQL Server 2014)
  尋找 [!INCLUDE[ssCurrent](../includes/sscurrent-md.md)] 資訊、系統需求、安裝指示等來源。  
 ...
 [取得 &#40;SQL Server 2014&#41;的協助](getting-assistance-sql-server-2014.md)  
