...
|-|-|  
|**工具**|**描述**|  
|[適用於 SQL Server 2014 的報表產生器說明](https://go.microsoft.com/fwlink/?LinkId=299171)|報表產生器是適用於商務使用者的報表撰寫環境。|  
...
|[SQL Server 服務安裝](https://go.microsoft.com/fwlink/?LinkId=299176)|用來協助將更新套用至 SQL Server 元件的文件。|  
...
|[PowerPivot for SharePoint](https://go.microsoft.com/fwlink/?LinkId=299184)|PowerPivot for SharePoint 是以 SharePoint 模式執行的 Analysis Services 伺服器。|  
