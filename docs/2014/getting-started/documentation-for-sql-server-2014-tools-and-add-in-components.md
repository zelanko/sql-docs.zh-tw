---
title: SQL Server 2014 工具和外接程式元件的文檔 |微軟文檔
ms.custom: ''
ms.date: 03/27/2020
...
|[共用點的電源透視](https://go.microsoft.com/fwlink/?LinkId=299184)|PowerPivot for SharePoint 是以 SharePoint 模式執行的 Analysis Services 伺服器。|  
  
## <a name="see-also"></a>另請參閱  
 [SQL 伺服器 2014 文檔](../2014-toc/index.yml)  
