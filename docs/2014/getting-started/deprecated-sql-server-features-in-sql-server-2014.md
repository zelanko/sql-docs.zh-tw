---
title: 已被取代的 SQL Server 2014 中的 SQL Server 功能 |Microsoft 文件
ms.custom: ''
ms.date: 05/24/2017
...
|資料可程式性|[sys.endpoint_webmethods &#40;Transact SQL&#41;](/sql/relational-databases/system-catalog-views/sys-endpoint-webmethods-transact-sql)|Windows Communications Foundation (WCF) 或 ASP.NET|原生 XML Web Service|23|  
  
### <a name="slipstream-functionality"></a>匯集功能  
 產品更新功能取代了之前 [!INCLUDE[ssKatmai](../includes/sskatmai-md.md)] PCU1 中可用的匯集功能。 因此的命令列參數 /*PCUSource*和 /*CUSource*、 與匯集功能應該就無法再使用相關聯。 這些參數仍可繼續運作，但 [!INCLUDE[ssNoVersion](../includes/ssnoversion-md.md)] 安裝程式的未來版本可能會移除這些參數。 /*UpdateSource*參數結合所有匯集參數中，功能 /*PCUSource*和 /*CUSource*。  
  
 如需有關匯集功能中可用[!INCLUDE[ssKatmai](../includes/sskatmai-md.md)]PCU1 中，請參閱[匯集 SQL Server 更新](http://go.microsoft.com/fwlink/?LinkId=219945)(http://go.microsoft.com/fwlink/?LinkId=219945)。  
