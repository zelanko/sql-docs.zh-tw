...
|SQLSERVER:\DAC|[Microsoft. SqlServer. 管理 DAC](/dotnet/api/microsoft.sqlserver.management.utility.deployeddac)|資料層應用程式物件 (如 DAC 封裝) 與作業 (如部署 DAC)。|  
