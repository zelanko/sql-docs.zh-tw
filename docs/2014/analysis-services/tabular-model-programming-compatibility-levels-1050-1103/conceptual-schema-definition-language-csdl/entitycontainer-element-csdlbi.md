...
# <a name="entitycontainer-element-csdlbi"></a>EntityContainer 元素 (CSDLBI)
 ...
 EntityContainer 必須指定資料模型中包含的每個實體類型，包括資料表和關聯性。 有關這些模型實體的資訊是透過列出 Entity 元素類型的子實體來指定。 如需詳細資訊，請參閱 [EntityType 元素 &#40;CSDLBI&#41;](entitytype-element-csdlbi.md)。  
