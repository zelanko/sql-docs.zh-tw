...
5.  在 屬性視窗中，將  **DiscretizationMethod**  屬性的值變更為 **自動**，並將  **DiscretizationBucketCount**  屬性的值變更為 `5`。  
     ...
     ![每年收入的修改屬性](../../2014/tutorials/media/l4-discretizationmethod-1.gif "每年收入的修改屬性")  
...
5.  在 屬性視窗中，將  **DiscretizationMethod**  屬性的值變更為 叢集，然後將  **DiscretizationBucketCount**  屬性的值**變更為**  `5`。  
...
9. 在此欄位清單中，依序展開 [員工] 維度和 [組織]，然後將 [病假時數] 拖曳至 [資料行標籤]。  
     ...
     ![依員工病假時數的銷售維度](../../2014/tutorials/media/l4-discretizationmethod-2.gif "依員工病假時數的銷售維度")  
