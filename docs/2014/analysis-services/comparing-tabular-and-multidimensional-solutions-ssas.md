---
title: 比較表格式和多維度方案（SSAS） |Microsoft Docs
ms.custom: ''
ms.date: 06/13/2017
...
-   [Analysis Services 中的模型化概觀](#bkmk_overview)  
...
-   [下一個步驟：建立解決方案](#bkmk_Next)  
  
 在 MSDN 上，可以在此技術文章中找到其他資訊： [在 SQL Server 2012 Analysis Services 中選擇表格式或多維度模型化體驗](https://go.microsoft.com/fwlink/?LinkId=251588)(英文)。  
  
##  <a name="overview-of-modeling-in-analysis-services"></a><a name="bkmk_overview"></a>Analysis Services 中的模型化總覽  
...
##  <a name="data-source-support-by-solution-type"></a><a name="bkmk_ds"></a>依解決方案類型的資料來源支援  
...
|**連結**|**支援選項摘要**|  
|--------------|--------------------------------------|  
|[&#40;SSAS 多維度&#41;支援的資料來源](multidimensional-models/supported-data-sources-ssas-multidimensional.md)|多維度模型使用來自關聯式資料來源的資料。|  
...
##  <a name="model-size"></a><a name="bkmk_modelsize"></a>模型大小  
 ...
 由數以百計的資料表或維度組成的極大模型通常會以程式設計方式在 Visual Studio 中建立，而不是在設計工具中建立。 如需有關模型中物件數目上限的詳細資訊，請參閱[&#40;Analysis Services&#41;的最大容量規格](multidimensional-models/olap-physical/maximum-capacity-specifications-analysis-services.md)。  
  
##  <a name="programmability-and-developer-experience"></a><a name="bkmk_ext"></a>可程式性和開發人員體驗  
...
##  <a name="query-and-scripting-language-support"></a><a name="bkmk_lang"></a>查詢和指令碼語言支援  
...
##  <a name="security-feature-support"></a><a name="bkmk_sec"></a>安全性功能支援  
...
##  <a name="design-tools"></a><a name="bkmk_designer"></a>設計工具  
...
##  <a name="client-and-reporting-applications"></a><a name="bkmk_client"></a>用戶端和報告應用程式  
...
|[!INCLUDE[ssCrescent](../includes/sscrescent-md.md)]在 Office 365 或 Power BI 網站中|僅限表格式模型。|  
...
##  <a name="hosting-platforms"></a><a name="bkmk_sharePoint"></a>裝載平臺  
...
##  <a name="next-step-build-a-solution"></a><a name="bkmk_Next"></a>下一步：建立解決方案  
...
## <a name="see-also"></a>另請參閱  
 ...
 [PowerPivot 的新功能](https://go.microsoft.com/fwlink/?LinkId=238141)   
 [SQL Server 2012 的 PowerPivot 說明](https://go.microsoft.com/fwlink/?LinkID=220946)   
 [PowerPivot BI 語義模型連接 &#40;. bism&#41;](power-pivot-sharepoint/power-pivot-bi-semantic-model-connection-bism.md)   
