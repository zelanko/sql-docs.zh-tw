...
1.  開啟適用於 [!INCLUDE[ssASnoversion](../includes/ssasnoversion-md.md)] 教學課程 Cube 的 Cube 設計師，然後按一下 [計算]**** 索引標籤。  
     ...
     ![Cube 設計師的計算索引標籤](../../2014/tutorials/media/l6-calculatedmembers-1.gif "Cube 設計師的計算索引標籤")  
...
9. 在 [非空白行為]**** 清單中，勾選 [網際網路銷售 - 銷售量]**** 和 [轉售商銷售 - 銷售量]**** 的核取方塊，然後按一下 [確定]****。  
     ...
     ![擴展的計算運算式窗格](../../2014/tutorials/media/l6-calculatedmembers-03.gif "擴展的計算運算式窗格")  
...
8.  將 [總毛利率]****、[網際網路毛利率]**** 和 [轉售商毛利率]**** 量值新增至 [值] 區域中，然後檢閱結果。  
     ...
     ![顯示轉售商銷售額的資料窗格](../../2014/tutorials/media/l6-calculatedmembers-7b.gif "顯示轉售商銷售額的資料窗格")  
