...
|**顯示量值**|按一下即可循環瀏覽下列選項，或選取下列選項之一來變更 [量值] 窗格的檢視：<br /><br /> **樹狀結構**： 顯示量值群組和樹狀檢視中的量值。<br /><br /> **方格**： 顯示量值群組與量值方格中的。|  
...
|**顯示**|按一下即可循環瀏覽下列選項，或選取下列選項之一來變更 [資料來源檢視] 窗格的檢視：<br /><br /> **樹狀檢視**： 顯示資料表、 具名查詢、 資料行、 具名的計算以及關聯性樹狀結構檢視中的。<br /><br /> **圖表檢視**： 顯示資料表、 具名查詢、 資料行、 具名的計算，以及在資料庫圖表中的關聯性。|  
