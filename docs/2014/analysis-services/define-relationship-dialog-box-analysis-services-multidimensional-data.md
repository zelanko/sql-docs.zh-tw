...
|關聯性類型|Description|選項|  
|-----------------------|-----------------|------------|  
|**[無關聯性]**|未定義關聯性，且 **[詳細資料]** 窗格不會顯示任何選項。||  
|**標準**|指定一般維度關聯性。 下列選項會顯示在 **[詳細資料]** 窗格中：|資料**細微性屬性**： <br />                      選取屬性，其中定義相對於維度之量值群組的資料粒度。 這個屬性通常是維度的索引鍵屬性。|  
|||**維度資料表**：顯示維度的主資料表。|  
...
|||**進階**：<br />                      按一下即可顯示 [量值群組繫結]**** 對話方塊，並在屬性和量值群組資料行之間的關聯性上編輯進階屬性，例如 Null 處理。 如需有關 [**量值群組**系結] 對話方塊的詳細資訊，請參閱[量值群組系結對話方塊 &#40;Analysis Services-多維度資料&#41;](measure-group-bindings-dialog-box-analysis-services-multidimensional-data.md)。|  
