...
# <a name="add-table-dialog-box-analysis-services---multidimensional-data"></a>[ 新增表格 ] 對話方塊 (Analysis Services - 多維度資料)
  在 [建立具名查詢]**** 對話方塊、[建立輪詢查詢][!INCLUDE[ssBIDevStudioFull](../includes/ssbidevstudiofull-md.md)]** 對話方塊或 [建立處理查詢]**** 對話方塊中建立查詢時，使用 ** 中的 [加入資料表]**** 對話方塊，即可加入資料表。 按一下 [建立具名查詢]**** 對話方塊、[建立輪詢查詢][!INCLUDE[ssBIDevStudioFull](../includes/ssbidevstudiofull-md.md)]** 對話方塊或 [建立處理查詢]**** 對話方塊中之 [工具列]**** 窗格的 [加入資料表]****，即可顯示 ** 中的 [加入資料表]**** 對話方塊。  
