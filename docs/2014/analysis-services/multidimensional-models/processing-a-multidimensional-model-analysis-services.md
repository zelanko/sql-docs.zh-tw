...
##  <a name="choosing-a-tool-or-approach"></a><a name="bkmk_tool"></a>選擇工具或方法  
 ...
 如需詳細資訊，請參閱[處理的工具和方式 &#40;Analysis Services&#41;](tools-and-approaches-for-processing-analysis-services.md)。  
  
##  <a name="processing-objects"></a><a name="bkmk_proc"></a>處理物件  
...
##  <a name="reprocessing-objects"></a><a name="bkmk_reproc"></a>重新處理物件  
