...
> [!NOTE]  
>  如果服務帳戶沒有 Analysis Services 執行個體的管理員權限，則從 Cube 處理資料採礦模型時可能會發生錯誤。 如需詳細資訊，請參閱 [採礦結構：當資料來源為 OLAP Cube 時的處理問題](https://go.microsoft.com/fwlink/?LinkId=251610)。  
 ...
 **資料庫-預設選項**  
 ...
 對於表格式資料庫，[**預設值**] 表示使用服務帳戶。  
  
 若為多維度資料庫，[預設值]**** 表示使用服務帳戶和目前使用者進行資料採礦作業。  
  
## <a name="see-also"></a>另請參閱  
 [建立 &#40;SSAS 多維度&#41;的資料來源](create-a-data-source-ssas-multidimensional.md)   
 [將資料來源屬性設定 &#40;SSAS 多維度&#41;](set-data-source-properties-ssas-multidimensional.md)   
 [&#40;SSAS 表格式&#41;的 DirectQuery 部署案例](../directquery-deployment-scenarios-ssas-tabular.md)  
