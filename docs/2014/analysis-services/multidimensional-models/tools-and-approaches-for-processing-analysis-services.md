...
-   使用 AMO 進行自訂方案程式設計。 如需相關資訊，請參閱 [Programming AMO OLAP Basic Objects](analysis-management-objects/programming-amo-olap-basic-objects.md)。  
