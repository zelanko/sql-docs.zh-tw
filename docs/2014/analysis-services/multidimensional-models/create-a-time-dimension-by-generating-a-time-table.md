...
-   **在資料來源中產生時間資料表**當您擁有在基礎資料來源中建立物件的許可權時，請選取此選項。 然後，這個精靈將產生時間資料表並將此資料表儲存在資料來源中。 接著，這個精靈會根據此時間資料表建立時間維度。  
  
-   **在伺服器上產生時間資料表**當您沒有在基礎資料來源中建立物件的許可權時，請選取此選項。 然後，這個精靈將在伺服器上 (而非資料來源中) 產生並儲存資料表 （從伺服器上的時間資料表建立的維度稱為「*伺服器時間維度*」）。接著，嚮導會從這個資料表建立伺服器時間維度。  
