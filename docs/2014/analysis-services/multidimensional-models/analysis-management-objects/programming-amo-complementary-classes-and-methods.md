...
3.  視需要啟動和停止追蹤。  
     ...
     即使在追蹤停止之後，追蹤仍然會在伺服器中，而且如果將追蹤定義為 AutoRestart=`true`，就應該會再次啟動。  
