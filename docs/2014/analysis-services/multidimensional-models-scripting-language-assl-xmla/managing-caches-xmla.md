...
## <a name="specifying-objects"></a>指定物件  
 命令的 Object 屬性只能包含下列其中一個物件的物件參考。 [Object](https://docs.microsoft.com/bi-reference/xmla/xml-elements-properties/object-element-xmla) `ClearCache` 如果物件參考不是用於下列其中一個物件，就會發生錯誤：  
