...
##  <a name="supported-versions-and-modes-of-analysis-services"></a><a name="bkmk_vers"></a> Analysis Services 的支援版本和模式  
...
##  <a name="authentication-requirements-and-security-considerations"></a><a name="bkmk_auth"></a>驗證需求和安全性考慮  
...
##  <a name="analysis-services-powershell-tasks"></a><a name="bkmk_tasks"></a>Analysis Services PowerShell 工作  
...
-   [載入 Analysis Services 提供者和指令程式](#bkmk_load)  
...
###  <a name="load-the-analysis-services-provider-and-cmdlets"></a><a name="bkmk_load"></a>載入 Analysis Services 提供者和 Cmdlet  
...
###  <a name="enable-remote-administration"></a><a name="bkmk_remote"></a>啟用遠端系統管理  
...
###  <a name="connect-to-an-analysis-services-object"></a><a name="bkmk_connect"></a>連接到 Analysis Services 物件  
...
###  <a name="administer-the-service"></a><a name="bkmk_admin"></a>管理服務  
...
###  <a name="get-help-for-analysis-services-powershell"></a><a name="bkmk_help"></a>取得 Analysis Services PowerShell 的說明  
