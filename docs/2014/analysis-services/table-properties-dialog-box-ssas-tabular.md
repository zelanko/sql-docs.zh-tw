---
title: 資料表屬性對話方塊 (SSAS-表格式) |Microsoft Docs
ms.custom: ''
ms.date: 06/13/2017
...
|**State**|顯示資料表的處理狀態。 如需此屬性之值的詳細資訊，請參閱<xref:Microsoft.AnalysisServices.ProcessableMajorObject.State%2A>。|  
