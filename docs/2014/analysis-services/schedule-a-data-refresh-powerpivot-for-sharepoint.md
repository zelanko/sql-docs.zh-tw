...
##  <a name="data-refresh-overview"></a><a name="intro"></a>資料重新整理總覽  
...
##  <a name="enable-and-schedule-data-refresh"></a><a name="drenablesched"></a>啟用和排程資料重新整理  
...
##  <a name="verify-data-refresh"></a><a name="drverify"></a>確認資料重新整理  
