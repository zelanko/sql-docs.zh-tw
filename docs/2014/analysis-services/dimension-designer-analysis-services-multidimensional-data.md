...
## <a name="pages"></a>頁面  
 ...
 使用這個頁面，即可檢視和修改維度的屬性、階層和層級。  
  
 [屬性關聯性](attribute-relationships-dimension-designer-analysis-services-multidimensional-data.md)  
 使用此頁面，即可建立、修改或刪除選取維度的屬性關聯性。  
