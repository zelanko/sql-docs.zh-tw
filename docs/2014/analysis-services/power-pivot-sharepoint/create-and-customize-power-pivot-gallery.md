...
##  <a name="create-the-powerpivot-gallery"></a><a name="createlib"></a>建立 PowerPivot 圖庫
...
##  <a name="customize-a-powerpivot-gallery-library"></a><a name="customize"></a>自訂 PowerPivot 圖庫文件庫
...
####  <a name="disable-or-hide-the-refresh-button"></a><a name="bkmk_hide_refresh_button"></a>停用或隱藏重新整理按鈕
...
##  <a name="switch-to-theater-view-or-gallery-view"></a><a name="switch"></a>切換至劇院 View 或圖庫 View
