...
##  <a name="rsreport"></a>從 Reporting Services 報表建立資料摘要  
 ...
 如需如何從報表匯出資料摘要的指示，請參閱[報表產生器說明檔](../../reporting-services/report-builder/generate-data-feeds-from-a-report-report-builder-and-ssrs.md)中的[從報表產生資料摘要 &#40;報表產生器及 SSRS&#41;](https://go.microsoft.com/fwlink/?LinkId=154494)。  
...
5.  指定一個或多個提供摘要的 URL：  
    ...
    2.  需要**Web 服務 URL** 。 如果沒有基底 URL，這個值在位址中必須包含 http:// 或 https://。 如果您有指定基底 URL，Web 服務 URL 就是基底 URL 後面的部分。 例如，如果完整的 URL 是http://adventure-works/inventory/today.aspx，則基底 url 會是http://adventure-works/inventory，而 Web 服務 URL 會是/today.aspx。  
