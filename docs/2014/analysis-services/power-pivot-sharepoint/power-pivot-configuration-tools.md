...
##  <a name="requirements-for-using-the-configuration-tools"></a><a name="bkmk_requirements"></a>使用組態工具的需求
...
##  <a name="two-versions-of-the-configuration-tool"></a><a name="bkmk_twoversions"></a>兩個版本的設定工具
...
###  <a name="how-the-two-configuration-tools-are-different"></a><a name="bkmk_sum_differences_betweentools"></a>兩個組態工具有何不同
...
##  <a name="overview-of-using-a-powerpivot-configuration-tool"></a><a name="bkmk_overview"></a>使用 PowerPivot 設定工具的總覽
...
##  <a name="start-one-of-the-powerpivot-configuration-tools"></a><a name="bmkm_start_tool"></a>啟動其中一個 PowerPivot 組態工具
