---
title: 下列功能不受 Excel Services 和可能不會顯示或是只顯示一部分： 註解、 形狀或其他物件 |Microsoft 文件
ms.custom: ''
ms.date: 06/13/2017
...
## <a name="explanation"></a>說明  
 Excel Web Access 會顯示這個錯誤，當您在瀏覽器中開啟 PowerPivot 活頁簿按一下**詳細資料**訊息時，按鈕**不支援的功能。 這個活頁簿可能不會如預期般顯示**。  
