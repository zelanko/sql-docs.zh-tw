---
title: 量值群組繫結對話方塊 (Analysis Services-多維度資料) |Microsoft 文件
ms.custom: ''
ms.date: 06/13/2017
...
|**Null 處理**|為屬性選取 Null 處理選項。 如需 Null 處理選項的詳細資訊，請參閱 [NullProcessing 元素 &#40;ASSL&#41;](scripting/properties/nullprocessing-element-assl.md)。|  
