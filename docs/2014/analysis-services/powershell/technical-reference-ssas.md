...
# <a name="technical-reference-ssas"></a>技術參考 (SSAS)
 ...
 ![小型檔案資料夾圖示](../../integration-services/media/filefolder-small.gif "小型檔案資料夾圖示")**預存程式參考**  
 ...
 ![小型檔案資料夾圖示](../../integration-services/media/filefolder-small.gif "小型檔案資料夾圖示")**查詢和運算式語言參考**  
