...
|EventSubclass|@shouldalert|@shouldalert|事件子類別提供有關每個事件類別的額外資訊：<br /><br /> 1： 程序<br /><br /> 2： 合併<br /><br /> 3： 刪除<br /><br /> 4: DeleteOldAggregations<br /><br /> 5： 重建<br /><br /> 6： 認可<br /><br /> 7： 復原<br /><br /> 8: CreateIndexes<br /><br /> 9: CreateTable<br /><br /> 10: InsertInto<br /><br /> 11： 交易<br /><br /> 12： 初始化<br /><br /> 13： 離散化<br /><br /> 14： 查詢<br /><br /> 15: CreateView<br /><br /> 16: WriteData<br /><br /> 17: ReadData<br /><br /> 18: GroupData<br /><br /> 19: GroupDataRecord<br /><br /> 20: BuildIndex<br /><br /> 21： 彙總<br /><br /> 22: BuildDecode<br /><br /> 23: WriteDecode<br /><br /> 24: BuildDMDecode<br /><br /> 25: ExecuteSQL<br /><br /> 26: ExecuteModifiedSQL<br /><br /> 27： 連接<br /><br /> 28: BuildAggsAndIndexes<br /><br /> 29: MergeAggsOnDisk<br /><br /> 30: BuildIndexForRigidAggs<br /><br /> 31: BuildIndexForFlexibleAggs<br /><br /> 32: WriteAggsAndIndexes<br /><br /> 33: WriteSegment<br /><br /> 34: DataMiningProgress<br /><br /> 35: ReadBufferFullReport<br /><br /> 36: ProactiveCacheConversion<br /><br /> 37： 備份<br /><br /> 38： 還原<br /><br /> 39： 同步處理<br /><br /> 40： 建立處理排程<br /><br /> 41： 卸離<br /><br /> 42： 附加<br /><br /> 43: Analyze\Encode Data<br /><br /> 44: compress Segment<br /><br /> 45: write Table Column<br /><br /> 46: relationship Build Prepare<br /><br /> 47: build Relationship Segment<br /><br /> 48： 負載<br /><br /> 49： 中繼資料載入<br /><br /> 50： 資料載入<br /><br /> 51： 張貼負載<br /><br /> 52： 備份期間的中繼資料周遊<br /><br /> 53: VertiPaq<br /><br /> 54： 階層處理<br /><br /> 55： 切換字典|  
...
|JobID|7|@shouldalert|包含與報告事件相關聯的作業識別碼。|  
...
|ObjectType|12|@shouldalert|包含物件類型。|  
...
|ConnectionID|25|@shouldalert|包含與報告事件相關聯的唯一連接識別碼。|  
...
|JobID|7|@shouldalert|包含與報告事件相關聯的作業識別碼。|  
|SessionType|8|8|包含與報告事件相關聯的工作階段類型 (造成事件的實體)。 針對處理事件，值為：<br /><br /> 1= 使用者<br /><br /> 2= 主動式快取<br /><br /> 3= 延遲處理|  
|ProgressTotal|9|@shouldalert|包含報告事件的整體進度。|  
|IntegerData|10|@shouldalert|包含與報告事件相關聯的整數資料，例如針對處理事件處理之資料列數的目前計數。|  
|ObjectID|11|8|包含與報告事件相關聯的物件識別碼 (字串)。|  
|ObjectType|12|@shouldalert|包含物件類型。|  
|ObjectName|13|8|包含與報告事件相關聯之物件的名稱。|  
|ObjectPath|14|8|包含與報告事件相關聯之物件的物件路徑，做為以物件的父系開頭之父系清單 (以逗號分隔)。|  
|ObjectReference|15|8|包含報告事件的物件參考，所有父系編碼為 XML，並使用標記來描述物件。|  
|Severity|22|@shouldalert|包含與報告事件相關聯之例外狀況的嚴重性層級。 值為：<br /><br /> 0 = 成功<br /><br /> 1 = 參考資訊<br /><br /> 2 = 警告<br /><br /> 3 = 錯誤|  
|成功|23|@shouldalert|包含伺服器報告事件的成功或失敗。 值為：<br /><br /> 0 = 失敗<br /><br /> 1 = 成功|  
|錯誤|24|@shouldalert|包含給定事件的錯誤號碼。|  
|ConnectionID|25|@shouldalert|包含與報告事件相關聯的唯一連接識別碼。|  
|DatabaseName|28|8|包含發生報告事件之資料庫的名稱。|  
|NTUserName|32|8|包含與報告事件相關聯的 Windows 使用者帳戶。|  
|NTDomainName|33|8|包含與報告事件相關聯的 Windows 網域帳戶。|  
