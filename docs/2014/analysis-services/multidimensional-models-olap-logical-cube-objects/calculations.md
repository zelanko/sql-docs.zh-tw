...
```  
 ...
 若要建立導出的成員，請使用**計算**的標籤，Cube 設計工具中。 如需詳細資訊，請參閱[建立導出成員](../multidimensional-models/create-calculated-members.md)  
