...
## <a name="reference-dimension-relationships"></a>參考維度關聯性  
 ...
 ![邏輯圖中，參考的維度關聯性](../../../2014/analysis-services/dev-guide/media/as-refdimension1.gif "邏輯圖中，參考的維度關聯性")  
 ...
 ![邏輯結構描述，參考的維度關聯性](../../../2014/analysis-services/dev-guide/media/as-refdim-schema1.gif "邏輯結構描述，參考的維度關聯性")  
 ...
 ![邏輯圖中，參考的維度關聯性](../../../2014/analysis-services/dev-guide/media/as-refdimension2.gif "邏輯圖中，參考的維度關聯性")  
  
 如需參考的關聯性的詳細資訊，請參閱[定義參考關聯性及參考的關聯性屬性](../multidimensional-models/define-a-referenced-relationship-and-referenced-relationship-properties.md)。  
...
>  在每次更新事實關聯性所參考的量值群組之後，都必須以累加方式更新事實維度。 如果事實維度是 ROLAP 維度，則 [!INCLUDE[ssASnoversion](../../includes/ssasnoversion-md.md)] 處理引擎會卸除任何快取，並以累加方式處理量值群組。  
 ...
 如需有關事實關聯性的詳細資訊，請參閱 <<c0> [ 定義事實關聯性及事實關聯性屬性](../multidimensional-models/define-a-fact-relationship-and-fact-relationship-properties.md)。  
