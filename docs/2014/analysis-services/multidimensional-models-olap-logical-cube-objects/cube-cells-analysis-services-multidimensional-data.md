...
-   封裝成員。  
 ...
 ![下半年成員的第三季和第四季資料格](https://docs.microsoft.com/analysis-services/analysis-services/dev-guide/media/as-cubeintro6.gif "下半年成員的第三季和第四季資料格")  
...
## <a name="empty-cells"></a>空資料格  
 ...
 ![識別空白資料格的 Cube 圖表](https://docs.microsoft.com/analysis-services/analysis-services/dev-guide/media/as-cubeintro7.gif "識別空白資料格的 Cube 圖表")  
