---
title: 採礦模型屬性對話方塊 (Analysis Services-資料採礦) |Microsoft 文件
ms.custom: ''
ms.date: 06/13/2017
...
|**State**|顯示採礦模型的處理狀態。 如需此屬性的值的詳細資訊，請參閱<xref:Microsoft.AnalysisServices.ProcessableMajorObject.State%2A>。|  
