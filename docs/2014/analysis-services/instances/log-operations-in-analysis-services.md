...
##  <a name="bkmk_general"></a>記錄檔設定的一般資訊  
...
##  <a name="bkmk_msmdsrv"></a>MSMDSRV.EXE 服務記錄檔  
...
-   [深入瞭解使用小型傾印的 SQL Server](https://blogs.msdn.com/b/sqlcat/archive/2009/09/11/looking-deeper-into-sql-server-using-minidumps.aspx)  
  
-   [如何建立使用者模式傾印檔案](https://support.microsoft.com/kb/931673)  
  
-   [如何在 SQL Server 中使用 Sqldumper.exe 公用程式產生傾印檔案](https://support.microsoft.com/kb/917825)  
