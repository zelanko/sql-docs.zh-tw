...
-   [MSMDSRV.EXE 服務記錄檔](#bkmk_msmdsrv)  
...
##  <a name="general-information-on-log-file-configuration-settings"></a><a name="bkmk_general"></a>記錄檔設定的一般資訊  
...
##  <a name="msmdsrv-service-log-file"></a><a name="bkmk_msmdsrv"></a> MSMDSRV 服務記錄檔  
...
##  <a name="query-logs"></a><a name="bkmk_querylog"></a>查詢記錄  
...
4.  如果您想要以不同的速率對查詢取樣，或使用不同的資料表名稱，請選擇性地變更 **QueryLogSampling** 或 **QueryLogTableName** 。  
 ...
 ![Management Studio 中的查詢記錄設定](../media/ssas-querylogsettings.png "Management Studio 中的查詢記錄設定")  
...
##  <a name="mini-dump-mdmp-files"></a><a name="bkmk_mdmp"></a>迷你傾印（. .mdmp）檔案  
...
##  <a name="tips-and-best-practices"></a><a name="bkmk_tips"></a>秘訣和最佳作法  
 本節是整篇文章所述秘訣的回顧。  
...
## <a name="see-also"></a>另請參閱  
 [Analysis Services 實例管理](analysis-services-instance-management.md)   
