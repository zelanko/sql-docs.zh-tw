...
## <a name="see-also"></a>另請參閱  
 ...
 [SQL Server 服務帳戶和個別服務 SID （Blog）](http://www.travisgan.com/2013/06/sql-server-service-account-and-per.html)   
 [SQL Server 使用服務 SID 來提供服務隔離（知識庫文章）](https://support.microsoft.com/kb/2620201)   
