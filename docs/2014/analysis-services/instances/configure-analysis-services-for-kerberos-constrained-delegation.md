...
##  <a name="allow-analysis-services-to-impersonate-a-user-identity"></a><a name="bkmk_impersonate"></a>允許 Analysis Services 模擬使用者身分識別  
...
##  <a name="configure-analysis-services-for-trusted-delegation"></a><a name="bkmk_delegate"></a>設定受信任委派的 Analysis Services  
...
##  <a name="test-for-impersonated-or-delegated-identity"></a><a name="bkmk_test"></a>測試模擬或委派的身分識別  
