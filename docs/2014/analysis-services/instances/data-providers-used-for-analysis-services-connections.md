...
# <a name="data-providers-used-for-analysis-services-connections"></a>用於 Analysis Services 連接的資料提供者
 ...
 [如何判斷 Analysis Services 資料提供者的版本](#bkmk_LibUpdate)  
  
 [取得較新版本資料提供者的位置](#bkmk_downloadsite)  
...
##  <a name="bkmk_LibUpdate"></a>如何判斷 Analysis Services 資料提供者的版本  
...
##  <a name="bkmk_downloadsite"></a>取得較新版本資料提供者的位置  
