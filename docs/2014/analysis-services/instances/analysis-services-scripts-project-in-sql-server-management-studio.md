...
4.  以滑鼠右鍵按一下專案，指向 [加入]****，然後選取 [現有項目]****，在方案總管中於 Analysis Server 指令碼專案的 [其他]**** 資料夾裡加入任何其他檔案，例如包含專案附註的文字檔。 
  [!INCLUDE[ssManStudioFull](../../includes/ssmanstudiofull-md.md)]會忽略這些檔案。  
