 ...
 **注意：** 本主題描述如何安裝[!INCLUDE[ssGemini](../../../includes/ssgemini-md.md)]方案檔和[!INCLUDE[ssGemini](../../../includes/ssgemini-md.md)]for SharePoint 2013 組態工具。 安裝之後，請參閱下列主題以取得資訊的組態工具和其他功能，[設定 PowerPivot 及部署解決方案&#40;SharePoint 2013&#41;](../../../analysis-services/instances/install-windows/configure-power-pivot-and-deploy-solutions-sharepoint-2013.md)。  
 ...
 **組態工具：** 只有其中一個 SharePoint 伺服器上需要 PowerPivot for SharePoint 2013 組態工具。 不過在多伺服器的伺服器陣列中，建議的最佳作法是在至少兩個伺服器上安裝組態工具，如此一來，即使其中一個伺服器已離線，您也可以存取組態工具。  
...
-   **權限：** 若要安裝[!INCLUDE[ssGeminiShortvnext](../../../includes/ssgeminishortvnext-md.md)]，目前的使用者必須是系統管理員之電腦以及 SharePoint 伺服器陣列管理員群組。  
