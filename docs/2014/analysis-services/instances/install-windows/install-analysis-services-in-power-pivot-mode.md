...
-   **中介層:** SharePoint 中 PowerPivot 體驗的增強功能, 包括 PowerPivot 圖庫、排程資料重新整理、管理儀表板和資料提供者。 如需有關安裝及設定中介層的詳細資訊，請參閱以下主題：  
    ...
    -   [設定 PowerPivot 及部署方案&#40;SharePoint 2013&#41;](https://docs.microsoft.com/analysis-services/instances/install-windows/configure-power-pivot-and-deploy-solutions-sharepoint-2013)  
...
2.  在 [物件總管] 中，以滑鼠右鍵按一下執行個體名稱，然後按一下 **[屬性]** 。  
     ...
     ![查看 SSAS 伺服器的屬性](../../../sql-server/install/media/as-ssms-proeprties.gif "查看 SSAS 伺服器的屬性")  
...
##  <a name="bkmk_verify"></a> 步驟 3：驗證整合  
 ...
 **Web 前端 (WFE)** 或仲介**層:** :若要在[!INCLUDE[ssASnoversion](../../../includes/ssasnoversion-md.md)]較大的 sharepoint 伺服器陣列中使用 sharepoint 模式的伺服器, 並將其他 PowerPivot 功能安裝到伺服器陣列中, 請在每部 sharepoint 伺服器上執行安裝程式套件**sppowerpivot.msi。** spPowerPivot.msi 會安裝必要的資料提供者以及 PowerPivot for SharePoint 2013 組態工具。  
 ...
 **冗余和伺服器負載:** 在 SharePoint 模式下安裝第[!INCLUDE[ssASnoversion](../../../includes/ssasnoversion-md.md)]二部或多部伺服器將會提供[!INCLUDE[ssASnoversion](../../../includes/ssasnoversion-md.md)]伺服器功能的冗余。 其他伺服器也會分散伺服器的負載。 如需詳細資訊，請參閱下列內容：  
