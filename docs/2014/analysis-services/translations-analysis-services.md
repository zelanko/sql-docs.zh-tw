...
> [!TIP]  
>  您可以使用用戶端應用程式 (例如 Excel、Management Studio 以及 [!INCLUDE[ssSqlProfiler](../includes/sssqlprofiler-md.md)] ) 來傳回翻譯的字串。 如需詳細資訊，請參閱＜ [Globalization Tips and Best Practices &#40;Analysis Services&#41;](globalization-tips-and-best-practices-analysis-services.md) ＞。  
