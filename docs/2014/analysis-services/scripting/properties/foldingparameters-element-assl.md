...
## <a name="remarks"></a>備註  
 ...
 如需有關如何使用中的交叉驗證資訊[!INCLUDE[ssBIDevStudioFull](../../../includes/ssbidevstudiofull-md.md)]，請參閱[交叉驗證報表中的量值](../../data-mining/measures-in-the-cross-validation-report.md)。  
