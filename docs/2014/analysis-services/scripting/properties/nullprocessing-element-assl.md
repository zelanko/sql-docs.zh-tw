...
|*ZeroOrBlank*|將 Null 值轉換成零 (針對數值資料項目) 或空白字串 (針對字串資料項目)。 **注意：** 這個值會提供與舊版的相容性[!INCLUDE[msCoName](../../../includes/msconame-md.md)] [!INCLUDE[ssNoVersion](../../../includes/ssnoversion-md.md)] [!INCLUDE[ssASnoversion](../../../includes/ssasnoversion-md.md)]。|  
