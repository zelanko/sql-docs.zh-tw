---
title: ManyToManyMeasureGroupDimension 資料類型 (ASSL) |Microsoft Docs
ms.custom: ''
ms.date: 06/13/2017
...
|------------------|-------------|  
|父元素|無|  
|子元素|[DefaultMember](../objects/member-element-assl.md)， [MeasureGroupID](../properties/id-element-assl.md)|  
|衍生的元素|無|  
  
## <a name="remarks"></a>備註  
 在 「 分析管理物件 (AMO) 物件模型的對應元素是<xref:Microsoft.AnalysisServices.ManyToManyMeasureGroupDimension>。  
