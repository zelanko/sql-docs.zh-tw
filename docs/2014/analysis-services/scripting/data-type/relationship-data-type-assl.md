...
|------------------|-------------|  
|父元素|無|  
|子元素|[識別碼](../properties/id-element-assl.md)，[可見](../properties/visible-element-assl.md)， [FromRelationshipEnd](relationshipend-data-type-assl.md)， [ToRelationshipEnd](relationshipend-data-type-assl.md)|  
|衍生的元素||  
