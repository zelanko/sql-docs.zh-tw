---
title: InheritedBinding 資料類型 (ASSL) |Microsoft Docs
ms.custom: ''
ms.date: 06/13/2017
...
ms.locfileid: "48168038"
---
# <a name="inheritedbinding-data-type-assl"></a>InheritedBinding 資料類型 (ASSL)
  定義衍生的資料類型，表示[MeasureGroupAttribute](measuregroupattribute-data-type-assl.md)元素會從屬性繼承其繫結。  
...
## <a name="remarks"></a>備註  
 ...
 在 「 分析管理物件 (AMO) 物件模型的對應元素是<xref:Microsoft.AnalysisServices.InheritedBinding>。  
