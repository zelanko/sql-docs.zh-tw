...
# <a name="creating-a-data-mining-model"></a>建立資料採礦模型
 ...
 雖然這項功能是資料採礦工具所提供的功能一樣強大的每個位元[!INCLUDE[ssNoVersion](../includes/ssnoversion-md.md)][!INCLUDE[ssASnoversion](../includes/ssasnoversion-md.md)]和[!INCLUDE[ssBIDevStudioFull](../includes/ssbidevstudiofull-md.md)]、 精靈和熟悉的 Excel 介面的組合可讓您輕鬆地建立、 修改及使用資料採礦。  
  
## <a name="advanced-data-mining"></a>進階 (資料採礦)  
 進階的精靈可讓您建立新的資料採礦模型，根據儲存在 Excel 中，使用其中一種資料採礦演算法在資料[!INCLUDE[ssNoVersion](../includes/ssnoversion-md.md)] [!INCLUDE[ssASnoversion](../includes/ssasnoversion-md.md)]。  
...
### <a name="add-model-to-structure"></a>將模型加入結構  
 ...
 [將模型加入結構&#40;資料採礦 excel 增益集&#41;](add-model-to-structure-data-mining-add-ins-for-excel.md)  
