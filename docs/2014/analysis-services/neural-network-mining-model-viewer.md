...
|值|描述|  
|-----------|-----------------|  
|**屬性**|從清單選擇輸入屬性。 如果您將選取專案保留為預設值， **\<All>** 則圖表會顯示所有輸入屬性的清單，並依其對可預測屬性的影響進行排序。|  
|**ReplTest1**|選擇輸入屬性的值。|  
...
|**照顧\<Value 1>**|顯示長條，該圖表示此特定屬性/值組合對 [值 1]**** 中選擇的目標結果有多大影響。|  
|**照顧\<Value 2>**|顯示長條，該圖表示此特定屬性/值組合對 [值 2]**** 中選擇的目標結果有多大影響。|  
