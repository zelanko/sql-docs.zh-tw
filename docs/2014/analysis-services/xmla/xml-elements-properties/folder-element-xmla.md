...
ms.locfileid: "36035067"
---
# <a name="folder-element-xmla"></a>Folder 元素 (XMLA)
  包含更新的檔案系統儲存位置[位置](location-element-xmla.md)項目期間[還原](../xml-elements-commands/restore-element-xmla.md)或[Synchronize](../xml-elements-commands/synchronize-element-xmla.md)命令。  
