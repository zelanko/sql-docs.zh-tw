...
ms.locfileid: "36033957"
---
# <a name="tablenotifications-element-xmla"></a>TableNotifications 元素 (XMLA)
  包含集合[TableNotification](tablenotification-element-xmla.md)元素所使用[NotifyTableChange](../xml-elements-commands/notifytablechange-element-xmla.md)命令。  
