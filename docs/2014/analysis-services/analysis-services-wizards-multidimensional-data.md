---
title: Analysis Services 的嚮導（多維度資料） |Microsoft Docs
ms.custom: ''
ms.date: 06/14/2017
...
ms.locfileid: "66062393"
---
# <a name="analysis-services-wizards-multidimensional-data"></a>Analysis Services 精靈 (多維度資料)
  [!INCLUDE[msCoName](../includes/msconame-md.md)]提供可在[!INCLUDE[ssBIDevStudioFull](../includes/ssbidevstudiofull-md.md)]和中[!INCLUDE[ssManStudioFull](../includes/ssmanstudiofull-md.md)]使用的嚮導。 [!INCLUDE[ssNoVersion](../includes/ssnoversion-md.md)] [!INCLUDE[ssASnoversion](../includes/ssasnoversion-md.md)] 下表描述可用的精靈。  
