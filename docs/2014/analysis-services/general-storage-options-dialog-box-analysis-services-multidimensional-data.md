...
|**延遲**|指定在開始建立新 MOLAP 快取與移除現有 MOLAP 快取之間的期間之間隔及時間單位。<br /><br /> 注意:此選項會停用，除非**卸除過期的快取**已選取。 另外請注意，應該不會設定此選項，如果**儲存模式**設為**HOLAP**。|  
|**定期更新快取**|不論是否接收到通知，都會定期更新 MOLAP 影像。<br /><br /> 注意:此選項會停用，除非**啟用主動式快取**已選取。 另外請注意，應該不會設定此選項，如果**儲存模式**設為**HOLAP**。|  
|**重建間隔**|選取間隔及時間單位，在建立了新的 MOLAP 影像之後，經過該時期 [!INCLUDE[msCoName](../includes/msconame-md.md)] [!INCLUDE[ssNoVersion](../includes/ssnoversion-md.md)] [!INCLUDE[ssASnoversion](../includes/ssasnoversion-md.md)] 就會再次針對物件啟動 MOLAP 影像處理 (不論是否接收到通知)。 在到達此間隔後收到的通知，不會取消此間隔所觸發的 MOLAP 影像處理。<br /><br /> 注意:此選項會停用，除非**定期更新快取**已選取。 另外請注意，應該不會設定此選項，如果**儲存模式**設為**HOLAP**。|  
|**立即線上工作**|使物件立即到線上工作。 如果設定了此選項，在重建 MOLAP 快取的期間，物件就會使用基礎 ROLAP 儲存體來解析查詢。 如果未設定此選項，只有在完成了物件的 MOLAP 快取之後，才會使物件上線。|  
|**啟用 ROLAP 彙總**|在基礎資料來源上使用具體化檢視來儲存彙總。<br /><br /> 注意:如果基礎資料來源不支援具體化的檢視，當處理物件時，會發生錯誤。|  
