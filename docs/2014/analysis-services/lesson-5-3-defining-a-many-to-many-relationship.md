...
10. 在 [資料表]**** 窗格中，以滑鼠右鍵按一下 [InternetSalesReason (dbo.FactInternetSalesReason)]****，然後按一下 [瀏覽資料]****。
     ...
     ![識別購買之銷售原因的索引鍵值](../../2014/tutorials/media/l5-many-to-many-1.gif "識別購買之銷售原因的索引鍵值")
...
6.  在 [屬性] 視窗中，將 [網際網路銷售原因計數]**** 量值的 [可見]**** 屬性變更為 **False**。
     ...
     ![網際網路銷售原因計數量值的屬性](../../2014/tutorials/media/l5-many-to-many-2.gif "網際網路銷售原因計數量值的屬性")
