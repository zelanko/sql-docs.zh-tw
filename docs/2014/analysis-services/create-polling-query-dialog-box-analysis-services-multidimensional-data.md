...
|值|描述|  
|-----------|-----------------|  
|**切換到一般查詢產生器**|選取即可只顯示一般查詢產生器檢視可用的選項。 僅會顯示下列選項：<br /><br /> **SQL 窗格**<br /><br /> **結果窗格**<br /><br /> **工具列**，只包含**切換至 VDT 查詢**產生器並**執行**<br /><br /> <br /><br /> 注意：唯有選取 [切換到 VDT 查詢產生器] **** 才會顯示此選項。|  
|**[切換到 VDT 查詢產生器]**|選取即可顯示 Visual Database Tools (VDT) 查詢產生器檢視可用的所有選項。<br /><br /> 注意：唯有選取 [切換到一般查詢產生器] **** 才會顯示此選項。|  
|**顯示/隱藏圖表窗格**|顯示或隱藏 [**圖表] 窗格**。<br /><br /> 注意：唯有選取 [切換到 VDT 查詢產生器] **** 才會顯示此選項。|  
...
|**執行**|執行查詢。 結果會顯示在 [**結果] 窗格**中。|  
|**確認 SQL**|驗證查詢中的 SQL 陳述式。<br /><br /> 注意：唯有選取 [切換到 VDT 查詢產生器] **** 才會顯示此選項。|  
|**昇冪**|以遞增順序排序 [**方格窗格]** 中所選取資料行的輸出資料列。<br /><br /> 注意：唯有選取 [切換到 VDT 查詢產生器] **** 才會顯示此選項。|  
|**遞減排序**|以遞減順序排序 [**方格窗格]** 中所選取資料行的輸出資料列。<br /><br /> 注意：唯有選取 [切換到 VDT 查詢產生器] **** 才會顯示此選項。|  
 ...
 **圖表窗格**  
 ...
 以滑鼠右鍵按一下 [**圖表] 窗格**，即可加入或移除資料表、選取所有資料表，以及顯示或隱藏窗格。  
