---
title: 指定的資料行&#39;內容和資料類型 （資料採礦精靈） |Microsoft Docs
ms.custom: ''
ms.date: 06/13/2017
...
## <a name="options"></a>選項。  
 **資料行**  
 精靈之 [指定培訓資料] 頁面中定義的資料行清單。  
  
 **內容類型**  
 指派給每個資料行的內容類型。 按一下資料格內部，即可變更內容類型。 如需內容類型的詳細資訊，請參閱[內容類型 &#40;資料採礦&#41;](data-mining/content-types-data-mining.md)。  
