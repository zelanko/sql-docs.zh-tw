...
4.  專案名稱的變更為`Analysis Services Tutorial`，如此也會變更**方案名稱**方塊，然後再按一下**確定**。  
  
 您已成功建立`Analysis Services Tutorial`為基礎的專案**Analysis Services 多維度和資料採礦專案**範本，在新的方案也名為`Analysis Services Tutorial`。  
