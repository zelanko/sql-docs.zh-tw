---
title: 分析 Excel (SSAS 表格式) 中的表格式模型 |Microsoft Docs
ms.custom: ''
ms.date: 06/13/2017
...
3.  若要使用檢視方塊，請在 **[檢視方塊]** 清單方塊中選取檢視方塊。  
     ...
     您必須使用 [檢視方塊] 對話方塊定義檢視方塊 (非預設值)。 如需詳細資訊，請參閱[建立及管理檢視方塊 &#40;SSAS 表格式&#41;](perspectives-ssas-tabular.md)。  
