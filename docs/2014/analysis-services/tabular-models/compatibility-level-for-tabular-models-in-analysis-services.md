...
### <a name="check-compatibility-level-for-a-tabular-model-database-in-ssms"></a>在 SSMS 中檢查表格式模型資料庫的相容性層級  
 您可以在 [資料庫屬性] 中查看 [**相容性層級**] 屬性（的新功能），以檢查 SSMS 中表格式模型資料庫的相容性層級 [!INCLUDE[ssSQL11SP1](../../includes/sssql11sp1-md.md)] 。 **Database Properties**  
...
### <a name="check-supported-compatibility-level-for-an-analysis-services-instance-in-ssms"></a>在 SSMS 中檢查 Analysis Services 執行個體支援的相容性層級  
 您可以在 Analysis Services 內容] 中的 [**資訊**] 頁面上，查看**支援的相容**性層級屬性，以檢查 SSMS 中支援的相容性層級（中的新功能 [!INCLUDE[ssSQL11SP1](../../includes/sssql11sp1-md.md)] ）。 **Analysis Services Properties** 支援的相容性層級 1103 表示已安裝 SQL Server SP1 或更新版本。 支援的相容性層級無法變更。  
