---
title: 處理工作空間資料庫 (SSAS 表格式) 中的資料分割 |Microsoft Docs
ms.custom: ''
ms.date: 06/13/2017
...
ms.locfileid: "54405888"
---
# <a name="process-partitions-in-the-workspace-database-ssas-tabular"></a>處理資料分割，在工作空間資料庫 (SSAS 表格式)
