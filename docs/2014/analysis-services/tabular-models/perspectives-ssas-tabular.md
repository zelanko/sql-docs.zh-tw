---
title: 透視圖（SSAS 表格式） |Microsoft Docs
ms.custom: ''
ms.date: 06/13/2017
...
|主題|描述|  
|-----------|-----------------|  
|[建立和管理 &#40;SSAS 表格式&#41;的觀點](perspectives-ssas-tabular.md)|描述如何使用模型設計師中的 [檢視方塊] 對話方塊，以建立及管理檢視方塊。|  
