---
title: Analysis Services&#39;和商業智慧的新功能 |Microsoft Docs
ms.custom: ''
ms.date: 06/07/2019
...
## <a name="features-recently-added-power-view-for-multidimensional-models"></a>最近新增的功能:多維度模型的 Power View  
