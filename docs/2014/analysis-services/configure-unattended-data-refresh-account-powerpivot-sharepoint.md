 ...
 **[!INCLUDE[applies](../includes/applies-md.md)]**  SharePoint 2010  
 ...
 [步驟 5： 確認帳戶可用性，在資料重新整理組態頁面](#bkmk_verify)  
...
###  <a name="bkmk_verify"></a> 步驟 5： 確認帳戶可用性，在資料重新整理組態頁面  
...
8.  按一下 [確定] 。  
 ...
 若同時變更了密碼與使用者名稱，您很可能需要執行其他的組態步驟 (例如授與外部資料來源的讀取權限及 SharePoint 權限)，才可更新 PowerPivot 活頁簿。 如需相關指示，請移至 PowerPivot 無人看管的資料重新整理帳戶組態中的此步驟：[步驟 3： 授與參與權限給帳戶](#bkmk_grant)，然後繼續進行其餘步驟，最後驗證，帳戶已正確設定。  
