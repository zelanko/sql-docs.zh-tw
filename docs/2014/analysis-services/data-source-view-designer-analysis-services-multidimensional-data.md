...
## <a name="see-also"></a>另請參閱
 多[維度模型中的資料來源視圖](multidimensional-models/data-source-views-in-multidimensional-models.md)[加入或移除資料來源視圖中的資料表或視圖 &#40;Analysis Services&#41;](multidimensional-models/adding-or-removing-tables-or-views-in-a-data-source-view-analysis-services.md)
