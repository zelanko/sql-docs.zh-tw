...
|**基於使用方式的最佳化**|按一下即可顯示 [基於使用方式的最佳化精靈]，並根據現有的使用模式，為選取的資料分割建立彙總設計。<br /><br /> 注意：唯有在 [量值群組] 窗格中量值群組的 [資料分割] 方格中選取資料分割的任何資料格，才會啟用此選項。<br /><br /> 也請注意，是否已選取回寫分割區，會停用此選項。|  
|**儲存體設定**|按一下即可顯示 [儲存設定] 對話方塊，並為選取的資料分割指定儲存模式、主動式快取和通知設定。<br /><br /> 注意：唯有在 [量值群組] 窗格中量值群組的 [資料分割] 方格中選取資料分割的任何資料格，才會啟用此選項。|  
