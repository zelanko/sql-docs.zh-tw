...
|**地**|如果 **[計算]** 索引標籤的工作階段因為連接遺失或逾時而中斷連接，按一下即可將 [!INCLUDE[ssASnoversion](../includes/ssasnoversion-md.md)] [計算] **索引標籤重新連接到** 執行個體和包含 Cube 的資料庫。|  
...
|**字體**|按一下即可顯示 [字型]**** 對話方塊，並在 Cube 指令碼中的選取點插入與字型相關之資料格屬性值的有效集合。 此選項只會在指令碼檢視中啟用。|  
