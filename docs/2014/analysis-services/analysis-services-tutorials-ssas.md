...
# <a name="analysis-services-tutorials-ssas"></a>Analysis Services 教學課程 (SSAS)
 ...
 [表格式模型化 &#40;的艾德作品教學課程&#41;](tabular-modeling-adventure-works-tutorial.md)  
 ...
 [Codeplex 上的 AdventureWorks 範例資料庫](https://go.microsoft.com/fwlink/?linkID=335807)  
 這個連結將帶您到 codeplex 下載頁面，其中包含適用 [!INCLUDE[ssSQL14](../includes/sssql14-md.md)] 的 AdventureWorks 範例資料庫。  
  
 [以程式設計方式建立表格式模型的 AMO 程式碼範例](https://go.microsoft.com/fwlink/?linkID=221036)  
