...
|選項|定義|  
|------------|----------------|  
|**繫結類型**|選取用於指定之資料分割來源的繫結類型。 下列是可以使用的選項：<br /><br /> **資料表繫結**： 選取即可顯示**資料表繫結詳細資料**窗格並指出資料分割繫結至資料來源或資料來源檢視中資料表的內容。 如需 [Table Binding Detail (資料表繫結詳細資料)] 窗格的詳細資訊，請參閱 [資料表繫結詳細資料 &#40;資料分割來源對話方塊&#41; &#40;Analysis Services - 多維度資料&#41;](table-binding-partition-source-dialog-analysis-services-multidimensional-data.md)。<br /><br /> **詳細資料**： 選取即可顯示**查詢繫結的詳細資料**窗格並指出資料分割繫結至資料來源上執行之查詢的內容。 如需 [Query Binding Detail (查詢繫結詳細資料)] 窗格的詳細資訊，請參閱 [查詢繫結詳細資料 &#40;資料分割來源對話方塊&#41; &#40;Analysis Services - 多維度資料&#41;](query-binding-partition-source-dialog-analysis-services-multidimensional-data.md)。|  
