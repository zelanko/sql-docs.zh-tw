...
|**評估**|從比率量值群組中選取量值，此群組包含 [內建量值類型]**** 中所選取量值在轉換時使用的匯率。|  
...
|**評估**|從比率量值群組中選取量值，此群組包含 **[帳戶成員]** 中所選取成員之量值在轉換時使用的匯率。|  
...
|**評估**|從比率量值群組中選取量值，此群組包含使用 **[帳戶類型]** 中所選取帳戶類型之屬性成員的量值在轉換時使用的匯率。|  
