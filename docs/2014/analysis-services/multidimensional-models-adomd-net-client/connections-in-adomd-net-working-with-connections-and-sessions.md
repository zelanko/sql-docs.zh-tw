...
ms.locfileid: "36132310"
---
# <a name="working-with-connections-and-sessions-in-adomdnet"></a>使用連接和 ADOMD.NET 中的工作階段
  在 XML for Analysis (XMLA) 中，工作階段可支援分析資料存取期間可設定狀態的作業。 工作階段會為分析資料來源界定命令與交易的範圍和內容。 用來管理工作階段的 XMLA 元素[BeginSession](../xmla/xml-elements-headers/beginsession-element-xmla.md)，[工作階段](../xmla/xml-elements-headers/session-element-xmla.md)，和[EndSession](../xmla/xml-elements-headers/endsession-element-xmla.md)。  
