...
##  <a name="creating-data-mining-projects"></a><a name="bkmk_Overview"></a> 建立資料採礦專案  
...
##  <a name="objects-in-data-mining-projects"></a><a name="bkmk_Objects"></a> 資料採礦專案中的物件  
...
###  <a name="data-sources"></a><a name="bkmk_DataSources"></a>資料來源  
...
###  <a name="mining-structures"></a><a name="bkmk_Structures"></a>採礦結構  
...
###  <a name="mining-models"></a><a name="bkmk_Models"></a>採礦模型  
...
##  <a name="using-the-completed-data-mining-project"></a><a name="bkmk_Complete"></a> 使用完成的資料採礦專案  
...
###  <a name="view-and-explore-models"></a><a name="bkmk_ViewExplore"></a>查看和探索模型  
...
###  <a name="create-predictions"></a><a name="bkmk_Predict"></a>建立預測  
...
##  <a name="programmatic-access-to-data-mining-objects"></a><a name="bkmk_API"></a> 以程式設計方式存取資料採礦物件  
...
|了解如何建立增益圖、收益圖或分類矩陣，或是測試採礦結構|[測試及驗證 &#40;資料採礦&#41;](testing-and-validation-data-mining.md)|  
