...
-   結構的鑽研權限可以使用 [StructureColumn &#40;DMX&#41;](/sql/dmx/structurecolumn-dmx) 函數，提供將結構資料行從模型加入到鑽研查詢的額外功能。 您也可以查詢的定型和測試案例，在結構中，方法是使用 SELECT...從\<結構 >。案例的語法。  
