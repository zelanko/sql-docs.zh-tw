...
##  <a name="queries-on-the-relational-store-during-processing"></a><a name="bkmk_QueryReqs"></a> 在處理期間查詢關聯式存放區  
...
##  <a name="processing-mining-models"></a><a name="bkmk_ProcessModels"></a> 處理採礦模型  
