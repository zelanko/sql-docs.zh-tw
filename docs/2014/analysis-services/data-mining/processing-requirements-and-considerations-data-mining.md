---
title: 處理需求和考慮（資料採礦） |Microsoft Docs
ms.custom: ''
ms.date: 06/13/2017
 ...
 **專案部署**：視專案設定和專案的目前狀態而定，專案中的採礦模型通常會在部署專案時完整處理。  
 ...
 **移動採礦模型**：當您使用 [匯出] 命令移動採礦模型時，只會匯出模型的定義，其中包括預期要提供資料給模型的採礦結構名稱。  
