 ...
 **內容查詢**  
 ...
 [正在從資料採礦架構資料列集抓取模型參數](#bkmk_Query1)  
  
 [使用 DMX 取得模型中樹狀結構的詳細資料](#bkmk_Query2)  
  
 [正在從模型中抓取子樹](#bkmk_Query3)  
  
 **預測查詢**  
  
 [傳回具有機率的預測](#bkmk_Query4)  
  
 [從決策樹模型預測關聯](#bkmk_Query5)  
  
 [從決策樹模型中抓取回歸公式](#bkmk_Query6)  
  
##  <a name="bkmk_top2"></a>尋找決策樹模型的相關資訊  
...
###  <a name="bkmk_Query1"></a>範例查詢1：從資料採礦架構資料列集取出模型參數  
...
###  <a name="bkmk_Query2"></a>範例查詢2：使用 DMX 傳回有關模型內容的詳細資料  
...
###  <a name="bkmk_Query3"></a>範例查詢3：從模型中抓取子樹  
...
###  <a name="bkmk_Query4"></a>範例查詢4：傳回具有機率的預測  
...
###  <a name="bkmk_Query5"></a>範例查詢5：從決策樹模型預測關聯  
...
###  <a name="bkmk_Query6"></a>範例查詢6：從決策樹模型中取出回歸公式  
