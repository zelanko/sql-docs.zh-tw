...
##  <a name="mining-model-architecture"></a><a name="bkmk_mdlArch"></a> 採礦模型架構
...
##  <a name="defining-data-mining-models"></a><a name="bkmk_mdlDefine"></a>定義資料採礦模型
 您可以使用下列一般步驟建立資料採礦模型：
...
##  <a name="processing-mining-models"></a><a name="bkmk_mdlProcess"></a> 處理採礦模型
...
##  <a name="viewing-and-querying-mining-models"></a><a name="bkmk_mdlView"></a> 檢視和查詢採礦模型
