---
title: 安全性總覽（資料採礦） |Microsoft Docs
ms.custom: ''
ms.date: 06/13/2017
...
##  <a name="configuring-the-logon-account-for-analysis-services"></a><a name="bkmk_Logon"></a> 設定 Analysis Services 的登入帳戶  
...
##  <a name="securing-an-analysis-services-instance"></a><a name="bkmk_Instance"></a> 保護 Analysis Services 執行個體的安全  
...
##  <a name="configuring-access-to-analysis-services"></a><a name="bkmk_Access"></a> 設定 Analysis Services 的存取權  
...
##  <a name="special-considerations-for-data-mining"></a><a name="bkmk_DMspecial"></a> 資料採礦的特殊考量  
