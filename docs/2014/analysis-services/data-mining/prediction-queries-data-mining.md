...
##  <a name="basic-prediction-query-design"></a><a name="bkmk_PredQuery"></a> 基本預測查詢設計  
...
###  <a name="adding-prediction-functions"></a><a name="bkmk_PredFunc"></a>加入預測函數  
...
###  <a name="creating-singleton-prediction-queries"></a><a name="bkmk_SingletonQuery"></a>建立單一預測查詢  
...
###  <a name="batch-prediction-queries"></a><a name="bkmk_BatchQuery"></a> 批次預測查詢  
...
###  <a name="predictions-in-time-series-mining-models"></a><a name="bkmk_TSQuery"></a> 時間序列採礦模型中的預測  
...
##  <a name="working-with-the-results-of-a-prediction-query"></a><a name="bkmk_WorkResults"></a> 使用預測查詢的結果  
