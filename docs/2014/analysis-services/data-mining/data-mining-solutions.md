...
# <a name="data-mining-solutions"></a>資料採礦方案
 ...
 [部署資料採礦解決方案](#bkmk_Deploy)  
  
 [解決方案逐步解說](#bkmk_Walkthru)  
...
##  <a name="bkmk_Deploy"></a>部署資料採礦解決方案  
...
##  <a name="bkmk_Walkthru"></a>解決方案逐步解說  
...
|工作|主題|  
|-----------|------------|  
|測試您建立的模型、驗證定型資料的品質，然後建立代表資料採礦模型精確度的圖表。|[測試和驗證 &#40;資料採礦&#41;](testing-and-validation-data-mining.md)|  
...
|將篩選套用到定型模式時所使用的資料來自訂採礦模型。|[將採礦模型新增至結構 &#40;Analysis Services 資料採礦&#41;](add-mining-models-to-a-structure-analysis-services-data-mining.md)|  
