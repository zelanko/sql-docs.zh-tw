...
##  <a name="requirements-for-olap-mining-structure-and-models"></a><a name="bkmk_Reqs"></a>OLAP 採礦結構和模型的需求  
...
##  <a name="overview-of-olap-data-mining-process"></a><a name="bkmk_Overview"></a>OLAP 資料採礦進程總覽  
...
##  <a name="slicing-a-cube-vs-filtering-models"></a><a name="bkmk_Filters"></a>配量 Cube 與篩選模型的比較  
...
##  <a name="using-nested-tables-in-an-olap-mining-model"></a><a name="bkmk_Nested"></a>在 OLAP 採礦模型中使用嵌套資料表  
...
##  <a name="understanding-data-mining-dimensions-and-drillthrough"></a><a name="bkmk_DMDimension"></a>瞭解資料採礦維度和鑽取  
