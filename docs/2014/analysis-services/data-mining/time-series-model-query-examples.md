...
###  <a name="sample-query-1-retrieving-periodicity-hints-for-the-model"></a><a name="bkmk_Query1"></a> 範例查詢 1：擷取模型的週期性提示  
...
###  <a name="sample-query-2-retrieving-the-equation-for-an-arima-model"></a><a name="bkmk_Query2"></a> 範例查詢 2：擷取 ARIMA 模型的方程式  
...
###  <a name="sample-query-3-retrieving-the-equation-for-an-artxp-model"></a><a name="bkmk_Query3"></a> 範例查詢 3：擷取 ARTXP 模型的方程式  
...
###  <a name="understanding-the-behavior-of-replace-and-extend-operations"></a><a name="bkmk_ReplaceExtend"></a> 了解取代和擴充作業的行為  
...
###  <a name="making-predictions-with-replace_model_cases"></a><a name="bkmk_REPLACE"></a> 使用 REPLACE_MODEL_CASES 做出預測  
...
|[PredictTimeSeries &#40;DMX&#41;](/sql/dmx/predicttimeseries-dmx)|傳回時間序列的預測記錄值或未來預測值。<br /><br /> 您也可以使用一般預測函數 [Predict &#40;DMX&#41;](/sql/dmx/predict-dmx) 來查詢時間序列模型。|  
