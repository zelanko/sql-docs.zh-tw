...
|[Microsoft 關聯分析演算法](microsoft-association-algorithm.md)|[Microsoft 線性迴歸演算法](microsoft-linear-regression-algorithm.md)|  
...
|SAMPLE_SIZE|[Microsoft 群集演算法技術參考](microsoft-clustering-algorithm-technical-reference.md)<br /><br /> [Microsoft 羅吉斯迴歸演算法技術參考](microsoft-logistic-regression-algorithm-technical-reference.md)<br /><br /> [Microsoft 類神經網路演算法技術參考](microsoft-neural-network-algorithm-technical-reference.md)|  
