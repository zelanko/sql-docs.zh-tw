...
##  <a name="creating-data-definition-queries"></a><a name="bkmk_Create"></a>建立資料定義查詢  
...
###  <a name="data-definition-queries-in-sql-server-data-tools"></a><a name="bkmk_ssdt"></a>SQL Server Data Tools 中的資料定義查詢  
...
###  <a name="data-definition-queries-in-sql-server-management-studio"></a><a name="bkmk_SSMS"></a>SQL Server Management Studio 中的資料定義查詢  
...
###  <a name="scripting-data-definition-statements"></a><a name="bkmk_Scripts"></a>編寫資料定義語句的腳本  
...
##  <a name="exporting-and-importing-models"></a><a name="bkmk_Export"></a>匯出和匯入模型  
