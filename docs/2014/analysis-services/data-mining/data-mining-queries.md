...
##  <a name="understanding-data-mining-queries"></a><a name="bkmk_Understand"></a>瞭解資料採礦查詢  
...
##  <a name="query-tools-and-interfaces"></a><a name="bkmk_Interfaces"></a>查詢工具和介面  
...
##  <a name="queries-for-different-model-types"></a><a name="bkmk_ModelTypes"></a> 不同模型類型的查詢  
...
##  <a name="requirements"></a><a name="bkmk_Reqs"></a> 需求  
