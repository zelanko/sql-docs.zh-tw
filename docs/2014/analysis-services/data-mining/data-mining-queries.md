...
##  <a name="bkmk_Understand"></a>瞭解資料採礦查詢  
...
##  <a name="bkmk_Interfaces"></a>查詢工具和介面  
 您可以使用 SQL Server 提供的其中一種查詢工具，以互動方式建立資料採礦查詢。 
...
-   **自訂預測函數：** 每種模型類型都會提供一組預測函數，這些函式是設計來處理該演算法所建立的模式。  
    ...
    |||  
    |-|-|  
    |[關聯模型查詢範例](association-model-query-examples.md)|[Microsoft Naive Bayes Algorithm](microsoft-naive-bayes-algorithm.md)|  
...
|工作|連結|  
|-----------|-----------|  
|檢視有關資料採礦查詢的教學課程和逐步解說|[第6課：建立和使用預測 &#40;基本資料採礦教學課程&#41;](../../tutorials/lesson-6-creating-and-working-with-predictions-basic-data-mining-tutorial.md)<br /><br /> [時間序列預測 DMX 教學課程](../../tutorials/time-series-prediction-dmx-tutorial.md)|  
|使用 SQL Server Management Studio 和 [!INCLUDE[ssBIDevStudioFull](../../includes/ssbidevstudiofull-md.md)]|[在 SQL Server Management Studio 中建立 DMX 查詢](create-a-dmx-query-in-sql-server-management-studio.md)<br /><br /> [使用預測查詢產生器來建立預測查詢](create-a-prediction-query-using-the-prediction-query-builder.md)<br /><br /> [將預測函數套用至模型](apply-prediction-functions-to-a-model.md)<br /><br /> [手動編輯預測查詢](manually-edit-a-prediction-query.md)|  
...
|了解內容查詢及參閱範例的詳細資訊|[建立採礦模型內容查詢](create-a-content-query-on-a-mining-model.md)<br /><br /> [查詢用於建立採礦模型的參數](query-the-parameters-used-to-create-a-mining-model.md)<br /><br /> [&#40;資料採礦&#41;的內容查詢](content-queries-data-mining.md)|  
|設定查詢選項，以及疑難排解查詢權限和問題|[針對資料採礦查詢變更逾時值](data-mining-queries.md)|  
|在 Integration Services 中使用資料採礦元件|[資料採礦查詢工作](../../integration-services/control-flow/data-mining-query-task.md)<br /><br /> [資料採礦查詢轉換](../../integration-services/data-flow/transformations/data-mining-query-transformation.md)|  
