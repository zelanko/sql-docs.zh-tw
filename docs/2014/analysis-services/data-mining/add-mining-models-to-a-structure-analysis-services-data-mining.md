---
title: 將採礦模型加入至結構（Analysis Services 資料採礦） |Microsoft Docs
ms.custom: ''
ms.date: 06/13/2017
...
> [!NOTE]  
>  在 DMX 中，CREATE MINING MODEL 陳述式會從採礦模型開始。 也就是說，您定義所要的採礦模型，然後 [!INCLUDE[ssASnoversion](../../includes/ssasnoversion-md.md)] 就會自動產生基礎結構。 稍後您可以使用 ALTER STRUCTURE，繼續將新的採礦模型加入該結構中 .。。ADD MODEL 語句。  
