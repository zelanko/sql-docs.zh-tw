...
##  <a name="dmx-query-templates"></a><a name="BKMK_Templates"></a>DMX 查詢範本  
...
##  <a name="build-and-run-a-dmx-query"></a><a name="BKMK_Building_Queries"></a>建立並執行 DMX 查詢  
