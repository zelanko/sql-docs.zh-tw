...
ms.locfileid: "66086045"
---
# <a name="browse-a-model-using-the-microsoft-cluster-viewer"></a>使用 Microsoft 叢集檢視器瀏覽模型
  中[!INCLUDE[msCoName](../../includes/msconame-md.md)] [!INCLUDE[msCoName](../../includes/msconame-md.md)] [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)]的叢集檢視器會顯示以[!INCLUDE[msCoName](../../includes/msconame-md.md)]群集演算法建立的挖掘[!INCLUDE[ssASnoversion](../../includes/ssasnoversion-md.md)]模型。 
  [!INCLUDE[msCoName](../../includes/msconame-md.md)] 群集演算法是用來瀏覽資料以識別資料中的異常及建立預測的一種分割演算法。 如需這個演算法的詳細資訊，請參閱 [Microsoft 群集演算法](microsoft-clustering-algorithm.md)。  
...
###  <a name="BKMK_Diagram"></a>群集圖表  
  ...
  ** 叢集檢視器的 [叢集圖表]**[!INCLUDE[msCoName](../../includes/msconame-md.md)] 索引標籤會顯示採礦模型中的所有叢集。 連接一個群集與另一個群集的線條陰影代表群集的相似程度。 如果陰影很淡或不存在，則表示群集不太相似。 當線條色彩加深時，連結的相似度就更高。 您可以調整群集右邊的滑桿，來調整檢視器要顯示的線條數目。 降低滑桿只顯示最強的連結。  
