...
## <a name="see-also"></a>另請參閱
 [資料採礦演算法 &#40;Analysis Services 資料採礦&#41;](data-mining-algorithms-analysis-services-data-mining.md) [Microsoft 線性回歸演算法技術參考](microsoft-linear-regression-algorithm-technical-reference.md)[線性回歸模型查詢範例](linear-regression-model-query-examples.md)[線性回歸模型的採礦模型內容 &#40;Analysis Services-資料採礦&#41;](mining-model-content-for-linear-regression-models-analysis-services-data-mining.md)
