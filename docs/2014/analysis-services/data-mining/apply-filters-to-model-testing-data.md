...
# <a name="apply-filters-to-model-testing-data"></a>將篩選套用至模型測試資料
 ...
 例如，在 AdventureWorks 目標郵寄案例中，您可以在 ProspectiveBuyer （也就是包含測試資料的資料表）上建立如下一個篩選條件運算式，並依收入範圍限制測試案例：  
...
10. （選擇性）按一下 [**值**] 文字方塊右邊的瀏覽按鈕 **（...）** ，以開啟 [**篩選**] 對話方塊，並針對嵌套的資料表或個別的案例資料表資料行設定條件。  
...
## <a name="see-also"></a>另請參閱  
 ...
 [使用嵌套資料表資料當做精確度圖表的輸入](using-nested-table-data-as-an-input-for-an-accuracy-chart.md)   
