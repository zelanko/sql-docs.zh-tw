---
title: 外部聯結運算子 *= 和 =* 90 或之後的相容性模式中不支援 |Microsoft 文件
ms.custom: ''
ms.date: 03/06/2017
...
## <a name="corrective-action"></a>更正動作  
 資料庫相容性模式變更為 90 或之後以前，請修改陳述式使用外部聯結運算子 * = 和 =\*使用對等的 OUTER JOIN 關鍵字。 下列範例會顯示使用 `*=` 運算子的查詢以及使用 `LEFT OUTER JOIN` 關鍵字的對等查詢。  
