...
-   將功能加入到現有的 [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] 執行個體  
 ...
 您只能新增支援的 SysPrep 功能-[!INCLUDE[ssDE](../../includes/ssde-md.md)]並[!INCLUDE[ssRSnoversion](../../includes/ssrsnoversion-md.md)]-已備妥的映像的[!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)]。 當備妥的執行個體完成之後，您就可以加入其他 SysPrep 不支援的功能。  
