...
## <a name="options"></a>選項。  
 **[!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] 執行個體名稱** - 使用下拉式清單選取要修改的 [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] 容錯移轉叢集執行個體。  
