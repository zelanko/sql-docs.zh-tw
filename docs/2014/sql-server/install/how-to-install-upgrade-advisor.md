...
1.  您可以使用下列其中一種方法來啟動安裝程序：  
    ...
    -   如果您是從網站安裝 [!INCLUDE[msCoName](../../includes/msconame-md.md)] ，請按一下 [**下載**] 連結，然後按一下 [**執行**] 按鈕以開始安裝。  
...
2.  在 [**歡迎使用 [!INCLUDE[ssCurrent](../../includes/sscurrent-md.md)] Upgrade Advisor 安裝程式**] 頁面上，按 **[下一步]**。  
