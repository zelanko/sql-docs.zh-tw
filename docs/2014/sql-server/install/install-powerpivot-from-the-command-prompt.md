...
3.  以有效的使用者帳戶和密碼取代 \<domain \ username > 和 @no__t 1StrongPassword > 的預留位置。  
  
     @No__t-0 和 **/assvcpassword**參數是用來設定應用程式伺服器上的 [!INCLUDE[ssGeminiSrv](../../includes/ssgeminisrv-md.md)] 實例。 請以有效的帳戶資訊取代這些預留位置。  
