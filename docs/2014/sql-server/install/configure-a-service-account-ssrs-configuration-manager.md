...
2.  在 [服務帳戶] 頁面上，選取可描述您想要使用之帳戶類型的選項。 如需有關哪一個帳戶類型，若要指定，請參閱建議[設定報表伺服器服務帳戶&#40;SSRS 組態管理員&#41;](../../reporting-services/install-windows/configure-the-report-server-service-account-ssrs-configuration-manager.md)。  
