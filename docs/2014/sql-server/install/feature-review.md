...
|元件群組|元件和功能|  
|---------------------|-----------------------------|  
|[!INCLUDE[ssDE](../../includes/ssde-md.md)] 服務|[!INCLUDE[ssDE](../../includes/ssde-md.md)] 是用來儲存、處理和保護資料安全的核心服務。 [!INCLUDE[ssDEnoversion](../../includes/ssdenoversion-md.md)] 包含以下元件：<br /><br /> 複寫：（選擇性）複寫是一組技術可用於複製和散發資料和資料庫物件從某個資料庫到另一個後同步處理以維護一致性的資料庫之間。<br /><br /> 全文檢索搜尋：（選擇性）全文檢索搜尋提供功能，以發出全文檢索查詢中一般以字元為基礎的資料對[!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)]資料表。<br /><br /> [!INCLUDE[ssDQSnoversion](../../includes/ssdqsnoversion-md.md)] （選擇性）：[!INCLUDE[ssDQSnoversion](../../includes/ssdqsnoversion-md.md)] (DQS) 是一種資料清除方案，可讓您探索不一致和不正確的資料，在您的資料來源，並提供自動化和互動的方式，來清理資料。|  
