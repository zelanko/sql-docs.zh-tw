...
## <a name="see-also"></a>另請參閱  
 [SysPrep 安裝 SQL Server 2014 使用](../../database-engine/install-windows/install-sql-server-using-sysprep.md)  
