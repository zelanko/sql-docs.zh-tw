...
4.  在上**連線參數**頁面上，選取的執行個體[!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)]您想要掃描、 選取驗證方法，並如有必要，輸入使用者名稱和密碼資訊，然後按一下 **下一步**.  
...
7.  按一下 **執行**分析執行個體[!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)]。  
