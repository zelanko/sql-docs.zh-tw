...
# <a name="what39s-new-in-sql-server-installation"></a>SQL Server 安裝的新增功能
 ...
 從 [!INCLUDE[ssSQL14](../../includes/sssql14-md.md)] 開始，Standard 版中的資料庫引擎具有 128 GB 的記憶體容量。 在[!INCLUDE[ssSQL11](../../includes/sssql11-md.md)]中，Standard edition 中的資料庫引擎具有 64 GB 的記憶體容量。  
