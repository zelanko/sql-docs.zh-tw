...
-   Windows Installer 4.5。 您可以安裝 Windows Installer 從[Windows Installer 網站](https://go.microsoft.com/fwlink/?LinkId=49112)。  
  
-   [!INCLUDE[dnprdnshort](../../includes/dnprdnshort-md.md)] (從 .NET Framework 4 開始)。 [!INCLUDE[dnprdnshort](../../includes/dnprdnshort-md.md)]位於[!INCLUDE[ssCurrent](../../includes/sscurrent-md.md)]產品媒體，以及從[SDK、 可轉散發套件和 service pack 下載網站](https://go.microsoft.com/fwlink/?LinkId=48882)。  
...
## <a name="see-also"></a>另請參閱  
 [操作說明：安裝 Upgrade Advisor](../../../2014/sql-server/install/how-to-install-upgrade-advisor.md)  
