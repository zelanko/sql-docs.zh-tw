---
title: HOW TO：將報表匯出 |Microsoft Docs
ms.custom: ''
ms.date: 03/06/2017
...
1.  在報表檢視器中，顯示您想要匯出的報表。 如需指示，請參閱[How to:檢視 Upgrade Advisor 報表](../../../2014/sql-server/install/how-to-view-an-upgrade-advisor-report.md)。  
