 ...
 **[!INCLUDE[applies](../../includes/applies-md.md)]**  SharePoint 2010  
 ...
 若為 SharePoint 2013，提供者內含在 SQL Server 功能套件中。 如需如何下載 spPowerPivot.msi 的詳細資訊，請參閱[Microsoft SQL Server 2014 功能套件](https://www.microsoft.com/download/details.aspx?id=35577)  
  
### <a name="download-and-install-the-client-library"></a>下載和安裝用戶端文件庫  
  
1.  在  [SQL Server 2014 功能套件頁面](https://go.microsoft.com/fwlink/?LinkID=296473)，尋找 Microsoft ADOMD.NET。  
