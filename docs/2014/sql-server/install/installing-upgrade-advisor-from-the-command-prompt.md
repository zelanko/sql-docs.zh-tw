---
title: 從命令提示字元安裝 Upgrade Advisor |Microsoft 文件
ms.custom: ''
ms.date: 03/06/2017
...
|/L|指定記錄檔選項。 若要將所有訊息都記錄到*log_file_name*，使用 **-L\*v * * * log_file_name*。 若只要記錄錯誤訊息，要使用`-Le` *log_file_name*。|  
