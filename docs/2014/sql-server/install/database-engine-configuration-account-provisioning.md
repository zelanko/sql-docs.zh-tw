...
> [!IMPORTANT]  
>  [!INCLUDE[ssNoteStrongPass](../../includes/ssnotestrongpass-md.md)]絕對不要設定空白或弱式 sa 密碼。  
...
> [!NOTE]  
>  [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)]驗證僅為回溯相容性而提供。 [!INCLUDE[ssNoteWinAuthentication](../../includes/ssnotewinauthentication-md.md)]  
...
## <a name="related-content"></a>相關內容  
 ...
 如需選擇帳戶以執行 [!INCLUDE[ssDEnoversion](../../includes/ssdenoversion-md.md)] 的詳細資訊，請參閱《** 線上叢書》中的**設定 Windows 服務帳戶與權限[!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)]主題。  
