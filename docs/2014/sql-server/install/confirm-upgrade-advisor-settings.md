 ...
 **傳送報告給[!INCLUDE[msCoName](../../includes/msconame-md.md)]。這些報表可能包含個人資訊。**  
 選取此選項會將提交分析來[!INCLUDE[msCoName](../../includes/msconame-md.md)][!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)]小組。 此資訊會用於改善未來的版本。  
