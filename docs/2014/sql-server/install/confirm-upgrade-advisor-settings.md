 ...
 **將報表傳送[!INCLUDE[msCoName](../../includes/msconame-md.md)]至。這些報表可能包含個人資訊。**  
 選取此選項會將您的[!INCLUDE[msCoName](../../includes/msconame-md.md)] [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)]分析提交給小組。 此資訊會用於改善未來的版本。  
