---
title: 授權拓撲和成本範例 SQL Server 2014 自助商業智慧 |Microsoft 文件
ms.custom: ''
ms.date: 05/24/2017
...
-   SharePoint 模式中的 Reporting Services，包括資料警示。  
 ...
 如需詳細資訊，請參閱表格中的功能[與 SharePoint 安裝 SQL Server BI 功能&#40;PowerPivot 和 Reporting Services&#41;](../../../2014/sql-server/install/install-sql-server-bi-features-sharepoint-powerpivot-reporting-services.md)。  
...
|Standard|**(Yes)**|**(Yes)**|  
 ...
 如需有關範例[!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)]授權價格，請參閱：  
  
-   [虛擬環境的授權](http://www.microsoft.com/licensing/about-licensing/virtualization.aspx)(http://www.microsoft.com/licensing/about-licensing/virtualization.aspx)。  
...
-   [SQL server 2014 版本和授權](http://www.microsoft.com/licensing/about-licensing/sql2014.aspx#tab=2)  
...
##  <a name="bkmk_3tier_powerpivot"></a> 3 層分別使用不同的拓撲[!INCLUDE[ssGemini](../../includes/ssgemini-md.md)]伺服器  
...
-   在不同伺服器 (3) 上執行的 [!INCLUDE[ssGemini](../../includes/ssgemini-md.md)] for SharePoint。 [!INCLUDE[ssCurrent](../../includes/sscurrent-md.md)] [!INCLUDE[ssGemini](../../includes/ssgemini-md.md)] for SharePoint 2013 是在 SharePoint 伺服器陣列外執行，而且可以安裝在伺服器上，不包含 SharePoint 安裝，可改善效能。  
...
-   中的 analysis Services PowerPivot 模式 (2) 在伺服陣列外的執行，但 PowerPivot 執行**相同的實體上**在其他應用程式角色的伺服器。  
  
-   資料庫角色 (3) 會使用 SQL Server Enterprise，讓[!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)]功能，AlwaysOn 可用性群組。  
...
-   [關於授權： 產品授權搜尋](http://www.microsoftvolumelicensing.com/default.aspx)(http://www.microsoftvolumelicensing.com/default.aspx)。  
  
-   [大量授權： 價格與如何購買](http://www.microsoft.com/licensing/how-to-buy/how-to-buy.aspx)(http://www.microsoft.com/licensing/how-to-buy/how-to-buy.aspx)。  
...
-   [適用於 SQL Server 2014 授權變更](https://www.directionsonmicrosoft.com/sites/default/files/PDFs/Licensing_Changes_for_SQL_Server_2014.pdf)(https://www.directionsonmicrosoft.com/sites/default/files/PDFs/Licensing_Changes_for_SQL_Server_2014.pdf)。  
  
-   [估計 SharePoint 2013 授權成本](http://www.degdigital.com/blog/sharepoint-2013-licensing-for-dummies/)(http://www.degdigital.com/blog/sharepoint-2013-licensing-for-dummies/)。  
