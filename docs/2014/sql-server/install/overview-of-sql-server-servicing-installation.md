 ...
 **檢閱已知問題：** 如需目前版本已知問題的詳細資訊，請參閱這裡的對應版本資訊： [SQL Server 版本資訊](https://msdn.microsoft.com/f617a0af-92dd-47aa-82c3-f51b1346bcd8)。  
...
### <a name="prepare-for-a-sscurrent-update-installation"></a>準備安裝 [!INCLUDE[ssCurrent](../../includes/sscurrent-md.md)] 更新  
...
### <a name="install-sscurrent-updates"></a>安裝 [!INCLUDE[ssCurrent](../../includes/sscurrent-md.md)] 更新  
 本節將說明安裝程序。  
...
#### <a name="starting-a-sscurrent-update"></a>啟動 [!INCLUDE[ssCurrent](../../includes/sscurrent-md.md)] 更新  
...
####  <a name="product-updates-in-sscurrent-installation"></a><a name="Slipstream"></a>安裝中的[!INCLUDE[ssCurrent](../../includes/sscurrent-md.md)]產品更新  
...
## <a name="updating-a-prepared-image-of-ssnoversion"></a>更新 [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] 的備妥映像  
...
## <a name="updating-a-completed-image-of-ssnoversion"></a>更新完成的 [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] 映像  
...
## <a name="rebuilding-a-sscurrent-failover-cluster-node"></a>重建 [!INCLUDE[ssCurrent](../../includes/sscurrent-md.md)] 容錯移轉叢集節點  
...
## <a name="uninstalling-updates-from-sscurrent"></a>解除安裝 [!INCLUDE[ssCurrent](../../includes/sscurrent-md.md)] 的更新  
