...
2.  在 [命令提示字元] 視窗中，輸入 `ipconfig,`，然後按下 ENTER，即可列出這部電腦可用的 IP 位址。  
    ...
    > [!NOTE]  
    >  
  **ipconfig** 命令有時會列出許多可能的連結，包含已中斷連線的連結。 
  **ipconfig** 命令可以同時列出 IPv4 及 IPv6 的位址。  
...
2.  在** [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] Configuration Manager**的主控台窗格中，展開** [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] [網路**設定]，展開 [ ** \<實例名稱>的通訊協定**]，然後按兩下 [ **tcp/ip**]。  
...
## <a name="see-also"></a>另請參閱  
 ...
 [透過 Proxy 伺服器連接到 SQL Server &#40;SQL Server 組態管理員&#41;](../../relational-databases/sql-server-configuration-manager.md)  
