---
title: 解除安裝 SQL Server 2014 |Microsoft 文件
ms.custom: ''
ms.date: 06/13/2017
...
-   [在 SQL Server 容錯移轉叢集中加入或移除節點 &#40;安裝程式&#41;](../failover-clusters/install/add-or-remove-nodes-in-a-sql-server-failover-cluster-setup.md)  
