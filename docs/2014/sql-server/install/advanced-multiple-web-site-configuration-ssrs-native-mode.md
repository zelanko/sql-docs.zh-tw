---
title: 進階多重網站組態 （SSRS 原生模式） |Microsoft 文件
ms.custom: ''
ms.date: 03/06/2017
 ...
 **通訊埠**  
 指定報表伺服器用來監視要求的通訊埠。 通訊埠 80 是預設通訊埠。 如果您使用通訊埠 80，您不需要在 URL 中包含此通訊埠。 如果您使用任何其他通訊埠編號，您必須一律包含在 URL (例如， http://localhost:8181/reports)。  
