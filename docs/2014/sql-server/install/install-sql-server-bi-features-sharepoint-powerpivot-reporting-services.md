---
title: 使用 SharePoint 安裝 SQL Server BI 功能(電源透視和報告服務) |微軟文件
ms.custom: ''
ms.date: 03/09/2017
...
|**[!INCLUDE[applies](../../includes/applies-md.md)]** SharePoint 2013 &#124;共享点 2010|
 ...
 ![註解](../../../2014/reporting-services/media/rs-fyinote.png "注意")有關目前發行說明,請參閱[SQL 伺服器 2014 發行說明](https://go.microsoft.com/fwlink/?LinkID=296445)。

##  <a name="in-this-topic"></a><a name="bkmk_top"></a>在本主題中
...
##  <a name="sql-server-bi-scenarios-and-sharepoint-2013"></a><a name="bkmk_bi_scenarios"></a>SQL 伺服器 BI 方案和 SharePoint 2013
...
|**3**|SharePoint 以及 SharePoint 模式的 Reporting Services|Power View|以 SharePoint 模式安裝 [!INCLUDE[ssRSnoversion](../../includes/ssrsnoversion-md.md)] 。<br /><br /> 為[!INCLUDE[ssRSnoversion](../../includes/ssrsnoversion-md.md)]SharePoint 安裝外接程式 **(rsSharePoint.msi)。** 有關詳細資訊,請參閱[安裝或卸載 SharePoint &#40;SharePoint 2010 和 SharePoint 2013&#41;](../../reporting-services/install-windows/install-or-uninstall-the-reporting-services-add-in-for-sharepoint.md)|
|**4**|所有 PowerPivot 功能|存取活頁簿做為來自於伺服器陣列外部的資料來源。<br /><br /> 排程資料重新整理。<br /><br /> PowerPivot 圖庫。<br /><br /> 管理儀表板。<br /><br /> BISM 連結檔案內容類型。|為 SharePoint 2013 外接程式 **(spPowerPivot.msi)** 部署 PowerPivot。 如需詳細資訊，請參閱下列：<br /><br /> [安裝或卸載 SharePoint 外接程式的 PowerPivot &#40;SharePoint 2013&#41;](https://docs.microsoft.com/analysis-services/instances/install-windows/install-or-uninstall-the-power-pivot-for-sharepoint-add-in-sharepoint-2013)<br /><br /> 如需有關如何下載 **spPowerPivot.msi**的詳細資訊，請參閱＜ [下載 SQL Server 2014 PowerPivot for SharePoint](https://go.microsoft.com/fwlink/?LinkID=296473)＞。|

 有關啟用[!INCLUDE[ssASnoversion](../../includes/ssasnoversion-md.md)]功能的其他資訊,請參閱[SharePoint 2013](https://blogs.msdn.com/b/analysisservices/archive/2012/07/27/introducing-the-bi-light-up-story-for-sharepoint-2013.aspx)的 SQL Server BIhttps://blogs.msdn.com/b/analysisservices/archive/2012/07/27/introducing-the-bi-light-up-story-for-sharepoint-2013.aspx)亮燈情景 (。

##  <a name="overview-of-installation"></a><a name="bkmk_install_sharepoint2013_overview"></a>安裝概述
 如果您要同時使用 [!INCLUDE[ssGeminiShort](../../includes/ssgeminishort-md.md)] 和 [!INCLUDE[ssRSnoversion](../../includes/ssrsnoversion-md.md)]，請執行 [SQL Server 安裝精靈] 兩次。 [!INCLUDE[ssRSnoversion](../../includes/ssrsnoversion-md.md)]是[!INCLUDE[ssGemini](../../includes/ssgemini-md.md)]SQL 伺服器設置精靈的 **「設定角色**」頁上的單獨選項。

  支援 SharePoint 2010 和 SharePoint 2013。不過，視 SharePoint 的版本而定，所使用的架構和安裝程序會有所不同。
...
5.  在 SharePoint Server 2013 中設定 Excel Services，以使用 [!INCLUDE[ssASnoversion](../../includes/ssasnoversion-md.md)] 執行個體。 有關詳細資訊,請參閱 PowerPivot 中的「配置基本分析服務 SharePoint 整合」[部分,用於 SharePoint 2013 安裝](https://docs.microsoft.com/analysis-services/instances/install-windows/install-analysis-services-in-power-pivot-mode)和管理[Excel 服務數據模型設定(SharePoint Server 2013)()。](https://technet.microsoft.com/library/jj219780.aspx) https://technet.microsoft.com/library/jj219780.aspx)
 ...
 **[!INCLUDE[ssRSnoversion](../../includes/ssrsnoversion-md.md)]** 對於 SharePoint 2010 和 2013
...
1.  SharePoint 模式中的 [!INCLUDE[ssRSnoversion](../../includes/ssrsnoversion-md.md)] 安裝和舊版一樣並沒有變更。
    ...
    -   查看下列項目的支援組合：
        ...
        -   SharePoint 產品的版本。
         ...
         [支援共享點和報告服務伺服器和外接程式組合&#40;SQL Server 2014&#41;](../../reporting-services/install-windows/supported-combinations-of-sharepoint-and-reporting-services-server.md)

    -   SharePoint 2010 上的 [!INCLUDE[ssRSnoversion](../../includes/ssrsnoversion-md.md)] 需要 SharePoint 2010 Service Pack 2 (SP2)。

    1.  以 SharePoint 模式安裝 [!INCLUDE[ssRSnoversion](../../includes/ssrsnoversion-md.md)] 。 [報告服務共用點模式安裝&#40;SharePoint 2010 和 SharePoint 2013&#41;](../../reporting-services/install-windows/install-reporting-services-sharepoint-mode.md)並[安裝共用點 2010 報告服務共用點模式](../../../2014/sql-server/install/install-reporting-services-sharepoint-mode-for-sharepoint-2010.md)。

    2.  安裝 SharePoint 產品的 [!INCLUDE[ssRSnoversion](../../includes/ssrsnoversion-md.md)] 增益集 (rsSharePoint.msi)。 請參閱[安裝或卸載 SharePoint &#40;SharePoint 2010 和 SharePoint 2013&#41;的報告服務載入項](../../reporting-services/install-windows/install-or-uninstall-the-reporting-services-add-in-for-sharepoint.md)。 有關 SharePoint[!INCLUDE[ssRSnoversion](../../includes/ssrsnoversion-md.md)]的外接程式的目前版本,請參閱[在何處查找 SharePoint 產品的報告服務外接程式](../../reporting-services/install-windows/where-to-find-the-reporting-services-add-in-for-sharepoint-products.md)。

    3.  設定 [!INCLUDE[ssRSnoversion](../../includes/ssrsnoversion-md.md)] SharePoint 服務以及至少一個 [!INCLUDE[ssRSnoversion](../../includes/ssrsnoversion-md.md)] 服務應用程式。 有關詳細資訊,請參閱[SharePoint 2013 安裝報告服務共用點模式中的](../../../2014/sql-server/install/install-reporting-services-sharepoint-mode-for-sharepoint-2013.md)「創建報告服務服務應用程式」 一節。

##  <a name="overview-of-database-attach-upgrade-and-sharepoint-2013"></a><a name="bkm_database_attach"></a>資料庫附加升級和共用點概述 2013
...
## <a name="see-also"></a>另請參閱
 [在哪裡可以找到 SharePoint 產品](../../reporting-services/install-windows/where-to-find-the-reporting-services-add-in-for-sharepoint-products.md)[支援共用點和報告服務伺服器和外接程式組合的報告服務載入項&#40;SQL Server 2014&#41;](../../reporting-services/install-windows/supported-combinations-of-sharepoint-and-reporting-services-server.md)[安裝或卸載 SharePoint &#40;SharePoint 2010 和 SharePoint 2013 的報告服務載入項&#41;](../../reporting-services/install-windows/install-or-uninstall-the-reporting-services-add-in-for-sharepoint.md)
