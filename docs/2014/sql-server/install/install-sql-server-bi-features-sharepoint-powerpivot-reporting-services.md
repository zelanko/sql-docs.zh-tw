...
|**[!INCLUDE[applies](../../includes/applies-md.md)]**  SharePoint 2013 &#124; SharePoint 2010|  
 ...
 ![附註](../../../2014/reporting-services/media/rs-fyinote.png "注意")如需目前的版本資訊，請參閱[SQL server 2014 版本資訊](http://go.microsoft.com/fwlink/?LinkID=296445)。  
...
##  <a name="bkmk_bi_scenarios"></a> SQL Server BI 案例和 SharePoint 2013  
 ...
 SharePoint 2013 中的 Excel Services 包含資料模型功能，可在瀏覽器中啟用與 [!INCLUDE[ssGemini](../../includes/ssgemini-md.md)] 活頁簿的互動。 如需基本資料模型功能您不需要部署[!INCLUDE[ssGeminiShort](../../includes/ssgeminishort-md.md)]2013年增益集至伺服器陣列中。 您只需要在 SharePoint 模式下安裝 [!INCLUDE[ssASnoversion](../../includes/ssasnoversion-md.md)] 伺服器，並且在 Excel Services **[資料模型]** 設定中註冊伺服器即可。  
...
##  <a name="bkmk_install_sharepoint2013_overview"></a> 安裝概觀  
 如果您想要使用這兩個[!INCLUDE[ssGeminiShort](../../includes/ssgeminishort-md.md)]和[!INCLUDE[ssRSnoversion](../../includes/ssrsnoversion-md.md)]，執行 SQL Server 安裝精靈兩次。 [!INCLUDE[ssRSnoversion](../../includes/ssrsnoversion-md.md)] 並[!INCLUDE[ssGemini](../../includes/ssgemini-md.md)]是不同選項**安裝程式角色**SQL Server 安裝精靈的頁面。  
  
 [!INCLUDE[ssGeminiShort](../../includes/ssgeminishort-md.md)] 支援 SharePoint 2010 和 SharePoint 2013不過視 SharePoint 的版本使用不同的架構和安裝程序。  
 ...
 **[!INCLUDE[ssGeminiShort](../../includes/ssgeminishort-md.md)] 2013**  
 ...
 針對**SharePoint 2013**，則[!INCLUDE[ssGeminiShort](../../includes/ssgeminishort-md.md)]可以在未安裝 SharePoint 產品的伺服器上執行安裝。 [!INCLUDE[ssGemini](../../includes/ssgemini-md.md)] For SharePoint 2013 中使用的架構是執行**外**SharePoint 伺服器陣列和可以安裝也包含 SharePoint 安裝在伺服器上，或者它可以是安裝並未包含的伺服器SharePoint 安裝。  
...
2.  以 SharePoint 模式安裝 [!INCLUDE[ssASnoversion](../../includes/ssasnoversion-md.md)]，並且在 [!INCLUDE[ssASnoversion](../../includes/ssasnoversion-md.md)] 中，將伺服器管理員權限授與 SharePoint 伺服器陣列及服務帳戶。  
     ...
     這兩個版本的 SharePoint[!INCLUDE[ssGemini](../../includes/ssgemini-md.md)]安裝程序開始選取的安裝程式角色**SQL Server PowerPivot for SharePoint**中的 SQL Server 安裝精靈或使用 SQL Server 命令提示字元安裝。  
  
     ![安裝程式角色](../../../2014/sql-server/install/media/gmni-setupui-featurerole-sql2012sp1.gif "安裝程式角色")  
  
3.  For SharePoint 2013，您可以擴充[!INCLUDE[ssGemini](../../includes/ssgemini-md.md)]功能和體驗。 下載並執行**spPowerPivot.msi**以新增伺服器端資料重新整理處理、 共同作業及管理支援[!INCLUDE[ssGemini](../../includes/ssgemini-md.md)]活頁簿。 如需詳細資訊，請參閱＜ [Microsoft SQL Server 2014 PowerPivot for Microsoft® SharePoint](http://go.microsoft.com/fwlink/?LinkID=324854)＞。  
  
     執行[!INCLUDE[ssGeminiShort](../../includes/ssgeminishort-md.md)]2013年安裝套件**spPowerPivot.msi**以確保資料的正確版本的 SharePoint 伺服器陣列中每部伺服器上安裝提供者。  
  
4.  若要設定[!INCLUDE[ssGemini](../../includes/ssgemini-md.md)]for SharePoint 2013 中，使用**PowerPivot for SharePoint 2013 組態**工具。  
 ...
 **[!INCLUDE[ssGeminiShort](../../includes/ssgeminishort-md.md)] 2010**  
 ...
 若為 SharePoint 2010，則需要在已經安裝或將會安裝 SharePoint 2010 的伺服器上執行 [!INCLUDE[ssGemini](../../includes/ssgemini-md.md)] for SharePoint 安裝。 [!INCLUDE[ssGemini](../../includes/ssgemini-md.md)]適用於 SharePoint 2010 的架構是執行**內**伺服陣列，所以 SharePoint 必須在伺服器上， [!INCLUDE[ssGemini](../../includes/ssgemini-md.md)] SharePoint 已安裝。  
...
2.  SQL Server 安裝精靈會安裝兩個[!INCLUDE[ssGemini](../../includes/ssgemini-md.md)]組態工具。 其中一個組態工具支援 SharePoint 2013，另一個工具則支援 SharePoint 2010。  
     ...
     若要設定[!INCLUDE[ssGemini](../../includes/ssgemini-md.md)]for SharePoint 2010 中，使用**PowerPivot 組態工具**。  
...
1.  適用於安裝[!INCLUDE[ssRSnoversion](../../includes/ssrsnoversion-md.md)]在 SharePoint 模式不會變更與舊版相同。  
  
     [!INCLUDE[ssRSnoversion](../../includes/ssrsnoversion-md.md)]適用於 SharePoint 2010 和 SharePoint 2013 的安裝步驟都非常類似。 有關 SharePoint 版本的重要注意事項如下：  
...
3.  以 SharePoint 模式安裝的 SQL Server Analysis Services 執行個體，並將 SharePoint 伺服器陣列與服務帳戶、 伺服器系統管理員權限授與[!INCLUDE[ssASnoversion](../../includes/ssasnoversion-md.md)]。  
