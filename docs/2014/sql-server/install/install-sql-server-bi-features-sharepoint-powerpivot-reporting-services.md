...
|**3**|SharePoint 以及 SharePoint 模式的 Reporting Services|Power View|以 SharePoint 模式安裝 [!INCLUDE[ssRSnoversion](../../includes/ssrsnoversion-md.md)] 。<br /><br /> 安裝適用于 SharePoint [!INCLUDE[ssRSnoversion](../../includes/ssrsnoversion-md.md)] 增益集 **（rssharepoint.msi .msi）** 。 如需詳細資訊，請參閱[安裝或卸載適用&#40;于 sharepoint SharePoint 2010 和 sharepoint 2013&#41;的 Reporting Services 增益集](../../reporting-services/install-windows/install-or-uninstall-the-reporting-services-add-in-for-sharepoint.md)|  
...
##  <a name="bkmk_install_sharepoint2013_overview"></a>安裝的總覽  
 ...
 [!INCLUDE[ssGeminiShort](../../includes/ssgeminishort-md.md)] 支援 SharePoint 2010 和 SharePoint 2013。不過，視 SharePoint 的版本而定，所使用的架構和安裝程序會有所不同。{2}  
