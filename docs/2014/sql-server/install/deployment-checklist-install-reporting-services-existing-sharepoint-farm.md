...
|對應至新增的所有 web 應用程式[!INCLUDE[ssRSnoversion](../../includes/ssrsnoversion-md.md)]服務應用程式|The new installation <bpt id="p1">**</bpt>is now functional<ept id="p1">**</ept>|  
