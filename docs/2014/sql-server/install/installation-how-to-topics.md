...
|[解除安裝現有的 SQL Server 執行個體 &#40;Setup&#41;](../../../2014/sql-server/install/uninstall-an-existing-instance-of-sql-server-setup.md)|用於手動解除安裝 [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] 之獨立執行個體的程序主題。|  
