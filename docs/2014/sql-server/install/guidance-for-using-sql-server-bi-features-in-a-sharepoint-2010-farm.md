...
-   [SharePoint 2010 的一般需求](#bkmk_generalsharepoint)  
...
-   [執行 SharePoint 安裝的需求和建議](#bkmk_install)  
...
###  <a name="bkmk_install"></a>執行 SharePoint 安裝的需求和建議  
 ...
 您可以在現有的 SharePoint 伺服器陣列中安裝 [!INCLUDE[ssRSnoversion](../../includes/ssrsnoversion-md.md)]。 雖然您可以依照任何順序安裝 [!INCLUDE[ssRSnoversion](../../includes/ssrsnoversion-md.md)] 或 SharePoint，不過 [!INCLUDE[ssRSnoversion](../../includes/ssrsnoversion-md.md)] 的組態會因安裝順序而異。 如需詳細資訊，請參閱[將其他報表伺服器加入至&#40;伺服器陣列 SSRS 向&#41;外](../../reporting-services/install-windows/add-an-additional-report-server-to-a-farm-ssrs-scale-out.md)延展和[安裝 sharepoint 2010 Reporting Services sharepoint 模式](../../../2014/sql-server/install/install-reporting-services-sharepoint-mode-for-sharepoint-2010.md)  
