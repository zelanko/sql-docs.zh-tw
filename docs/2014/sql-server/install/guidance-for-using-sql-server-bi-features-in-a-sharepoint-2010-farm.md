---
title: 使用 SharePoint 2010 伺服陣列中的 SQL Server BI 功能的指引 |Microsoft 文件
ms.custom: ''
ms.date: 03/09/2017
...
# <a name="guidance-for-using-sql-server-bi-features-in-a-sharepoint-2010-farm"></a>在 SharePoint 2010 伺服器陣列中使用 SQL Server BI 功能的指引
  本主題摘要說明根據您使用之軟體版本的功能可用性， 也說明使用特定 SQL Server 功能的 SharePoint 2010 安裝需求。 SharePoint 2013 相關的資訊，請參閱[在 SharePoint 中的 SQL Server BI 功能的部署拓撲](deployment-topologies-for-sql-server-bi-features-in-sharepoint.md)。  
...
-   Reporting Services 包含 SharePoint 產品的增益集。 支援的增益集和報表伺服器組態可以比此處所示的層級更細微。 如需詳細資訊，請參閱[支援組合的 SharePoint 和 Reporting Services 伺服器與增益集&#40;SQL Server 2014&#41;](../../reporting-services/install-windows/supported-combinations-of-sharepoint-and-reporting-services-server.md)。  
...
|一般 [!INCLUDE[ssRSnoversion](../../includes/ssrsnoversion-md.md)] 報表檢視以及 SharePoint 的功能整合。|[!INCLUDE[SPS2010](../../includes/sps2010-md.md)] Standard 和 Enterprise Edition。<br /><br /> [!INCLUDE[SPF2010](../../includes/spf2010-md.md)]。|  
 ...
 如需詳細資訊，請參閱[支援的 SQL Server 2012 的版本功能](http://go.microsoft.com/fwlink/?linkid=232473)。  
...
-   您想要使用 [!INCLUDE[ssGemini](../../includes/ssgemini-md.md)] 和 [!INCLUDE[ssGemini](../../includes/ssgemini-md.md)] 組態工具。  
 ...
 其中一個主要原因 SP1 所執行的 SharePoint 安裝的[!INCLUDE[ssSQL11](../../includes/sssql11-md.md)]是 database engine 功能**sp_dboption**，先前的版本中已被取代，請在已停止[!INCLUDE[ssSQL11](../../includes/sssql11-md.md)]釋出。 如需詳細資訊，請參閱[SQL Server 2014 中已停止的 Database Engine 功能](../../database-engine/discontinued-database-engine-functionality-in-sql-server-2016.md)  
...
> [!NOTE]  
>  現有的伺服陣列，您必須使用下列其中一種**其他**步驟來完成 SharePoint SP1 升級。 如需詳細資訊，請參閱[的已知問題，當您安裝 Office 2010 SP1 和 SharePoint 2010 SP1](http://support.microsoft.com/kb/2532126)和[描述的 SharePoint Server 2010 SP1](http://support.microsoft.com/kb/2460045):  
  
-   **SharePoint 產品設定精靈：** 執行精靈以完成 SP1 升級和設定。  
  
-   **使用 psconfig 完成升級：** 執行命令`psconfig –upgrade`以完成 SP1 升級  
  
 如需詳細資訊，請參閱 「 升級 」 一節[(SharePoint Server 2010)](http://technet.microsoft.com/library/cc263093.aspx)和[資源中心： SharePoint 2010 產品的更新](http://technet.microsoft.com/sharepoint/ff800847.aspx)  
...
|元件|動作|  
|---------------|------------|  
|Reporting Services 增益集|SharePoint 2010 產品準備工具會安裝 Reporting Service 增益集的 [!INCLUDE[ssKilimanjaro](../../includes/sskilimanjaro-md.md)] 版。 [!INCLUDE[ssCurrent](../../includes/sscurrent-md.md)] 包含 [!INCLUDE[ssCurrent](../../includes/sscurrent-md.md)] 功能需要使用的新版本增益集。 您可以使用 [[!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] 安裝精靈] 安裝增益集，也可以從 MSDN 下載增益集。 如需有關何處取得最新版的增益集，以及如何將它安裝的詳細資訊，請參閱[如何尋找 Reporting Services 增益集，適用於 SharePoint 產品](../../reporting-services/install-windows/where-to-find-the-reporting-services-add-in-for-sharepoint-products.md)和[安裝或解除安裝 Reporting ServicesSharePoint 的增益集&#40;SharePoint 2010 和 SharePoint 2013&#41;](../../reporting-services/install-windows/install-or-uninstall-the-reporting-services-add-in-for-sharepoint.md)。|  
...
###  <a name="bkmk_install"></a> 執行 SharePoint 安裝的需求與建議  
 ...
 您可以在現有的 SharePoint 伺服器陣列中安裝 [!INCLUDE[ssRSnoversion](../../includes/ssrsnoversion-md.md)]。 雖然您可以依照任何順序安裝 [!INCLUDE[ssRSnoversion](../../includes/ssrsnoversion-md.md)] 或 SharePoint，不過 [!INCLUDE[ssRSnoversion](../../includes/ssrsnoversion-md.md)] 的組態會因安裝順序而異。 如需詳細資訊，請參閱[將其他的報表伺服器加入至伺服陣列&#40;SSRS 向外&#41;](../../reporting-services/install-windows/add-an-additional-report-server-to-a-farm-ssrs-scale-out.md)和[安裝 Reporting Services SharePoint Mode for SharePoint 2010](../../../2014/sql-server/install/install-reporting-services-sharepoint-mode-for-sharepoint-2010.md)  
...
## <a name="see-also"></a>另請參閱  
 [安裝及部署的 SharePoint Server 2010](http://technet.microsoft.com/sharepoint/ee518643.aspx)   
