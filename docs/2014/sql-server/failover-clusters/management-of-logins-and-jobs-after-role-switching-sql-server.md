...
# <a name="management-of-logins-and-jobs-after-role-switching-sql-server"></a>角色切換後針對登入和作業進行管理 (SQL Server)
  針對[!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)]資料庫部署高可用性或嚴重損壞修復解決方案時，請務必重現儲存在**master**或**msdb**資料庫中之資料庫的相關資訊。 這類相關資訊通常包括主要/主體資料庫的各項作業，以及需要連接到該資料庫的使用者或處理序的登入。 您應將此資訊複寫於裝載次要/鏡像資料庫的任何 [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] 執行個體上。 可能的話，最好在角色切換之後，以程式設計方式在新的主要/主體資料庫上重現此資訊。  
...
## <a name="see-also"></a>另請參閱  
 ...
 [針對孤立使用者進行疑難排解 &#40;SQL Server&#41;](troubleshoot-orphaned-users-sql-server.md)  
