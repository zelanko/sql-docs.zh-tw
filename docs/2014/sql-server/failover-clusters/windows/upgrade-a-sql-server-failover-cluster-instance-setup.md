...
13. 在 [**錯誤報表**] 頁面上，指定您想要傳送給的資訊， [!INCLUDE[msCoName](../../../includes/msconame-md.md)] 以便協助改善 [!INCLUDE[ssNoVersion](../../../includes/ssnoversion-md.md)] 。 錯誤報告選項預設為啟用。  
