...
|**必須是唯一的**|選取的屬性 **必須獨立或與定義的屬性結合時是唯一的** 。<br /><br /> **最佳作法** ：結合此動作與強制性條件，以確保訂閱系統中索引欄位的有效性。<br /><br /> 此動作僅適用於文字、數字、日期及連結值。|  
...
## <a name="see-also"></a>另請參閱  
 [商務規則條件&#40;Master Data Services&#41;](business-rule-conditions-master-data-services.md)   
