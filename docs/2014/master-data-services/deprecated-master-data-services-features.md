...
## <a name="staging-process"></a>暫存處理序  
 ...
 已在中[!INCLUDE[ssCurrent](../includes/sscurrent-md.md)]執行新的、更高的效能暫存進程。 如需詳細資訊，請參閱[資料匯入 &#40;Master Data Services&#41;](overview-importing-data-from-tables-master-data-services.md)。  
