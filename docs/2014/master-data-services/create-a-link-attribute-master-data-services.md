...
ms.locfileid: "65479940"
---
# <a name="create-a-link-attribute-master-data-services"></a>建立連結屬性 (Master Data Services)
  當您想要讓使用者輸入超連結作為屬性值 (例如 [!INCLUDE[ssMDSshort](../includes/ssmdsshort-md.md)]) 時，可以在 http://www.contoso.com 中建立連結屬性。  
...
## <a name="see-also"></a>另請參閱  
 ...
 [&#40;Master Data Services 建立檔案屬性&#41;](../../2014/master-data-services/create-a-file-attribute-master-data-services.md)  
