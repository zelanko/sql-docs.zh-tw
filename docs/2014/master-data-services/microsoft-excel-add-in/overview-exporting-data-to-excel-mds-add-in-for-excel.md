...
## <a name="filtering-data"></a>篩選資料  
 您可以在載入之前篩選資料，以便限制即將下載的資料量。 這包括選擇您想要載入的屬性 (資料行)、您想要顯示屬性的順序，以及您想要使用的成員 (資料列)。 如需詳細資訊，請參閱[載入之前篩選資料&#40;MDS 增益集適用於 Excel&#41;](filter-data-before-exporting-mds-add-in-for-excel.md)。  
