...
-   使用中工作表必須使用您想要的格式包含 MDS 管理的資料。 例如，您應該依照您想要的順序 (套用任何想要的篩選) 來檢視資料行。 如需詳細資訊，請參閱 <<c0> [ 載入之前篩選資料&#40;MDS 增益集適用於 Excel&#41; ](filter-data-before-exporting-mds-add-in-for-excel.md)並[重新排序資料行&#40;MDS 增益集適用於 Excel&#41;](reorder-columns-mds-add-in-for-excel.md)。</c0>  
