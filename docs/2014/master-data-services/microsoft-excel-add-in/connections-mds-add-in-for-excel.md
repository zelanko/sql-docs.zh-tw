...
## <a name="troubleshooting-connections"></a>疑難排解連接  
 當您連接到 MDS，如果您遇到任何問題，請參閱[ https://social.technet.microsoft.com/wiki/contents/articles/4520.aspx ](https://social.technet.microsoft.com/wiki/contents/articles/4520.aspx)如需疑難排解秘訣。  
