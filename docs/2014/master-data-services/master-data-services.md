...
# <a name="master-data-services"></a>Master Data Services
 ...
 透過適當的訓練，大部分商務使用者應該都可以實作 [!INCLUDE[ssMDSshort](../includes/ssmdsshort-md.md)] 方案。 此外，您還可以使用 MDS 管理任何網域；這不是單指管理客戶、產品或帳戶的清單。 首次安裝 MDS 時，它不包含任何網域的結構，但您可以透過為網域建立模型來定義所需的網域。  
...
-   [!INCLUDE[ssMDSshort](../includes/ssmdsshort-md.md)] web 的服務，開發人員可用來擴充或開發自訂方案[!INCLUDE[ssMDSshort](../includes/ssmdsshort-md.md)]。  
