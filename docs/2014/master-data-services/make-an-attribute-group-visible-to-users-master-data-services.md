...
-   至少有一個屬性群組必須存在。 如需詳細資訊，請參閱[建立屬性群組&#40;Master Data Services&#41;](../../2014/master-data-services/create-an-attribute-group-master-data-services.md)。  
...
7.  按一下 **使用者**或**群組**，取決於您想要的群組顯示給使用者或群組。  
