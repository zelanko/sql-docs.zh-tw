...
|**如下所示**|使用 Transact-SQL 的 LIKE 運算子來篩選結果。 如需詳細資訊，請參閱《SQL Server 線上叢書》中的 [LIKE &#40;Transact-SQL&#41;](/sql/t-sql/language-elements/like-transact-sql)。|  
