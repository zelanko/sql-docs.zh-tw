...
|工作描述|主題|  
|----------------------|-----------|  
|使用 MDSModelDeploy 工具建立模型物件與/或資料的新部署封裝。|[使用 MDSModelDeploy 建立模型部署套件](../../2014/master-data-services/create-a-model-deployment-package-by-using-mdsmodeldeploy.md)|  
...
|使用精靈僅部署模型物件的封裝。|[使用精靈部署模型部署套件](../../2014/master-data-services/deploy-a-model-deployment-package-by-using-the-wizard.md)|  
|編輯模型部署封裝以部署選取的模型部分，而非整個模型。|[編輯模型部署套件](../../2014/master-data-services/edit-a-model-deployment-package.md)|  
