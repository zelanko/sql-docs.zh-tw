...
-   資料中至少**有**一個值符合條件所指定的規則。

-   **沒有資料**-資料中沒有任何值符合條件所指定的規則。
...
-   每天**每隔10天**-每隔10天傳送警示一次。

-   **星期一每隔2周**-只在每隔兩周的星期一傳送警示。

-   **每小時每12小時**-每隔12小時傳送警示一次。
...
## <a name="see-also"></a>另請參閱
 警示系統管理員的[Reporting Services 資料警示](../ssms/agent/alerts.md)[資料警示管理員](../../2014/reporting-services/data-alert-manager-for-alerting-administrators.md)
