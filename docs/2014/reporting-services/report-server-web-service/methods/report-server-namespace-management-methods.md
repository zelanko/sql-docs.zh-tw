...
|<xref:ReportService2010.ReportingService2010.CreateCatalogItem%2A>|將新項目加入至報表伺服器資料庫或 SharePoint 文件庫。 這個方法會套用至 `Report`、`Model`、`Dataset`、`Component`、`Resource` 和 `DataSource` 項目類型。|  
...
|<xref:ReportService2010.ReportingService2010.GetItemDefinition%2A>|擷取項目的定義或內容。 這個方法會套用至 `Report`、`Model`、`Dataset`、`Component`、`Resource` 和 `DataSource` 項目類型。|  
...
|<xref:ReportService2010.ReportingService2010.SetItemDefinition%2A>|設定指定之項目的定義或內容。 這個方法會套用至 `Report`、`Model`、`Dataset`、`Component`、`Resource` 和 `DataSource` 項目類型。|  
