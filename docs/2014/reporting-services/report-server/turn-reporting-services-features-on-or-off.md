...
2.  在物件總管中，以滑鼠右鍵[!INCLUDE[ssRSnoversion](../../includes/ssrsnoversion-md.md)]按一下節點，指向 [**原則**]，然後按一下 [ **facet**]。  
...
##  <a name="scheduled-events-and-delivery"></a><a name="Sched"></a>Scheduled Events 和傳遞  
...
4.  在 **[Facet 屬性]** 底下：  
    ...
    -   若要開啟排程的事件和傳遞， **ScheduleEventsAndReportDeliveryEnabled**請將`True`[scheduleeventsandreportdeliveryenabled 設定設定為。  
  
    -   若要關閉排程的事件和傳遞， **ScheduleEventsAndReportDeliveryEnabled**請將`False`[scheduleeventsandreportdeliveryenabled 設定設定為。  
...
##  <a name="report-manager"></a><a name="ReportManager"></a>報表管理員  
...
4.  在 **[Facet 屬性]** 底下：  
    ...
    -   若要開啟報表管理員，請**ReportManagerEnabled**將 [reportmanagerenabled `True`設定為。  
  
    -   若要關閉報表管理員，請**ReportManagerEnabled**將 [reportmanagerenabled `False`設定為。  
  
5.  [!INCLUDE[clickOK](../../includes/clickok-md.md)]  
  
##  <a name="report-builder"></a><a name="ReportBuilder"></a> 報表產生器  
