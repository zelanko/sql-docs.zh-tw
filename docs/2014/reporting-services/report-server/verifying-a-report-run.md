...
|-----------------------------|-----------------------------------------------|-----------------------------------------------|  
|以報表快照集形式執行的報表。|在 [內容] 頁面上。 如需詳細資訊，請參閱[內容頁面 &#40;報表管理員&#41;](../contents-page-report-manager.md)。|1) 尋找包含報表的資料夾。<br />2) 在 [詳細資料] 檢視中設定資料夾。<br />3) 3) 請注意日期和時間在**時執行**資料行。|  
