...
##  <a name="understanding-data-access-technology"></a><a name="DataAccess"></a>瞭解資料存取技術  
...
##  <a name="understanding-report-data"></a><a name="ReportData"></a> 了解報表資料  
...
##  <a name="working-with-data-types"></a><a name="DataTypes"></a>使用資料類型  
