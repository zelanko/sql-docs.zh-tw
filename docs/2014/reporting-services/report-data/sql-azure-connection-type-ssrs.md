...
ms.locfileid: "78176888"
---
# <a name="sql-azure-connection-type-ssrs"></a>SQL Azure 連接類型 (SSRS)
  [!INCLUDE[msCoName](../../includes/msconame-md.md)][!INCLUDE[ssSDSfull](../../includes/sssdsfull-md.md)]是一個基於雲的託管關係資料庫，基於[!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)]技術構建。 若要在報表中包含來自 [!INCLUDE[ssSDS](../../includes/sssds-md.md)] 的資料，您必須具有以 [!INCLUDE[ssSDS](../../includes/sssds-md.md)]類型之報表資料來源為基礎的資料集。 此內建資料來源類型是以 [!INCLUDE[ssSDS](../../includes/sssds-md.md)] 資料延伸模組為基礎。 使用此資料來源類型可連接至 [!INCLUDE[ssSDS](../../includes/sssds-md.md)]並從中擷取資料。
...
>  當開啟 [!INCLUDE[ssSDS](../../includes/sssds-md.md)]的連接時，請將連接逾時設定為 30 秒。
 ...
 有關詳細資訊，請參閱[Azure SQL 資料庫文檔](https://docs.microsoft.com/azure/sql-database/)。

 您可以使用本主題中的資訊來建置資料來源。 有關分步說明，請參閱[添加和驗證資料連線或資料來源&#40;報表產生器和 SSRS&#41;](add-and-verify-a-data-connection-report-builder-and-ssrs.md)。
...
-   不需要認證。 若要使用這個選項，您先前必須在報表伺服器上設定自動執行帳戶。 如需詳細資訊，請參閱 msdn.microsoft.com 上 [Reporting Services 文件](https://go.microsoft.com/fwlink/?linkid=121312)中的[設定自動執行帳戶 &#40;SSRS 設定管理員&#41;](../install-windows/configure-the-unattended-execution-account-ssrs-configuration-manager.md)。
 ...
 有關詳細資訊，請參閱[報表服務中的資料連線、資料來源和連接字串](../data-connections-data-sources-and-connection-strings-in-reporting-services.md)或在[報表產生器中指定憑據](../specify-credentials-in-report-builder.md)。
...
###  <a name="using-query-type-text"></a><a name="QueryText"></a>使用查詢類型文本
...
###  <a name="using-query-type-storedprocedure"></a><a name="QueryStoredProcedure"></a>使用查詢類型預存程序
...
```
 ...
 根據預設，每個報表參數的資料類型為 Text，並具有自動建立的資料集，以提供可用值的下拉式清單。 建立報表參數後，您可能必須變更預設值。 有關詳細資訊，請參閱[報表參數&#40;報表產生器和報表設計師&#41;](../report-design/report-parameters-report-builder-and-report-designer.md)。
...
##  <a name="how-to-topics"></a><a name="HowTo"></a>如何訪問主題
 本節包含使用資料連接、資料來源與資料集的逐步指示。

 [添加和驗證資料連線或資料來源&#40;報表產生器和 SSRS&#41;](add-and-verify-a-data-connection-report-builder-and-ssrs.md)
...
##  <a name="related-sections"></a><a name="Related"></a>相關部分
 本文件集的這些章節會提供報表資料的深入概念性資訊，以及如何定義、自訂和使用與報表資料相關組件的程序資訊。

 [將資料添加到報表&#40;報表產生器和 SSRS&#41;](report-datasets-ssrs.md)提供訪問報表資料的概述。

 [報表產生器中的資料連線、資料來源和連接字串](../data-connections-data-sources-and-connection-strings-in-report-builder.md)提供有關資料來源的資訊。

 [報告嵌入資料集和共用資料集&#40;報表產生器和 SSRS&#41;](report-embedded-datasets-and-shared-datasets-report-builder-and-ssrs.md)提供有關嵌入和共用資料集的資訊。

 [資料集欄位收集&#40;報表產生器和 SSRS&#41;](dataset-fields-collection-report-builder-and-ssrs.md)提供有關查詢生成的資料集欄位集合的資訊。
...
## <a name="see-also"></a>另請參閱
 [報表參數&#40;報表產生器和報表設計師&#41;](../report-design/report-parameters-report-builder-and-report-designer.md)[篩選器、組和排序資料&#40;報表產生器和 SSRS&#41;](../report-design/filter-group-and-sort-data-report-builder-and-ssrs.md)[運算式&#40;報表產生器和 SSRS&#41;](../report-design/expressions-report-builder-and-ssrs.md)
