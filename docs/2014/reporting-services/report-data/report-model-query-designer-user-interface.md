...
|Results pane|顯示查詢的結果。 若要執行查詢，請以滑鼠右鍵按一下任何窗格，然後按一下 [執行]，或是按一下工具列上的 [執行] (![執行查詢](../../analysis-services/media/rsqdicon-run.gif "執行查詢")) 按鈕。|  
...
|![恢復動作](../media/rsqdicon-undo.gif "恢復動作")|恢復上一個動作。|  
|![重做動作](../media/rsqdicon-redo.gif "重做動作")|重做上一個動作。|  
|![執行查詢](../../analysis-services/media/rsqdicon-run.gif "執行查詢")|執行查詢並將產生的資料列顯示在 [結果] 窗格中。|  
|![在選取篩選條件資料行旁邊的篩選圖形](../media/rsqdicon-filter.gif "在選取篩選條件資料行旁邊的篩選圖形")|開啟 [篩選資料] 對話方塊，讓您指定要篩選的資料。 您可以指定與目前 [設計區域] 中資料無關的篩選。|  
...
## <a name="text-based-query-designer"></a>以文字為基礎的查詢設計工具  
 ...
 ![一般語意模型語言查詢設計工具](../media/rsqd-dsawmodel-smql-generic.gif "一般語意模型語言查詢設計工具")  
