...
ms.locfileid: "78176858"
---
# <a name="sql-server-parallel-data-warehouse-connection-type-ssrs"></a>SQL Server Parallel Data Warehouse 連接類型 (SSRS)
  [!INCLUDE[msCoName](../../../includes/msconame-md.md)] [!INCLUDE[ssDWCurrentFull](../../../includes/ssdwcurrentfull-md.md)] 是可擴充的資料倉儲設備，其透過大量平行處理來提供效能和擴充性。 [!INCLUDE[ssDW](../../../includes/ssdw-md.md)] 使用 [!INCLUDE[ssCurrent](../../../includes/sscurrent-md.md)] 資料庫來進行分散式處理和資料存放。
...
-   不需要認證。 若要使用這個選項，您先前必須在報表伺服器上設定自動執行帳戶。 如需詳細資訊，請參閱 msdn.microsoft.com 上 [Reporting Services 文件](https://go.microsoft.com/fwlink/?linkid=121312)中的[設定自動執行帳戶 &#40;SSRS 設定管理員&#41;](../install-windows/configure-the-unattended-execution-account-ssrs-configuration-manager.md)。
 ...
 有關詳細資訊,請參閱[報表服務中的資料連線、資料來源和連接字串](../data-connections-data-sources-and-connection-strings-in-reporting-services.md)或在[報表產生器中指定認證](../specify-credentials-in-report-builder.md)。
...
###  <a name="using-query-type-text"></a><a name="QueryText"></a>使用查詢類型文字
...
```
 ...
 根據預設，每個報表參數的資料類型為 Text，並具有自動建立的資料集，以提供可用值的下拉式清單。 建立報表參數後，您可能必須變更預設值。 有關詳細資訊,請參閱[報表參數&#40;報表生成器和報表設計器&#41;](../report-design/report-parameters-report-builder-and-report-designer.md)。
...
##  <a name="how-to-topics"></a><a name="HowTo"></a>如何存取主題
 本節包含使用資料連接、資料來源與資料集的逐步指示。

 [新增與驗證資料連線或資料來源&#40;報表產生器和 SSRS&#41;](add-and-verify-a-data-connection-report-builder-and-ssrs.md)
...
##  <a name="related-sections"></a><a name="Related"></a>相關部分
 ...
 [將資料加入到報表&#40;報表產生器和 SSRS&#41;](report-datasets-ssrs.md)提供訪問報表數據的概述。

 [報表產生器中的資料連線、資料來源和連接字串](../data-connections-data-sources-and-connection-strings-in-report-builder.md)提供有關數據源的資訊。

 [報告嵌入資料集和分享資料集&#40;報表產生器和 SSRS&#41;](report-embedded-datasets-and-shared-datasets-report-builder-and-ssrs.md)提供有關嵌入和共享數據集的資訊。

 [資料集欄位收集&#40;報表產生器和 SSRS&#41;](dataset-fields-collection-report-builder-and-ssrs.md)提供有關查詢生成的數據集欄位集合的資訊。
...
## <a name="see-also"></a>另請參閱
 [報表參數&#40;報表產生器和報表設計器&#41;](../report-design/report-parameters-report-builder-and-report-designer.md)[篩選器、組和排序資料&#40;報表產生器和 SSRS&#41;](../report-design/filter-group-and-sort-data-report-builder-and-ssrs.md)[運算式&#40;報表產生器和 SSRS&#41;](../report-design/expressions-report-builder-and-ssrs.md)
