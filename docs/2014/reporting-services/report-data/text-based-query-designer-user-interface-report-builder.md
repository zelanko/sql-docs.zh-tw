...
#### <a name="example"></a>範例  
 下列[!INCLUDE[ssSampleDBobject](../../../includes/sssampledbobject-md.md)]查詢會從`Person`架構的**2008**資料庫`ContactType`資料表中傳回姓氏清單。  
...
### <a name="command-type-storedprocedure"></a>StoredProcedure 命令類型  
 ...
 ![文字型查詢設計工具中的預存程序](https://docs.microsoft.com/analysis-services/analysis-services/media/rs-relational-text-sp.gif "文字型查詢設計工具中的預存程序")  
...
#### <a name="example"></a>範例  
 下列查詢會呼叫[!INCLUDE[ssSampleDBobject](../../../includes/sssampledbobject-md.md)] `uspGetWhereUsedProductID` **2008**預存程式。 當您執行查詢時，必須為產品識別碼參數輸入值。  
...
## <a name="see-also"></a>另請參閱  
 [關聯式查詢設計工具使用者介面 &#40;報表產生器&#41;](relational-query-designer-user-interface-report-builder.md)   
