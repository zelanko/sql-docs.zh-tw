---
title: 報表設計師 SQL Server Data Tools 中的查詢設計工具（SSRS） |Microsoft Docs
ms.custom: ''
ms.date: 06/13/2017
...
##  <a name="text-based-query-designer"></a><a name="Textbased"></a>以文字為基礎的查詢設計工具
 以文字為基礎的查詢設計工具是最支援的關聯式資料來源的預設查詢建立工具[!INCLUDE[msCoName](../../../includes/msconame-md.md)] [!INCLUDE[ssNoVersion](../../../includes/ssnoversion-md.md)]，包括、Oracle、Teradata、OLE DB、XML 和 ODBC。 相較於圖形化查詢設計工具，此查詢設計工具在查詢設計期間並不會驗證查詢語法。 下圖說明以文字為基礎的查詢設計工具。
...
##  <a name="graphical-query-designer"></a><a name="Graphical"></a>圖形化查詢設計工具
...
##  <a name="report-model-query-designer"></a><a name="Model"></a>報表模型查詢設計工具
...
##  <a name="mdx-query-designer"></a><a name="MDX"></a>MDX 查詢設計工具
...
##  <a name="dmx-query-designer"></a><a name="DMX"></a>DMX 查詢設計工具
 ...
 ![Analysis Services MDX 查詢設計工具，[設計] 檢視](../media/rsqd-dsawas-dmx-designmode.gif "Analysis Services DMX 查詢設計工具，[設計] 檢視")
...
##  <a name="sap-netweaver-bi-query-designer"></a><a name="SAPBW"></a>Sap NetWeaver BI 查詢設計工具
...
##  <a name="hyperion-essbase-query-designer"></a><a name="Hyperion"></a>Hyperion Essbase 查詢設計工具
...
## <a name="see-also"></a>另請參閱
 [Reporting Services 工具](../tools/reporting-services-tools.md)會[將資料加入至報表 &#40;報表產生器和 Ssrs&#41;](report-datasets-ssrs.md) [資料連線、資料來源和連接字串](../data-connections-data-sources-and-connection-strings-in-reporting-services.md)Reporting Services [ssrs](../reporting-services-tutorials-ssrs.md) Reporting Services &#40;ssrs&#41;[支援的資料](../create-deploy-and-manage-mobile-and-paginated-reports.md)源 Reporting Services &#40;在 ssrs 中[建立內嵌或共用資料來源](../create-an-embedded-or-shared-data-source-ssrs.md)&#41;
