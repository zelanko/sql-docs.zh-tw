---
title: 報表設計器 SQL 伺服器資料工具 (SSRS) 中的查詢設計工具 |微軟文件
ms.custom: ''
ms.date: 06/13/2017
...
##  <a name="text-based-query-designer"></a><a name="Textbased"></a>基於文字查詢設計器
 基於文字的查詢設計器是大多數受支援的關係資料來源(包括[!INCLUDE[msCoName](../../../includes/msconame-md.md)][!INCLUDE[ssNoVersion](../../../includes/ssnoversion-md.md)]Oracle、Teradata、OLE DB、XML 和 ODBC)的預設查詢建構工具。 相較於圖形化查詢設計工具，此查詢設計工具在查詢設計期間並不會驗證查詢語法。 下圖說明以文字為基礎的查詢設計工具。
...
##  <a name="graphical-query-designer"></a><a name="Graphical"></a>圖像查詢設計器
...
##  <a name="report-model-query-designer"></a><a name="Model"></a>報表模型查詢設計器
...
##  <a name="mdx-query-designer"></a><a name="MDX"></a>MDX 查詢設計器
...
##  <a name="dmx-query-designer"></a><a name="DMX"></a>DMX 查詢設計器
...
##  <a name="sap-netweaver-bi-query-designer"></a><a name="SAPBW"></a>Sap NetWeaver BI 查詢設計器
...
##  <a name="hyperion-essbase-query-designer"></a><a name="Hyperion"></a>Hyperion Esbase 查詢設計器
...
## <a name="see-also"></a>另請參閱
 [報告服務工具](../tools/reporting-services-tools.md)[將資料加入到報表&#40;報表產生器和 SSRS&#41;](report-datasets-ssrs.md)[報告服務、資料來源和連接字串的報告](../data-connections-data-sources-and-connection-strings-in-reporting-services.md)服務[,報告服務&#40;SSRS&#41;](../reporting-services-tutorials-ssrs.md) [SSRS &#40;支援的資料來源,&#41;](../create-deploy-and-manage-mobile-and-paginated-reports.md)[建立嵌入式或共享資料來源&#40;SSRS&#41;](../create-an-embedded-or-shared-data-source-ssrs.md)
