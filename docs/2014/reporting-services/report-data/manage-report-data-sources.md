...
|在報表專案中加入共用資料來源 (.rds) 檔案的連結。|報表設計師|[建立、 修改及刪除共用的資料來源&#40;SSRS&#41;](create-modify-and-delete-shared-data-sources-ssrs.md)|  
...
|在報表伺服器上建立共用資料來源項目。|報表管理員|[建立、 刪除或修改共用的資料來源&#40;報表管理員&#41;](../create-delete-or-modify-a-shared-data-source-report-manager.md)|  
