...
# <a name="security-extensions-overview"></a>安全性延伸模組概觀
 ...
 ![Reporting Services 安全性延伸模組處理序](../../media/rosettasecurityextensionflow.gif "Reporting Services 安全性延伸模組處理序")
...
## <a name="see-also"></a>另請參閱
 [執行安全性延伸](../security-extension/implementing-a-security-extension.md)模組[設定報表管理員傳遞自訂驗證 cookie](../../security/configure-the-web-portal-to-pass-custom-authentication-cookies.md)
