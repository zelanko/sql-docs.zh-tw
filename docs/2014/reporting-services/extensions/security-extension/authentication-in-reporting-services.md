...
2.  Web 服務會呼叫<xref:ReportService2010.ReportingService2010.LogonUser%2A>方法的安全性延伸模組，具體而言，類別可實作**IAuthenticationExtension**。  
