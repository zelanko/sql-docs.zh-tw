...
|主題|描述|  
|-----------|-----------------|  
|[操作說明：將資料處理延伸模組部署到報表伺服器](deploying-a-data-processing-extension-to-a-report-server.md)|描述如何將資料處理延伸模組部署到報表伺服器。|  
|[操作說明：將資料處理延伸模組部署到報表設計師](deploying-a-data-processing-extension-to-report-designer.md)|描述如何將資料處理延伸模組部署到報表設計師。|  
