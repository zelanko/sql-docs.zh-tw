...
# <a name="debugging-data-processing-extension-code"></a>偵錯資料處理延伸模組程式碼
  [!INCLUDE[msCoName](../../../includes/msconame-md.md)]提供數個偵錯工具，可協助您分析資料處理延伸模組程式碼，並找出其中的[!INCLUDE[dnprdnshort](../../../includes/dnprdnshort-md.md)]錯誤。 效果最好的工具將視您嘗試要完成的項目而定。 此範例會使用 [!INCLUDE[vsOrcas](../../../includes/vsorcas-md.md)]。  
