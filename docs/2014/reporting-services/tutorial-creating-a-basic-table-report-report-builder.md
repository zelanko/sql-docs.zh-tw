...
##  <a name="1-create-a-new-report-from-getting-started"></a><a name="CreateTable"></a>1. 從消費者入門建立新的報表  
...
##  <a name="1b-create-a-query-in-the-table-wizard"></a><a name="Query"></a>1a-1b. 在資料表精靈中建立查詢  
...
##  <a name="1e-choose-a-style-in-the-table-wizard"></a><a name="Style"></a>1e. 在資料表精靈中選擇樣式  
 樣式會指定字型樣式、色彩集和框線樣式。  
