...
## <a name="connected-mode"></a>連線模式  
 如需搭配[!INCLUDE[ssRSnoversion](../includes/ssrsnoversion-md.md)]連線模式使用 ADS 擴充功能的最新資訊，請參閱[SharePoint 網站中的 Access Services 報表顯示資料延伸模組 ' ADS '](https://social.technet.microsoft.com/wiki/contents/articles/25298.access-services-report-in-sharepoint-site-shows-error-in-data-extension-ads.aspx)中的錯誤。  
