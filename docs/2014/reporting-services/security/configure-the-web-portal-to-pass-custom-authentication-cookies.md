---
title: 設定報表管理員傳遞自訂驗證 Cookie |Microsoft 文件
ms.custom: ''
ms.date: 06/13/2017
...
## <a name="modifying-the-rsreportserverconfig-file"></a>修改 RSReportServer.Config 檔  
 您可以啟用報表管理員來加傳送其他 cookie 到報表伺服器 <`PassThroughCookies`> RSReportServer.config 檔案中的報表管理員組態設定的項目。 當單一登入驗證方案不僅需要報表伺服器驗證 Cookie，同時也需要協力廠商驗證系統提供的 Cookie 時，傳送其他 Cookie 這項功能就顯得非常有用。  
...
## <a name="see-also"></a>另請參閱  
 ...
 [設定及管理報表伺服器&#40;SSRS 原生模式&#41;](../report-server/configure-and-administer-a-report-server-ssrs-native-mode.md)  
