...
## <a name="see-also"></a>另請參閱  
 [將報表伺服器資料庫移到另一部電腦&#40;SSRS 原生模式&#41;](../report-server/moving-the-report-server-databases-to-another-computer-ssrs-native-mode.md)   
