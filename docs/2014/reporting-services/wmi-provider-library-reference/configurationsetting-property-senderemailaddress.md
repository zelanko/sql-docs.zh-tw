...
---
# <a name="senderemailaddress-property-wmi-msreportserver_configurationsetting"></a>SenderEmailAddress 屬性 (WMI MSReportServer_ConfigurationSetting)
...
## <a name="property-values"></a>屬性值  
 唯讀 `String` 物件，代表報表伺服器所使用的電子郵件地址。  
