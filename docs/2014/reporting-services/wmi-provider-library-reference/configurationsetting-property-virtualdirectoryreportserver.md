...
ms.locfileid: "59969984"
---
# <a name="virtualdirectoryreportserver-property-wmi-msreportserverconfigurationsetting"></a>VirtualDirectoryReportServer 屬性 (WMI MSReportServer_ConfigurationSetting)
  傳回報表伺服器應用程式的虛擬目錄。 唯讀。  
