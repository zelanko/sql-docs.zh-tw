...
ms.locfileid: "66097522"
---
# <a name="sendusingsmtpserver-property-wmi-msreportserver_configurationsetting"></a>SendUsingSMTPServer 屬性 (WMI MSReportServer_ConfigurationSetting)
  指定在報表伺服器的電子郵件組態中之 `SendUsing` 元素是否應該設定為 `true`。  
