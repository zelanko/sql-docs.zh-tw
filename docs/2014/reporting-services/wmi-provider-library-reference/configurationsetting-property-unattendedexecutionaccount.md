...
---
# <a name="unattendedexecutionaccount-property-wmi-msreportserver_configurationsetting"></a>UnattendedExecutionAccount 屬性 (WMI MSReportServer_ConfigurationSetting)
