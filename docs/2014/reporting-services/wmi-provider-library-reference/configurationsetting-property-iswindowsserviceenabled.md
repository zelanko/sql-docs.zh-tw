...
ms.locfileid: "48191758"
---
# <a name="iswindowsserviceenabled-property-wmi-msreportserverconfigurationsetting"></a>IsWindowsServiceEnabled 屬性 (WMI MSReportServer_ConfigurationSetting)
