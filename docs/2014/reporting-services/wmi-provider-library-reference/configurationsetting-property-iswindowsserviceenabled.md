...
ms.locfileid: "66097584"
---
# <a name="iswindowsserviceenabled-property-wmi-msreportserver_configurationsetting"></a>IsWindowsServiceEnabled 屬性 (WMI MSReportServer_ConfigurationSetting)
...
## <a name="property-values"></a>屬性值  
 唯讀的 **布林** 值。 值為 `true` 指出是否已啟用報表伺服器 Windows 服務。  
