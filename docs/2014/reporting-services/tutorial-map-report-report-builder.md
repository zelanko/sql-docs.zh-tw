...
##  <a name="1-create-a-map-with-a-polygon-layer-from-the-map-wizard"></a><a name="Map"></a>1. 從地圖 Wizard 建立具有多邊形圖層的地圖  
...
##  <a name="4-add-a-bing-maps-tile-background"></a><a name="TileLayer"></a>4. 加入 Bing 地圖底圖背景  
...
##  <a name="6-vary-county-color-based-on-sales"></a><a name="Vary"></a>6. 根據銷售來改變縣市色彩  
...
###  <a name="6d-create-a-new-legend"></a><a name="NewLegend"></a>6d. 建立新的圖例  
...
###  <a name="6e-associate-legend-and-color-rules"></a><a name="Associate"></a>6e. 讓圖例與色彩規則產生關聯  
 每個圖例都可以顯示一或多組規則結果。  
...
##  <a name="center-the-map-view"></a><a name="CenterView"></a>置中地圖視圖  
 變更地圖檢視區的置中與縮放層級。  
...
##  <a name="add-a-report-title"></a><a name="Title"></a>加入報表標題  
