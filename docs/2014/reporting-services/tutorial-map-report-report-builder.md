...
6.  [依據銷售量變化郡的色彩](#Vary)  
    ...
    3.  [依據貨幣格式化色階中的資料](#ColorScale)  
  
    4.  [建立新的圖例](#NewLegend)  
  
    5.  [讓圖例與色彩規則產生關聯](#Associate)  
  
    6.  [清除未包含資料之郡的色彩](#NoData)  
  
7.  [加入自訂點](#CustomPoint)  
  
8.  [將地圖檢視置中](#CenterView)  
...
##  <a name="Map"></a>1. 從地圖 Wizard 建立具有多邊形圖層的地圖  
...
15. 按一下地圖來選取它，然後顯示 **[地圖圖層]** 窗格。 
  **[地圖圖層]** 窗格會顯示一個 **[內嵌]** 圖層類型的多邊形圖層。 每個郡在此圖層上都是一個內嵌的地圖元素。  
...
2.  按兩下地圖來顯示 **[地圖圖層]** 窗格。 在工具列上，按一下 [**新增圖層] [wizard]** 按鈕![rs_IconMapLayerWizard](../../2014/tutorials/media/rs-iconmaplayerwizard.gif "rs_IconMapLayerWizard")。  
...
11. 在 [**選擇空間資料和地圖視圖選項**] 頁面上，確認 [**空間**] 欄位`SpatialLocation`為，而 [**圖層類型**] 為 [**點**]。 接受此頁面上的其他預設值。  
...
18. 按一下 [完成]  。  
     ...
     按兩下地圖來顯示 **[地圖圖層]** 窗格。 
  **[地圖圖層]** 窗格會顯示一個新圖層 PointLayer1，其空間資料來源類型為 **DataRegion**。  
...
7.  在 [**設計查詢**] 頁面上，按一下 [當做**文字編輯**]。 查詢設計工具會切換為以文字為基礎的模式。  
...
##  <a name="TileLayer"></a>4. 加入 Bing 地圖底圖背景  
...
2.  按兩下地圖來顯示 **[地圖圖層]** 窗格。 在工具列上，按一下 [**新增圖層**![rs_IconMapAddLayer](../../2014/tutorials/media/rs-iconmapaddlayer.gif "rs_IconMapAddLayer")]。  
...
3.  按一下 PolygonLayer1 上的向下箭頭，然後按一下 **[圖層資料]**。 
  **[地圖多邊形圖層屬性]** 對話方塊隨即開啟。  
...
2.  按一下 PolygonLayer1 上的向下箭頭，然後按一下 **[多邊形色彩規則]**。 
  **[地圖色彩規則屬性]** 對話方塊隨即開啟。 您會發現已選取 **[使用調色盤將資料視覺化]** 色彩規則選項。 此選項是由精靈設定。  
...
7.  將 **[結束色彩]** 變更為 **[綠色]**。  
     ...
     [**紅色**] 表示低銷售值、[**黃色**] 表示中間銷售值，而 [**綠色**] 表示高銷售值。 報表處理器會根據這些值以及您在 **[分佈]** 頁面上選擇的選項，計算色彩範圍。  
...
6.  在 [**圖例文字**] 中，使用下列格式來指定不含小數位數的貨幣：`#FROMVALUE {C0} - #TOVALUE {C0}`  
...
## <a name="next-steps"></a>後續步驟  
 ...
 如需詳細資訊，請參閱[Maps &#40;報表產生器和 SSRS&#41;](report-design/maps-report-builder-and-ssrs.md) ，以及 blogs.msdn.com 上[SQL Server Reporting Services 的空間資料](https://go.microsoft.com/fwlink/?LinkId=152771)的 blog 專案製圖調整。  
  
 如需更多教學課程，請參閱[教學課程 &#40;報表產生器&#41;](report-builder-tutorials.md)。  
