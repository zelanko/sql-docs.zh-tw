...
##  <a name="BackToTop"></a>地圖嚮導和地圖圖層的 Wizard 頁面
...
###  <a name="Shapefile"></a>什麼是 ESRI 形狀檔？
...
###  <a name="SqlServerSpatial"></a>什麼是 SQL Server 空間查詢？
...
##  <a name="MapView"></a>選擇空間資料和地圖視圖選項
 在此頁面上，您可以設定下列選項：
...
###  <a name="MapType"></a>基本地圖、反升地圖和分析地圖之間有何差異？
