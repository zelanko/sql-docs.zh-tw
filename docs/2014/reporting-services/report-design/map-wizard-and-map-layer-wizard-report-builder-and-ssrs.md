...
##  <a name="map-wizard-and-map-layer-wizard-pages"></a><a name="BackToTop"></a>地圖嚮導和地圖圖層的 Wizard 頁面
...
2.  [選擇空間資料和地圖視圖選項](#MapView)。 設定地圖檢視、地圖解析度，指定是否要在報表中內嵌空間資料，以及指定是否要包含 [!INCLUDE[msCoName](../../../includes/msconame-md.md)] Bing 地圖底圖的圖格背景。
...
3.  [選擇 [地圖視覺效果](#Visualization)]。 選擇要建立之地圖的類型。
...
8.  [選擇色彩主題和資料視覺效果](#ThemeandVisualization)。 若要指定如何根據地圖背景視覺化資料，請指定地圖主題、要視覺化的欄位，以及要改變的項目：色彩、大小和/或標記類型。
 ...
 搭配 [![回到頁首] 連結使用的箭號圖示](../../2014-toc/media/uparrow16x16.gif "與 [回到頁首] 連結搭配使用的箭頭圖示")[回到頁首](#BackToTop)

##  <a name="choose-a-source-of-spatial-data"></a><a name="SpatialDataSource"></a>選擇空間資料的來源
...
###  <a name="what-is-spatial-data"></a><a name="SpatialData"></a>什麼是空間資料？
...
###  <a name="what-is-the-map-gallery"></a><a name="MapGallery"></a>什麼是地圖庫？
...
###  <a name="what-is-an-esri-shapefile"></a><a name="Shapefile"></a>什麼是 ESRI 形狀檔？
 ESRI 形狀檔是一組檔案，其中包含符合 Environmental Systems Research Institute, Inc. (ESRI) 形狀檔空間資料格式的資料。 這組檔案通常包含 .shp 檔案的* \<>檔案名*，其中包含空間資料和支援檔案， * \<filename>*.dbf。
...
###  <a name="where-can-i-get-esri-shapefiles"></a><a name="GetShapefiles"></a>哪裡可以取得 ESRI 形狀檔？
 ESRI 形狀檔可上網取得。 如需詳細資訊，請參閱 [尋找地圖的 ESRI 形狀檔](https://go.microsoft.com/fwlink/?linkid=178814)。

###  <a name="what-is-a-sql-server-spatial-query"></a><a name="SqlServerSpatial"></a>什麼是 SQL Server 空間查詢？
...
##  <a name="choose-spatial-data-and-map-view-options"></a><a name="MapView"></a>選擇空間資料和地圖視圖選項
 在此頁面上，您可以設定下列選項：
...
###  <a name="what-is-the-map-view-or-viewport"></a><a name="Viewport"></a> 何謂地圖檢視或檢視區？
 地圖檢視區會針對報表中的所有圖層定義要顯示的地圖區域。

 根據預設，色階與距離標尺會出現在檢視區內部，而地圖圖例則出現在檢視區外部。 您可以在完成精靈後，變更檢視區的這些選項。

###  <a name="what-is-map-resolution-and-optimization"></a><a name="Resolution"></a>什麼是地圖解析度和優化？
...
###  <a name="what-does-embedding-spatial-data-do"></a><a name="Embed"></a>內嵌空間資料的用途為何？
...
###  <a name="what-is-a-bing-map-tile-background"></a><a name="Tiles"></a>什麼是 Bing 地圖底圖背景？
...
-   **混合式.** 顯示 **[路段圖]** 和 **[空照圖]** 檢視的組合。
 ...
 若要在設計檢視下查看圖格背景，您必須能夠存取網際網路。 若要從報表伺服器上的報表查看預覽中的圖格背景，則必須將報表伺服器設定為支援 Bing 地圖底圖。 如需詳細資訊，請參閱在 SQL Server 線上叢書的[Reporting Services 檔](https://go.microsoft.com/fwlink/?linkid=121312)中，針對[報表進行疑難排解：對應報表 &#40;報表產生器和 SSRS&#41;](troubleshoot-reports-map-reports-report-builder-and-ssrs.md)和「規劃對應」。

 如需自訂圖格圖層之其他方式的詳細資訊，請參閱[加入、變更或刪除地圖或地圖圖層 &#40;報表產生器及 SSRS&#41;](add-change-or-delete-a-map-or-map-layer-report-builder-and-ssrs.md)。

 搭配 [![回到頁首] 連結使用的箭號圖示](../../2014-toc/media/uparrow16x16.gif "與 [回到頁首] 連結搭配使用的箭頭圖示")[回到頁首](#BackToTop)

##  <a name="choose-map-visualization"></a><a name="Visualization"></a>選擇地圖視覺效果
...
###  <a name="what-is-the-difference-among-a-basic-map-a-bubble-map-and-an-analytical-map"></a><a name="MapType"></a>基本地圖、反升地圖和分析地圖之間有何差異？
...
##  <a name="choose-the-analytical-dataset"></a><a name="AnalyticalData"></a>選擇分析資料集
...
###  <a name="what-is-the-difference-between-spatial-data-and-analytical-data"></a><a name="Diff"></a>空間資料和分析資料之間有何差異？
...
##  <a name="specify-the-match-fields"></a><a name="SpecifyMatchFields"></a>指定符合欄位
 在此頁面上，建立空間資料與分析資料間的關聯性。

###  <a name="what-are-match-fields"></a><a name="MatchFields"></a> 何謂符合欄位？
 符合欄位可讓報表處理器建立分析資料與空間資料間的關聯性。 符合欄位會在分析資料內指定唯一的值。 例如，商店名稱在資料內可能不是唯一的，因此您可以同時指定城市和商店名稱。

 搭配 [![回到頁首] 連結使用的箭號圖示](../../2014-toc/media/uparrow16x16.gif "與 [回到頁首] 連結搭配使用的箭頭圖示")[回到頁首](#BackToTop)

##  <a name="choose-color-theme-and-data-visualization"></a><a name="ThemeandVisualization"></a>選擇色彩主題和資料視覺效果
 在此頁面上，指定如何根據地圖背景、地圖主題、要視覺化的欄位，以及要改變的項目 (色彩、大小和/或標記類型) 視覺化資料。

###  <a name="what-does-the-theme-do"></a><a name="Theme"></a>主題的用途為何？
 您所選擇的主題會設定色彩、框線與字型的預設值。 您可以在完成精靈後變更這些選項。

###  <a name="what-are-the-legends-and-scales-in-map-preview-for"></a><a name="Legends"></a> 地圖預覽中的圖例和標尺用途為何？
...
-   **圖表.** 圖例會提供指引，以協助解譯地圖上色彩、大小及標記類型的意義。 根據預設，所有圖層的所有規則都會在第一個圖例中顯示資料間隔。 您可以自訂此圖例並在將地圖加入至報表中之後加入圖例。

###  <a name="what-are-rules"></a><a name="Rules"></a> 何謂規則？
...
## <a name="see-also"></a>另請參閱
 [報表疑難排解：地圖報表 &#40;報表產生器和 ssrs&#41;](troubleshoot-reports-map-reports-report-builder-and-ssrs.md) [規劃地圖報表 &#40;報表產生器和 ssrs&#41;](plan-a-map-report-report-builder-and-ssrs.md) [對應 &#40;報表產生器和 ssrs&#41;](maps-report-builder-and-ssrs.md)
