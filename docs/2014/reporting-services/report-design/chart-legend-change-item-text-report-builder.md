...
# <a name="change-the-text-of-a-legend-item-report-builder-and-ssrs"></a>變更圖例項目的文字 (報表產生器及 SSRS)
 ...
 在形狀圖上，您可以變更圖例項目的文字，以顯示有關個別資料點的詳細資訊。 例如，如果您要將資料點的值顯示為圖例中的百分比，可以使用關鍵字 (如 `#PERCENT`)。 您可以配合關鍵字附加 .NET Framework 格式化程式碼來套用數值和日期格式。 如需關鍵字的詳細資訊，請參閱[格式化圖表上的資料點 &#40;報表產生器及 SSRS&#41;](formatting-data-points-on-a-chart-report-builder-and-ssrs.md)。  
