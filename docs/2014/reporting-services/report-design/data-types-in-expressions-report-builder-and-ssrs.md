...
-   在文字方塊中，使用運算式來擷取部分字串。 例如：  
 ...
 如需將`DateTime`字串轉換成資料類型的詳細資訊，請參閱[剖析日期和時間字串](https://go.microsoft.com/fwlink/?LinkId=89703)、[格式化特定文化特性的日期和時間](https://go.microsoft.com/fwlink/?LinkId=89704)，以及在 MSDN 上的[DateTime、DateTimeOffset 和 TimeZoneInfo 之間選擇](https://go.microsoft.com/fwlink/?linkid=110652)。  
