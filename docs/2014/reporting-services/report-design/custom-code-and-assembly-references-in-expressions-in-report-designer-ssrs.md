...
```  
 ...
 將下列程式碼內嵌在定義程式碼區塊後，會顯示 `FixSpelling` 方法的實作。 此範例將示範如何使用完整的參考[!INCLUDE[msCoName](../../includes/msconame-md.md)] [!INCLUDE[dnprdnshort](../../includes/dnprdnshort-md.md)] `StringBuilder`類別。  
...
## <a name="see-also"></a>另請參閱  
 ...
 [將組件參考加入至報表 &#40;SSRS&#41;](add-an-assembly-reference-to-a-report-ssrs.md)   
