...
# <a name="sparklines-and-data-bars-report-builder-and-ssrs"></a>走勢圖和資料橫條 (報表產生器和 SSRS)
 ...
 若要快速地開始使用走勢圖，請參閱[教學課程：將走勢圖加入至您的報表&#40;報表產生器&#41;](../tutorial-add-a-sparkline-to-your-report-report-builder.md)和視訊[How to:在資料表中建立走勢圖](https://go.microsoft.com/fwlink/?LinkId=197092)並[走勢圖、 橫條圖與指標在報表產生器](https://technet.microsoft.com/bi/video/ff877165)。  
...
-   [範圍圖表&#40;報表產生器及 SSRS&#41;](range-charts-report-builder-and-ssrs.md):股票圖、K 線圖、誤差線與盒狀圖。  
...
## <a name="see-also"></a>另請參閱  
 ...
 [操作說明：資料表 （影片） 中建立走勢圖](https://go.microsoft.com/fwlink/?LinkId=197092)  
