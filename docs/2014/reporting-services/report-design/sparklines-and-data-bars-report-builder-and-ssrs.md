...
-   [直條圖 &#40;報表產生器和 SSRS&#41;](charts-report-builder-and-ssrs.md)：基本、堆疊和100% 堆疊直條圖。  
  
-   [折線圖 &#40;報表產生器和 SSRS&#41;](line-charts-report-builder-and-ssrs.md)：3d 折線圖以外的所有圖表。  
  
-   [區域圖 &#40;報表產生器和 SSRS&#41;](area-charts-report-builder-and-ssrs.md)：3d 區域圖以外的所有部分  
  
-   [圓形圖 &#40;報表產生器和 SSRS&#41;](pie-charts-report-builder-and-ssrs.md)：和環圈圖（平面和立體），但不是漏斗圖和金字塔圖之類的其他形狀。  
  
-   [範圍圖表 &#40;報表產生器和 SSRS&#41;](range-charts-report-builder-and-ssrs.md)： stock、k 線、誤差線和盒狀圖。  
...
-   [橫條圖 &#40;報表產生器和 SSRS&#41;](bar-charts-report-builder-and-ssrs.md)： [基本]、[堆疊] 和 [100% 堆疊橫條圖]。  
  
-   [直條圖 &#40;報表產生器和 SSRS&#41;](charts-report-builder-and-ssrs.md)：基本、堆疊和100% 堆疊直條圖。 直條圖可以是走勢圖或資料橫條。  

##  <a name="AlignDatainTableMatrix"></a>對齊資料表或矩陣中的走勢圖資料  
...
##  <a name="UnderstandScope"></a>瞭解提供給走勢圖或資料橫條的資料  
...
##  <a name="HowTo"></a>How to 主題  
 [&#40;報表產生器和 SSRS 新增走勢圖和資料橫條&#41;](sparklines-and-data-bars-report-builder-and-ssrs.md)  
...
## <a name="see-also"></a>另請參閱  
 ...
 [報表產生器中的走勢圖、橫條圖和指標（影片）](https://technet.microsoft.com/bi/video/ff877165)   
