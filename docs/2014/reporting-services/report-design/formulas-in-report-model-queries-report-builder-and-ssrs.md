...
# <a name="formulas-in-report-model-queries-report-builder-and-ssrs"></a>報表模型查詢中的公式 (報表產生器及 SSRS)
 ...
 公式不是 RDL 運算式，開頭不得為等號 (=)。 如需 RDL 運算式的詳細資訊，請參閱[運算式 &#40;報表產生器及 SSRS&#41;](expressions-report-builder-and-ssrs.md)。  
...
-   `SUM`(`IF`(**完成貨物旗標**、 「 完成 」、 「 未完成 」))  
  
 定義公式之後，您可以使用查詢設計工具查看結果。  
...
##  <a name="Functions"></a> 函數  
 ...
 ![函式的範例。](../media/functionexample.gif "函式的範例。")  
