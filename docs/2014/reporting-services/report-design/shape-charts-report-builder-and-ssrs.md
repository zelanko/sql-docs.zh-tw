...
# <a name="shape-charts-report-builder-and-ssrs"></a>形狀圖 (報表產生器及 SSRS)
 ...
 漏斗圖會將值顯示為逐漸減少的比例。 區域的大小取決於所有值總計中所佔百分比的數列值。 例如，您可能會使用漏斗圖來顯示網站訪客的趨勢。 漏斗圖在頂端可能會顯示一個寬廣的區域，表示訪客點擊首頁的次數，而其他區域在比例上會比較小。 如需如何將資料加入漏斗圖中的詳細資訊，請參閱 [圖表 &#40;報表產生器及 SSRS&#41;](charts-report-builder-and-ssrs.md)。  
  
 下圖顯示漏斗圖的範例。  
  
 ![漏斗圖](../media/rs-funnelchart.gif "漏斗圖")  
