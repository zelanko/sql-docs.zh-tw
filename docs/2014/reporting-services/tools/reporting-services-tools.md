...
|工具|描述|如何存取|  
|----------|-----------------|-------------------|  
|[!INCLUDE[ssCrescent](../../includes/sscrescent-md.md)]|互動式的資料探索和視覺呈現體驗設計為可讓您建立以及與依據 [!INCLUDE[ssASnoversion](../../includes/ssasnoversion-md.md)] 表格式模型的報表進行互動。<br /><br /> 注意：在[!INCLUDE[ssRSnoversion](../../includes/ssrsnoversion-md.md)] SharePoint 模式中需要。|Sliverlight 瀏覽器|  
...
## <a name="tools-for-report-server-administration"></a>適用於報表伺服器管理的工具  
 一組圖形和腳本工具可用於管理中[!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] [!INCLUDE[ssRSnoversion](../../includes/ssrsnoversion-md.md)]的報表伺服器。 所使用工具取決於報表伺服器的部署模式。  
...
## <a name="tools-for-report-content-management"></a>用於報表內容管理的工具  
 一組圖形和腳本工具可用於管理中[!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] [!INCLUDE[ssRSnoversion](../../includes/ssrsnoversion-md.md)]的內容。 所使用工具取決於報表伺服器的部署模式。  
