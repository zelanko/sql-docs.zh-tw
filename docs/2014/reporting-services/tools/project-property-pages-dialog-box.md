 ...
 **TargetServerVersion**  
 [!INCLUDE[ssKatmai](../../includes/sskatmai-md.md)]選取[!INCLUDE[ssKilimanjaro](../../includes/sskilimanjaro-md.md)]或版本[!INCLUDE[ssRSnoversion](../../includes/ssrsnoversion-md.md)]的，或選取 [偵測**版本**]，以自動判斷安裝在**TargetServer URL**屬性所識別之伺服器上的版本。 伺服器預設值是 **SQL Server 2008 R2**。  
 ...
 **TargetServerURL**  
 ...
 發行至以 SharePoint 整合模式執行的報表伺服器時，請使用 SharePoint 頂層網站或子網站的 URL。 若未指定網站，則會使用預設的最上層網站。 例如，HTTP://\<*servername>*、HTTP://<*servername*/\<*site>* 或 HTTP://\<*servername>* / \< *site>* / \<*子網站>*。  
