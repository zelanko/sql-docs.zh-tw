---
title: 地圖色彩規則對話方塊、 一般 |Microsoft 文件
ms.custom: ''
ms.date: 06/14/2017
...
## <a name="see-also"></a>另請參閱  
 ...
 [變更地圖圖例、 色階與相關的規則&#40;報表產生器和 SSRS&#41;](report-design/change-map-legends-color-scale-and-associated-rules-report-builder-and-ssrs.md)  
