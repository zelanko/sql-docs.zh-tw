---
title: 填滿對話方塊 （報表產生器及 SSRS） |Microsoft 文件
ms.custom: ''
ms.date: 06/13/2017
 ...
 **使用此映像**  
 ...
 如果您選取 [外部] 選項，輸入影像的 URL。 對於發行到設定為原生模式報表伺服器報表，使用完整或相對路徑 (例如 http://*\<servername >*/images/image1.jpg)。 對於發行到設定為 SharePoint 整合模式之報表伺服器報表，請使用完整的 URL (例如 http://*\<sharepoint 伺服器名稱 > /\<網站 >*  /文件/映像image1.jpg)。  
