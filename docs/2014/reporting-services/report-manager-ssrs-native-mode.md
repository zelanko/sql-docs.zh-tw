...
> [!NOTE]  
>  如需支援的瀏覽器和版本資訊，請參閱[規劃 Reporting Services 和 Power View 瀏覽器支援&#40;Reporting Services 2014&#41;](../../2014/reporting-services/browser-support-for-reporting-services-and-power-view.md)。  
...
2.  在網頁瀏覽器的網址列中，輸入報表管理員 URL。  
    ...
    -   預設 URL 為 `http://[ComputerName]/reports`。  
...
##  <a name="bkmk_icon_descriptions"></a> 圖示描述  
 下表描述報表管理員中使用的圖示。 如需有關在報表工具列中顯示的圖示的詳細資訊，請參閱[HTML 檢視器和報表工具列](html-viewer-and-the-report-toolbar.md)。  
  
|圖示|描述|動作|  
|----------|-----------------|------------|  
|![報表圖示](media/hlp-16doc.gif "報表圖示")|報表|按一下報表圖示或名稱，開啟報表。 報表會在個別視窗中開啟。|  
