---
title: 尋找及檢視報表在報表管理員 （報表產生器及 SSRS） |Microsoft Docs
ms.custom: ''
ms.date: 03/07/2017
...
## <a name="opening-a-report"></a>開啟報表  
 ...
 您也可以從報表產生器用瀏覽的方式直接從報表伺服器開啟報表。 如需詳細資訊，請參閱 <<c0> [ 搜尋報表和其他項目&#40;報表產生器及 SSRS&#41;](searching-for-reports-and-other-items-report-builder-and-ssrs.md)。</c0>  
