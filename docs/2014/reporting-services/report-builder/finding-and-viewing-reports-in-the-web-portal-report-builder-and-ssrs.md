---
title: 尋找及檢視報表在報表管理員 （報表產生器及 SSRS） |Microsoft 文件
ms.custom: ''
ms.date: 03/07/2017
...
## <a name="navigating-the-folder-hierarchy-in-report-manager"></a>在報表管理員中導覽資料夾階層  
 ...
 ![報表管理員功能區及瀏覽](../media/rs-reportmanager-ribbon.gif "報表管理員功能區及瀏覽")  
報表管理員功能區  
