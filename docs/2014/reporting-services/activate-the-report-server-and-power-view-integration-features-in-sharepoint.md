...
# <a name="activate-the-report-server-and-power-view-integration-features-in-sharepoint"></a>在 SharePoint 中啟用報表伺服器和 Power View 整合功能
 ...
 當沒有根網站集合，[!INCLUDE[ssRSnoversion](../includes/ssrsnoversion-md.md)]增益集將會記錄類似下列訊息。  
  
 「SharePoint Web 應用程式 80 沒有根網站集合」  
  
 此訊息可在名為 “RS_SP_#.log” 的增益集安裝記錄中找到，其中 # 是遞增的數字。 此記錄檔可在目前使用者的 Temp 資料夾中找到，例如 C:\Users\\[使用者名稱]\AppData\Local\Temp。如需有關增益集的記錄選項的詳細資訊，請參閱[安裝或解除安裝 Reporting Services 增益集的 SharePoint &#40;SharePoint 2010 和 SharePoint 2013&#41;](install-windows/install-or-uninstall-the-reporting-services-add-in-for-sharepoint.md)。  
