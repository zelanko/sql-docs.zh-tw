 ...
 **注意** ：如需可用的 URL 存取參數清單，請參閱 [URL 存取參數參考](url-access-parameter-reference.md)。 如需透過 URL 傳遞報表參數的範例，請參閱 [在 URL 內傳遞報表參數](pass-a-report-parameter-within-a-url.md)。  
