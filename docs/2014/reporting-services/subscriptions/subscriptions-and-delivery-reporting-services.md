...
-   [Reporting Services 中的 SharePoint 文件庫傳遞](sharepoint-library-delivery-in-reporting-services.md)描述 SharePoint 文件庫的訂閱傳遞。  
  
-   [資料驅動訂閱](data-driven-subscriptions.md)提供有關使用資料驅動訂閱在執行時間自訂報表輸出的資訊。  
