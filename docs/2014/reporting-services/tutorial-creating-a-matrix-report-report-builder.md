...
##  <a name="CreateMatrix"></a>1. 從 [新增資料表或矩陣] Wizard 建立矩陣報表和資料集  
...
##  <a name="Groups"></a>2. 從 [新增資料表或矩陣] Wizard 組織資料並選擇版面配置和樣式  
...
##  <a name="AdjacentGroup"></a>4. 加入連續的資料行群組  
...
##  <a name="RotateTextBox"></a>9. （選擇性）旋轉文字方塊270度  
