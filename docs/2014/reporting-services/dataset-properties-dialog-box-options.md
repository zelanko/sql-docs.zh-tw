---
title: 資料集屬性對話方塊、 選項 |Microsoft 文件
ms.custom: ''
ms.date: 03/07/2017
...
# <a name="dataset-properties-dialog-box-options"></a>資料集屬性對話方塊、選項
  選取**選項**上**DatasetProperties**對話方塊來變更資料的選項，例如定序選項和小計的查詢。 如需詳細資訊，請參閱 [Collation and Unicode Support](../relational-databases/collations/collation-and-unicode-support.md)。  
