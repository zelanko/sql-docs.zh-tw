...
##  <a name="Chart"></a> 1.從圖表精靈建立圖表報表  
 從**入門**對話方塊中，建立內嵌資料集、 選擇共用的資料來源，以及使用圖表精靈 建立橫條圖。  
...
1.  按一下 **[開始]**、依序指向 **[程式集]** 和 **[Microsoft SQL Server 2012 報表產生器]**，然後按一下 **[報表產生器]**。  
    ...
    > [!NOTE]  
    >  如果**入門**對話方塊不會出現，按一下 [報表產生器] 按鈕，然後按一下**新增**。  
...
2.  垂直軸，以滑鼠右鍵按一下，然後按一下 **垂直軸屬性**。  
  
3.  在 [軸範圍和間隔] 的 [間隔] 方塊中，鍵入 **1**。  
  
4.  [!INCLUDE[clickOK](../includes/clickok-md.md)]  
  
5.  以滑鼠右鍵按一下垂直**軸標題**清除**顯示軸標題**核取方塊。  
...
8.  回到上**類別目錄群組屬性**頁面上，於**順序**下拉式清單中，選取**Z 到 A**。這樣會選取反向字母順序，如此這些名稱就會按照由上而下的順序顯示。  
  
9. [!INCLUDE[clickOK](../includes/clickok-md.md)]  
  
10. 按一下 **[執行]** 預覽報表。  
  
 水平軸上的名稱會依反向順序排序，與**Alerca**頂端和**Zeng**底部。  
...
2.  選取的文字**圖表標題**頂端的圖表，然後輸入下列文字： **Sales for 2008 和 2009 年**。  
...
2.  沿著圖表的底部，按一下以選取水平軸。  
     ...
     在功能區 上**首頁**索引標籤的**數目**群組中，按一下**貨幣** 按鈕。 水平軸標籤就會變更為貨幣。  
...
7.  以滑鼠右鍵按一下**軸標題**按一下**軸標題屬性**。  
  
8.  在**標題文字**方塊中，輸入**銷售單位： 千**按一下**確定**。  
...
2.  型別**銷售橫條圖**中按下 ENTER，然後再輸入**五個 2009年年前**，因此它看起來像這樣：  
...
4.  選取**五個 2009年年前**，然後在**字型**區段**首頁**索引標籤上，將字型大小設定為**10**。  
