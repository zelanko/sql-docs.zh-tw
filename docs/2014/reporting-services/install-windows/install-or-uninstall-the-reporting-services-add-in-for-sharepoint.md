...
##  <a name="what-does-the-add-in-install"></a><a name="bkmk_whatinstalled"></a>增益集的安裝內容為何？
...
##  <a name="setup-log-files"></a><a name="bkmk_logfiles"></a>安裝程式記錄檔
...
##  <a name="upgrade"></a><a name="bkmk_upgrade"></a>更新
...
##  <a name="rscustomactionexe"></a><a name="bkmk_rscustomaction"></a>Rscustomaction.exe .exe
