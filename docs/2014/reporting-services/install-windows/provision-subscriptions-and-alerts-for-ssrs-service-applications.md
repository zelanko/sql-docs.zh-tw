...
3.  展開**Microsoft SharePoint 2010 產品**按一下**SharePoint 2010 管理命令介面**。  
...
1.  若要開啟 SQL Server Management Studio，在**啟動**功能表上，按一下  **Microsoft SQL Server 2012**按一下**SQL Server Management Studio**。  
