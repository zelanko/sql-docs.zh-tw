...
## <a name="see-also"></a>另請參閱  
 [將 Web 或應用程式伺服器加入至伺服器陣列（SharePoint Server 2010）](https://technet.microsoft.com/library/bb218968.aspx?missingurl=%2fen-us%2flibrary%2fe1aeaddf-6ee4-43a9-82b7-db20b68c71db\(Office.14\))   
