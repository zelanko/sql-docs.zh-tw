...
# <a name="where-to-find-the-reporting-services-add-in-for-sharepoint-products"></a>尋找適用於 SharePoint 產品之 Reporting Services 增益集的位置
  [!INCLUDE[msCoName](../../includes/msconame-md.md)] [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] [!INCLUDE[ssRSnoversion](../../includes/ssrsnoversion-md.md)] (SSRS) 增益集的 SharePoint 產品與技術 (rsSharePoint.msi) 是一種 Web 下載，它提供整合報表伺服器與 SharePoint 部署的功能。  
...
-   如果是從命令提示字元進行安裝，請使用 **RS_SHPWFE** 選項來安裝此增益集。 如需詳細資訊[!INCLUDE[ssRSnoversion](../../includes/ssrsnoversion-md.md)]命令提示字元安裝，請參閱[命令提示字元安裝的 Reporting Services SharePoint 模式和原生模式](install-reporting-services-at-the-command-prompt.md)。  
...
##  <a name="bkmk_sql2008r2"></a> SQL Server 2008 R2 Reporting Services 增益集適用於 SharePoint 2010 產品  
 適用於 Microsoft SharePoint 2010 產品的 Microsoft SQL Server 2008 R2 Reporting Services 增益集是由 SharePoint 2010 產品準備工具 (**PreRequisiteInstaller.exe**) 安裝。 如果您想要分別下載和安裝增益集，此檔案的最新版本位於線上[!INCLUDE[msCoName](../../includes/msconame-md.md)]Download Center [SQL Server 2008 R2 Reporting Services 增益集適用 Microsoft SharePoint Technologies 2010](http://go.microsoft.com/fwlink/?LinkID=164654).  
...
##  <a name="bkmk_sql2008sp2"></a> SQL Server 2008 SP2 Reporting Services 增益集適用 SharePoint 2007 產品與技術  
 ...
 此檔案的最新版本位於線上[!INCLUDE[msCoName](../../includes/msconame-md.md)]Download Center [Microsoft SQL Server 2008 SP2 Reporting Services 增益集適用於 Microsoft SharePoint 技術](http://go.microsoft.com/fwlink/?LinkID=204594)。  
...
##  <a name="bkmk_sql2008"></a> SQL Server 2008 Reporting Services 增益集適用 SharePoint 2007 產品與技術  
 ...
 此檔案的最新版本位於線上[!INCLUDE[msCoName](../../includes/msconame-md.md)]Download Center [Microsoft SQL Server 2008 Reporting Services 增益集適用於 Microsoft SharePoint 技術](http://go.microsoft.com/fwlink/?LinkID=204813)。  
...
## <a name="see-also"></a>另請參閱  
 ...
 [將報表伺服器內容類型加入至文件庫&#40;Reporting Services SharePoint 整合模式&#41;](../add-reporting-services-content-types-to-a-sharepoint-library.md)   
