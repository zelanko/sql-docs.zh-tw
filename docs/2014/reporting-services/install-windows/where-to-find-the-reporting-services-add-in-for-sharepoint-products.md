...
##  <a name="sql-server-2008-r2-reporting-services-add-in-for-sharepoint-2010-products"></a><a name="bkmk_sql2008r2"></a>適用于 SharePoint 2010 產品的 SQL Server 2008 R2 Reporting Services 增益集  
...
##  <a name="sql-server-2008-sp2-reporting-services-add-in-for-sharepoint-2007-products-and-technologies"></a><a name="bkmk_sql2008sp2"></a>適用于 SharePoint 2007 產品和技術的 SQL Server 2008 SP2 Reporting Services 增益集  
...
##  <a name="sql-server-2008-reporting-services-add-in-for-sharepoint-2007-products-and-technologies"></a><a name="bkmk_sql2008"></a>適用于 SharePoint 2007 產品和技術的 SQL Server 2008 Reporting Services 增益集  
