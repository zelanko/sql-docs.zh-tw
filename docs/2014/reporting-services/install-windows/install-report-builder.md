---
title: 安裝獨立版的報表產生器（報表產生器） |Microsoft Docs
ms.custom: ''
ms.date: 12/29/2017
...
7.  閱讀 [**授權合約**] 頁面上的合約，然後選取 [**我接受授權合約中的條款**] 選項。 按一下 **[下一步]** 。  
  
8.  提供您的個人姓名和公司名稱。 按一下 **[下一步]** 。  
  
9. 在 [**特徵選取**] 頁面上，選擇性地按一下 **[流覽] 或 [** **磁片成本**]。 按一下 **[下一步]** 。  
...
10. 在 **[預設的目標伺服器]** 頁面上，選擇性地提供目標報表伺服器的 URL (如果它與預設值不同的話)。 按一下 **[下一步]** 。  
...
4.  閱讀 [**授權合約**] 頁面上的合約，然後選取 [**我接受授權合約中的條款**] 選項。 按一下 **[下一步]** 。  
  
5.  提供您的個人姓名和公司名稱。 按一下 **[下一步]** 。  
  
6.  在 [**特徵選取**] 頁面上，選擇性地按一下 **[流覽] 或 [** **磁片成本**]。 按一下 **[下一步]** 。  
...
7.  在 **[預設的目標伺服器]** 頁面上，選擇性地提供目標報表伺服器的 URL (如果它與預設值不同的話)。 按一下 **[下一步]** 。  
