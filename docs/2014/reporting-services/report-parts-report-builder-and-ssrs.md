...
##  <a name="ComponentWorkflow"></a>報表元件的生命週期  
...
##  <a name="PublishingComponents"></a>發行報表元件  
...
##  <a name="ReusingComponents"></a>重複使用報表元件  
...
##  <a name="UpdatingComponents"></a>以伺服器的變更更新報表元件  
...
##  <a name="RepublishingComponents"></a>更新已經在伺服器上的報表元件  
...
##  <a name="RptPartsRptDesigner"></a>在報表設計師中使用報表元件  
