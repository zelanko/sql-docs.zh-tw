---
title: 第 1 課：建立中繼資料採礦方案 （中繼資料採礦教學課程） |Microsoft Docs
ms.custom: ''
ms.date: 03/06/2017
...
# <a name="lesson-1-creating-the-intermediate-data-mining-solution-intermediate-data-mining-tutorial"></a>第 1 課：建立中繼資料採礦方案 （中繼資料採礦教學課程）
 ...
 在此教學課程中，您將會使用 [!INCLUDE[ssASnoversion](../includes/ssasnoversion-md.md)] 來建立個別的 [!INCLUDE[ssBIDevStudioFull](../includes/ssbidevstudiofull-md.md)]專案。 您將會建立一個使用 [!INCLUDE[ssASnoversion](../includes/ssasnoversion-md.md)] 的 [!INCLUDE[ssSampleDBDWobject](../includes/sssampledbdwobject-md.md)]資料來源，並將數個新的資料來源檢視加入到該資料來源中，以支援案例與模型類型。  
  
 這一課包含下列工作：  
  
-   [建立方案與資料來源&#40;中繼資料採礦教學課程&#41;](../../2014/tutorials/creating-a-solution-and-data-source-intermediate-data-mining-tutorial.md)  
