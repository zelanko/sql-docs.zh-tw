---
title: 工作 3： 建立和執行資料品質專案以進行比對 |Microsoft 文件
ms.custom: ''
ms.date: 04/27/2017
...
1.  主頁面上**DQS 用戶端**，按一下 **新增資料品質專案**。  
  
2.  型別**移除供應商重複項目**從**專案名稱**。  
  
3.  選取**供應商**從清單中的 Kb**使用知識庫**欄位。 在上一課，您已經在此知識庫中建立比對原則。  
  
4.  選取**比對**從**活動清單**從右下方的窗格。  
...
7.  按一下**瀏覽**選取**Cleansed Supplier List.xls**，這是清理活動的輸出檔案。  
  
8.  地圖**SupplierID**來源資料行**Supplier ID**網域**Supplier Name**資料行**Supplier Name**網域及**ContactEmailAddress**欄**Contact Email**網域。  
