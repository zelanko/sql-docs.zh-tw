...
# <a name="lesson-3-adding-and-processing-models"></a>第 3 課：新增及處理模型
 ...
 若要完成本課程中的工作，您將使用[Microsoft 群集演算法](../../2014/analysis-services/data-mining/microsoft-clustering-algorithm.md)和[Microsoft 貝氏貝氏機率分類演算法](../../2014/analysis-services/data-mining/microsoft-naive-bayes-algorithm.md)。  
