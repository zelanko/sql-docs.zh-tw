...
1.  流覽**** 至或您在**http://localhost/MDS**設定 MDS 時所指定的網站和應用程式，以啟動主資料管理員。 如果您將**主資料管理員**保持開啟，請按一下頂端的 [ **SQL Server 2012 Master Data Services** ，以切換至**首頁**。  
...
15. 在 [**管理連接**] 對話方塊中，選取 [**本機 MDS 伺服器**] （http://localhost/MDS)，按一下 [**測試**] 以測試連接。 在訊息方塊上按一下 **[確定]** 。  
