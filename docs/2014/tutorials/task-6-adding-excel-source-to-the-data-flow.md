...
2.  以滑鼠右鍵按一下 [資料流程] 索引標籤中的 [ **Excel 來源**], 然後按一下 [**重新命名**]。  
...
7.  在 [ **Excel 來源編輯器**] 對話方塊中, 于 [ **excel 工作表的名稱**] 清單方塊中選取 [ **IncomingSuppliers $** ]。  
     ...
     ![Excel 工作表的名稱-連入供應商 $](../../2014/tutorials/media/et-addingexcelsourcetothedataflow-02.jpg "Excel 工作表的名稱-連入供應商 $")  
