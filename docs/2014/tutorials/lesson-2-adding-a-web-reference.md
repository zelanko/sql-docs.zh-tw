---
title: 第 2 課： 加入 Web 參考 |Microsoft 文件
ms.custom: ''
ms.date: 03/06/2017
...
4.  在**URL**方塊**加入 Web 參考**對話方塊方塊中，輸入可取得服務描述的報表伺服器 Web 服務，例如 URL http://localhost/reportserver/reportservice2010.asmx。 然後按一下 **移**按鈕，以擷取 Web 服務的相關資訊。  
  
     \- 或 -  
  
     如果報表伺服器 Web 服務存在於本機電腦上，按一下**本機電腦上的 Web 服務**瀏覽器窗格中的連結。 然後按一下所提供清單中的 ReportService2010 Web 服務連結。  
  
5.  在**Web 參考名稱**方塊中，Web 參考重新命名為 ReportService2010，這是您將針對這個 Web 參考使用的命名空間。  
