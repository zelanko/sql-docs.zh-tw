---
title: 存取報表伺服器 Web 服務使用 Visual Basic 或 Visual C# （SSRS 教學課程） |Microsoft Docs
ms.custom: ''
ms.date: 03/06/2017
...
-   用戶端應用程式使用下列方法建立[!INCLUDE[msCoName](../includes/msconame-md.md)][!INCLUDE[vs_dev10_long](../includes/vs-dev10-long-md.md)]主控台應用程式專案範本。  
