---
title: 了解需求時間序列模型 （中繼資料採礦教學課程） |Microsoft Docs
ms.custom: ''
ms.date: 03/06/2017
...
3.  在資料來源檢視設計介面中，選取 Reporting Date 資料行，然後選取**屬性**。 接下來，按一下資料行 TimeIndex，然後選取**屬性**。  
...
1.  在窗格**SalesByRegion.dsv**，選取 vTimeSeries 資料表。  
  
2.  以滑鼠右鍵按一下資料行，而 Reporting Date，然後選取**設定邏輯主索引鍵**。  
...
-   以滑鼠右鍵按一下  索引標籤中，**瀏覽 vTimeSeries 資料表**，然後選取**關閉**。  
