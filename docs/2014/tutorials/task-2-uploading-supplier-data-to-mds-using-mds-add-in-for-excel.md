...
5.  在 [**管理連接**] 對話方塊中，如果您在 [**現有連接**] 下看不到**本機 MDS 伺服器**的連接，請執行下列動作：  
    ...
    2.  在 [**加入新連接**] 對話方塊中，針對 [**描述** **http://localhost/MDS** ] 和 [ **Mds 伺服器位址**] 輸入**本機 MDS 伺服器**，然後按一下 **[確定**] 關閉對話方塊。  
  
6.  在 [**管理連接**] 對話方塊中，選取 [**本機 MDS 伺服器**] （http://localhost/MDS)，按一下 [**測試**] 以測試連接。 在訊息方塊上按一下 **[確定]** 。  
