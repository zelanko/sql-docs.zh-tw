...
-   **連接管理員** 使用含有不同字碼頁識別碼的變數來設定一般檔案連接管理員的字碼頁；或是在運算式中輸入如 3 的正整數，以指定資料檔中要跳過的資料列數。  
 ...
 若要深入了解屬性運算式以及撰寫運算式，請參閱[在封裝中使用屬性運算式](use-property-expressions-in-packages.md)和 [Integration Services &#40;SSIS&#41; 運算式](integration-services-ssis-expressions.md)。  
