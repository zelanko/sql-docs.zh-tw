...
# <a name="data-mining-query-task-editor-query-tab"></a>資料採礦查詢工作編輯器 (查詢索引標籤)
 ...
 若要深入了解在封裝中實作資料採礦，請參閱 [資料採礦查詢工作](control-flow/data-mining-query-task.md) 和 [資料採礦方案](../analysis-services/data-mining/data-mining-solutions.md)。  
