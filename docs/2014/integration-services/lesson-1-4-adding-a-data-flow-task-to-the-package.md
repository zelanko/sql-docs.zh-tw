...
3.  在**控制流程**設計介面中，以滑鼠右鍵按一下新加入**Data Flow Task**，按一下 **重新命名**，並將名稱變更為`Extract Sample Currency Data`。  
...
4.  以滑鼠右鍵按一下資料流程工作中，按一下**屬性**，然後在 [屬性] 視窗中，確認`LocaleID`屬性設定為**英文 （美國）**。  
