...
8.  藉由執行下列工作，在第二個資料流程中加入查閱轉換，然後設定該轉換：  
    ...
    9. 若要設定錯誤輸出，按一下 **[錯誤輸出]** 頁面，然後設定錯誤處理選項。 如需詳細資訊，請參閱[查閱轉換編輯器 &#40;錯誤輸出頁面&#41;](../lookup-transformation-editor-error-output-page.md)。  
...
13. 開啟父封裝，在控制流程中加入執行封裝工作，然後將工作設定為呼叫子封裝。 如需詳細資訊，請參閱 [執行封裝工作](../control-flow/execute-package-task.md)。  
