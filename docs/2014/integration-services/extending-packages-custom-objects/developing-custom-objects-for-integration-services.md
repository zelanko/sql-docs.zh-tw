...
ms.locfileid: "85469313"
---
# <a name="developing-custom-objects-for-integration-services"></a>開發 Integration Services 的自訂物件
  當 [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] [!INCLUDE[ssISnoversion](../../includes/ssisnoversion-md.md)] 隨附的控制流程與資料流程物件無法完全滿足需求時，您可以自行開發許多類型的自訂物件，包括：
...
|自訂物件|基底類別|屬性|重要的方法|
|-------------------|----------------|---------------|-----------------------|
|Task|[-SqlServer. Task](/dotnet/api/microsoft.sqlserver.dts.runtime.task)|<xref:Microsoft.SqlServer.Dts.Runtime.DtsTaskAttribute>|<xref:Microsoft.SqlServer.Dts.Runtime.Task.Execute%2A>|
...
-   [DTSPipelineComponentAttribute. n * （）](/dotnet/api/microsoft.sqlserver.dts.pipeline.dtspipelinecomponentattribute.helpcollection)
...
-   [DTSTaskAttribute. SamplesTag * （Sql Server）](/dotnet/api/microsoft.sqlserver.dts.runtime.dtstaskattribute.samplestag)

-   [DTSTaskAttribute. n * （Sql Server）](/dotnet/api/microsoft.sqlserver.dts.runtime.dtstaskattribute.helpcollection)

-   [DTSTaskAttribute. HelpKeyword * （Sql Server）](/dotnet/api/microsoft.sqlserver.dts.runtime.dtstaskattribute.helpkeyword)
...
|-------------------|-----------------------------------|----------------------------------------------------------------------|
|Task|<xref:Microsoft.SqlServer.Dts.Runtime.Design.IDtsTaskUI>|僅 [屬性] 視窗|
...
## <a name="see-also"></a>另請參閱
 [保存自訂物件](persisting-custom-objects.md)[建立、部署和自訂物件的調試](building-deploying-and-debugging-custom-objects.md)
