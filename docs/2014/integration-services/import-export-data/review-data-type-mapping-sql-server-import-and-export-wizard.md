...
|**目的地資料行**|顯示目的地資料行的名稱。|  
|**目的地類型**|顯示目的地資料行的資料類型。|  
|**將**|指定是否應該繼續進行規劃的轉換：<br /><br /> 選取此核取方塊，即可讓精靈繼續進行規劃的轉換。<br /><br /> 清除此核取方塊，即可取消資料類型轉換。|  
|**發生錯誤時**|指定精靈如何處理錯誤：<br /><br /> 使用 [**錯誤時（全域）** ] 設定。<br /><br /> 因錯誤而失敗，並停止匯入或匯出程序。<br /><br /> 忽略錯誤。|  
