---
title: 指令碼工作編輯器 （指令碼頁面） |Microsoft 文件
ms.custom: ''
ms.date: 06/13/2017
...
## <a name="see-also"></a>另請參閱  
 ...
 [[一般] 頁面](general-page-of-integration-services-designers-options.md)   
 [指令碼工作編輯器&#40;[一般] 頁面&#41;](../../2014/integration-services/script-task-editor-general-page.md)   
