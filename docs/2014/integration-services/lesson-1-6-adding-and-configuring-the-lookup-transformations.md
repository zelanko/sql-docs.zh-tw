...
10. 在 [屬性] 視窗中，確認`LocaleID`屬性設定為**英文 （美國）** 和**DefaultCodePage**屬性設定為**1252年**。  
...
12. 在 [屬性] 視窗中，確認`LocaleID`屬性設定為**英文 （美國）** 和**DefaultCodePage**屬性設定為**1252年**。  
