---
title: 第 2 課：建立部署配套 |Microsoft Docs
ms.custom: ''
ms.date: 06/13/2017
...
ms.locfileid: "53375550"
---
# <a name="lesson-2-creating-the-deployment-bundle"></a>第 2 課：建立部署配套
  在 [第 1 課：準備建立部署配套](../integration-services/lesson-1-preparing-to-create-the-deployment-bundle.md)，您建立[!INCLUDE[ssISnoversion](../includes/ssisnoversion-md.md)]專案名為 部署教學課程、 套件和支援檔案加入專案，以及在封裝中實作組態。  
