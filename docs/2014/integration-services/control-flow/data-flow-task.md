...
# <a name="data-flow-task"></a>資料流程工作
 ...
 若要從文字檔將資料大量插入 [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] 資料庫，您可以使用「大量插入」工作取代資料流程工作和資料流程。 但是，「大量插入」工作無法轉換資料。 如需詳細資訊，請參閱 [大量插入工作](bulk-insert-task.md)。  
