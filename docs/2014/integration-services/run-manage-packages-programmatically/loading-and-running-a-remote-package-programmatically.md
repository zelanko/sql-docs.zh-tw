...
-   視訊[How to:使用 SQL Server Agent （SQL Server 視訊），讓 SSIS 封裝執行自動化](https://technet.microsoft.com/sqlserver/ff686764.aspx)，technet.microsoft.com 上的  
