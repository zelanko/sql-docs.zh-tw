---
title: 匯總轉換編輯器（匯總索引標籤） |Microsoft Docs
ms.custom: ''
ms.date: 06/13/2017
...
>   
>  在彙總轉換中， **[索引鍵]** 和 **[索引鍵小數位數]** 會參考預期要從 **[群組依據]** 作業產生的群組數。 [**計算相異索引鍵**] 和 [**計算相異小**數位數] 會參考預期要從 [**相異計數**] 作業產生的相異值數目。  
...
|**平均線**|傳回資料行中資料行值的平均。 只能平均具有數值資料類型的資料行。 如需詳細資訊，請參閱 AVG。|  
