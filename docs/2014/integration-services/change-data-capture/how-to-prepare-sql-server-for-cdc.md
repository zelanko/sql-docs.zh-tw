...
# <a name="how-to-prepare-sql-server-for-cdc"></a>如何為 CDC 準備 SQL Server
 ...
 為 Oracle CDC 準備 SQL Server 是由 Oracle CDC 服務管理員所執行。 如需有關 CDC 服務管理員角色的詳細資訊，請參閱[Change Data Capture Service for Oracle by Attunity 的使用者角色](user-roles.md)。  
