...
|偵錯|工作和元件在設計環境中偵錯時，透過程式碼支援中斷點與逐步執行。 如需詳細資訊，請參閱[編碼和偵錯指令碼工作](../control-flow/script-task.md)和 [撰寫程式碼和偵錯指令碼元件] (.../ extending-packages-scripting/data-flow-script-component/coding-and-debugging-the-script-component.md。|  
...
## <a name="see-also"></a>另請參閱  
 ...
 [使用 Web 服務在 SSIS 中透過指令碼 (Curated Answer)](http://go.microsoft.com/fwlink/?LinkId=321996)  
