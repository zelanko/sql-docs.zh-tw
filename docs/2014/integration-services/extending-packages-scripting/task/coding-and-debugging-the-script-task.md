...
## <a name="see-also"></a>另請參閱
 [參考腳本解決方案中的其他元件在](../referencing-other-assemblies-in-scripting-solutions.md)[腳本工作編輯器中設定腳本工作](configuring-the-script-task-in-the-script-task-editor.md)
