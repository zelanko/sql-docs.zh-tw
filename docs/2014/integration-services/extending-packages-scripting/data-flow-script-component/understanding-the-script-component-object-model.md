...
## <a name="see-also"></a>另請參閱
 [在腳本元件編輯器中設定腳本元件](configuring-the-script-component-in-the-script-component-editor.md)[編碼和調試腳本元件] （。/extending-packages-scripting/data-flow-script-component/coding-and-debugging-the-script-component.md
