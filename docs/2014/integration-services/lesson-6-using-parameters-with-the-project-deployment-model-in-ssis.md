---
title: 第 6 課： 搭配專案部署模型使用參數 |Microsoft 文件
ms.custom: ''
ms.date: 06/13/2017
...
# <a name="lesson-6-using-parameters-with-the-project-deployment-model"></a>第 6 課：搭配專案部署模型使用參數
 ...
 在這一課，您將修改您在建立封裝[第 5 課： 加入封裝組態的封裝部署模型](lesson-5-add-ssis-package-configurations-for-the-package-deployment-model.md)使用專案部署模型。 您會以參數取代組態值來指定範例資料位置。 您也可以複製此教學課程所包含之已完成的第 5 課封裝。  
...
1.  [步驟 1： 複製第 5 課封裝](lesson-6-1-copying-the-lesson-5-package.md)  
...
## <a name="start-the-lesson"></a>開始課程  
 [步驟 1： 複製第 5 課封裝](lesson-6-1-copying-the-lesson-5-package.md)  
