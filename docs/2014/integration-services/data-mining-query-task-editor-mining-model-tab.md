---
title: 資料採礦查詢工作編輯器 （採礦模型索引標籤） |Microsoft Docs
ms.custom: ''
ms.date: 06/13/2017
...
# <a name="data-mining-query-task-editor-mining-model-tab"></a>資料採礦查詢工作編輯器 (採礦模型索引標籤)
 ...
 若要深入了解在封裝中實作資料採礦，請參閱 [Data Mining Query Task](control-flow/data-mining-query-task.md) (資料採礦查詢工作) 和 [Data Mining Solutions](../analysis-services/data-mining/data-mining-solutions.md)(資料採礦方案)。  
