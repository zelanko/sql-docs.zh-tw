...
-   在 **CREATE** 陳述式的 **FOR** 子句中。 如需詳細資訊，請參閱 [CREATE SELECTIVE XML INDEX &#40;Transact-SQL&#41;](/sql/t-sql/statements/create-selective-xml-index-transact-sql)。  
  
-   在 **ALTER** 陳述式的 **ADD** 子句中。 如需詳細資訊，請參閱 [ALTER INDEX &#40;選擇性 XML 索引&#41;](../indexes/indexes.md)。  
...
## <a name="see-also"></a>另請參閱  
 [選擇性 XML 索引 &#40;SXI&#41;](../xml/selective-xml-indexes-sxi.md)   
 [建立、修改和卸除選擇性 XML 索引](../xml/create-alter-and-drop-selective-xml-indexes.md)  
