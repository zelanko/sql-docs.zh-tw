...
|主題|描述|  
|-----------|-----------------|  
|[Canonical Forms and Pattern Restrictions](canonical-forms-and-pattern-restrictions.md)|說明標準格式與模式限制。|  
...
|[Enumeration Facets](enumeration-facets.md)|描述有關列舉 Facet 的限制。|  
|[Mixed Type and Simple Content](mixed-type-and-simple-content.md)|描述將混合類型限制為簡單內容的限制。|  
