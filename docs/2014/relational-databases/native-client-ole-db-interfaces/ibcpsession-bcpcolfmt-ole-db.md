...
> [!NOTE]  
>  [Ibcpsession:: Bcpcolumns](ibcpsession-bcpcolumns-ole-db.md)任何呼叫之前，必須呼叫方法**BCPColFmt**。 您必須呼叫**BCPColFmt**一次是針對使用者檔案中的每個資料行。 呼叫**BCPColFmt**一次以上的任何使用者檔案資料行導致錯誤。  
 ...
 **請注意** [ibcpsession:: Bcpwritefmt](ibcpsession-bcpwritefmt-ole-db.md)函式可以用來保存透過提供的格式規格**BCPColFmt**。  
...
## <a name="return-code-values"></a>傳回碼值  
 ...
 E_FAIL  
 發生提供者特有的錯誤，詳細的資訊，請使用如[ISQLServerErrorInfo](../../database-engine/dev-guide/isqlservererrorinfo-ole-db.md)介面。  
