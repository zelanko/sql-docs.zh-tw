...
ms.locfileid: "62691854"
---
# <a name="ibcpsession2-ole-db"></a>IBCPSession2 (OLE DB)
  IBCPSession2 介面是提供成員函式的替代選項為每個資料行呼叫 ibcpsession:: Bcpcolfmt IBCPSession 的擴充功能。  IBCPSession2 IBCPSession 會繼承，並加入一個新方法：[IBCPSession2::BCPSetBulkMode](ibcpsession2-bcpsetbulkmode.md)。  
