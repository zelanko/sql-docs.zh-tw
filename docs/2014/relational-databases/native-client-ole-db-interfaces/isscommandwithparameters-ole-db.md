...
|[ISSCommandWithParameters：： SetParameterProperties &#40;OLE DB&#41;](isscommandwithparameters-setparameterproperties-ole-db.md)|根據序數，設定每個參數的參數屬性，或指定**SSPARAMPROPS**結構的陣列來設定大量參數屬性。|  
