...
-   [!INCLUDE[ssManStudioFull](../includes/ssmanstudiofull-md.md)]的使用者。 [!INCLUDE[ssManStudio](../includes/ssmanstudio-md.md)] 的安裝方式是執行 [!INCLUDE[ssNoVersion](../includes/ssnoversion-md.md)] 安裝程式或從 [Microsoft 下載中心](http://go.microsoft.com/fwlink/?LinkId=144346)下載並安裝。  
