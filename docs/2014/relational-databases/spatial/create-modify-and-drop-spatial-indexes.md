 ...
 **若要使用 Management Studio 中的資料表設計工具來建立空間索引**  
...
###  <a name="drop"></a>若要卸載空間索引  
 **若要使用 Transact-sql 卸載空間索引**  
 [DROP INDEX &#40;Transact-SQL&#41;](/sql/t-sql/statements/drop-index-transact-sql)  
  
 **若要使用 Management Studio 卸載索引**  
 [刪除索引](../indexes/delete-an-index.md)  
  
 **若要使用中的資料表設計工具卸載空間索引 Management Studio**  
