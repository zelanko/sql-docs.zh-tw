...
-   [處理結果操作說明主題 &#40;OLE DB&#41;](results/processing-results-how-to-topics-ole-db.md)  
  
-   [設定大型資料&#40;OLE DB&#41;](set-large-data-ole-db.md)  
  
-   [列舉 OLE DB 資料來源 &#40;OLE DB&#41;](enumerate-ole-db-data-sources-ole-db.md)  
  
-   [使用 IRowsetFastLoad 大量複製資料 &#40;OLE DB&#41;](../native-client-ole-db-interfaces/irowsetfastload-ole-db.md)  
  
-   [取得 FAST_FORWARD 資料指標](obtain-a-fast-forward-cursor.md)  
  
-   [使用書籤擷取資料列 &#40;OLE DB&#41;](retrieve-rows-using-bookmarks-ole-db.md)  
  
-   [使用 IRow::GetColumns &#40;或 IRow::Open&#41; 和 ISequentialStream 擷取資料行](fetch-columns-using-irow-getcolumns-or-irow-open-and-isequentialstream.md)  
...
-   [檔案資料流及 OLE DB](filestream/filestream-and-ole-db.md)  
