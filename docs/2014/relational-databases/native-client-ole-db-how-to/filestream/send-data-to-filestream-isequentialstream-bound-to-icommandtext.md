---
title: 將資料傳送到 FILESTREAM 資料行使用 ISequentialStream Bound to ICommandText 參數 (OLE DB) |Microsoft 文件
ms.custom: ''
ms.date: 03/08/2017
...
## <a name="example"></a>範例  
 在編譯和執行此範例之前，啟用 FILESTREAM 支援 ([Enable and Configure FILESTREAM](../../blob/enable-and-configure-filestream.md))。  
 ...
 複製第三個程式碼清單並將它貼入名為 ICommandUpload.cpp 的檔案中。  
  
 編譯 ICommandUpload.cpp、ISSHelper.cpp、ole32.lib 和 oleaut32.lib。  
