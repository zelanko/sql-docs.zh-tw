...
## <a name="create-the-database-and-resource-pool"></a>建立資料庫和資源集區  
...
## <a name="bind-the-database-to-the-pool"></a>將資料庫繫結至集區  
...
## <a name="confirm-the-binding"></a>確認繫結  
...
## <a name="make-the-binding-effective"></a>使繫結生效  
