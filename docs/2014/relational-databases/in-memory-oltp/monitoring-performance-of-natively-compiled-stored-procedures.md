...
```  
 ...
 如需有關`sp_statement_completed`擴充事件的詳細資訊，請參閱[如何取出造成事件的語句](https://blogs.msdn.com/b/extended_events/archive/2010/05/07/making-a-statement-how-to-retrieve-the-t-sql-statement-that-caused-an-event.aspx)。  
