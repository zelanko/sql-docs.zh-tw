...
## <a name="specifying-conditions"></a>指定條件  
 指定的運算式必須是評估為布林值的有效 Transact-SQL 運算式。 如需詳細資訊，請參閱[&#40;transact-sql&#41;的運算式](/sql/t-sql/language-elements/expressions-transact-sql)。  
...
3.  如果您想要在運算式評估為`true`時中斷，請選擇 [**是 true** ]，如果您想要在運算式的值變更時中斷，請選擇 [**已變更**]。  
