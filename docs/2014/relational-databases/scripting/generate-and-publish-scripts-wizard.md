...
###  <a name="advanced-publishing-options-page"></a><a name="AdvPubOpts"></a>[Advanced 發行選項] 頁面  
...
2.  **發佈定序** ：包含資料表資料行的定序資訊。 預設值為 **False**。 如需詳細資訊，請參閱 [Collation and Unicode Support](../collations/collation-and-unicode-support.md)。  
...
###  <a name="provider-configuration-page"></a><a name="ProvConfig"></a>[提供者設定] 頁面  
