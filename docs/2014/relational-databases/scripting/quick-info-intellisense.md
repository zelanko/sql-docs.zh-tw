...
ms.locfileid: "75243731"
---
# <a name="quick-info-intellisense"></a>快速資訊 (IntelliSense)
  IntelliSense [!INCLUDE[msCoName](../../includes/msconame-md.md)]的 [**快速資訊**] 選項會顯示程式碼中任何識別碼的完整宣告。 當您將滑鼠指標移到識別碼上方時，系統就會在黃色的快顯視窗中顯示它的宣告。 在 [!INCLUDE[ssManStudioFull](../../includes/ssmanstudiofull-md.md)]中，資料庫引擎和 XML 查詢編輯器中會提供 **[快速諮詢]** 。  
  
## <a name="transact-sql-quick-info"></a>Transact-SQL 快速諮詢  
 **** [ [!INCLUDE[ssDE](../../includes/ssde-md.md)]快速諮詢] 會在查詢編輯器中顯示兩種類型的資訊。 不是處於偵錯模式時， **[快速諮詢]** 會顯示運算式宣告。 處於偵錯模式時， **[快速諮詢]** 會改為顯示運算式的名稱及其目前值。  
