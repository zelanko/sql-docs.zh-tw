...
2.  **若要在中設定伺服器狀態色彩：**  [物件總管](#SetOEServerColor)、[已註冊的伺服器](#SetRegServerColor)  
  
3.  **使用狀態色彩：**  [使用伺服器色彩開啟查詢編輯器](#OpenServerColor)、[開啟指定狀態色彩的查詢編輯器](#OpenSpecColor)  
...
##  <a name="SetOEServerColor"></a>在物件總管中設定伺服器的狀態色彩  
 **若要在物件總管中設定伺服器狀態色彩**  
...
##  <a name="SetRegServerColor"></a>設定已註冊伺服器的狀態色彩  
 **若要為已註冊的伺服器設定伺服器色彩**  
