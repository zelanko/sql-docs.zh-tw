...
# <a name="creating-a-user-defined-type"></a>建立使用者定義型別
 ...
 在 [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] 中，執行 Common Language Runtime (CLR) 程式碼的功能預設為 OFF。 不過，您可以使用 `sp_configure` 系統預存程序來啟用 CLR，如下列 [!INCLUDE[tsql](../../includes/tsql-md.md)] 陳述式所示：  
...
## <a name="example"></a>範例  
 下列程式代碼清單會定義 Point UDT，這在撰寫[使用者定義型](creating-user-defined-types-coding.md)別時有詳細的說明。  
