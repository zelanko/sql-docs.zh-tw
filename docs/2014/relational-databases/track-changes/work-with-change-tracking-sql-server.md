...
-   CHANGETABLE(CHANGES ...) 因此會傳回上一次同步處理版本之後發生的所有變更。  
     ...
     ![變更追蹤查詢輸出的範例](../../database-engine/media/queryoutput.gif "變更追蹤查詢輸出的範例")  
...
```  
 ...
 如需快照集交易的詳細資訊，請參閱 [SET TRANSACTION ISOLATION LEVEL &#40;Transact-SQL&#41;](/sql/t-sql/statements/set-transaction-isolation-level-transact-sql)。  
