...
ms.locfileid: "36146464"
---
# <a name="view-the-dependencies-of-a-stored-procedure"></a>檢視預存程序的相依性
    
##  <a name="Top"></a> 本主題描述如何檢視預存程序中的相依性[!INCLUDE[ssCurrent](../../includes/sscurrent-md.md)]使用[!INCLUDE[ssManStudioFull](../../includes/ssmanstudiofull-md.md)]或[!INCLUDE[tsql](../../includes/tsql-md.md)]。  
