...
|DatabaseID|`int`|發生逾時的資料庫識別碼。 [!INCLUDE[ssSqlProfiler](../../includes/sssqlprofiler-md.md)] 顯示資料庫的名稱，如果`ServerName`則表示追蹤中擷取資料行和伺服器可供使用。 請使用 DB_ID 函數判斷資料庫的值。|3|是|  
