...
|DatabaseID|`int`|發生逾時的資料庫識別碼。 如果在追蹤中擷取到 `ServerName` 資料行，而且伺服器可以使用，則 [!INCLUDE[ssSqlProfiler](../../includes/sssqlprofiler-md.md)] 會顯示資料庫名稱。 請使用 DB_ID 函數判斷資料庫的值。|3|是|  
