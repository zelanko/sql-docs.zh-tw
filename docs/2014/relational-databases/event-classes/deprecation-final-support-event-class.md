...
|SessionLoginName|`nvarchar`|引發工作階段的使用者登入名稱。 例如，若您使用 Login1 連接到 [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)]，並且以 Login2 執行陳述式，則 `SessionLoginName` 會顯示 Login1，而 `LoginName` 會顯示 Login2。 這個資料行會同時顯示 [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] 與 Windows 登入。|64|是|  
...
## <a name="see-also"></a>另請參閱  
 ...
 [淘汰公告事件類別](deprecation-announcement-event-class.md)   
