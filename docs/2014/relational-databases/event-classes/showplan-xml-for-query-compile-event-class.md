...
ms.locfileid: "62650401"
---
# <a name="showplan-xml-for-query-compile-event-class"></a>Showplan XML For Query Compile 事件類別
  當編譯 SQL 語句時[!INCLUDE[msCoName](../../includes/msconame-md.md)] [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] ，會發生「執行程式表 XML For Query Compile」事件類別。 包含此事件類別，以識別上[!INCLUDE[msCoName](../../includes/msconame-md.md)] [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)]的執行程式表運算子。  
