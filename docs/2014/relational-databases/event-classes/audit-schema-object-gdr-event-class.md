...
# <a name="audit-schema-object-gdr-event-class"></a>Audit Schema Object GDR 事件類別
  每當中[!INCLUDE[msCoName](../../includes/msconame-md.md)] [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)]的任何使用者對架構物件使用權限發出 GRANT、REVOKE 或 DENY 時，就會發生**Audit Schema Object GDR**事件類別。  
