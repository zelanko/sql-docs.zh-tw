...
ms.author: sstein
manager: craigg
ms.openlocfilehash: 088dbb64910b4c8d8eb4d06dfc26fef6c79054d6
ms.sourcegitcommit: 3da2edf82763852cff6772a1a282ace3034b4936
ms.translationtype: MT
ms.contentlocale: zh-TW
ms.lasthandoff: 10/02/2018
ms.locfileid: "48193901"
---
...
|**ObjectType**|**int**|代表參與事件之物件類型的值。 這個資料行傳回的值是 **sys.objects** 目錄檢視之 **type** 資料行中對應值與 [ObjectType 追蹤事件資料行](objecttype-trace-event-column.md)中列出值的組合。 例如，如果傳回 8277-U，則物件類型是使用者自訂資料表。|28|是|  
