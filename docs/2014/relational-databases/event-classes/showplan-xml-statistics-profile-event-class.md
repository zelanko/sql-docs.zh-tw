...
# <a name="showplan-xml-statistics-profile-event-class"></a>Showplan XML Statistics Profile 事件類別
  執行 SQL 語句時[!INCLUDE[msCoName](../../includes/msconame-md.md)] [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] ，會發生顯示計畫 XML Statistics Profile 事件類別。 包含「執行程式表 XML Statististics profile Profile」事件類別，以識別[!INCLUDE[msCoName](../../includes/msconame-md.md)] [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)]上的執行程式表運算子。  
