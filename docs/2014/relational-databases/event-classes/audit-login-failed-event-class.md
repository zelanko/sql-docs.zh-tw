...
ms.locfileid: "63000363"
---
# <a name="audit-login-failed-event-class"></a>Audit Login Failed 事件類別
  **Audit Login Failed**事件類別指出使用者嘗試登入[!INCLUDE[msCoName](../../includes/msconame-md.md)] [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)]但失敗。 此類別中的事件是由新連接引發，或是由連接集區中重複使用的連接所引發。  
