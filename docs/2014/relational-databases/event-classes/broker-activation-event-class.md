...
|**EventSubClass**|`nvarchar`|此事件報告的特定動作。 下列其中一個值：<br /><br /> **開始**： <br />                
  [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] 已開始啟用預存程序。<br /><br /> 已結束：啟用預存程式正常**結束**。<br /><br /> 已**中止**：啟用預存程式已結束，但發生錯誤。|21|否|  
