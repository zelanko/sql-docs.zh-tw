...
|**BinaryData**|**image**|用來完成處理序的 CPU 數量，根據的值如下：<br /><br /> 0x00000000：表示在序列中執行的序列計畫。<br /><br /> 0x01000000 表示在序列中執行的平行計畫。<br /><br /> >= 0x02000000：指出平行執行的平行計畫。|2|否|  
