...
ms.locfileid: "62663226"
---
# <a name="cursorrecompile-event-class"></a>CursorRecompile 事件類別
  **CursorRecompile**事件類別描述應用程式開發介面（API）資料指標中所發生的資料指標重新編譯事件。 當因為架構變更而重新[!INCLUDE[msCoName](../../includes/msconame-md.md)] [!INCLUDE[ssDE](../../includes/ssde-md.md)]編譯 transact-sql 資料指標時，就會發生資料指標重新編譯事件。  
...
|**EventSequence**|**int**|
  **CursorRecompile** 事件類別在批次中的順序。|51|否|  
