...
ms.locfileid: "62938947"
---
# <a name="audit-database-scope-gdr-event-class"></a>Audit Database Scope GDR 事件類別
  每當中[!INCLUDE[msCoName](../../includes/msconame-md.md)] [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)]的任何使用者對語句許可權發出 GRANT、REVOKE 或 DENY 時，就會發生**Audit Database Scope GDR**事件類別，以取得僅限資料庫的動作，例如授與資料庫的許可權。  
