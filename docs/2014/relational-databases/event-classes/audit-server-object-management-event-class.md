...
# <a name="audit-server-object-management-event-class"></a>Audit Server Object Management 事件類別
  當伺服器物件的 CREATE、ALTER 或 DROP 時，會發生**Audit Server Object Management**事件類別。  
...
|**EventSubClass**|**int**|事件子類別的類型。<br /><br /> 1=建立<br /><br /> 2=改變<br /><br /> 3=卸除<br /><br /> 4=傾印<br /><br /> 7=對應至登入的認證<br /><br /> 9=認證對應已卸除<br /><br /> 11=載入|21|是|  
