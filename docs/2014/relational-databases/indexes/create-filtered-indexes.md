...
-   篩選索引具有索引檢視表所不及的下列優勢：  
    ...
    -   線上索引重建。 您可以在篩選索引可用於查詢時，重建篩選索引。 線上索引重建不支援索引檢視表。 如需詳細資訊，請參閱 [ALTER INDEX &#40;Transact-SQL&#41;](/sql/t-sql/statements/alter-index-transact-sql) 的 REBUILD 選項。  
