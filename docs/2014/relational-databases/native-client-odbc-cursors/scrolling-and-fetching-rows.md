...
-   捲動與提取資料列使用**SQLFetch**或[SQLFetchScroll](../native-client-odbc-api/sqlfetchscroll.md)。  
...
-   [建立 ODBC 中的資料列的書籤](scrolling-and-fetching-rows-bookmarking-rows-in-odbc.md)  
