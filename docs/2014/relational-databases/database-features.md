...
|[資料分割資料表和索引](partitions/partitioned-tables-and-indexes.md)|[同義字 &#40;Database Engine&#41;](synonyms/synonyms-database-engine.md)|[事件通知](service-broker/event-notifications.md)|  
...
|[使用者定義函數](user-defined-functions/user-defined-functions.md)|[資料層應用程式](data-tier-applications/data-tier-applications.md)||  
|[統計資料](statistics/statistics.md)|[交易記錄 &#40;SQL Server&#41;](logs/the-transaction-log-sql-server.md)||  
|[計劃指南](performance/plan-guides.md)|[資料庫檢查點 &#40;SQL Server&#41;](logs/database-checkpoints-sql-server.md)||  
