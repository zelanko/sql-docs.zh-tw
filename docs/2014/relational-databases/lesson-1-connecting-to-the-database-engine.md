...
##  <a name="tools-for-getting-started"></a><a name="tools"></a>適用于消費者入門的工具  
...
2.  在 [**一般**] 頁面的 [**登入名稱**] 方塊中，以* \<domain> \\<登 \> *入的格式輸入 Windows 登入。  
