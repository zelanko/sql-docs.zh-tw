...
ms.locfileid: "63140487"
---
# <a name="examples-of-bulk-import-and-export-of-xml-documents-sql-server"></a>大量匯入與匯出 XML 文件的範例 (SQL Server)
    
##  <a name="top"></a> 您可以大量匯入 XML 文件[!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)]資料庫或大量匯出它們從[!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)]資料庫。 本主題將提供這兩種情況的範例。  
...
-   A. [以二進位位元組資料流的 XML 資料大量匯入](#binary_byte_stream)  
  
-   B. [大量匯入現有的資料列中的 XML 資料](#existing_row)  
...
###  <a name="bulk_export_xml_data"></a> E. 大量匯出 XML 資料  
