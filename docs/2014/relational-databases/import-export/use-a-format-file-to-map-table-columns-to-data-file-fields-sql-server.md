...
> [!NOTE]  
>  非 XML 格式檔案或 XML 格式檔案可以用來將資料檔案大量匯入資料表，方法是使用**bcp**命令、BULK INSERT 語句或 INSERT .。。SELECT * FROM OPENROWSET （BULK ...）語句。 如需詳細資訊，請參閱[使用格式檔案大量匯入資料 &#40;SQL Server&#41;](use-a-format-file-to-bulk-import-data-sql-server.md)。  
