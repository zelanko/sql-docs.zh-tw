...
## <a name="see-also"></a>另請參閱  
 ...
 [CLR 整合自訂屬性的總覽](../../database-engine/dev-guide/overview-of-clr-integration-custom-attributes.md)   
