...
ms.locfileid: "84997144"
---
# <a name="files-and-version-numbers"></a>檔案和版本號碼
  所有必要的 [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] 管理物件（SMO）元件都會安裝為 [!INCLUDE[msCoName](../../includes/msconame-md.md)] [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] 用戶端或伺服器實例的一部分。 SMO 是實作於數個 Managed 組件中。 您可以在用戶端或伺服器上開發 SMO 應用程式。  
