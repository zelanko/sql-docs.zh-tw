...
|DBPROP_INDEX_FILLFACTOR|R/W:讀取/寫入<br /><br /> 預設：0<br /><br /> 描述：指定用來儲存索引頁的百分比。 如需詳細資訊，請參閱 [CREATE INDEX](/sql/t-sql/statements/create-index-transact-sql)。<br /><br /> 變數的類型為 VT_I4。 其值必須大於或等於 1 且小於或等於 100。|  
