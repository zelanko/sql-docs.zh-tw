...
|屬性識別碼|描述|  
|-----------------|-----------------|  
|SSPROP_COL_COLLATIONNAME|類型：VT_BSTR<br /><br /> R/W：寫入<br /><br /> 預設值：Null<br /><br /> 描述： 這個屬性只能用於**ITableDefinition**。 建立時，會使用這個屬性中指定的字串[CREATE TABLE](/sql/t-sql/statements/create-table-transact-sql)<br /><br /> 陳述式。|  
