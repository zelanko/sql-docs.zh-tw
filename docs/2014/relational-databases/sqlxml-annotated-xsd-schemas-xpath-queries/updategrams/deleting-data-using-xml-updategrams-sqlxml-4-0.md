...
ms.author: douglasl
manager: craigg
ms.openlocfilehash: f61b29a0516cab83b14d2162d7dd71b1ac5b8926
ms.sourcegitcommit: c18fadce27f330e1d4f36549414e5c84ba2f46c2
ms.translationtype: MT
ms.contentlocale: zh-TW
ms.lasthandoff: 07/02/2018
ms.locfileid: "37321818"
---
...
1.  完整的範例 B （「 插入多筆記錄使用 updategram 」） 中[插入的資料使用 XML Updategram &#40;SQLXML 4.0&#41;](inserting-data-using-xml-updategrams-sqlxml-4-0.md)。  
  
2.  將上述的 updategram 複製到 [記事本]，並將它儲存為 Updategram-removeshifts.xml 相同的資料夾中，用來完成 （「 插入多筆記錄使用 updategram 」） 中[插入的資料使用 XML Updategram &#40;SQLXML 4.0&#41;](inserting-data-using-xml-updategrams-sqlxml-4-0.md).  
