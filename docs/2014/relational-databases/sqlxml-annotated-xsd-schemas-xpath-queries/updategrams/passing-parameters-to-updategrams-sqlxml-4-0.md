...
2.  準備在 SQLXML 4.0 測試指令碼 (Sqlxml4test.vbs) [ADO to Execute SQLXML 4.0](../../sqlxml/using-ado-to-execute-sqlxml-4-0-queries.md)以加入下列幾行之後執行 updategram `cmd.Properties("Output Stream").Value = outStream`:  
