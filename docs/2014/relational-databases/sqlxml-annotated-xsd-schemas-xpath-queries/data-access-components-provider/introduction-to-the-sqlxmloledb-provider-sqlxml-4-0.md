...
|namespaces||這個屬性會讓使用命名空間的 XPath 查詢得以執行。 如需使用此屬性的範例，請參閱[使用命名空間執行 XPath 查詢 &#40;SQLXMLOLEDB 提供者&#41;](executing-xpath-queries-with-namespaces-sqlxmloledb-provider.md)。|  
