...
-   對應結構描述  
 ...
 在此範例 ADO 應用程式中，XML 範本，其中包含 XPath 查詢 （根） 針對 中描述的 XSD 對應結構描述 (MySchema.xml) 指定[執行 XPath 查詢&#40;SQLXMLOLEDB 提供者&#41;](executing-xpath-queries-sqlxmloledb-provider.md).  
