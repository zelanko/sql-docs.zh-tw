...
## <a name="property-valuereturn-value"></a>屬性值/傳回值  
 指定與 [執行個體相關之一般旗標的](../serversettingsgeneralflag-class/serversettingsgeneralflag-class.md) ServerSettingsGeneralFlag 類別 [!INCLUDE[ssNoVersion](../../../includes/ssnoversion-md.md)]物件陣列。  
