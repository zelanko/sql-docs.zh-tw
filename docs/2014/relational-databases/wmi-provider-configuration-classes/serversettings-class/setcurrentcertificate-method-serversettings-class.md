...
## <a name="parts"></a>組件  
 *object*  
 [ServerSettings 類別] ServerSettings-class.md）物件，代表實例上的伺服器設定 [!INCLUDE[msCoName](../../../includes/msconame-md.md)] [!INCLUDE[ssNoVersion](../../../includes/ssnoversion-md.md)] 。  
