...
## <a name="parts"></a>組件  
 *object*  
 A [ProtocolName 屬性 （ServerNetworkProtocol 類別）](servernetworkprotocol-class.md)物件的執行個體所使用之網路通訊協定[!INCLUDE[ssNoVersion](../../../includes/ssnoversion-md.md)]。  
