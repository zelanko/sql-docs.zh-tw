...
# <a name="sqlserviceadvancedproperty-class"></a>SqlServiceAdvancedProperty 類別
 ...
 [AdvancedProperties 屬性（SqlService 類別）](../sqlservice-class/advancedproperties-property-sqlservice-class.md)會參考[SqlServiceAdvancedProperty 類別](sqlserviceadvancedproperty-class.md)物件的陣列。  
