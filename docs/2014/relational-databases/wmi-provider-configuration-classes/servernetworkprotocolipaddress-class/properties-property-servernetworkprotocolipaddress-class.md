...
## <a name="parts"></a>組件  
 *object*  
 代表 [執行個體上網路通訊協定之 IP 位址的](servernetworkprotocolipaddress-class.md) ServerNetworkProtocolIPAdress 類別 [!INCLUDE[ssNoVersion](../../../includes/ssnoversion-md.md)]物件。  
