...
```  
 ...
 如需[!INCLUDE[ssNoVersion](../../../includes/ssnoversion-md.md)] Native Client OLE DB 提供者如何公開大數值資料類型的詳細資訊，請參閱[Blob 和 OLE 物件](../../native-client-ole-db-blobs/blobs-and-ole-objects.md)。  
