...
# <a name="large-clr-user-defined-types"></a>大型 CLR 使用者定義型別
 ...
 如需詳細資訊，請參閱[Large CLR User-Defined 類型&#40;OLE DB&#41; ](../ole-db/large-clr-user-defined-types-ole-db.md)和[Large CLR User-Defined 類型&#40;ODBC&#41;](../odbc/large-clr-user-defined-types-odbc.md)。  
