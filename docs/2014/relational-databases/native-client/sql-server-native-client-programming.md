...
> [!NOTE]  
>  如需清單之間的差異[!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)]原生用戶端和 Windows DAC，加上有關問題的資訊來更新 Windows DAC 應用程式之前，請考慮[!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)]原生用戶端，請參閱[更新 SQL Server 的應用程式原生用戶端從 MDAC](applications/updating-an-application-to-sql-server-native-client-from-mdac.md)。  
...
## <a name="in-this-section"></a>本節內容  
 [SQL Server Native Client 中最新消息](sql-server-native-client.md)  
