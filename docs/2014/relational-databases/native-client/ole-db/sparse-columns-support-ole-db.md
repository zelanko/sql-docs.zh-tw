...
|類型或成員函數|描述|  
|-----------------------------|-----------------|  
|IColumnsInfo::GetColumnsInfo|已針對`column_set` *dwFlags*中的資料行設定新的 DBCOLUMNFLAGS 旗標值 DBCOLUMNFLAGS_SS_ISCOLUMNSET。<br /><br /> `column_set` 資料行會設定 DBCOLUMNFLAGS_WRITE。|  
