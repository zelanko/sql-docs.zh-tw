...
ms.locfileid: "36134152"
---
# <a name="service-principal-names-spns-in-client-connections-odbc"></a>用戶端連接 (ODBC) 中的服務主要名稱 (SPN)
  本主題描述可在用戶端應用程式內支援服務主要名稱 (SPN) 的 ODBC 屬性和函數。 如需有關 Spn 的用戶端應用程式，請參閱[服務主體名稱&#40;SPN&#41;支援用戶端連接中的](../features/service-principal-name-spn-support-in-client-connections.md)和[取得 Kerberos 相互驗證](../../native-client-odbc-how-to/get-mutual-kerberos-authentication.md)。  
