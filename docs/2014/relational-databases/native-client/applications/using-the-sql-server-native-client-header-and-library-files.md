...
## <a name="static-linking-and-bcp-functions"></a>靜態連結與 BCP 函數  
 ...
 如需詳細資訊，請參閱[執行大量複製作業](../features/performing-bulk-copy-operations.md)。  
