...
-   `DataTypeCompatibility=80`  
 ...
 如需 Native Client 中[!INCLUDE[ssNoVersion](../../../includes/ssnoversion-md.md)]支援的 ADO 連接字串關鍵字的詳細資訊，請參閱搭配[使用連接字串關鍵字與 SQL Server Native Client](using-connection-string-keywords-with-sql-server-native-client.md)。  
