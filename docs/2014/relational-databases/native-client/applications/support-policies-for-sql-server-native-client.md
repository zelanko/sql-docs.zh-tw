...
## <a name="ole-db-support-policies"></a>OLE DB 支援原則  
 ...
 如果使用 OLE DB 服務元件的 OLE DB 應用程式在其連接字串中指定了 [!INCLUDE[ssNoVersion](../../../includes/ssnoversion-md.md)]，它們就只能使用 `DataTypeCompatibility=80` Native Client。 不過，在此情況下[!INCLUDE[ssVersion2005](../../../includes/ssversion2005-md.md)] ，將無法使用之後新增的任何功能。  
