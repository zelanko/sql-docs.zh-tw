...
# <a name="finding-more-sql-server-native-client-information"></a>尋找其他 SQL Server Native Client 資訊
 ...
 [資料存取和儲存體程式開發人員中心](http://go.microsoft.com/fwlink?linkid=4173)  
 ...
 [Windows Data Access Component](http://go.microsoft.com/fwlink/?LinkId=107907)  
 ...
 其他資訊[!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)]原生用戶端可以找到搜尋[Microsoft Knowledge Base](http://go.microsoft.com/fwlink?linkid=5757)。  
