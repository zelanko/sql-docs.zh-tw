...
|---------------|--------------------------|-----------------|  
|SRVBIGBINARY|`binary`|
  `binary` 資料類型，長度為 0 到 8000 個位元組。|  
|SRVBIGCHAR|`char`|
  `character` 資料類型，長度為 0 到 8000 個位元組。|  
