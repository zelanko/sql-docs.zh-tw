...
1.  執行 **sp_syscollector_stop_collection_set** 預存程序，停止您想要加入此項目的收集組。 例如，若要停止名為 "Test Collection Set" 的收集組，請執行下列陳述式：  
    ...
    > [!NOTE]  
    >  您也可以使用 [!INCLUDE[ssManStudioFull](../../includes/ssmanstudiofull-md.md)]中的 [物件總管] 來停止收集組。 如需詳細資訊，請參閱 [啟動或停止收集組](start-or-stop-a-collection-set.md)。  
