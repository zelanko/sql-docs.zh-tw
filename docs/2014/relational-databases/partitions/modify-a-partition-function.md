...
> [!CAUTION]  
>  多份資料表或索引可以使用相同的資料分割函數。 當您修改資料分割函數時，將會在單一交易中影響所有資料表或索引。 修改之前，請先檢查資料分割函式的相依性。  
...
3.  複製下列範例並將其貼到查詢視窗中，然後按一下 **[執行]** 。  
 ...
 如需詳細資訊，請參閱 [ALTER PARTITION FUNCTION &#40;Transact-SQL&#41;](/sql/t-sql/statements/alter-partition-function-transact-sql)。  
