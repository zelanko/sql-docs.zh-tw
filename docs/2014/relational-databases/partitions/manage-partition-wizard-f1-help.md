...
# <a name="manage-partition-wizard-f1-help"></a>管理資料分割精靈 F1 說明
  使用 [**管理資料分割] Wizard** ，透過資料分割切換或滑動視窗案例的執行，管理和修改現有的資料分割資料表。 這個精靈可以讓資料分割的管理更方便，並且簡化將資料移轉入和移轉出資料表的一般作業。  
...
##  <a name="Top"></a> 本節內容  
 ...
 [管理資料分割嚮導（選取資料分割動作頁面）](#SelectPartitionAction)  
  
 [管理資料分割嚮導（在頁面中切換）](#SwitchIn)  
  
 [管理資料分割嚮導（切換移出頁面）](#SwitchOut)  
  
 [管理資料分割嚮導（選取臨時資料表選項頁面）](#StagingTableOptions)  
  
 [管理資料分割嚮導（選取輸出選項頁面）](#OutputOption)  
  
 [管理資料分割嚮導（新增作業排程頁面）](#NewJob)  
  
 [管理資料分割嚮導（摘要頁面）](#Summary)  
  
 [管理資料分割嚮導（進度頁面）](#Progress)  
  
##  <a name="SelectPartitionAction"></a>[選取資料分割動作] 頁面  
 ...
 **管理滑動視窗案例中的分割資料**  
 ...
 [這一節中](#Top)，搭配 [![回到頁首] 連結使用的箭號圖示](../../2014-toc/media/uparrow16x16.gif "與 [回到頁首] 連結搭配使用的箭頭圖示")  
...
##  <a name="StagingTableOptions"></a>選取臨時表選項頁面  
...
##  <a name="Progress"></a> 進度頁面  
 使用 [進度]**** 頁面，即可監視有關 [管理資料分割精靈]**** 動作的狀態資訊。 根據您在嚮導中選取的選項，[**進度**] 頁面可能會包含一或多個動作。 頂端的方塊會顯示精靈的整體狀態以及精靈已接收的狀態、錯誤和警告訊息數。  
...
## <a name="see-also"></a>另請參閱  
 [資料分割資料表和索引](partitioned-tables-and-indexes.md)  
