...
|為得到此結果|使用此函數|  
|------------------------|-----------------------|  
|取得特定 FileTable 或目前資料庫的根層級 UNC 路徑。|[FileTableRootPath &#40;Transact-SQL&#41;](/sql/relational-databases/system-functions/filetablerootpath-transact-sql)|  
...
##  <a name="how-to-use-relative-paths-for-portable-code"></a><a name="BestPracticeRelativePaths"></a> 如何：使用可攜式程式碼的相對路徑  
...
###  <a name="nesting-level"></a><a name="nesting"></a> 巢狀層級  
  
> [!IMPORTANT]  
>  您不能在 FileTable 目錄中儲存超過 15 層的子目錄。 當您儲存了 15 層的子目錄時，最低的一層將無法包含任何檔案，因為這些檔案代表另外的一層。  
  
###  <a name="length-of-full-path-name"></a><a name="fqnlength"></a> 完整路徑名稱長度  
