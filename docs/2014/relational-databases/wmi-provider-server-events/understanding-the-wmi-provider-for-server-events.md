...
```
 ...
 在此範例中，`SQLWEP_76CF38C1_18BB_42DD_A7DC_C8820155B0E9` 是由前置詞 [!INCLUDE[tsql](../../includes/tsql-md.md)] 和 GUID 構成的 `SQLWEP_` 識別碼。 
  `SQLWEP` 會為每個識別碼建立一個新的 GUID。 子句中`A7E5521A-1CA6-4741-865D-826F804E5135`的值是 GUID，可識別 msdb 資料庫中的 broker 實例。 **** `TO SERVICE`
