...
ms.locfileid: "62743317"
---
# <a name="lesson-6-migrate-a-database-from-a-source-machine-on-premises-to-a-destination-machine-in-windows-azure"></a>第 6 課：將資料庫移轉來源機器內部部署至 Windows Azure 中的目的地電腦
