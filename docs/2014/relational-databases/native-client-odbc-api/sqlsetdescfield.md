...
ms.locfileid: "36023979"
---
# <a name="sqlsetdescfield"></a>SQLSetDescField
  SQLSetDescField 可以用來設定資料表值參數和資料表值參數資料行的描述項欄位。 如需可用的欄位資訊，請參閱[資料表值參數描述項欄位](../native-client-odbc-table-valued-parameters/table-valued-parameter-descriptor-fields.md)和[資料表值參數組成資料行的描述項欄位](../native-client-odbc-table-valued-parameters/descriptor-fields-for-table-valued-parameter-constituent-columns.md)。  
...
## <a name="sqlsetdescfield-support-for-enhanced-date-and-time-features"></a>增強型日期和時間功能的 SQLSetDescField 支援  
 ODBC 中已經增強了日期/時間功能。 提供新的日期/時間類型的描述項欄位的相關資訊，請參閱[and Result Metadata<](../native-client-odbc-date-time/metadata-parameter-and-result.md)。  
