...
## <a name="sqlsoptssnocountstatus"></a>SQL_SOPT_SS_NOCOUNT_STATUS  
 SQL_SOPT_SS_NOCOUNT_STATUS 屬性指出 NOCOUNT 目前的設定選項，可控制是否[!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)]報告受到陳述式的資料列數時[SQLRowCount](sqlrowcount.md)呼叫。 *ValuePtr*值屬於類型是 SQLLEN。  
