---
title: 教學課程：Windows Azure 儲存體服務中的 SQL Server 資料檔案 |Microsoft Docs
ms.custom: ''
ms.date: 06/13/2017
 ...
 **[第 4 課：在 Windows Azure 儲存體中建立資料庫](../relational-databases/lesson-3-database-backup-to-url.md)**  
