...
# <a name="sqlxml-40-programming-concepts"></a>SQLXML 4.0 程式設計概念
 ...
 [xml 資料類型在 SQLXML 4.0 中的支援](xml-data-type-support-in-sqlxml-4-0.md)  
 ...
 [使用 Updategram 來修改 SQLXML 4.0 中的資料](../sqlxml-annotated-xsd-schemas-xpath-queries/updategrams/using-updategrams-to-modify-data-in-sqlxml-4-0.md)  
 ...
 [快取範本、XSL 和架構 &#40;SQLXML 4.0&#41;](../sqlxml-annotated-xsd-schemas-xpath-queries/caching-templates-xml-schemas/caching-templates-xsl-and-schemas-sqlxml-4-0.md)  
