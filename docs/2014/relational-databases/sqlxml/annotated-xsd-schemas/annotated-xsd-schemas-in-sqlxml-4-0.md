...
## <a name="in-this-section"></a>本節內容  
 ...
 [使用註解 XSD 結構描述中&#40;SQLXML 4.0&#41;](../../sqlxml-annotated-xsd-schemas-using/using-annotations-in-xsd-schemas-sqlxml-4-0.md)  
 描述如何在各種狀況下使用 XSD 結構描述中的註解，並提供範例。  
  
 [使用註解式 XSD 結構描述，在查詢中的&#40;SQLXML 4.0&#41;](using-annotated-xsd-schemas-in-queries-sqlxml-4-0.md)  
 描述如何在查詢中使用註解式 XSD 結構描述。  
  
 [註解式轉換為相等的 XSD 結構描述的 XDR 結構描述&#40;SQLXML 4.0&#41;](converting-annotated-xdr-schemas-to-equivalent-xsd-schemas-sqlxml-4-0.md)  
