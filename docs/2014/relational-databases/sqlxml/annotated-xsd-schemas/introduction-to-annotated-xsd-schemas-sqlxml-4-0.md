...
```  
 ...
 對應結構描述中**\<連絡人 >** 元素會對應至 AdventureWorks 範例資料庫中的 Person.Contact 資料表使用`sql:relation`註解。 ConID、FName 和 LName 屬性會使用 `sql:field` 註解來對應至 Person.Contact 資料表中的 ContactID、FirstName 和 LastName 資料行。  
...
## <a name="see-also"></a>另請參閱  
 ...
 [註解式 XDR 結構描述&#40;SQLXML 4.0 中已被取代&#41;](annotated-xdr-schemas-deprecated-in-sqlxml-4-0.md)  
