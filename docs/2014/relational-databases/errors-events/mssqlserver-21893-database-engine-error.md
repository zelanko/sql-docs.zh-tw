...
## <a name="explanation"></a>說明  
 `sp_validate_redirected_publisher` 在遠端伺服器使用發行者資料庫的訂用帳戶中繼資料資料表，以識別其相關聯的訂閱者，並確認 master.dbo.sysservers 的訂閱者沒有相關聯的項目。 如果任何識別的訂閱者不存在，就會傳回此錯誤。  
