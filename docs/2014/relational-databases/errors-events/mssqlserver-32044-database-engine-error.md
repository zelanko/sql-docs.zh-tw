...
## <a name="explanation"></a>說明  
 這個資料庫鏡像事件是在主體伺服器執行個體上發出，用來指示由於資料庫鏡像，彙總認可等待時間已達到或超出使用者指定的臨界值。 等待時間是交易數目和各交易時間的乘積。 例如，下列情況都會產生 1000年毫秒等待時間：1000 筆交易 * 1 毫秒，以及 1 筆交易\*1000年毫秒。 交易計數激增、傳送記錄延遲，或是排清鏡像伺服器執行個體上的記錄延遲，都可能會使認可等待時間增加。  
