...
## <a name="explanation"></a>說明  
 記憶體最佳化資料表的資料列大小限制為 8,060 個位元組。 如需詳細資訊，請參閱 [記憶體最佳化資料表中的資料表和資料列大小](../in-memory-oltp/memory-optimized-tables.md)。 如需詳細資訊，請參閱[記憶體內部 OLTP &#40;記憶體內部最佳化&#41;](../in-memory-oltp/in-memory-oltp-in-memory-optimization.md)。  
