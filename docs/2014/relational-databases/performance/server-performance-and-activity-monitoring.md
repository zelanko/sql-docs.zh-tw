...
ms.locfileid: "63150610"
---
# <a name="server-performance-and-activity-monitoring"></a>伺服器效能與活動監視
  監視資料庫的目標在於評估伺服器的執行效能。 有效的監視包括定期建立目前效能的快照集以隔離造成問題的處理序，以及持續蒐集資料來追蹤效能趨勢。 [!INCLUDE[msCoName](../../includes/msconame-md.md)][!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)]和[!INCLUDE[msCoName](../../includes/msconame-md.md)] Windows 作業系統提供公用程式，可讓您查看資料庫的目前狀況並隨著狀況變更來追蹤效能。  
...
-   [啟動 [系統監視器] &#40;Windows&#41;](start-system-monitor-windows.md)  
 ...
 **若要使用 Transact-sql 預存程式透過 SQL 追蹤執行監視工作**  
  
-   [建立追蹤 &#40;Transact-SQL&#41;](../sql-trace/create-a-trace-transact-sql.md)  
  
-   [&#40;Transact-sql&#41;設定追蹤篩選](../../ssms/agent/set-sql-server-alias-for-sql-server-agent-service-ssms.md)  
  
-   [修改現有的追蹤 &#40;Transact-sql&#41;](../sql-trace/modify-an-existing-trace-transact-sql.md)  
  
-   [查看已儲存的追蹤 &#40;Transact-sql&#41;](../sql-trace/view-a-saved-trace-transact-sql.md)  
  
-   [&#40;Transact-sql&#41;視圖篩選資訊](../sql-trace/view-filter-information-transact-sql.md)  
  
-   [&#40;Transact-sql&#41;刪除追蹤](../sql-trace/delete-a-trace-transact-sql.md)  
  
 **若要使用 SQL Server Profiler 來建立和修改追蹤**  
...
-   [建立 Transact-sql 腳本以執行追蹤 &#40;SQL Server Profiler&#41;](../../tools/sql-server-profiler/create-a-transact-sql-script-for-running-a-trace-sql-server-profiler.md)  
...
-   [在追蹤 &#40;SQL Server Profiler 中，篩選 &#40;Spid&#41; 的伺服器處理序識別碼&#41;](../../tools/sql-server-profiler/filter-server-process-ids-spids-in-a-trace-sql-server-profiler.md)  
 ...
 **若要使用 SQL Server Profiler 開啟追蹤並設定追蹤的顯示方式**  
...
-   [一次重新執行單一事件 &#40;SQL Server Profiler&#41;](../../tools/sql-server-profiler/replay-a-single-event-at-a-time-sql-server-profiler.md)  
...
-   [重新執行 Transact-sql 腳本 &#40;SQL Server Profiler&#41;](../../tools/sql-server-profiler/replay-a-transact-sql-script-sql-server-profiler.md)  
  
 **若要使用 SQL Server Profiler 來建立、修改和使用追蹤範本**  
...
-   [分別儲存執行程式表 XML 事件 &#40;SQL Server Profiler&#41;](save-showplan-xml-events-separately-sql-server-profiler.md)  
  
-   [將執行程式表 XML 統計資料設定檔事件分別儲存 &#40;SQL Server Profiler&#41;](save-showplan-xml-statistics-profile-events-separately-sql-server-profiler.md)  
  
-   [從追蹤 &#40;SQL Server Profiler 解壓縮腳本&#41;](../../tools/sql-server-profiler/extract-a-script-from-a-trace-sql-server-profiler.md)  
