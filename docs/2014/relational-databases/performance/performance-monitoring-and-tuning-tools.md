...
ms.locfileid: "63150829"
---
# <a name="performance-monitoring-and-tuning-tools"></a>效能監視及微調工具
  [!INCLUDE[msCoName](../../includes/msconame-md.md)][!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)]提供了一組完整的工具，可用來[!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)]監視中的事件，以及用來微調實體資料庫設計。 要選擇的工具依據要做的監視或微調類型，以及要監視的特殊事件而定。  
