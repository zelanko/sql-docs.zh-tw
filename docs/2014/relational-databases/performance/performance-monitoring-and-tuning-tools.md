...
|在自訂應用程式中使用|是 <sup>1</sup>||||是||  
 ...
 <sup>1</sup> Using[!INCLUDE[ssSqlProfiler](../../../includes/sssqlprofiler-md.md)]系統預存程序。  
