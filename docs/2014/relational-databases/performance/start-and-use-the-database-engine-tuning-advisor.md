...
###  <a name="to-create-transact-sql-script-workloads"></a><a name="SSMS"></a>建立 Transact-sql 腳本工作負載  
...
###  <a name="to-create-trace-file-and-trace-table-workloads"></a><a name="Profiler"></a>建立追蹤檔案和追蹤資料表工作負載  
...
2.  依下列程序，使用  [微調][!INCLUDE[ssSqlProfiler](../../includes/sssqlprofiler-md.md)] **** 範本來建立追蹤檔案或資料表：  
...
2.  檢查微調記錄檔，找出因沒有適當權限而未微調的陳述式。 如需詳細資訊，請參閱[View and 使用 Database Engine Tuning Advisor 的輸出](database-engine-tuning-advisor.md)。  
...
####  <a name="to-tune-a-database-by-using-the-plan-cache"></a><a name="PlanCache"></a>若要使用計畫快取微調資料庫  
