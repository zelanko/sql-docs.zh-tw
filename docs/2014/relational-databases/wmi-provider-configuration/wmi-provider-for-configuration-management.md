...
## <a name="see-also"></a>另請參閱  
 [了解用於組態管理的 WMI 提供者](understanding-the-wmi-provider-for-configuration-management.md)   
