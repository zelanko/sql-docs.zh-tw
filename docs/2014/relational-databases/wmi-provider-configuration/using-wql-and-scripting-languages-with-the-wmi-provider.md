---
title: 使用 WQL 與指令碼語言與組態管理的 WMI 提供者 |Microsoft 文件
ms.custom: ''
ms.date: 03/06/2017
...
-   使用指令碼語言，例如 VBScript。  
 ...
 或者，可以使用 SMO 中的 WMI Managed 物件，以程式設計方式管理 [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] 服務與網路設定。 如需程式設計 WMI managed 物件，請參閱[管理服務和網路設定，使用 WMI 提供者所](../server-management-objects-smo/tasks/managing-services-and-network-settings-by-using-wmi-provider.md)。  
...
## <a name="see-also"></a>另請參閱  
 ...
 [修改 SQL Server 服務進階屬性使用 VBScript](access-wmi-provider-for-configuration-management-using-vbscript.md)  
