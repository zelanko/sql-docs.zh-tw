...
-   [!INCLUDE[ssManStudioFull](../../includes/ssmanstudiofull-md.md)]：[如何：將訂閱設定為使用 Web 同步\(處理 SQL Server Management Studio\) ](https://msdn.microsoft.com/library/ms345214.aspx)  
