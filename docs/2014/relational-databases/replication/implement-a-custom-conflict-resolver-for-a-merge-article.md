...
1.  SQL Server 2000 範例檔案中有提供範例。 下載[ **sql2000samples.zip**](https://github.com/Microsoft/sql-server-samples/blob/master/samples/tutorials/Miscellaneous/sql2000samples.zip)。 這會下載總計 6.9 mb 的 3 個檔案。  
