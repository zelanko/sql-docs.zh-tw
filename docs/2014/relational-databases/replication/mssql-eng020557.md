...
-   請檢查代理程式記錄和作業記錄是否同時發生其他錯誤。 如需有關如何在複寫監視器中檢視代理程式狀態和錯誤詳細資料的資訊，請參閱[View Information and Perform Tasks 使用 「 複寫監視器](monitor/view-information-and-perform-tasks-replication-monitor.md)。
