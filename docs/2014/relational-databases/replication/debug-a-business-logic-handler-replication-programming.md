...
ms.author: craigg
manager: jhubbard
ms.openlocfilehash: ddb4e297b979edbdbc22b72fcf5fe746e1fcb695
ms.sourcegitcommit: 5dd5cad0c1bbd308471d6c885f516948ad67dfcf
ms.translationtype: MT
ms.contentlocale: zh-TW
ms.lasthandoff: 06/19/2018
ms.locfileid: "36145819"
---
...
3.  在以程式設計方式同步啟動合併代理程式的 [!INCLUDE[msCoName](../../includes/msconame-md.md)] Visual Studio 中，建立 Replication Management Objects (RMO) 專案。 如需相關資訊，請參閱 [同步處理提取訂閱](synchronize-a-pull-subscription.md)。  
