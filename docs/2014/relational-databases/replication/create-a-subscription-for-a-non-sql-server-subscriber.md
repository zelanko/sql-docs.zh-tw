...
7.  同步處理訂閱。 如需詳細資訊，請參閱 [同步處理發送訂閱](synchronize-a-push-subscription.md)。  
...
12. 在 **[精靈動作]** 頁面中，選擇性地編寫訂閱指令碼。 如需詳細資訊，請參閱 [Scripting Replication](scripting-replication.md)。  
