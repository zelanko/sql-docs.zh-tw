...
ms.locfileid: "62676911"
---
# <a name="sql-server-replication-add-publisher-dialog-box"></a>SQL Server 複寫 [新增發行者] 對話方塊 
  [**加入發行者**] 對話方塊可讓您將一個或多個發行者加入至複寫監視器的左窗格。 加入發行者之後，選取左窗格中的發行者會在右窗格中顯示該發行者的資訊。  
