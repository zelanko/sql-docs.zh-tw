 ...
 **代理程式**  
 快照集代理程式。 這是唯一與快照式發行集相關聯的代理程式。 散發代理程式與這個發行集的訂閱相關聯。 如需詳細資訊，請參閱[檢視與訂閱建立關聯之代理程式的資訊並執行工作 &#40;複寫監視器&#41;](monitor/view-information-and-perform-tasks-for-subscription-agents.md)。  
