...
-   複寫 [!INCLUDE[tsql](../../../includes/tsql-md.md)] 程式設計與 Replication Management Objects (RMO) 程式設計： [Create a Pull Subscription](../create-a-pull-subscription.md) 和 [Create a Push Subscription](../create-a-push-subscription.md)  
