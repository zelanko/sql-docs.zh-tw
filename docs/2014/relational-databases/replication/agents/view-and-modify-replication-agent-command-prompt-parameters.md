...
|-----------|--------------|------------------------------------|  
|快照集代理程式|**\<發行者>-\<發行集資料庫>-\<發行集>\<-整數>**|[複寫快照集代理程式](replication-snapshot-agent.md)|  
|合併式發行集分割區的快照集代理程式|**Dyn_\<發行者>-\<發行集資料庫>-\<發行集>-\<GUID>**|[複寫快照集代理程式](replication-snapshot-agent.md)|  
...
|發送訂閱的散發代理程式|** \< \< \<發行者>-發行集資料庫>-發行集>-訂閱者\<>-整數>1 \< ** <sup>1</sup>|[複寫散發代理程式](replication-distribution-agent.md)|  
|提取訂閱的散發代理程式|** \< \< \< \<發行者>-發行集資料庫>-發行集>-訂閱者>-訂閱資料庫\<>-GUID>2 \< ** <sup>2</sup>|[複寫散發代理程式](replication-distribution-agent.md)|  
|發送訂閱至非 SQL Server 訂閱者的散發代理程式|**\<發行者>-\<發行集資料庫>-\<發行集>\<-訂閱者\<>-整數>**|[複寫散發代理程式](replication-distribution-agent.md)|  
