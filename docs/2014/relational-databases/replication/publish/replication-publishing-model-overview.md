...
## <a name="see-also"></a>另請參閱
 複寫[代理程式總覽](../agents/replication-agents-overview.md)[類型的](../types-of-replication.md)複寫設定複寫，用於[維護 AlwaysOn 發行集資料庫 &#40;SQL Server](../../../database-engine/availability-groups/windows/maintaining-an-always-on-publication-database-sql-server.md)的[AlwaysOn 可用性群組（SQL Server）](../../../database-engine/availability-groups/windows/always-on-availability-groups-sql-server.md)&#41;
