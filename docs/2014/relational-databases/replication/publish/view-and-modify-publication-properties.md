...
##  <a name="using-sql-server-management-studio"></a><a name="SSMSProcedure"></a> 使用 SQL Server Management Studio  
 在 [**發行集屬性 \<Publication> -** ] 對話方塊中，您可以使用和複寫監視器來查看及修改發行集屬性 [!INCLUDE[ssManStudioFull](../../../includes/ssmanstudiofull-md.md)] 。 如需啟動複寫監視器的詳細資訊，請參閱[啟動複寫監視器](../monitor/start-the-replication-monitor.md)。  
