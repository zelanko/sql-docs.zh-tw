...
##  <a name="BasicsQuerySimilar"></a>尋找相似或相關的檔  
  
###  <a name="HowToQuerySimilar"></a>如何：使用 SEMANTICSIMILARITYTABLE 尋找相似或相關的檔  
...
###  <a name="HowToIdentifySimilar"></a>範例：尋找與另一份檔相似的前幾個檔  
...
##  <a name="BasicsQuerySimilarity"></a>尋找檔相似或相關的資訊  
  
###  <a name="HowToQuerySimilarity"></a>如何：尋找檔類似或與 SEMANTICSIMILARITYDETAILSTABLE 相關的資訊  
...
###  <a name="HowToSimilarPhrases"></a>範例：尋找檔之間相似的前幾個主要片語  
