---
title: 已取代的 SQL Server 2014 中的全文檢索搜尋功能 |Microsoft 文件
ms.custom: ''
ms.date: 03/06/2017
...
|已被取代的功能|取代|功能名稱|功能識別碼|  
|------------------------|-----------------|------------------|----------------|  
|CONTAINS 和 CONTAINSTABLE 一般 NEAR 運算子：<br /><br /> {<simple_term> &#124; <prefix_term>}<br /><br /> {<br /><br /> { { NEAR &#124; ~ }    {<simple_term> &#124; <prefix_term>} } [...*n*]<br /><br /> }|自訂 NEAR 運算子：<br /><br /> NEAR(<br /><br /> {   {<simple_term> &#124; <prefix_term>} [ ,…*n* ]<br /><br /> &#124; ( {<simple_term> &#124; <prefix_term>} [,…*n*] )<br /><br /> [，\<距離 > [，\<順序 >]]<br /><br /> }<br /><br /> )<br /><br /> \<距離 >:: = {*整數* &#124; **MAX**}<br /><br /> \<順序 >:: = {TRUE &#124; **FALSE**}|FULLTEXT_OLD_NEAR_SYNTAX|247|  
...
## <a name="see-also"></a>另請參閱  
 [SQL Server、 Deprecated Features 物件](../performance-monitor/sql-server-deprecated-features-object.md)   
 [對全文檢索搜尋的重大變更](../../database-engine/breaking-changes-to-full-text-search.md)   
