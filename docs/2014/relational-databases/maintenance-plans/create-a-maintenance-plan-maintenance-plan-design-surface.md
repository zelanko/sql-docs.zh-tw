...
-   [使用維護計畫建立維護計畫 Design Surface](#SSMSProcedure)  
...
##  <a name="SSMSProcedure"></a>使用維護計畫 Design Surface  
...
4.  在 **[新增維護計畫]** 對話方塊中的 **[名稱]** 方塊，輸入計畫的名稱，然後按一下 **[確定]**。 這會開啟工具箱和 _maintenance_plan_name [設計]_ **** 介面，並在主要方格中建立預設的 [子計畫_1]**** 子計畫。  
...
11. 若要指定報表選項：  
    ...
    2.  在 **[報表與記錄]** 對話方塊中的 **[報表]** 底下，選取 **[產生文字檔報表]** 、 **[傳送報表至電子郵件收件者]** 或兩者。  
        ...
        2.  根據上述選項，透過在 **[資料夾]** 或 **[檔案名稱]** 方塊中輸入資訊，輸入新檔案或要附加之檔案的名稱和完整路徑。 或者，按一下省略號 **（...）** ，然後從 [**尋找資料夾-**_server_name_ ] 或 [**尋找資料庫檔案-**_server_name_ ] 對話方塊中選取資料夾或檔案名的路徑。  
...
12. 若要在記錄檔檢視器中檢視結果，請在物件總管**** 中以滑鼠右鍵按一下 [維護計畫]**** 資料夾或特定維護計畫，然後選取 [檢視記錄]****。  
     ...
     [**記錄檔檢視器-**_server_name_ ] 對話方塊有下列選項。  
