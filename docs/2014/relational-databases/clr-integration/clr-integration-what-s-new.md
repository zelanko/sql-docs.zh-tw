...
---
# <a name="what39s-new-in-clr-integration"></a>什麼&#39;s CLR 整合的新功能
...
-   在 CLR 版本 4 中，`System.TimeSpan` 值的格式錯誤將會產生 `System.FormatExceptions`。 在 CLR 的版本 4 之前，`System.TimeSpan` 值的格式錯誤會被忽略。 依賴 CLR 版本 4 之前行為的資料庫應用程式應該要以資料庫相容性層級 (`ALTER DATABASE Compatibility Level`) 100 或更低的層級來執行。 如需詳細資訊，請參閱[< TimeSpan_LegacyFormatMode > 項目](http://go.microsoft.com/fwlink/?LinkId=205109)。  
