...
-   [sys.assembly_files &#40;-SQL&AMP;#41;&#41;](/sql/relational-databases/system-catalog-views/sys-assembly-files-transact-sql)  
  
 **若要取得跨組件參考的相關資訊**  
  
-   [sys.assembly_references &#40;-SQL&AMP;#41;&#41;](/sql/relational-databases/system-catalog-views/sys-assembly-references-transact-sql)  
  
 **若要取得使用者定義類型的組件資訊**  
  
-   [sys.assembly_types &#40;-SQL&AMP;#41;&#41;](/sql/relational-databases/system-catalog-views/sys-assembly-types-transact-sql)  
