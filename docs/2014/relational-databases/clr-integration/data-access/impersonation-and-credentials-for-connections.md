...
> [!NOTE]  
>  如需模擬中行為變更的資訊，請參閱[SQL Server 2014 中對於 Database Engine 功能的突破性變更](../../../database-engine/breaking-changes-to-database-engine-features-in-sql-server-2016.md)。  
