...
---
# <a name="connect-to-azure-storage-restore"></a>連接到 Azure 儲存體 (還原)
  此對話方塊可讓您指定 Azure 儲存體帳戶資訊的連線, 以便在 Azure 儲存體帳戶中取出檔案儲存體。 指定所需的資訊之後, 按一下 **[連線]** 以建立與 Azure 儲存體的連接。  
