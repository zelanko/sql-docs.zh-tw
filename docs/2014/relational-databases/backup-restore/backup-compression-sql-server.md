...
> [!NOTE]  
>  資訊版本的[!INCLUDE[ssCurrent](../../includes/sscurrent-md.md)]支援備份壓縮，請參閱[支援的 SQL Server 2014 的版本功能](../../getting-started/features-supported-by-the-editions-of-sql-server-2014.md)。 每個 [!INCLUDE[ssKatmai](../../includes/sskatmai-md.md)] 版本與更新版本都可以還原壓縮的備份。  
