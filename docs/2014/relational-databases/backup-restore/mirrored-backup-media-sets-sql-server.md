...
> [!NOTE]  
>  如需媒體集的一般資訊，請參閱 [媒體集、媒體家族與備份組 &#40;SQL Server&#41;](media-sets-media-families-and-backup-sets-sql-server.md)Enterprise Edition 才支援鏡像備份媒體集。  
...
##  <a name="overview-of-mirrored-media-sets"></a><a name="OverviewofMirroredMediaSets"></a> 鏡像媒體集概觀  
 ...
 ![鏡像媒體集：兩個具有兩個鏡像的家族](../../database-engine/media/bnr-backup-media-mirror.gif "鏡像媒體集：兩個具有兩個鏡像的家族")  
...
##  <a name="hardware-requirements-for-backup-mirrors"></a><a name="HardwareReqs"></a> 備份鏡像的硬體需求  
