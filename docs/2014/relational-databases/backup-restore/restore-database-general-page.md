...
> [!NOTE]  
>  當[!INCLUDE[ssManStudioFull](../../includes/ssmanstudiofull-md.md)]您使用指定還原工作時, 可以按一下 [**腳本**], 然後選取腳本的目的地, 以產生對應[!INCLUDE[tsql](../../includes/tsql-md.md)]的[還原](/sql/t-sql/statements/restore-statements-transact-sql)腳本。  
