---
title: 使用標示的異動以一致的方式復原相關的資料庫 （完整復原模式） |Microsoft Docs
ms.custom: ''
ms.date: 06/13/2017
...
## <a name="recovering-to-a-marked-transaction"></a>復原到標示的交易  
 如需如何將包含標示之交易的資料庫復原成特定標示或該標示之前的相關資訊，請參閱 [復原包含標記之異動的相關資料庫](recovery-of-related-databases-that-contain-marked-transaction.md)。  
