...
-   用於只複製完整備份：  
     ...
     備份資料庫*database_name*到 \<backup_device*> * .。。使用 COPY_ONLY .。。  
...
### <a name="to-view-copy-only-backups"></a>檢視只複製備份
  
-   [backupset &#40;Transact-SQL&#41;](/sql/relational-databases/system-tables/backupset-transact-sql)  
  
### <a name="to-set-up-and-use-the-sql-server-powershell-provider"></a>若要設定和使用 SQL Server PowerShell 提供者
