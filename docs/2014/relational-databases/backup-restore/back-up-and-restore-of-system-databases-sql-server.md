...
-   您只能從伺服器執行個體目前執行之 [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] 版本所建立的備份還原系統資料庫。 例如，在執行 SP1 的伺服器實例上還原系統資料庫 [!INCLUDE[ssSQL11](../../includes/sssql11-md.md)] 。  
