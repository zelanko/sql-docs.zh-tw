...
##  <a name="permissions-naming-conventions"></a><a name="_conventions"></a>許可權命名慣例  
 以下描述一般權限命名慣例：  
...
##  <a name="sql-server-and-sql-database-permissions"></a><a name="_permissions"></a>SQL Server 和 SQL Database 許可權  
