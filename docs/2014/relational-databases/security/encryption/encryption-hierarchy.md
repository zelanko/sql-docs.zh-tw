...
-   服務主要金鑰和所有資料庫主要金鑰都是對稱金鑰。  
 ...
 ![在堆疊中顯示部分加密組合。](../../../database-engine/media/encryption-hierarchy-wheel.gif "在堆疊中顯示部分加密組合。")  
...
### <a name="transact-sql-functions"></a>Transact-SQL 函數  
 當使用 [!INCLUDE[tsql](../../../includes/tsql-md.md)] 函數插入或更新個別項目時，可以進行加密。 如需詳細資訊，請參閱 [ENCRYPTBYPASSPHRASE &#40;Transact-SQL&#41;](/sql/t-sql/functions/encryptbypassphrase-transact-sql) 和 [DECRYPTBYPASSPHRASE &#40;Transact-SQL&#41;](/sql/t-sql/functions/decryptbypassphrase-transact-sql)。  
