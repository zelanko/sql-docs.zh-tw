...
ms.author: edmaca
manager: craigg
ms.openlocfilehash: 34cc4d4d0e7c55218efde4bcb0789b227bd86600
ms.sourcegitcommit: c18fadce27f330e1d4f36549414e5c84ba2f46c2
ms.translationtype: MT
ms.contentlocale: zh-TW
ms.lasthandoff: 07/02/2018
ms.locfileid: "37313728"
---
...
2.  以滑鼠右鍵按一下 [稽核] 資料夾，然後選取 [新增稽核…]。 如需詳細資訊，請參閱 [Create a Server Audit and Server Audit Specification](create-a-server-audit-and-server-audit-specification.md)。  
