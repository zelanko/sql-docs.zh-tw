...
-   [自主資料庫使用者-使資料庫可攜](contained-database-users-making-your-database-portable.md)  
  
 **使用其他身分識別**  
  
-   [認證 &#40;資料庫引擎&#41;](authentication-access/credentials-database-engine.md)  
  
-   [以另一個登入執行](/sql/t-sql/statements/execute-as-transact-sql)  
...
-   [BitLocker （磁片磁碟機層級）](https://support.microsoft.com/kb/2855131)  
...
-   [儲存在 Azure Key Vault 中的金鑰](encryption/extensible-key-management-using-azure-key-vault-sql-server.md)  
  
 **資料行、 資料和金鑰加密**  
  
-   [依憑證加密](/sql/t-sql/functions/encryptbycert-transact-sql)  
  
-   [使用非對稱金鑰加密](/sql/t-sql/functions/encryptbyasymkey-transact-sql)  
  
-   [以對稱金鑰加密](/sql/t-sql/functions/encryptbykey-transact-sql)  
  
-   [以複雜密碼加密](/sql/t-sql/functions/encryptbypassphrase-transact-sql)  
...
-   [無權](permissions-database-engine.md)  
...
-   [簽署的物件](/sql/t-sql/statements/add-signature-transact-sql)  
...
-   [Azure 服務防火牆設定](/sql/relational-databases/system-stored-procedures/sp-set-firewall-rule-azure-sql-database)  
...
-   [SQL Server Audit &#40;資料庫引擎&#41;](auditing/sql-server-audit-database-engine.md)  
  
-   [SQL Database 稽核](https://azure.microsoft.com/documentation/articles/sql-database-auditing-get-started/)  
...
-   [通用條件](https://go.microsoft.com/fwlink/?LinkId=616319)  
  
 **SQL Database**  
  
-   [Microsoft Azure 信任中心：依功能的相容性](https://azure.microsoft.com/support/trust-center/services/)  
  
## <a name="see-also"></a>另請參閱  
 [保護 SQL Server](securing-sql-server.md)   
 [主體 &#40;資料庫引擎&#41;](authentication-access/principals-database-engine.md)   
 [SQL Server 憑證和非對稱金鑰](sql-server-certificates-and-asymmetric-keys.md)   
 [SQL Server 加密](encryption/sql-server-encryption.md)   
 [介面區設定](surface-area-configuration.md)   
 [強式密碼](strong-passwords.md)   
 [可信任的資料庫屬性](trustworthy-database-property.md)   
 [資料庫引擎功能和工作](../../database-engine/database-engine-features-and-tasks.md)  
