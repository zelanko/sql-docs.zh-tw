...
-   建立[DDL 觸發程序](../triggers/ddl-triggers.md)和[DML 觸發程序](../triggers/dml-triggers.md)  
 ...
 ![小型檔案資料夾圖示](../../integration-services/media/filefolder-small.gif "小型檔案資料夾圖示")**相容性**  
 **[SQL Server]**  
