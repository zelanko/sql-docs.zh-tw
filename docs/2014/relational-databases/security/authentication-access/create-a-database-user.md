...
4.  在 [資料庫使用者 - 新增] 對話方塊的 [一般] 頁面上，從 [使用者類型] 清單中選取下列其中一個使用者類型：**有登入的 SQL 使用者**，**沒有登入的 SQL 使用者**，**使用者對應至憑證**，**使用者對應至非對稱金鑰**，或**Windows 使用者**.  
 ...
 **資料庫使用者-新增**對話方塊也會提供其他四個頁面上的選項：**擁有的結構描述**，**成員資格**，**安全性實體**，和**擴充屬性**。  
