...
8.  根據指定的 [填滿因數](../indexes/specify-fill-factor-for-an-index.md) ，計算每個分頁所保留的可用資料列數目：  
...
8.  計算索引中的非分葉頁面數目：  
     ...
     ***Num_Index_Pages =*** ∑層級 ***（Num_Leaf_Pages/（Index_Rows_Per_Page***<sup>層級</sup>***））***  
