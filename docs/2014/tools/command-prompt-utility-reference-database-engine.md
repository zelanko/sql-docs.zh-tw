...
|[sqlagent90 應用程式](sqlagent90-application.md)|用來從命令提示字元啟動 [!INCLUDE[ssNoVersion](../includes/ssnoversion-md.md)] Agent。|\<drive>： \Program Files\Microsoft SQL Server \\ < *instance_name*> \mssql\binn|  
