...
ms.locfileid: "85007065"
---
# <a name="sqllocaldb-utility"></a>SqlLocalDB 公用程式
  使用 `SqlLocalDB` 公用程式來建立 LocalDB 的實例 [!INCLUDE[msCoName](../includes/msconame-md.md)] [!INCLUDE[ssExpCurrent](../includes/ssexpcurrent-md.md)] ** **。 `SqlLocalDB`公用程式（SqlLocalDB.exe）是簡單的命令列工具，可讓使用者和開發人員建立及管理 [!INCLUDE[ssExpress](../includes/ssexpress-md.md)] **LocalDB**的實例。 如需如何使用**LocalDB**的詳細資訊，請參閱[SQL Server 2014 Express LocalDB](../database-engine/configure-windows/sql-server-2016-express-localdb.md)。  
...
## <a name="arguments"></a>引數  
 [**建立**  |  ]**c** ] *\<instance-name>* *\<instance-version>* [**-s** ]  
 ...
 *\<instance-name>* 傳回名稱、版本、狀態（執行中或已停止）、指定之 localdb 實例的上次啟動時間 [!INCLUDE[ssExpress](../includes/ssexpress-md.md)] ** **，以及**localdb**的本機管道名稱。  
