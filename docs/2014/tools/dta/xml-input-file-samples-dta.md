...
-   [含內嵌工作負載的 XML 輸入檔範例 &#40;DTA&#41;](xml-input-file-sample-with-inline-workload-dta.md)  
  
-   [含使用者指定組態的 XML 輸入檔範例 &#40;DTA&#41;](xml-input-file-sample-with-user-specified-configuration-dta.md)  
