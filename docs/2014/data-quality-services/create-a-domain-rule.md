...
|值為日期/時間|只有具有 SQL Server 日期/時間資料類型的值才有效。 這包括 datetime、time、date 等等。|範例運算元：N/A<br /><br /> 有效值：1916-06-04;1916-06-04 18:24:24;2001 年 3 月 21日日;5/18/2011;18:24:24<br /><br /> 無效的值：March 213 2006|  
...
|值包含模式|只有包含運算元中之字元、數字和特殊字元模式的值才有效。|範例運算元：Aa-12 (值包含模式*任何*兩個字元後面接著連字號 （-） 的後面同樣再接著*任何*兩個數字。)<br /><br /> 有效值：AAA-01、ab 975-<br /><br /> 不是有效的值：A7、 AA-C-45、 6、c 98|  
|值不包含模式|只有不包含運算元中之字元模式的值才有效。|範例運算元：Ab-12 (值不能包含的模式*任何*兩個字元後面接著連字號 （-） 的後面同樣再接著*任何*兩個數字。)<br /><br /> 有效值：A7、 AA-C-45、 6、c 98<br /><br /> 不是有效的值：AAA-01、ab 975-|  
