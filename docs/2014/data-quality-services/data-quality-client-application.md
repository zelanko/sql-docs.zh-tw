...
# <a name="data-quality-client-application"></a>Data Quality Client 應用程式
 ...
 負責管理資料資產與維護高標準資料品質的資料管理人、資料專家或 IT 專業人員可以透過以下任一種角色使用用戶端應用程式：可以編輯並執行資料品質專案的 DQS KB 操作員；可以執行專案功能，以及建立並編輯知識庫的 DQS KB 編輯者；以及可以執行專案與知識庫功能並管理系統的 DQS 系統管理員。 如需詳細資訊，請參閱 < [DQS 安全性](../../2014/data-quality-services/dqs-security.md)。  
