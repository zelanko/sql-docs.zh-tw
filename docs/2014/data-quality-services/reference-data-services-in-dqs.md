...
##  <a name="Marketplace"></a>使用來自 Azure Marketplace 的參考資料  
 DQS 支援使用來自 Azure Marketplace 的參考資料，讓內容提供者透過 Marketplace 提供參考資料服務。 服務商場是 Microsoft 的服務，可針對高品質資料和應用程式提供單一服務商場和傳遞通道，並提供雲端服務。 如需 Marketplace 的詳細資訊，請參閱[瞭解 Azure Marketplace](https://azuremarketplace.microsoft.com/marketplace/)。  
