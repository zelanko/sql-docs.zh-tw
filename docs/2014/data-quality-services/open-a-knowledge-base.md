...
-   **\<空白 >**:[狀態] 欄位是空的知識庫，如果已發行知識庫，依序按一下**發佈**在定義域管理活動中，然後按一下**是-發行知識庫並結束**。  
  
-   **在工作中**:已儲存知識庫工作，依序按一下**發佈**在定義域管理活動中，然後按一下**否-儲存知識庫並結束的工作**。  
  
-   **定義域管理**:資料輸入的網域中的知識，但尚未發行知識庫，工作仍在定義域管理活動。 知識探索活動無法使用。 當您在 **[定義域管理]** 畫面中按一下 **[關閉]** 時，就會發生這種狀況。  
...
-   **比對原則-比對原則**:在 已關閉知識庫**比對原則-比對原則**頁面。 知識庫已鎖定，無法使用 [知識探索] 和 [定義域管理] 活動。  
  
-   **比對原則-比對結果**:在 已關閉知識庫**比對原則-比對結果**頁面。 知識庫已鎖定，無法使用 [知識探索] 和 [定義域管理] 活動。  
