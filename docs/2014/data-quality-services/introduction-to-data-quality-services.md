...
##  <a name="the-business-need-for-dqs"></a><a name="BusinessNeed"></a> DQS 的商務需求
...
##  <a name="answering-the-need-with-dqs"></a><a name="Answer"></a>使用 DQS 來回答需求
...
##  <a name="a-knowledge-driven-solution"></a><a name="KnowledgeDrivenSolution"></a> 知識驅動方案
...
##  <a name="dqs-components"></a><a name="Components"></a> DQS 元件
...
##  <a name="data-quality-functionality-in-integration-services-and-master-data-services"></a><a name="Processes"></a> Integration Services 和 Master Data Services 中的資料品質功能
