...
|透過知識探索將知識加入至知識庫；定義域值管理；加入比對原則；匯入知識、定義域或值；或是使用預設知識庫 (DQS 資料)。|[將知識新增至知識庫](../../2014/data-quality-services/adding-knowledge-to-a-knowledge-base.md)|  
