...
-   **新的**：DQS 沒有足夠的資訊 (建議)，因此無法對應至其他任何索引標籤的有效值。此外，此索引標籤也包含信賴等級低於 *自動建議臨界值* ，但夠高而可以標示為有效的值。  
...
|工作描述|主題|  
|----------------------|-----------|  
|描述如何設定清理活動的臨界值。|[設定清理和比對的閾值](../../2014/data-quality-services/configure-threshold-values-for-cleansing-and-matching.md)|  
