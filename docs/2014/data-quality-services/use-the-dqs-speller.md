...
##  <a name="enable-the-speller"></a><a name="Enable"></a> 啟用拼字檢查  
...
##  <a name="use-the-speller"></a><a name="Use"></a> 使用拼字檢查  
...
##  <a name="follow-up-after-using-the-speller"></a><a name="FollowUp"></a> 後續操作：使用拼字檢查之後  
...
##  <a name="how-the-speller-works"></a><a name="How"></a> 拼字檢查的運作方式  
