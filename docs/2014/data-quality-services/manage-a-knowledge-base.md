...
4.  在內容功能表中，您可以進行下列作業：  
    ...
    1.  **開啟**:按一下以開啟在中選取之活動的知識庫**選取活動**窗格。  
    ...
    6.  **屬性**：按一下即可將資料庫的屬性顯示在唯讀畫面中。  
        ...
        2.  **狀態**:指出知識庫是否**中的工作**而且如果它是在特定的知識管理活動中，決定最後關閉。 此狀態可能是 **[工作中]**(表示已在知識管理工作階段中開啟知識庫，但是並未進行特定活動)，或是 **[工作中]** 再加上知識管理活動 (表示已在知識管理工作階段中開啟知識庫，而且正在進行特定活動)。  
  
        3.  **已鎖定**:**真**如果知識庫已鎖定， **False**如果不是  
