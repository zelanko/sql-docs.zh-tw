...
ms.locfileid: "84937519"
---
# <a name="manage-dqs-databases"></a>管理 DQS 資料庫
  本節針對 DQS 資料庫提供可執行之資料庫管理活動的相關資訊，如備份/還原或卸離/附加等。  
  
##  <a name="backup-and-restore-the-dqs-databases"></a><a name="BackupRestore"></a> 備份與還原 DQS 資料庫  
...
|工作描述|主題|  
|----------------------|-----------|  
|描述如何備份及還原 DQS 資料庫。|[備份及還原 DQS 資料庫](../../2014/data-quality-services/backing-up-and-restoring-dqs-databases.md)|  
|描述如何卸離和附加 DQS 資料庫。|[卸離和附加 DQS 資料庫](../../2014/data-quality-services/detaching-and-attaching-dqs-databases.md)|  
