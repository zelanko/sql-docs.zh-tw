...
-   設定參考資料服務設定。 如需詳細資訊，請參閱[設定 DQS 使用參考資料](../../2014/data-quality-services/configure-dqs-to-use-reference-data.md)。  
...
-   在活動層級或更進階的模組層級設定 DQS 記錄檔的嚴重性層級。 如需詳細資訊，請參閱[Configure Severity Levels for DQS 記錄檔](../../2014/data-quality-services/configure-severity-levels-for-dqs-log-files.md)。  
