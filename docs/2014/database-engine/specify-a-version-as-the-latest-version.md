...
-   **固定版本**。 當您固定某個檔案版本時，並不會刪除比固定版本還新的版本。 另外，您也可以取消固定先前所固定的檔案。 當您執行這個動作時，最近簽入的檔案版本會成為最新的版本。 不過，您無法簽出固定的檔案。  
  
-   **回復到指定的版本**。 當您回復到指定的版本時，會從原始檔控制中刪除比回復目標版本還新的所有版本。 之後，您可以簽出其餘的最新版本。  
