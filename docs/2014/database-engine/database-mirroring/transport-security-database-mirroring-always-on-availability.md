...
### <a name="certificates"></a>憑證  
 ...
 在建立憑證時會建立加密方法。 如需詳細資訊，請參閱 [允許資料庫鏡像端點使用輸出連線的憑證 &#40;Transact-SQL&#41;](database-mirroring-use-certificates-for-outbound-connections.md)。 請謹慎管理您所使用的憑證。  
...
## <a name="see-also"></a>另請參閱  
 ...
 [疑難排解 AlwaysOn 可用性群組組態&#40;SQL Server&#41;刪除](../availability-groups/windows/troubleshoot-always-on-availability-groups-configuration-sql-server.md)
