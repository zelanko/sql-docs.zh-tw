...
-   當鏡像端點已經存在時，會顯示來自該端點的通訊埠編號。 如果您需要變更通訊埠，請使用 ALTER ENDPOINT 命令。 如需詳細資訊，請參閱 [ALTER ENDPOINT &#40;Transact-SQL&#41;](/sql/t-sql/statements/alter-endpoint-transact-sql)。  
