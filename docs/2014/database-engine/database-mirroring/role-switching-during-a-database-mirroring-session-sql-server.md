...
##  <a name="manual-failover"></a><a name="ManualFailover"></a>手動容錯移轉  
...
###  <a name="how-manual-failover-works"></a><a name="HowManualFoWorks"></a>手動容錯移轉的運作方式  
 手動容錯移轉會起始下列動作順序：  
...
##  <a name="forced-service-with-possible-data-loss"></a><a name="ForcedService"></a>強制服務（可能會遺失資料）  
...
###  <a name="typical-case-of-forced-service"></a><a name="TypicalCaseFS"></a>強制服務的一般情況  
 ...
 ![在可能遺失資料的情況下強制服務](../media/dbm-forced-service.gif "在可能遺失資料的情況下強制服務")  
