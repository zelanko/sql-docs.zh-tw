...
## <a name="see-also"></a>另請參閱
 資料庫[鏡像作業模式](database-mirroring-operating-modes.md)[在資料庫鏡像會話期間切換角色 &#40;SQL Server&#41;](role-switching-during-a-database-mirroring-session-sql-server.md) [監視資料庫鏡像 &#40;SQL Server&#41;](monitoring-database-mirroring-sql-server.md)
