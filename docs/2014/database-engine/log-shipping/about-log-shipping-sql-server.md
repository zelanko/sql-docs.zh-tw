...
-   [從移轉的必要條件是記錄傳送至 AlwaysOn 可用性群組&#40;SQL Server&#41;](../availability-groups/windows/prereqs-migrating-log-shipping-to-always-on-availability-groups.md)  
