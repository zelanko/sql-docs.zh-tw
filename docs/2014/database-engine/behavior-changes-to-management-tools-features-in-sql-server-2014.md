---
title: 行為變更至 管理工具 SQL Server 2014 中的功能 |Microsoft Docs
ms.custom: ''
ms.date: 11/27/2018
...
## <a name="previous-versions"></a> 非常舊版本的 SQL Server 的封存文件

[!INCLUDE[Archived documentation for very old versions of SQL Server](../includes/paragraph-content/previous-versions-archive-documentation-sql-server.md)]

## <a name="see-also"></a>另請參閱  
 [回溯相容性](../../2014/getting-started/backward-compatibility.md)  
 [SQL Server 2014 中管理工具功能的重大變更](breaking-changes-to-database-engine-features-in-sql-server-2016.md?view=sql-server-2014)
