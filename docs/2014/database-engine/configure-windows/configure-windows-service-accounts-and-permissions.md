...
-   [服務屬性和設定](#Serv_Prop)  
    ...
    -   [Windows 7 和 Windows Server 2008 R2 提供的新帳戶類型](#New_Accounts)  
...
|[!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] VSS Writer|[LOCAL SYSTEM](#Local_System)|[LOCAL SYSTEM](#Local_System)|  
 ...
 <sup>*</sup>當需要 [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] 電腦外部的資源時，[!INCLUDE[msCoName](../../includes/msconame-md.md)] 建議您使用受管理的服務帳戶（MSA），並以所需的最低許可權來設定。  
...
|[!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] Distributed Replay Client|DRU_CLT、CLTSVCACCOUNT、CLTSVCPASSWORD、CLTSTARTUPTYPE、CLTCTLRNAME、CLTWORKINGDIR、CLTRESULTDIR|  
 ...
 <sup>2</sup>[!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] Agent 服務會在 [!INCLUDE[ssExpress](../../includes/ssexpress-md.md)] 的實例上停用，並使用 Advanced Services [!INCLUDE[ssExpress](../../includes/ssexpress-md.md)]。  
...
|**[!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] Distributed Replay Client：**|**以服務方式登入** (SeServiceLogonRight)|  
 ...
 <sup>1</sup>[!INCLUDE[ssExpress](../../includes/ssexpress-md.md)]的實例上會停用 [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] Agent 服務。  
...
||\<ToolsDir>\DReplayClient\IRDefinition.xml|讀取、執行、列出資料夾內容|  
 ...
 <sup>1</sup>[!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] Agent 服務會在 [!INCLUDE[ssExpress](../../includes/ssexpress-md.md)] 的實例上停用，並使用 Advanced Services [!INCLUDE[ssExpress](../../includes/ssexpress-md.md)]。  
...
||\<報表伺服器 Web 服務帳戶>|*安裝>\<* \Reporting Services\ReportServer\global.asax|Full|  
...
||網路服務|*安裝>\<* \Reporting Services\ReportServer\ReportService.asmx|Full|  
...
-   **[HKEY_LOCAL_MACHINE \Software\Microsoft\Microsoft SQL Server\Instance Names\SQL]"InstanceName" = "MSSQL12.CONTOSO"**  
