...
ms.locfileid: "62782003"
---
# <a name="hide-an-instance-of-sql-server-database-engine"></a>隱藏 SQL Server Database Engine 的執行個體
  此主題描述如何使用 SQL Server 組態管理員，在 [!INCLUDE[ssDE](../../includes/ssde-md.md)] 中隱藏 [!INCLUDE[ssCurrent](../../includes/sscurrent-md.md)] 執行個體。 
...
## <a name="see-also"></a>另請參閱  
 [伺服器網路設定](server-network-configuration.md)   
 [SQL 虛擬伺服器用戶端連接的描述](https://support.microsoft.com/kb/273673)   
 [如何將靜態埠指派給名為 instance 的 SQL Server，並避免常見的缺陷](https://blogs.msdn.com/b/arvindsh/archive/2012/09/08/how-to-assign-a-static-port-to-a-sql-server-named-instance-and-avoid-a-common-pitfall.aspx)  
