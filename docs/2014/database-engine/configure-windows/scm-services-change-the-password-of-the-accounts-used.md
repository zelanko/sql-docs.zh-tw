...
4.  在 [ **SQL Server （** \<instancename> **）屬性**] 對話方塊的 [登入] 索引標籤上，針對 [**帳戶名稱**] 方塊中所列的帳戶，在 [**密碼**] 和 [**確認密碼**] 方塊中輸入新密碼，然後按一下 **[確定]**。  
...
4.  在 [ **SQL Server Agent （** \<instancename> **）屬性**] 對話方塊的 [登入] 索引標籤上，針對 [**帳戶名稱**] 方塊中所列的帳戶，在 [**密碼**] 和 [**確認密碼**] 方塊中輸入新密碼，然後按一下 **[確定]**。  
