---
title: 指定可用性組名頁面（新增可用性群組嚮導/加入資料庫 Wizard） |Microsoft Docs
ms.custom: ''
ms.date: 06/13/2017
...
ms.locfileid: "62789990"
---
# <a name="specify-availability-group-name-page-new-availability-group-wizardadd-database-wizard"></a>指定可用性群組名稱頁面 (新增可用性群組精靈/加入資料庫精靈)
...
##  <a name="PageOptions"></a>指定可用性組名選項  
 **指定可用性組名**  
 指定可用性群組的名稱。 若為新的可用性群組，請指定在 WSFC 叢集之所有可用性群組中唯一的有效 [!INCLUDE[ssNoVersion](../../../includes/ssnoversion-md.md)] 識別碼。 可用性群組名稱的最大長度為 128 個字元。  
