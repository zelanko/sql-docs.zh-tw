...
##  <a name="monitoring-the-alwayson-availability-groups-feature-on-a-server-instance"></a><a name="AoAgFeatureOnSI"></a>監視伺服器實例上的 AlwaysOn 可用性群組功能  
 若要監視伺服器執行個體上的 [!INCLUDE[ssHADR](../../../includes/sshadr-md.md)] 功能，請使用下列內建函數：  
  
 [SERVERPROPERTY](/sql/t-sql/functions/serverproperty-transact-sql) 函數  
...
##  <a name="monitoring-availability-replicas"></a><a name="AvReplicas"></a>監視可用性複本  
