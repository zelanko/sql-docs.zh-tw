---
title: Alwayson 操作問題的 Always On 可用性群組 (SQL Server) 原則 |Microsoft Docs
ms.custom: ''
ms.date: 06/13/2017
...
> [!IMPORTANT]  
>  **<sup>*</sup>**  對於 AlwaysOn 原則類別目錄名稱可做為 Id。 變更 AlwaysOn 類別目錄的名稱會破壞其健全狀況評估功能。 因此，請勿修改 AlwaysOn 類別目錄的名稱。  
