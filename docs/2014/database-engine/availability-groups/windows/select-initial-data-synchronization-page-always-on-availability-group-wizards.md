---
title: 選取初始資料同步處理頁面（AlwaysOn 可用性群組嚮導） |Microsoft Docs
ms.custom: ''
ms.date: 06/14/2017
...
-   若要將一個或多個記錄傳送主要資料庫加入可用性群組，或可從記錄傳送將一個或多個對應的次要資料庫移轉至 [!INCLUDE[ssHADR](../../../includes/sshadr-md.md)]。 如需詳細資訊，請參閱[從記錄傳送遷移至 AlwaysOn 可用性群組 &#40;SQL Server&#41;的必要條件](prereqs-migrating-log-shipping-to-always-on-availability-groups.md)。  
