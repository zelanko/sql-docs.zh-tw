...
-   [使用 SQL Server 的多個版本和實例](../../sql-server/install/work-with-multiple-versions-and-instances-of-sql-server.md)  
...
#### <a name="to-upgrade-to-sscurrent"></a>升級至 [!INCLUDE[ssCurrent](../../includes/sscurrent-md.md)]  
