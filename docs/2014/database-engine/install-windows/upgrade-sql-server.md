...
-   [升級的使用說明主題](../../../2014/sql-server/install/upgrade-how-to-topics.md)  
...
## <a name="see-also"></a>另請參閱  
 ...
 [升級複寫的資料庫](../../database-engine/install-windows/upgrade-replicated-databases.md)   
 [升級 Master Data Services](upgrade-master-data-services.md)   
 [SQL Server 2005 最佳做法分析程式](https://www.microsoft.com/download/details.aspx?id=23864)   
 [SQL Server 2008 R2 最佳做法分析程式](https://www.microsoft.com/download/details.aspx?id=15289)   
