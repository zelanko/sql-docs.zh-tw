...
-   [啟動/停止 SQL Server 服務](configure-sql-server-on-a-server-core-installation.md#bkmk_startstopservices)  
...
-   [SQL Server 稽核](configure-sql-server-on-a-server-core-installation.md#bkmk_auditing)  
  
-   [命令提示字元公用程式](configure-sql-server-on-a-server-core-installation.md#bkmk_cmd)  
  
-   [使用疑難排解工具](configure-sql-server-on-a-server-core-installation.md#bkmk_troubleshoot)  
