---
title: SQLXML 4.0.NET Framework 支援 |Microsoft 文件
ms.custom: ''
ms.date: 06/13/2017
...
## <a name="in-this-section"></a>本節內容  
 ...
 [.NET 環境中使用 SQLXML 大量載入](../../relational-databases/sqlxml-annotated-xsd-schemas-xpath-queries/sqlxml-4-0-net-framework-support-using-bulk-load.md)  
