---
title: 執行預存程式的使用說明主題（ODBC） |Microsoft Docs
ms.custom: ''
ms.date: 06/13/2017
...
-   [&#40;ODBC&#41;處理傳回碼和輸出參數](../../relational-databases/native-client-odbc-how-to/running-stored-procedures-process-return-codes-and-output-parameters.md)  
