...
-   [!INCLUDE[ssSampleDBnormal](../../includes/sssampledbnormal-md.md)]資料庫，可在 Codeplex 上取得[網站](http://go.microsoft.com/fwlink/?linkid=62796)  
...
-   [!INCLUDE[ssSampleDBnormal](../../includes/sssampledbnormal-md.md)] 資料庫必須安裝在您所使用的 [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] 執行個體上。  
...
```  
 ...
 這是 [!INCLUDE[tsql](../../includes/tsql-md.md)] 安裝指令碼 (`Install.sql`)，它會部署組件並在資料庫中建立函數。  
