...
ms.locfileid: "36033945"
---
# <a name="solution-explorer-source-control"></a>方案總管原始檔控制
  [!INCLUDE[msCoName](../includes/msconame-md.md)] [!INCLUDE[ssManStudioFull](../includes/ssmanstudiofull-md.md)] 方案總管 可以整合到不同的來源控制系統。 將方案或專案整合為原始檔控制系統之後，就可以控制專案中指令碼和查詢的檔案存取權和版本設定。  
...
3.  在**選項**對話方塊方塊中，展開 **原始檔控制**，然後按一下 **外掛程式選擇**頁面。  
...
|[將方案和專案加入原始檔控制](../../2014/database-engine/add-solutions-and-projects-to-source-control.md)|說明如何利用 [!INCLUDE[ssManStudio](../includes/ssmanstudio-md.md)] 環境，將方案和專案加入原始檔控制中。|  
