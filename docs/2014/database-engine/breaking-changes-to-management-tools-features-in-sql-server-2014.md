...
## <a name="breaking-changes-in-includesssql14includessssql14-mdmd"></a>中的重大變更[!INCLUDE[ssSQL14](../includes/sssql14-md.md)]  
 將於日後提供資訊。  
  
## <a name="breaking-changes-in-includesssql11includessssql11-mdmd"></a>中的重大變更[!INCLUDE[ssSQL11](../includes/sssql11-md.md)]  
