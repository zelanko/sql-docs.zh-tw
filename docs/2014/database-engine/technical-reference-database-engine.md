...
# <a name="technical-reference-database-engine"></a>技術參考 (Database Engine)
 ...
 [已註冊的伺服器 F1 說明](../ssms/register-servers/registered-servers-f1-help.md)  
 ...
 ![小型檔案資料夾圖示](../../2014/integration-services/media/filefolder-small.gif "小型檔案資料夾圖示")**命令提示字元公用程式參考**  
 ...
 ![小型檔案資料夾圖示](../../2014/integration-services/media/filefolder-small.gif "小型檔案資料夾圖示") **Database Engine PowerShell Cmdlet**  
 [Invoke-PolicyEvaluation 指令程式](../../2014/database-engine/invoke-policyevaluation-cmdlet.md)  
