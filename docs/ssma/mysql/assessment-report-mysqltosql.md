---
description: 評定報告 (MySQLToSQL)
title: 評量報表 (MySQLToSQL) |Microsoft Docs
ms.prod: sql
ms.custom: ''
ms.date: 01/19/2017
ms.reviewer: ''
...
若要存取評量報告，請選取要在來源中繼資料瀏覽器中轉換的物件，以滑鼠右鍵按一下 [ **架構**]，然後選取 [ **建立報告**]。  
...
|**Source**|顯示所選物件的 MySQL 程式碼，並反白顯示未轉換成的程式碼 [!INCLUDE[tsql](../../includes/tsql-md.md)] 。 只有在左窗格中選取了具有程式碼的個別物件時，才會顯示此窗格。<br /><br />按一下行號以設定或清除書簽。 使用窗格頂端的按鈕來流覽程式碼。|  
