...
-   設定 SQL server 的同步處理的相關資訊，請參閱[專案設定 &#40;同步處理 &#41;&#40;MySQLToSQL &#41;](../../ssma/mysql/project-settings-synchronization-mysqltosql.md).  
...
移轉程序的下一個步驟是[連接到 MySQL &#40;MySQLToSQL &#41;](../../ssma/mysql/connecting-to-mysql-mysqltosql.md)  
