---
description: SSMA 主控台中的命令列選項 (MySQLToSQL)
title: SSMA 主控台中的命令列選項 (MySQLToSQL) |Microsoft Docs
ms.prod: sql
ms.custom: ''
ms.date: 01/19/2017
ms.reviewer: ''
...
您無法將任何其他選項或密碼輸入為命令列參數。 否則會產生錯誤。 如需詳細資訊，請參閱 [管理密碼](managing-passwords-mysqltosql.md) 一節。  
...
如需 SSMA 主控台命令列選項的表格式顯示，請參閱 [附錄-1 &#40;MySQLToSQL&#41;](../../ssma/mysql/appendix-1-mysqltosql.md)。  
...
-   如需指定密碼或匯出/匯入密碼，請參閱 [管理密碼 &#40;MySQLToSQL&#41;](../../ssma/mysql/managing-passwords-mysqltosql.md)。  
  
-   若要產生報表，請參閱 [&#40;MySQLToSQL&#41;產生報表 ](../../ssma/mysql/generating-reports-mysqltosql.md)。  
  
-   如需疑難排解主控台中的問題，請參閱 [&#40;MySQLToSQL&#41;的疑難排解 ](../../ssma/mysql/troubleshooting-mysqltosql.md)。  
