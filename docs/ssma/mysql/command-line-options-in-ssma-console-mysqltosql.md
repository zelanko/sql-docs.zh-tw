---
title: SSMA 主控台 (MySQLToSQL) 中的命令列選項 |Microsoft Docs
ms.prod: sql
ms.custom: ''
ms.date: 01/19/2017
ms.reviewer: ''
...
您無法輸入任何其他選項和密碼，做為命令列參數。 否則，它會導致錯誤。 如需詳細資訊，請參閱[管理密碼](http://msdn.microsoft.com/4ffbc587-ea3f-49ad-bc42-a654f672325e)一節。  
...
SSMA 主控台命令列選項以表格形式顯示，請參閱[附錄-1 &#40;MySQLToSQL&#41;](../../ssma/mysql/appendix-1-mysqltosql.md)。  
...
-   指定的密碼或匯出 / 匯入的密碼，請參閱 <<c0> [ 管理的密碼&#40;MySQLToSQL&#41;](../../ssma/mysql/managing-passwords-mysqltosql.md)。</c0>  
  
-   要產生報表，請參閱[產生的報表&#40;MySQLToSQL&#41;](../../ssma/mysql/generating-reports-mysqltosql.md)。  
