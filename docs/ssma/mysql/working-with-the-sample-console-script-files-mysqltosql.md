---
title: 使用範例主控台指令碼檔 (MySQLToSQL) |Microsoft Docs
ms.prod: sql
ms.custom: ''
ms.date: 01/19/2017
ms.reviewer: ''
...
ms.locfileid: "47805116"
---
# <a name="working-with-the-sample-console-script-files-mysqltosql"></a>使用範例主控台指令碼檔 (MySQLToSQL)
...
-   **ServersConnectionFileSample.xml:**  
    ...
    -   如需有關如何連接到來源和目標伺服器的詳細資訊，請參閱 <<c0> [ 建立伺服器連線檔案&#40;MySQLToSQL&#41; ](../../ssma/mysql/creating-the-server-connection-files-mysqltosql.md) 。</c0>  
...
-   **VariableValueFileSample.xml:** 所有的變數，已使用範例主控台指令碼檔案和`ServersConnectionFileSample.xml`已定序，此檔案中。 使用者已取代範例變數的範例主控台指令碼的執行值與使用者定義的並將這個檔案傳遞做為其他命令列引數，以及指令碼檔案。  
    ...
    如需有關變數值檔案的詳細資訊，請參閱[建立變數值檔案&#40;MySQLToSQL&#41;](../../ssma/mysql/creating-variable-value-files-mysqltosql.md)。  
...
-   **AssessmentReportGenerationSample.xml:** 此範例可讓使用者產生的 xml 評定報告可以用於由使用者分析他開始轉換並移轉資料之前。  
    ...
    如需有關如何產生報告的詳細資訊，請參閱 <<c0> [ 產生的報表&#40;MySQLToSQL&#41;](../../ssma/mysql/generating-reports-mysqltosql.md)。</c0>  
...
-   **ConversionAndDataMigrationSample.xml:**  
    ...
    **命令名稱**  
    ...
    2.  如果使用者需要評估多個物件 / 資料庫他可以指定多個`metabase-object`節點中所示`convert-schema`命令的範例 4 的範例主控台指令碼檔案。  
    ...
    **命令名稱**  
    ...
    2.  如果使用者需要評估多個物件 / 資料庫他可以指定多個`metabase-object`節點中所示`synchronize-target`命令的範例 3 的範例主控台指令碼檔案。  
    ...
    **命令名稱**  
    ...
    2.  如果使用者需要評估多個物件 / 資料庫他可以指定多個`metabase-object`節點中所示`migrate-data`命令的範例 2 的範例主控台指令碼檔案。  
...
[建立伺服器連線檔案&#40;MySQLToSQL&#41;](../../ssma/mysql/creating-the-server-connection-files-mysqltosql.md)  
[產生報告&#40;MySQLToSQL&#41;](../../ssma/mysql/generating-reports-mysqltosql.md)  
