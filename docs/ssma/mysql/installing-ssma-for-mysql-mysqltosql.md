...
|[在 SQL Server (MySQL 上安裝 SSMA 元件至 SQL) ](https://msdn.microsoft.com/6772d0c5-258f-4d7b-afb0-b5f810e71af1)|提供在實例上安裝延伸模組套件的相關資訊和指示 [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] 。|  
