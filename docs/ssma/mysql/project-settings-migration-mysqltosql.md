...
|詞彙|定義|  
|--------|--------------|  
|**批次大小**|指定批次在資料移轉期間使用的大小。<br /><br />**預設模式**: 1000年<br /><br />**開放式模式**: 1000年<br /><br />**完整模式**: 1000年|  
...
|**值，驗證**|指定如何處理無效的空間值。 如果未指定 ' 嘗試進行有效 '，正在嘗試修改無效的值，讓它們變成有效。<br /><br />**預設模式**： 使有效<br /><br />**開放式模式**： 不會變更<br /><br />**完整模式**： 使有效|  
