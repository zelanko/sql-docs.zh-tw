...
當您定義的連接屬性時，您也可以指定其中將移轉物件和資料的資料庫。 您連線至 SQL Server 後，您可以自訂這個對應 MySQL 結構描述層級。 如需詳細資訊，請參閱[對應至 SQL Server 結構描述 &#40; 的 MySQL 資料庫MySQLToSQL &#41;](../../ssma/mysql/mapping-mysql-databases-to-sql-server-schemas-mysqltosql.md)  
...
-   若要自訂 MySQL 結構描述和 SQL Server 資料庫和結構描述之間的對應，請參閱[對應至 SQL Server 結構描述 &#40; 的 MySQL 資料庫MySQLToSQL &#41;](../../ssma/mysql/mapping-mysql-databases-to-sql-server-schemas-mysqltosql.md)  
