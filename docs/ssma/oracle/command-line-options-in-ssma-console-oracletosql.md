---
description: SSMA 主控台中的命令列選項 (OracleToSQL)
...
您無法將任何其他選項或密碼輸入為命令列參數。 否則會產生錯誤。 如需詳細資訊，請參閱 [管理密碼](managing-passwords-oracletosql.md) 一節。  
...
如需 SSMA 主控台命令列選項的表格式顯示，請參閱 [附錄-1 &#40;OracleToSQL&#41;](../../ssma/oracle/appendix-1-oracletosql.md)。  
