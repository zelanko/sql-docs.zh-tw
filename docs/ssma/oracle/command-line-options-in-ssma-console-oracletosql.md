---
title: SSMA 主控台 (OracleToSQL) 中的命令列選項 |Microsoft Docs
ms.prod: sql
ms.custom: ''
ms.date: 01/19/2017
ms.reviewer: ''
...
您無法輸入任何其他選項和密碼，做為命令列參數。 否則，它會導致錯誤。 如需詳細資訊，請參閱[管理密碼](http://msdn.microsoft.com/8c7d9f8e-06bb-476c-bbd2-15b61d5bba3c)一節。  
...
SSMA 主控台命令列選項以表格形式顯示，請參閱[附錄-1 &#40;OracleToSQL&#41;](../../ssma/oracle/appendix-1-oracletosql.md)。  
