---
description: 'SSMA for Oracle 的新 GUI 功能 (OracleToSQL) '
...
ms.locfileid: "88320334"
---
# <a name="new-gui-features-in-ssma-for-oracle-oracletosql"></a>SSMA for Oracle 的新 GUI 功能 (OracleToSQL) 
本章描述 SSMA 消費者介面的新功能。  
  
## <a name="layouts"></a>版面配置  
這項功能可讓您選擇兩個預先定義的 windows 配置的其中一個，或建立您自己的版面配置。 若要存取配置子功能表，請在 [View] 功能表上指向 [版面配置]。 您可以選擇其中一個現有的版面配置，加入新的版面配置或管理版面配置。  
