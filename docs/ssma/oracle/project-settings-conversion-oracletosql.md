...
|**取代函式呼叫中使用 ISNULL**|ISNULL 陳述式用於取代函式呼叫中，以模擬 Oracle 行為。 此設定有下列選項：<br /><br />是<br /><br />否<br /><br />當您選取的轉換模式**模式** 方塊中，SSMA 會套用下列設定：<br /><br />**預設/開放式模式：** 否<br /><br />**完整模式：** 是|  
|**CONCAT 函式呼叫中使用 ISNULL**|CONCAT 函式呼叫會使用 ISNULL 陳述式來模擬 Oracle 行為。 此設定有下列選項：<br /><br />是<br /><br />否<br /><br />當您選取的轉換模式**模式** 方塊中，SSMA 會套用下列設定：<br /><br />**預設/開放式模式：** 否<br /><br />**完整模式：** 是|  
