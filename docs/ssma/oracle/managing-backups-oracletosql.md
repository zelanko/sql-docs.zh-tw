...
若要開啟 [備份] 對話方塊，請在 [測試者] 功能表上指向 [Oracle 備份管理]，然後按一下 [備份 ...]。在 [備份] 對話方塊中，您會找到 Oracle 中繼資料樹狀結構，其中顯示已載入之 Oracle 架構的所有資料表。 選取一或多個資料表來執行備份。  
...
### <a name="restore"></a>還原  
若要開啟 [還原] 對話方塊，請在 [測試者] 功能表上指向 [Oracle 備份管理]，然後按一下 [還原]。您會在這裡找到一個樹狀結構，其中包含備份中可用的資料表。 選取一或多個資料表來還原其資料。  
...
若要開啟 [管理備份內容]，請在 [測試者] 功能表上指向 [Oracle 備份管理]，然後按一下 [備份內容]。您會在這裡找到一個樹狀結構，其中包含備份中的資料表。  
