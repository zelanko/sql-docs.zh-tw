...
/>  
```  
SSMA for Oracle 主控台應用程式支援回溯相容性。 您可以在 若要開啟建立的前一版的 SSMA 專案。  
...
-   `metabase:` 指定是否該檢視器來源或目標 metabase。  
...
-   `sql` 指定要轉換一或多個陳述式的 Oracle sql 陳述式可以分隔使用 「; 」  
...
如需命令列選項的資訊，請參閱[SSMA 主控台中的命令列選項&#40;OracleToSQL&#41; ](../../ssma/oracle/command-line-options-in-ssma-console-oracletosql.md) 。  
  
如需範例主控台指令碼檔的資訊，請參閱[使用範例主控台指令碼檔&#40;OracleToSQL&#41;](../../ssma/oracle/working-with-the-sample-console-script-files-oracletosql.md)  
  
下一個步驟取決於您的專案需求：  
  
-   指定的密碼或匯出 / 匯入的密碼，請參閱 <<c0> [ 管理的密碼&#40;OracleToSQL&#41;](../../ssma/oracle/managing-passwords-oracletosql.md)。</c0>  
  
-   要產生報表，請參閱[產生的報表&#40;OracleToSQL&#41;](../../ssma/oracle/generating-reports-oracletosql.md)。  
