---
description: " (對話方塊的全域設定)  (OracleToSQL) "
title: " (對話方塊的全域設定)  (OracleToSQL) |Microsoft Docs"
ms.prod: sql
ms.custom: ''
ms.date: 01/19/2017
ms.reviewer: ''
...
ms.locfileid: "88463190"
---
# <a name="global-settings-dialogs--oracletosql"></a> (對話方塊的全域設定)  (OracleToSQL) 
