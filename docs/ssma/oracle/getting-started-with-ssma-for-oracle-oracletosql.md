...
-   選取資料移轉的資料表，然後將資料從這些資料表[!INCLUDE[ssNoVersion](../../includes/ssnoversion_md.md)]。 如需詳細資訊，請參閱[移轉至 SQL Server 的 Oracle 資料&#40;OracleToSQL&#41;](../../ssma/oracle/migrating-oracle-data-into-sql-server-oracletosql.md)。  
...
如需詳細資訊，請參閱[載入轉換的資料庫物件至 SQL Server &#40;OracleToSQL&#41;](../../ssma/oracle/loading-converted-database-objects-into-sql-server-oracletosql.md)。  
...
[移轉至 SQL Server 的 Oracle 資料&#40;OracleToSQL&#41;](../../ssma/oracle/migrating-oracle-data-into-sql-server-oracletosql.md)  
