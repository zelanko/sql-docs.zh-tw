---
title: " (遷移的專案設定)  (OracleToSQL) |Microsoft Docs"
ms.prod: sql
ms.custom: ''
ms.date: 01/19/2017
ms.reviewer: ''
...
ms.locfileid: "87933239"
---
# <a name="project-settings-migration-oracletosql"></a>專案設定 (移轉) (OracleToSQL)
[**專案設定**] 對話方塊的 [遷移] 頁面包含自訂 SSMA 如何將資料從 Oracle 遷移至的設定 [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] 。  
