---
title: 將 Oracle 資料移轉至 SQL Server (OracleToSQL) |Microsoft Docs
...
> [!IMPORTANT]  
> 如果使用的引擎是伺服器端資料移轉引擎，則在您可以遷移資料之前，您必須先在執行 SSMA 的電腦上安裝 SSMA for Oracle Extension Pack 和 Oracle 提供者。 SQL Server Agent 服務也必須正在執行。 如需有關如何安裝延伸模組套件的詳細資訊，請參閱[ (OracleToSQL 安裝伺服器元件) ](https://msdn.microsoft.com/33070e5f-4e39-4b70-ae81-b8af6e4983c5)  
