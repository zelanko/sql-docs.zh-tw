...
|package|SSMA 會建立一組預存程式和函式，並透過類似的物件名稱進行整合。|  
...
|同義字|**同義字是針對下列物件類型所建立：**<br /><br />資料表和物件資料表<br /><br />視圖和物件檢視<br /><br />預存程序<br /><br />函式<br /><br />**下列物件的同義字會解析並由直接物件參考取代：**<br /><br />序列<br /><br />package<br /><br />JAVA 類別架構物件<br /><br />使用者定義物件類型<br /><br />另一個同義字的同義字無法遷移，而且將會標示為錯誤。<br /><br />不會針對具體化視圖建立同義字。|  
