---
description: " (遷移)  (DB2ToSQL) 的專案設定"
title: " (遷移)  (DB2ToSQL) 的專案設定 |Microsoft Docs"
ms.prod: sql
ms.custom: ''
ms.date: 01/19/2017
ms.reviewer: ''
...
ms.locfileid: "88426950"
---
# <a name="project-settings-migration-db2tosql"></a> (遷移)  (DB2ToSQL) 的專案設定
[ **專案設定** ] 對話方塊的 [遷移] 頁面包含的設定，可自訂 SSMA 將資料從 DB2 遷移至的方式 [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] 。  
