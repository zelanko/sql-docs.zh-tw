...
2.  [連接到 DB2 資料庫](http://msdn.microsoft.com/5eb5801d-f0c3-4127-97c0-0b1ef49f4844)。  
  
3.  [連接到 SQL Server](http://msdn.microsoft.com/b59803cb-3cc6-41cc-8553-faf90851410e)。  
  
4.  [DB2 結構描述對應到 SQL Server 結構描述](http://msdn.microsoft.com/05ff7bd4-e60b-4f48-a893-bc2346aa9a8a)。  
  
5.  （選擇性）[評估報告](http://msdn.microsoft.com/9e13eba0-e3cf-4205-974f-c00f982061de)評估進行轉換的資料庫物件，並且估計的轉換時間。  
  
6.  [將 DB2 結構描述轉換](http://msdn.microsoft.com/7947efc3-ca86-4ec5-87ce-7603059c75a0)。  
  
7.  [已轉換的資料庫物件載入 SQL Server](http://msdn.microsoft.com/f4ea1ced-9f9f-4a9d-88ab-81dbab64adc3)。  
...
8.  [將 DB2 資料移轉至 SQL Server](http://msdn.microsoft.com/86cbd39f-6dac-409a-9ce1-7dd54403f84b)。  
