---
description: " (對話方塊的全域設定)  (DB2ToSQL) "
title: " (對話方塊的全域設定)  (DB2ToSQL) |Microsoft Docs"
ms.prod: sql
ms.custom: ''
ms.date: 01/19/2017
ms.reviewer: ''
...
ms.locfileid: "88454210"
---
# <a name="global-settings-dialogs-db2tosql"></a> (對話方塊的全域設定)  (DB2ToSQL) 
