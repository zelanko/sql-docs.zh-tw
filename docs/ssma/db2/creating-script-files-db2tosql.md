...
ms.author: Shamikg
manager: craigg
ms.openlocfilehash: bfe74dfbd9f8514ecf5e77214a2528f657ab9424
...
## <a name="configuring-db2-console-settings"></a>設定 DB2 主控台設定  
指令碼的組態會顯示在主控台指令碼檔案。  
...
例如，DB2 資料庫中特定資料表的一般資料移轉如下的階層： 結構描述-&gt;資料表。  
