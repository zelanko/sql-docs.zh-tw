---
description: DB2ToSQL) 的 Advanced Object Selection (
title: DB2ToSQL) 的 Advanced Object Selection (|Microsoft Docs
ms.prod: sql
ms.custom: ''
ms.date: 01/19/2017
ms.reviewer: ''
...
ms.locfileid: "88463510"
---
# <a name="advanced-object-selection-db2tosql"></a>DB2ToSQL) 的 Advanced Object Selection (
