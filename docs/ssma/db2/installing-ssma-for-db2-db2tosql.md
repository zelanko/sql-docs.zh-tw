...
ms.openlocfilehash: 8e4bd893e696586626ea7f283d3a83c29878044a
...
您將會執行移轉步驟在電腦上安裝用戶端應用程式。 延伸模組組件部署用戶端，而且不需要個別安裝。  
  
## <a name="upgrading-ssma-for-db2"></a>升級的 SSMA for DB2  
如果您想要升級至更新版本的 SSMA for DB2 時，您必須先解除安裝用戶端和伺服器延伸模組組件，然後再安裝較新版本。  
  
## <a name="contents"></a>目錄  
  
|主題|Description|  
|---------|---------------|  
|[SSMA 安裝 DB2 用戶端 &#40; DB2ToSQL &#41;](../../ssma/db2/installing-ssma-for-db2-client-db2tosql.md)|提供有關的資訊和指示安裝 SSMA 用戶端。|  
