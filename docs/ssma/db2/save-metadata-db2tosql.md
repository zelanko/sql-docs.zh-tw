---
title: 儲存中繼資料（DB2ToSQL） |Microsoft Docs
ms.prod: sql
ms.custom: ''
ms.date: 01/19/2017
ms.reviewer: ''
...
若要存取 [**儲存中繼資料**] 對話方塊，請儲存專案。 如果遺漏任何中繼資料，SSMA 將會顯示 [**儲存中繼資料**] 對話方塊。  
...
**狀態**  
指出中繼資料是否已載入至 SSMA 專案，或中繼資料是否遺失。  
  
SSMA 會視需要將中繼資料載入專案。 當您流覽中繼資料和轉換架構時，會自動載入中繼資料。  
