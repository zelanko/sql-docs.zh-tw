...
ms.openlocfilehash: 2e3049789d6b6f987bced5d103b00fce5bd6743e
...
1. [將 Oracle 結構描述移轉至 SQL Server 2017 on Linux 與 SQL Server 移轉小幫手](oracle/sql-server-linux-convert-from-oracle.md)
