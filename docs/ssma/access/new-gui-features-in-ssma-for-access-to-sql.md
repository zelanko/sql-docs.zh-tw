---
description: SSMA 中的新 GUI 功能，可存取 SQL
title: SSMA 中的新 GUI 功能可存取 SQL |Microsoft Docs
ms.prod: sql
ms.custom: ''
ms.date: 01/19/2017
ms.reviewer: ''
...
ms.locfileid: "88320804"
---
# <a name="new-gui-features-in-ssma-for-access-to-sql"></a>SSMA 中的新 GUI 功能，可存取 SQL
本章將說明 SSMA 的新功能消費者介面  
  
## <a name="layouts"></a>版面配置  
這項功能可讓您選擇兩個預先定義的 windows 配置，或建立您自己的版面配置。 若要存取配置子功能表，請在 [View] 功能表上指向 [版面配置]。 您可以選擇其中一個現有的版面配置、新增目前的版面配置或管理版面配置。  
