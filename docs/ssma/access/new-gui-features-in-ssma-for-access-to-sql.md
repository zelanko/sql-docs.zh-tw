...
ms.openlocfilehash: f1d2b9fa1bd4cfd574a1bec992dd060937289963
...
這項功能可讓您選擇其中一個預先定義的兩個視窗配置，或建立自己版面配置。 若要存取版面配置 子功能表，請在 檢視 功能表上指向版面配置。 您那里選擇其中一個現有的配置、 加入目前的配置或管理配置。  
