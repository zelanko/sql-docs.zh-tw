...
---
# <a name="command-line-options-in-ssma-console-accesstosql"></a>SSMA 主控台 (AccessToSQL) 中的命令列選項
...
您不能輸入命令列參數選項或密碼。 否則，它會導致錯誤。 如需詳細資訊，請參閱[管理密碼](http://msdn.microsoft.com/en-us/b099d0f9-dd37-4c87-8b6f-ed0177881ea4)> 一節。  
