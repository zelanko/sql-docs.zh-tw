...
**[路徑] 方塊**  
顯示將加入 [位置] 方塊的路徑。 輸入或瀏覽至您想要掃描，然後按一下 [路徑**新增**] 按鈕。  
...
**取代**  
如果選取項目在清單中的位置，則路徑 文字方塊中的項目會取代選取的項目。  
  
**移除**  
從搜尋的位置清單中移除選取的項目。  
  
**全部或部份檔案名稱**  
若要尋找的名稱會包含特定字串的資料庫，輸入的字串。 請勿使用萬用字元。  
  
**建立日期**  
若要尋找特定的日期範圍內所建立的資料庫，請輸入的開始日期**從**方塊和結束日期的**至**方塊。  
  
**上次更新的日期**  
若要尋找資料庫上次更新特定的日期範圍內，輸入的開始日期**從**方塊和結束日期的**至**方塊。  
