...
建立新的專案頁面是您用來輸入專案的檔案名稱、 位置和移轉專案類型 （以用於移轉的 SQL Server 為目標的版本）。 如需詳細資訊，請參閱[新專案 (SSMA)](http://msdn.microsoft.com/ca294f6d-eeb5-42ca-9306-156281a3f0f3)  
...
-   [尋找資料庫精靈 （選取檔案）](http://msdn.microsoft.com/2f574a34-4bab-40a4-89a8-ad4907ffc3fd)  
  
-   [尋找資料庫精靈 (驗證選取項目)](http://msdn.microsoft.com/62e20e03-50cc-4ac8-8072-524d194d2ec3)  
