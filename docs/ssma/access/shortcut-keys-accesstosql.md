---
title: 快速鍵 (AccessToSQL) |Microsoft Docs
ms.prod: sql
ms.custom: ''
ms.date: 01/19/2017
ms.reviewer: ''
...
ms.locfileid: "63299080"
---
# <a name="shortcut-keys-accesstosql"></a>快速鍵 (AccessToSQL)
您可以使用鍵盤快速鍵來巡覽 SSMA 應用程式。 如需詳細資訊，請參閱下列主題。  
  
-   [功能表命令和其他快速鍵&#40;AccessToSQL&#41;](../../ssma/access/menu-commands-and-other-shortcut-keys-accesstosql.md)  
