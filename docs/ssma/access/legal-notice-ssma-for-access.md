---
description: 適用于存取)  (SSMA 法律注意事項
title: 法律注意事項 (存取) 的 SSMA |Microsoft Docs
ms.prod: sql
ms.custom: ''
ms.date: 01/19/2017
ms.reviewer: ''
...
ms.locfileid: "88372884"
---
# <a name="legal-notice-ssma-for-access"></a>適用于存取)  (SSMA 法律注意事項
...
© 2016 Microsoft Corporation. 著作權所有，並保留一切權利。  
