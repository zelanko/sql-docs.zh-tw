...
|存取最近使用的專案。|ALT + F + P|  
|顯示 [移轉精靈] 對話方塊。|ALT + F + W|  
|加入資料庫。|ALT + F + A|  
|移除資料庫。|ALT + F + R|  
|顯示 [尋找資料庫精靈] 對話方塊。|ALT + F + F|  
...
|顯示 [尋找資料庫精靈] 對話方塊。|ALT + T + F|  
|顯示轉換、 載入和移轉精靈 對話方塊。|ALT + T + V|  
|連結資料表，或連結的資料表。|ALT + T + L|  
|取消連結資料表，或取消連結資料表。|ALT + T + U|  
|匯出結構描述。|ALT + T + E|  
|在本機刪除。|ALT + T + D|  
...
[快速鍵&#40;AccessToSQL&#41;](../../ssma/access/shortcut-keys-accesstosql.md)  
