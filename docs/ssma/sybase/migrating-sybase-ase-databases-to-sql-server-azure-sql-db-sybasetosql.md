...
description: 使用此建議的程式，將 SAP 調適型伺服器企業資料庫移轉至使用 SQL Server 移轉小幫手 (SSMA) 的 SQL Server 或 Azure SQL Database。
ms.custom: ''
ms.date: 11/30/2017
ms.prod: sql
ms.reviewer: ''
