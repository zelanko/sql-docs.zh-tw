...
|[安裝 SSMA for Sybase &#40;SybaseToSQL&#41;](../../ssma/sybase/installing-ssma-for-sybase-sybasetosql.md)|包含的文章會提供必要條件和指示，以在執行 [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] 實例的電腦上安裝 Sybase 用戶端和必要元件的 SSMA。|  
