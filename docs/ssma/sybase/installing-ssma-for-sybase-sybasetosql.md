...
## <a name="upgrading-ssma-for-sap-ase"></a>升級的 SSMA for SAP ASE  
如果您想要將升級至更新版本的 SSMA for SAP ASE，您必須先解除安裝用戶端和伺服器延伸模組組件。 然後安裝較新版本。  
  
如果您開啟的專案從舊版的 SSMA for SAP ASE，SSMA 會詢問您想要將專案轉換成較新版本。 按一下**是**使用較新版本的 SSMA 專案。  
