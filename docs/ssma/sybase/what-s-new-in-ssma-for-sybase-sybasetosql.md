...
適用於 SAP ASE v8.2 版的 SSMA 已增強使用一組目標的設計可以改善品質和轉換度量，以及修正的修正程式：
...
2010 年 7 月版的 SSMA for Sybase 加入：
...
2007 年版的 SSMA for Sybase 加入：  
  
* 儲存專案時更快載入資料庫內容的能力。  
* 支援 SQL Server 中的使用者輸入註解格式 SQL 模式。  
* 在物件轉換中的增強功能。  
