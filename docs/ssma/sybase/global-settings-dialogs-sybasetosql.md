---
description: " (對話方塊的全域設定)  (SybaseToSQL) "
title: " (對話方塊的全域設定)  (SybaseToSQL) |Microsoft Docs"
ms.custom: ''
ms.date: 01/19/2017
ms.prod: sql
ms.reviewer: ''
...
ms.locfileid: "88492204"
---
# <a name="global-settings-dialogs--sybasetosql"></a> (對話方塊的全域設定)  (SybaseToSQL) 
