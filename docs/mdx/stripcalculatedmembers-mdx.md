...
## <a name="remarks"></a>備註  
 **StripCalculatedMembers**函式會從集合中移除匯出成員。 您可以使用 [AddCalculatedMembers](../mdx/addcalculatedmembers-mdx.md) 函式將匯出成員加入至集合中，此函數會傳回伺服器上定義的匯出成員，或是使用 WITH 成員語法在查詢本身內加入的匯出成員。  
