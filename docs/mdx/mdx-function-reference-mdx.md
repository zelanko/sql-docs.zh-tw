...
# <a name="mdx-function-reference-mdx"></a>MDX 函數參考 (MDX)
  ...
  Analysis Services 提供在多維度運算式（MDX）語法中使用函式的功能。 函數可以用於任何有效的 MDX 陳述式，且通常是用於查詢、自訂積存定義以及其他計算。 本節提供 MDX 函數的相關資訊。  
...
|函式|描述|  
|--------------|-----------------|  
|[MDX&#41;的階層 &#40;](../mdx/hierarchy-mdx.md)|傳回含有特定成員或層級的階層式架構。|  
|[維度 &#40;MDX&#41;](../mdx/dimension-mdx.md)|傳回含有指定成員、層級或階層式架構的維度。|  
|[MDX&#41;&#40;維度](../mdx/dimensions-mdx.md)|傳回由數值或字串運算式所指定的階層。|  
...
|函式|描述|  
|--------------|-----------------|  
|[&#40;MDX 的上階&#41;](../mdx/ancestor-mdx.md)|傳回某個成員在特定層級或特定距離的上階。|  
...
|[&#40;MDX&#41;的 Lag](../mdx/lag-mdx.md)|傳回在成員維度內指定的成員，前面指定幾個位置上的成員。|  
...
|[&#41; &#40;MDX 的成員 &#40;字串&#41;](../mdx/members-string-mdx.md)|傳回由字串運算式指定的成員。|  
...
|[父系 &#40;MDX&#41;](../mdx/parent-mdx.md)|傳回一個成員的父系。|  
|[PrevMember &#40;MDX&#41;](../mdx/prevmember-mdx.md)|傳回含有指定成員的層級中之前一個成員。|  
|[StrToMember &#40;MDX&#41;](../mdx/strtomember-mdx.md)|傳回由 MDX 格式的字串所指定的成員。|  
...
|[LinRegIntercept &#40;MDX&#41;](../mdx/linregintercept-mdx.md)|計算集合的線性回歸，並傳回回歸行 y = ax + b 中的攔截值。|  
|[LinRegPoint &#40;MDX&#41;](../mdx/linregpoint-mdx.md)|計算集合的線性回歸，並傳回回歸行 y = ax + b 中*y*的值。|  
|[LinRegR2 &#40;MDX&#41;](../mdx/linregr2-mdx.md)|計算一個集合的線性迴歸，並傳回決定係數 R2。|  
|[LinRegSlope &#40;MDX&#41;](../mdx/linregslope-mdx.md)|計算集合的線性回歸，並傳回迴歸線 y = ax + b 中的斜率值。|  
...
|[&#40;MDX&#41;的最大值](../mdx/max-mdx.md)|在集合評估後傳回數值運算式的最大值。|  
...
|[次序 &#40;MDX&#41;](../mdx/rank-mdx.md)|傳回指定集合中、指定 Tuple 的以一為基底次序。|  
...
|[MDX&#41;的值 &#40;](../mdx/value-mdx.md)|傳回一個量值的數值。|  
|[&#40;MDX&#41;的 Var](../mdx/var-mdx.md)|傳回某個數值運算式在採用無偏差結果母體公式的集合上所評估出的範例變異數。|  
|[&#40;MDX 的變異數&#41;](../mdx/variance-mdx.md)|[Var &#40;MDX&#41;](../mdx/var-mdx.md)的別名。|  
...
|[尾 &#40;MDX&#41;](../mdx/tail-mdx.md)|從集合末端傳回一個子集合。|  
...
|[年初迄今 &#40;MDX&#41;](../mdx/ytd-mdx.md)|傳回與指定成員相同層級的一組兄弟成員，從第一個兄弟開始，並以指定的成員結束，如同時間維度中的*Year*層級所限制。|  
...
|[&#41; &#40;MDX 的專案 &#40;元組&#41;](../mdx/item-tuple-mdx.md)|從集合傳回一個 Tuple。|  
|[根 &#40;MDX&#41;](../mdx/root-mdx.md)|傳回由 cube、維度或元組中每個屬性階層之**所有**成員組成的元組。|  
|[StrToTuple &#40;MDX&#41;](../mdx/strtotuple-mdx.md)|傳回由 MDX 格式的字串所指定的元組。|  
