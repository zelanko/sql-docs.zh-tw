...
> [!NOTE]  
>  *預存*程式是用於 [!INCLUDE[ssASnoversion](../includes/ssasnoversion-md.md)] 這類函數的術語。 舊版的會將 [!INCLUDE[ssASnoversion](../includes/ssasnoversion-md.md)] 這些類型的函*式當做使用者定義函數*來呼叫。  
