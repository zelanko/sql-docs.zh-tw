...
## <a name="remarks"></a>備註  
 ...
 每次使用連接字串參數\<*子查詢 = 1*開啟連接時, 匯出成員就可以包含在 SELECT 查詢座標軸子句 > 中, 請參閱[支援的 xmla &#40;屬性 xmla&#41; ](https://docs.microsoft.com/bi-reference/xmla/xml-elements-properties/propertylist-element-supported-xmla-properties)和<xref:Microsoft.AnalysisServices.AdomdClient.AdomdConnection.ConnectionString%2A>用於參數使用方式。 以下提供子選擇中的導出成員範例。  
...
|**HL Mountain Frame**|**$3,365,069.27**|**$174.11**|**0.01%**|  
 ...
 您可以在連接字串中使用自動存在 = [1 | 2 | 3] 參數來修改自動存在行為;如需參數使用方式, <xref:Microsoft.AnalysisServices.AdomdClient.AdomdConnection.ConnectionString%2A>請參閱[支援的 xmla 屬性&#40;xmla&#41; ](https://docs.microsoft.com/bi-reference/xmla/xml-elements-properties/propertylist-element-supported-xmla-properties)和。  
...
## <a name="see-also"></a>另請參閱  
 ...
 [使用查詢和交叉分析篩選器軸&#40;來限制查詢 MDX&#41;](~/analysis-services/multidimensional-models/mdx/mdx-query-and-slicer-axes-restricting-the-query.md)  
