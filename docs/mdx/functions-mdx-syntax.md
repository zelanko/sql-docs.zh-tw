---
description: 函數 (MDX 語法)
title: 函數 (MDX 語法) |Microsoft Docs
ms.date: 06/04/2018
ms.prod: sql
...
|函數類別|描述|  
|-----------------------|-----------------|  
|陣列函數|提供可在預存程序中使用的陣列。<br /><br /> 如需詳細資訊，請參閱 [使用預存程式 &#40;MDX&#41;](../mdx/using-stored-procedures-mdx.md)。|  
...
|集合函數|傳回其他物件集合的參考，或字串運算式的參考。<br /><br /> 如需詳細資訊，請參閱 [使用設定函數](../mdx/using-set-functions.md)。|  
