...
```  
 ...
 此外，MDX 使用特殊的一元運算子來判斷 [RollupChildren](../mdx/rollupchildren-mdx.md) 函數所執行的匯總作業。 如需有關這些特殊一元運算子的詳細資訊，請參閱 [將自訂匯總加入至維度](/analysis-services/multidimensional-models/bi-wizard-add-a-custom-aggregation-to-a-dimension)。  
