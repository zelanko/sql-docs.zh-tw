...
## <a name="remarks"></a>備註  
 **StrToMember**函數會傳回字串運算式中指定的成員。 **StrToMember**函數通常會搭配使用者自訂函數使用，以將成員規格從外部函數傳回至 mdx 語句，或在 MDX 查詢已參數化時。  
...
## <a name="examples"></a>範例  
 下列範例會使用**StrToMember**函數，傳回州名屬性階層中 Bayern 成員的「轉售商銷售量」量值。 指定的字串提供了限定成員名稱。  
...
```  
 ...
 下列範例會使用**StrToMember**函數，傳回州名屬性階層中 Bayern 成員的「轉售商銷售量」量值。 所提供的成員名稱字串會解析成合格的成員名稱。  
