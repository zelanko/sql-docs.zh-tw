...
1. [建立並快速地建立 TRANSACT-SQL (T-SQL) 指令碼中的使用程式碼片段[!INCLUDE[name-sos](../includes/name-sos-short.md)]](code-snippets.md)
2. [儀表板[!INCLUDE[name-sos](../includes/name-sos-short.md)]](dashboards.md)
3. [下載並安裝[!INCLUDE[name-sos](../includes/name-sos.md)]](download.md)
4. [連接[!INCLUDE[name-sos](../includes/name-sos-short.md)]到 SQL Server 使用 Windows 驗證的 Kerberos](enable-kerberos.md)
5. [[!INCLUDE[name-sos](../includes/name-sos.md)]常見問題集](faq.md)
6. [管理伺服器和資料庫中的 深入了解 widget[!INCLUDE[name-sos](../includes/name-sos-short.md)]](insight-widgets.md)
7. [整合式終端機](integrated-terminal.md)
8. [中的鍵盤快速鍵[!INCLUDE[name-sos](../includes/name-sos.md)]](keyboard-shortcuts.md)
9. [快速入門： 使用[!INCLUDE[name-sos](../includes/name-sos-short.md)]連接並查詢 Azure SQL database](quickstart-sql-database.md)
10. [快速入門： 使用[!INCLUDE[name-sos](../includes/name-sos-short.md)]連接並查詢 Azure SQL 資料倉儲中的資料](quickstart-sql-dw.md)
11. [快速入門： 連接及查詢 SQL Server 使用[!INCLUDE[name-sos](../includes/name-sos-short.md)]](quickstart-sql-server.md)
12. [中的伺服器群組[!INCLUDE[name-sos](../includes/name-sos-short.md)]](server-groups.md)
13. [使用者和工作區設定](settings.md)
14. [使用原始檔控制中[!INCLUDE[name-sos](../includes/name-sos-short.md)]](source-control.md)
15. [備份及還原使用[!INCLUDE[name-sos](../includes/name-sos-short.md)]](tutorial-backup-restore-sql-server.md)
16. [教學課程： 建立自訂的見解 widget](tutorial-build-custom-insight-sql-server.md)
17. [教學課程： 將*5 名最慢的查詢*範例資料庫儀表板的小工具](tutorial-qds-sql-server.md)
18. [教學課程： 使用 TRANSACT-SQL 編輯器來建立資料庫物件，[!INCLUDE[name-sos](../includes/name-sos-short.md)]](tutorial-sql-editor.md)
19. [教學課程： 使用情況下啟用資料表的空間使用方式範例深入了解 widget[!INCLUDE[name-sos](../includes/name-sos-short.md)]](tutorial-table-space-sql-server.md)
20. [啟用或停用的使用量資料收集[!INCLUDE[name-sos](../includes/name-sos-short.md)]](usage-data-collection.md)
21. [什麼是[!INCLUDE[name-sos](../includes/name-sos.md)]？](what-is.md)
