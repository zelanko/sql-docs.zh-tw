...
SQL Server Agent 延伸模組是管理和疑難排解 SQL Agent 作業和組態的擴充功能。 此延伸模組目前為預覽狀態。

主要工作包括：
- 列出在 SQL Server 上 SQL Server Agent 的工作設置
- 檢視作業歷程記錄與工作執行結果
- 啟動和停止作業的基本作業控制
...
當您連接到 SQL Server Agent 擴充功能時，您會看到第一件事是一份您所有的 Agent 作業清單。
