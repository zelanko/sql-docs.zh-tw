...
<div id="main" class="v2">
                    ...
                    <div class="cardSize">
                        <div class="cardPadding">
                            <div class="card">
                                ...
                                <div class="cardText">
                                    <span class="likeAnH3">取得使用 SQL Server 的 Azure VM</span>
                                </div>
                            </div>
                        </div>
                    </div>
    ...
    <div class="container">
        <h1 class="screenReader">Microsoft SQL 文件</h1>
        <ul class="pivots">
            <li>
                                  ...
                                  <div class="cardPadding">
                                      <div class="card">
                                          ...
                                          <div class="cardText">
                                              ...
                                              <ul class="noBullet">
                                              <li><a class="barLink" href="/sql/sql-server/sql-server-technical-documentation?toc=..%2ftoc%2ftoc.json"><strong>內部部署</strong></a></li>
                                              ...
                                              <li><a class="barLink" href="/sql/sql-server/what-s-new-in-sql-server-ver15/"><strong>新功能</strong></a></li>
                                              </ul>
                                          </div>
                                      </div>
                                  </div>
                              ...
                              <div class="cardSize">
                                  <div class="cardPadding">
                                      <div class="card">
                                          ...
                                          <div class="cardText">
                                              <h3>SQL 作為 Azure 服務</h3>
                                              <ul class="noBullet">
                                                  <li><a class="barLink" href="/azure/sql-database/"><strong>Azure SQL Database</strong></a></li>
                                                  <li><a class="barLink" href="/azure/sql-data-warehouse/sql-data-warehouse-overview-what-is/"> <strong>Azure SQL 資料倉儲</strong></a></li>
                                                  <li><a class="barLink" href="https://azure.microsoft.com/updates/?status=all&product=sql-database"><strong>新功能</strong></a></li>
                                              </ul>
                                          </div>
                                      </div>
                                  </div>
                                    ...
                                    <div class="cardPadding">
                                        <div class="card">
                                            ...
                                            <div class="cardText">
                                                ...
                                                <ul class="noBullet">
                                                    <li><a class="barLink" href="/sql/linux/sql-server-linux-overview/"><strong>內部部署</strong></a></li>
                                                    <li><a class="barLink" href="/sql/linux/quickstart-install-connect-clouds/"><strong>在 Azure VM 上</strong></a></li>
                                                    <li><a class="barLink" href="/sql/linux/sql-server-linux-whats-new/"><strong>新功能</strong></a></li>
                                                </ul>
                                            </div>
                                        </div>
                                    </div>
                                          ...
                                          <div class="cardSize">
                                              <div class="cardPadding">
                                                  <div class="card">
                                                      ...
                                                      <div class="cardText">
                                                          <h3>安裝或升級</h3>
                                                          <p>開始使用詳細說明如何安裝和升級 SQL Server 及其相關聯服務的文件。</p>
                                                      </div>
                                                  </div>
                                              </div>
                                          </div>
                                          ...
                                          <div class="cardSize">
                                              <div class="cardPadding">
                                                  <div class="card">
                                                      ...
                                                      <div class="cardText">
                                                          <h3>商務持續性</h3>
                                                          <p><b>高可用性、災害復原、Always On 可用性群組、Always On 容錯移轉叢集執行個體、資料庫鏡像、備份與還原</b></p>
                                                      </div>
                                                  </div>
                                              </div>
                                          </div>
                                          ...
                                          <div class="cardSize">
                                              <div class="cardPadding">
                                                  <div class="card">
                                                      ...
                                                      <div class="cardText">
                                                          <h3>Security</h3>
                                                          <p><b>權限、存取管理、Always Encrypted、TDE、SSL</b></p>
                                                      </div>
                                                  </div>
                                              </div>
                                          </div>
                                          ...
                                          <div class="cardSize">
                                              <div class="cardPadding">
                                                  <div class="card">
                                                      ...
                                                      <div class="cardText">
                                                          <h3>深入了解 SQL Server</h3>
                                                          <p>使用一系列的指南和教學課程，深入了解 SQL Server 架構內部。 </p>
                                                      </div>
                                                  </div>
                                              </div>
                                          </div>
                                                  ...
                                                  <div class="cardText">
                                                        ...
                                                        <ul class="noBullet">
                                                          <li><a class="barLink" href="/sql/relational-databases/database-features/">關聯式資料庫概念</a></li>
                                                            <li><a class="barLink" href="/sql/connect/homepage-sql-connection-programming/">與內部部署用戶端應用程式連線</a></li>
                                                            <li><a class="barLink" href="/azure/sql-database/sql-database-libraries">Azure SQL DB 連線程式庫</a></li>
                                                            <li><a class="barLink" href="https://docs.microsoft.com/azure/sql-database/sql-database-develop-overview">Azure SQL DB 應用程式</a></li>
                                                        </ul>
                                                    </div>
                                                </div>
                                            </div>
                                        ...
                                        <div class="cardSize">
                                            <div class="cardPadding">
                                                ...
                                                <ul class="noBullet">
                                                     ...
                                                     <li><a class="barLink" href="/sql/samples/sql-samples-where-are/">資料庫範例</a></li>
                                                     <li><a class="barLink" href="/previous-versions/sql/">已封存內容 (SQL 2005-2012)</a></li>
                                                </ul></td></tr></table>
                                                    </div>
                                                </div>
                                            </div>
                                                ...
                                                <div class="card">
                                                  <div class="cardText">
                                                        ...
                                                        <ul class="noBullet">
                                                            ...
                                                            <li><a class="barLink" href="/power-bi/service-get-started/">Power BI 服務</a></li>
                                                            <li><a class="barLink" href="/power-bi/report-server/get-started/">Power BI 報表伺服器</a></li>
                                                        </ul>
                                                    </div>
                                                </div>
                                            </div>
                                                ...
                                                <div class="card">
                                                  <div class="cardText">
                                                        ...
                                                        <li><a class="barLink" href="/sql/analytics-platform-system/">Microsoft Analytics Platform System</a></li>
                                                            ...
                                                            <li><a class="barLink" href="/sql/relational-databases/polybase/polybase-guide/">PolyBase</a></li>                                                            <li><a class="barLink" href="/sql/big-data-cluster/big-data-cluster-overview/">SQL Server 2019 巨量資料叢集</a></li>
                                                       </ul>
                                                    </div>
                                                </div>
                                            </div>
