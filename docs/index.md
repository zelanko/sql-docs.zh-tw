                                        ...
                                        <div class="card">
                                            <div class="cardText">
                                                ...
                                                <ul class="noBullet">
                                                    ...
                                                    <li><a class="barLink" href="https://docs.microsoft.com/azure/sql-data-warehouse/sql-data-warehouse-overview-what-is">Azure SQL 資料倉儲</a></li>                                                    <li><a class="barLink" href="/sql/sql-server/sql-server-technical-documentation?view=sql-server-2017">SQL Server 2017</a></li>
                                                    ...
                                                    <li><a class="barLink" href="https://docs.microsoft.com/en-us/previous-versions/sql/">舊版 SQL Server (2005 - 2012)</a></li>
                                    ...
                                    <div class="cardPadding">
                                        <div class="card">
                                            <div class="cardText">
                                                ...
                                                <h4>範例</h4>
                                                <ul class="noBullet">
                                                    <li><a class="barLink" href="https://github.com/Microsoft/sql-server-samples/tree/master/samples">GitHub 上的程式碼範例</a></li>
