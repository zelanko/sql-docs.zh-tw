...
可以。 DEA 支援 XEvents。 下載 DEA 的最新版本，並試用。
...
- 使用者具有 [重新執行] [常見問題](./database-experimentation-assistant-replay-trace.md?view=sql-server-ver15#frequently-asked-questions-about-trace-replay)中所列的許可權。
