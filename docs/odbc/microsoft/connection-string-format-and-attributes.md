...
|備註|當這個值為 true （1）時，驅動程式會傳回[SQLColumns](../../odbc/microsoft/level-1-api-functions-odbc-driver-for-oracle.md)結果集的 [備註] 資料行。 當此值未設定時，ODBC Driver for Oracle 可提供更快速的存取。|0|  
