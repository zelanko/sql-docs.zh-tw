---
description: Visual FoxPro 語言參考
title: Visual FoxPro 語言參考 |Microsoft Docs
ms.custom: ''
ms.date: 01/19/2017
ms.prod: sql
...
-   [DROP TABLE 命令](../../odbc/microsoft/drop-table-command.md)  
...
-   [SET BLOCKSIZE 命令](../../odbc/microsoft/set-blocksize-command.md)  
...
-   [SET EXCLUSIVE 命令](../../odbc/microsoft/set-exclusive-command.md)  
  
-   [SET NULL 命令](../../odbc/microsoft/set-null-command.md)  
  
-   [SET PATH 命令](../../odbc/microsoft/set-path-command.md)  
  
-   [SET REPROCESS 命令](../../odbc/microsoft/set-reprocess-command.md)  
  
-   [SET UNIQUE 命令](../../odbc/microsoft/set-unique-command.md)  
  
-   [UPDATE - SQL 命令](../../odbc/microsoft/update-sql-command.md)  
  
-   [Visual FoxPro 欄位資料類型](../../odbc/microsoft/visual-foxpro-field-data-types.md)
