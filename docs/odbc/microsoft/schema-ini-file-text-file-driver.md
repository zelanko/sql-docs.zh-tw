...
|**CurrencyNegFormat**|可以是下列值之一：<br /><br /> -（$1）<br />--$1<br />-$-1<br />-$1-<br />-（$1）<br />--$1<br />-1-$<br />-$1-<br />--$1<br />--$1<br />-$1-<br />-$1-<br />-$-1<br />-1-$<br />-（$1）<br />-（$1）<br /><br /> 這個範例會顯示貨幣符號，但您應該以實際程式中的適當**CurrencySymbol**值來取代它。|  
