---
title: 唯讀狀態 （文字檔案驅動程式） |Microsoft 文件
ms.custom: ''
ms.date: 01/19/2017
ms.prod: sql
...
ms.locfileid: "32898983"
---
# <a name="read-only-status-text-file-driver"></a>唯讀狀態 （文字檔案驅動程式）
使用文字驅動程式時，資料來源資料表是唯讀的。 不過，應用程式可以針對文字的資料表執行插入。
