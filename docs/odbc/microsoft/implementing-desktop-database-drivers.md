...
-   [桌面資料庫驅動程式搭配使用的檔案](../../odbc/microsoft/files-to-use-with-the-desktop-database-drivers.md)  
...
-   [桌面資料庫驅動程式的診斷功能](../../odbc/microsoft/diagnostics-for-desktop-database-drivers.md)  
  
-   [接受字串參數的函式](../../odbc/microsoft/functions-accepting-string-parameters.md)  
  
-   [Sql-92 相容性](../../odbc/microsoft/sql-92-compliance.md)  
  
-   [驅動程式的起始位址](../../odbc/microsoft/base-address-of-drivers.md)  
