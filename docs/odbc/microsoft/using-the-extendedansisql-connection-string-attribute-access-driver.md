...
-   [設定 ExtendedAnsiSQL](../../odbc/microsoft/setting-extendedansisql.md)  
  
-   [藉由設定 ExtendedAnsiSQL 啟用新的資料類型](../../odbc/microsoft/enabling-new-data-types-by-setting-extendedansisql.md)  
  
-   [建立和卸除檢視和使用 ExtendedAnsiSQL 程序](../../odbc/microsoft/creating-and-dropping-views-and-procedures-using-extendedansisql.md)  
