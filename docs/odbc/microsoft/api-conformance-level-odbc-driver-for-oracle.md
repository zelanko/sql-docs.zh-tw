...
>  將移除這項功能，在未來的版本的 Windows。 請避免在新的開發工作中使用這項功能，並規劃修改目前使用這項功能的應用程式。 相反地，使用由 Oracle 提供的 ODBC 驅動程式。  
 ...
 ODBC Driver for Oracle 支援[核心層級 API 函式](../../odbc/microsoft/core-level-api-functions-odbc-driver-for-oracle.md)和[層級 1 API 函式](../../odbc/microsoft/level-1-api-functions-odbc-driver-for-oracle.md)。 此驅動程式也支援下列[層級 2 API 函式](../../odbc/microsoft/level-2-api-functions-odbc-driver-for-oracle.md):  
