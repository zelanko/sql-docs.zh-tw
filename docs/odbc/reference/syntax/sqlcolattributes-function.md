...
ms.openlocfilehash: 2cfdf8bacf7cf043a8f00ee9bea4eff10c10b1db
 ...
 **摘要**  
 在 ODBC 3。*x*，ODBC 2.0 函式**SQLColAttributes**已被取代**SQLColAttribute**。 如需詳細資訊，請參閱[SQLColAttribute 函數](../../../odbc/reference/syntax/sqlcolattribute-function.md)。  
