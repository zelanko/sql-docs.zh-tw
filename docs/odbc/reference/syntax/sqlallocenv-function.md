---
title: SQLAllocEnv 函式 |Microsoft Docs
ms.custom: ''
ms.date: 01/19/2017
ms.prod: sql
 ...
 **摘要**  
 在 ODBC 3 中。*x*，ODBC 2。*x*函數**SQLAllocEnv**已由**SQLAllocHandle**取代。 如需詳細資訊，請參閱[SQLAllocHandle 函數](../../../odbc/reference/syntax/sqlallochandle-function.md)。  
