---
title: SQLParamOptions 函式 |Microsoft 文件
ms.custom: ''
ms.date: 01/19/2017
ms.prod: sql
...
ms.author: genemi
manager: craigg
ms.openlocfilehash: 32df75c492316e2abbf085d392d25be7769d9697
 ...
 **摘要**  
 ODBC 2.0 函式**SQLParamOptions**在 ODBC 3 已被取代。*x*呼叫[SQLSetStmtAttr](../../../odbc/reference/syntax/sqlsetstmtattr-function.md)。  
