...
|SQL_ATTR_ODBC_VERSION (ODBC 3.0)|判斷是否特定的功能表現出 ODBC 32 位元整數*2.x*行為或 ODBC *3.x*行為。 若要設定此屬性的值會使用下列值：<br /><br /> SQL_OV_ODBC3_80 = 驅動程式管理員和驅動程式展示下列 ODBC 3.8 行為：<br /><br /> -驅動程式傳回，並預期 ODBC *3.x*日期、 時間和時間戳記的程式碼。<br />-驅動程式會傳回 ODBC *3.x* SQLSTATE 程式碼時**SQLError**， **SQLGetDiagField**，或**SQLGetDiagRec**呼叫。<br />- *CatalogName*呼叫中的引數**SQLTables**接受搜尋模式。<br />-驅動程式管理員支援 C 資料類型擴充性。 如需有關 C 資料類型擴充性的詳細資訊，請參閱[ODBC 中的 C 資料類型](../../../odbc/reference/develop-app/c-data-types-in-odbc.md)。<br /><br /> 如需詳細資訊，請參閱 < [What's New in ODBC 3.8](../../../odbc/reference/what-s-new-in-odbc-3-8.md)。<br /><br /> SQL_OV_ODBC3 = 驅動程式管理員和驅動程式展示在下列 ODBC *3.x*行為：<br /><br /> -驅動程式傳回，並預期 ODBC *3.x*日期、 時間和時間戳記的程式碼。<br />-驅動程式會傳回 ODBC *3.x* SQLSTATE 程式碼時**SQLError**， **SQLGetDiagField**，或**SQLGetDiagRec**呼叫。<br />- *CatalogName*呼叫中的引數**SQLTables**接受搜尋模式。<br />-驅動程式管理員不支援 C 資料類型擴充性。<br /><br /> SQL_OV_ODBC2 = 驅動程式管理員和驅動程式展示在下列 ODBC *2.x*行為。 這是特別適用於 ODBC *2.x*應用程式使用 ODBC *3.x*驅動程式。<br /><br /> -驅動程式傳回，並預期 ODBC *2.x*日期、 時間和時間戳記的程式碼。<br />-驅動程式會傳回 ODBC *2.x* SQLSTATE 程式碼時**SQLError**， **SQLGetDiagField**，或**SQLGetDiagRec**呼叫。<br />- *CatalogName*呼叫中的引數**SQLTables**不接受搜尋模式。<br />-驅動程式管理員不支援 C 資料類型擴充性。<br /><br /> 應用程式必須設定這個環境屬性，然後呼叫任何有 SQLHENV 引數的函式或呼叫會傳回 SQLSTATE HY010 （函數順序錯誤）。 它是驅動程式特有的其他行為是否存在這些環境的旗標。<br /><br /> -如需詳細資訊，請參閱[宣告應用程式的 ODBC 版本](../../../odbc/reference/develop-app/declaring-the-application-s-odbc-version.md)並[行為變更](../../../odbc/reference/develop-app/behavioral-changes.md)。|  
