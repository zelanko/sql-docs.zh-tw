---
title: SQLFreeConnect 函式 |Microsoft Docs
ms.custom: ''
ms.date: 01/19/2017
ms.prod: sql
 ...
 **摘要**  
 在 ODBC 3 *.x*，ODBC 2.0 函式**SQLFreeConnect**已被取代**SQLFreeHandle**。 如需詳細資訊，請參閱 < [SQLFreeHandle](../../../odbc/reference/syntax/sqlfreehandle-function.md)。  
