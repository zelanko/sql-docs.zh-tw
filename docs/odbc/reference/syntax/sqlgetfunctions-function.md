...
|SQL_API_SQLMORERESULTS| |  
 ...
 [1] 使用 ODBC*2.x 驅動程式*時，只有在下列兩種情況成立時，才會傳回**SQLBulkOperations** ： ODBC 2.X 驅動程式支援**SQLSetPos**，*.x*而資訊類型 SQL_POS_OPERATIONS 會以設定的 SQL_POS_ADD 位的方式傳回。  
