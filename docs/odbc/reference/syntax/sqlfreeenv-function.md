---
title: "SQLFreeEnv 函式 |Microsoft 文件"
ms.custom: 
ms.date: 01/19/2017
...
ms.openlocfilehash: 25703f3fc1770b860334545070b790ccde667cc0
 ...
 **摘要**  
 在 ODBC 3*.x*，ODBC 2.0 函式**SQLFreeEnv**已被取代**SQLFreeHandle**。 如需詳細資訊，請參閱[SQLFreeHandle](../../../odbc/reference/syntax/sqlfreehandle-function.md)。  
