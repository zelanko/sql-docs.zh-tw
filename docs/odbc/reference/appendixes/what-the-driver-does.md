...
|**SQLBulkOperations**|如果 ODBC 3.x*驅動程式*應該搭配使用**SQLSetPos**與 SQL_ADD 作業的 odbc 2.x*應用程式*一起運作，此驅動程式必須支援具有 SQL_ADD*作業的* **SQLSetPos** ，以及具有 SQL_ADD*作業的* **SQLBulkOperations** 。 **|  
