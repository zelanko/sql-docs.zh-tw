---
title: SQLGetStmtAttr （資料指標程式庫） |Microsoft 文件
ms.custom: ''
ms.date: 01/19/2017
ms.prod: sql
...
ms.openlocfilehash: 83092581e071e59ac1d4f4f7d16640d7ec4a79e4
...
>  將移除這項功能，在未來的版本的 Windows。 避免在新的開發工作中使用這項功能，並規劃修改目前使用這項功能的應用程式。 Microsoft 建議使用驅動程式的資料指標功能。  
 ...
 本主題討論使用**SQLGetStmtAttr**資料指標程式庫中的函式。 如需一般資訊**SQLGetStmtAttr**，請參閱[SQLGetStmtAttr 函數](../../../odbc/reference/syntax/sqlgetstmtattr-function.md)。  
