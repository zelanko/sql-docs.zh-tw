...
|S0<br /><br /> 未配置|S1<br /><br /> 配置|S2-S3<br /><br /> Prepared|S4<br /><br /> 執行|S5-S7<br /><br /> 資料指標|S8-S10<br /><br /> 需要的資料|S11-S12<br /><br /> 非同步處理|  
|------------------------|----------------------|------------------------|---------------------|----------------------|--------------------------|-----------------------|  
|(IH)|S5 [s] S11 [x]|S1 [e] S5 [s] S11 [x]|S1 [e] [1] S5 [s] 和 [1] S11 [x] 和 [1] 24000 [2]|請參閱下一步 的資料表|HY010|NS [c] HY010 o|  
...
|S0<br /><br /> 未配置|S1<br /><br /> 配置|S2-S3<br /><br /> Prepared|S4<br /><br /> 執行|S5-S7<br /><br /> 資料指標|S8-S10<br /><br /> 需要的資料|S11-S12<br /><br /> 非同步處理|  
|------------------------|----------------------|------------------------|---------------------|----------------------|--------------------------|-----------------------|  
|(IH)|S4 [s] 和 [nr] S5 [s] 和 [r] [d] S8 S11 [x]|-[e] [1] S1 [e] 和 [2] S4 [s] 和 [nr] S5 [s] 和 [r] [d] S8 S11 [x]|-[e]，[1]，和 [3] S1 [e]、 [2] 和 [3] S4 [s]，[nr]，和 [3] S5 [s]、 [r]，S8 [3] [d] 和 [3] 的 S11 [x] 和 [3] 24000 [4]|請參閱下一步 的資料表|HY010|NS [c] HY010 [o]|  
...
|S0<br /><br /> 未配置|S1<br /><br /> 配置|S2-S3<br /><br /> Prepared|S4<br /><br /> 執行|S5-S7<br /><br /> 資料指標|S8-S10<br /><br /> 需要的資料|S11-S12<br /><br /> 非同步處理|  
|------------------------|----------------------|------------------------|---------------------|----------------------|--------------------------|-----------------------|  
|(IH)|(HY010)|請參閱下一步 的資料表|S2 [e]，p 及 [1] S4 [s]、 [p]，[nr]，和 [1] S5 [s]、 [p]，[r]，和 [1] S8 [d] [p]，和 [1] S11 [x]，[p]，並為 [1] 24000 [p] 和 [2] HY010 [np]|請參閱 < 資料指標狀態 」 表格|HY010|NS [c] HY010 [o]|  
...
|S0<br /><br /> 未配置|S1<br /><br /> 配置|S2-S3<br /><br /> Prepared|S4<br /><br /> 執行|S5-S7<br /><br /> 資料指標|S8-S10<br /><br /> 需要的資料|S11-S12<br /><br /> 非同步處理|  
|------------------------|----------------------|------------------------|---------------------|----------------------|--------------------------|-----------------------|  
|(IH)|--[1]|--[1]|-[s] 和 [2] S1 [nf]，[np]，[4] S2 和 [nf]，[p]，和 [4] S5 [s] 和 [3] S11 [x]|S1 [nf]，[np]，[4] S3 和 [nf]，[p] 和 [4] S4 [s] 和 [2] S5 [s] 和 [3] S11 [x]|HY010|NS [c] HY010 [o]|  
...
|S0<br /><br /> 未配置|S1<br /><br /> 配置|S2-S3<br /><br /> Prepared|S4<br /><br /> 執行|S5-S7<br /><br /> 資料指標|S8-S10<br /><br /> 需要的資料|S11-S12<br /><br /> 非同步處理|  
|------------------------|----------------------|------------------------|---------------------|----------------------|--------------------------|-----------------------|  
|(IH)|S2 [s] 和 [nr] S3 [s] 和 [r] S11 [x]|-[s] 或 ([e] 和 [1]) S1 [e] 和 [2] S11 [x]|S1 [e] [3] S2 和 [s]、 [nr]，和 [3] S3 [s]、 [r]，和 [3] S11 [x] 和 [3] 24000 [4]|請參閱下一步 的資料表|HY010|NS [c] HY010 [o]|  
