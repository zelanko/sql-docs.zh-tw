...
|SQL_ODBC_API_CONFORMANCE (ODBC 1.0)|SQLSMALLINT 值，表示 ODBC 一致性層級。<br /><br /> SQL_OAC_NONE = None<br /><br /> SQL_OAC_LEVEL1 = 支援的層級 1<br /><br /> SQL_OAC_LEVEL2 = 層級 2 支援|  
