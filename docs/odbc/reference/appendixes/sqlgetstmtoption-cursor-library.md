---
description: SQLGetStmtOption (資料指標程式庫)
...
>  未來的 Windows 版本將會移除這項功能。 請避免在新的開發工作中使用這項功能，並規劃修改目前使用這項功能的應用程式。 Microsoft 建議使用驅動程式的資料指標功能。  
 ...
 本主題討論如何在資料指標程式庫中使用 **SQLGetStmtOption** 函數。 如需 **SQLGetStmtOption**的一般資訊，請參閱 [SQLGetStmtOption 函數](../../../odbc/reference/syntax/sqlgetstmtoption-function.md)。  
