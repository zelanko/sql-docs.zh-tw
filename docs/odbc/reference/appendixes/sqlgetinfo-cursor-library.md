...
|SQL_GETDATA_EXTENSIONS|SQL_GD_BLOCK&#124;任何驅動程式所傳回的值**附註：** 與擷取資料時**SQLFetchScroll**， **SQLGetData**支援指定的功能SQL_GD_ANY_COLUMN 和 SQL_GD_BOUND 位元遮罩。|  
...
|SQL_STATIC_CURSOR_ATTRIBUTES2|SQL_CA2_READ_ONLY_CONCUR &AMP;#124; SQL_CA2_OPT_VALUES_ 並行存取&AMP;#124;SQL_CA2_SENSITIVITY_UPDATES|  
