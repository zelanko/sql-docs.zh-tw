...
ms.locfileid: "47724416"
---
# <a name="sql-to-c-timestamp"></a>SQL 到 C：時間戳記
時間戳記的 ODBC SQL 資料類型的識別項是：  
...
_C_TYPE_TIMESTAMP|不會被截斷的小數秒數部分的時間戳記 [a]<br /><br /> 會被截斷的小數秒數部分的時間戳記，[a]|資料 [e]<br /><br /> 截斷的資料 [e]|16 [f]<br /><br /> 16 [f]|n/a<br /><br /> 01S07|  
