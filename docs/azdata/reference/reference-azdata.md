...
|[azdata arc](reference-azdata-arc.md) | 針對 Azure 資料服務使用 Azure Arc 的命令。 |
...
|[azdata postgres](reference-azdata-postgres.md) | Postgres 查詢執行器與互動式殼層。 |
