...
##  <a name="set-domain-properties"></a><a name="Set"></a> 設定定義域屬性  
...
##  <a name="domain-properties"></a><a name="Properties"></a> 定義域屬性  
  
###  <a name="domain-name-and-description"></a><a name="Name"></a> 定義功能變數名稱稱和描述  
