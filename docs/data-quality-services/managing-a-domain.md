...
|使用關聯來更正屬於定義域值之一部分的詞彙|[Create Term-Based Relations](../data-quality-services/create-term-based-relations.md)|  
|完成、關閉或取消定義域管理活動|[結束定義域管理活動](../Topic/End%20the%20Domain%20Management%20Activity.md)|  
