...
-   **新增**：DQS 沒有足夠的資訊 (建議)，因此無法對應至其他任何索引標籤的有效值。此外，此索引標籤也包含信賴等級低於 *自動建議臨界值* ，但夠高而可以標示為有效的值。  
...
|描述如何清理複合定義域。|[清理複合網域中的資料](../data-quality-services/cleanse-data-in-a-composite-domain.md)|  
