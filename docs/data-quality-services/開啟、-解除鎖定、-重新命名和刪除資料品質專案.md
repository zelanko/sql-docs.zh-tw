...
4.  隨即以上次活動關閉時的相同狀態來開啟資料品質專案。 資料品質專案具有以下狀態：  
    ...
    -   如 **清理** 活動中，資料品質專案可以有下列狀態︰ **清理-對應**, ，**清理-清理**, ，**清理-管理和檢視結果**, ，和 **清理-匯出**。  
  
    -   如 **比對** 活動中，資料品質專案可以有下列狀態︰ **比對-對應**, ，**比對-比**, ，**比對-生存**, ，和 **比對-匯出**。  
...
3.  在 **開啟專案** 畫面，以滑鼠右鍵按一下您，所建立的鎖定的資料品質專案，然後按一下 **Unlock** 快顯功能表中。 專案會顯示綠色核取記號，表示專案已解除鎖定。  
...
3.  在 **開啟專案** 螢幕，以滑鼠右鍵按一下您，所建立的資料品質專案，然後按一下 **重新命名** 快顯功能表中。  
...
3.  在 **開啟專案** 螢幕，由您，解除鎖定的資料品質專案上按一下滑鼠右鍵，然後按一下 **刪除** 快顯功能表中。  
