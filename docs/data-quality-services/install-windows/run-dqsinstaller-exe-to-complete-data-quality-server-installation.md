---
title: 執行 DQSInstaller.exe 以完成 Data Quality Server 安裝
description: 瞭解如何執行 DQSInstaller.exe 來完成 SQL Server Data Quality Services （DQS）的安裝。
