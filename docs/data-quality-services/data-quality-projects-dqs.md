...
##  <a name="data-quality-project-matching-activity"></a><a name="Matching"></a> 資料品質專案：相符活動  
 比對資料品質專案可讓您根據知識庫中的比對原則來執行比對活動，藉由識別完全相符和大致相符來避免資料重複，藉此讓您移除重複的資料。 建議您先清理資料，然後再執行資料的比對。 操作方法：  
...
##  <a name="data-profiling-and-notifications"></a><a name="ProfilingNotification"></a> 資料分析與通知  
