...
---
# DQS 定義域支援的 SQL Server 和 SSIS 資料類型
...
|字串|char<br /><br /> nchar<br /><br /> nvarchar<br /><br /> varchar|  
 ...
 DQS 不支援其餘 SQL Server 資料類型。 如需所有 SQL Server 資料型別資訊，請參閱 [資料類型 & #40。TRANSACT-SQL & #41;](../t-sql/data-types/data-types-transact-sql.md)。  
...
## 另請參閱  
 [管理定義域](../data-quality-services/managing-a-domain.md)  
