...
[!INCLUDE[appliesto-ss-xxxx-xxxx-xxx-md](../../includes/appliesto-ss-xxxx-xxxx-xxx-md.md)] **DiagnosticInformation** 項目包含報告此公用程式找到之診斷資訊的所有項目。 **DiagnosticInformation** 是 **ssbdiagnostic** XML 輸出檔的根元素。  
