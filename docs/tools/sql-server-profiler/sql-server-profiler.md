...
|**追蹤擷取**|[ 中的](../../relational-databases/extended-events/extended-events.md)擴充事件[!INCLUDE[ssManStudioFull](../../includes/ssmanstudiofull-md.md)]圖形化使用者介面|[!INCLUDE[ssSqlProfiler](../../includes/sssqlprofiler-md.md)]|  
