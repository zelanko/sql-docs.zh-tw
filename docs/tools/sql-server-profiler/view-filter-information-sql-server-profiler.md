...
[!INCLUDE[appliesto-ss-xxxx-xxxx-xxx-md](../../includes/appliesto-ss-xxxx-xxxx-xxx-md.md)]本主題描述如何使用事件類別資料行上檢視篩選[!INCLUDE[ssSqlProfiler](../../includes/sssqlprofiler-md.md)]。  
