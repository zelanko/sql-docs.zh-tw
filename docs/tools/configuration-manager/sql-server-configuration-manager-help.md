...
[!INCLUDE[appliesto-ss-xxxx-xxxx-xxx-md-winonly](../../includes/appliesto-ss-xxxx-xxxx-xxx-md-winonly.md)]
 ...
 > [!TIP]
 > 如果您需要在 Linux 上設定 [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)]，請使用 **mssql-conf** 工具。 如需詳細資訊，請參閱[使用 mssql-conf 工具在 Linux 上設定 SQL Server](../../linux/sql-server-linux-configure-mssql-conf.md)。

 本節包含關於「 [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] 組態管理員」中對話方塊的 F1 說明主題。  
  
> [!NOTE]
>  [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] Configuration Manager 無法設定早於 [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)][!INCLUDE[msCoName](../../includes/msconame-md.md)] 的 [!INCLUDE[ssVersion2005](../../includes/ssversion2005-md.md)] 版本。  
 ...
 **使用 [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] 存取 [!INCLUDE[win8](../../includes/win8-md.md)] 設定管理員**  
