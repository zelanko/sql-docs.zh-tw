---
title: "SQL Server 屬性 （服務索引標籤） |Microsoft 文件"
ms.custom: 
ms.date: 03/14/2017
...
[!INCLUDE[appliesto-ss-xxxx-xxxx-xxx-md](../../includes/appliesto-ss-xxxx-xxxx-xxx-md.md)]使用**服務**索引標籤上**MSSQLSERVER 內容**對話方塊來檢視或指定下列選項。  
