---
title: "註冊連接的伺服器 (SQL Server Management Studio) | Microsoft Docs"
ms.custom: ""
ms.date: "07/28/2016"
...
---
# 註冊連接的伺服器 (SQL Server Management Studio)
  本主題描述如何使用 [!INCLUDE[ssManStudioFull](../../includes/ssmanstudiofull-md.md)] (SSMS) 註冊 [!INCLUDE[ssCurrent](../../includes/sscurrent-md.md)] 中已連接的伺服器。 透過註冊伺服器，您可以儲存經常存取之伺服器的連接資訊。 您可以在連接之前或連接時從 [物件總管] 註冊伺服器。  您可以從功能表瀏覽至 [檢視]\\[已註冊的伺服器]，在 SSMS 中檢視已註冊的伺服器。
