...
ms.topic: "article"
helpviewer_keywords: 
  - "SQL Server Management Studio [SQL Server], 快速鍵"
  - "鍵盤快速鍵 [SQL Server Management Studio]"
  - "功能表快速鍵 [SQL Server Management Studio]"
  - "查詢編輯器 [SQL Server Management Studio], 鍵盤快速鍵"
  - "熱鍵 [SQL Server Management Studio]"
  - "快速鍵 [SQL Server Management Studio], 鍵盤快速鍵"
  - "鍵盤快速鍵 [SQL Server Management Studio], 快速鍵清單"
  - "快速鍵 [SQL Server Management Studio]"
  - "快速鍵"
...
|顯示物件總管|F8|F8|  
|顯示已註冊的伺服器|CTRL+ALT+G|CTRL+ALT+G|  
...
|讓所選的文字變成註解|CTRL+K、CTRL+C|CTRL+K、CTRL+C|  
...
|移到下一個使用中視窗 [!INCLUDE[ssManStudio](../../includes/ssmanstudio-md.md)]|ALT+F6|ALT+F6|  
