...
ms.topic: "reference"
helpviewer_keywords: 
  - "SQL Server Management Studio [SQL Server], 說明"
  - "已註冊的伺服器 [SQL Server], 說明"
  - "SQL Server Management Studio 說明 [SQL Server], 已註冊的伺服器"
...
# 已註冊的伺服器 F1 說明
 ...
 ## Reporting Services 新增或編輯伺服器註冊 (一般索引標籤) 
 ...
 **測試**  
 ...
 ## Analysis Services - 多維度資料新增或編輯伺服器註冊 (一般索引標籤)
