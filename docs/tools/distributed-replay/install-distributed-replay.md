...
-   [從命令提示字元處安裝 Distributed Replay](#bkmk_command_prompt)  
...
|/CTLRSTARTUPTYPE<br /><br /> **選擇性**|Distributed Replay Controller 服務的啟動類型。|Automatic<br /><br /> 已停用<br /><br /> Manual|  
...
|/CLTSTARTUPTYPE<br /><br /> **選擇性**|Distributed Replay Client 服務的啟動類型。|Automatic<br /><br /> 已停用<br /><br /> Manual|  
...
##  <a name="bkmk_configuration_file"></a> 使用組態檔安裝 Distributed Replay  
