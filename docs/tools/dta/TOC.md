...
# [啟動 dta 命令提示字元公用程式和微調工作負載](starting-the-dta-command-prompt-utility-and-tuning-a-workload.md)
...
# [檢視微調建議](viewing-tuning-recommendations.md)
# [檢視微調報表](viewing-tuning-reports.md)
...
# [第 1 課：Database Engine Tuning Advisor 中的基本導覽](lesson-1-basic-navigation-in-database-engine-tuning-advisor.md)
# [StorageBoundInMB 元素 (DTA)](storageboundinmb-element-dta.md)
# [結構描述的 Table 元素 (DTA)](table-element-for-schema-dta.md)
# [dta 公用程式](dta-utility.md)
...
# [啟動 Database Engine Tuning Advisor](launching-database-engine-tuning-advisor.md)
# [TuningTimeInMin 元素 (DTA)](tuningtimeinmin-element-dta.md)
# [Index 元素 (DTA)](index-element-dta.md)
# [設定工具選項和配置](setting-tool-options-and-layout.md)
...
# [XML 輸入檔範例 (DTA)](xml-input-file-samples-dta.md)
