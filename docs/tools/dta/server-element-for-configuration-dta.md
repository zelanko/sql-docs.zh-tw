...
[!INCLUDE[appliesto-ss-xxxx-xxxx-xxx-md](../../includes/appliesto-ss-xxxx-xxxx-xxx-md.md)] 包含 Database Engine Tuning Advisor 評估假設性設定 (**Configuration** 項目所指定) 時所在之伺服器的識別資訊。  
