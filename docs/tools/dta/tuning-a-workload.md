...
2.  啟動 Database Engine Tuning Advisor。 請參閱[啟動 Database Engine Tuning Advisor](../../tools/dta/launching-database-engine-tuning-advisor.md)。  
...
## 本課程的下一項工作  
[檢視微調建議](../../tools/dta/viewing-tuning-recommendations.md)  
