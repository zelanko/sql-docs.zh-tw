...
helpviewer_keywords: 
  - "實體設計結構 [SQL Server]"
  - "命令提示字元公用程式 [SQL Server], dta"
  - "dta 公用程式"
  - "微調資料庫 [SQL Server], Database Engine Tuning Advisor"
  - "工作負載 [SQL Server], 分析"
  - "dta 公用程式, 關於 dta 公用程式"
  - "效能 [SQL Server], Database Engine Tuning Advisor"
  - "Database Engine Tuning Advisor [SQL Server], 命令提示"
  - "最佳化資料庫 [SQL Server]"
