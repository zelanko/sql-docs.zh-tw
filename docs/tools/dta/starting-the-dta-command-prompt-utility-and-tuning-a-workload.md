...
這項工作會帶您逐步啟動 **dta** 公用程式、檢視它的說明，再從命令提示字元之下，利用它來微調工作負載。 它會使用您在 Database Engine Tuning Advisor 圖形化使用者介面 (GUI) 的[微調工作負載](../../tools/dta/tuning-a-workload.md)練習中所建立的 MyScript.sql 工作負載。  
...
下列工作將帶您逐步開啟命令提示字元、啟動 **dta** 命令提示字元公用程式、檢視其語法說明，以及微調您在[微調工作負載](../../tools/dta/tuning-a-workload.md)中所建立的簡單工作負載 MyScript.sql。  
  
### 若要啟動 dta 命令提示字元公用程式和檢視說明  
