...
> [!NOTE]
> 從 SQL Server 2019 CU3 開始支援 Ubuntu 18.04。 如果您正在使用 Ubuntu 16.04，請將下列路徑變更為 `/ubuntu/16.04`，而非 `/ubuntu/18.04`。
...
> [!NOTE]
> 從 SQL Server 2019 CU3 開始支援 Ubuntu 18.04。 下列 SQL Server 2019 命令會指向 Ubuntu 18.04 存放庫。
>
