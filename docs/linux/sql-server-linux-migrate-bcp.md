...
- [bcp 公用程式](https://msdn.microsoft.com/en-us/library/ms162802.aspx)
- [使用 bcp 時的相容性的資料格式](https://msdn.microsoft.com/en-us/library/ms190759.aspx)
- [使用 BULK INSERT 匯入大量資料](https://msdn.microsoft.com/en-us/library/ms175915.aspx)
