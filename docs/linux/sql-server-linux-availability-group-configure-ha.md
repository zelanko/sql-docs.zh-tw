---
title: 在 Linux 上設定 SQL Server 的可用性群組
...
建立 AG 以確保 Linux 上的高可用性。 搭配使用 [CREATE AVAILABILITY GROUP](../t-sql/statements/create-availability-group-transact-sql.md) 與 `CLUSTER_TYPE = EXTERNAL`。 
