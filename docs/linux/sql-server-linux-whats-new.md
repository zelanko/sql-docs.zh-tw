...
> [!NOTE]
> 除了在本文中的這些功能，累計更新定期發行後發行 GA 版本。 這些累計更新可提供許多增強功能和修正程式。 如需最新 CU 版本資訊，請參閱[http://aka.ms/sql2017cu](http://aka.ms/sql2017cu)。 如需下載套件和已知的問題，請參閱[版本資訊](sql-server-linux-release-notes.md)。
