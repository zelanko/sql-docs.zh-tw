...
ms.openlocfilehash: 269850b1cbf093aa0b30b36d0338bb85bb5326b1
...
1. [使用 ssis conf，設定 Linux 上的 SQL Server Integration Services](sql-server-linux-configure-ssis.md)
2. [版本和支援的功能的 SQL Server 2017 on Linux](sql-server-linux-editions-and-components-2017.md)
3. [排程 SQL Server Integration Services 封裝執行 Linux 上的 cron](sql-server-linux-schedule-ssis-packages.md)
