---
title: Linux 上的 SQL Server 2017 的版本資訊
...
ms.locfileid: "67834807"
---
# <a name="release-notes-for-sql-server-2017-on-linux"></a>Linux 上的 SQL Server 2017 的版本資訊

[!INCLUDE[appliesto-ss-xxxx-xxxx-xxx-md-linuxonly](../includes/appliesto-ss-xxxx-xxxx-xxx-md-linuxonly.md)]

下列版本資訊適用於[!INCLUDE[ssSQL17](../includes/sssql17-md.md)]在 Linux 上執行。 這篇文章會分成區段，每個版本。 GA 版本已可支援性和詳細的已知問題所列。 每個累計更新 (CU) 或一般發行版本 (GDR) 具有描述 CU 的變更，以及連結至 Linux 套件下載技術支援文件的連結。

> [!TIP]
> 這些版本資訊是特別針對[!INCLUDE[ssSQL17](../includes/sssql17-md.md)]釋放。 如需有關新[!INCLUDE[sql-server-2019](../includes/sssqlv15-md.md)]，請參閱 < [Linux 上的 SQL Server 2019 預覽的版本資訊](sql-server-linux-release-notes-2019.md?view=sql-server-ver15)。
...
> [!TIP]
> 如需詳細資訊，請檢閱[系統需求](sql-server-linux-setup.md#system)如[!INCLUDE[ssNoVersion](../includes/ssnoversion-md.md)]Linux 上。 為最新的支援政策[!INCLUDE[ssSQL17](../includes/sssql17-md.md)]，請參閱 < [Microsoft SQL Server 的技術支援原則](https://support.microsoft.com/help/4047326/support-policy-for-microsoft-sql-server)。

## <a name="tools"></a>工具

大部分現有的用戶端工具為目標[!INCLUDE[ssNoVersion](../includes/ssnoversion-md.md)]可以順暢地將目標設[!INCLUDE[ssNoVersion](../includes/ssnoversion-md.md)]在 Linux 上執行。 有些工具可能會有適用於 Linux 的特定版本需求。 如需完整的清單[!INCLUDE[ssNoVersion](../includes/ssnoversion-md.md)]工具，請參閱[SQL Tools 和 SQL Server 公用程式](../tools/overview-sql-tools.md)。

## <a name="release-history"></a>版本歷程記錄

下表列出的版本歷程記錄[!INCLUDE[ssSQL17](../includes/sssql17-md.md)]。
...
如果您已設定的 CU 的儲存機制 (**mssql server 2017**)，則會收到的最新的 CU[!INCLUDE[ssNoVersion](../includes/ssnoversion-md.md)]封裝時執行的新安裝。 CU 的存放庫會是預設值之所有套件安裝的發行項[!INCLUDE[ssNoVersion](../includes/ssnoversion-md.md)]Linux 上。 如果您已設定的 GDR 存放庫 (**mssql server 2017-gdr**)，只會收到重大安全性更新發行後 ga。 如果您需要 Docker 容器 CU 或 GDR 更新，請參閱官方的映像[Microsoft SQL Server on Linux 的 Docker 引擎](https://hub.docker.com/r/microsoft/mssql-server)。 如需有關存放庫組態的詳細資訊，請參閱[在 Linux 上的 SQL server 設定存放庫](sql-server-linux-change-repo.md)。

如果您要更新現有[!INCLUDE[ssNoVersion](../includes/ssnoversion-md.md)]封裝，執行適當的更新命令，針對每個封裝，以取得最新的 CU。 特定更新每個套件的指示，請參閱下列的安裝指南：
...
## <a id="CU15"></a> CU15 (2018 年)

這是累計更新 15 (CU15) 發行[!INCLUDE[ssSQL17](../includes/sssql17-md.md)]。 [!INCLUDE[ssDEnoversion](../includes/ssdenoversion-md.md)]這一版的版本是 14.0.3162.1。 如需此版本中的改進與修正資訊，請參閱[ https://support.microsoft.com/en-us/help/4498951 ](https://support.microsoft.com/en-us/help/4498951)。
...
| 套件 | 套件版本 | 下載 |
|-----|-----|-----|
| Red Hat RPM 套件 | 14.0.3162.1-1 | [引擎 RPM 套件](https://packages.microsoft.com/rhel/7/mssql-server-2017/mssql-server-14.0.3162.1-1.x86_64.rpm)</br>[高可用性的 RPM 套件](https://packages.microsoft.com/rhel/7/mssql-server-2017/mssql-server-ha-14.0.3162.1-1.x86_64.rpm)</br>[全文檢索搜尋的 RPM 套件](https://packages.microsoft.com/rhel/7/mssql-server-2017/mssql-server-fts-14.0.3162.1-1.x86_64.rpm)</br>[SSIS 封裝](https://packages.microsoft.com/rhel/7/mssql-server-2017/mssql-server-is-14.0.1000.169-1.x86_64.rpm) | 
| SLES RPM 套件 | 14.0.3162.1-1 | [mssql server 引擎 RPM 套件](https://packages.microsoft.com/sles/12/mssql-server-2017/mssql-server-14.0.3162.1-1.x86_64.rpm)</br>[高可用性的 RPM 套件](https://packages.microsoft.com/sles/12/mssql-server-2017/mssql-server-ha-14.0.3162.1-1.x86_64.rpm)</br>[全文檢索搜尋的 RPM 套件](https://packages.microsoft.com/sles/12/mssql-server-2017/mssql-server-fts-14.0.3162.1-1.x86_64.rpm) | 
| Ubuntu 16.04 的 Debian 套件 | 14.0.3162.1-1 | [引擎的 Debian 套件](https://packages.microsoft.com/ubuntu/16.04/mssql-server-2017/pool/main/m/mssql-server/mssql-server_14.0.3162.1-1_amd64.deb)</br>[高可用性的 Debian 套件](https://packages.microsoft.com/ubuntu/16.04/mssql-server-2017/pool/main/m/mssql-server-ha/mssql-server-ha_14.0.3162.1-1_amd64.deb)</br>[全文檢索搜尋中的 Debian 套件](https://packages.microsoft.com/ubuntu/16.04/mssql-server-2017/pool/main/m/mssql-server-fts/mssql-server-fts_14.0.3162.1-1_amd64.deb)<br/>[SSIS 封裝](https://packages.microsoft.com/ubuntu/16.04/mssql-server-2017/pool/main/m/mssql-server-is/mssql-server-is_14.0.1000.169-1_amd64.deb) |

## <a id="CU14"></a> CU14 (Mar 2018)

這是累計更新 14 (CU14) 發行[!INCLUDE[ssSQL17](../includes/sssql17-md.md)]。 [!INCLUDE[ssDEnoversion](../includes/ssdenoversion-md.md)]這一版的版本是 14.0.3076.1。 如需此版本中的改進與修正資訊，請參閱[ https://support.microsoft.com/help/4484710 ](https://support.microsoft.com/help/4484710)。
...
| 套件 | 套件版本 | 下載 |
|-----|-----|-----|
| Red Hat RPM 套件 | 14.0.3076.1-2 | [引擎 RPM 套件](https://packages.microsoft.com/rhel/7/mssql-server-2017/mssql-server-14.0.3076.1-2.x86_64.rpm)</br>[高可用性的 RPM 套件](https://packages.microsoft.com/rhel/7/mssql-server-2017/mssql-server-ha-14.0.3076.1-2.x86_64.rpm)</br>[全文檢索搜尋的 RPM 套件](https://packages.microsoft.com/rhel/7/mssql-server-2017/mssql-server-fts-14.0.3076.1-2.x86_64.rpm)</br>[SSIS 封裝](https://packages.microsoft.com/rhel/7/mssql-server-2017/mssql-server-is-14.0.1000.169-1.x86_64.rpm) | 
| SLES RPM 套件 | 14.0.3076.1-2 | [mssql server 引擎 RPM 套件](https://packages.microsoft.com/sles/12/mssql-server-2017/mssql-server-14.0.3076.1-2.x86_64.rpm)</br>[高可用性的 RPM 套件](https://packages.microsoft.com/sles/12/mssql-server-2017/mssql-server-ha-14.0.3076.1-2.x86_64.rpm)</br>[全文檢索搜尋的 RPM 套件](https://packages.microsoft.com/sles/12/mssql-server-2017/mssql-server-fts-14.0.3076.1-2.x86_64.rpm) | 
| Ubuntu 16.04 的 Debian 套件 | 14.0.3076.1-2 | [引擎的 Debian 套件](https://packages.microsoft.com/ubuntu/16.04/mssql-server-2017/pool/main/m/mssql-server/mssql-server_14.0.3076.1-2_amd64.deb)</br>[高可用性的 Debian 套件](https://packages.microsoft.com/ubuntu/16.04/mssql-server-2017/pool/main/m/mssql-server-ha/mssql-server-ha_14.0.3076.1-2_amd64.deb)</br>[全文檢索搜尋中的 Debian 套件](https://packages.microsoft.com/ubuntu/16.04/mssql-server-2017/pool/main/m/mssql-server-fts/mssql-server-fts_14.0.3076.1-2_amd64.deb)<br/>[SSIS 封裝](https://packages.microsoft.com/ubuntu/16.04/mssql-server-2017/pool/main/m/mssql-server-is/mssql-server-is_14.0.1000.169-1_amd64.deb) |

## <a id="CU13"></a> CU13 (Dec 2018)

這是累計的 Update 13 (CU13) 發行[!INCLUDE[ssSQL17](../includes/sssql17-md.md)]。 [!INCLUDE[ssDEnoversion](../includes/ssdenoversion-md.md)]這一版的版本是 14.0.3048.4。 如需此版本中的改進與修正資訊，請參閱[ https://support.microsoft.com/help/4466404 ](https://support.microsoft.com/help/4466404)。
...
| 套件 | 套件版本 | 下載 |
|-----|-----|-----|
| Red Hat RPM 套件 | 14.0.3048.4-1 | [引擎 RPM 套件](https://packages.microsoft.com/rhel/7/mssql-server-2017/mssql-server-14.0.3048.4-1.x86_64.rpm)</br>[高可用性的 RPM 套件](https://packages.microsoft.com/rhel/7/mssql-server-2017/mssql-server-ha-14.0.3048.4-1.x86_64.rpm)</br>[全文檢索搜尋的 RPM 套件](https://packages.microsoft.com/rhel/7/mssql-server-2017/mssql-server-fts-14.0.3048.4-1.x86_64.rpm)</br>[SSIS 封裝](https://packages.microsoft.com/rhel/7/mssql-server-2017/mssql-server-is-14.0.1000.169-1.x86_64.rpm) | 
| SLES RPM 套件 | 14.0.3048.4-1 | [mssql server 引擎 RPM 套件](https://packages.microsoft.com/sles/12/mssql-server-2017/mssql-server-14.0.3048.4-1.x86_64.rpm)</br>[高可用性的 RPM 套件](https://packages.microsoft.com/sles/12/mssql-server-2017/mssql-server-ha-14.0.3048.4-1.x86_64.rpm)</br>[全文檢索搜尋的 RPM 套件](https://packages.microsoft.com/sles/12/mssql-server-2017/mssql-server-fts-14.0.3048.4-1.x86_64.rpm) | 
| Ubuntu 16.04 的 Debian 套件 | 14.0.3048.4-1 | [引擎的 Debian 套件](https://packages.microsoft.com/ubuntu/16.04/mssql-server-2017/pool/main/m/mssql-server/mssql-server_14.0.3048.4-1_amd64.deb)</br>[高可用性的 Debian 套件](https://packages.microsoft.com/ubuntu/16.04/mssql-server-2017/pool/main/m/mssql-server-ha/mssql-server-ha_14.0.3048.4-1_amd64.deb)</br>[全文檢索搜尋中的 Debian 套件](https://packages.microsoft.com/ubuntu/16.04/mssql-server-2017/pool/main/m/mssql-server-fts/mssql-server-fts_14.0.3048.4-1_amd64.deb)<br/>[SSIS 封裝](https://packages.microsoft.com/ubuntu/16.04/mssql-server-2017/pool/main/m/mssql-server-is/mssql-server-is_14.0.1000.169-1_amd64.deb) |

## <a id="CU12"></a> CU12 (Oct 2018)

這是累計更新 12 (CU12) 發行[!INCLUDE[ssSQL17](../includes/sssql17-md.md)]。 [!INCLUDE[ssDEnoversion](../includes/ssdenoversion-md.md)]這一版的版本是 14.0.3045.24。 如需此版本中的改進與修正資訊，請參閱[ https://support.microsoft.com/help/4464082 ](https://support.microsoft.com/help/4464082)。
...
| 套件 | 套件版本 | 下載 |
|-----|-----|-----|
| Red Hat RPM 套件 | 14.0.3045.24-1 | [引擎 RPM 套件](https://packages.microsoft.com/rhel/7/mssql-server-2017/mssql-server-14.0.3045.24-1.x86_64.rpm)</br>[高可用性的 RPM 套件](https://packages.microsoft.com/rhel/7/mssql-server-2017/mssql-server-ha-14.0.3045.24-1.x86_64.rpm)</br>[全文檢索搜尋的 RPM 套件](https://packages.microsoft.com/rhel/7/mssql-server-2017/mssql-server-fts-14.0.3045.24-1.x86_64.rpm)</br>[SSIS 封裝](https://packages.microsoft.com/rhel/7/mssql-server-2017/mssql-server-is-14.0.1000.169-1.x86_64.rpm) | 
| SLES RPM 套件 | 14.0.3045.24-1 | [mssql server 引擎 RPM 套件](https://packages.microsoft.com/sles/12/mssql-server-2017/mssql-server-14.0.3045.24-1.x86_64.rpm)</br>[高可用性的 RPM 套件](https://packages.microsoft.com/sles/12/mssql-server-2017/mssql-server-ha-14.0.3045.24-1.x86_64.rpm)</br>[全文檢索搜尋的 RPM 套件](https://packages.microsoft.com/sles/12/mssql-server-2017/mssql-server-fts-14.0.3045.24-1.x86_64.rpm) | 
| Ubuntu 16.04 的 Debian 套件 | 14.0.3045.24-1 | [引擎的 Debian 套件](https://packages.microsoft.com/ubuntu/16.04/mssql-server-2017/pool/main/m/mssql-server/mssql-server_14.0.3045.24-1_amd64.deb)</br>[高可用性的 Debian 套件](https://packages.microsoft.com/ubuntu/16.04/mssql-server-2017/pool/main/m/mssql-server-ha/mssql-server-ha_14.0.3045.24-1_amd64.deb)</br>[全文檢索搜尋中的 Debian 套件](https://packages.microsoft.com/ubuntu/16.04/mssql-server-2017/pool/main/m/mssql-server-fts/mssql-server-fts_14.0.3045.24-1_amd64.deb)<br/>[SSIS 封裝](https://packages.microsoft.com/ubuntu/16.04/mssql-server-2017/pool/main/m/mssql-server-is/mssql-server-is_14.0.1000.169-1_amd64.deb) |

## <a id="CU11"></a> CU11 (年 9 月 2018)

這是累計的 Update 11 (CU11) 發行[!INCLUDE[ssSQL17](../includes/sssql17-md.md)]。 [!INCLUDE[ssDEnoversion](../includes/ssdenoversion-md.md)]這一版的版本是 14.0.3038.14。 如需此版本中的改進與修正資訊，請參閱[ https://support.microsoft.com/help/4462262 ](https://support.microsoft.com/help/4462262)。
...
| Ubuntu 16.04 的 Debian 套件 | 14.0.3038.14-2 | [引擎的 Debian 套件](https://packages.microsoft.com/ubuntu/16.04/mssql-server-2017/pool/main/m/mssql-server/mssql-server_14.0.3038.14-2_amd64.deb)</br>[高可用性的 Debian 套件](https://packages.microsoft.com/ubuntu/16.04/mssql-server-2017/pool/main/m/mssql-server-ha/mssql-server-ha_14.0.3038.14-2_amd64.deb)</br>[全文檢索搜尋中的 Debian 套件](https://packages.microsoft.com/ubuntu/16.04/mssql-server-2017/pool/main/m/mssql-server-fts/mssql-server-fts_14.0.3038.14-2_amd64.deb)<br/>[SSIS 封裝](https://packages.microsoft.com/ubuntu/16.04/mssql-server-2017/pool/main/m/mssql-server-is/mssql-server-is_14.0.1000.169-1_amd64.deb) |

## <a id="CU10"></a> CU10 (Aug 2018)

這是累計更新 10 (CU10) 發行[!INCLUDE[ssSQL17](../includes/sssql17-md.md)]。 [!INCLUDE[ssDEnoversion](../includes/ssdenoversion-md.md)]這一版的版本是 14.0.3037.1。 如需此版本中的改進與修正資訊，請參閱[ https://support.microsoft.com/help/4342123 ](https://support.microsoft.com/help/4342123)。
...
這是安全性更新，其中也包含先前發行的 CU (CU9) [!INCLUDE[ssSQL17](../includes/sssql17-md.md)]。 [!INCLUDE[ssDEnoversion](../includes/ssdenoversion-md.md)]這一版的版本是 14.0.3035.2。 如需此版本中的改進與修正資訊，請參閱[ https://support.microsoft.com/help/4293805 ](https://support.microsoft.com/help/4293805)。
...
這是安全性更新，其中只包含 GDR2 （和 GDR1） 的安全性問題修正[!INCLUDE[ssSQL17](../includes/sssql17-md.md)]。  [!INCLUDE[ssDEnoversion](../includes/ssdenoversion-md.md)]這一版的版本是 14.0.2002.14。 如需此版本中的改進與修正資訊，請參閱[ https://support.microsoft.com/help/4293803 ](https://support.microsoft.com/help/4293803)。
...
## <a id="CU9"></a> CU9 (七月 2018)

這是加裝累計更新 9 (CU9) 發行[!INCLUDE[ssSQL17](../includes/sssql17-md.md)]。 [!INCLUDE[ssDEnoversion](../includes/ssdenoversion-md.md)]這一版的版本是 14.0.3030.27。 如需此版本中的改進與修正資訊，請參閱[ https://support.microsoft.com/help/4341265 ](https://support.microsoft.com/help/4341265)。
...
這是累積更新 8 (CU8) 發行[!INCLUDE[ssSQL17](../includes/sssql17-md.md)]。 [!INCLUDE[ssDEnoversion](../includes/ssdenoversion-md.md)]這一版的版本是 14.0.3029.16。 如需此版本中的改進與修正資訊，請參閱[ https://support.microsoft.com/help/4338363 ](https://support.microsoft.com/help/4338363)。
...
這是累積更新 7 (CU7) 發行[!INCLUDE[ssSQL17](../includes/sssql17-md.md)]。 [!INCLUDE[ssDEnoversion](../includes/ssdenoversion-md.md)]這一版的版本是 14.0.3026.27。 如需此版本中的改進與修正資訊，請參閱[ https://support.microsoft.com/help/4229789 ](https://support.microsoft.com/help/4229789)。
...
這是累計更新 6 (CU6) 發行[!INCLUDE[ssSQL17](../includes/sssql17-md.md)]。 [!INCLUDE[ssDEnoversion](../includes/ssdenoversion-md.md)]這一版的版本是 14.0.3025.34。 如需此版本中的改進與修正資訊，請參閱[ https://support.microsoft.com/help/4101464 ](https://support.microsoft.com/help/4101464)。
...
這是累計更新 5 (CU5) 發行[!INCLUDE[ssSQL17](../includes/sssql17-md.md)]。 [!INCLUDE[ssDEnoversion](../includes/ssdenoversion-md.md)]這一版的版本是 14.0.3023.8。 如需此版本中的改進與修正資訊，請參閱[ https://support.microsoft.com/help/4092643 ](https://support.microsoft.com/help/4092643)。

### <a name="known-upgrade-issue"></a>已知的升級問題

當您從舊版升級到 CU5，[!INCLUDE[ssNoVersion](../includes/ssnoversion-md.md)]可能無法啟動，發生下列錯誤：
...
若要解決這個錯誤，請啟用 SQL Server Agent，然後重新啟動[!INCLUDE[ssNoVersion](../includes/ssnoversion-md.md)]使用下列命令：
...
這是加裝累計更新 4 (CU4) 發行[!INCLUDE[ssSQL17](../includes/sssql17-md.md)]。 [!INCLUDE[ssDEnoversion](../includes/ssdenoversion-md.md)]這一版的版本是 14.0.3022.28。 如需此版本中的改進與修正資訊，請參閱[ https://support.microsoft.com/help/4056498 ](https://support.microsoft.com/help/4056498)。
...
這是安全性更新，只會包含安全性修正的 GDR1 [!INCLUDE[ssSQL17](../includes/sssql17-md.md)]。 [!INCLUDE[ssDEnoversion](../includes/ssdenoversion-md.md)]這一版的版本是 14.0.2000.63。 如需此版本中的改進與修正資訊，請參閱[ https://support.microsoft.com/help/4057122 ](https://support.microsoft.com/help/4057122)。
...
這是累積更新 3 (CU3) 發行[!INCLUDE[ssSQL17](../includes/sssql17-md.md)]。 [!INCLUDE[ssDEnoversion](../includes/ssdenoversion-md.md)]這一版的版本是 14.0.3015.40。 如需此版本中的改進與修正資訊，請參閱[ https://support.microsoft.com/help/4052987 ](https://support.microsoft.com/help/4052987)。
...
這是累計更新 2 (CU2) 發行[!INCLUDE[ssSQL17](../includes/sssql17-md.md)]。 [!INCLUDE[ssDEnoversion](../includes/ssdenoversion-md.md)]這一版的版本是 14.0.3008.27。 如需此版本中的改進與修正資訊，請參閱[ https://support.microsoft.com/help/4052574 ](https://support.microsoft.com/help/4052574)。
...
這是累計更新 1 (CU1) 發行[!INCLUDE[ssSQL17](../includes/sssql17-md.md)]。 [!INCLUDE[ssDEnoversion](../includes/ssdenoversion-md.md)]這一版的版本是 14.0.3006.16。 如需此版本中的改進與修正資訊，請參閱[ https://support.microsoft.com/help/KB4053439 ](https://support.microsoft.com/help/4038634)。
...
這是公開上市 (GA) 發行[!INCLUDE[ssSQL17](../includes/sssql17-md.md)]。 [!INCLUDE[ssDEnoversion](../includes/ssdenoversion-md.md)]這一版的版本是 14.0.1000.169。
...
| &nbsp; | PolyBase |
| &nbsp; | 分散式的查詢與第 3 方連線 |
| &nbsp; | 連結的伺服器以外的資料來源 [!INCLUDE[ssNoVersion](../includes/ssnoversion-md.md)]  |
...
下列各節說明的公開上市 (GA) 版本的已知的問題[!INCLUDE[ssSQL17](../includes/sssql17-md.md)]Linux 上。

#### <a name="general"></a>一般

- 主機名稱的長度，[!INCLUDE[ssNoVersion](../includes/ssnoversion-md.md)]已安裝，將需要為 15 個字元或更少。 

    - **解析**:將項目 15 個字元，長或較少 /etc/hostname 中的名稱。

- 回溯的時間手動設定系統時間會導致[!INCLUDE[ssNoVersion](../includes/ssnoversion-md.md)]停止更新內部系統的時間內[!INCLUDE[ssNoVersion](../includes/ssnoversion-md.md)]。

    - **解析**:重新啟動 [!INCLUDE[ssNoVersion](../includes/ssnoversion-md.md)]。

- 支援只是單一執行個體安裝。

    - **解析**:如果您想要指定的主機上有多個執行個體，請考慮使用 Vm 或 Docker 容器。 

- [!INCLUDE[ssNoVersion](../includes/ssnoversion-md.md)] Configuration Manager 無法連線到[!INCLUDE[ssNoVersion](../includes/ssnoversion-md.md)]Linux 上。

- 預設語言**sa**登入是英文。

    - **解析**:變更的語言**sa**登入**ALTER LOGIN**陳述式。

#### <a name="databases"></a>資料庫

- 使用 mssql conf 公用程式無法移動 master 資料庫。 其他系統資料庫可以移動與 mssql 設定

- 還原資料庫備份上時[!INCLUDE[ssNoVersion](../includes/ssnoversion-md.md)]在 Windows 中，您必須使用**WITH MOVE** TRANSACT-SQL 陳述式中的子句。

- 不支援分散式交易，需要 Microsoft Distributed Transaction Coordinator 服務[!INCLUDE[ssNoVersion](../includes/ssnoversion-md.md)]在 Linux 上執行。 [!INCLUDE[ssNoVersion](../includes/ssnoversion-md.md)] 若要[!INCLUDE[ssNoVersion](../includes/ssnoversion-md.md)]除非它們包含 DTC 支援連結的伺服器。 如需詳細資訊，請參閱 <<c0> [ 在 Linux 上執行的 SQL Server 不支援分散式交易，需要 Microsoft Distributed Transaction Coordinator 服務](https://blogs.msdn.microsoft.com/bobsql/2017/12/11/sql-server-linux-distributed-transactions-requiring-the-microsoft-distributed-transaction-coordinator-service-are-not-supported-on-sql-server-running-on-linux-sql-server-to-sql-server-distributed-tr/)。

- 特定演算法 （加密套件） 的傳輸層安全性 (TLS) 無法正常運作與[!INCLUDE[ssNoVersion](../includes/ssnoversion-md.md)]Linux 上。 這會導致連線失敗時嘗試連線到[!INCLUDE[ssNoVersion](../includes/ssnoversion-md.md)]，以及建立高可用性群組中的複本之間的連線問題。

   - **解析**:修改**mssql.conf**設定指令碼[!INCLUDE[ssNoVersion](../includes/ssnoversion-md.md)]上 Linux 停用有問題的加密套件，執行下列動作：
      ...
      1. 重新啟動[!INCLUDE[ssNoVersion](../includes/ssnoversion-md.md)]使用下列命令。

      ```bash
      sudo systemctl restart mssql-server
      ```

- [!INCLUDE[ssSQL14](../includes/sssql14-md.md)] 無法還原使用記憶體內部 OLTP 的 Windows 上的資料庫上[!INCLUDE[ssSQL17](../includes/sssql17-md.md)]Linux 上。 若要還原[!INCLUDE[ssSQL14](../includes/sssql14-md.md)]資料庫使用記憶體內部 OLTP，先升級資料庫，以[!INCLUDE[ssSQL15](../includes/sssql15-md.md)]或[!INCLUDE[ssSQL17](../includes/sssql17-md.md)]日前他們的 Windows 上[!INCLUDE[ssNoVersion](../includes/ssnoversion-md.md)]透過備份/還原或卸離/附加在 Linux 上。
...
- 只找出 **/var/opt/mssql**上 NFS 掛接的目錄。 其他檔案，例如[!INCLUDE[ssNoVersion](../includes/ssnoversion-md.md)]系統二進位檔，不支援。
...
- 當執行 mssql conf 安裝程式，和執行的非英文版安裝[!INCLUDE[ssNoVersion](../includes/ssnoversion-md.md)]，不正確的擴充的字元則會顯示當地語系化文字，也就是 「 設定 SQL Server...」。 或者，您也可以針對非拉丁型安裝，句子可能會遺漏完全。 遺漏的句子應該會顯示下列當地語系化的字串：「 已成功處理授權 PID。 新的版本是 [\<名稱\>edition]"。 此字串是資訊之用和下一個輸出[!INCLUDE[ssNoVersion](../includes/ssnoversion-md.md)]累計更新將解決此問題適用於所有語言。 這不會影響順利安裝[!INCLUDE[ssNoVersion](../includes/ssnoversion-md.md)]以任何方式。 
...
- 具有[!INCLUDE[ssISnoversion](../includes/ssisnoversion-md.md)]重新整理 Linux CTP 2.1 和更新版本，[!INCLUDE[ssISnoversion](../includes/ssisnoversion-md.md)]封裝可以在 Linux 上使用 ODBC 連接。 這項功能經過[!INCLUDE[ssNoVersion](../includes/ssnoversion-md.md)]和 MySQL ODBC 驅動程式，但也應該使用 ODBC 規格會觀察到的任何 Unicode ODBC 驅動程式。 在設計階段，您可以提供 DSN 或連接字串來連接到 ODBC 資料;您也可以使用 Windows 驗證。 如需詳細資訊，請參閱 <<c0> [ 部落格文章宣佈的 ODBC 支援在 Linux 上](https://blogs.msdn.microsoft.com/ssis/2017/06/16/odbc-is-supported-in-ssis-on-linux-ssis-helsinki-ctp2-1-refresh/)。
...
- 在 Linux 上執行 SSIS 封裝時，下列功能不支援此版本中：
  ...
  - 第三方元件
  - 異動資料擷取 (CDC)
  - [!INCLUDE[ssISnoversion](../includes/ssisnoversion-md.md)] 相應放大
...
下列限制適用於[!INCLUDE[ssManStudioFull](../includes/ssmanstudiofull-md.md)]連線到 Windows 上[!INCLUDE[ssNoVersion](../includes/ssnoversion-md.md)]Linux 上。

- 維護計畫不支援。

- 管理資料倉儲 (MDW) 和中的資料收集器[!INCLUDE[ssManStudioFull](../includes/ssmanstudiofull-md.md)]不支援。 

- [!INCLUDE[ssManStudioFull](../includes/ssmanstudiofull-md.md)] UI 元件的 Windows 驗證] 或 [Windows 事件記錄檔選項不適用於 Linux。 您仍然可以使用這些功能與其他選項，例如 SQL 登入。 
