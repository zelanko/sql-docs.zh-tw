...
> [!WARNING]
> 這個區段、方法或工作包含說明如何修改登錄的步驟。 不過，如果您不正確地修改登錄，可能會造成資料遺失，而且需要重新安裝作業系統，就會發生嚴重的問題。 我們強烈建議您先備份登錄，然後再進行修改。 如此一來，如果發生問題，您就可以還原登錄。 如需有關如何備份和還原登錄的詳細資訊，請按一下下列文章編號，以查看 Microsoft 知識庫中的文章：<br>
