---
title: Tempdb 資料庫-Parallel Data Warehouse |Microsoft 文件
description: 平行處理資料倉儲的 Tempdb 資料庫。
author: mzaman1
manager: craigg
ms.prod: sql
...
ms.locfileid: "31538858"
---
# <a name="tempdb-database-in-parallel-data-warehouse"></a>平行處理資料倉儲的 tempdb 資料庫
