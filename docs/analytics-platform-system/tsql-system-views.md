...
## <a name="parallel-data-warehouse-dynamic-management-views-dmvs"></a>平行資料倉儲動態管理檢視 (Dmv)
...
## <a name="sql-server-dmvs-applicable-to-parallel-data-warehouse"></a>適用於平行處理資料倉儲的 SQL Server Dmv
下列 Dmv 適用於平行處理資料倉儲，但必須藉由連接到執行**主要**資料庫。
