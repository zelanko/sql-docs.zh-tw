...
|啟動 SQL Server PDW 組態管理員|[啟動 Configuration Manager &#40;Analytics Platform System&#41;](launch-the-configuration-manager.md)|  
...
|可以變更的 DSRM 密碼。<br /><br />(選擇性)|如需詳細資訊，請參閱[設定系統管理員密碼來登入以目錄服務還原模式的 AD 節點&#40;DSRM&#41; &#40;Analytics Platform System&#41;](set-admin-password-for-logging-on-to-ad-nodes-in-directory-services-restore-mode.md)。|  
...
|設定外部資料，例如 Hadoop 或 Azure blob 儲存體的連線。<br /><br />(選擇性)|如需詳細資訊，請參閱[設定外部資料的 PolyBase 連線&#40;Analytics Platform System&#41;](configure-polybase-connectivity-to-external-data.md)。|  
...
|設定將遙測資料傳送給 Microsoft<br /><br />(選擇性)|若要設定將遙測資料傳送到 Microsoft Analytics Platform System，您需要的控制節點上執行 PowerShell 指令碼。 如需特定指示，請參閱[傳送遙測意見給 Microsoft &#40;SQL Server PDW&#41;](send-telemetry-feedback-to-microsoft-sql-server-pdw.md)。|  
