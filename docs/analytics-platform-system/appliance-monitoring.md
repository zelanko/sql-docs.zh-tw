---
title: 應用裝置監視-Analytics Platform System |Microsoft 文件
description: 此應用裝置的監視指南描述的工具和監視 Analytics Platform System 應用裝置的工作。
author: mzaman1
manager: craigg
ms.prod: sql
...
|監視工作|Description|  
|-------------------|---------------|  
|使用系統管理員主控台監視應用裝置。|[使用管理主控台來監視設備&#40;Analytics Platform System&#41;](monitor-the-appliance-by-using-the-admin-console.md)|  
|使用系統檢視表，以監視應用裝置。|[使用系統檢視表來監視設備&#40;Analytics Platform System&#41;](monitor-the-appliance-by-using-system-views.md)|  
|使用 System Center 監視的應用裝置|[使用 System Center Operations Manager 監視的應用裝置&#40;Analytics Platform System&#41;](monitor-the-appliance-by-using-system-center-operations-manager.md)|  
