...
3.  監視 SQL Server PDW 和 HDInsight 的管理組件必須安裝、 匯入，並設定。 使用下列指示來執行這些工作。  
    ...
    -   [SCOM 管理組件 &#40; 安裝Analytics Platform System &#41;](install-the-scom-management-packs.md)  
  
    -   [匯入 PDW &#40; SCOM 管理組的件Analytics Platform System &#41;](import-the-scom-management-pack-for-pdw.md) 
