...
|-------------------|-----------------------|------------------------------------|  
|字串常值中**datetime**格式|'yyyy-MM-dd hh:mm:ss[.fff]'<br /><br />範例: ' 2007年-05-08 12:35:29.123'|插入值時，遺失的小數點後數字會設為 0。 例如，常值 '2007年-05-08 12:35' 會插入做為 ' 2007年-05-08 12:35:00.000'。|  
...
|-------------------|-----------------------|------------------------------------------|  
|字串常值中**datetime**格式|'yyyy-MM-dd hh:mm:ss[.fff]'<br /><br />範例: ' 2007年-05-08 12:35:29.123'|遺失的小數點後數字和位移的值時都會設為 0 會插入的值。 例如，常值 '2007年-05-08 12:35:29.123' 會插入做為' 2007年-05-08 12:35:29.1230000 + 00:00 '。|  
...
|-------------------|-----------------------|-------------------------------------|  
|字串常值中**datetime**格式|'yyyy-MM-dd hh:mm:ss[.fff]'<br /><br />範例: ' 2007年-05-08 12:35:29.123'|小數秒數是選擇性的則會插入值時，會設定為 0。|  
