---
title: 針對資料收集進行疑難排解
description: 了解您在嘗試自行或透過 Microsoft 客戶支援服務的協助解決問題時，應使用的資料收集方法。
ms.prod: sql
...
ms.locfileid: "73727603"
---
# <a name="troubleshoot-data-collection-for-machine-learning"></a>針對機器學習的資料收集進行疑難排解

[!INCLUDE[appliesto-ss-xxxx-xxxx-xxx-md](../includes/appliesto-ss-xxxx-xxxx-xxx-md.md)]

此文章說明在嘗試自行或透過 Microsoft 客戶支援服務的協助解決問題時，應使用的資料收集方法。
...
視您使用的 SQL Server 版本而定，某些機器學習功能可能無法使用或受到限制。 下列文章列出 Enterprise、Developer、Standard 與 Express 版本中的機器學習功能。

* [SQL Server 的版本及支援功能](https://docs.microsoft.com/sql/sql-server/editions-and-components-of-sql-server-2016)
* [ SQL Server 版本的 R 與 Python 功能](r/differences-in-r-features-between-editions-of-sql-server.md)
...
如需版本與 R 元件下載連結的清單，請參閱[在沒有網際網路存取的電腦上安裝機器學習元件](https://docs.microsoft.com/sql/advanced-analytics/r/installing-ml-components-without-internet-access)。 可以存取網際網路的電腦上，系統會自動識別並安裝所需的 R 版本。
...
5. 若使用者需要安裝新的 R 套件，或使用其他使用者安裝的 R 套件，您可能需要在執行個體上啟用套件管理，然後再指派額外權限。 如需詳細資訊，請參閱[啟用或停用 R 套件管理](r/r-package-how-to-enable-or-disable.md)。
