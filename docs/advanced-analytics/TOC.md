...
## [預先訓練模型](install/sql-pretrained-models-install.md)
...
## R
### [以 R 和 SQL 撰寫的 Hello World](tutorials/rtsql-using-r-code-in-transact-sql-quickstart.md)
### [處理輸入和輸出](tutorials/rtsql-working-with-inputs-and-outputs.md)
### [處理資料類型和物件](tutorials/rtsql-r-and-sql-data-types-and-data-objects.md)
### [建立預測模型](tutorials/rtsql-create-a-predictive-model-r.md)
### [從模型預測及繪製](tutorials/rtsql-predict-and-plot-from-model.md)

# [教學課程](tutorials/machine-learning-services-tutorials.md)
## [R](tutorials/sql-server-r-tutorials.md)
### [了解資料庫內分析](tutorials/sqldev-in-database-r-for-sql-developers.md)
#### [1 - 取得資料和指令碼](tutorials/sqldev-download-the-sample-data.md)
#### [2 - 設定環境](r/sqldev-import-data-to-sql-server-using-powershell.md)
#### [3 - 將資料視覺化](tutorials/sqldev-explore-and-visualize-the-data.md)
#### [4 - 建立資料特徵](tutorials/sqldev-create-data-features-using-t-sql.md)
...
#### [使用 SQL 探索資料](tutorials/walkthrough-view-and-explore-the-data.md)
#### [使用 R 摘要資料](tutorials/walkthrough-view-and-summarize-data-using-r.md)
#### [建立圖表及繪圖](tutorials/walkthrough-create-graphs-and-plots-using-r.md)
#### [建立資料特徵](tutorials/walkthrough-create-data-features.md)
#### [建立及儲存模型](tutorials/walkthrough-build-and-save-the-model.md)
#### [部署及使用模型](tutorials/walkthrough-deploy-and-use-the-model.md)

### [使用 RevoScaleR 深入鑽研](tutorials/deepdive-data-science-deep-dive-using-the-revoscaler-packages.md)
#### [建立資料庫與權限](tutorials/deepdive-work-with-sql-server-data-using-r.md)
#### [使用 RxSqlServerData 建立資料物件](tutorials/deepdive-create-sql-server-data-objects-using-rxsqlserverdata.md)
#### [查詢及修改資料](tutorials/deepdive-query-and-modify-the-sql-server-data.md)
#### [定義計算內容](tutorials/deepdive-define-and-use-compute-contexts.md)
#### [建立及執行 R 指令碼](tutorials/deepdive-create-and-run-r-scripts.md)
#### [將資料視覺化](tutorials/deepdive-visualize-sql-server-data-using-r.md)
#### [建立模型](tutorials/deepdive-create-models.md)
#### [為新資料評分](tutorials/deepdive-score-new-data.md)
#### [轉換資料](tutorials/deepdive-transform-data-using-r.md)
#### [使用 rxImport 將資料載入記憶體](tutorials/deepdive-load-data-into-memory-using-rximport.md)
#### [使用 rxDataStep 建立資料表](tutorials/deepdive-create-new-sql-server-table-using-rxdatastep.md)
...
### [了解資料庫內分析](tutorials/sqldev-in-database-python-for-sql-developers.md)
#### [取得資料和指令碼](tutorials/sqldev-py1-download-the-sample-data.md)
#### [匯入資料](tutorials/sqldev-py2-import-data-to-sql-server-using-powershell.md)
#### [探索及視覺化資料](tutorials/sqldev-py3-explore-and-visualize-the-data.md)
#### [建立資料特徵](tutorials/sqldev-py4-create-data-features-using-t-sql.md)
...
# [套件參考](r/machine-learning-services-r-reference.md)

## [SQL 中的 MicrosoftML](using-the-microsoftml-package.md)
## [SQL 中的 RevoScaleR](r/revoscaler-overview.md)
## [適用於 SQL Server 資料的 RevoScaleR 函式](r/scaler-functions-for-working-with-sql-server-data.md)
## [SQL 中的 sqlrutils](r/generating-an-r-stored-procedure-for-r-code-using-the-sqlrutils-package.md)
## [SQL 中的 olapR](r/how-to-create-mdx-queries-using-olapr.md)
## [SQL 中的 revoscalepy](python/what-is-revoscalepy.md)
