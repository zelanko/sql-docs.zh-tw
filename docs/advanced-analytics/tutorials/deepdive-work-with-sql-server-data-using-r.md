---
title: "使用 SQL Server 資料使用 R |Microsoft 文件"
ms.custom:
- SQL2016_New_Updated
ms.date: 05/18/2017
...
> [!NOTE]
> 執行 R 指令碼的帳戶如果您只會讀取資料，需要選取權限 (**db_datareader**角色) 上指定的資料庫。 不過，在本教學課程中，您將需要 DDL 系統管理員權限以準備資料庫，並建立資料表來儲存評分結果。
> 
> 此外，如果您不是資料庫擁有者，您將需要的權限，EXECUTE ANY EXTERNAL SCRIPT，可以執行 R 指令碼。
