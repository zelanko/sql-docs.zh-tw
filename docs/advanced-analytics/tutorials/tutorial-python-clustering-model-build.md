...
ms.locfileid: "70238710"
---
# <a name="tutorial-build-a-clustering-model-in-python-with-sql-server-machine-learning-services"></a>教學課程：使用 SQL Server Machine Learning 服務在 Python 中建立群集模型
...
* 本教學課程的第三部分假設您已完成[**第一**](tutorial-python-clustering-model.md)部分的必要條件, 並已完成[**第二部分**](tutorial-python-clustering-model-prepare-data.md)中的步驟。
...
這四個叢集表示是使用[第一部分](tutorial-python-clustering-model-prepare-data.md#separate-customers)中定義的變數來提供:
...
> [教學課程：使用 SQL Server Machine Learning 服務在 Python 中部署群集模型](tutorial-python-clustering-model-deploy.md)