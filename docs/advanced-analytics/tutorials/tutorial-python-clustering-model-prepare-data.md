---
title: 教學課程：準備資料以在 Python 中執行叢集
...
ms.locfileid: "70211962"
---
# <a name="tutorial-prepare-data-to-perform-clustering-in-python-with-sql-server-machine-learning-services"></a>教學課程：使用 SQL Server Machine Learning 服務準備資料以在 Python 中執行叢集

在這四部分教學課程系列的第二部分中, 您將使用 Python 從 SQL 資料庫匯入和準備資料。 稍後在此系列中, 您將使用這項資料, 以 SQL Server Machine Learning 服務來定型和部署 Python 中的叢集模型。
...
* 本教學課程的第二部分假設您已完成[**第一部分**](tutorial-python-clustering-model.md)的必要條件。
...
> [教學課程：使用 SQL Server Machine Learning 服務在 Python 中建立預測模型](tutorial-python-clustering-model-build.md)
