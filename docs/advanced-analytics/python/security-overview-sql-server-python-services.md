---
title: 在 SQL Server Machine Learning Python 的安全性概觀 |Microsoft 文件
ms.prod: sql
...
ms.locfileid: "31202130"
---
# <a name="security-overview-for-python-in-sql-server-machine-learning"></a>在 SQL Server Machine Learning Python 的安全性概觀
