...
若要設定 Microsoft R Server 的另一個執行個體具有相同參數，您可以重新使用的在安裝期間建立的組態檔。 如需詳細資訊，請參閱[使用組態檔安裝 SQL Server](/sql-docs/docs/database-engine/install-windows/install-sql-server-2016-using-a-configuration-file)
