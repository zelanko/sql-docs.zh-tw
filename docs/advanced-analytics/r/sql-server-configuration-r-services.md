...
> 
> 您可以在最後一篇文章中檢閱特定最佳化的結果：[效能微調 - 案例研究結果](../../advanced-analytics/r/performance-case-study-r-services.md)
> 
...
2. 定義處理器親和性
3. 使用 [Resource Governor](../r/resource-governance-for-r-services.md) 建立用於外部處理序的資源集區
...
[R 的效能微調 - 簡介](../r/sql-server-r-services-performance-tuning.md)

[R 的效能微調 - SQL Server 設定](../r/sql-server-configuration-r-services.md)

[R 的效能微調 - R 程式碼和資料最佳化](../r/r-and-data-optimization-r-services.md)
