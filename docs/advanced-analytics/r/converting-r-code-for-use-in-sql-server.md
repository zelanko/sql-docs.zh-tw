---
title: 將 R 程式碼，以用於 SQL Server 機器學習服務轉換 |Microsoft 文件 」
ms.prod: sql
...
ms.locfileid: "31203580"
---
# <a name="convert-r-code-for-execution-in-sql-server-in-database-instances"></a>轉換為 SQL Server （資料庫） 執行個體中執行 R 程式碼
