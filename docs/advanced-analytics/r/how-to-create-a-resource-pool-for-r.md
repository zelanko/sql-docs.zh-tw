---
title: SQL Server 機器學習建立資源集區 |Microsoft 文件
ms.prod: sql
...
ms.locfileid: "31203500"
---
# <a name="create-a-resource-pool-for-machine-learning-in-sql-server"></a>SQL Server 中建立機器學習的資源集區
