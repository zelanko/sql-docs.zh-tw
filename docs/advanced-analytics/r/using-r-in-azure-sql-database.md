...
在此同時，我們建議您使用其中一個 Azure Marketplace 可用的 SQL Server 2017 虛擬機器： 
...
+ [深入了解虛擬機器](https://docs.microsoft.com/azure/machine-learning/data-science-virtual-machine/deep-learning-dsvm-overview)， 
