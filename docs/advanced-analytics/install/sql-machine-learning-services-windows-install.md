---
title: 在 Windows 上安裝 SQL Server 機器學習服務 (Python、R)
titleSuffix: ''
description: 此文章解釋如何在 Windows 上安裝 SQL Server 機器學習服務。 您可以使用機器學習服務來在資料庫中執行 Python 和 R 指令碼。
ms.prod: sql
