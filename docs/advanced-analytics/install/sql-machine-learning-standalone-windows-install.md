...
安裝完成時，請參閱 [SQL Server R Services 的自訂報告](../r/monitor-r-services-using-custom-reports-in-management-studio.md)。如需任何錯誤或警告的說明，請參閱[升級和安裝常見問題 - 機器學習服務](../r/upgrade-and-installation-faq-sql-server-r-services.md)。
::: moniker-end
