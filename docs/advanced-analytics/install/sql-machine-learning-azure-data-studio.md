...
了解如何使用 [SQL Server 機器學習服務](../what-is-sql-server-machine-learning.md)在 [Azure Data Studio](https://docs.microsoft.com/sql/azure-data-studio/what-is) 的筆記本中執行 Python 和 R 指令碼。 Azure Data Studio 是跨平台的資料庫工具。
