...
## <a name="provider-specific-connection-parameters"></a>提供者特定的連接參數
 除了 ADO 定義的連接參數之外，提供者還支援數個提供者特定的連接參數。 如同 ADO 連接屬性，可以透過[連接](../../../ado/reference/ado-api/connection-object-ado.md)的[Properties](../../../ado/reference/ado-api/properties-collection-ado.md)集合或**ConnectionString**的一部分設定這些提供者特有的屬性。

 這些參數會在 OLE DB 程式設計 [人員參考](https://msdn.microsoft.com/3c5e2dd5-35e5-4a93-ac3a-3818bb43bbf8)中完整說明。 [ADO 動態屬性索引](../../../ado/reference/ado-api/ado-dynamic-property-index.md)提供這些參數名稱和對應 OLE DB 屬性之間的交互參考。
