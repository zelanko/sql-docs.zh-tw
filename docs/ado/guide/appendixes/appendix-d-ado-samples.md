...
> [!NOTE]
>  公司、 名稱和範例中所使用的資料均屬虛構，除非另有說明。

 若要尋找 ADO 範例，請導覽至您的 Windows SDK 根資料夾，例如 C:\Program Files\Microsoft SDKs\Windows\v6.0。 然後瀏覽至 Samples\dataaccess\ADO 子資料夾。
