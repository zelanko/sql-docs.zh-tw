...
|傳回**記錄集中**的相關記錄|[資料成形摘要](../../ado/guide/data/data-shaping-overview.md)|
|存取半結構化資料|[記錄和資料流](../../ado/guide/data/records-and-streams.md)|
|使用 XML 進行查詢或命令輸入|[命令資料流](../../ado/guide/data/command-streams.md)|
|從提供者傳回 XML 資料|[將結果集擷取為資料流](../../ado/guide/data/retrieving-resultsets-into-streams.md)|
