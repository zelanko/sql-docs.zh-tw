...
> [!NOTE]
>  針對 MDAC 2.0 和更新版本以及 Windows DAC，預設的商務物件 [RDSServer DataFactory](../../../ado/reference/rds-api/datafactory-object-rdsserver.md)在 MDAC/Windows DAC 安裝期間不會依預設註冊。 但是，如果在安裝之前將 **RDSServer** 註冊為安全的電腦上執行，則會保留新安裝的登錄專案。  
