...
```  
 ...
 結構描述定義符合[W3C XML 資料的規格](https://www.w3.org/TR/1998/NOTE-XML-data/)並可在 （雖然驗證不會發生在 Internet Explorer 5） 完整驗證。 XML 資料是目前唯一支援的結構描述的格式資料錄集的持續性。  
