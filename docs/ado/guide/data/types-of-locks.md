...
## <a name="adlockbatchoptimistic"></a>Adlockpessimistic  
 表示開放式批次更新。 所需的批次更新模式。  
...
## <a name="adlockreadonly"></a>Recordset  
