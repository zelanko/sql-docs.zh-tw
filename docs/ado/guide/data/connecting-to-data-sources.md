...
-   [使用連接物件](../../../ado/guide/data/using-a-connection-object.md)  
  
-   [使用資料錄集物件](../../../ado/guide/data/using-a-recordset-object.md)  
  
-   [建立的連接字串](../../../ado/guide/data/creating-a-connection-string.md)  
