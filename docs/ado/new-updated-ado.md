---
title: 已更新-SQL Server 文件的 ADO |Microsoft 文件
description: 顯示程式碼片段的最近變更過的文件，如 ActiveX Data Objects (ADO) 的 Microsoft SQL Server 的更新內容。
manager: craigg
author: MightyPen
ms.author: genemi
ms.topic: article
...
ms.locfileid: "32435479"
---
# <a name="new-and-recently-updated-activex-data-objects-ado-for-sql-server"></a>新增和更新最近： ActiveX Data Objects (ADO) for SQL Server
...
- *主旨區域：* &nbsp; **ActiveX Data Objects (ADO) for SQL Server**。
