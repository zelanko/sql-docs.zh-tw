...
|常數|值|描述|  
|--------------|-----------|-----------------|  
|**adSimpleRecord**|0|指出*簡單*（不包含子節點） 的記錄。|  
|**adCollectionRecord**|1|指出*集合*（包含子節點） 的記錄。|  
|**adRecordUnknown**|-1|表示這個型別**記錄**不明。|  
|**adStructDoc**|2|表示一種特殊種類的*集合*代表 COM 的記錄結構化文件。|  
