---
description: '使用 #import) Visual C++ 語法索引的記錄集 ('
title: '使用 #import) 的 Visual C++ 語法索引記錄集 (|Microsoft Docs'
ms.prod: sql
...
ms.locfileid: "88772137"
---
# <a name="recordset-visual-c-syntax-index-with-import"></a>使用 #import) Visual C++ 語法索引的記錄集 (
## <a name="methods"></a>方法  
