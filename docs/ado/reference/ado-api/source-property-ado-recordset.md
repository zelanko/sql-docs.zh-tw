...
## <a name="remarks"></a>備註  
 ...
 如果您將**Source**屬性設定為**Command**物件，**記錄集**物件的[ActiveConnection](../../../ado/reference/ado-api/activeconnection-property-ado.md)屬性將會繼承指定**命令**物件的**ActiveConnection**屬性值。 但是，讀取**Source**屬性不會傳回**命令**物件;相反地，它會傳回您設定**Source**屬性的**命令**物件之[CommandText](../../../ado/reference/ado-api/commandtext-property-ado.md)屬性。  
  
 如果**來源**屬性是 SQL 語句、預存程式或資料表名稱，您可以使用[Open](../../../ado/reference/ado-api/open-method-ado-recordset.md)方法呼叫傳遞適當的*選項*引數，以優化效能。  
