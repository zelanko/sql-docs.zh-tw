---
title: 'RecordsetEvents （Visual c + + 語法索引與 #import） |Microsoft 文件'
ms.prod: sql
...
ms.locfileid: "35281277"
---
# <a name="recordsetevents-visual-c-syntax-index-with-import"></a>RecordsetEvents （Visual c + + 語法索引與 #import）
## <a name="events"></a>事件  
