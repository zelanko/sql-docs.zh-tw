...
ms.locfileid: "88442040"
---
# <a name="source-property-ado-record"></a>Source 屬性 (ADO Record)
指出 [記錄](../../../ado/reference/ado-api/record-object-ado.md)所代表的資料來源或物件。  
  
## <a name="settings-and-return-values"></a>設定和傳回值  
 設定或傳回 **Variant** 值，指出 **記錄**所表示的實體。  
  
## <a name="remarks"></a>備註  
 **Source**屬性會傳回**Record**物件[Open](../../../ado/reference/ado-api/open-method-ado-record.md)方法的*來源*引數。 它可以包含絕對或相對的 URL 字串。 絕對 URL 可以在不設定 [ActiveConnection](../../../ado/reference/ado-api/activeconnection-property-ado.md) 屬性的情況下用來直接開啟 **記錄** 物件。 在此情況下，會建立隱含 **連接** 物件。  
