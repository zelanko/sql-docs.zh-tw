---
title: "ConnectionEvents （Visual c + + 語法索引與 #import） |Microsoft 文件"
...
---
# <a name="connectionevents-visual-c-syntax-index-with-import"></a>ConnectionEvents （Visual c + + 語法索引與 #import）
## <a name="events"></a>事件  
