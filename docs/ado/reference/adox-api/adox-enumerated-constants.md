...
|列舉型別|描述|  
|-----------------|-----------------|  
|[ActionEnum](../../../ado/reference/adox-api/actionenum.md)|指定呼叫 **SetPermissions** 時要執行的動作類型。|  
|[AllowNullsEnum](../../../ado/reference/adox-api/allownullsenum.md)|指定是否為具有 null 值的記錄編制索引。|  
...
|[KeyTypeEnum](../../../ado/reference/adox-api/keytypeenum.md)|指定索引 **鍵**的類型： primary、foreign 或 unique。|  
|[ObjectTypeEnum](../../../ado/reference/adox-api/objecttypeenum.md)|指定要設定許可權或擁有權的資料庫物件類型。|  
|[RightsEnum](../../../ado/reference/adox-api/rightsenum.md)|指定物件之群組或使用者的許可權或許可權。|  
