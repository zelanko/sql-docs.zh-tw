---
description: ActiveConnection 屬性 (ADOX)
...
ms.locfileid: "88440648"
---
# <a name="activeconnection-property-adox"></a>ActiveConnection 屬性 (ADOX)
指出[類別目錄](../../../ado/reference/adox-api/catalog-object-adox.md)所屬的 ADO[連接](../../../ado/reference/ado-api/connection-object-ado.md)物件。  
