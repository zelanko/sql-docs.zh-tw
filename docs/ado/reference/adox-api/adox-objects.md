...
|[群組](../../../ado/reference/adox-api/group-object-adox.md)|代表有受保護的資料庫內的存取權限的群組帳戶。|  
|[索引](../../../ado/reference/adox-api/index-object-adox.md)|代表資料庫資料表中的索引。|  
...
|[[檢視]](../../../ado/reference/adox-api/view-object-adox.md)|代表已篩選的一組記錄或一份虛擬資料表。|  
 ...
 這些物件之間的關聯性所示[ADOX 物件模型](../../../ado/reference/adox-api/adox-object-model.md)。  
