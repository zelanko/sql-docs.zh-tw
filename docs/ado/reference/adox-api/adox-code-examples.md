...
使用下列程式碼範例以了解如何使用 ADOX 物件、 方法、 屬性和事件。  
  
> [!NOTE]
>  貼入您的程式碼編輯器中整個程式碼範例。 如果使用部分的範例，或遺失段落格式時，此範例可能無法正確執行。  
  
-   [ADOX Microsoft Visual Basic 中的程式碼範例](../../../ado/reference/adox-api/adox-code-examples-in-microsoft-visual-basic.md)  
  
-   [ADOX Microsoft Visual c + + 中的程式碼範例](../../../ado/reference/adox-api/adox-code-examples-in-microsoft-visual-c.md)  
