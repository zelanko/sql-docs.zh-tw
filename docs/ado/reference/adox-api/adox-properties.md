...
ms.locfileid: "88440550"
---
# <a name="adox-properties"></a>ADOX 屬性

|屬性|描述|  
|-|-|  
|[ActiveConnection](../../../ado/reference/adox-api/activeconnection-property-adox.md)|指出類別目錄所屬的 ADO **連接** 物件。|  
...
|[DateCreated](../../../ado/reference/adox-api/datecreated-property-adox.md)|指出建立物件的日期。|  
...
|[DeleteRule](../../../ado/reference/adox-api/deleterule-property-adox.md)|指出刪除 primary key 時所執行的動作。|  
...
|[有效位數](../../../ado/reference/adox-api/precision-property-adox.md)|表示資料行中資料值的最大有效位數。|  
|[PrimaryKey](../../../ado/reference/adox-api/primarykey-property-adox.md)|指出索引是否代表資料表上的主鍵。|  
|[RelatedColumn](../../../ado/reference/adox-api/relatedcolumn-property-adox.md)|指出相關資料表中相關資料行的名稱， (索引鍵資料行僅) 。|  
|[RelatedTable](../../../ado/reference/adox-api/relatedtable-property-adox.md)|指出相關資料表的名稱。|  
|[SortOrder](../../../ado/reference/adox-api/sortorder-property-adox.md)|指出僅) 資料行 (索引資料行的排序次序。|  
|[輸入 (資料行) ](../../../ado/reference/adox-api/type-property-column-adox.md)|表示資料行的資料類型。|  
|[輸入 (機碼) ](../../../ado/reference/adox-api/type-property-key-adox.md)|指出索引鍵的資料類型。|  
|[輸入 (資料表) ](../../../ado/reference/adox-api/type-property-table-adox.md)|指出資料表的型別。|  
|[唯一](../../../ado/reference/adox-api/unique-property-adox.md)|指出索引鍵是否必須是唯一的。|  
|[UpdateRule](../../../ado/reference/adox-api/updaterule-property-adox.md)|指出更新主鍵時所執行的動作。|  
