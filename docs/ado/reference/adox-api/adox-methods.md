...
|||  
|-|-|  
|[附加 （資料行）](../../../ado/reference/adox-api/append-method-adox-columns.md)|將新**資料行**物件**資料行**集合。|  
|[附加 （群組）](../../../ado/reference/adox-api/append-method-adox-groups.md)|將新**群組**物件**群組**集合。|  
|[附加 （索引）](../../../ado/reference/adox-api/append-method-adox-indexes.md)|將新**索引**物件**索引**集合。|  
|[附加 （索引鍵）](../../../ado/reference/adox-api/append-method-adox-keys.md)|將新**金鑰**物件**金鑰**集合。|  
|[附加 （程序）](../../../ado/reference/adox-api/append-method-adox-procedures.md)|將新**程序**物件**程序**集合。|  
