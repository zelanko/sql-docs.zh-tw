---
title: 來源屬性 (ADO MD) |Microsoft 文件
ms.prod: sql
...
ms.locfileid: "35284594"
---
# <a name="source-property-ado-md"></a>來源屬性 (ADO MD)
表示中的資料來源[資料格集](../../../ado/reference/ado-md-api/cellset-object-ado-md.md)。  
  
## <a name="settings-and-return-values"></a>設定和傳回值  
 設定或傳回**Variant**，並關閉是讀取/寫入[資料格集](../../../ado/reference/ado-md-api/cellset-object-ado-md.md)物件或唯讀狀態開啟**資料格集**物件。 **Variant**應該包含有效**字串**，例如，MDX 查詢。  
