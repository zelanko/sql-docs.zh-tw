---
title: "標題屬性 (ADO MD) |Microsoft 文件"
...
表示要使用時顯示的文字標題[層級](../../../ado/reference/ado-md-api/level-object-ado-md.md)或[成員](../../../ado/reference/ado-md-api/member-object-ado-md.md)物件。  
