...
ms.locfileid: "88438750"
---
# <a name="readystate-property-rds"></a>ReadyState 屬性 (RDS)
表示 [DataControl](../../../ado/reference/rds-api/datacontrol-object-rds.md) 物件在將資料提取到其 [記錄集](../../../ado/reference/ado-api/recordset-object-ado.md) 物件時的進度。  
...
## <a name="remarks"></a>備註  
 ...
 如果非同步作業期間發生錯誤， **ReadyState** 屬性會變更為 **adcReadyStateComplete**， [狀態](../../../ado/reference/ado-api/state-property-ado.md) 屬性會從 **AdStateExecuting** 變更為 **adStateClosed**，而 [ **記錄集** 物件 [值](../../../ado/reference/ado-api/value-property-ado.md) ] 屬性則不會保留 *任何*專案。  
  
## <a name="applies-to"></a>套用至  
 [DataControl 物件 (RDS)](../../../ado/reference/rds-api/datacontrol-object-rds.md)  
  
## <a name="see-also"></a>另請參閱  
 [ (VBScript) 的 ReadyState 屬性範例 ](../../../ado/reference/rds-api/readystate-property-example-vbscript.md)   
