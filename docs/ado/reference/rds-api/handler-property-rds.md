...
## <a name="remarks"></a>備註  
 ...
 設定的替代方案**處理常式**屬性會指定處理常式和中的參數[ConnectionString](../../../ado/reference/ado-api/connectionstring-property-ado.md)屬性，也就是 「 **處理常式 = * * * handlerName，parameter1，...; parameter2*".  
