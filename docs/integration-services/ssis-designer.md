...
helpviewer_keywords: 
  - "SQL Server Integration Services, SSIS 設計師"
  - "Business Intelligence Development Studio, Integration Services in"
  - "工具 [Integration Services], SSIS 設計師"
  - "SSIS, SSIS 設計師"
  - "SSIS 設計師, 關於 SSIS 設計師"
  - "Integration Services, SSIS 設計師"
...
### 參數索引標籤  
 ...
 如需參數的詳細資訊，請參閱 [Integration Services (SSIS) 參數](https://msdn.microsoft.com/library/hh213214.aspx)。  
...
### 事件處理常式索引標籤  
 ...
 如需詳細資訊，請參閱 [Add an Event Handler to a Package](../Topic/Add%20an%20Event%20Handler%20to%20a%20Package.md) (將事件處理常式加入封裝中)。  
...
##### 連接管理員區域  
 ...
 如需詳細資訊，請參閱 [Integration Services &#40;SSIS&#41; Connections](../integration-services/connection-manager/integration-services-ssis-connections.md) (Integration Services (SSIS) 連接) 和 [Create Connection Managers](../Topic/Create%20Connection%20Managers.md) (建立連線管理員)。  
