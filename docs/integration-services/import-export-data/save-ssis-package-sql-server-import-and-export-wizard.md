...
![顯示在於 [儲存並執行套件] 頁面上選取 [SQL Server] 選項時，[匯入與匯出精靈] 中 [儲存 SSIS 套件] 頁面的螢幕擷取畫面。](../../integration-services/import-export-data/media/save-package2.png "[匯入和匯出精靈] 的 [儲存 SSIS 套件] 頁面")  
...
![顯示在於 [儲存並執行套件] 頁面上選取 [檔案系統] 選項時，[匯入與匯出精靈] 中 [儲存 SSIS 套件] 頁面的螢幕擷取畫面。](../../integration-services/import-export-data/media/save-package1.png "[匯入和匯出精靈] 的 [儲存 SSIS 套件] 頁面")  
