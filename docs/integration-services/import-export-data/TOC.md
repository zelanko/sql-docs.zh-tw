...
# [資料行轉換詳細資訊對話方塊 (SQL Server 匯入和匯出精靈)](column-conversion-details-dialog-box-sql-server-import-and-export-wizard.md)
# [提供來源查詢 (SQL Server 匯入和匯出精靈)](provide-a-source-query-sql-server-import-and-export-wizard.md)
# [使用 SQL Server 匯入和匯出精靈來匯入或匯出資料](import-and-export-data-with-the-sql-server-import-and-export-wizard.md)
...
# [正在執行作業 (SQL Server 匯入和匯出精靈)](performing-operation-sql-server-import-and-export-wizard.md)
# [儲存 SSIS 封裝 (SQL Server 匯入和匯出精靈)](save-ssis-package-sql-server-import-and-export-wizard.md)
# [SQL Server 匯入和匯出精靈的資料類型對應](data-type-mapping-in-the-sql-server-import-and-export-wizard.md)
...
# [建立資料表的 SQL 陳述式 (SQL Server 匯入和匯出精靈)](create-table-sql-statement-sql-server-import-and-export-wizard.md)
