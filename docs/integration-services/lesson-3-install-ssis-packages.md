...
-   [步驟 1：複製部署配套](../integration-services/step-1-copying-the-deployment-bundle.md)  
  
-   [步驟 2：執行封裝安裝精靈](../integration-services/step-2-running-the-package-installation-wizard.md)  
  
-   [步驟 3：測試部署的封裝](../integration-services/step-3-testing-the-deployed-packages.md)  
