---
title: "使用預存程序部署及執行 SSIS 封裝 | Microsoft Docs"
ms.custom: ""
ms.date: "08/26/2016"
...
>   
>      如需有關記錄層級的詳細資訊，請參閱＜ [Enable Logging for Package Execution on the SSIS Server](../../integration-services/performance/enable-logging-for-package-execution-on-the-ssis-server.md)＞。  
