...
# [為 Oracle CDC 檢視指令碼準備 SQL Server](prepare-sql-server-for-oracle-cdc-view-script.md)
...
# [異動資料擷取](change-data-capture-ssis.md)
...
# [如何為 CDC 準備 SQL Server](how-to-prepare-sql-server-for-cdc.md)
...
# [Attunity oracle 異動資料擷取](change-data-capture-for-oracle-by-attunity.md)
...
# [Attunity Oracle 異動資料擷取服務](change-data-capture-service-for-oracle-by-attunity.md)
