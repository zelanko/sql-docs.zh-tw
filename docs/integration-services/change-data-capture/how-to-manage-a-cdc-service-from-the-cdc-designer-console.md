---
description: 如何從 CDC 設計工具主控台管理 CDC 服務
...
4.  您可以針對 CDC 服務執行以下工作：  
    ...
    -   **停止所有執行個體** (包含在選取的 CDC 服務中)  
     ...
     如需有關這些工作的詳細資訊，請參閱＜ [Manage a CDC Service](../../integration-services/change-data-capture/manage-a-cdc-service.md)＞。  
