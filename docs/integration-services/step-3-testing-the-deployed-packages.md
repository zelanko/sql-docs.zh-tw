...
3.  從套件清單的最上方開始，以滑鼠右鍵按一下 [DataTransfer]，然後按一下 [執行套件]。  
...
2.  在 [連接到伺服器] 對話方塊中，從 [伺服器類型] 清單中選取 [Database Engine]，並在 [伺服器名稱] 方塊中提供安裝教學課程套件所在的伺服器名稱或是輸入 (local)，然後選取驗證模式。 如果要使用「SQL Server 驗證」，請提供使用者名稱和密碼。  
...
2.  如果提示您重新連接，請在 [連接到伺服器] 對話方塊中，從 [伺服器類型] 清單中選取 [Database Engine]，並在 [伺服器名稱] 方塊中提供安裝教學課程套件所在的伺服器名稱或是輸入 (local)，然後選取驗證模式。 如果要使用「SQL Server 驗證」，請提供使用者名稱和密碼。  
