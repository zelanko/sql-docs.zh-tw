---
title: "在 SQL Server 資料工具中建立封裝 | Microsoft Docs"
ms.custom: ""
ms.date: "03/14/2017"
...
-   執行 [!INCLUDE[ssNoVersion](../includes/ssnoversion-md.md)] 匯入和匯出精靈  
 ...
 使用 [!INCLUDE[ssIS](../includes/ssis-md.md)] 設計師在 [!INCLUDE[ssBIDevStudioFull](../includes/ssbidevstudiofull-md.md)] 中建立的封裝將儲存到檔案系統。 若要將封裝儲存到 [!INCLUDE[ssNoVersion](../includes/ssnoversion-md.md)] 或封裝存放區，您必須儲存該封裝的複本。 如需詳細資訊，請參閱[儲存封裝的複本](../Topic/Save%20a%20Copy%20of%20a%20Package.md)。  

 如需示範如何使用預設封裝範本建立基本封裝的影片，請參閱[建立基本封裝 (SQL Server 影片)](http://go.microsoft.com/fwlink/?LinkId=131023)。  

## 取得 SQL Server Data Tools
若要安裝 SQL Server Data Tools (SSDT)，請參閱[下載 SQL Server Data Tools (SSDT)](https://msdn.microsoft.com/library/mt204009.aspx)。

## 在 SQL Server Data Tools 中使用封裝範本來建立封裝  
