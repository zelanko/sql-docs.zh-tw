---
title: "Integration Services (SSIS) 封裝 | Microsoft Docs"
ms.custom: ""
ms.date: "08/31/2016"
...
ms.topic: "article"
helpviewer_keywords: 
  - "SQL Server Integration Services 封裝, 關於封裝"
  - "封裝 [Integration Services], 關於封裝"
  - "SSIS 封裝, 關於封裝"
  - "SSIS 封裝"
  - "SQL Server Integration Services 封裝"
  - "容器 [Integration Services], 封裝"
  - "封裝 [Integration Services]"
  - "Integration Services 封裝, 關於封裝"
...
# Integration Services (SSIS) 封裝
 ...
 ![��有控制流程和資料流程的封裝](../integration-services/media/ssis-package.gif "��有控制流程和資料流程的封裝")  
...
## 將現有封裝重複使用為範本  
 ...
 若要變更封裝 GUID，請在 [!INCLUDE[ssBIDevStudioFull](../includes/ssbidevstudiofull-md.md)] 之 [屬性] 視窗的**ID** 屬性中重新產生 GUID。 若要變更封裝名稱，您可以更新 [屬性] 視窗中 **Name** 屬性的值。 您也可以使用 **dtutil** 命令提示字元，或以程式設計方式來更新 GUID 和名稱。 如需詳細資訊，請參閱[設定封裝屬性](../integration-services/set-package-properties.md)和 [dtutil 公用程式](../integration-services/dtutil-utility.md)。  
...
### 保護封裝的安全  
 封裝可利用數位簽章簽署，並使用密碼或使用者金鑰加密。 數位簽章可驗證封裝的來源。 不過，您也必須將 [!INCLUDE[ssISnoversion](../includes/ssisnoversion-md.md)] 設定為在載入封裝時檢查數位簽章。 如需詳細資訊，請參閱[使用數位簽章來識別封裝的來源](../integration-services/packages/identify-the-source-of-packages-with-digital-signatures.md)和[封裝中的敏感性資料存取控制](../integration-services/packages/access-control-for-sensitive-data-in-packages.md)。  
...
## 封裝上可用的自訂記錄項目  
 下表列出封裝的自訂記錄項目。 如需詳細資訊，請參閱 [Integration Services &#40;SSIS&#41; 記錄](../integration-services/performance/integration-services-ssis-logging.md)和[自訂訊息以進行記錄](../integration-services/performance/custom-messages-for-logging.md)。  
...
-   [SQL Server 匯入和匯出精靈](SQL%20Server%20Import%20and%20Export%20Wizard.md)  
