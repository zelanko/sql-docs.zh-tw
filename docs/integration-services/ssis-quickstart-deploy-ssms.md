...
2. 在 [連線至伺服器]  對話方塊中，輸入下列資訊：
   ...
   | **驗證** | SQL Server 驗證 | 使用 SQL Server 驗證時，您可以連線到 SQL Server 或 Azure SQL Database。 請參閱此文章中的[部署中的驗證方法](#authentication-methods-for-deployment)。 |
