...
```  
 ...
 如需詳細資訊，請參閱 [MSDN Library](http://go.microsoft.com/fwlink/?LinkId=7022) 中的＜通用類型轉換＞與＜實作類型轉換子＞。  
...
```  
 ...
 如需詳細資訊，請參閱 [MSDN Library](http://go.microsoft.com/fwlink/?LinkId=7022) 中的＜實作 UI 類型編輯器＞。  
