...
##  <a name="steps-in-building-deploying-and-debugging-a-custom-object-for-integration-services"></a><a name="top"></a> 針對 Integration Services 建置、部署和偵錯自訂物件的步驟  
...
##  <a name="signing-the-assembly"></a><a name="signing"></a> 簽署組件  
...
##  <a name="installing-the-assembly-in-the-global-assembly-cache"></a><a name="installing"></a> 在全域組件快取中安裝組件  
