...
# <a name="support-multi-targeting-in-your-custom-components"></a>支援在自訂元件中多目標
 您現在可以使用 SSIS 設計師中 SQL Server Data Tools (SSDT) 來建立、 維護及執行封裝，該目標 SQL Server 2016、 SQL Server 2014 或 SQL Server 2012。 若要取得 SSDT for Visual Studio 2015，請參閱[下載最新 SQL Server Data Tools](../../ssdt/download-sql-server-data-tools-ssdt.md)。 
