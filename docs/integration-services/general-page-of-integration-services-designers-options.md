---
title: "Integration Services 設計師選項的 [一般]頁面 | Microsoft Docs"
ms.custom: ""
ms.date: "03/14/2017"
...
---
# Integration Services 設計師選項的 [一般]頁面
 ...
 **載入封裝時檢查數位簽章**  
 ...
 如需詳細資訊，請參閱[使用數位簽章來識別封裝的來源](../integration-services/packages/identify-the-source-of-packages-with-digital-signatures.md)。  
