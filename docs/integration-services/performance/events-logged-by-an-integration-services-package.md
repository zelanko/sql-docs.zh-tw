---
title: "Integration Services 封裝所記錄的事件 | Microsoft Docs"
ms.custom: ""
ms.date: "03/14/2017"
...
ms.topic: "article"
helpviewer_keywords: 
  - "封裝 [Integration Services], 事件"
  - "事件 [Integration Services], 封裝"
...
# Integration Services 封裝所記錄的事件
 ...
 如需如何執行 SSIS 套件的一般資訊，請參閱[執行專案和套件](https://msdn.microsoft.com/library/ms141708.aspx)。  
...
## 相關工作  
 如需如何即時檢視記錄項目的詳細資訊，請參閱[檢視記錄事件視窗中的記錄項目](../../integration-services/performance/view-log-entries-in-the-log-events-window.md)。  
  
## 請參閱＜  
 [Integration Services 服務所記錄的事件](../../integration-services/service/events-logged-by-the-integration-services-service.md)  
