---
title: "使用已儲存的組態檔來設定記錄 | Microsoft Docs"
ms.custom: ""
ms.date: "03/01/2017"
...
4.  在 [提供者與記錄] 索引標籤上，選取要用於容器的記錄檔。  
    ...
    > [!NOTE]  
    >  您只可在封裝層級建立記錄檔。 如需詳細資訊，請參閱[在 SQL Server Data Tools 中啟用封裝記錄功能](../../integration-services/performance/enable-package-logging-in-sql-server-data-tools.md)。  
