...
ms.topic: "article"
helpviewer_keywords: 
  - "存取 [Integration Services]"
  - "存取資料庫 [Integration Services]"
...
## 連接至採用 Access 2003 或舊版格式的資料來源  
  
#### 從連接管理員區域建立 Access 連接管理員  
...
#### 從 SQL Server 匯入和匯出精靈建立 Access 連接  
...
#### 從 SQL Server 匯入和匯出精靈建立 OLE DB 連接  
