---
title: "產生封裝執行的傾印檔案 | Microsoft Docs"
ms.custom: ""
ms.date: "08/24/2016"
...
-   .tmp 偵錯傾印檔案。 這是文字格式的檔案。  
 ...
 [!INCLUDE[ssISnoversion](../../includes/ssisnoversion-md.md)] 預設會將這些檔案儲存在 *\<磁碟機>:*\Program Files\Microsoft SQL Server\110\Shared\ErrorDumps 資料夾中。  
