---
title: "傾印檔案產生 for Package Execution |Microsoft 文件"
ms.custom: 
ms.date: 08/24/2016
...
-   .tmp 偵錯傾印檔案。 這是文字格式的檔案。  
 ...
 根據預設，[!INCLUDE[ssISnoversion](../../includes/ssisnoversion-md.md)]將這些檔案儲存在資料夾中， *\<磁碟機 >:*\Program Files\Microsoft SQL Server\110\Shared\ErrorDumps。  
