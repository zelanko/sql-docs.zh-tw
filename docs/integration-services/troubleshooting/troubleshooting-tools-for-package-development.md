---
title: "疑難排解封裝開發的工具 | Microsoft Docs"
ms.custom: ""
ms.date: "03/17/2017"
...
-   **使用資料檢視器監看資料在資料流程中的移動**。 資料檢視器會在資料於來源、轉換和目的地之間移動時顯示資料值。 資料檢視器可以在方格中顯示資料。 您可以將資料檢視器中的資料複製到 [剪貼簿] 中，然後將資料貼到檔案或 Excel 試算表中。 如需詳細資訊，請參閱[將資料檢視器加入資料流程](../../integration-services/troubleshooting/add-a-data-viewer-to-a-data-flow.md)。  
