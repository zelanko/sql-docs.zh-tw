...
helpviewer_keywords: 
  ...
  - "資料分割處理目的地 [Integration Services]"
  - "目的地 [Integration Services], 資料分割處理"
...
-   [資料分割處理目的地編輯器 &#40;連線管理員頁面&#41;](../../integration-services/data-flow/partition-processing-destination-editor-connection-manager-page.md)  
