...
ms.openlocfilehash: bb730312a1e163c71bde73e8b90810be99e2ceb9
...
-   [ODBC 目的地](../../integration-services/data-flow/odbc-destination.md)  
...
|SQL_FLOAT|DT_R8|  
|SQL_REAL|DT_R4|  
|SQL_NUMERIC (p,s)|DT_NUMERIC (p,s)|如果 P 大於或等於 38，而且 S 大於或等於 0，而且 S 小於或等於 P，則數值資料類型會對應至 DT_NUMERIC。|  
||DT_R8|如果至少下列一個條件為真，則數值資料類型會對應至 DT_R8：<br /><br />有效位數大於 38<br /><br />小數位數小於零<br /><br />小數位數大於 38<br /><br />小數位數大於有效位數|  
||DT_CY|如果宣告為 money 資料類型，則數值資料類型會對應至 DT_CY。|  
|SQL_DECIMAL (p,s)|DT_NUMERIC (p,s)|如果 P 大於或等於 38，而且 S 大於或等於 0，而且 S 小於或等於 P，則 decimal 資料類型會對應至 DT_NUMERIC。|  
||DT_R8|如果至少下列一個條件為真，則 decimal 資料類型會對應至 DT_R8：<br /><br />有效位數大於 38<br /><br />小數位數小於零<br /><br />小數位數大於 38<br /><br />小數位數大於有效位數|  
||DT_CY|如果宣告為 money 資料類型，則 decimal 資料類型會對應至 DT_CY。|  
