...
-   blogs.msdn.com 上的部落格文章： [疑難排解 SSIS 封裝效能問題](https://techcommunity.microsoft.com/t5/sql-server-integration-services/api-sample-oledb-source-and-oledb-destination/ba-p/387553)  
