---
title: "逐步解說︰發行 SSIS 封裝做為 SQL 檢視 | Microsoft Docs"
ms.custom: 
  - "SQL2016_New_Updated"
ms.date: "03/14/2017"
...
## 步驟 2︰使用 SSIS 資料摘要發行精靈來發行 SSIS 封裝做為 SQL 檢視  
...
3.  以滑鼠右鍵按一下精靈建立的 [\<**精靈建立的檢視**>]，然後按一下 [Select top 1000 rows (選取前 1000 個資料列)]。  
...
### 使用適用於 SSIS 的 OLE DB 提供者建立連結的伺服器  
