---
title: "資料採礦查詢轉換編輯器 （採礦模型索引標籤） |Microsoft 文件"
ms.custom: 
ms.date: 03/01/2017
...
ms.openlocfilehash: 6cb4dd082e29aea790eff8b000b1ccf5d5ad126c
...
# <a name="data-mining-query-transformation-editor-mining-model-tab"></a>資料採礦查詢轉換編輯器 (採礦模型索引標籤)
 ...
 若要深入了解資料採礦查詢轉換，請參閱＜ [Data Mining Query Transformation](../../../integration-services/data-flow/transformations/data-mining-query-transformation.md)＞。  
...
## <a name="see-also"></a>請參閱＜  
 ...
 [資料採礦查詢轉換編輯器 &#40;查詢索引標籤 &#41;](../../../integration-services/data-flow/transformations/data-mining-query-transformation-editor-query-tab.md)  
