 ...
 **設定錯誤輸出**  
 使用 [設定錯誤輸出](../error-handling-in-data.md) 對話方塊來指定如何處理資料列層級錯誤。  
  
## <a name="see-also"></a>另請參閱  
 [快速剖析](../parsing-data.md)   
