...
-   [將清理專案值匯入定義域中](../../../data-quality-services/import-cleansing-project-values-into-a-domain.md)  
 ...
 **加密連線**  
 指定是否要加密連線，以便加密 DQS 伺服器與 [!INCLUDE[ssISnoversion](../../../includes/ssisnoversion-md.md)] 之間的資料傳輸。  
