...
## 相關工作  
 您可以使用 [!INCLUDE[ssIS](../../../includes/ssis-md.md)] 設計師或物件模型來設定轉換。 如需使用 [!INCLUDE[ssIS](../../../includes/ssis-md.md)] 設計師來設定轉換的詳細資訊，請參閱[設定 OLE DB 命令轉換](../../../integration-services/data-flow/transformations/configure-the-ole-db-command-transformation.md)。 如需有關以程式設計方式來設定此轉換的詳細資訊，請參閱《開發人員指南》。  
