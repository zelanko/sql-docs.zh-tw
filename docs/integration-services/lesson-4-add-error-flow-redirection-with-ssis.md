...
-   [步驟 1：複製第 3 課的套件](../integration-services/step-1-copying-the-lesson-3-package.md)  
  
-   [步驟 2：建立損毀檔案](../integration-services/step-2-creating-a-corrupted-file.md)  
  
-   [步驟 3：加入錯誤流程重新導向](../integration-services/step-3-adding-error-flow-redirection.md)  
  
-   [步驟 4：加入一般檔案目的地](../integration-services/step-4-adding-a-flat-file-destination.md)  
  
-   [步驟 5：測試第 4 課的教學課程封裝](../integration-services/step-5-testing-the-lesson-4-tutorial-package.md)  
