...
ms.topic: "article"
helpviewer_keywords: 
  - "相容性 [Integration Services]"
  - "Data Transformation Services, 支援"
  - "SQL Server Integration Services, 回溯相容性"
  - "dtsrun 公用程式"
  - "Integration Services, 回溯相容性"
  - "回溯相容性 [Integration Services]"
...
## SQL Server 2016 Integration Services 已被取代的功能
...
## SQL Server 2016 中已停止的 Integration Services 功能
...
## SQL Server 2016 中對於 Integration Services 功能的突破性變更
...
## SQL Server 2016 中 Integration Services 功能的行為變更
