...
helpviewer_keywords: 
  ...
  - "執行屬性 [Integration Services]"
  - "封裝 [Integration Services]，屬性"
  - "識別屬性 [Integration Services]"
  - "密碼 [Integration Services]"
  - "SSIS 封裝，屬性"
  - "交易屬性 [Integration Services]"
  - "更新封裝屬性"
  - "強制執行的值屬性 [Integration Services]"
  - "安全性屬性 [Integration Services]"
  - "版本屬性 [Integration Services]"
...
-   [版本](#Version)  
 ...
 如需無法在 [屬性] 視窗中設定之其他封裝屬性的資訊，請參閱<xref:Microsoft.SqlServer.Dts.Runtime.Package>。  
  
### 在屬性視窗中設定封裝屬性  
  
-   [設定封裝的屬性](../Topic/Set%20the%20Properties%20of%20a%20Package.md)  
...
###  <a name="Security"></a> Security  
 此類別中的屬性是用來設定封裝的保護等級。 如需詳細資訊，請參閱 [Access Control for Sensitive Data in Packages](../integration-services/packages/access-control-for-sensitive-data-in-packages.md)。  
