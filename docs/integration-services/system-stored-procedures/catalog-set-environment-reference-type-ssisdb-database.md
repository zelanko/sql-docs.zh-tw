---
description: catalog.set_environment_reference_type (SSISDB 資料庫)
...
ms.locfileid: "88425070"
---
# <a name="catalogset_environment_reference_type-ssisdb-database"></a>catalog.set_environment_reference_type (SSISDB 資料庫)
