...
5.  在 [瀏覽資料夾] 對話方塊中，尋找電腦上包含 Currency_*.txt 檔案的資料夾。  
    ...
    3.  按一下超連結 "http://msftisprodsamples.codeplex.com/downloads/get/578097" SQL2012.Integration_Services.Create_Simple_ETL_Tutorial.Sample.zip 檔案。  
