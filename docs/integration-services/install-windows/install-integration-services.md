...
ms.topic: "article"
helpviewer_keywords: 
  - "Integration Services, 安裝"
  - "SSIS, 安裝"
  - "安裝 Integration Services, 關於安裝 Integration Services"
  - "SQL Server Integration Services, 安裝"
  - "安裝 [Integration Services], 關於安裝 Integration Services"
  - "安裝 Integration Services"
  - "安裝程式 [Integration Services]"
...
>     
>  如需如何授與權限的指示，請參閱[授與 Integration Services 服務的權限](../../integration-services/service/grant-permissions-to-integration-services-service.md)。    
