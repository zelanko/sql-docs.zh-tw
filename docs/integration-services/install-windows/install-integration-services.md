...
## <a name="installing-standalone-or-side-by-side"></a>獨立或並存安裝    
...
### <a name="installing-a-dedicated-server-for-etl"></a>安裝 ETL 的專用伺服器
...
## <a name="a-complete-installation-of-integration-services"></a>Integration Services 的完整安裝
