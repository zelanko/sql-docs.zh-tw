...
---
# 使用 SSIS 封裝升級精靈來升級 Integration Services 封裝
...
#### 從 SQL Server Management Studio 執行此精靈  
...
#### 在 SQL Server Management Studio 或命令提示字元中備份原始封裝  
