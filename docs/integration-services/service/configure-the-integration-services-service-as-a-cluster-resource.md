...
---
# 將 Integration Services 服務設定為叢集資源
...
-   將 [!INCLUDE[ssISnoversion](../../includes/ssisnoversion-md.md)] 服務連線成叢集資源。  
 ...
 在叢集或任何伺服器上設定 [!INCLUDE[ssISnoversion](../../includes/ssisnoversion-md.md)] 服務之後，您可能必須先設定 DCOM 權限，才能從用戶端電腦連接到該服務。 如需詳細資訊，請參閱[連接到遠端 Integration Services 伺服器 &#40;SSIS 服務&#41;](../../integration-services/service/connect-to-a-remote-integration-services-server-ssis-service.md)。  
