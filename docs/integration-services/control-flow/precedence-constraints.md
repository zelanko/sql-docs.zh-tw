...
helpviewer_keywords: 
  - "工作 [Integration Services], 優先順序條件約束"
  - "控制流程 [Integration Services], 優先順序條件約束"
  - "優先順序條件約束 [Integration Services]"
  - "條件約束 [Integration Services]"
  - "時序執行選項 [Integration Services]"
  - "容器 [Integration Services], 優先順序條件約束"
...
## 優先順序條件約束的組態  
 ...
 如需可在 [[!INCLUDE[ssIS](../../includes/ssis-md.md)] 設計師] 中設定之屬性的詳細資訊，請參閱[優先順序條件約束編輯器](../Topic/Precedence%20Constraint%20Editor.md)。  
...
-   [設定優先順序條件約束的屬性](../Topic/Set%20the%20Properties%20of%20a%20Precedence%20Constraint.md)  
  
-   [使用快速鍵功能表來設定優先順序條件約束的值](../Topic/Set%20the%20Value%20of%20a%20Precedence%20Constraint%20by%20Using%20the%20Shortcut%20Menu.md)  
...
## 請參閱＜  
 [將運算式加入優先順序條件約束](../Topic/Add%20Expressions%20to%20Precedence%20Constraints.md)   
 [多個優先順序條件約束](../Topic/Multiple%20Precedence%20Constraints.md)  
