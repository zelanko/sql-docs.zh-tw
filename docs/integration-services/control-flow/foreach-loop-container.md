---
title: "「 Foreach 迴圈 」 容器 |Microsoft 文件"
ms.custom:
- SQL2016_New_Updated
ms.date: 08/22/2017
...
-   列舉 ADLS 目錄中的檔案的 ADLS Foreach 檔案列舉值。
 ...
 ![列舉資料夾的 Foreach 迴圈 」 容器](../../integration-services/control-flow/media/ssis-foreachloop.gif "列舉資料夾的 Foreach 迴圈容器")  
...
### <a name="add-and-configure-a-foreach-loop-container"></a>加入和設定 Foreach 迴圈容器
...
## <a name="general-page---foreach-loop-editor"></a>[一般] 頁面-Foreach 迴圈編輯器
 ...
 **ADO 物件來源變數**  
 在清單中，選取的使用者自訂變數，或按一下\<**新增變數...**> 若要建立新的變數。  
 ...
 **連接**  
 在清單中，選取 ADO.NET 連接管理員，或按一下\<**新增連接...**> 以建立新的 ADO.NET 連接管理員。  
 ...
 **DocumentSource**  
 ...
 如果**DocumentSourceType**設**檔案連接**，選取檔案連接管理員，或按一下\<**新增連接...**> 以建立新的連接管理員。  
 ...
 **相關主題：** [File Connection Manager](../../integration-services/connection-manager/file-connection-manager.md)、 [File Connection Manager Editor](../../integration-services/connection-manager/file-connection-manager-editor.md)  
 ...
 如果**DocumentSourceType**設**變數**，選取現有的變數，或按一下\<**新增變數...**> 若要建立新的變數。  
...
|Value|Description|  
|-----------|-----------------|  
|**導覽器**|使用 XPathNavigator 列舉。|  
|**節點**|列舉 XPath 作業傳回的節點。|  
|**節點文字**|列舉 XPath 作業傳回的文字節點。|  
 ...
 **OuterXPathString**  
 ...
 如果**OuterXPathStringSourceType**設**檔案連接**，選取檔案連接管理員，或按一下\<**新增連接...**> 以建立新的連接管理員。  
  
 **相關主題：** [File Connection Manager](../../integration-services/connection-manager/file-connection-manager.md)、 [File Connection Manager Editor](../../integration-services/connection-manager/file-connection-manager-editor.md)  
  
 如果**OuterXPathStringSourceType**設**變數**，選取現有的變數，或按一下\<**新增變數...**> 若要建立新的變數。  
 ...
 **InnerXPathString**  
 ...
 如果**InnerXPathStringSourceType**設**檔案連接**，選取檔案連接管理員，或按一下\<**新增連接...**> 以建立新的連接管理員。  
  
 **相關主題：** [File Connection Manager](../../integration-services/connection-manager/file-connection-manager.md)、 [File Connection Manager Editor](../../integration-services/connection-manager/file-connection-manager-editor.md)  
  
 如果**InnerXPathStringSourceType**設**變數**，選取現有的變數，或按一下\<**新增變數...**> 若要建立新的變數。  
...
## <a name="use-property-expressions-with-foreach-loop-containers"></a>使用 「 Foreach 迴圈 」 容器使用屬性運算式  
