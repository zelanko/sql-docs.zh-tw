...
-   [Analysis Services 處理工作編輯器 &#40;Analysis Services 頁面&#41;](../../integration-services/control-flow/analysis-services-processing-task-editor-analysis-services-page.md)  
...
## 以程式設計方式設定 Analysis Services 處理工作  
