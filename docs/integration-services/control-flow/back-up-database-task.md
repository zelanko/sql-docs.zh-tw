...
helpviewer_keywords: 
  - "資料庫備份 [Integration Services]"
  - "備份資料庫工作 [Integration Services]"
  - "備份資料庫 [Integration Services]"
  - "交易記錄備份 [Integration Services]"
  - "備份交易記錄 [Integration Services]"
...
-   [備份資料庫工作 &#40;維護計畫&#41;](../../relational-databases/maintenance-plans/back-up-database-task-maintenance-plan.md)  
