...
helpviewer_keywords: 
  - "Transact-SQL 陳述式, SSIS"
  - "陳述式 [Integration Services]"
  - "批次 [Integration Services]"
  - "執行 SQL 工作 [Integration Services]"
...
## 建立 SQL 陳述式  
 ...
 在 [!INCLUDE[ssIS](../../includes/ssis-md.md)] 設計師中，您可以使用 [執行 SQL 工作編輯器] 對話方塊輸入 SQL 陳述式，或使用圖形化使用者介面 [查詢產生器] 建立 SQL 查詢。 如需詳細資訊，請參閱[執行 SQL 工作編輯器 &#40;一般頁面&#41;](../Topic/Execute%20SQL%20Task%20Editor%20\(General%20Page\).md) 和[查詢產生器](../Topic/Query%20Builder.md)。  
...
>  只有在資料提供者支援參數時，您才能在執行 SQL 工作中使用參數。  
 ...
 如需在「執行 SQL」工作中使用參數和傳回碼的資訊，請參閱[執行 SQL 工作中的參數和傳回碼](../Topic/Parameters%20and%20Return%20Codes%20in%20the%20Execute%20SQL%20Task.md)。  
...
## 指定結果集類型  
 ...
 如需在「執行 SQL」工作中從 SQL 命令擷取結果集的資訊，請參閱[執行 SQL 工作中的結果集](../Topic/Result%20Sets%20in%20the%20Execute%20SQL%20Task.md)。  
...
### 自訂記錄項目  
 下表描述「執行 SQL」工作的自訂記錄項目。 如需詳細資訊，請參閱 [Integration Services &#40;SSIS&#41; 記錄](../../integration-services/performance/integration-services-ssis-logging.md)和[自訂訊息以進行記錄](../../integration-services/performance/custom-messages-for-logging.md)。  
...
-   [執行 SQL 工作編輯器 &#40;一般頁面&#41;](../Topic/Execute%20SQL%20Task%20Editor%20\(General%20Page\).md)  
  
-   [執行 SQL 工作編輯器 &#40;參數對應頁面&#41;](../Topic/Execute%20SQL%20Task%20Editor%20\(Parameter%20Mapping%20Page\).md)  
  
-   [執行 SQL 工作編輯器 &#40;結果集頁面&#41;](../Topic/Execute%20SQL%20Task%20Editor%20\(Result%20Set%20Page\).md)  
...
-   [在執行 SQL 工作中將結果集對應至變數](../Topic/Map%20Result%20Sets%20to%20Variables%20in%20an%20Execute%20SQL%20Task.md)  
  
## 相關內容  
  
-   [執行 SQL 工作中的參數和傳回碼](../Topic/Parameters%20and%20Return%20Codes%20in%20the%20Execute%20SQL%20Task.md)  
  
-   [執行 SQL 工作中的結果集](../Topic/Result%20Sets%20in%20the%20Execute%20SQL%20Task.md)  
