...
**Azure SQL DW 上傳工作**是適用於 SQL Server 2016 的 SQL Server Integration Services (SSIS) Feature Pack for Azure 元件。 請在 [這裡](http://go.microsoft.com/fwlink/?LinkID=626967)。
...
ColumnDelimiter|指定一或多個標示各資料行結尾的字元。 例如 &#124; 為直立線符號，\t 為定位字元，&#124;\t 則表示直立線-定位字元的順序。
