---
title: "Azure HDInsight Hive 工作 |Microsoft 文件"
ms.custom: 
ms.date: 02/28/2017
...
**Azure HDInsight Hive 工作**是一種元件的[Azure 的 SQL Server Integration Services (SSIS) Feature Pack](../../integration-services/azure-feature-pack-for-integration-services-ssis.md)。
