...
-   [步驟 1：建立工作資料夾和環境變數](../integration-services/step-1-creating-working-folders-and-environment-variables.md)  
  
-   [步驟 2：建立部署專案](../integration-services/step-2-creating-the-deployment-project.md)  
  
-   [步驟 3：加入封裝和其他檔案](../integration-services/step-3-adding-packages-and-other-files.md)  
  
-   [步驟 4：加入封裝組態](../integration-services/step-4-adding-package-configurations.md)  
