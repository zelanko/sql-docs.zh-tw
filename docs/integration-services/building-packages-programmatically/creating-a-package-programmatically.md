...
-   blogs.msdn.com 上的部落格文章：[API Sample - OleDB source and OleDB destination](https://techcommunity.microsoft.com/t5/sql-server-integration-services/api-sample-oledb-source-and-oledb-destination/ba-p/387553) (API 範例 - OleDB 來源與 OleDB 目的地)。  
