---
title: "第 5 課： 加入封裝部署模型的 SSIS 封裝組態 |Microsoft 文件"
ms.custom: 
ms.date: 03/14/2017
...
封裝組態可讓您從開發環境之外設定執行階段屬性和變數。 組態可讓您開發彈性且易於部署和散發的封裝。 [!INCLUDE[msCoName](../includes/msconame-md.md)][!INCLUDE[ssISnoversion](../includes/ssisnoversion-md.md)]提供下列組態類型：  
...
-   [步驟 1： 複製第 4 課封裝](../integration-services/lesson-5-1-copying-the-lesson-4-package.md)  
