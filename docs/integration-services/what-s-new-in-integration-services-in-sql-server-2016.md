...
####  <a name="ssisdbupgrwiz"></a> SSISDB 升級精靈  
...
####  <a name="LogReader"></a> SSIS 目錄中新的 ssis_logreader 資料庫層級角色  
...
####  <a name="RuntimeLineage"></a> SSIS 目錄中新的 RuntimeLineage 記錄層級  
...
####  <a name="getidstring"></a> 已擴大錯誤資料行名稱的支援  
...
####  <a name="ProjectUpgrade"></a> 已改進專案升級的體驗  
...
####  <a name="ODatav4"></a> 支援 OData v4 資料來源  
...
####  <a name="more_hadoop"></a> 已擴大 Hadoop 和 HDFS 的支援  
...
####  <a name="hdfsORC"></a> HDFS 檔案目的地現在支援 ORC 檔案格式  
...
####  <a name="odbc2016"></a> 已針對 SQL Server 2016 更新 ODBC 元件  
 ODBC 來源和目的地元件已更新，可與 SQL Server 2016 完全相容。 沒有任何新功能，也沒有任何行為變更。  

####  <a name="Excel2016"></a> 明確支援 Excel 2016 資料來源  
...
### <a name="pdwau5"></a> 已發行 Connectors for Analytics Platform System (PDW) Appliance Update 5
...
#### <a name="datalakestore"></a> 已推出 Azure Data Lake Store 的支援
...
#### <a name="sqldwupload"></a> 已推出 Azure SQL 資料倉儲的支援
...
####  <a name="ComplexFeedinbox"></a> 資料摘要發行元件現在是 SSIS 的一部分  
...
####  <a name="AzureBlob"></a> 支援 SQL Server 匯入和匯出精靈中的 Azure Blob 儲存體  
...
####  <a name="ASDDL"></a> Analysis Services 執行 DDL 工作已更新  
 Analysis Services 執行 DDL 工作已更新，可接受表格式模型指令碼語言命令。

####  <a name="ssasrc0"></a> Analysis Services 工作支援表格式模型  
