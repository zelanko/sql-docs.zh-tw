...
# 使用封裝中的註解
 ...
 如需對封裝檔案格式所做變更的詳細資訊，請參閱 [SSIS 封裝格式](../Topic/SSIS%20Package%20Format.md)。  
  
 當您儲存封裝時，「 [!INCLUDE[ssIS](../includes/ssis-md.md)] 設計師」會在封裝中儲存註解。  
  
### 將註解加入封裝  
  
-   [將註解加入封裝](../Topic/Add%20an%20Annotation%20to%20a%20Package.md)  
