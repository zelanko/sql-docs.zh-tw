...
[!INCLUDE[ssas](../includes/applies-to-version/ssas.md)]
 ...
 如需支援之內容類型的完整說明 [!INCLUDE[ssASnoversion](../includes/ssasnoversion-md.md)] ，請參閱 [&#40;資料採礦&#41;的內容類型 ](https://docs.microsoft.com/analysis-services/data-mining/content-types-data-mining)。  
