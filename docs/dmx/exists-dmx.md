...
## <a name="examples"></a>範例  
 ...
 下列範例是 `[Association]` 以您在「 [基本資料採礦」教學](https://msdn.microsoft.com/library/6602edb6-d160-43fb-83c8-9df5dddfeb9c)課程中建立的「挖掘」結構和「採礦模型」為基礎。 此查詢只會傳回客戶至少購買一個修補套件的案例。  
