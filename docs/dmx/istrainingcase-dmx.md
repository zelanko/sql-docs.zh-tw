...
> [!NOTE]  
>  如果您想要使用 IsTrainingCase 或 IsTestCase 函數來傳回有關模型中案例的詳細資料，則必須在模型上啟用「鑽取」。 如需詳細資訊，請參閱 [針對採礦模型啟用鑽研](https://docs.microsoft.com/analysis-services/data-mining/enable-drillthrough-for-a-mining-model)。  
