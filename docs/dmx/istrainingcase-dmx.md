...
>  如果您想要使用 IsTrainingCase 或 IsTestCase 函數來傳回模型中案例的詳細資料, 則必須在模型上啟用鑽取。 如需詳細資訊，請參閱 [針對採礦模型啟用鑽研](https://docs.microsoft.com/analysis-services/data-mining/enable-drillthrough-for-a-mining-model)。  
 ...
 若要傳回屬於測試資料集一部分的案例, 請使用函數[IsTestCase &#40;DMX&#41;](../dmx/istestcase-dmx.md)。  
...
```  
 ...
 如需如何查詢資料採礦中使用之案例的其他範例, 請參閱[ &#60;從&#62;模型選取。案例&#40;DMX&#41; ](../dmx/select-from-model-cases-dmx.md) , 並[從&#60;結構&#62;中選取。案例](../dmx/select-from-structure-cases.md)。  
