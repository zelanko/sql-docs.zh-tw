---
description: 模型旗標 (DMX)
title: " (DMX) 的模型旗標 |Microsoft Docs"
ms.date: 06/07/2018
ms.prod: sql
 ...
 **MODEL_EXISTENCE_ONLY**  
 ...
 協力廠商演算法可能支援其他的模型旗標。 若要判斷演算法支援哪些模型旗標，請使用 **SUPPORTED_MODELING_FLAGS** 架構資料列集。 您也可以查詢伺服器上的採礦服務，以判斷特定演算法支援的模型旗標。 例如，下列查詢會在目前的伺服器上，傳回 Microsoft 線性迴歸演算法支援的模型旗標：  
...
## <a name="specifying-modeling-flags-on-a-mining-model"></a>在採礦模型上指定模型旗標  
 如需支援在 [採礦結構] 資料行上指定旗標之語法的範例 [!INCLUDE[ssASnoversion](../includes/ssasnoversion-md.md)] ，請參閱 [建立 &#40;DMX&#41;的採礦結構 ](../dmx/create-mining-structure-dmx.md)。  
