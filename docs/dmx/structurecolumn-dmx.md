...
## <a name="remarks"></a>備註  
 ...
 如需如何在 DMX SELECT 語句中使用此函數的詳細資訊，請參閱[SELECT FROM &#60;model&#62;。&#40;DMX&#41;](../dmx/select-from-model-cases-dmx.md)或[從 &#60;結構&#62; 中選取的案例。案例](../dmx/select-from-structure-cases.md)。  
  
## <a name="error-messages"></a>錯誤訊息  
 如果使用者沒有父採礦結構的鑽研權限，就會引發下列安全性錯誤：  
  
 '% {User/} ' 使用者沒有許可權可以深入探索 '% {model/} ' 採礦模型的父代採礦結構。  
