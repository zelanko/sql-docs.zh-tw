---
title: 檢查更新檔對話方塊
description: 了解如何在電腦上安裝最新的 SQL Server Data Tools (SSDT) 版本。 熟悉 [檢查更新] 對話方塊。
ms.prod: sql
ms.technology: ssdt
ms.topic: conceptual
...
此外，[檢查更新] 對話方塊還有一個 [自動檢查 SQL Server Data Tools 的更新] 的核取方塊。 當選取時，SQL Server Data Tools 會在 Visual Studio 啟動時顯示可用更新的描述。 您可以選擇安裝這些更新。  
