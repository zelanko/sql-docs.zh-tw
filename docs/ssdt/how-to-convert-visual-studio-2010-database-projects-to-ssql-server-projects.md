---
title: 將 Visual Studio 2010 資料庫專案轉換成 SQL Server 資料庫專案
description: 將 Visual Studio 2010 資料庫專案轉換成 SQL Server 專案，並將目標重定為不同的平台。 檢視 SSDT 可以和無法轉換的物件。
ms.prod: sql
ms.technology: ssdt
ms.topic: conceptual
f1_keywords:
