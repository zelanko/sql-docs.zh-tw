...
ms.locfileid: "51661757"
---
# <a name="install-sql-server-data-tools"></a>安裝 SQL Server Data Tools
本主題將說明如何安裝 SQL Server Data Tools。 如需 SQL Server Data Tools 的更新，請前往 SQL Server Data Tools 下載頁面 ([安裝最新版的 SQL Server Data Tools](https://go.microsoft.com/fwlink/?LinkID=616714))。  
...
若要下載 SSDTSetup.exe，請前往 [安裝 SQL Server Data Tools](https://go.microsoft.com/fwlink/?LinkID=616714)，再按一下您的 Visual Studio 版本適用的連結，然後下載您的語言適用的 SSDTSetup.exe。  
