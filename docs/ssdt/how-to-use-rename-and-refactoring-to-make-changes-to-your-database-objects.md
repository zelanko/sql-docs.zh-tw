---
title: 如何：使用重命名和重構，變更資料庫物件 | Microsoft Docs
ms.custom:
- SSDT
ms.date: 02/09/2017
ms.prod: sql
...
ms.locfileid: "37093910"
---
# <a name="how-to-use-rename-and-refactoring-to-make-changes-to-your-database-objects"></a>如何：使用重命名和重構，變更資料庫物件
