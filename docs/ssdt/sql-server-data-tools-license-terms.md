...
&nbsp;&nbsp;**b.  其他 Microsoft 程式。** 軟體包含其他 Microsoft SQL Server 技術、Microsoft Visual Studio 2015 Shell (隔離式) 可轉散發套件、Microsoft Visual Studio 2015 Shell (整合式) 可轉散發套件、Microsoft Visual Studio Tools for Applications 2015、.NET Framework、Visual C++ Redistributable for Visual Studio 2015 及 Microsoft Report Viewer 2016 Runtime 搭配此處授權之軟體。 這些元件都受到個別合約及其特有的產品支援原則所規範，如同該元件安裝目錄或軟體隨附之 [授權] 資料夾中的授權條款所述。  
