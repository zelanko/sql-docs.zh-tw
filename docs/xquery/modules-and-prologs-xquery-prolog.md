...
description: 瞭解 XQuery 初構，其中包含一系列的宣告和定義，這些宣告會建立查詢處理所需的環境。
ms.custom: ''
ms.date: 08/09/2016
ms.prod: sql
ms.prod_service: sql
...
[!INCLUDE[tsql-appliesto-ss2008-xxxx-xxxx-xxx-md](../includes/tsql-appliesto-ss2008-xxxx-xxxx-xxx-md.md)]
 ...
 例如，下列 XQuery 是針對將製造指示儲存為 XML 的**xml**類型的 [指示] 資料行所指定。 該查詢會擷取工作中心位置 `10` 的製造指示。 `query()` **Xml**資料類型的方法是用來指定 XQuery。  
