---
title: 排序與未排序的運算式（XQuery） |Microsoft Docs
ms.custom: ''
ms.date: 03/14/2017
ms.prod: sql
ms.prod_service: sql
...
[!INCLUDE[tsql-appliesto-ss2012-xxxx-xxxx-xxx-md](../includes/tsql-appliesto-ss2012-xxxx-xxxx-xxx-md.md)]
  ...
  根據預設，中[!INCLUDE[ssNoVersion](../includes/ssnoversion-md.md)]所有作業的排序模式都會進行**排序**。 因此，路徑運算式和 FLWOR 運算式所傳回的節點序列（不含**order by**子句）都是以檔順序排列。  
  
 不支援 XQuery 規格中所述的其他已**排序**和未**排序**語法。  
