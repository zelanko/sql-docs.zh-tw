---
title: 已更新-SQL Server 文件的 XQuery |Microsoft 文件
description: 顯示更新的內容，如需 Microsoft SQL server XQuery 中最近變更過的文件的程式碼片段。
manager: craigg
author: MightyPen
ms.author: genemi
ms.topic: article
...
ms.locfileid: "32739300"
---
# <a name="new-and-recently-updated-xquery-for-sql-server"></a>新增和更新最近： SQL Server 的 XQuery
