...
|**9349**|停用前 N 個排序運算子的批次模式。 [!INCLUDE[ssSQL15](../../includes/sssql15-md.md)] 導入前幾個排序運算子的新批次模式，將提升許多分析查詢的效能。<br /><br />**範圍**：全域或工作階段或查詢|
