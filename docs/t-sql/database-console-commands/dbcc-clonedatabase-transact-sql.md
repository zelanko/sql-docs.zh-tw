...
[How to generate a script of the necessary database metadata to create a statistics-only database in SQL Server](http://support.microsoft.com/help/914288) (如何產生必要資料庫中繼資料的指令碼，以在 SQL Server 中建立僅限統計資料的資料庫)   
