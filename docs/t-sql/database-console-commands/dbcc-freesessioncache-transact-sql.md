---
title: "DBCC FREESESSIONCACHE (TRANSACT-SQL) |Microsoft 文件"
ms.custom: 
ms.date: 07/16/2017
...
使用分散式查詢的執行個體的分散式的查詢連接快取排清[!INCLUDE[msCoName](../../includes/msconame-md.md)] [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)]。
