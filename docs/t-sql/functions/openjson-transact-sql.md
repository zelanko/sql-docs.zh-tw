...
### <a name="example-6---simple-example-with-json-content"></a>範例 6 - 使用 JSON 內容的簡單範例
...
- [搭配使用 OPENJSON 與預設結構描述 &#40;SQL Server&#41;](../../relational-databases/json/use-openjson-with-the-default-schema-sql-server.md)   
