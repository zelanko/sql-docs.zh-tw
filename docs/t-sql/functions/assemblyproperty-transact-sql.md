...
下列範例假設 `HelloWorld` 組件是已在 [!INCLUDE[ssSampleDBobject](../../includes/sssampledbobject-md.md)] 資料庫中註冊的組件。 如需詳細資訊，請參閱 [Hello World 範例](https://msdn.microsoft.com/library/fed6c358-f5ee-4d4c-9ad6-089778383ba7)。
