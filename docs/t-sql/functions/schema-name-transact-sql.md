...
### <a name="c-returning-the-name-of-the-default-schema-of-the-caller"></a>C. 傳回呼叫端預設結構描述的名稱  
  
```  
SELECT SCHEMA_NAME();  
```  
  
### <a name="d-returning-the-name-of-a-schema-by-using-an-id"></a>D. 使用識別碼來傳回結構描述的名稱  
