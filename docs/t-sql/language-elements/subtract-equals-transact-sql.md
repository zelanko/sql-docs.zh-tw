---
title: "-= （減 EQUALS） (TRANSACT-SQL) |Microsoft 文件"
ms.custom: 
ms.date: 03/06/2017
...
---
# <a name="--subtract-equals-transact-sql"></a>-= (減 EQUALS) (Transact-SQL)
...
## <a name="remarks"></a>備註  
 如需詳細資訊，請參閱[-&#40;減去 &#41;&#40;TRANSACT-SQL &#41;](../../t-sql/language-elements/subtract-transact-sql.md).  
