---
description: STPolyFromWKB (geometry 資料類型)
title: STPolyFromWKB (geometry 資料類型) | Microsoft Docs
ms.custom: ''
ms.date: 08/03/2017
ms.prod: sql
 ...
 *WKB_polygon*  
 這是要傳回之 **geometryPolygon** 執行個體的 WKB 表示法。 *WKB_polygon* 是 **varbinary(max)** 運算式。  
