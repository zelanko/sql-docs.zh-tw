...
在 SQL Database 中，必須連線至 master 資料庫以適當的權限建立登入。 如需詳細資訊，請參閱[建立其他登入和具有系統管理權限的使用者](/azure/sql-database/sql-database-manage-logins#create-additional-logins-and-users-having-administrative-permissions) (機器翻譯)。
