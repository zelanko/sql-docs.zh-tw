...
請移至案例：  
-   [資料行存放區索引進行即時作業分析](https://msdn.microsoft.com/library/dn817827.aspx)  
-   [資料倉儲的資料行存放區索引](https://msdn.microsoft.com/library/dn913734.aspx)  
  
深入了解：  
-   [資料行存放區索引指南](https://msdn.microsoft.com/library/gg492088.aspx)  
-   [資料行存放區索引功能摘要](https://msdn.microsoft.com/library/dn934994.aspx)  
