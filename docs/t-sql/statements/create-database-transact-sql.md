...
如果 AUTOGROW 設為 ON，會允許記錄檔成長至超過此限制。 使用 [DBCC SHRINKLOG (Azure Synapse Analytics)](../../t-sql/database-console-commands/dbcc-shrinklog-azure-sql-data-warehouse.md) 陳述式，將記錄檔大小縮小至其原始大小。
