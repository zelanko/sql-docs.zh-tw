---
description: DENY 資料庫權限 (Transact-SQL)
...
|ALTER ANY SECURITY POLICY<br /> **適用於**：[!INCLUDE[ssSQL15](../../includes/sssql15-md.md)] 及更新版本、[!INCLUDE[ssSDSfull](../../includes/sssdsfull-md.md)]。|CONTROL|CONTROL SERVER|
