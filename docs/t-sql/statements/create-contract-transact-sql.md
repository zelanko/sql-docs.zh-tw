...
## <a name="remarks"></a>Remarks  
 ...
 無論合約為何，服務一律可以接收 `http://schemas.microsoft.com/SQL/ServiceBroker/DialogTimer`、`http://schemas.microsoft.com/SQL/ServiceBroker/Error` 和 `http://schemas.microsoft.com/SQL/ServiceBroker/EndDialog` 訊息類型。 [!INCLUDE[ssSB](../../includes/sssb-md.md)] 會針對應用程式使用系統訊息的這些訊息類型。  
