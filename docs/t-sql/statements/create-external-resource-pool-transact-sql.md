...
[!INCLUDE[tsql-appliesto-ss2016-xxxx-xxxx-xxx_md](../../includes/tsql-appliesto-ss2016-xxxx-xxxx-xxx-md.md)]
  ...
  建立外部集區，用來定義外部處理序的資源。 針對 R 服務外部集區管理`rterm.exe`， `BxlServer.exe`，及其所衍生的其他處理序。 資源集區代表的 Database Engine 執行個體的實體資源 （記憶體和 Cpu） 的子集。 資源管理員可讓資料庫管理員在資源集區間散發伺服器資源，最多可達 64 個集區。  
