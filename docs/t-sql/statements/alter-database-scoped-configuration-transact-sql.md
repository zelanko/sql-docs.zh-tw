...
- 在 SQL Server 和 Azure SQL Server Database 受控執行個體中，此選項會在 TEMPDB 中設定，並且個別使用者資料庫的設定不會有任何效果。
...
**適用對象**：[!INCLUDE[ssSDSFull](../../includes/sssdsfull-md.md)] 且作為公開預覽功能
