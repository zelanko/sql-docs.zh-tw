---
title: "DROP SERVER AUDIT (TRANSACT-SQL) |Microsoft 文件"
ms.custom: 
ms.date: 03/06/2017
...
[!INCLUDE[tsql-appliesto-ss2008-xxxx-xxxx-xxx_md](../../includes/tsql-appliesto-ss2008-xxxx-xxxx-xxx-md.md)]
  ...
  使用 SQL Server Audit 功能卸除伺服器稽核物件。 如需有關 SQL Server Audit 的詳細資訊，請參閱[SQL Server Audit &#40; Database engine&#41;](../../relational-databases/security/auditing/sql-server-audit-database-engine.md)。  
...
## <a name="remarks"></a>備註  
 ...
 DROP SERVER AUDIT 不會卸除關聯的伺服器或資料庫稽核規格。 這些規格必須手動卸除或維持遺棄的狀態，之後會對應到新的伺服器稽核。  
  
## <a name="permissions"></a>Permissions  
 若要建立、更改或卸除伺服器稽核，主體需要使用 ALTER ANY SERVER AUDIT 或 CONTROL SERVER 權限。  
  
## <a name="examples"></a>範例  
 下列範例會卸除稱為 `HIPAA_Audit` 的稽核。  
