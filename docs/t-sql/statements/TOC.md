...
## [DATABASE (Azure SQL 資料倉儲)](alter-database-azure-sql-data-warehouse.md)  
## [DATABASE (平行處理資料倉儲)](alter-database-parallel-data-warehouse.md)  
...
## [DATABASE SET 選項](alter-database-transact-sql-set-options.md)  
...
## [DATABASE (Azure SQL 資料倉儲)](create-database-azure-sql-data-warehouse.md)  
## [DATABASE (平行處理資料倉儲)](create-database-parallel-data-warehouse.md)  
...
## [敏感度分類](drop-sensitivity-classification-transact-sql.md)
...
## [權限：GRANT、DENY、REVOKE (Azure SQL 資料倉儲、平行處理資料倉儲)](permissions-grant-deny-revoke-azure-sql-data-warehouse-parallel-data-warehouse.md)  
...
## [REVOKE XML 結構描述集合權限](revoke-xml-schema-collection-permissions-transact-sql.md)  
