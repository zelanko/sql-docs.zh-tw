...
下列範例會建立可以用來建立資料庫範圍認證[外部資料來源](../../t-sql/statements/create-external-data-source-transact-sql.md)，可以執行大量作業，例如[BULK INSERT](../../t-sql/statements/bulk-insert-transact-sql.md)和[OPENROWSET](../../t-sql/functions/openrowset-transact-sql.md).   
```tsql
