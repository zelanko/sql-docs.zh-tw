...
> |||||
> |---|---|---|---|
> |**\* _SQL Server \*_** &nbsp;|[SQL Database<br />單一資料庫/彈性集區](pick-a-product-template.md?view=azuresqldb-current)|[SQL Database<br />受控執行個體](pick-a-product-template.md?view=azuresqldb-mi-current)|[SQL 資料<br />倉儲](pick-a-product-template.md?view=azure-sqldw-latest)|||
