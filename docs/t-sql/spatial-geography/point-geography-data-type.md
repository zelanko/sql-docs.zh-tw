---
description: Point (geography 資料類型)
 ...
 *SRID*  
 這是 **int** 運算式，代表要傳回之**地理**執行個體的[空間參考識別碼](../../relational-databases/spatial/spatial-reference-identifiers-srids.md)。  
