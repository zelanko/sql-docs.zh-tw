---
description: STMPointFromWKB (geography 資料類型)
title: STMPointFromWKB (geography 資料類型) | Microsoft Docs
ms.custom: ''
ms.date: 07/30/2017
ms.prod: sql
