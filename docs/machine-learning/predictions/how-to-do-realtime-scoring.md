...
| [原生評分 C++ 擴充功能](native-scoring-predict-transact-sql.md) | 序列化模型上的 [PREDICT T-SQL 函式](https://docs.microsoft.com/sql/t-sql/queries/predict-transact-sql) | R：RevoScaleR <br/>Python：revoscalepy | 平均小於 20 毫秒。 | 
...
[**原生評分**](native-scoring-predict-transact-sql.md)是一個 SQL Server 2017 功能，會實作為原生 C++ 程式庫，但僅適用於 RevoScaleR 和 revoscalepy 模型。 這是最快速且更安全的方法，但支援與其他方法相關的較小型功能集。
