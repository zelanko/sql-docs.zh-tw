...
description: 了解 RxInSqlServer 函式，此函式可讓您定義遠端 SQL Server 的計算內容。
ms.prod: sql
...
> [計算本機和遠端計算內容中的摘要統計資料](../../machine-learning/tutorials/deepdive-create-and-run-r-scripts.md)