---
title: 安裝與升級常見問題
description: SQL Server 中安裝或升級機器學習功能的一些常見問題解答。
ms.prod: sql
...
ms.locfileid: "86300214"
---
# <a name="installation-and-upgrade-faq-for-sql-server-machine-learning-or-r-server"></a>SQL Server 機器學習或 R Server 的安裝與升級常見問題
 [!INCLUDE [SQL Server](../../includes/applies-to-version/sqlserver.md)]

本文提供 SQL Server 中安裝機器學習功能的一些常見問題解答。 文中也會說明升級的相關常見問題。
