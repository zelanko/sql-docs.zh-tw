...
若要完成本快速入門，您需要 [!INCLUDE[name-sos](../includes/name-sos-short.md)] 和 SQL Server 的存取權。
...
2. 第一次執行 [!INCLUDE[name-sos](../includes/name-sos-short.md)] 時，應該會開啟 [歡迎使用]  頁面。 如果您沒有看到 [歡迎使用]  頁面，請選取 [說明]   > [歡迎使用]  。 選取 [新增連線]  ，開啟 [連線]  窗格：
