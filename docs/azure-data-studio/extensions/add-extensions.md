...
2. 選取可用的延伸模組，檢視詳細資料。
    ...
    ![延伸模組詳細資料](media/add-extensions/extension-details.png)
...
若要解除安裝延伸模組，請按一下延伸模組項目右邊的齒輪圖示，然後從下拉式功能表中選擇 [解除安裝]。 此動作會解除安裝選取的延伸模組，並提示重新載入 Azure Data Studio。
 ...
 ![延伸模組下拉式清單](media/add-extensions/extension-gear-dropdown.png)
...
![延伸模組正在啟用](media/add-extensions/extensions-enable.png)
...
![延伸模組排序](media/add-extensions/extension-sort.png)
