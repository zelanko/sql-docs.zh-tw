...
|編輯器選項對話方塊的 F1 說明頁面之位置。|[查詢選項頁面 F1 說明](https://docs.microsoft.com/sql/ssms/f1-help/f1-help-for-server-connections-sql-server-management-studio)|