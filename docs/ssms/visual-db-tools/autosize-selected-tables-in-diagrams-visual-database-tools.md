...
[!INCLUDE[appliesto-ss-asdb-asdw-pdw-md](../../includes/appliesto-ss-asdb-asdw-pdw-md.md)] 您可以將圖表中的資料表快速調整成可以顯示所有欄位的最小尺寸。  
  
### <a name="to-automatically-size-selected-tables-in-diagrams"></a>若要自動調整圖表中選取資料表的大小  
