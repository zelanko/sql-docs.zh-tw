...
[!INCLUDE[appliesto-ss-asdb-asdw-pdw-md](../../includes/appliesto-ss-asdb-asdw-pdw-md.md)] 您可以在 [屬性] 視窗中顯示資料庫圖表的屬性。  
  
### <a name="to-show-database-diagram-properties-in-the-properties-window"></a>若要在屬性視窗中顯示資料庫圖表屬性  
