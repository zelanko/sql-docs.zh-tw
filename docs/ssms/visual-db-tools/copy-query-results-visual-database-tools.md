...
[!INCLUDE[appliesto-ss-asdb-asdw-pdw-md](../../includes/appliesto-ss-asdb-asdw-pdw-md.md)] 您可以從 [結果] 窗格，將結果集複製成定位字元分隔的文字。 您可以複製整個結果集或任何數目的連續或非連續的資料列或資料格。  
...
3.  若要選取資料列：  
    ...
    -   先選取一列，再拖曳滑鼠以選取其他資料列，即可選取多個連續的資料列。  
  
    -   先選取一列，再按住 CTRL 鍵，同時按一下其他資料列，即可選取非連續的資料列。  
...
4.  若要選取資料格：  
    ...
    -   拖曳滑鼠到相鄰資料格，即可選取多個資料格。  
  
    -   先選取單一資料格，再按住 CTRL 鍵，同時按一下其他資料格，即可選取非連續的資料格。  
