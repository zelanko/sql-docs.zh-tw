---
description: 圖表窗格 (Visual Database Tools)
title: 圖表窗格
...
|:::image type="icon" source="../../ssms/visual-db-tools/media/dv3wbi2.gif":::|查詢或檢視|  
|:::image type="icon" source="../../ssms/visual-db-tools/media/dv3wbi3.gif":::|連結的資料表|  
|:::image type="icon" source="../../ssms/visual-db-tools/media/dvudficon.gif":::|使用者定義函數|  
|:::image type="icon" source="../../ssms/visual-db-tools/media/dv3wbi5.gif":::|連結的檢視|  
...
|核取方塊或符號|描述|  
|-----------------------|---------------|  
|:::image type="icon" source="../../ssms/visual-db-tools/media/dv3wbi7.gif":::<br /><br />:::image type="icon" source="../../ssms/visual-db-tools/media/dv3wbi8.gif":::<br /><br />:::image type="icon" source="../../ssms/visual-db-tools/media/dv3wbi9.gif":::<br /><br />:::image type="icon" source="../../ssms/visual-db-tools/media/dv3wbia.gif":::|指定查詢結果集 (選取查詢) 中是否使用資料欄，或者是否在 UPDATE、INSERT FROM、製成資料表 (Make Table) 或 INSERT INTO 查詢中使用資料欄。 選取要新增到結果的資料行。 如果選取 [(所有資料行)]  ，所有資料行都將出現在輸出中。<br /><br />核取方塊所使用的圖示將根據您建立的查詢類型而有所改變。 建立刪除查詢時，您無法選取個別的資料行。|  
|:::image type="icon" source="../../ssms/visual-db-tools/media/dv3wbib.gif":::<br /><br />:::image type="icon" source="../../ssms/visual-db-tools/media/dv3wbic.gif":::|指示用來排列查詢結果 (ORDER BY 子句的一部分) 的資料欄。 如果排列順序為遞增，則圖示將以 A-Z 的方法呈現，如果為遞減排序，則為 Z-A。|  
|:::image type="icon" source="../../ssms/visual-db-tools/media/dv3wbid.gif":::|指示在彙總查詢中用來建立群組結果集 (GROUP BY 子句的一部分) 的資料欄。|  
|:::image type="icon" source="../../ssms/visual-db-tools/media/dv3wbie.gif":::|指示查詢 (WHERE 或 HAVING 子句的一部分) 的搜尋條件包含該資料欄。|  
|:::image type="icon" source="../../ssms/visual-db-tools/media/dv3wbif.gif":::|指示摘要輸出該資料欄內容 (包含在 SUM、AVG 或其他彙總函式)。|  
...
|:::image type="icon" source="../../ssms/visual-db-tools/media/dv3wbii.gif":::|使用「大於」運算子的內部聯結。 (聯結線圖式顯示的運算子即為聯結使用的運算子)|  
...
|:::image type="icon" source="../../ssms/visual-db-tools/media/dv3wbil.gif":::|完整的外部聯結，將同時包括兩邊的資料表，即使該資料表在相關資料表中並沒有相符項目。|  
...
|:::image type="icon" source="../../ssms/visual-db-tools/media/dv3wbio.gif ":::|查詢和檢視設計師無法決定聯結類型|  
