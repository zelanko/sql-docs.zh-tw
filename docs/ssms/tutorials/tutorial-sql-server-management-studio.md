...
- [教學課程：使用 SSMS 對 SQL Server 進行連線與查詢](connect-query-sql-server.md)
    ...
    在本節中，您將學習如何連線到您的 SQL Server 執行個體。 您也將學習一些基本的 Transact-SQL (T-SQL) 命令來建立和查詢新的資料庫。 

- [教學課程：在 SSMS 中撰寫物件指令碼](scripting-ssms.md)

    在本節中，您將學習如何在 SSMS 中撰寫各種物件的指令碼，包括資料庫和查詢。 

- [教學課程：在 SSMS 中使用範本](templates-ssms.md)
   
    在本節中，您將學習如何使用在 SSMS 中預先建立的範本。 

- [教學課程： SSMS 設定](ssms-configuration.md)

    在本節中，您將學習設定 SSMS 環境的基本概念。 
  

- [教學課程：使用 SSMS 的其他祕訣與訣竅](ssms-tricks.md)

    在本節中，您將學習使用 SSMS 的其他祕訣與訣竅。 本教學課程包含下列：
    - 註解、取消註解文字
    - 縮排文字
    - 在物件總管中篩選物件
