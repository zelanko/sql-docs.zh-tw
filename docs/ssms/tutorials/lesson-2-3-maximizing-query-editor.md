...
## <a name="maximizing-the-query-editor-window"></a>將查詢編輯器視窗最大化  
  
#### <a name="to-maximize-the-query-editor-window"></a>若要將查詢編輯器視窗最大化  
...
## <a name="hiding-tool-windows"></a>隱藏工具視窗  
  
#### <a name="to-automatically-hide-all-tool-windows"></a>若要自動隱藏所有工具視窗  
...
[使用註解](../../tools/sql-server-management-studio/lesson-2-4-using-comments.md)  
