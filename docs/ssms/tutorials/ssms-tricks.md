...
* 下載 [AdventureWorks 範例資料庫](https://github.com/Microsoft/sql-server-samples/releases)。 若要了解如何在 SSMS 中還原資料庫，請參閱[還原資料庫](../../relational-databases/backup-restore/restore-a-database-backup-using-ssms.md)。 
