...
[SSMS 18.0 Public Preview 7 現在已可供使用](#ssms-180-preview-7)，它是最新一代的 *SQL Server Management Studio*，可提供 [!INCLUDE[sql-server-2019](../includes/sssqlv15-md.md)] 的支援。
...
**SSMS 18.0 Public Preview 7 現在已可供使用，它是最新一代的 *SQL Server Management Studio*，可提供 [!INCLUDE[sql-server-2019](../includes/sssqlv15-md.md)] 的支援！**

**[![下載](../ssdt/media/download.png) 下載 SQL Server Management Studio 18.0 (Preview 7)](https://go.microsoft.com/fwlink/?linkid=2078638)**

*Preview 7* 是 SSMS 18.0 的最新公開預覽版。 如果您先前已安裝 SSMS 18.0 Preview，請將它解除安裝，再安裝 SSMS 18.0 Preview 7。

**版本資訊**

- 版本號碼：18.0 (Preview 7)<br>
...
## <a name="available-languages-ssms-180-preview-7"></a>可用語言 (SSMS 18.0 Preview 7)

此版 SSMS 提供下列語言版本：

SQL Server Management Studio 18.0 (Preview 7)：<br>
[簡體中文](https://go.microsoft.com/fwlink/?linkid=2078638&clcid=0x804) | [繁體中文](https://go.microsoft.com/fwlink/?linkid=2078638&clcid=0x404) | [英文 (美國)](https://go.microsoft.com/fwlink/?linkid=2078638&clcid=0x409) | [法文](https://go.microsoft.com/fwlink/?linkid=2078638&clcid=0x40c) | [德文](https://go.microsoft.com/fwlink/?linkid=2078638&clcid=0x407) | [義大利文](https://go.microsoft.com/fwlink/?linkid=2078638&clcid=0x410) | [日文](https://go.microsoft.com/fwlink/?linkid=2078638&clcid=0x411) | [韓文](https://go.microsoft.com/fwlink/?linkid=2078638&clcid=0x412) | [葡萄牙文 (巴西)](https://go.microsoft.com/fwlink/?linkid=2078638&clcid=0x416) | [俄文](https://go.microsoft.com/fwlink/?linkid=2078638&clcid=0x419) | [西班牙文](https://go.microsoft.com/fwlink/?linkid=2078638&clcid=0x40a)

SQL Server Management Studio 18.0 升級套件 (升級到 18.0)：<br>
目前沒有可用的升級選項。 如果您先前已安裝 SSMS 18.0 預覽版，請將它解除安裝，再安裝 SSMS 18.0 Preview 7。
...
## <a name="new-in-this-release-ssms-180-preview-7"></a>此版本 (SSMS 18.0 Preview 7) 中的新功能

SSMS 18.0 (Preview 7) 是 SQL Server Management Studio 的最新版本。 18.x 世代的 SSMS 幾乎支援 SQL Server 2008 到 SQL Server 2019 預覽版的所有功能範圍。

如需此版本中新增功能的詳細資料，請參閱 [SSMS 變更記錄](sql-server-management-studio-changelog-ssms.md)。

## <a name="supported-sql-offerings-ssms-180-preview-7"></a>支援的 SQL 供應項目 (SSMS 18.0 Preview 7)
...
## <a name="supported-operating-systems-ssms-180-preview-7"></a>支援的作業系統 (SSMS 18.0 Preview 7)
...
<sup>*</sup> 需要版本 1607 (10.0.14939) 或更新版本
...
## <a name="release-notes-ssms-180-preview-7"></a>版本資訊 (SSMS 18.0 Preview 7)
