---
description: 利用 SQL Server Management Studio 管理伺服器
...
[如何：檢視伺服器屬性 (SQL Server Management Studio)](../database-engine/configure-windows/view-or-change-server-properties-sql-server.md)  
