...
**12. 不為瑕疵擔保之聲明。本軟體僅以「現況」授權。您應自行承擔使用本文件的風險。Microsoft 不提供明示擔保、保證或條件。貴用戶所在地區的法律可能會提供額外的消費者權利或法定保證，而這些額外的消費者權利是本合約無法改變的。在　貴用戶所屬之當地法律許可下，Microsoft 可排除適售性、適合某特定用途或未侵權之默示擔保責任。**  
