...
[!INCLUDE[appliesto-ss-asdb-asdw-pdw-md](../../includes/appliesto-ss-asdb-asdw-pdw-md.md)] 限制物件選項對話方塊為僅顯示您想看到的物件類型。  
  
## <a name="options"></a>選項。  
**特定物件**  
開啟 [選取物件] 對話方塊，以進一步定義物件搜尋。  
...
**屬於結構描述的所有物件**  
將 [結構描述名稱] 方塊中所指定之結構描述所擁有的所有物件加入。 僅顯示於資料庫範圍對話方塊，例如 [資料庫使用者 - 新增] 對話方塊。  
