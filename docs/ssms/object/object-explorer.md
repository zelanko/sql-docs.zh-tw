...
|描述在 [!INCLUDE[ssManStudioFull](../../includes/ssmanstudiofull_md.md)]中執行自訂報表的方式。|[Management Studio 中的自訂報表](../../ssms/object/custom-reports-in-management-studio.md)|  
