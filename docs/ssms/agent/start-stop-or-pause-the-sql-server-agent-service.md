...
-   [啟動、停止、暫停、繼續、重新啟動 Database Engine、SQL Server Agent 或 SQL Server Browser 服務](http://msdn.microsoft.com/32660a02-e5a1-411a-9e57-7066ca459df6)  
