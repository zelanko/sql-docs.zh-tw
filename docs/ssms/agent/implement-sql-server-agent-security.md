---
description: 實作 SQL Server Agent 安全性
title: 實作 SQL Server Agent 安全性
...
[安全性與保護 (Database Engine)](../../relational-databases/security/security-center-for-sql-server-database-engine-and-azure-sql-database.md)  
