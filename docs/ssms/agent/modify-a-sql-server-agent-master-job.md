---
description: 修改 SQL Server Agent 主要作業
title: 修改 SQL Server Agent 主要作業
...
[變更 SQL Server Agent Master Job 的步驟](../../ssms/agent/change-steps-of-a-sql-server-agent-master-job.md)  
