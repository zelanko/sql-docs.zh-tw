...
[!INCLUDE[appliesto-ss-xxxx-xxxx-xxx-md](../../includes/appliesto-ss-xxxx-xxxx-xxx-md.md)] 本節包含 [!INCLUDE[ssNoVersion](../../includes/ssnoversion_md.md)] Agent 的 F1 說明。 在使用者介面的環境中按一下 F1 鍵，或是在對話方塊中按一下 [說明]，即可取得這些主題。  
