...
本主題描述如何在 [!INCLUDE[msCoName](../../includes/msconame_md.md)] 中設定 [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] [!INCLUDE[ssCurrent](../../includes/sscurrent-md.md)] Agent，以在意外停止時自動重新啟動。  
