---
description: 選取 SQL Server Agent 服務的帳戶
...
[使用 SQL 電腦管理員管理服務](../../database-engine/configure-windows/scm-services-connect-to-another-computer.md)  
