---
description: Proxy 編輯器 - 新增主體
title: Proxy 編輯器 - 新增主體
ms.prod: sql
...
使用此頁面將伺服器主體存取權授與 [!INCLUDE[msCoName](../../includes/msconame_md.md)] [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] Agent Proxy 帳戶。  
