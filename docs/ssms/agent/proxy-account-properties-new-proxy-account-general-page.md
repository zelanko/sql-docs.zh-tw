...
> [!NOTE]  
> 提供的認證名稱必須是現有的認證名稱。 如需如何建立認證的詳細資訊，請參閱 [如何︰建立 Proxy (SQL Server Management Studio)](http://msdn.microsoft.com/c1e77e91-2a69-40d9-b8b3-97cffc710586)  
