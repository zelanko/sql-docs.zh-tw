---
description: Proxy 帳戶屬性 - 新 Proxy 帳戶 (主體索引標籤)
title: 新增 Proxy 帳戶 (主體頁面)
ms.prod: sql
...
使用此頁面來檢視或變更可以在作業步驟中使用 [!INCLUDE[msCoName](../../includes/msconame_md.md)] [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] Agent Proxy 帳戶的主體。  
