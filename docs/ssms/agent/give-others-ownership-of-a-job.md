...
ms.openlocfilehash: ceddff66c0c5edf93c5217840cb2094ddf4ef7db
...
此主題描述如何將 [!INCLUDE[msCoName](../../includes/msconame_md.md)] [!INCLUDE[ssNoVersion](../../includes/ssnoversion_md.md)] Agent 作業的擁有權重新指派給其他使用者。  
