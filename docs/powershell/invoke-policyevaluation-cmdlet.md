---
title: "Invoke-PolicyEvaluation 指令程式 | Microsoft Docs"
ms.custom: ""
ms.date: "03/14/2017"
...
ms.topic: "article"
helpviewer_keywords: 
  - "原則式管理, Invoke-PolicyEvaluation"
  - "原則式管理, PowerShell"
  - "Invoke-PolicyEvaluation 指令程式"
  - "Cmdlet [SQL Server], Invoke-PolicyEvaluation"
...
-   **-TargetObjects** 會使用在目標集中代表 SQL Server 物件的物件或物件陣列。 例如，您可以建立要傳入 **-TargetObjects** 的 <xref:Microsoft.SqlServer.Management.Smo.Database> 類別物件陣列。  
