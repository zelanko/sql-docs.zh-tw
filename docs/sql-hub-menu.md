        ...
        <ul class="pivots">
            <li>
                ...
                <ul id="products">
                         ...
                         <ul id="products-sql-server" class="cardsC">
                            <li class="fullSpan">
                                <div class="container intro">
                                    <p>使用可調整的混合式資料庫平台，建置智慧型的關鍵任務應用程式。 一應俱全的內建功能︰範圍涵蓋記憶體內部效能、進階安全性到資料庫內分析。</p>
                                </div>
                            </li>
                            <li>
                                ...
                                <div class="cardSize">
                                    <div class="cardPadding">
                                        <div class="card">
                                            ...
                                            <div class="cardText">
                                                <h3>新功能</h3>
                                                <p>SQL Server 2016 及更新版本的新功能和更新</p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="cardSize">
                                    <div class="cardPadding">
                                        <div class="card">
                                            ...
                                            <div class="cardText">
                                                <h3>SQL Server Management Studio 教學課程</h3>
                                                <p>了解如何使用 SQL Server Management Studio</p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="cardSize">
                                    <div class="cardPadding">
                                        <div class="card">
                                            ...
                                            <div class="cardText">
                                                <h3>Transact-SQL 教學課程</h3>
                                                <p>了解如何撰寫 Transact-SQL 陳述式</p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                    ...
                    <li>
                        <a href="#products-sql-server-azure">Azure VM 上的 SQL Server</a>
                        <ul id="products-sql-server-azure" class="cardsC">
                            <li class="fullSpan">
                                <div class="container intro">
                                    <p>主機 SQL Server，包括 Azure 虛擬機器上的 SQL Server 2016 企業版。 使用資源庫映像或您自己的授權。 將內部部署 SQL Server 工作負載移轉至雲端。</p>
                                </div>
                            </li>
                            <li>
                                ...
                                <div class="cardSize">
                                    <div class="cardPadding">
                                        <div class="card">
                                            ...
                                            <div class="cardText">
                                                <h3>佈建</h3>
                                                <p>在 Azure 入口網站中佈建 SQL Server 虛擬機器</p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="cardSize">
                                    <div class="cardPadding">
                                        <div class="card">
                                            ...
                                            <div class="cardText">
                                                <h3>移轉</h3>
                                                <p>將 SQL Server 資料庫移轉到 Azure 虛擬機器中的 SQL Server</p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="cardSize">
                                    <div class="cardPadding">
                                        <div class="card">
                                            ...
                                            <div class="cardText">
                                                <h3>可用性和復原</h3>
                                                <p>Azure 虛擬機器中之 SQL Server 的高可用性和災害復原</p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="cardSize">
                                    <div class="cardPadding">
                                        <div class="card">
                                            ...
                                            <div class="cardText">
                                                <h3>VM 上的 SQL Server 案例</h3>
                                                <p>了解 SQL Server 虛擬機器如何解決各種商務問題</p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="cardSize">
                                    <div class="cardPadding">
                                        <div class="card">
                                            ...
                                            <div class="cardText">
                                                <h3>常見問題集</h3>
                                                <p>取得有關 Azure VM 上之 SQL Server 的常見問題解答</p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="cardSize">
                                    <div class="cardPadding">
                                        <div class="card">
                                            ...
                                            <div class="cardText">
                                                <h3>文件集</h3>
                                                <p>下載 Azure VM 上之 SQL Server 的相關文件</p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                    ...
                    <li>
                        <a href="/en-us/sql/linux?toc=/sql/docs/linux/toc.json">Linux 上的 SQL Server</a>
                    </li>
                    <li>
                    ...
                    <li>
                        <a href="/en-us/azure/sql-data-warehouse/">Azure SQL 資料倉儲</a>
                    </li>
                    <li>
                        <a href="/en-us/sql/microsoft-sql-documentation-table-of-contents">SQL 目錄</a>
                    </li>
                </ul>
            </li>
            <li>
                                ...
                                <div class="cardSize">
                                    <div class="cardPadding">
                                        <div class="card">
                                            ...
                                            <div class="cardText">
                                                <h3>T-SQL</h3>
                                                <p><a href="https://msdn.microsoft.com/library/bb510741.aspx">開始使用</a></p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="cardSize">
                                    <div class="cardPadding">
                                        <div class="card">
                                            ...
                                            <div class="cardText">
                                                <h3>ADO.NET</h3>
                                                <p><a href="/sql/connect/ado-net/microsoft-ado-net-for-sql-server">開始使用</a></p>
                                                <p><a href="https://msdn.microsoft.com/library/system.data.sqlclient.aspx">API 參考</a></p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="cardSize">
                                    <div class="cardPadding">
                                        <div class="card">
                                            ...
                                            <div class="cardText">
                                                <h3>驅動程式</h3>
                                                <p><a href="/sql/connect/sql-server-drivers">開始使用</a></p>
                                ...
                                <div class="cardSize">
                                    <div class="cardPadding">
                                        <div class="card">
                                            ...
                                            <div class="cardText">
                                                <h3>SSMS</h3>
                                                <p><a href="/azure/sql-database/sql-database-connect-query-ssms">開始使用</a></p>
                                                <p><a href="/sql/ssms/download-sql-server-management-studio-ssms">下載 SQL Server Management Studio</a></p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="cardSize">
                                    <div class="cardPadding">
                                        <div class="card">
                                            ...
                                            <div class="cardText">
                                                <h3>SSDT</h3>
                                                <p><a href="https://msdn.microsoft.com/library/hh272686(v=vs.103).aspx">開始使用</a></p>
                                                <p><a href="/sql/ssdt/download-sql-server-data-tools-ssdt">下載 SQL Server Data Tools</a></p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="cardSize">
                                    <div class="cardPadding">
                                        <div class="card">
                                            <div class="cardImageOuter">
                                                <div class="cardImage"> 
                                                    <img alt="" src="/media/common/i_extensions.svg">
                                                </div>
                                            </div>
                                            <div class="cardText">
                                                <h3>VS Code &amp; SQL 延伸模組</h3>
                                                <p><a href="https://code.visualstudio.com/docs">開始使用</a></p>
                                                <p><a href="https://code.visualstudio.com/">下載 Visual Studio Code</a></p>
                                                <p><a href="https://marketplace.visualstudio.com/items?itemName=ms-mssql.mssql">SQL 延伸模組 (mssql)</a></p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="cardSize">
                                    <div class="cardPadding">
                                        <div class="card">
                                            ...
                                            <div class="cardText">
                                                <h3>PowerShell</h3>
                                                <p><a href="/azure/powershell-install-configure">開始使用</a></p>
                                                <p><a href="/powershell/resourcemanager/azurerm.sql/v2.3.0/azurerm.sql">Azure SQL Database Cmdlet</a></p>
                                                <p><a href="https://msdn.microsoft.com/library/mt740629.aspx">SQL Server Cmdlet</a></p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="cardSize">
                                    <div class="cardPadding">
                                        <div class="card">
                                            ...
                                            <div class="cardText">
                                                <h3>Azure CLI 2.0</h3>
                                                <p><a href="/cli/azure/get-started/">開始使用</a></p>
                                                <p><a href="https://github.com/Azure/azure-cli">下載 Azure CLI 2.0</a></p>
                                                <p><a href="/cli/azure/">參考</a></p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="cardSize">
                                    <div class="cardPadding">
                                        <div class="card">
                                            ...
                                            <div class="cardText">
                                                <h3>Azure CLI</h3>
                                                <p><a href="/azure/xplat-cli-install?toc=/azure/virtual-machines/linux/toc.json">開始使用</a></p>
                                                <p><a href="http://aka.ms/linux-azure-cli">下載適用於 Linux 的 Azure CLI</a></p>
                                                <p><a href="http://aka.ms/mac-azure-cli">下載適用於 Mac 的 Azure CLI</a></p>
                                                <p><a href="http://aka.ms/webpi-azure-cli">下載適用於 Windows 的 Azure CLI</a></p>
                                                <p><a href="https://azure.microsoft.com/documentation/articles/azure-cli-arm-commands/">參考</a></p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                ...
                <ul id="architecture">
                    <li>
                        ...
                        <ul id="architecture1" class="cardsC">
                            <li>
                                <div class="container intro">
                                    <p>SQL 的架構建議和模式，由 Azure SQL Database 開始。</p>
                                </div>
                            </li>
                            <li>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>多租用戶 SaaS 應用程式</h3>
                                                    <p>Azure SQL Database 中的多租用戶 SaaS 應用程式的設計模式</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>資料列層級安全性</h3>
                                                    <p>在 Azure SQL Database 中使用分區化資料庫實作資料列層級安全性</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>應用程式的災害復原設計</h3>
                                                    <p>在 Azure SQL Database 中使用作用中異地複寫設計來設計應用於雲端災害復原的應用程式</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>使用彈性集區的災害復原策略</h3>
                                                    <p>Azure SQL Database 中使用彈性集區的應用程式災害復原策略</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
