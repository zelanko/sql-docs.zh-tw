...
10. 在 [資料表] 窗格中，以滑鼠右鍵按一下 [InternetSalesReason (dbo.FactInternetSalesReason)]，然後按一下 [瀏覽資料]。  
    ...
    ![識別購買之銷售原因的索引鍵值](../analysis-services/media/l5-many-to-many-1.png "識別購買之銷售原因的索引鍵值")  
...
6.  在 [屬性] 視窗中，將 [網際網路銷售原因計數] 量值的 [可見] 屬性變更為 **False**。  
    ...
    ![網際網路銷售原因計數量值的屬性](../analysis-services/media/l5-many-to-many-2.gif "網際網路銷售原因計數量值的屬性")  
...
13. 在 [維度設計師] 的 [階層] 窗格中，依序建立 [銷售原因] 使用者階層，其中包含 [銷售原因類型] 層級和 [銷售原因] 層級。  
...
## 本課程的下一項工作  
[在量值群組內定義維度資料粒度](../analysis-services/defining-dimension-granularity-within-a-measure-group.md)  
