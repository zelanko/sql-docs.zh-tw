...
1.  切換到 [!INCLUDE[ssASnoversion](../includes/ssasnoversion-md.md)] 教學課程 Cube 的 Cube 設計師，然後再切換到 [翻譯] 索引標籤。  
    ...
    ![翻譯索引標籤中的預設語言](../analysis-services/media/l9-translations-5.gif "翻譯索引標籤中的預設語言")  
...
5.  在工具列上，選取 [語言] 清單中的 [西班牙文 (西班牙)]。  
    ...
    ![重新擴展的中繼資料窗格](../analysis-services/media/l9-translations-6.png "重新擴展的中繼資料窗格")  
...
9. 在 [中繼資料] 窗格中，以滑鼠右鍵按一下 [Mes del Ano]，然後選取[加入至查詢]。  
    ...
    ![資料窗格中的西班牙文月份名稱](../analysis-services/media/l9-translations-7.gif "資料窗格中的西班牙文月份名稱")  
