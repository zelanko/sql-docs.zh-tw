...
[定義維度](../analysis-services/defining-a-dimension.md)  
在這項工作中，您會使用維度精靈來定義維度。  
  
[定義 Cube](../analysis-services/defining-a-cube.md)  
在這項工作中，您會使用 Cube 精靈來定義初始 [!INCLUDE[ssASnoversion](../includes/ssasnoversion-md.md)] Cube。  
  
[將屬性加入至維度](../analysis-services/adding-attributes-to-dimensions.md)  
在這項工作中，您會將屬性加入至已建立的維度。  
  
[檢閱 Cube 和維度屬性](../analysis-services/reviewing-cube-and-dimension-properties.md)  
在這項工作中，您會檢閱使用 Cube 精靈所定義之 Cube 的結構。  
  
[部署 Analysis Services 專案](../analysis-services/deploying-an-analysis-services-project.md)  
