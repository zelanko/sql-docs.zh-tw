...
### 預測分隔資料行  
 ...
 ![來自 Microsoft 決策樹演算法的長條圖](../../analysis-services/data-mining/media/dt-histogram.gif "來自 Microsoft 決策樹演算法的長條圖")  
...
### 預測連續資料行  
 ...
 ![顯示非線性的多條迴歸線](../../analysis-services/data-mining/media/regression-tree1.png "顯示非線性的多條迴歸線")  
