...
```  
 ...
 如需使用 DMX 查詢來傳回案例資料的詳細資訊，請參閱 [SELECT FROM &#60;模型&#62;.CASES &#40;DMX&#41;](../Topic/SELECT%20FROM%20%3Cmodel%3E.CASES%20\(DMX\).md) 和 [SELECT FROM &#60;結構&#62;.CASES](../Topic/SELECT%20FROM%20%3Cstructure%3E.CASES.md)。  
