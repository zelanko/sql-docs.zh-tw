...
ms.topic: "article"
helpviewer_keywords: 
  - "資料採礦 [Analysis Services], 巢狀資料表"
  - "資料表 [Analysis Services], 巢狀"
  - "巢狀資料表"
