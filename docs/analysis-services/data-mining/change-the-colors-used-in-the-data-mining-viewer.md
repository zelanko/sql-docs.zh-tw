...
4.  從下拉式清單中選取新的色彩。 按一下 **[自訂]** 索引標籤，從目前電腦上可用的自訂調色盤中選取一個色彩，或是按一下 **[系統]** ，從 Windows 色彩配置內指定的色彩當中選取一個色彩。  
  
    > [!NOTE]  
    >  如果您使用自訂色彩，該色彩將會以色彩圖示和色彩的 RBG 值來表示。 如果您使用系統色彩或 Web 色彩，該色彩將會以色彩圖示和色彩名稱來表示。  
