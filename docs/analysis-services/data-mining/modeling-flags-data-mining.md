...
helpviewer_keywords: 
  ...
  - "資料類型 [資料採礦]"
  - "REGRESSOR 旗標"
  - "MODEL_EXISTENCE_ONLY 旗標"
  - "REGRESSOR 資料行"
  - "資料行 [資料採礦], 模型旗標"
  - "NOT NULL 模型旗標"
  - "模型旗標 [資料採礦]"
  - "Null 值 [Analysis Services]"
  - "MODEL_EXISTENCE_ONLY 資料行"
  - "編寫 [資料採礦]"
...
> [!NOTE]  
>  「遺漏」是演算法所使用的特殊狀態，與資料行中的文字值「遺漏」不同。 如需詳細資訊，請參閱[遺漏值 &#40;Analysis Services - 資料採礦&#41;](../../analysis-services/data-mining/missing-values-analysis-services-data-mining.md)。  
