...
## 了解羅吉斯迴歸模型的結構  
 ...
 ![羅吉斯迴歸模型的模型內容結構](../../analysis-services/data-mining/media/skt-modelcontentstructure-logregc.gif "羅吉斯迴歸模型的模型內容結構")  
...
|輸出節點|包含與 NODE_DESCRIPTION 資料行資訊相同的 XML 片段。|  
 ...
 NODE_DISTRIBUTION  
 包含節點之統計資訊的巢狀資料表。 如需每個節點類型之這個資料表內容的詳細資訊，請參閱[類神經網路模型的採礦模型內容 &#40;Analysis Services - 資料採礦&#41;](../../analysis-services/data-mining/mining-model-content-for-neural-network-models-analysis-services-data-mining.md)中的＜了解 NODE_DISTRIBUTION 資料表＞一節。  
