...
helpviewer_keywords: 
  - "ARTXP"
  - "HISTORICAL_MODEL_GAP 參數"
  - "AUTO_DETECT_PERIODICITY 參數"
  - "時間序列演算法 [Analysis Services]"
  - "ARIMA"
  - "INSTABILITY_SENSITIVITY 參數"
  - "PERIODICITY_HINT 參數"
  - "MAXIMUM_SERIES_VALUE 參數"
  - "時間序列 [Analysis Services]"
  - "MINIMUM_SUPPORT 參數"
  - "HISTORIC_MODEL_COUNT 參數"
  - "FORECAST_METHOD 參數"
  - "MISSING_VALUE_SUBSTITUTION 參數"
  - "MINIMUM_SERIES_VALUE 參數"
  - "COMPLEXITY_PENALTY 參數"
  - "PREDICTION_SMOOTHING 參數"
