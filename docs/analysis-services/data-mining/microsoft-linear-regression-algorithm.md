...
# Microsoft 線性迴歸演算法
 ...
 ![模式化一組資料的線條](../../analysis-services/data-mining/media/linear-regression.png "模式化一組資料的線條")  
...
## 檢視線性迴歸模型  
 ...
 如果是線性迴歸模型，此模型內容包含中繼資料、迴歸公式及有關輸入值分佈的統計資料。 如需詳細資訊，請參閱[線性迴歸模型的採礦模型內容 &#40;Analysis Services - 資料採礦&#41;](../../analysis-services/data-mining/mining-model-content-for-linear-regression-models-analysis-services-data-mining.md)。  
