...
helpviewer_keywords: 
  - "屬性 [資料採礦]"
  - "採礦結構 [Analysis Services], 關於採礦結構"
  - "採礦結構 [Analysis Services]"
  - "資料採礦 [Analysis Services], 結構"
  - "Analysis Services 物件, 資料採礦物件"
  - "資料採礦 [Analysis Services], 模型"
  - "演算法 [資料採礦]"
  - "資料採礦 [Analysis Services], 物件"
...
### 檢視採礦結構  
 ...
 `SELECT * FROM <model>.CASES` 陳述式會傳回相同的資料行，但是僅針對該特定模型中的案例。 如需詳細資訊，請參閱 [SELECT FROM &#60;structure&#62;.CASES](../Topic/SELECT%20FROM%20%3Cstructure%3E.CASES.md) 和 [SELECT FROM &#60;model&#62;.CASES &#40;DMX&#41;](../Topic/SELECT%20FROM%20%3Cmodel%3E.CASES%20\(DMX\).md)。  
...
|使用以 OLAP Cube 為基礎的採礦結構|[建立新的 OLAP 採礦結構](../../analysis-services/data-mining/create-a-new-olap-mining-structure.md)<br /><br /> [篩選採礦結構的來源 Cube](../Topic/Filter%20the%20Source%20Cube%20for%20a%20Mining%20Structure.md)|  
