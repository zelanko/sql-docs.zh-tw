...
-   您也可以使用 DMX 來定義採礦結構。 如需詳細資訊，請參閱[資料採礦延伸模組 &#40;DMX&#41; 資料定義陳述式](../Topic/Data%20Mining%20Extensions%20\(DMX\)%20Data%20Definition%20Statements.md)。  
...
###  <a name="bkmk_ViewExplore"></a> 檢視及瀏覽模型  
