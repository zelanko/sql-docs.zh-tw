...
##  <a name="bkmk_top"></a> 取得有關羅吉斯迴歸模型的資訊  
 ...
 若要依照查詢案例，您可以建立羅吉斯迴歸模型，中繼資料採礦教學課程的下一節所述：[第 5 課：建立類神經網路和羅吉斯迴歸模型&#40;中繼資料採礦教學課程&#41;](http://msdn.microsoft.com/library/42c3701a-1fd2-44ff-b7de-377345bbbd6b)。  
...
###  <a name="bkmk_Query3"></a> 範例查詢 3:針對連續值進行預測  
 ...
 下列查詢範例是以中繼教學課程中的撥接中心模型為基礎，並且建立單一查詢，以便預測星期五上午排班的服務等級。 [PredictHistogram (DMX)](../../dmx/predicthistogram-dmx.md) 函數會傳回一個巢狀資料表，其中提供與了解預測值之有效性相關的統計資料。  
...
|預測的服務等級|服務等級|$SUPPORT|$PROBABILITY|$ADJUSTEDPROBABILITY|$VARIANCE|$STDEV|  
|-----------------------------|-------------------|--------------|------------------|--------------------------|---------------|------------|  
