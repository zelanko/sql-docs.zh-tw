...
## Microsoft 羅吉斯迴歸演算法的實作  
 ...
 ![使用羅吉斯迴歸模式化的資料](../../analysis-services/data-mining/media/logistic-regression.gif "使用羅吉斯迴歸模式化的資料")  
...
```  
 ...
 如需詳細資訊，請參閱[羅吉斯迴歸模型查詢範例](../../analysis-services/data-mining/logistic-regression-model-query-examples.md)。  
