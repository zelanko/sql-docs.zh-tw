...
author: minewiskan
manager: kfile
ms.openlocfilehash: 63f52edcc93e6cc400dff24c0a0bf0861918cdd5
...
|**識別碼**|顯示採礦結構的唯一識別碼。<br /><br /> 在建立採礦結構時您指派給結構的名稱會當做識別碼使用。 如果您之後針對 **Name** 屬性輸入新的值，藉以變更此名稱，則新的名稱只會當作別名使用，而不會變更識別碼。|  
|**語言**|針對採礦結構中的標題指定語言。|  
