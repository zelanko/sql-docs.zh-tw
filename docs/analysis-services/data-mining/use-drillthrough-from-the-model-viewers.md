---
title: 從 模型檢視器使用鑽研 |Microsoft Docs
ms.date: 05/08/2018
ms.prod: sql
...
3.  選取下列其中一個選項：**僅模型資料行**或是**模型和結構資料行**。 如果您沒有權限，選項可能無法使用。  
...
3.  選取 **鑽研**，然後選取下列選項之一：**僅模型資料行**或是**模型和結構資料行**。 如果您沒有權限，選項可能無法使用。  
