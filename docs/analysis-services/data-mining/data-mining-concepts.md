...
ms.topic: "article"
helpviewer_keywords: 
  - "SQL Server Analysis Services，資料採礦"
  - "清除資料"
  - "預測分析"
  - "學習演算法"
  - "資料採礦 [Analysis Services]，概念"
  - "感應學習"
  - "資料採礦 [Analysis Services]，關於資料採礦"
  - "採礦模型 [Analysis Services]"
  - "資料存取 [Analysis Services]"
  - "機器學習演算法 [Analysis Services]"
  - "採礦模型 [Analysis Services]，關於資料採礦"
  - "SSAS，資料採礦"
  - "Analysis Services，資料採礦"
...
6.  [部署及更新模型](#DeployingandUpdatingModels)  
 ...
 ![資料採礦處理中的關鍵步驟](../../analysis-services/data-mining/media/data-mining-process.gif "資料採礦處理中的關鍵步驟")  
 ...
 如需如何將 [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] 工具套用到商務案例的範例，請參閱[資料採礦基本教學課程](../Topic/Basic%20Data%20Mining%20Tutorial.md)。  
...
##  <a name="ExploringData"></a> 瀏覽資料  
 ...
 ![資料採礦的第三個步驟：瀏覽資料](../../analysis-services/data-mining/media/dmprocess-exploring.gif "資料採礦的第三個步驟：瀏覽資料")  
...
##  <a name="BuildingModels"></a> 建立模型  
 ...
 ![資料採礦的第四個步驟：建立採礦模型](../../analysis-services/data-mining/media/dmprocess-building.gif "資料採礦的第四個步驟：建立採礦模型")  
...
##  <a name="ValidatingModels"></a> 瀏覽及驗證模型  
 ...
 ![資料採礦的第五個步驟：驗證採礦模型](../../analysis-services/data-mining/media/dmprocess-validating.gif "資料採礦的第五個步驟：驗證採礦模型")  
  
 在您將模型部署到實際執行環境之前，您會想要先測試模型的執行效能。 同時，當您建立模型時，通常會建立包含不同組態的多個模型，然後測試所有模型以查看哪個模型會針對您的問題和資料產生最佳的效果。  
  
 [!INCLUDE[ssASnoversion](../../includes/ssasnoversion-md.md)] 提供的工具可協助您將資料分割為訓練資料集與測試資料集，讓您可以針對相同的資料，正確評估所有模型的效能。 您會使用訓練資料集來建立模型，並建立預測查詢，使用測試資料集來測試模型的精確度。 在 [!INCLUDE[ssASCurrent](../../includes/ssascurrent-md.md)]中，這個資料分割可以在建立採礦結構時自動完成。 如需詳細資訊，請參閱[測試和驗證 &#40;資料採礦&#41;](../../analysis-services/data-mining/testing-and-validation-data-mining.md)。  
...
##  <a name="DeployingandUpdatingModels"></a> 部署及更新模型  
 ...
 ![資料採礦的第六個步驟：部署採礦模型](../../analysis-services/data-mining/media/dmprocess-deploying.gif "資料採礦的第六個步驟：部署採礦模型")  
