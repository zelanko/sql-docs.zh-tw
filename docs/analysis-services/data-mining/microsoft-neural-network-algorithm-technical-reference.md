...
[!INCLUDE[ssas-appliesto-sqlas](../../includes/ssas-appliesto-sqlas.md)][!INCLUDE[msCoName](../../includes/msconame-md.md)]類神經網路使用*多層認知*網路，亦稱為*Back-Propagated 差異規則網路*、 組成的神經，最多三個層級或*「 認知器 」*。 這 3 層分別是輸入層、選擇性隱藏層和輸出層。  
