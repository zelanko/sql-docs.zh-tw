...
## <a name="xmla-query-templates"></a>XMLA 查詢範本  
 ...
 在 DMX 和 XMLA 中處理作業的方式也有一些重大差異。 例如，您可以使用 XMLA 來執行管理作業 (例如備份整個 [!INCLUDE[ssASnoversion](../../includes/ssasnoversion-md.md)] 資料庫)，但是如果您要備份單一採礦模型，DMX 會提供單一命令 [EXPORT &#40;DMX&#41;](../../dmx/export-dmx.md)，這個命令比較適合這個用途。  
