...
-   第二個篩選中，您會選擇 [客戶] 維度，選取 「 性別 」 屬性，並選取 「 女性 」 清單中的屬性值。  
 ...
 在建立採礦結構之後，您可以修改 Cube 資料的定義和篩選準則。 如需詳細資訊，請參閱 <<c0> [ 採礦模型的篩選](~/analysis-services/data-mining/filters-for-mining-models-analysis-services-data-mining.md)。  
