---
title: "在模型中指定當做迴歸輸入變數使用的資料行 | Microsoft Docs"
ms.custom: ""
ms.date: "03/01/2017"
...
# 在模型中指定當做迴歸輸入變數使用的資料行
 ...
 下列程序描述如何使用[類神經網路教學課程](../Topic/Lesson%205:%20Building%20Neural%20Network%20and%20Logistic%20Regression%20Models%20\(Intermediate%20Data%20Mining%20Tutorial\).md)所使用的相同範例資料來建立簡單的線性迴歸模型。 此模型不一定很強固，但可以示範如何使用資料採礦設計師自訂線性迴歸模型。  
