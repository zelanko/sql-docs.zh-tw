...
# [模型篩選條件語法和範例](model-filter-syntax-and-examples-analysis-services-data-mining.md)
...
# [叢集模型的採礦模型內容](mining-model-content-for-clustering-models-analysis-services-data-mining.md)
...
# [資料採礦預存程序](data-mining-stored-procedures-analysis-services-data-mining.md)
...
# [將採礦模型加入至結構](add-mining-models-to-a-structure-analysis-services-data-mining.md)
...
# [群集模型的時序採礦模型內容](mining model content for sequence clustering models.md)
...
# [測試及驗證工作與操作方法](testing-and-validation-tasks-and-how-tos-data-mining.md)
