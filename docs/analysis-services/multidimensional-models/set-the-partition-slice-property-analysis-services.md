...
ms.topic: "article"
helpviewer_keywords: 
  - "分割區 [Analysis Services], 資料配量"
  - "資料配量 [Analysis Services]"
...
---
# 設定 Partition Slice 屬性 (Analysis Services)
...
> [!NOTE]  
>  請注意，資料分割的 Slice 屬性不支援動態多維度運算式 (MDX) 函數 (例如 [Generate &#40;MDX&#41;](../../mdx/generate-mdx.md) 或 [Except &#40;MDX&#41;](../Topic/Except%20\(MDX\).md))。 您必須使用明確的 Tuple 或成員參考來定義配量。  
>   
