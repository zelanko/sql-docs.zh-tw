...
manager: "erikre"
---
# 使用 DRILLTHROUGH 擷取來源資料 (MDX)
  多維度運算式 (MDX) 使用 [DRILLTHROUGH](../Topic/DRILLTHROUGH%20Statement%20\(MDX\).md) 陳述式從來源資料擷取 Cube 資料格的資料列集。  
...
## 請參閱＜  
 [操作資料 &#40;MDX&#41;](../../../analysis-services/multidimensional-models/mdx/manipulating-data-mdx.md)  
