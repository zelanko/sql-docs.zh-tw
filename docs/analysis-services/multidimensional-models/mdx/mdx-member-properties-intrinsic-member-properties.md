...
> [!NOTE]  
>  MEMBERS 結構描述資料列集中的資料行支援下表列出的內建成員屬性。 如需 **MEMBERS** 結構描述資料列集的詳細資訊，請參閱 [MDSCHEMA_MEMBERS 資料列集](https://docs.microsoft.com/bi-reference/schema-rowsets/ole-db-olap/mdschema-members-rowset)。  
