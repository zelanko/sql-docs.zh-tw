---
title: "建立查詢中的 Cube 內容 (MDX) | Microsoft Docs"
ms.custom: ""
ms.date: "03/13/2017"
...
ms.topic: "article"
helpviewer_keywords: 
  - "Cube [Analysis Services], MDX"
  - "MDX [Analysis Services], Cube 內容"
  - "SELECT 陳述式 [MDX]"
  - "多維度運算式 [Analysis Services], Cube 內容"
  - "查詢 [MDX], Cube 內容"
...
```  
 ...
 如需 MDX SELECT 陳述式的 FROM 子句詳細資訊，請參閱 [SELECT 陳述式 &#40;MDX&#41;](../Topic/SELECT%20Statement%20\(MDX\).md)。  
