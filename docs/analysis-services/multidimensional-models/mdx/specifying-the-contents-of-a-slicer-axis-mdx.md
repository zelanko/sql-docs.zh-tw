---
title: "指定 Slicer 軸的內容 (MDX) | Microsoft Docs"
ms.custom: ""
ms.date: "03/03/2017"
...
### 隱含 Slicer 軸  
 如果 Cube 內階層的成員未明確地包含在查詢座標軸中，階層的預設成員就會隱含地包含在 Slicer 軸中。 如需預設成員的詳細資訊，請參閱[定義預設成員](../../../analysis-services/multidimensional-models/define-a-default-member.md)。  
