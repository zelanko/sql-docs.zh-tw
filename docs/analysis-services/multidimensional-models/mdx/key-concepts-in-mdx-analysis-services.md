---
title: "MDX 的關鍵概念 (Analysis Services) | Microsoft Docs"
ms.custom: ""
ms.date: "03/13/2017"
...
ms.topic: "article"
helpviewer_keywords: 
  - "多維度運算式 [Analysis Services]，關於 MDX"
  - "維度模型 [MDX]"
  - "MDX [Analysis Services]，關於 MDX"
  - "多維度運算式 [Analysis Services]，維度模型化"
  - "MDX [Analysis Services]，維度模型化"
...
-   亞太的「(全部) 成員」為 $1,594,335.38  
 ...
 ![標註所有成員的樞紐分析表](../../../analysis-services/multidimensional-models/mdx/media/ssas-keyconcepts-pivot2-allmember.png "標註所有成員的樞紐分析表")  
  
 展開階層，最後您會來到最底層。 這稱為 **分葉成員**。 分葉成員是階層中沒有子系的成員。@@@ 在此範例中，Australia 為分葉成員。  
  
 ![標註分葉成員的樞紐分析表](../../../analysis-services/multidimensional-models/mdx/media/ssas-keyconcepts-pivot3-leafparent.png "標註分葉成員的樞紐分析表")  
...
## 索引鍵屬性  
 ...
 ![顯示資料粒度屬性的模型](../../../analysis-services/multidimensional-models/mdx/media/ssas-keyconcepts-granularityattrib.png "顯示資料粒度屬性的模型")  
...
-   [基本 MDX 查詢 &#40;MDX&#41;](../../../analysis-services/multidimensional-models/mdx/the-basic-mdx-query-mdx.md)  
