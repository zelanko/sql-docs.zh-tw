...
ms.locfileid: "68179395"
---
# <a name="attribute-properties---view-attributes-in-dimension-designer"></a>屬性內容 - 在維度設計師中檢視屬性
...
|![索引鍵屬性圖示](../../analysis-services/multidimensional-models/media/as-icon-key-attribute.gif "索引鍵屬性圖示")|Key|  
