---
title: "使用部署公用程式的部署模型方案 | Microsoft Docs"
ms.custom: ""
ms.date: "03/14/2017"
...
ms.topic: "article"
helpviewer_keywords: 
  - "部署 [Analysis Services], 命令提示字元"
  - "命令提示字元公用程式 [SQL Server], Microsoft.AnalysisServices.Deployment"
  - "Microsoft.AnalysisServices.Deployment 公用程式"
  - "Analysis Services 部署, 命令提示字元"
