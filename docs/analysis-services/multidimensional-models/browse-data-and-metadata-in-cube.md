---
title: "瀏覽 Cube 中的資料和中繼資料 | Microsoft Docs"
ms.custom: ""
ms.date: "03/01/2017"
...
-   在 [篩選] 窗格的 [維度] 欄中，按一下 [\<選取維度>] 並從清單中選取維度，然後按一下 [階層] 欄中的 [\<選取階層>] 並從清單中選取階層。  
