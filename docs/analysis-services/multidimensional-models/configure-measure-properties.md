...
ms.topic: "article"
helpviewer_keywords: 
  - "加總性 [Analysis Services]"
  - "ID 屬性"
  - "ErrorConfiguration 屬性"
  - "AggregateFunction 屬性"
  - "DisplayFolder 屬性"
  - "IgnoreUnrelatedDimensions 屬性"
  - "FormatString 屬性"
  - "Description 屬性"
  - "局部加總"
  - "屬性 [Analysis Services], 量值群組"
  - "彙總函式 [Analysis Services]"
  - "DataType 屬性"
  - "ProcessingMode 屬性"
  - "MeasureExpression 屬性"
  - "AggregationPrefix 屬性"
  - "Visible 屬性"
  - "屬性 [Analysis Services], 量值"
  - "StorageLocation 屬性"
  - "StorageMode 屬性"
  - "格式 [Analysis Services], 量值"
  - "Source 屬性"
  - "彙總 [Analysis Services], 量值"
  - "量值 [Analysis Services], 屬性"
  - "非加總 [Analysis Services]"
  - "Name 屬性"
  - "量值 [Analysis Services], 顯示格式"
  - "ProcessingPriority 屬性"
  - "量值群組 [Analysis Services], 屬性"
  - "Type 屬性"
  - "ProactiveCaching 屬性"
...
## 請參閱＜  
 ...
 [修改量值](../../analysis-services/modifying-measures.md)  
