---
title: "Analysis Services 部署的需求和考量 | Microsoft Docs"
ms.custom: ""
ms.date: "03/16/2017"
...
helpviewer_keywords: 
  ...
  - "延展性 [Analysis Services]"
  - "空間 [Analysis Services]"
  - "Analysis Services 部署, 需求"
  - "部署 [Analysis Services], 需求"
  - "磁碟空間 [Analysis Services]"
  - "需求 [Analysis Services]"
  - "處理器 [Analysis Services]"
  - "系統需求 [Analysis Services]"
  - "可用性 [Analysis Services]"
...
### 處理結構化變更時維持可用性  
 ...
 若要直接在背景處理來源資料的累加更新，請啟用主動式快取。 主動式快取會自動以新的來源資料更新 Cube，不需要手動處理且不影響 Cube 的可用性。 如需詳細資訊，請參閱[主動式快取 &#40;資料分割&#41;](../Topic/Proactive%20Caching%20\(Partitions\).md)。  
