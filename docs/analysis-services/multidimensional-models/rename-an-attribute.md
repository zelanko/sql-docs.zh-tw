...
ms.topic: "article"
helpviewer_keywords: 
  - "名稱 [Analysis Services], 屬性"
  - "重新命名屬性"
  - "屬性 [Analysis Services], 重新命名"
  - "Name 屬性"
...
# 重新命名屬性
 ...
 如需如何重新命名屬性的詳細資訊，請參閱[將屬性繫結至索引鍵資料行](../../analysis-services/multidimensional-models/bind-an-attribute-to-a-key-column.md)。  
