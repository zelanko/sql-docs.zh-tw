...
# <a name="amo-classes---introduction"></a>AMO 類別-簡介
 ...
 ![檢閱在 AMO 概念性主題中的類別](../../../analysis-services/multidimensional-models/analysis-management-objects/media/amo-reviewedclasses.gif "檢閱 AMO 概念性主題中的類別")  
...
|[AMO 資料採礦類別](../../../analysis-services/multidimensional-models/analysis-management-objects/amo-data-mining-classes.md)|描述可讓您管理在 [!INCLUDE[ssASnoversion](../../../includes/ssasnoversion-md.md)]中的資料採礦物件之類別。|  
