---
title: "處理多維度模型 (Analysis Services) | Microsoft Docs"
ms.custom: ""
ms.date: "03/04/2017"
...
ms.topic: "article"
helpviewer_keywords: 
  - "線上模式 [Analysis Services]"
  - "處理物件 [Analysis Services]"
  - "分割區 [Analysis Services], 處理"
  - "作業 [Analysis Services]"
  - "物件 [Analysis Services], 處理"
  - "重新處理物件"
  - "影響分析 [Analysis Services]"
  - "維度 [Analysis Services], 處理"
  - "專案模式 [Analysis Services]"
  - "Cube [Analysis Services], 處理"
...
## 請參閱＜  
 [邏輯架構 &#40;Analysis Services - 多維度資料&#41;](../Topic/Logical%20Architecture%20\(Analysis%20Services%20-%20Multidimensional%20Data\).md)   
