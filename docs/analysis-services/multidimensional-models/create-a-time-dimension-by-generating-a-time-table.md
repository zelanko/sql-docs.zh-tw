...
helpviewer_keywords: 
  ...
  - "以資料表為基礎的時間維度 [Analysis Services]"
...
## 選取日曆  
 您建立時間維度時，一律會包含標準 (西曆) 12 個月日曆，從 1 月 1 日開始，到 12 月 31 日結束。 在精靈的 **[選取日曆]** 頁面上，可以指定此維度中之階層做為基礎的其他日曆。 如需日曆類型的描述，請參閱[建立日期類型維度](../../analysis-services/multidimensional-models/create-a-date-type-dimension.md)。  
...
## 請參閱＜  
 ...
 [建立日期類型維度](../../analysis-services/multidimensional-models/create-a-date-type-dimension.md)   
