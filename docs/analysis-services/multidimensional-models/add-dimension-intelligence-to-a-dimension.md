---
title: "將維度智慧加入至維度中 | Microsoft Docs"
ms.custom: ""
ms.date: "12/09/2016"
...
ms.topic: "article"
helpviewer_keywords: 
  - "商業智慧增強功能 [Analysis Services], 維度智慧"
  - "維度 [Analysis Services], 商業智慧增強功能"
  - "維度智慧 [Analysis Services]"
  - "Type 屬性"
...
> [!NOTE]  
>  如果選取 [帳戶] 作為維度，您將會指定維度的帳戶智慧。 如需詳細資訊，請參閱[將帳戶智慧加入至維度中](../../analysis-services/multidimensional-models/add-account-intelligence-to-a-dimension.md)。  
