...
helpviewer_keywords: 
  ...
  - "Analysis Services 物件，資料來源"
  - "儲存資料 [Analysis Services], 資料來源"
  - "data sources [Analysis Services], about data sources"
  - "安全性 [Analysis Services], 資料來源"
  - "資料來源 [Analysis Services]"
  - "儲存體 [Analysis Services], 資料來源"
...
# 多維度模型中的資料來源
 ...
 [!INCLUDE[ssASnoversion](../../includes/ssasnoversion-md.md)] 中的**資料來源**物件會指定與外部資料來源的直接連接。 除了實體位置之外，資料來源物件還會指定連接字串、資料提供者、認證，以及控制連接行為的其他屬性。  
