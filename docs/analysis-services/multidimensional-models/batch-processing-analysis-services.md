...
##  <a name="bkmk_xmla"></a> 在 Management Studio 中使用 XMLA 執行批次處理  
 ...
 如需逐步指示，請參閱[使用 SQL Server Agent 排程 SSAS 管理工作](../../analysis-services/instances/schedule-ssas-administrative-tasks-with-sql-server-agent.md)中的**範例 2**  
