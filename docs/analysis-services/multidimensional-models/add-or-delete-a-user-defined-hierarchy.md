---
title: "加入或刪除使用者定義階層 | Microsoft Docs"
ms.custom: ""
ms.date: "03/04/2017"
...
ms.topic: "article"
helpviewer_keywords: 
  - "階層 [Analysis Services], 加入"
  - "移除階層"
  - "加入階層"
  - "刪除階層"
  - "階層 [Analysis Services], 移除"
...
5.  也可以選擇，修改使用者自訂階層或其層級的屬性。  
     ...
     例如，您可能會想要指定使用者自訂階層的名稱，也可能重新命名一個或多個層級，然後定義「全部」層級的自訂名稱。 如需詳細資訊，請參閱[使用者階層屬性](../Topic/User%20Hierarchy%20Properties.md)和[層級屬性 - 使用者階層](../Topic/Level%20Properties%20-%20user%20hierarchies.md)。  
  
    > [!NOTE]  
    >  依預設，使用者自訂階層就是可以讓使用者向下鑽研資訊的路徑。 但是，如果層級之間有關聯性存在，則可以設定層級之間的屬性關聯性來提升查詢效能。 如需詳細資訊，請參閱[屬性關聯性](../../analysis-services/multidimensional-models-olap-logical-dimension-objects/attribute-relationships.md)和[定義屬性關聯性](../../analysis-services/multidimensional-models/define-attribute-relationships.md)。  
