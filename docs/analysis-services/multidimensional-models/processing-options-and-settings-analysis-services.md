...
ms.topic: "article"
helpviewer_keywords: 
  - "處理資料選項 [Analysis Services]"
  - "處理物件 [Analysis Services]"
  - "取消處理選項 [Analysis Services]"
  - "完整處理選項 [Analysis Services]"
  - "處理索引選項 [Analysis Services]"
  - "處理結構選項 [Analysis Services]"
  - "處理累加選項 [Analysis Services]"
  - "處理更新選項 [Analysis Services]"
  - "處理清除結構選項 [Analysis Services]"
  - "處理預設選項 [Analysis Services]"
