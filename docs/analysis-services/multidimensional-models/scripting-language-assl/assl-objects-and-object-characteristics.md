...
## <a name="object-processing"></a>物件處理  
 ASSL 包括的唯讀元素或是屬性 (例如**LastProcessed**)，可以從讀取[!INCLUDE[ssASnoversion](../../../includes/ssasnoversion-md.md)]執行個體，但這省略命令指令碼提交到執行個體時。 [!INCLUDE[ssASnoversion](../../../includes/ssasnoversion-md.md)] 會在沒有警告或錯誤的情況下，忽略唯讀元素已修改的值。  
