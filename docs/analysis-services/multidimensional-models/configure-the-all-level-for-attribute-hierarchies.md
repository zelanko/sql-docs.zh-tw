...
helpviewer_keywords: 
  - "所有成員"
  - "IsAggregatable 屬性"
  - "最上層 [Analysis Services]"
  - "(全部) 層級"
  - "AttributeAllMemberName 屬性"
  - "層級 [Analysis Services]"
  - "成員 [Analysis Services], 全部"
  - "AllMemberName 屬性"
...
## 請參閱＜  
 [定義預設成員](../../analysis-services/multidimensional-models/define-a-default-member.md)  
