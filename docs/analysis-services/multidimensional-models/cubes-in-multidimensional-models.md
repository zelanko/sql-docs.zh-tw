...
ms.topic: "article"
helpviewer_keywords: 
  - "OLAP 物件 [Analysis Services], Cube"
  - "Cube [Analysis Services], 關於 Cube"
  - "Cube [Analysis Services]"
  - "OLAP [Analysis Services], Cube"
...
|階層|[建立使用者定義階層](../../analysis-services/multidimensional-models/create-user-defined-hierarchies.md)|  
