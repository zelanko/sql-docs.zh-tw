---
title: "在維度設計師中檢視屬性 | Microsoft Docs"
ms.custom: ""
ms.date: "03/04/2017"
...
|圖示|屬性使用方式|  
|----------|---------------------|  
|![屬性圖示](../../analysis-services/multidimensional-models/media/as-icon-attribute.png "屬性圖示")|Regular 或 AccountType|  
|![索引鍵屬性圖示](../../analysis-services/multidimensional-models/media/as-icon-key-attribute.png "索引鍵屬性圖示")|索引鍵|  
|![父屬性圖示](../../analysis-services/multidimensional-models/media/as-icon-parent-attribute.png "父屬性圖示")|父系|  
