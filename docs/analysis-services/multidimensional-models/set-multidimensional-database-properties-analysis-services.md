...
|MasterDataSource ID|與遠端資料分割一起使用。 如需詳細資訊，請參閱[遠端資料分割](../Topic/Remote%20Partitions.md)。|  
  
## 請參閱＜  
 [資料庫屬性對話方塊 &#40;SSAS - 多維度&#41;](../Topic/Database%20Properties%20Dialog%20Box%20\(SSAS%20-%20Multidimensional\).md)   
