...
-   開啟\<*專案名稱*> 以任何文字編輯器，並手動變更選項。 DeployPartitions，RetainPartitions PartitionDeployment 選項。 RoleDeployment 選項都 DeployRolesAndMembers、 DeployRolesRetainMembers、 RetainRoles。
