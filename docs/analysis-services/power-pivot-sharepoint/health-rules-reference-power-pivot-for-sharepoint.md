...
|[!INCLUDE[ssGemini_md](../../includes/ssgemini-md.md)]：Analysis Services 的 CPU 資源不足，無法執行所要求的作業。|是|否|SharePoint 2010|提供給 Analysis Services 處理序 (msmdsrv.exe) 使用的 CPU 資源數量不夠此伺服器上的活動層級使用。 請考慮將另一個 [!INCLUDE[ssGemini_md](../../includes/ssgemini-md.md)] for SharePoint 伺服器加入至陣列。 如需詳細資訊，請參閱 [部署檢查清單：將 Power Pivot 伺服器加入 SharePoint 2010 伺服器陣列，藉以向外延展](http://msdn.microsoft.com/library/2dbddcc7-427a-4537-a8e2-56d99b9d967d)。|  
