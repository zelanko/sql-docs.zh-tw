---
title: 將 BI 語意模型連接內容類型新增至程式庫 |Microsoft Docs
ms.date: 05/02/2018
ms.prod: sql
...
ms.locfileid: "68208357"
---
# <a name="add-bi-semantic-model-connection-content-type-to-library"></a>將 BI 語意模型連接內容類型新增至程式庫
