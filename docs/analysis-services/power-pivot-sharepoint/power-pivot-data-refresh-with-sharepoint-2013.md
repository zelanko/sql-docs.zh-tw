---
title: Power Pivot 資料重新整理與 SharePoint 2013 |Microsoft Docs
ms.date: 05/02/2018
ms.prod: sql
...
-   **支援的活頁簿：** 使用所建立的活頁簿[!INCLUDE[ssSQL11](../../includes/sssql11-md.md)][!INCLUDE[ssGemini](../../includes/ssgemini-md.md)]適用於 Excel 2010 增益集或 Excel 2013。 不支援在 Excel 2010 中使用 [!INCLUDE[ssKilimanjaro](../../includes/sskilimanjaro-md.md)][!INCLUDE[ssGemini](../../includes/ssgemini-md.md)] 增益集所建立的活頁簿。 請至少將活頁簿升級為 [!INCLUDE[ssSQL11](../../includes/sssql11-md.md)][!INCLUDE[ssGemini](../../includes/ssgemini-md.md)] 格式。 如需活頁簿升級的詳細資訊，請參閱[升級活頁簿和排程的資料重新整理 &#40;SharePoint 2013&#41;](../../analysis-services/instances/install-windows/upgrade-workbooks-and-scheduled-data-refresh-sharepoint-2013.md)。  
...
##  <a name="bkmk_moreinformation"></a> 其他資訊  
 ...
 [SharePoint 中的 excel Services](/sharepoint/dev/general-development/excel-services-in-sharepoint)。  
