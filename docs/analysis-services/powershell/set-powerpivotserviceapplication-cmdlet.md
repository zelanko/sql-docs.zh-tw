---
title: "Set-PowerPivotServiceApplication 指令程式 | Microsoft Docs"
ms.custom: ""
ms.date: "03/01/2017"
...
---
# Set-PowerPivotServiceApplication 指令程式
...
## 說明  
 ...
 若要確認變更，請執行下列 Cmdlet：Get-PowerPivotServiceApplication -Identity \<GUID> | format-list。  
...
### -AdministrationConnectionPoolSize \<整數>  
...
### -AllowCustomWindowsCredentials [\<切換參數>]  
...
### -DataRefreshFailureThreshold \<整數>  
...
### -DataRefreshInactiveWorkbooksThreshold \<整數>  
...
### -LoadsToConnectionsRatioCollectionInterval \<整數>  
...
### -LoadsToConnectionsRatioLimit \<整數>  
...
### -UsageExpectedResponseUpperLimit \<整數>  
...
### -UsageLongResponseUpperLimit \<整數>  
...
### -UsageQuickResponseUpperLimit \<整數>  
...
### -UsageTrivialResponseUpperLimit \<整數>  
