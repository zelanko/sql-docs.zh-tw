---
title: "Restore-ASDatabase 指令程式 | Microsoft Docs"
ms.custom: ""
ms.date: "03/07/2017"
...
### -Credential \<PSCredential>  
 ...
 如需驗證和認證使用方式的詳細資訊，請參閱 [Analysis Services 中的 PowerShell 指令碼](../../analysis-services/instances/powershell-scripting-in-analysis-services.md)。 如需 HTTP 存取的詳細資訊，請參閱[設定 Internet Information Services &#40;IIS&#41; 8.0 上 Analysis Services 的 HTTP 存取](../../analysis-services/instances/configure http access to analysis services on iis 8.0.md)。  
