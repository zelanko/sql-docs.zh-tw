...
### <a name="-serviceapplicationname-string"></a>-服務應用程式名稱\<字串 >  
 設定服務應用程式的顯示名稱。  
...
### <a name="-databaseservername-string"></a>-DatabaseServerName\<字串 >  
...
### <a name="-addtodefaultproxygroup-switch"></a>-AddToDefaultProxyGroup\<切換 >  
