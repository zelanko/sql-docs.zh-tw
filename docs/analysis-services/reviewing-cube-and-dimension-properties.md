...
## 另請參閱  
[在維度設計師中瀏覽維度資料](../analysis-services/multidimensional-models/browse-dimension-data-in-dimension-designer.md)  
