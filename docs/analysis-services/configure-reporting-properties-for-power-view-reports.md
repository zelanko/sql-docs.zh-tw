...
#### 若要隱藏 [Product Category] 和 [Product Subcategory] 資料表  
...
如需 [預設欄位集] 的詳細資訊，請參閱《SQL Server 線上叢書》中的[設定 Power View 報表的預設欄位集 &#40;SSAS 表格式&#41;](../analysis-services/tabular-models/configure-default-field-set-for-power-view-reports-ssas-tabular.md)。  
...
如需資料表行為屬性的詳細資訊，請參閱《SQL Server 線上叢書》中的[設定 Power View 報表的資料表行為屬性 &#40;SSAS 表格式&#41;](../analysis-services/tabular-models/configure-table-behavior-properties-for-power-view-reports-ssas-tabular.md)。  
...
## 重新部署 Adventure Works Internet Sales 表格式模型  
因為您已變更此模型，所以必須重新部署。 基本上來說，您將會重複[第 14 課：部署](../analysis-services/lesson-14-deploy.md)中所執行的工作。  
  
#### 若要重新部署 Adventure Works Internet Sales 表格式模型  
