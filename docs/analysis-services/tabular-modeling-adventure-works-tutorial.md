...
---
# 表格式模型化 (Adventure Works 教學課程)
本教學課程提供如何使用 [!INCLUDE[ssBIDevStudioFull](../includes/ssbidevstudiofull-md.md)] 建立 [!INCLUDE[ssCurrent](../includes/sscurrent-md.md)] Analysis Services 表格式模型的課程。  
...
-   [!INCLUDE[ssCurrent](../includes/sscurrent-md.md)] Analysis Services 執行個體 (以表格式模式執行)。  
  
-   [!INCLUDE[ssBIDevStudioFull](../includes/ssbidevstudiofull-md.md)]. [取得最新的版本。](https://msdn.microsoft.com/library/mt204009.aspx)  
  
-   Adventure Works DW 2014 範例資料庫。 這個範例資料庫包括完成本教學課程所需的資料。 若要下載範例資料庫，請移至 [http://go.microsoft.com/fwlink/?LinkID=335807](http://go.microsoft.com/fwlink/?LinkID=335807)。  
...
|[第 3 課：重新命名資料行](../analysis-services/lesson-3-rename-columns.md)|20 分鐘|  
|[第 4 課：標記為日期資料表](../analysis-services/lesson-4-mark-as-date-table.md)|3 分鐘|  
|[第 5 課：建立關聯性](../analysis-services/lesson-5-create-relationships.md)|10 分鐘|  
|[第 6 課：建立導出資料行](../analysis-services/lesson-6-create-calculated-columns.md)|15 分鐘|  
|[第 7 課：建立量值](../analysis-services/lesson-7-create-measures.md)|30 分鐘|  
|[第 8 課：建立關鍵效能指標](../analysis-services/lesson-8-create-key-performance-indicators.md)|15 分鐘|  
|[第 9 課：建立檢視方塊](../Topic/Lesson%209:%20Create%20Perspectives.md)|5 分鐘|  
|[第 10 課：建立階層](../analysis-services/lesson-10-create-hierarchies.md)|20 分鐘|  
|[第 11 課：建立資料分割](../analysis-services/lesson-11-create-partitions.md)|15 分鐘|  
|[第 12 課：建立角色](../analysis-services/lesson-12-create-roles.md)|15 分鐘|  
|[第 13 課：在 Excel 中進行分析](../analysis-services/lesson-13-analyze-in-excel.md)|20 分鐘|  
|[第 14 課：部署](../analysis-services/lesson-14-deploy.md)|5 分鐘|  
  
## 補充課程  
本教學課程也包含[補充課程](../Topic/Supplemental%20Lessons.md)。 本節中的主題並非完成教學課程所必須，但是能幫助您更了解進階表格式模型撰寫功能。  
  
|課程|估計完成時間|  
|----------|------------------------------|  
|[使用資料列篩選器實作動態安全性](../analysis-services/implement-dynamic-security-by-using-row-filters.md)|30 分鐘|  
|[設定 Power View 報表的報表屬性](../analysis-services/configure-reporting-properties-for-power-view-reports.md)|30 分鐘|  
