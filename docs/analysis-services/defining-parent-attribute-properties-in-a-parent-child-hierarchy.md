---
title: "定義父子式階層中父屬性 (Attribute) 的屬性 (Property) | Microsoft Docs"
ms.custom: ""
ms.date: "02/27/2017"
...
如需詳細資訊，請參閱[父子式維度](../analysis-services/multidimensional-models/parent-child-dimensions.md)及[父子式階層中的屬性](../analysis-services/multidimensional-models/attributes-in-parent-child-hierarchies.md)。  
...
10. ![顯��員工階層的樞紐分析表](../analysis-services/media/l4-employee-1.gif "顯��員工階層的樞紐分析表")  
...
5.  將 [Employees (員工)] 階層拖曳至 [資料列標籤] 區域中。  
    ...
    ![已修改的員工階層](../analysis-services/media/l4-employee-2.png "已修改的員工階層")  
