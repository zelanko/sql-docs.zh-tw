---
title: "定義和瀏覽 KPI | Microsoft Docs"
ms.custom: ""
ms.date: "02/27/2017"
...
1.  針對 [!INCLUDE[ssASnoversion](../includes/ssasnoversion-md.md)] 教學課程 Cube，開啟 [Cube 設計師]，然後按一下 [KPI] 索引標籤。  
    ...
    ![Cube 設計師的 KPI 索引標籤](../analysis-services/media/l7-kpi-1.gif "Cube 設計師的 KPI 索引標籤")  
  
2.  在 [KPI] 索引標籤的工具列上，按一下 [新增 KPI] 按鈕。  
  
    顯示窗格中會出現一個空白的 KPI 範本，如下圖所示。  
  
    ![顯示窗格中的空白 KPI 範本](../analysis-services/media/l7-kpi-2.gif "顯示窗格中的空白 KPI 範本")  
