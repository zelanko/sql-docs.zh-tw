...
若要完成這一課，Excel 必須安裝在與 SSDT 相同的電腦上。 如需詳細資訊，請參閱 [[在 Excel 中進行分析]](../tabular-models/analyze-in-excel-ssas-tabular.md)所在電腦上安裝 Excel。  
  
估計的時間才能完成這一課：**20 分鐘的時間**  
  
## <a name="prerequisites"></a>先決條件  
本主題是表格式模型教學課程的一部分，必須依序完成。 執行工作之前在這一課，您應已完成上一課：[第 11 課：建立角色](lesson-11-create-roles.md)。  
...
請移至下一課：[第 13 課：部署](lesson-13-deploy.md)。
