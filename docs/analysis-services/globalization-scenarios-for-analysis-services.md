---
title: "Analysis Services 的全球化案例 | Microsoft Docs"
ms.custom: 
  - "SQL2016_New_Updated"
ms.date: "03/01/2017"
...
ms.topic: "article"
helpviewer_keywords: 
  - "多種語言支援 [Analysis Services]"
  - "語言 [Analysis Services]"
  - "SSAS, 國際考量"
  - "國際性考量 [Analysis Services]"
  - "全球性考量 [Analysis Services]"
  - "SQL Server Analysis Services, 國際化考量"
  - "Analysis Services，國際性考量"
...
-   開發和生產環境位於不同的國家/地區。 在一個國家/地區開發方案，再部署至另一個國家/地區，變得愈來愈普遍。 如果您負責準備將使用某種語言開發的方案，部署至使用不同語言套件的伺服器，就必須了解如何設定語言和定序屬性。 設定這些屬性可讓您覆寫繼承並取自原始主機系統的預設值。 如需設定屬性的詳細資訊，請參閱[語言和定序 &#40;Analysis Services&#41;](../analysis-services/languages-and-collations-analysis-services.md)。  
