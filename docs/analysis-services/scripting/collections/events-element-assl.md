...
[!INCLUDE[ssas-appliesto-sqlas](../../../includes/ssas-appliesto-sqlas.md)]定義集合[事件](../../../analysis-services/scripting/objects/event-element-assl.md)所擷取的項目[追蹤](../../../analysis-services/scripting/objects/trace-element-assl.md)。  
