---
title: TimeAttributeBinding 資料類型 (ASSL) |Microsoft 文件
ms.custom: ''
ms.date: 03/03/2017
...
[!INCLUDE[ssas-appliesto-sqlas](../../../includes/ssas-appliesto-sqlas.md)]定義代表產生的資料的項目，例如伺服器時間維度中的屬性索引鍵資料行的繫結的 「 預留位置 」 的衍生的資料類型。  
...
## <a name="remarks"></a>備註  
 ...
 分析管理物件 (AMO) 物件模型中的對應元素是<xref:Microsoft.AnalysisServices.TimeAttributeBinding>。  
