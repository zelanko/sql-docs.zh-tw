...
[!INCLUDE[ssas-appliesto-sqlas](../../../includes/ssas-appliesto-sqlas.md)]識別[Cube](../../../analysis-services/scripting/objects/cube-element-assl.md)元素相關聯[繫結](../../../analysis-services/scripting/data-type/binding-data-type-assl.md)項目。  
...
## <a name="remarks"></a>備註  
 對應至父系的項目**CubeID**在 「 分析管理物件 (AMO) 物件模型是<xref:Microsoft.AnalysisServices.CubeAttributeBinding>， <xref:Microsoft.AnalysisServices.CubeDimensionBinding>，和<xref:Microsoft.AnalysisServices.MeasureGroupBinding>。  
