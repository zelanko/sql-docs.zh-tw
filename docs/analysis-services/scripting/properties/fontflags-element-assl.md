...
## <a name="remarks"></a>備註  
 **FontFlags**屬性包含多維度運算式 (MDX) 運算式，並套用至**CalculationProperty**項目具有[CalculationType](../../../analysis-services/scripting/properties/calculationtype-element-assl.md)的*成員*或*儲存格*。  
