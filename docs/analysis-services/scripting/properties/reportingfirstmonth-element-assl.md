---
title: ReportingFirstMonth 元素 (ASSL) |Microsoft 文件
ms.custom: ''
ms.date: 03/06/2017
...
[!INCLUDE[ssas-appliesto-sqlas](../../../includes/ssas-appliesto-sqlas.md)]定義的第一個報表月份[TimeBinding](../../../analysis-services/scripting/data-type/timebinding-data-type-assl.md)項目。  
...
## <a name="remarks"></a>備註  
 對應目的父代的項目**ReportingFirstMonth**在 「 分析管理物件 (AMO) 物件模型而言， <xref:Microsoft.AnalysisServices.TimeBinding>。  
