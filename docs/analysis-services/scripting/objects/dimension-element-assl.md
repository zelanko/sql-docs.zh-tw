...
|上階或父系|資料類型|  
|------------------------|---------------|  
|[資料庫](../../../analysis-services/scripting/objects/database-element-assl.md)|[維度](../../../analysis-services/scripting/data-type/dimension-data-type-assl.md)|  
...
|關聯性|元素|  
|------------------|-------------|  
|父元素|[維度](../../../analysis-services/scripting/collections/dimensions-element-assl.md)|  
|子元素|無|  
