...
[!INCLUDE[ssas-appliesto-sqlas](../../../includes/ssas-appliesto-sqlas.md)]定義屬於特定的權限[角色](../../../analysis-services/scripting/objects/role-element-assl.md)特定資料庫維度或 cube 維度的項目。  
