...
-   資料類型，例如**繫結**和**權限**，可用於定義子項目和其他物件的屬性。  
    ...
    > [!NOTE]  
    >  本章節並未涵蓋資料類型元素。 如需詳細資訊，請參閱， [Analysis Services 指令碼語言 XML 資料類型 &#40;ASSL &#41;](../../analysis-services/scripting/data-type/analysis-services-scripting-language-xml-data-types-assl.md).  
