...
ms.topic: "reference"
helpviewer_keywords: 
  - "SQMSupportEnabled 屬性"
  - "ComUdfEnabled 屬性"
  - "LinkToOtherInstanceEnabled 屬性"
  - "ManagedCodeEnabled 屬性"
  - "ConnStringEncryptionEnabled 屬性"
  - "LinkFromOtherInstanceEnabled 屬性"
  - "LinkInsideInstanceEnabled 屬性"
  - "UseCachedPageAllocators 屬性"
