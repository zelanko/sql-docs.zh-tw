---
title: "SQL Server Management Studio 中的 Analysis Services 指令碼專案 | Microsoft Docs"
ms.custom: ""
ms.date: "03/14/2017"
...
ms.topic: "article"
helpviewer_keywords: 
  - "指令碼 [Analysis Services]"
  - "指令碼 [Analysis Services], 專案"
  - "專案 [Analysis Services], Analysis Server 指令碼專案"
  - "專案 [Analysis Services], 建立"
  - "Analysis Server 指令碼專案"
...
3.  以滑鼠右鍵按一下 [查詢]，在方案總管中於 Analysis Server 指令碼專案的 [指令碼] 資料夾裡建立多維度運算式 (MDX)、資料採礦延伸模組 (DMX)，以及 XML for Analysis (XMLA) 指令碼。 如需詳細資訊，請參閱[在 Analysis Services 中編寫管理工作的指令碼](../../analysis-services/instances/script-administrative-tasks-in-analysis-services.md)。  
