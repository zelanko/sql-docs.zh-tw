---
title: "判斷 Analysis Services 執行個體的伺服器模式 | Microsoft Docs"
ms.custom: ""
ms.date: "03/03/2017"
...
## 物件總管中的伺服器圖示  
 ...
 ![每個伺服器模式的物件總管圖示](../../analysis-services/instances/media/ssas-ssms-servermodes.gif "每個伺服器模式的物件總管圖示")  
  
## 檢視 MSMDSRV.INI 檔案中的 DeploymentMode 屬性  
