...
ms.topic: "article"
helpviewer_keywords: 
  - "Analysis Services 物件, 指令碼"
  - "物件 [Analysis Services], 指令碼"
  - "指令碼 [Analysis Services], 物件"
...
## 在 Management Studio 中編寫 Analysis Services 物件的指令碼  
...
## 請參閱＜  
 ...
 [XMLA 查詢編輯器 &#40;Analysis Services - 多維度資料&#41;](../Topic/XMLA%20Query%20Editor%20\(Analysis%20Services%20-%20Multidimensional%20Data\).md)  
