...
ms.locfileid: "52516378"
---
# <a name="checklist-use-powershell-to-verify-power-pivot-for-sharepoint"></a>檢查清單：使用 PowerShell 驗證 Power Pivot for SharePoint
 ...
 **排程的資料重新整理：** 設定重新整理排程活頁簿**並且重新整理儘速**。  如需詳細資訊，請參閱的 < 確認資料重新整理 > 一節[排程資料重新整理和資料來源，執行不支援 Windows 驗證&#40;Power Pivot for SharePoint&#41;](../../../analysis-services/power-pivot-sharepoint/schedule-data-refresh-and-data-sources-no-windows-authentication.md)。  
