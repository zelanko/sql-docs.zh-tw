...
---
# 設定 Analysis Services 及 Kerberos 限制委派 (KCD)
...
## 案例 1︰以活頁簿作為資料來源 (WDS)。  
 ![see 1](../../../analysis-services/instances/install-windows/media/ssas-callout1.png "see 1") Office Online Server 會開啟 Excel 活頁簿，![see 2](../../../analysis-services/instances/install-windows/media/ssas-callout2.png "see 2") 則偵測到另一個活頁簿的資料連線。 Office Online Server 將要求傳送到 [!INCLUDE[ssGemini](../../../includes/ssgemini-md.md)] 重新導向程式服務 ![see 3](../../../analysis-services/instances/install-windows/media/ssas-callout3.png "see 3")，以開啟第二個活頁簿及資料 ![see 4](../../../analysis-services/instances/install-windows/media/ssas-callout4.png "see 4")。  
...
### 2016 SQL Server 資料庫引擎和 Power Pivot 模式的 Analysis services  
 以下摘要說明要在 [!INCLUDE[ssNoVersion](../../../includes/ssnoversion-md.md)] 電腦上安裝的項目。  
  
 ![附註](../../../analysis-services/instances/install-windows/media/ssrs-fyi-note.png "附註") 在 [!INCLUDE[ssASnoversion](../../../includes/ssasnoversion-md.md)] 安裝精靈中，特徵選取工作流程安裝了 PowerPivot 模式的 [!INCLUDE[ssCurrent](../../../includes/sscurrent-md.md)]。  
  
1.  執行 [!INCLUDE[ssCurrent](../../../includes/sscurrent-md.md)] 安裝精靈，然後從特徵選取頁面依序按一下資料庫引擎、[!INCLUDE[ssASnoversion](../../../includes/ssasnoversion-md.md)] 及管理工具。 您可在安裝精靈稍後的安裝中，對 [!INCLUDE[ssASnoversion](../../../includes/ssasnoversion-md.md)] 指定 [!INCLUDE[ssGemini](../../../includes/ssgemini-md.md)] 模式。  
...
4.  請注意，根據預設，搜尋中不包括 “Computer” 物件類型。 按一下 ![click objects to add computer account](../../../analysis-services/instances/install-windows/media/ss-objects-button.png "click objects to add computer account") 新增 Computers 物件。  
...
5.  設定「對 Windows Token 服務的宣告」(C2WTS)，**此為案例 1 所需**。 如需詳細資訊，請參閱[對 Windows Token 服務的宣告 (C2WTS) 概觀](https://msdn.microsoft.com/en-us/library/ee517278.aspx)。  
...
6.  設定 Kerberos 的 SharePoint 驗證提供者。 **此為案例 1 所需**。 如需詳細資訊，請參閱 [Plan for Kerberos authentication in SharePoint 2013](https://technet.microsoft.com/en-us/library/ee806870.aspx) (規劃 SharePoint 2013 的 Kerberos 驗證)。  
