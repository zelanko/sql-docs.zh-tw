---
title: "中斷 Analysis Services 伺服器上的使用者和工作階段連接 | Microsoft Docs"
ms.custom: ""
ms.date: "03/06/2017"
...
ms.topic: "article"
helpviewer_keywords: 
  - "結束使用者活動 [Analysis Services]"
  - "連接 [Analysis Services]"
  - "工作階段 [Analysis Services]"
...
2.  按 F5 執行取消命令。  
 ...
 如需本主題中所參考之 XMLA 的詳細資訊，請參閱 [Execute 方法 &#40;XMLA&#41;](../Topic/Execute%20Method%20\(XMLA\).md) 和 [Cancel 元素 &#40;XMLA&#41;](../../analysis-services/xmla/xml-elements-commands/cancel-element-xmla.md)。  
