...
-   在 [資料分割] 對話方塊的 [資料分割] 清單中，使用 Ctrl 再按一下以選取您要合併的資料分割，然後按一下 [合併] 按鈕。  
...
## 請參閱＜  
 ...
 [處理表格式模型資料分割 &#40;SSAS 表格式&#41;](../../analysis-services/tabular-models/process-tabular-model-partitions-ssas-tabular.md)  
