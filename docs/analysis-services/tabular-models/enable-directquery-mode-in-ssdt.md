...
[!INCLUDE[ssas-appliesto-sqlas-aas](../../includes/ssas-appliesto-sqlas-aas.md)]本主題中，我們將說明如何啟用 DirectQuery 模式中的表格式模型專案[!INCLUDE[ssBIDevStudio](../../includes/ssbidevstudio-md.md)]。  
