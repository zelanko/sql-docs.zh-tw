...
|主題|說明|  
|-----------|-----------------|  
|[設定 Power View 報表的預設欄位集 &#40;SSAS 表格式&#41;](../../analysis-services/tabular-models/power-view-configure-default-field-set-for-reports.md)|描述如何設定預設欄位集，這是預先定義的資料行和量值的清單，當您選取報表欄位清單中的資料表時，此清單會自動加入至 [!INCLUDE[ssCrescent](../../includes/sscrescent-md.md)] 報表畫布。|  
