...
# [設定 Power View 報表的預設欄位集](configure-default-field-set-for-power-view-reports-ssas-tabular.md)
# [從 SQL Server 資料工具部署](deploy-from-sql-server-data-tools-ssas-tabular.md)
...
# [在 DirectQuery 模式中定義分割區](define-partitions-in-directquery-models-ssas-tabular.md)
# [雙向交叉篩選](bi-directional-cross-filters-tabular-models-analysis-services.md)
# [將資料行加入至資料表](add-columns-to-a-table-ssas-tabular.md)
# [建立導出資料行](create-a-calculated-column-ssas-tabular.md)
...
# [將範例資料加入 DirectQuery 模型中](add-sample-data-to-a-directquery-model-in-design-mode.md)
...
# [設定 Power View 報表的資料表行為屬性](configure-table-behavior-properties-for-power-view-reports-ssas-tabular.md)
