...
### [設定預設的資料模型和部署屬性](configure-default-data-modeling-and-deployment-properties-ssas-tabular.md)  
...
### [指定「標記為日期資料表」以搭配時間智慧使用](specify-mark-as-date-table-for-use-with-time-intelligence-ssas-tabular.md)  
...
# [部署表格式模型解決方案](tabular-model-solution-deployment-ssas-tabular.md)  
...
## [連線到表格式模型資料庫](connect-to-a-tabular-model-database-ssas.md)  
