---
title: "從 Power Pivot 匯入 (SSAS 表格式) | Microsoft Docs"
ms.custom: ""
ms.date: "03/01/2017"
...
---
# 從 Power Pivot 匯入 (SSAS 表格式)
  本主題描述如何使用 [!INCLUDE[ssBIDevStudioFull](../../includes/ssbidevstudiofull-md.md)] 的 [從 [!INCLUDE[ssGemini](../../includes/ssgemini-md.md)] 匯入] 專案範本，從 [!INCLUDE[ssGemini](../../includes/ssgemini-md.md)] 活頁簿匯入中繼資料和資料，以建立新的表格式模型專案。  
  
## 從 Power Pivot for Excel 檔案建立新的表格式模型  
...
#### 若要從 Power Pivot for Excel 檔案建立新的表格式模型專案  
...
## 請參閱＜  
 ...
 [複製及貼上資料 &#40;SSAS 表格式&#41;](../../analysis-services/tabular-models/copy-and-paste-data-ssas-tabular.md)  
