...
|主題|Description|  
|-----------|-----------------|  
|[建立及管理工作空間資料庫中的資料分割](../../analysis-services/tabular-models/create-and-manage-partitions-in-the-workspace-database-ssas-tabular.md)|描述如何建立及管理模型工作空間資料庫中的資料分割在 SSDT 中使用資料分割管理員。|  
