---
title: "表格式模型資料庫 (SSAS 表格式) |Microsoft 文件"
ms.custom: 
ms.date: 05/22/2017
...
ms.openlocfilehash: a93c765d376aa0ff664c730196175784e88fe775
...
[!INCLUDE[ssas-appliesto-sqlas-aas](../../includes/ssas-appliesto-sqlas-aas.md)]表格式模型資料庫是 Analysis Services 資料庫中建立[!INCLUDE[ssBIDevStudioFull](../../includes/ssbidevstudiofull-md.md)]使用 Analysis Services 表格式模型專案範本，資料表和關聯性用於表示資料的主要結構。  
...
## <a name="in-this-section"></a>本節內容  
 ...
 [表格式模型角色](../../analysis-services/tabular-models/tabular-model-roles-ssas-tabular.md)  
