---
title: "SQL Server 2016 Analysis Services 中適用於表格式模型的雙向交叉篩選 | Microsoft Docs"
ms.custom: 
  - "SQL2016_New_Updated"
ms.date: "03/07/2017"
...
---
# SQL Server 2016 Analysis Services 中適用於表格式模型的雙向交叉篩選
 ...
 在 SSDT 中，設定交叉篩選的機制是透過資料表關聯性對話方塊中的 [篩選方向] 選項。 這項功能僅適用於 [SQL Server Data Tools for Visual Studio 2015 (SSDT)](http://go.microsoft.com/fwlink/p/?LinkID=627574) 建立在 1200 相容性層級中的表格式模型。  
...
4.  確認模型相容性層級設定為 [SQL Server 2016 RTM (1200)]。  
...
## 請參閱＜  
 ...
 [如何在 Power Pivot 和 SSAS 表格式模型中處理簡單多對多關聯性的實用範例](http://social.technet.microsoft.com/wiki/contents/articles/22202.a-practical-example-of-how-to-handle-simple-many-to-many-relationships-in-power-pivotssas-tabular-models.aspx)   
