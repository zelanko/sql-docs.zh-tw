...
ms.locfileid: "68207691"
---
# <a name="directquery-mode"></a>DirectQuery 模式
[!INCLUDE[ssas-appliesto-sqlas-aas](../../includes/ssas-appliesto-sqlas-aas.md)]
  這篇文章說明*DirectQuery 模式*1200年及以上的相容性層級的 Analysis Services 表格式模型。 您可以針對在 SSDT 中設計的模型開啟 DirectQuery 模式；或者，針對已部署的表格式模型，則可以在 SSMS 中變更為 DirectQuery 模式。 選擇 DirectQuery 模式之前，請務必了解優點與限制。
...
-   DirectQuery 可以利用提供者端的查詢加速功能，例如提供的記憶體最佳化資料行索引。  
...
相容性層級 1200年及以上的 DirectQuery 表格式模型會與下列資料來源和提供者相容：
...
## <a name="additional-articles-in-this-section"></a>在本節中的其他文章
