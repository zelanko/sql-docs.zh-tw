---
title: "建立導出資料表 (SSAS 表格式) | Microsoft Docs"
ms.custom: 
  - "SQL2016_New_Updated"
ms.date: "03/01/2017"
...
1.  首先，確認表格式模型具有 1200 的相容性層級。 您可以檢查 SSDT 中模型上的 **相容性層級** 屬性。  
...
## 請參閱＜  
 ...
 [Analysis Services 中的資料分析運算式 &#40;DAX&#41;](../Topic/Data%20Analysis%20Expressions%20\(DAX\)%20in%20Analysis%20Services.md)   
