---
title: 變更 Analysis Services 表格式模型資料表、 資料行或資料列篩選對應 |Microsoft Docs
ms.date: 05/07/2018
ms.prod: sql
...
ms.locfileid: "68207750"
---
# <a name="change-table-column-or-row-filter-mappings"></a>變更資料表、資料行或資料列篩選對應 
[!INCLUDE[ssas-appliesto-sqlas-aas](../../includes/ssas-appliesto-sqlas-aas.md)]
  這篇文章說明如何使用變更資料表、 資料行或資料列篩選對應**編輯資料表屬性** 對話方塊中的[!INCLUDE[ssBIDevStudio](../../includes/ssbidevstudio-md.md)]。  
...
> [!NOTE]  
>  如果您的資料表有多個資料分割，您無法使用 [編輯資料表屬性] 對話方塊變更資料列篩選對應。 若要針對具有多個資料分割的資料表變更資料列篩選對應，請使用資料分割管理員。 如需詳細資訊，請參閱 <<c0> [ 分割區](../../analysis-services/tabular-models/partitions-ssas-tabular.md)。  
