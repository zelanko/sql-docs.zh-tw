...
3.  從 [中繼資料] 窗格的 [地理位置]  維度中，將 [地理位置]  使用者定義階層拖曳到 [資料] 窗格的 [將列欄位拖曳到這裡]  區域。  
    ...
    ![建立維度的轉售商銷售-銷售量 量值](../media/l5-referencedrelationship-1.gif "建立維度 Reseller Sales-sales Amount 量值")  
...
8.  按一下省略符號按鈕 ( **...** ) 中**全名**交集處的儲存格**客戶**維度和**網際網路銷售**量值群組。  
    ...
    ![定義關聯性 對話方塊](../media/l5-referencedrelationship-4.gif "定義關聯性對話方塊")  
...
3.  在 [中繼資料] 窗格中，展開 [轉售商地理位置]  以滑鼠右鍵按一下 [地理位置]  ，然後按一下 [加入至資料列區域]  。  
    ...
    ![定義關聯性 對話方塊](../media/l5-referencedrelationship-5.gif "定義關聯性對話方塊")  
