...
8.  在 [翻譯資料行]  清單中選取 **SpanishMonthName**，如下圖所示。  
    ...
    ![屬性資料翻譯對話方塊](../media/l9-translations-4.gif "屬性資料翻譯對話方塊")  
...
1.  切換到 [!INCLUDE[ssASnoversion](../../includes/ssasnoversion-md.md)] 教學課程 Cube 的 Cube 設計師，然後再切換到 [翻譯]  索引標籤。  
    ...
    ![預設的翻譯索引標籤中的語言](../media/l9-translations-5.gif "預設翻譯索引標籤中的語言")  
...
5.  在工具列上，選取 [語言]  清單中的 [西班牙文 (西班牙)]  。  
    ...
    ![Repopulated 中繼資料 窗格](../media/l9-translations-6.gif "Repopulated 中繼資料 窗格")  
...
9. 在 [中繼資料] 窗格中，以滑鼠右鍵按一下 [Mes del Ano]  ，然後選取[加入至查詢]  。  
    ...
    ![在資料窗格中的西班牙文月份名稱](../media/l9-translations-7.gif "資料窗格中的，以西班牙文月份名稱")  
...
[Cube 翻譯](../multidimensional-models-olap-logical-cube-objects/cube-translations.md)  
[Analysis Services 中的翻譯支援](../translation-support-in-analysis-services.md)  
