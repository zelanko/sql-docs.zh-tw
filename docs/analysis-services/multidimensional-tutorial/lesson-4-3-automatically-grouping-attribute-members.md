...
5.  在 [屬性] 視窗中，將 [DiscretizationMethod] 屬性的值變更為 [自動]，再將 [DiscretizationBucketCount] 屬性的值變更為 [5]。  
    ...
    ![修改屬性的 Yearly Income](../media/l4-discretizationmethod-1.gif "修改 Yearly Income 屬性")  
...
9. 在此欄位清單中，依序展開 [員工] 維度和 [組織]，然後將 [病假時數] 拖曳至 [資料行標籤]。  
    ...
    ![依員工病假時數建立維度的銷售保留小時](../media/l4-discretizationmethod-2.gif "依員工病假時數建立維度的銷售保留時數")  
