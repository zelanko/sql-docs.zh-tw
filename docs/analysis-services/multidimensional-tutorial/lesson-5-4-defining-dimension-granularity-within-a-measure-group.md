...
5.  展開 [銷售領域]  維度，然後將 [銷售領域]  使用者定義階層拖曳至 [資料列標籤]。  
    ...
    ![銷售區域 cube 維度](../media/l5-granularity-2.gif "銷售區域 cube 維度")  
...
7.  在樞紐分析表欄位清單中，選取 [銷售領域]  使用者定義階層，然後按一下右側的向下箭號。  
    ...
    ![在欄位清單中的銷售領域階層](../media/l5-granularity-1a.png "欄位清單中的銷售領域階層")  
  
8.  在篩選中，按一下 [全選] 核取方塊以清除所有選取項目，然後只選擇 [北美洲]  。  
  
    ![篩選窗格來選取北美](../media/l5-granularity-1b.png "來選取北美的篩選窗格")  
...
11. 在樞紐分析表上，按一下 [資料列標籤] 旁邊的向下鍵。 清除 [FY 2008]  之外的所有年份。  
    ...
    ![值的銷售金額配額](../media/l5-granularity-3.png "值 Sales Amount，配額")  
...
8.  依序展開 [FY 2008]  、[H1 FY 2008]  和 [Q1 FY 2008]  。  
    ...
    ![銷售配額量值群組已正確建立維度](../media/l5-granularity-7.gif "已正確建立維度的銷售配額量值群組")  
