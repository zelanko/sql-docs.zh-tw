...
4.  在 [屬性] 視窗中，針對已選取的屬性，將 **AttributeHierarchyEnabled** 屬性的值設為 **False**。  
    ...
    ![AttributeHierarchyEnabled 屬性設為 False](../media/l4-hierarchyenabled-1.gif "AttributeHierarchyEnabled 屬性設為 False")  
...
4.  在 [屬性] 視窗中，針對已選取的屬性，將 **AttributeHierarchyVisible** 屬性的值設為 **False** 。  
    ...
    ![AttributeHierarchyVisible 屬性設為 False](../media/l4-hierarchyvisible-1.gif "AttributeHierarchyVisible 屬性設為 False")  
