...
2.  在左窗格的 [組態屬性]  節點中，按一下 [部署]  。  
    ...
    > [!NOTE]  
    > 如果您想要將專案部署至的具名執行個體[!INCLUDE[ssASnoversion](../../includes/ssasnoversion-md.md)]的本機電腦上，或遠端伺服器上的執行個體中，變更**伺服器**屬性，以適當的執行個體名稱，例如\< **ServerName**>\\\<**InstanceName**>。  
