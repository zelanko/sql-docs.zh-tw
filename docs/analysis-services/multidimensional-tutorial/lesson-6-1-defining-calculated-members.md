...
1.  開啟適用於 [!INCLUDE[ssASnoversion](../../includes/ssasnoversion-md.md)] 教學課程 Cube 的 Cube 設計師，然後按一下 [計算] 索引標籤。  
    ...
    ![計算索引標籤，Cube 設計師](../media/l6-calculatedmembers-1.gif "計算索引標籤，Cube 設計師 的")  
...
2.  在 [計算] 索引標籤的工具列上，按一下 [新增導出成員]。  
    ...
    ![計算運算式窗格表單](../media/l6-calculatedmembers-02.gif "計算運算式窗格表單")  
  
3.  在 [名稱] 方塊中，將導出量值的名稱，改為**總銷售量**。  
...
9. 在 [非空白行為] 清單中，勾選 [網際網路銷售 - 銷售量] 和 [轉售商銷售 - 銷售量] 的核取方塊，然後按一下 [確定]。  
    ...
    ![Populated 計算運算式 窗格](../media/l6-calculatedmembers-03.gif "填入計算運算式 窗格")  
...
11. 在計算指令碼的 **Calculate;** 命令之後、剛新增的計算指令碼之前，新增一行，然後把下列文字新增到指令碼的那一行：  
    ...
    ![在 [計算運算式] 窗格中的指令碼](../media/l6-calculatedmembers-04.gif "計算運算式窗格中的指令碼")  
...
17. 在計算指令碼的 [網際網路毛利率] 計算正前方新增一行，然後把下列文字新增至指令碼的那一行：  
    ...
    ![在 [計算運算式] 窗格中的新計算](../media/l6-calculatedmembers-05.gif "計算運算式窗格中的新計算")  
...
8.  將 [總毛利率]、[網際網路毛利率] 和 [轉售商毛利率] 量值新增至 [值] 區域中，然後檢閱結果。  
    ...
    ![顯示轉售商銷售的 [資料] 窗格](../media/l6-calculatedmembers-7b.gif "顯示轉售商銷售的 [資料] 窗格")  
