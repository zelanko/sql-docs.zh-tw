...
ms.topic: "article"
helpviewer_keywords: 
  - "Business Intelligence Development Studio, 翻譯 [Analysis Services]"
  - "翻譯 [Analysis Services], 關於翻譯"
  - "物件翻譯 [Analysis Services]"
  - "語言識別碼 [Analysis Services]"
  - "屬性翻譯 [Analysis Services]"
...
> [!TIP]  
>  您可以使用用戶端應用程式 (例如 Excel、Management Studio 和 SQL Server Profiler) 來傳回翻譯的字串。 如需詳細資訊，請參閱 [Globalization Tips and Best Practices &#40;Analysis Services&#41;](../analysis-services/globalization-tips-and-best-practices-analysis-services.md) (全球化秘訣和最佳做法 (Analysis Services))。  
  
## 如何將翻譯的中繼資料加入 Analysis Services 模型中  
 請前往下列連結取得逐步指示：  
