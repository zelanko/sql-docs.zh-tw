---
title: azdata bdc pool 參考
titleSuffix: SQL Server big data clusters
description: azdata bdc pool 命令的參考文章。
author: MikeRayMSFT
ms.author: mikeray
...
ms.locfileid: "69653680"
---
# <a name="azdata-bdc-pool"></a>azdata bdc pool

[!INCLUDE[tsql-appliesto-ssver15-xxxx-xxxx-xxx](../includes/tsql-appliesto-ssver15-xxxx-xxxx-xxx.md)]

下列文章提供 **azdata** 工具中 **bdc pool** 命令的參考。 如需其他 **azdata** 命令的詳細資訊，請參閱 [azdata 參考](reference-azdata.md)。

## <a name="commands"></a>命令
|     |     |
| --- | --- |
[azdata bdc pool status](reference-azdata-bdc-pool-status.md) | 集區狀態命令。
