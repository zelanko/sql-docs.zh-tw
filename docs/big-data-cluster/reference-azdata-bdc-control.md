---
title: azdata bdc control 參考
titleSuffix: SQL Server big data clusters
description: azdata bdc control 命令的參考文章。
author: MikeRayMSFT
ms.author: mikeray
...
ms.locfileid: "74821448"
---
# <a name="azdata-bdc-control"></a>azdata bdc control

[!INCLUDE[tsql-appliesto-ssver15-xxxx-xxxx-xxx](../includes/tsql-appliesto-ssver15-xxxx-xxxx-xxx.md)]  

下文提供 `bdc control` 工具中 `azdata` 命令的參考。 如需其他 `azdata` 命令的詳細資訊，請參閱 [azdata 參考](reference-azdata.md)

## <a name="commands"></a>命令
|     |     |
| --- | --- |
[azdata bdc control status](reference-azdata-bdc-control-status.md) | 控制服務狀態命令。
