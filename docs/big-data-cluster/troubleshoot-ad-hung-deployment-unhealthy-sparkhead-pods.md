...
description: 使用狀況不良的 `sparkhead` Pod 對 Active Directory 網域中沒有反應的 SQL Server 巨量資料叢集部署進行疑難排解。
author: macarv-ms
ms.author: macarv
ms.reviewer: mikeray
ms.date: 08/20/2020
...
## <a name="check-the-hdfs-and-sparkservices"></a>檢查 HDFS 和 Spark 服務 
...
:::image type="content" source="media/troubleshoot-ad-hung-deployment-unhealthy-sparkhead-pods/missing_reverse_lookup_zone_entry_for_domain_controller_add.png" alt-text="遺失網域控制站的反向對應區域項目":::
