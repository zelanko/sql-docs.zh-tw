...
ms.locfileid: "73532056"
---
# <a name="install-azdata-for-includebig-data-clusters-2019includesssbigdataclusters-ss-novermd-using-pip"></a>使用 `pip` 安裝 `azdata`，以[!INCLUDE[big-data-clusters-2019](../includes/ssbigdataclusters-ss-nover.md)]
...
1. 您先前如有安裝任何舊版的 `azdata`，請務必先解除安裝，然後再安裝最新版本。
