...
description: 本文描述 SQL Server 巨量資料叢集的控制器。
...
ms.locfileid: "92914332"
---
# <a name="what-is-the-controller-on-a-sql-server-big-data-cluster"></a>什麼是 SQL Server 巨量資料叢集上的控制器？

[!INCLUDE[SQL Server 2019](../includes/applies-to-version/sqlserver2019.md)]

控制器會裝載部署和管理 SQL Server 巨量資料叢集所用的核心邏輯。 其負責與 Kubernetes、SQL Server 執行個體 (為叢集的一部分) 和其他元件 (例如 HDFS 和 Spark) 的互動。
...
> [!NOTE]
> 您必須提供符合 [SQL Server 密碼複雜性需求](../relational-databases/security/password-policy.md)的密碼。
...
- [工作坊：Microsoft [!INCLUDE[big-data-clusters-2019](../includes/ssbigdataclusters-ss-nover.md)]架構](https://github.com/microsoft/sqlworkshops-bdc) \(英文\)