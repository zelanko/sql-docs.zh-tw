---
title: 監視使用叢集系統管理入口網站的叢集 |Microsoft Docs
description: ''
author: yualan
ms.author: alayu
manager: craigg
...
> [!NOTE]
> 那里會存取網頁，因為我們使用自動產生的 SSL 憑證時，會出現安全性警告。 在未來版本中，我們將提供的功能，可提供您自己的簽署的憑證。
