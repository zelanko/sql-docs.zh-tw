...
ms.locfileid: "70158083"
---
# <a name="azdata-bdc-hdfs-status"></a>azdata bdc hdfs 狀態
...
|     |     |
| --- | --- |
[azdata bdc hdfs 狀態顯示](#azdata-bdc-hdfs-status-show) | Hdfs 服務狀態。
## <a name="azdata-bdc-hdfs-status-show"></a>azdata bdc hdfs 狀態顯示
Hdfs 服務狀態。
```bash
