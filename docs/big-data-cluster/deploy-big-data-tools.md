...
| **Azure CLI**<sup>2</sup> | 對於 AKS | 用於管理 Azure 服務的新式命令列介面。 與 AKS 巨量資料叢集部署搭配使用 ([詳細資訊](/cli/azure/?view=azure-cli-latest&preserve-view=true))。 | [安裝](/cli/azure/install-azure-cli?view=azure-cli-latest&preserve-view=true) |
