---
title: azdata bdc sql 參考
titleSuffix: SQL Server big data clusters
description: azdata bdc sql 命令的參考文章。
author: MikeRayMSFT
ms.author: mikeray
...
ms.locfileid: "74821026"
---
# <a name="azdata-bdc-sql"></a>azdata bdc sql

[!INCLUDE[tsql-appliesto-ssver15-xxxx-xxxx-xxx](../includes/tsql-appliesto-ssver15-xxxx-xxxx-xxx.md)]  

下文提供 `bdc sql` 工具中 `azdata` 命令的參考。 如需其他 `azdata` 命令的詳細資訊，請參閱 [azdata 參考](reference-azdata.md)

## <a name="commands"></a>命令
|     |     |
| --- | --- |
[azdata bdc sql status](reference-azdata-bdc-sql-status.md) | SQL 服務狀態命令。
